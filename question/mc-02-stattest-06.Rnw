...
wrong_vec <- c('In der Analogie des Niederschlags oder Regenmenge: ein statistischer Test gibt nur die Stärke eines Effektes wieder. Zum Beispiel, wie hoch ist der Mittelwertsunterschied. Der Effekt kann nicht bewertet werden.',
