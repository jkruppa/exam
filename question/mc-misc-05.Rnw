...
ques_vec <- c(str_c('Sie haben das abstrakte Modell $Y \sim X$ mit $X$ als Faktor mit zwei Leveln vorliegen. Welche Aussage über $', variable_vec, '$ ist richtig?'),
              'Gegeben ist das Modell $Y \sim X$. Welche Aussage über $', variable_vec, '$ ist richtig?',
              'Es sei $', variable_vec, '$ in dem Modell $Y \sim X$. Welche Aussage ist richtig?') |>  sample(1)
@
