...
<<>>=
day1 <- c(40, 45, 50) %>% sample(1)
day2 <- c(60, 65, 70) %>% sample(1)
day3 <- c(100, 105, 110, 115) %>% sample(1)
people <- c(218, 222, 237, 245) %>% sample(1)
vit_c_sellerie <- c(7000, 8000, 6000) %>% sample(1)
vit_c_bedarf <- c(105, 110, 115) %>% sample(1)
surv_day <- c(90, 95, 100) %>% sample(1)
day_journey <- c(18, 20, 22) %>% sample(1)
@
...
$\Sexpr{vit_c_sellerie}\mu g/100g$ Vitamin C. Der Bedarf liegt bei
$\Sexpr{vit_c_bedarf}mg$ pro Tag f{\"u}r M{\"a}nner.

\begin{enumerate}
  \setcounter{enumi}{2}
\item Berechnen Sie die notwendige Menge an aufzunehmenden wilden Sellerie
  auf die Concepci{\'o}n f{\"u}r die ununterbrochene Fahrt von drei Monate und \Sexpr{day_journey}
