...
ques_vec <-  c(str_c("'So, was haben wir gemacht? Wir haben einen t-test für den Vergleich der Mittelwerte gerechnet.', meint ", name, ". ", name_sec, " schaut fragend. 'Hatten wir nicht alles zu einer Kontrolle verglichen? Das war doch so!', ruft ", name_sec, " laut aus. 'Wir haben doch Messwert \\textit{", effect, "} erhoben.', stellt ", name, " fest. Jetzt haben beide das Problem, die möglichen 95\\% Konfidenzintervalle zu interpretieren.")) |> 
  sample(1)
