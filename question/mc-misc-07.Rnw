...
ques_vec <- c(str_c('Sie führen ein Experiment zur Behandlung von Klaueninfektionen bei Kühen durch. Bei ', num_1, ' Tieren finden Sie eine Erkrankung der Klauen vor und ', num_2, ' Tiere sind gesund. Welche Aussage über den ', var_vec, ' Effektschätzer ist richtig?'),
              '',
              '') |>  sample(1)
@
