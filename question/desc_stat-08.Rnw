...
ques_vec <- c(str_c("'Uff!', denkt sich ", name, ". Jetzt hat ", names(name), " doch tatsächlich zwei kategoriale Variablen in ", project, " gemessen. Zum einen die Behandlung ", x_val, " und zum anderen die Messung ", y_val, " im Kontext von ", obser, ". Hierfür hat ", names(name) , " ", exp, " ", ort, " durchgeführt. Jetzt möchte ", name, " die Daten einmal in einer explorativen Datenanalyse darstellen. Danach kann ", names(name), " dann über den passenden statistischen Test nachdenken. Dabei unterstützt ", betreuer, " diesen Ansatz bevor es in der Datenanalyse weiter geht."),
              str_c("Zwei kategoriale Variablen darzustellen ist nicht so einfach. ", name, " hatte erst über einen Mittelwert nachgedacht, dann aber die Idee verworfen. In ", exp, " ", ort, " hatte ", names(name), " sich zum einen die Behandlung ", x_val, " und zum anderen die Messung ", y_val, " im Kontext von ", obser, " angeschaut. Jetzt möchte ", betreuer, " erstmal die langen Tabellen mit ja/nein in einer explorativen Datenanalyse zusammengefasst bekommen. Sonst geht es bei ", project, " nicht weiter."),
              str_c("In ", exp, " ", ort, " hatte ", name, " sich zum einen die Behandlung ", x_val, " und zum anderen die Messung ", y_val, " im Kontext von ", obser, " angeschaut. Nun steht ", name, " vor dem Problem, dass ", names(name), " zwei kategoriale Variablen in ", project, " gemessen hat. Da ", betreuer, " erstmal die langen Tabellen mit ja/nein in einer explorativen Datenanalyse zusammengefasst und präsentiert bekommen möchte bevor es überhaupt weitergeht, muss ", names(name), " jetzt eine Lösung finden.")) |> 
  sample(1)
