...
vit_c_sellerie <- c(7000, 8000, 6000, 5000) %>% sample(1)
vit_c_bedarf <- c(105, 110, 115, 110) %>% sample(1)
...
\item Berechnen Sie die notwendige Menge an aufzunehmenden wilden Sellerie
  in $\Sexpr{unit}$ auf die Concepci{\'o}n f{\"u}r die ununterbrochene Fahrt von drei Monate und \Sexpr{day_journey}
