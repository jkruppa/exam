...
paper <- c("Sánchez, M., et al. (2022). Hoverfly pollination enhances yield and fruit quality in mango under protected cultivation",
           ...
           "Selle, P. H., et al. (2010). Implications of sorghum in broiler chicken nutrition",
           "Wu, G., et al. (2004). Arginine nutrition in neonatal pigs") |> 
  set_names(c("mango", "duckweed", "chicken", "pigs")) |> sample(1)

ques_vec <- c(str_c(name, " hält die wissenschaftliche Veröffentlichung \\textit{", paper, "} unter einem Schnaufen in die Luft. 'Worum geht es denn eigentlich in dieser Arbeit?', fragt ", names(name), " stirnrunzelnd. ", name, " soll die Veröffentlichung nutzen um das eigene Experiment zu planen. Als eine Vorlage sozusagen. Daher möchte ", betreuer, ", dass ", names(name), " einmal die Veröffentlichung sinnvoll zusammenfasst. Das sollte dann doch etwas aufwendiger werden."),
              str_c("Vor dem Start der eigenen Arbeit möchte ", betreuer, ", dass ", name, " einmal die wissenschaftliche Veröffentlichung \\textit{", paper, "} sinnvoll zusammenfasst. Dann würde die eigene Arbeit auch leichter von der Hand gehen und ", name, " hätte dann schon eine Vorlage. 'Das ist jetzt aber umfangreicher als gedacht!', schnauft ", names(name), " und runzelt die Stirn."),
