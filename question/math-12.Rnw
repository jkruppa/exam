...
\paragraph{Die atmende Wand\footnote{Die Quelle der Inspiration
  für die Aufgabe war folgender Artikel:
  \href{https://de.wikipedia.org/wiki/Atmende_Wand}{Atmende Wand}} und Brot aus Luft\footnote{Die Quelle der Inspiration
  für die Aufgabe war folgender Artikel:
