...
<<>>=
kable(data_tbl[1:3,], booktabs = TRUE, align = "lrrrrr") %>% 
...
\item Interpretieren Sie den Effekt von \textit{\Sexpr{sample(c("maxdepth", "temp",
      "do2", "no3"), 1)}} auf die Anzahl an Knochenhechten! Liegt ein
