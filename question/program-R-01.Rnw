...
ques_vec <- c(str_c(name, " muss ", project , " mit \\Rlogo arbeiten. Deshalb sitzt ", names(name), " jetzt mit Ihnen zusammen und hat einige Fragen zu den \\textbf{Grundlagen} in \\Rlogo an Sie! Na dann wollen Sie mal helfen. Immerhin will ", betreuer, ", dass \\Rlogo genutzt wird."),
              str_c("'Unter den Blinden ist der Einäuge König!', ruft Ihnen ", name, " entgegen. Leider kennt sich ", name, " überhaupt nicht mit den \\textbf{Grundlagen} in \\Rlogo aus aber ", betreuer, " möchte gerne, dass die Auswertung in \\Rlogo gemacht wird. Da müssen Sie dann wohl mal ran und helfen."),
...
ques_random <- c(ques_1, ques_2, ques_3, ques_4, ques_5, ques_6, ques_7, ques_8, ques_9) |> sample()

@

\Sexpr{ques_vec}\\[1Ex]

\Sexpr{name} fragt: \textit{\Sexpr{ques_random[1]}} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

\Sexpr{name} fragt: \textit{\Sexpr{ques_random[2]}} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

\Sexpr{name} fragt: \textit{\Sexpr{ques_random[3]}} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

\Sexpr{name} fragt: \textit{\Sexpr{ques_random[4]}} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

\Sexpr{name} fragt: \textit{\Sexpr{ques_random[5]}} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

\Sexpr{name} fragt: \textit{\Sexpr{ques_random[6]}} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

\Sexpr{name} fragt: \textit{\Sexpr{ques_random[7]}} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

\Sexpr{name} fragt: \textit{\Sexpr{ques_random[8]}} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

\Sexpr{name} fragt: \textit{\Sexpr{ques_random[9]}} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]
