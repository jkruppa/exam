...
ques_vec <-  c(str_c(name_sec[1], " und ", name_sec[2], " sind bei ", name, " um sich Hilfe für eine Versuchsplanung in \\Rlogo zu holen. Dabei geht es um den Zusammenhang zwischen der Behandlung ", x1_val, " sowie ", x2_val, " und dem Messwert ", y_val, " in ", obser, ". Der Versuch soll in ", exp, " ", ort, " durchgeführt werden. Nach ", betreuer, " ist der Messwert ", y_val, " normalverteilt. Die beiden entschieden sich für ein faktorielles Versuchsdesign. Im ersten Schritt überlegt ", name, " ein einfaches experimentelles Design zu probieren. Daher entscheiden sich alle drei für ein \\textit{", simple, "} mit nur einem der beiden Faktoren. Das sollte für den anfang erstmal reichen. 'Und jetzt, was machen wir jetzt?', ", name_sec[2], " schaut die anderen beiden mit großen Augen an. Die zucken mit der Schulter.")) |> 
  sample(1)
@ 
