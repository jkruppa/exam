...
h_vorne <- c(6, 5, 7) %>% sample(1)
h_hinten <- c(8, 9, 11) %>% sample(1)
tiefe <- c(12, 13, 14) %>% sample(1)
breite <- c(30, 40, 50) %>% sample(1)

beton_m <- c(5, 10, 15) %>% sample(1)
save_m <- c(10, 15, 20) %>% sample(1)
dichte_l <- c(220, 235, 240) %>% sample(1)
dichte_h <- c(270, 280, 290) %>% sample(1)
radius <- c(1, 1.2, 1.5) %>% sample(1)
grad <- c(85, 90, 95) %>% sample(1)
@
...
Sicherheitstoleranz von $\Sexpr{save_m}\%$ ein. In fl{\"u}ssiger Form hat
