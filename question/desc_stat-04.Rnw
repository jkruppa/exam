...
\begin{enumerate}
\item Zeichnen Sie in \textit{einer} Abbildung die beiden Boxplots für die zwei Behandlungen von \Sexpr{plant}! Beschriften Sie die Achsen entsprechend! \textbf{(5 Punkte)} 
