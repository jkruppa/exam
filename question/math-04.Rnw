...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr \Sexpr{export_year} blieben die Erträge von Blaubeeren mit \Sexpr{export_blau_chile}t in dem prognostizierten Rahmen. Die Menge \Sexpr{blau_switch} sich um \Sexpr{export_blau_chile_per}\%. Die Exporte für Avocados \Sexpr{avo_switch} in dem gleichen Zeitraum um \Sexpr{export_avocado_chile_per}\% auf \Sexpr{export_avocado_chile}t.
