...
\item Skizzieren Sie eine Abbildung, der dem obigen Ergebnis der
  einfaktoriellen ANOVA näherungsweise entspricht! Begründen Sie Ihre Darstellung! \textif{Berücksichtigen Sie dabei den p-Wert sowie den berechneten Wert von $\eta^2$ in Ihrer Darstellung.} \textbf{(4 Punkte)}
\end{enumerate}
