...
v_blei <- c(10, 12, 13) %>% sample(1)
l_tropf <- c(3.2, 3.5, 3.1) %>% sample(1)
d_tropf <- c(2, 1.8, 1.7) %>% sample(1)
n_blei <- c(1.2e6, 2.3e5, 6.1e4) %>% sample(1)
d_blei <- c(11.34, 10.32, 12.63) %>% sample(1)
n_prod <- c(700, 900, 1100) %>% sample(1)
dist <- c(0.5, 0.8, 1.2) %>% sample(1)
@
...
Geschwindigkeit von $\Sexpr{v_blei}m/s$ bilden. 
...
\begin{enumerate}
  \setcounter{enumi}{3}
\item Wie schwer sind die \Sexpr{n_blei} Bleikugeln, die Sie jetzt auf die
