...
questions_vec <- c('Keine Interaktion ist zu erwarten. Die Geraden der Verabreichungsmethode laufen parallel und mit {\"a}hnlichen Abst{\"a}nden.',
                   'Eine leichte Interaktion ist zu erwarten. Die Geraden schneiden sich noch nicht, aber die Abst{\"a}nde unterscheiden sich stark.',
