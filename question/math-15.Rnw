...
\item Osterglocken beginnen ab einer GLT von \Sexpr{glt}$^\circ C$ zu blühen. An welchem Tag im 1. Quartal des Jahres \Sexpr{today_year -1} war dies der Fall? \textit{Ignorieren Sie ein eventuelles Schaltjahr in Ihrer Berechnung.} \textbf{(3 Punkte)}
\end{enumerate}
