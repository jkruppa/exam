...
Leider kennen sich \Sexpr{name} und \Sexpr{name_sec[1]} mit Darstellung einer einfaktoriellen ANOVA überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe! 
