...
<<>>=
firma <- c("KH Gesund und Sch{\"o}n Komponenten (KH-GSK)",
           "GroKo Versicherungssysteme (GroKoVer)",
           "Direkt Finanzanlagen Left/Right (D-FL/R)")  %>%
  set_names(c("KH-GSK", "GroKoVer", "D-FL/R")) %>% sample(1)
umsatz <- c(260, 275, 290, 310) %>% sample(1)
steigerung <- c(10, 15, 24, 27) %>% sample(1)
partner <- c(280000, 330000, 360000, 380000) %>% sample(1)
year <- year(Sys.Date()) - 2
prov <- c(20, 25, 30) %>% sample(1)
...
\item Wie viel von dem Umsatz im Jahr 2021 wird im Schnitt von jedem
