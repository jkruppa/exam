...
\Sexpr{name}, \Sexpr{name_sec[1]}, \Sexpr{name_sec[2]} und \Sexpr{name_sec[3]}
...
für die erste Stufe beträgt \Sexpr{prov_1}\%. Für die zweite, dritte und
...
wirbt wiederum \Sexpr{n_partner} Partner für sich selbst an. Pro Monat
...
für \Sexpr{einstieg}EUR kaufen. Diese Einheiten können Sie nur direkt
verkaufen. Leider mussten Sie den Kauf über einen Kredit über
\Sexpr{zins}\% p.a. über \Sexpr{month} Monate finanzieren.
