...
<<mc-testing-ttest-02, results='asis', echo = FALSE, fig.height = 3, fig.width = 3, fig.align = "center", message = FALSE>>=
...
ggplot(data_tbl, aes(x = dose, y = mean, fill = dose)) +
  ...
  theme_minimal() +
  labs(y = "Ertrag in Trockenmasse [t/ha]", x = "Behandlung mit Mikronährstoff",
