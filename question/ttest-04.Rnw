...
%% --------------------------------------------------------------------
\includegraphics[width = 1.2cm]{\Sexpr{avatar_file}}\hfill\href{https://youtu.be/QR90zyn0Iz8}{\includegraphics[width = 2cm]{img/youtube}}\\[1Ex]
%% --------------------------------------------------------------------
...
ques_vec <- c(str_c("Alles voll mit ", obser, ". Das hat ", name, " in ", project, " gemacht. ", obser, ". Worum ging es aber konkret? ", name, " hat als ", outcome_name, " ", y_val, " von ", obser, " bestimmt. Die Daten hat er in einem ", exp, " erhoben. In dem Experiment ging es um eine vorher/nachher Untersuchung an den gleichen ", obser, ". Als Behandlung wurde ", x_val, "eingesetzt. Nach der Meinung ", betreuer, " muss hier ein gepaarter t-Test gerechnet werden."))

str_c("Als ", name, " ", betreuer, " zugehört hatte, klang das mit der Messung an der gleichen Beobachtung irgendwie einfacher als es jetzt in der Praxis ist.")
