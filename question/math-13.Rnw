...
L{\"a}nge von \Sexpr{karton}cm und eine Breite von \Sexpr{sb}cm. Die
...
Seitenl{\"a}ngen $a$ und $b$ bei der Verwendung von \Sexpr{zaun}m Zaun bestimmen!
