...
$\Sexpr{m_sun}$kg. Wenn die Sonne nun am Ende ihrer Lebenszeit zu einem schwarzen Loch mit dem Radius
von $\Sexpr{r_black}$m kollabiert, wird
die Sonne $\Sexpr{m_perc}$\% der aktuellen Masse verloren haben. Ein
