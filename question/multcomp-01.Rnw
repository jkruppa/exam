...
ques_vec <-  c(str_c("In ", exp, " mit ", obser, " wurde die Behandlung ", x_val, " gegen die Ergebnisse einer früheren Studie von ", study, " verglichen. Im Rahmen des Experiments haben ", name, " und ", name_sec, " verschiedene Student t-Tests für den Mittelwertsvergleich für den Messwert ", y_val, " gerechnet. Es ergab sich dann die folgende Tabelle der rohen p-Werte für die Vergleiche zu ", study, ".")) |> 
  sample(1)
...
Leider kennen sich \Sexpr{name} und \Sexpr{name_sec[1]} mit der Adjustierung von $p$-Werten überhaupt nicht aus. Deshalb brauchen bei der Erstellung Ihre Hilfe!
