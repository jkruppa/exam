...
Leider kennen sich \Sexpr{name} und \Sexpr{betreuer} mit der Berechnung einer zweifaktoriellen ANOVA überhaupt nicht aus. Geschweige denn mit der Interpretation einer Interaktion zwischen zwei Behandlungsfaktoren. Deshalb braucht \Sexpr{names(name)} bei der Erstellung Ihre Hilfe, sonst wird es heute Abend mit seinem Hobby \Sexpr{attr_name_vec$hobby} nichts mehr! 
