...
und blicken in das hochrote Gesicht \Sexpr{person}. "'Wieso?"', entfährt es
...
mathematischen untermauerten Argumenten im \Sexpr{markt} über sich ergehen
...
\item Ein Kilo Strauchtomaten benötigt \Sexpr{kilo_tomate_water}l Wasser.
\item Ein Kilo Salat benötigt \Sexpr{kilo_salat_water}l Wasser.
\item Ein Kilo Avocado benötigt \Sexpr{kilo_avocado_water}l Wasser.
\item Ein Kilo Blaubeeren benötigt \Sexpr{kilo_blaubeeren_water}l Wasser.
\end{itemize}
...
In dem Exportjahr \Sexpr{export_year} blieben die Erträge von Blaubeeren mit
\Sexpr{export_blau_chile}t in dem prognostizierten Rahmen aber hinter den
Erwartungen zurück. Die Menge reduzierte sich um
\Sexpr{export_blau_chile_per}\%. Die Exporte für Avocados stiegen in dem gleichen
...
gibt etwa \Sexpr{wasserverbrauch_chile} Liter Wasser pro Kopf für den täglichen Bedarf.
