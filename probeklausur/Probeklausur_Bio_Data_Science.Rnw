...
\begin{graybox}{Rechen- und Textaufgaben}
  ...
  \begin{center}
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
      \hline
      \textbf{Aufgabe} & \textbf{11} & \textbf{12} & \textbf{13} & \textbf{14} & \textbf{15} &  \textbf{\Sexpr{seventeen}} \strut\\
      \hline
      \textbf{Punkte} & 
      ...
      \hspace{1Ex}\Large\textcolor{gray!70}{\Sexpr{points_vec[6]}}\hspace{1Ex}  \strut\\
      \hline
  \end{tabular}
\end{center}
\begin{itemize}
