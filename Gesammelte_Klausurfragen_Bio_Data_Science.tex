...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.34, 0.03, 0.42 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.15, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.068, 0.006, 0.084 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.15, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.05, 1.7, 0.15, 2.1 und 4.45. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.068, 0.006, 0.084 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 13, 12, 15 und 16.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 13 +/- 1.37
\item [\textbf{B} \msquare] Es ergibt sich 12 +/- 3.75
\item [\textbf{C} \msquare] Es ergibt sich 13 +/- 7.5
\item [\textbf{D} \msquare] Es ergibt sich 14 +/- 1.37
\item [\textbf{E} \msquare] Es ergibt sich 13 +/- 2.74
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 16, 23, 17, 20, 19, 17 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 +/- 23
\item [\textbf{B} \msquare] Es ergibt sich 22 +/- 17
\item [\textbf{C} \msquare] Es ergibt sich 19 +/- 17
\item [\textbf{D} \msquare] Es ergibt sich 22 [18, 24]
\item [\textbf{E} \msquare] Es ergibt sich 19 [17, 23]
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.57, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 1.75, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.36, da es sich um ein Anteil handelt.
...
$y = \{22, 17, 19, 21, 15, 19, 25, 16, 28, 21, 9\}$. Berechnen Sie folgende
...
Frischgewicht (\textit{freshmatter}) von Lauch.
...
\begin{center}
$10.1, 9.5, 11.7, 9.2, 8.3, 10.4, 13.7, 13.5, 11.3, 7.3, 11.3, 9.7$
\end{center}
...
\begin{minipage}[c]{.4\linewidth} % [b] => Ausrichtung an \caption
  \includegraphics[width=\linewidth]{/Users/kruppajo/Documents/GitHub/exam/question/img/boxplot-03-c.png}
\end{minipage}
...
den Boniturnoten (\textit{grade}) von Lauch.
...
## t = 1.9005, df = 14, p-value = 0.07815
...
## t = 3.7725, df = 16, p-value = 0.001667
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  1.265507 4.512271
## sample estimates:
...
## t = 0.56744, df = 12, p-value = 0.5809
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.398000  4.086889
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 85.29 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 35.27 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  4.469  2.2346  1.0829 0.3576
## Residuals 20 41.270  2.0635
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 114 128 112  99 105 103 131 138 152 150 130 161
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 51.37 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 104.29 &  &  &  \strut\\
    \hline
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2  77.72  38.860  2.1093 0.150317
## form       1 249.14 249.137 13.5229 0.001723
## dose:form  2  61.05  30.524  1.6568 0.218543
## Residuals 18 331.62  18.423
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 106$ Sauen. In dem Experiment wurde gemessen,
...
## -4.667 -1.000  0.000  1.000  4.333 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   15.000      0.874  17.162 9.98e-12
## waterB         9.667      1.236   7.821 7.43e-07
## 
## Residual standard error: 2.622 on 16 degrees of freedom
## Multiple R-squared:  0.7926,	Adjusted R-squared:  0.7797 
## F-statistic: 61.16 on 1 and 16 DF,  p-value: 7.432e-07
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7926$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: weight, variety und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.87 & 0 & 12.35 & 103.27 & 70.73 & 11\\
10.83 & 0 & 10.10 & 97.97 & 68.56 & 10\\
9.29 & 1 & 10.36 & 99.13 & 69.95 & 5\\
9.81 & 0 & 11.23 & 99.30 & 69.73 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.2173 -1.3135 -0.1595  1.4985  4.9088 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -3.44770    7.31200  -0.472    0.638
## Fe           0.73508    0.07153  10.277   <2e-16
## light        0.81884    0.56484   1.450    0.151
## water       -0.03868    0.17834  -0.217    0.829
## 
## Residual standard error: 2.29 on 85 degrees of freedom
## Multiple R-squared:  0.5686,	Adjusted R-squared:  0.5534 
## F-statistic: 37.35 on 3 and 85 DF,  p-value: 1.708e-15
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & so4 & maxdepth & no3 & do2\\
\midrule
COLLIER\_RUN & 18 & 17.63 & 42 & 0.26 & 8.6\\
LITTLE\_GUNPOWDER\_R & 3 & 6.96 & 85 & 2.60 & 9.7\\
SENECA\_CR & 23 & 8.37 & 45 & 1.58 & 9.9\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.371  -4.475  -2.010   1.325  15.295  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.889000   1.462900   0.608  0.54619
## so4         -0.006059   0.022669  -0.267  0.79038
## maxdepth     0.013123   0.004378   2.998  0.00426
## no3          0.215809   0.077124   2.798  0.00733
## do2          0.133307   0.143373   0.930  0.35704
## 
## (Dispersion parameter for quasipoisson family taken to be 41.4493)
## 
##     Null deviance: 2398.0  on 53  degrees of freedom
## Residual deviance: 1660.6  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.52     -0.536   0.592
## 2 water           0.145     0.300   0.764
## 3 nematodes       0.147     1.14    0.252
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4698 -0.5469 -0.1612  0.5758  3.3374 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  202.4   14.23   
##  subject  (Intercept) 3930.5   62.69   
##  Residual              713.2   26.71   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.044     26.476   7.631
## attitudepop  -19.719      5.868  -3.360
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0804812 0.0044492 0.6732834
## high 0.0804812 1.0000000 0.0000294 0.1772994
## low  0.0044492 0.0000294 1.0000000 0.0014465
## mid  0.6732834 0.1772994 0.0014465 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 12, 14, 16, 14 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 14, 5, 9, 8 und 12! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, drymatter und P an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCSFGST & 4.5 | 1.5 | Mikro \\
    B & GCO0MGR & 1.0 | 2.0 | Normal \\ 
    C & GCX2KQO & 4.0 | 4.0 | Mikro \\ 
    D & GCDOLSU & 5.0 | 5.0 | Mikro \\ 
    E & GC5HSIJ & 3.0 | 4.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 709 n. Chr. f{\"u}r den neuen Lehnsherren
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  6-mal-gefaltete, 0.6mm, 50-cm-Karton} durch
...
Sie haben den Vektor $A = \{11, 16, 3\}$ und den Vektor $B = \{1, -4, 7\}$ gegeben.
