...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.42, 0.02 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.36, 1.68, 0.08 und 3.56. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.105, 0.005 und 0.2225. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.105, 0.005 und 0.2225. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 16, 10, 9, 10 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.4 +/- 3.36
\item [\textbf{B} \msquare] Es ergibt sich 11.4 +/- 1.68
\item [\textbf{C} \msquare] Es ergibt sich 10.4 +/- 1.68
\item [\textbf{D} \msquare] Es ergibt sich 10.4 +/- 11.3
\item [\textbf{E} \msquare] Es ergibt sich 9.4 +/- 5.65
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 8, 25, 21, 23, 22, 17, 42, 12, 30, 29 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 [17, 30]
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 17
\item [\textbf{C} \msquare] Es ergibt sich 23 +/- 30
\item [\textbf{D} \msquare] Es ergibt sich 23 [17, 30]
\item [\textbf{E} \msquare] Es ergibt sich 25 +/- 17
\end{enumerate}
...
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.4 liegt keine Overdispersion vor.
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.4 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\end{enumerate}
...
\item [\textbf{B} \msquare] Es handelt sich um eine Poisson-Verteilung mit Pois(15).
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.36 ist
richtig?
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.46, da es sich um ein Anteil handelt.
...
\midrule
(Intercept) & 38.31 & 0.35\\
light\_binhigh & 4.28 & 0.45\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 18.36
\item [\textbf{B} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 4.28
...
\item [\textbf{D} \msquare] Eine gaussian Regression basiert auf dem maximum Likelihood Prinzip. Hierbei kann kein Effekt beschrieben werden. Im Zweifel hilft aber eine Quadrierung der Fehlerqudrate $\epsilon$.
\item [\textbf{E} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 18.36
\end{enumerate}
...
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 34
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 9
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 18
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 36
\end{enumerate}
...
$y = \{17, 14, 14, 16, 18, 15, 15\}$. Berechnen Sie folgende
...
\begin{center}
$10.8, 15, 7.4, 12.3, 8.7, 6, 9.2, 9.4, 7.7, 9.8, 9.7, 9.5, 11, 9.3$
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 86.86 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 45.43 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 74.159  37.079  12.393 0.0003155
## Residuals 20 59.841   2.992
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 118 129  99 115  93  91 129 144 144 153 150 168
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 1.88 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 547.78 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 292.86 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 65 & 1104.94 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 207.63  103.82  5.2459 0.016031
## form       1 142.29  142.29  7.1900 0.015241
## dose:form  2 387.10  193.55  9.7804 0.001333
## Residuals 18 356.21   19.79
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   74   \strut\\
    \hline
     &  62 &  82 &  144  \strut\\
  \end{tabular}
\end{center}
...
## -6.0000 -1.1111  0.4444  1.7500  5.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  17.1111     0.9534  17.948 5.04e-12
## trtB         -2.1111     1.3483  -1.566    0.137
## 
## Residual standard error: 2.86 on 16 degrees of freedom
## Multiple R-squared:  0.1329,	Adjusted R-squared:  0.07867 
## F-statistic: 2.452 on 1 and 16 DF,  p-value: 0.137
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -5.7117, df = 8, p-value = 0.0004483
...
Einflussvariablen ($x$) wurden erhoben: height, P und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.19 & 1 & 11.33 & 97.66 & 67.49 & 9\\
8.87 & 0 & 10.58 & 96.11 & 65.20 & 13\\
8.92 & 1 & 9.89 & 94.66 & 67.38 & 11\\
7.78 & 0 & 7.77 & 102.20 & 71.13 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -9.3773 -2.1513  0.1368  2.1644 10.1541 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 74.42625    2.85388  26.079   <2e-16
## light        0.68205    0.77122   0.884    0.379
## P           -0.38093    0.23893  -1.594    0.114
## nematodes   -0.06096    0.11404  -0.535    0.594
## 
## Residual standard error: 3.429 on 98 degrees of freedom
## Multiple R-squared:  0.03254,	Adjusted R-squared:  0.002923 
## F-statistic: 1.099 on 3 and 98 DF,  p-value: 0.3535
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & do2 & maxdepth & no3\\
\midrule
PRETTYBOY\_BR & 19 & 904 & 9.8 & 39 & 6.81\\
GREENE\_BR & 33 & 2225 & 9.1 & 41 & 2.30\\
LITTLE\_ANTIETAM\_CR & 24 & 3488 & 9.3 & 44 & 2.11\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -11.251   -4.127   -1.963    2.058   16.948  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.225e+00  1.431e+00   0.856  0.39613
## acerage     3.407e-05  1.254e-05   2.717  0.00908
## do2         7.281e-02  1.486e-01   0.490  0.62633
## maxdepth    1.157e-02  4.193e-03   2.759  0.00813
## no3         2.028e-01  6.683e-02   3.035  0.00384
## 
## (Dispersion parameter for quasipoisson family taken to be 35.81682)
## 
##     Null deviance: 2477.7  on 53  degrees of freedom
## Residual deviance: 1555.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.40      1.06    0.287
## 2 nematodes       0.153    -0.213   0.832
## 3 water           0.134    -1.22    0.222
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2010 -0.5934 -0.1092  0.5938  3.6414 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  194.8   13.96   
##  subject  (Intercept) 3946.7   62.82   
##  Residual              643.7   25.37   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.336     26.475   7.680
## attitudepop  -21.619      5.575  -3.878
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000116 0.0000012 0.0312959
## high 0.0000116 1.0000000 0.4411405 0.0061679
## low  0.0000012 0.4411405 1.0000000 0.0007799
## mid  0.0312959 0.0061679 0.0007799 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 12, 6, 9, 10 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 1, 4, 10, 2 und 7! \textbf{(2 Punkte)}
...
\begin{quote}
  ...
  ersten Symptome ein; die ersten Toten sind nach 80 Tagen zu beklagen;
...
\item Bei einem vermutetet Alter der Erde von $\ensuremath{4.6\times 10^{9}}$ Jahren,
  ...
  $\ensuremath{1.2\times 10^{9}}$ Jahre vollst{\"a}ndig im Erdinneren umgewandelt haben! \textbf{(2
    Punkte)}
...
Sie haben den Vektor $A = 13, -7, 4$ und den Vektor $B = 9, 7, 1$ gegeben.
...
\item W{\"u}rden Sie die Axt mit zwei sechseitigen W{"u}rfeln (2d6) als Schaden oder
  das Schwert mit einem sechseitigen W{"u}rfel plus 5 (1d6+5) als Schaden bevorzugen?
