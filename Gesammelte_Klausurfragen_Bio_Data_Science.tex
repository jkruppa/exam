...
wurde an 47 Schweinen durchgef{\"u}hrt, wobei jedes Tier eine von
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 15, 9, 6 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.8 +/- 1.71
\item [\textbf{B} \msquare] Es ergibt sich 10.8 +/- 1.71
\item [\textbf{C} \msquare] Es ergibt sich 9.8 +/- 11.7
\item [\textbf{D} \msquare] Es ergibt sich 9.8 +/- 3.42
\item [\textbf{E} \msquare] Es ergibt sich 8.8 +/- 5.85
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 15, 0, 30, 17, 28, 14 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 [15, 31]
\item [\textbf{B} \msquare] Es ergibt sich 17 [14, 30]
\item [\textbf{C} \msquare] Es ergibt sich 17 +/- 30
\item [\textbf{D} \msquare] Es ergibt sich 24 +/- 14
\item [\textbf{E} \msquare] Es ergibt sich 17 +/- 14
\end{enumerate} 
...
In dem folgenden Histogramm von $n = 171$ Pflanzen ist welche
...
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.29, da es sich um eine Chancenverh{"a}ltnis handelt.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.03, 0.42 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.12, 1 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.12, 1.68 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.12, 1 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.0075, 0.105 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.0075, 0.105 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\item [\textbf{D} \msquare] Compact line display. Gleichheit in den Behandlungen wird durch den gleichen Buchstaben oder Symbol dargestellt. Fr{"u}her wurden keine Buchstaben sondern eine durchgezogene Linie verwendet. Bei mehr als drei Gruppen funktioniert die Linie aber graphisch nicht mehr.
...
\begin{center}
$1, 4, 11, 5, 2, 3, 2, 2, 1, 7, 3, 7, 4, 9, 1, 4, 8, 2, 3, 5, 2, 0, 6, 2, 7, 2, 2, 6, 2, 8$
\end{center}
...
\begin{center}
$11, 13.4, 8.4, 14.4, 9.3, 11.8, 9.7, 12.6, 11.7, 10.4, 8.6, 8.3, 9, 6.6, 10.6, 10.6, 10.9$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  Testentscheidung & 20\% & (Unbekannte) Wahrheit & H$_0$ wahr \\
  \end{tabular}
  \end{center}
...
## t = -4.458, df = 12, p-value = 0.0007819
...
## t = -0.62423, df = 16, p-value = 0.5413
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -3.419140  1.863584
## sample estimates:
...
Der Datensatz \texttt{plant\_growth\_tbl} enth{\"a}lt das Frischgewicht der Brokolik{"o}pfe
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 132.67 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 91.33 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Der Datensatz \textit{crop\_tbl} enth{\"a}lt das Outcome \textit{freshmatter} f{\"u}r einen Freilandversuch mit 
...
## trt        2 58.189 29.0946  6.9839 0.004483
## Residuals 22 91.651  4.1659
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 64.01 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 65 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 24.19 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 157.52 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 58 H{"a}ngebauchschweinen durchgef{\"u}hrt, wobei
...
## Response: weight
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 399.10 199.548 16.1136 9.75e-05
## form       1   0.01   0.014  0.0012  0.97318
## dose:form  2 135.46  67.731  5.4693  0.01394
## Residuals 18 222.91  12.384
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0480489 0.3239395 0.2782700
## high 0.0480489 1.0000000 0.0044827 0.3478742
## low  0.3239395 0.0044827 1.0000000 0.0432515
## mid  0.2782700 0.3478742 0.0432515 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 168$ Sauen. In dem Experiment wurde gemessen,
...
## -6.8889 -2.6389  0.1111  2.8611  4.1111 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.889      1.184  14.267 1.62e-10
## waterB        -4.000      1.674  -2.389   0.0295
## 
## Residual standard error: 3.551 on 16 degrees of freedom
## Multiple R-squared:  0.263,	Adjusted R-squared:  0.2169 
## F-statistic: 5.709 on 1 and 16 DF,  p-value: 0.02954
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.263$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: block, variety und dry. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
Mehr Informationen zu den Aufgaben in dem \href{https://jkruppa.github.io/math/}{Skript Mathematik}.\\
\end{graybox}
\clearpage
% -----------------------------------------------------------------------  
...
\midrule
foraging incl. scratching & 37cm; 17cm; 64.1\% & 31cm; 23cm; 64.1\% & 34cm; 30cm; 50.1\%\\
drinking/eating & 37cm; 21cm; 0.6\% & 34cm; 18cm; 0.8\% & 30cm; 20cm; 0.9\%\\
preening & 28cm; 36cm; 8.1\% & 29cm; 25cm; 5.2\% & 33cm; 21cm; 6.3\%\\
sitting & 38cm; 27cm; 12.8\% & 39cm; 34cm; 14.2\% & 40cm; 30cm; 12.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCCFEBO & 3.0 | 2.5 | Normal \\
    B & GCZQXOD & 1.0 | 4.5 | Normal \\ 
    C & GC2SHOR & 3.5 | 2.0 | Klein \\ 
    D & GCQI5MG & 2.0 | 1.0 | Normal \\ 
    E & GC3SIDH & 2.5 | 5.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1153 n. Chr. f{\"u}r den neuen Lehnsherren
...
4.5\% p.a. {\"u}ber 36 Monate finanzieren.
...
Sie haben den Vektor $A = \{6, 3, 0\}$ und den Vektor $B = \{0, 4, 3\}$ gegeben.
