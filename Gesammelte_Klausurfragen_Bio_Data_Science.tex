...
\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.84, 0.004 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.84, 0.004 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
...
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.0525, 3e-04 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3.56, 0.84, 0.004 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 10, 16, 6 und 4.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.4 +/- 10.9
\item [\textbf{B} \msquare] Es ergibt sich 9.4 +/- 2.335
\item [\textbf{C} \msquare] Es ergibt sich 9.4 +/- 21.8
\item [\textbf{D} \msquare] Es ergibt sich 9.4 +/- 4.67
\item [\textbf{E} \msquare] Es ergibt sich 10.4 +/- 2.335
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 29, 19, 25, 22, 21, 14, 22, 38, 6, 16 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 [17, 30]
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 16
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 29
\item [\textbf{D} \msquare] Es ergibt sich 22 [16, 29]
\item [\textbf{E} \msquare] Es ergibt sich 22 +/- 16
\end{enumerate} 
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.2, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.25, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.2, da es sich um ein Anteil handelt.
...
$y = \{13, 14, 13, 15, 13, 17, 16, 16, 16, 17, 13\}$. Berechnen Sie folgende
...
\begin{center}
$9.3, 10.6, 11.3, 13.8, 6.8, 8.7, 9.9, 9, 6.5, 8.6, 11.8, 8.9, 7.7, 6.7, 7.6$
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.5 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 23.37 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 134.012  67.006  34.489 3.292e-07
## Residuals 20  38.857   1.943
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 119 109 132  95  98  86 147 126 151 161 144 142
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 45.45 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 415.45 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 31.24 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 39 & 572.63 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 330.58 165.290 14.2076 0.0001984
## form       1  77.78  77.780  6.6856 0.0186532
## dose:form  2  27.22  13.611  1.1699 0.3329118
## Residuals 18 209.41  11.634
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -3.2857 -1.7714  0.0571  1.4786  5.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   14.286      1.046  13.654  8.6e-08
## trtB           3.314      1.621   2.045   0.0681
## 
## Residual standard error: 2.768 on 10 degrees of freedom
## Multiple R-squared:  0.2948,	Adjusted R-squared:  0.2243 
## F-statistic: 4.181 on 1 and 10 DF,  p-value: 0.06811
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: N, variety und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.41 & 0 & 9.94 & 97.01 & 69.41 & 13\\
11.60 & 0 & 9.65 & 102.88 & 73.99 & 8\\
9.66 & 0 & 10.61 & 103.47 & 73.55 & 13\\
8.67 & 1 & 11.74 & 103.59 & 72.45 & 11\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.1448 -1.3031  0.4065  1.4023  4.9429 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  3.62260    6.92338   0.523    0.602
## Fe           0.65679    0.06750   9.730 5.13e-16
## light       -0.11698    0.47141  -0.248    0.805
## water        0.05869    0.14559   0.403    0.688
## 
## Residual standard error: 2.135 on 97 degrees of freedom
## Multiple R-squared:  0.4975,	Adjusted R-squared:  0.482 
## F-statistic: 32.02 on 3 and 97 DF,  p-value: 1.798e-14
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & maxdepth & do2 & so4\\
\midrule
SOUTH\_BR\_PATAPSCO & 26 & 18.6 & 60 & 7.9 & 8.84\\
LIBERTY\_RES & 12 & 20.2 & 62 & 8.3 & 5.82\\
BASIN\_RUN & 13 & 15.3 & 80 & 9.6 & 16.75\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -10.083   -3.795   -1.369    1.642   12.768  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.402245   1.596195  -1.505   0.1387
## temp         0.152310   0.044300   3.438   0.0012
## maxdepth     0.017143   0.003785   4.529 3.81e-05
## do2          0.224665   0.115584   1.944   0.0577
## so4         -0.028804   0.024656  -1.168   0.2484
## 
## (Dispersion parameter for quasipoisson family taken to be 28.09398)
## 
##     Null deviance: 2175.3  on 53  degrees of freedom
## Residual deviance: 1290.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.90      0.526   0.599
## 2 water           0.184    -0.557   0.577
## 3 nematodes       0.180    -0.484   0.628
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0432 -0.6138 -0.0671  0.6167  3.3100 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  180.9   13.45   
##  subject  (Intercept) 4062.3   63.74   
##  Residual              660.3   25.70   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.994     26.807   7.572
## attitudepop  -21.097      5.646  -3.737
## 
...
\begin{verbatim}
##          ctrl      high       low       mid
## ctrl 1.00e+00 0.0000561 0.0000036 0.0000003
## high 5.61e-05 1.0000000 0.3530948 0.0830381
## low  3.60e-06 0.3530948 1.0000000 0.4032972
## mid  3.00e-07 0.0830381 0.4032972 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 7, 11, 10, 9 und 12!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 15, 15, 7 und 8! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, P und drymatter an vier verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{8, 8, 6\}$ und den Vektor $B = \{3, 3, -5\}$ gegeben.
