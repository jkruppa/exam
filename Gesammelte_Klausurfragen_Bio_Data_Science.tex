...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.03, 0.34, 0.21 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 0.15, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.006, 0.068, 0.042 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 0.15, 1.7, 1.05 und 4.45. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 0.15, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.006, 0.068, 0.042 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 5, 11, 13, 16 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.4 +/- 16.3
\item [\textbf{B} \msquare] Es ergibt sich 11.4 +/- 4.04
\item [\textbf{C} \msquare] Es ergibt sich 11.4 +/- 2.02
\item [\textbf{D} \msquare] Es ergibt sich 10.4 +/- 8.15
\item [\textbf{E} \msquare] Es ergibt sich 12.4 +/- 2.02
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 19, 15, 30, 20, 15, 7 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 [15, 30]
\item [\textbf{B} \msquare] Es ergibt sich 19 +/- 15
\item [\textbf{C} \msquare] Es ergibt sich 24 [15, 30]
\item [\textbf{D} \msquare] Es ergibt sich 24 +/- 15
\item [\textbf{E} \msquare] Es ergibt sich 19 +/- 30
\end{enumerate}
...
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.41 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.41 liegt keine Overdispersion vor.
\end{enumerate}
...
In einem Stallexperiment mit $n = 100$ Ferkeln wurden verschiedene
...
\item [\textbf{B} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 9.11
\item [\textbf{C} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -3.02
\item [\textbf{D} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 9.11
...
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 310
...
$y = \{14, 18, 14, 18, 12, 18, 15\}$. Berechnen Sie folgende
...
\begin{center}
$10.2, 7.7, 10.6, 10.1, 8.6, 10.8, 8.9, 11.1, 10.7, 8.3, 8.8, 10.9, 7.9, 9.1$
\end{center}
...
## t = 1.7961, df = 14, p-value = 0.09409
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.6009417  6.7914179
## sample estimates:
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 123 127 128 109 103 103 134 140 146 160 158 152
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 4.39 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.69 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  3.2888 1.64439   4.074 0.02843 *
## Residuals 27 10.8980 0.40363                  
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 203.74 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2441.01 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 105.88 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 717.89 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df  Sum Sq Mean Sq F value    Pr(>F)    
## supp       1  252.29  252.29 18.0444 8.394e-05 ***
## dose       2 2013.88 1006.94 72.0187 4.358e-16 ***
## supp:dose  2   80.58   40.29  2.8818   0.06453 .  
## Residuals 55  768.99   13.98                      
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   50  \strut\\
    \hline
...
##  -3.60  -1.75  -0.30   1.30   5.40 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   19.600      1.192  16.448 1.35e-09 ***
## trtB          -4.600      1.486  -3.095  0.00927 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.665 on 12 degrees of freedom
## Multiple R-squared:  0.4439,	Adjusted R-squared:  0.3976 
## F-statistic: 9.579 on 1 and 12 DF,  p-value: 0.009275
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: center, region und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
BEAVER\_RUN & 37 & 43 & 8.1 & 5.66 & 19.3\\
BEAVER\_DAM\_CR & 19 & 56 & 9.2 & 5.44 & 17.0\\
BUFFALO\_RUN & 16 & 37 & 8.3 & 0.61 & 16.8\\
ROCK\_CR & 3 & 33 & 6.8 & 2.47 & 18.0\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -7.704  -4.173  -1.789   1.399  15.685  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)  
## (Intercept) -1.808765   1.742529  -1.038   0.3044  
## maxdepth     0.009319   0.004629   2.013   0.0496 *
## do2          0.277213   0.130479   2.125   0.0387 *
## no3          0.167022   0.075661   2.208   0.0320 *
## temp         0.091103   0.044809   2.033   0.0475 *
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 36.25157)
## 
##     Null deviance: 2009.8  on 53  degrees of freedom
## Residual deviance: 1415.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.48       1.24  0.217 
## 2 light           0.504      2.54  0.0111
## 3 water           0.148     -1.42  0.155
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
9.73 & 0 & 9.53 & 98.60 & 71.44 & 10\\
8.73 & 0 & 11.09 & 101.14 & 73.52 & 8\\
12.79 & 1 & 12.14 & 95.55 & 64.48 & 8\\
9.13 & 0 & 10.29 & 97.49 & 64.52 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.4537 -1.6959 -0.3212  1.3637  6.0061 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -3.77398    8.17562  -0.462  0.64545    
## P           -0.55527    0.16842  -3.297  0.00139 ** 
## Fe           0.78553    0.07944   9.889 3.91e-16 ***
## light        1.32217    0.55608   2.378  0.01949 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.46 on 92 degrees of freedom
## Multiple R-squared:  0.5607,	Adjusted R-squared:  0.5464 
## F-statistic: 39.15 on 3 and 92 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 799.5
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0214 -0.6858 -0.1350  0.5785  3.4174 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  230.5   15.18   
##  subject  (Intercept) 4029.2   63.48   
##  Residual              700.5   26.47   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.859     26.854   7.517
## attitudepop  -19.215      5.815  -3.304
## 
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.1831292 0.0006671 0.0000014
## B 0.1831292 1.0000000 0.0000136 0.0000000
## C 0.0006671 0.0000136 1.0000000 0.0402543
## D 0.0000014 0.0000000 0.0402543 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 19, 15, 30, 20, 15, 7 und 63!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 19, 15, 30, 20, 15, 7 und 63! \textbf{(2 Punkte)}
