...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.001, 0.03, 0.89, 0.02 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 2e-04, 0.005, 0.1483, 0.0033 und 0.0017. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.52, 0.006, 0.18, 5.34, 0.12 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.006, 0.18, 1, 0.12 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.006, 0.18, 1, 0.12 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 2e-04, 0.005, 0.1483, 0.0033 und 0.0017. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 20, 4, 10 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.6 +/- 3.115
\item [\textbf{B} \msquare] Es ergibt sich 9.6 +/- 3.115
\item [\textbf{C} \msquare] Es ergibt sich 9.6 +/- 6.23
\item [\textbf{D} \msquare] Es ergibt sich 9.6 +/- 38.8
\item [\textbf{E} \msquare] Es ergibt sich 8.6 +/- 19.4
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 32, 21, 33, 6, 36, 26 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 31 [22, 37]
\item [\textbf{B} \msquare] Es ergibt sich 31 +/- 21
\item [\textbf{C} \msquare] Es ergibt sich 32 +/- 36
\item [\textbf{D} \msquare] Es ergibt sich 32 [21, 36]
\item [\textbf{E} \msquare] Es ergibt sich 32 +/- 21
\end{enumerate} 
...
$y = \{6, 16, 14, 14, 20, 13, 14\}$. Berechnen Sie folgende
...
\begin{center}
$8.2, 10.9, 10.9, 14.8, 8.2, 9.4, 9.1, 6.9, 8.8, 11.8, 6.8, 9.4, 9.6, 8.9$
\end{center}
...
Nach einem Feldexperiment mit zwei Substrattypen ($torf$ und $70+30$) ergibt sich die
...
## t = 0.78909, df = 14, p-value = 0.4432
...
## 
## data:  freshmatter by N
## t = 0.85831, df = 10, p-value = 0.4108
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.328700  7.500128
## sample estimates:
...
## t = -0.95957, df = 12, p-value = 0.3562
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.340700  2.851811
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 51.68 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 106.32 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 122.000  61.000  16.565 8.307e-05
## Residuals 18  66.286   3.683
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 118 120 115  93 103  96 126 136 128 154 143 164
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 30.03 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 164.14 &  &  &  \strut\\
    \hline
...
## Response: weight
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 336.85 168.425 11.1804 0.0006979
## form       1  16.00  16.002  1.0622 0.3163534
## dose:form  2 157.90  78.952  5.2410 0.0160815
## Residuals 18 271.16  15.064
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -7.3333 -1.9722 -0.2222  2.7500  5.6667 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.222      1.274  12.738 8.63e-10
## waterB        10.111      1.801   5.614 3.88e-05
## 
## Residual standard error: 3.821 on 16 degrees of freedom
## Multiple R-squared:  0.6633,	Adjusted R-squared:  0.6422 
## F-statistic: 31.52 on 1 and 16 DF,  p-value: 3.88e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.6633$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: variety, height und dry. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.59 & 0 & 8.99 & 101.66 & 74.17 & 16\\
10.48 & 0 & 10.72 & 99.93 & 66.02 & 11\\
10.54 & 0 & 12.15 & 101.57 & 68.54 & 9\\
8.23 & 0 & 6.68 & 102.13 & 73.09 & 11\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.9133 -1.9316  0.0189  1.8099  9.2803 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  74.4403     3.2212  23.110   <2e-16
## nematodes     0.1169     0.1040   1.124   0.2637
## P            -0.3834     0.2191  -1.750   0.0831
## water        -0.1477     0.2265  -0.652   0.5157
## 
## Residual standard error: 3.162 on 104 degrees of freedom
## Multiple R-squared:  0.04019,	Adjusted R-squared:  0.0125 
## F-statistic: 1.452 on 3 and 104 DF,  p-value: 0.2321
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
ROCK\_CR & 3 & 7.61 & 2.47 & 18.0 & 33\\
HAWLINGS\_R & 1 & 4.64 & 2.62 & 20.5 & 73\\
MUDLICK\_RUN & 8 & 16.30 & 0.84 & 21.0 & 51\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.157  -4.485  -2.577   1.817  15.816  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.408133   1.067839   1.319  0.19341
## so4         -0.007115   0.023114  -0.308  0.75951
## no3          0.247988   0.076405   3.246  0.00212
## temp         0.027726   0.046585   0.595  0.55448
## maxdepth     0.013454   0.004528   2.971  0.00459
## 
## (Dispersion parameter for quasipoisson family taken to be 42.2521)
## 
##     Null deviance: 2485.2  on 53  degrees of freedom
## Residual deviance: 1741.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.75      2.45   0.0142
## 2 water           0.174    -2.35   0.0187
## 3 nematodes       0.151     0.367  0.713
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2976 -0.5194 -0.1273  0.6314  3.3188 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  218.1   14.77   
##  subject  (Intercept) 3903.5   62.48   
##  Residual              635.1   25.20   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.652     26.398   7.639
## attitudepop  -18.554      5.537  -3.351
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.1444344 0.1559479 0.0002597
## high 0.1444344 1.0000000 0.0059126 0.0000034
## low  0.1559479 0.0059126 1.0000000 0.0123141
## mid  0.0002597 0.0000034 0.0123141 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 10, 7, 9, 12 und 17!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 12, 10, 9, 12 und 9! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes leaf, grade und P an vier verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC47AXA & 5.0 | 3.5 | Normal \\
    B & GCNQTSJ & 3.0 | 4.0 | Klein \\ 
    C & GCUTK46 & 2.0 | 5.0 | Mikro \\ 
    D & GCK8FXW & 2.5 | 2.5 | Mikro \\ 
    E & GCXVCEG & 1.0 | 3.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 723 n. Chr. f{\"u}r den neuen Lehnsherren
...
\item Erg{\"a}nzen Sie in der Tabelle den \textit{gesamten} Fleischkonsum in
  Deutschland und Nigeria im Jahr 2021, der sich aus der Abbildung ergibt! \textbf{(1 Punkt)}
\end{enumerate}
...
Sie haben den Vektor $A = \{10, 1, -4\}$ und den Vektor $B = \{6, 0, -6\}$ gegeben.
