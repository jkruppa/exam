...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.001, 0.03, 0.02, 0.21 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.52, 0.006, 0.18, 0.12, 1.26 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.0002, 0.005, 0.0033, 0.035 und 0.0017. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.006, 0.18, 0.12, 1 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.0002, 0.005, 0.0033, 0.035 und 0.0017. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.006, 0.18, 0.12, 1 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Sie rechnen eine simple Gaussian Regression. Sie sch{"a}tzen einen Mittelwertsunterschied. 
...
## t = 0.848528, df = 16, p-value = 0.40866
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.99888824  2.33222157
## sample estimates:
...
## t = 0.861105, df = 12, p-value = 0.40606
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -1.5642572  3.6087017
## sample estimates:
...
\item Folgende statistische Fachbegriffe bzw. Methoden sind gegeben:
  \begin{itemize}
  \item[] Wilcoxon-Test, Paired t-Test, Mann-Whitney-U-Test, t-Test, ANOVA, Spearman Korrelation, Simple Gaussian linear Regression, Pearson Korrelation und Kruskal-Wallis-Test.
  \end{itemize}
