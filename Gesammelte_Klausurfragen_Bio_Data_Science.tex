...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\square\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\begin{graybox}{Endnote}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 59 Punkten sind aus den Rechen- und
    Textaufgaben erreicht. 
  \item[] \rule[0ex]{3em}{.4pt}\, von 79 Punkten in Summe.
...
\end{center}
\begin{itemize}
\item Es sind \rule[0ex]{2em}{.4pt}\, von 59 Punkten erreicht worden.
\end{itemize}
\end{graybox}
...
\item [\textbf{D} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Behandlungsbedingungen erklärt wird. Daher werden 24\% der Varianz erklärt.
...
Ein Versuch wurde an 57 Tieren durchgeführt, wobei jedes Tier eine von drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Die folgende Abbildung enthält die Daten aus diesem Versuch zur Bewertung der Wirkung von Vitamin E auf das Zahnwachstum bei Hasen.  Welche Aussage ist richtig, wenn Sie eine zweifaktorielle ANOVA rechnen?
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 10, 14, 9 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es berechnet sich 11.6 +/- 4.3
\item [\textbf{B} \msquare] Es ergibt sich 12.6 +/- 1.035
\item [\textbf{C} \msquare] Sie erhalten 11.6 +/- 2.07
\item [\textbf{D} \msquare] Sie erhalten 11.6 +/- 1.035
\item [\textbf{E} \msquare] Sie erhalten 11.6 +/- 1.44
\end{enumerate} 
...
Wie lautet der Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 19, 31, 25, 18, 10, 19 und 51.




\begin{enumerate}
\item [\textbf{A} \msquare] Sie erhalten 19 [18; 31]
\item [\textbf{B} \msquare] Es berechnet sich 20 [19; 30]
\item [\textbf{C} \msquare] Sie erhalten 19 +/- 31
\item [\textbf{D} \msquare] Es berechnet sich 25 [19; 32]
\item [\textbf{E} \msquare] Es ergibt sich 19 +/- 18
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die opimale Anzahl ist größer als zwanzig Beobachtungen, wobei es gerne sehr viel mehr sein können.
...
Der Mittelwert $\bar{y}$ und der Median $\tilde{y}$ unterscheiden sich nicht in Ihren Feldexperiment zu Leistungssteigerung von Erbsen.  Welche Aussage ist richtig?
...
In dem folgenden Histogramm von $n = 193$ Pflanzen ist welche Verteilung abgebildet?
...
In einer lineren Regression kann es vorkommen, dass der Effekt repräsentiert durch den $\beta$ Koeffizienten nicht so richtig von der Größenordnung zu dem p-Wert passen will. So liefert eine Untersuchung des Einflusses von der $NO_3$-Konzentration in [$\mu g$] im Wasser auf den absoluten Proteingehalt in [$kg$] an Wasserlinsen folgende Effekte und p-Werte: $0.00051$ als p-Wert und einen $\beta_{NO_3}$ Koeffizienten von $1.1\times 10^{-5}$. Welche Aussage ist richtig?
...
\item [\textbf{B} \msquare] Das Gewicht und die $NO_3$-Konzentration korrelieren sehr stark, deshalb wird der $\beta_{NO_3}$ Koeffizient sehr klein. Mit einer ANOVA kann für die Korrelation korrigiert werden und der Effektschätzer passt dann zum p-Wert.
...
Sie führen ein Experiment zur Behandlung von Klaueninfektionen bei Schafe durch. Bei 4 Tieren finden Sie eine Erkrankung der Klauen vor und 8 Tiere sind gesund. Welche Aussage über den Effektschätzer Odds ratio ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 2, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Das Verhältnis der Anteile Odds ratio ergibt ein Anteilsverhältnis von 0.33. Wir sind am Anteil der Kranken interessiert.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.5, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.5, da es sich um eine Chancenverhältnis handelt
  
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.33, da es sich um eine Chancenverhältnis handelt.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.02, 0.21 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.08, 0.84 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.36, 0.08, 0.84 und 3.56. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.08, 0.84 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.005, 0.0525 und 0.2225. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.005, 0.0525 und 0.2225. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate}
...
Ein Versuch wurde in 9 Parzellen pro Gruppe durchgeführt. Die folgende Abbildung enthält die Daten aus diesem Versuch zur Bewertung der Wirkung des Mikronährstoff Nitrat auf den Ertrag in t/ha von Papaya im Vergleich zu einer Kontrolle.  Welche Aussage ist richtig, wenn Sie einen t-Test rechnen?
...
\item [\textbf{E} \msquare] Die Barplots deuten auf ein signifikanten Unterschied. Der Effekt liegt vermutlich bei 5.
\end{enumerate}
...
Barplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Alex nicht gemerkt, welche statistischen Maßzahlen für einen Barplot erhoben werden müssen. Das ist in soweit doof, da nach seiner Betreuerin erstmal ein Barplot nachgebaut werden soll, bevor es mit seiner Hausarbeit losgeht. Dann hat er schonmal den \Rlogo Code vorliegen und nachher geht dann alles schneller. Die Behandlung für Maiss werden verschiedene Substrattypen ($torf$, $40p60n$ und $70p30n$) sein. Erfasst wird als Endpunkt ($Y$) \textit{Ertrag}. Alex soll dann \textit{yield} in seiner Exceldatei eintragen.
...
Yuki steht vor einem ersten Problem, denn wenn es nach seiner Betreuerin geht, soll er in einem einem Freilandversuch Lauch auswertet. Soweit eigentlich alles passend. Die Behandlung waren verschiedene Genotypen ($AA$, $AB$ und $BB$). In seiner Exceldatei hat er den Messwert ($Y$) \textit{Trockengewicht} als \textit{drymatter} aufgenommen. Nun soll Yuki die Daten eimal als Barplots in einer Präsentation visualisieren, damit seiner Betreuerin wieder klar wird, was er eigentlich nochmal gemacht hat und was für ein Ergbnis in einem statistischen Test zu erwarten wäre.
...
Tina steht vor einem ersten Problem, denn wenn es nach ihrem Betreuer geht, soll sie in einem einem Freilandversuch Kartoffeln auswertet. Soweit eigentlich alles passend. Die Behandlung werden verschiedene Düngestufen ($ctrl$, $low$ und $high$) sein. In ihrer Exceldatei wird sie den Endpunkt ($Y$) \textit{Proteingehalt} als \textit{protein} aufnehmen. Vorab soll Tina aber eimal die folgenden Boxplots ihrem Betreuer nachbauen, damit sie den \Rlogo Code schonmal für später vorliegen hat. Anhand von Boxplots lässt sich eine Aussage über die Normalverteilung von $Y$ treffen. Damit geht das Problem schon los.
...
In einem Gespräch mit ihrer Betreuerin wird Tina gebeten seine Daten aus einem Feldexperiment mit Lauch in einem Histogramm darzustellen. In ihrem Experiment hat er die seltsamen Verdickungen erst fotographiert und dann ausgezählt. Laut ihrer Betreuerin soll das Histogramm helfen, die Verteilung der die seltsamen Verdickungen zu bestimmen.

\begin{center}
Die seltsamen Verdickungen: 4, 7, 2, 6, 5, 5, 5, 4, 3, 2, 5, 5, 2, 5, 7, 4, 4, 5, 4, 6, 2, 6, 6, 6, 2, 7, 10, 3, 2, 5
\end{center}
...
In ihrer Projektbericht möchte Tina gerne die Daten aus einem Feldexperiment mit Lauch in einem Histogramm darstellen. Das Histogramm erlaubt ihr dabei Rückschlüsse auf die Verteilung über das Outcome ($Y$) zu treffen. In seinem Experiment hat Tina die mittleren Knötchen gezählt.

\begin{center}
Die mittleren Knötchen: 9.9, 9.7, 10.4, 7.7, 16.5, 7.6, 12.5, 9, 12.3, 9.3, 9.1, 10.5, 4.8, 7.9, 12.4, 7.1, 8.1, 8.2, 10.5, 10.3, 10.1, 9.3, 11.3, 11.1, 9.8
\end{center}
...
Wenn es nach Paula ginge, wäre sie schon längst fertig mit ihrer Abschlussarbeit. In ihrer Abschlussarbeit hatte sie einen Versuch in einer Klimakammer im Emsland durchgeführt. Nach der Meinung ihrem Betreuer sieht das jedoch etwas anders aus. Jetzt soll sie doch noch eine explorative Datenanalyse für den Zusammenhang zwischen durchschnittlicher Regenwurmdichte [Anzahl/l] und Proteingehalt [g/kg] in Lauch durchführen. Wie nervig! Da zwei kontinuierliche Variablen vorliegen, geht die explorative Datenanalyse leider nicht mit Boxplots oder Barplots.
...
'Uff!', denkt sich Alex. Jetzt hat er doch tatsächlich zwei kategoriale Variablen in seiner Abschlussarbeit gemessen. Zum einen die Behandlung Mechanische Bearbeitung [ja/nein] und zum anderen die Messung Frischegewicht über Zielwert [ja/nein] im Kontext von Lauch. Hierfür hat er ein Freilandversuch im Teuteburgerwald durchgeführt. Jetzt möchte Alex die Daten einmal in einer explorativen Datenanalyse darstellen. Danach kann er dann über den passenden statistischen Test nachdenken. Dabei unterstützt seine Betreuerin diesen Ansatz bevor es in der Datenanalyse weiter geht.
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  Richtige Entscheidung & H$_0$ beibehalten & Testentscheidung & 20\% \\
  \end{tabular}
  \end{center}
...
Mark ist im Emsland für einen Pilotexperiment mit sehr geringer Fallzahl $(n_1 = n_2 = 3)$ mit Lauch. Allein diese Tatsache ist für ihn eine Erzählung wert. Für seinen Projektbericht musste er ein Feldexperiment mit Lauch durchführen und das sollte laut seiner Betreuerin an diesem Ort besonders gut gelingen, da man hier gut neue technische Anlagen und Behandlungen fernab der Bevölkerung testen könne. Zeugen gibt es hier jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn seine Behandlung Bewässerungstypen ($low$ und $high$) und der Messwert Chlorophyllgehalt (SPAD-502Plus) [SPAD] sollen mit einem t-Test ausgewertet werden. Immerhin weiß er, dass sein Messwert einer Normalverteilung folgt. 
...
'Der t-Test testet einen normalverteilten Endpunkt ($Y$).', liest Jessica laut. Das hilft jetzt auch nur bedingt weiter. Laut ihrem Betreuer ist zwar ihr Messwert Trockengewicht [kg/ha] normalverteilt, aber wie rechnet sie jetzt einen t-Test? Für ihren Projektbericht musste sie ein Feldexperiment mit Lauch in der Uckermark durchführen. Als wäre das nicht schon anstrengend genug gewesen. Jetzt soll sie auch noch testen, ob die Behandlung Substrattypen ($torf$ und $70p30n$) ein signifikantes Ergebnis liefert.
...
'Der t-Test testet einen normalverteilten Endpunkt ($Y$).', liest Alex laut. Das hilft jetzt auch nur bedingt weiter. Laut seiner Betreuerin ist zwar ihm Messwert Frischegewicht [kg/ha] normalverteilt, aber wie rechnet er jetzt einen t-Test? Für seinen Projektbericht musste er einen Versuch in einer Klimakammer mit Lauch im Emsland durchführen. Als wäre das nicht schon anstrengend genug gewesen. Jetzt soll er auch noch testen, ob die Behandlung Bewässerungstypen ($low$ und $high$) ein signifikantes Ergebnis liefert.
...
Es gibt ja immer die Möglichkeit sich Hilfe zu holen. Das geht natürlich auch immer in einem Projektbericht. Deshalb arbeiten Alex und Paula gemeinsam an einem Projektbericht. Das macht dann auch die Analyse ihres Hauptversuches einfacher. Zwar hat jeder von ihnen noch ein Subthema, aber auch da kann man sich ja helfen. In dem Hauptversuch wurde Folgendes von den beiden gemacht. Alex und Paula haben sich Lauch angeschaut. Dabei geht um Zusammenhang zwischen Jäten ($Aussaat$ und $Ernte$) und Proteingehalt [g/kg]. Jetzt sollen beide einen gepaarten t-Test rechnen.
...
'Mit dem R Paket \texttt{\{emmeans\}} können wir gleich die Gruppenvergleiche rechnen und uns das \textit{compact letter displac}' ausgeben lassen!', verkündet Nilufar sichtlich stolz. 'Nach Meinung der Betreuerin soll es aber nur erstmal ein t-Test sein. Und die Ausgabe ist schon wirr genug.', merkt Mark an. Mark und Alex sind bei Nilufar um sich in \Rlogo helfen zu lassen. Die beiden waren 1 Monate im Wendland um einen Versuch mit Lauch in einem Feldexperiment durchzuführen. Ziel war es das Outcome ($Y$) Trockengewicht [kg/ha] zu bestimmen.
...
## t = 0.73395, df = 20, p-value = 0.4715
...
## t = -5.1241, df = 19, p-value = 6.03e-05
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -23.603342  -9.913021
## sample estimates:
...
Helfen Sie Yuki bei der Interpretation des t-Tests! Sonst geht es auch für Tina und Alex nicht weiter.
...
## 	Two Sample t-test
## 
## data:  Frischegewicht by Genotypen
## t = 0.16497, df = 17, p-value = 0.8709
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -10.91128  12.76239
## sample estimates:
...
Mark und Tina haben sich dazu entschieden zusammenzuarbeiten. Das sollte alles etwas einfacher machen. Jeder hat zwar ein getrenntes Themenfeld aber den Hauptversuch machen beide gemeinsam. Das hat sich schonmal als gut Idee soweit herausgestellt. In einem Projektbericht sollen beide herausfinden, ob es einen Zusammenhang zwischen Düngung ($vorher$ und $nachher$) und Trockengewicht [kg/ha] gibt. Die Besonderheit ist hierbei, dass die Messungen an der gleichen Beobachtung stattfinden. Beide messen also zweimal an den gleichen Lauch. Hier muss dann wohl auf einen normalverteilten Messwert ($Y$) ein gepaarter t-Test gerechnet werden. Leider kennen sich beide nicht sehr gut in \Rlogo aus.
...
Mark und Alex schauen sich etwas entnervt an. Gemeinsam schreiben die beiden ihre Abschlussarbeit und sollen nun als erstes einmal die Daten mit eine einfaktoriellen ANOVA auswerten damit abgeschätzt werden kann, ob überhaupt signifikante Ergebnisse in den multipen Gruppenvergleichen zu erwarten sind. Die beiden waren im Teuteburgerwald um ein Freilandversuch mit Lauch durchzuführen. Dabei haben Mark und Alex den Messwert Proteingehalt [g/kg] unter der Behandung Lüftungssystemen und Folientunneln ($ctrl$, $storm$, $thunder$ und $tornado$) ermittelt.
...
\toprule
    ...
    \midrule
   \textbf{Lüftungssystemen}  & 3 &  &  &  &  \strut\\
   \textbf{error}  & 21 & 1029.16 &  &  &  \strut\\
   \textbf{Total}  & 24 & 4946.96 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
Steffen und Mark schauen sich etwas entnervt an. Gemeinsam schreiben die beiden ihre Abschlussarbeit und sollen nun als erstes einmal die Daten mit eine einfaktoriellen ANOVA auswerten damit abgeschätzt werden kann, ob überhaupt signifikante Ergebnisse in den multipen Gruppenvergleichen zu erwarten sind. Nun möchte erstmal ihre Betreuung der Arbeit eine ANOVA Tabelle sehen. Was immer da auch drin zu erkennen sein mag. Steffen schaut Mark sehen erstmla gar nichts. Die beiden waren im Teuteburgerwald um einen Versuch in einer Klimakammer mit Lauch durchzuführen. Dabei haben Steffen und Mark den Messwert Frischegewicht [kg/ha] unter der Behandung Düngestufen ($ctrl$, $low$, $mid$ und $high$) ermittelt.
...
\toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Düngestufen}  & 3 & 81.13 &  &  &  \strut\\
   \textbf{Error}  & 26 & 251.17 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
Steffen schaut entnervt auf und klappt den Laptop zu. Nun möchte seine Betreuerin seiner Hausarbeit erstmal eine ANOVA sehen und \textit{dann} die Ergebnisse präsentiert bekommen bevor es überhaupt mit der Abschlussarbeit weitergeht. Dabei war er extra im Teuteburgerwald um ein Freilandversuch mit Lauch durchzuführen. Und dort was es wirklich nicht schön geschweige denn spannend wie bei seinen Kommilitonen, die in Almería waren. Hätte er es vorher gewusst, dann hätte er die Abschlussarbeit bei wem anders geschrieben. Aber gut, jetzt als die ANOVA in \Rlogo.
...
## Lichtstufen  3 853.24 284.413  17.117 1.991e-06
## Residuals   27 448.63  16.616
\end{verbatim}
\end{kframe}
\end{knitrout}
...
In ein Gewächshausexperiment wurden Lauch mit dem Behandlung Genotypen ($AA$, $AB$ und $BB$) sowie der Behandlung Lüftungssystemen und Folientunneln ($ctrl$, und $tornado$) untersucht. Es wurde als Messwert Proteingehalt [g/kg] bestimmt. Alex ahnte schon, dass es komplexer wird, als er mit seiner Hausarbeit angefangen hat. Das es jetzt aber so kompliziert wird, hätte er jetzt aber auch nicht gedacht. Alex kratzt sich am Kopf. Eventuell muss er dann doch nochmal Hilfe in der statistischen Beratung holen. Jetzt versucht er es aber erstmal selber.
...
\begin{center}
  ...
  \toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Genotypen}  & 3 & 99.56 &  &  &  \strut\\
    \textbf{Lüftungssystemen}  & 1 & 228.07 &  &  &  \strut\\
    \textbf{Genotypen:Lüftungssystemen}  & 3 & 368.31 &  &  &  \strut\\
   \textbf{Error}  & 18 & 217.14 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
Es ist schon kurz nach fünf und Jonas wird langsam nervös. Jonas wollte heute Abend noch seine E-Sport Qualifikation schauen. Stattdessen versucht seine Betreuerin die Ausgabe der zweifaktoriellen ANOVA zu visualieren und zu überprüfen, ob es mit der Visualisierung der Daten als Boxplots zusammenpasst. Jonas hatte im Teuteburgerwald ein Feldexperiment mit Lauch durchgeführt. Es gab dabei zwei Behandlungen. Einmal Bewässerungstypen ($ctrl$, $low$, $mid$ und $high$) sowie als zweite Behandlung Düngestufen ($ctrl$, und $high$). Gemessen wurde der Messwert ($Y$) Chlorophyllgehalt (SPAD-502Plus) [SPAD]. So kompliziert kann das jetzt doch nicht sein!
...
##                               Df Sum Sq Mean Sq F value    Pr(>F)
## Bewässerungstypen              2 154.55  77.274  5.2838 0.0156522
## Düngestufen                    1   6.81   6.810  0.4657 0.5036660
## Bewässerungstypen:Düngestufen  2 360.86 180.430 12.3374 0.0004226
## Residuals                     18 263.24  14.625
\end{verbatim}
\end{kframe}
\end{knitrout}
...
'Moment, die haben ja das Gleiche gemacht wie wir!', ruft Yuki laut aus. Jessica schaut etwas verwundert. 'Das glaube ich eher nicht. Lass uns mal unsere Daten mit den Ergebnissen von Meyer et al. (2021) vergleichen.', antwortet Jessica. In einen Versuch in einer Klimakammer mit Lauch wurde die Behandlung Genotypen ($00$, $AA$, $AB$ und $BB$) auf den Messwert Trockengewicht [kg/ha] untersucht. Jetzt müssen die beiden mal schauen, ob sie wirklich was Neues gefunden haben oder ob die Ergebnisse alle die gleichen sind wie schon bei Meyer et al. (2021). Es ergab sich dann die folgende Tabelle der rohen p-Werte für die Vergleiche zu Meyer et al. (2021).
...
Leider kennen sich Yuki und Jessica mit der Adjustierung von $p$-Werten und dem Signifikanzniveau $\alpha$ überhaupt nicht aus. Deshalb brauchen die beiden bei der Erstellung Ihre Hilfe!
...
Tina hatte in ihrer Abschlussarbeit ein Freilandversuch durchgeführt. Soweit so gut. Dabei hat sie sich mit Lauch beschäftigt. Angeblich der neueste heiße Kram... aber das ist wiederum was anderes. So richtig mitgenommen hat Tina das Thema dann doch nicht. Hat sie sich doch mit Lichtstufen ($none$, $200lm$, $400lm$, $600lm$, $700lm$ und $800lm$) und Trockengewicht [kg/ha] schon eine Menge an Daten angeschaut. Nach ihrem Betreuer soll sie nun ein CLD bestimmen. Weder weiß sie was ein CLD ist, noch war ihr erster Gedanke mit Köln und die LGBTQ Community richtig...
...
Mark betrachtet in sich gekehrt die Poster vor dem Büro von sein Betreuer. Viele der explorativen Abbildungen sagen ihm etwas. Die Barplots und die Boxplots könnte er dann schon nachbauen. Das macht ihn dann zuversichtlich die Abschlussarbeit auch hinzukriegen. Etwas komischer sind die seltsamen Buchstaben über den Barplots. Mark betrachtet ein Poster das sich mit Lauch beschäftigt. Lichtstufen ($none$, $200lm$, $400lm$ und $800lm$) und Proteingehalt [g/kg] wurden dort bestimmt. So richtig schlau, wird er daraus nicht. Als erstes müsse müsse man die Gruppen nach absteigender Effektstärke sortieren, liest Mark im Methodenteil und ist dann noch verwirrter als vorher schon.
...
\item Interpretieren Sie das \textit{Compact letter display (CLD)} für Mark und Jessica! \textbf{(1 Punkt)} 
\end{enumerate}
...
\midrule
\textbf{none} & 1.0000000 & 0.4746427 & 0.8737357 & 0.0003885\\
\textbf{200lm} & 0.4746427 & 1.0000000 & 0.5839060 & 0.0002263\\
\textbf{400lm} & 0.8737357 & 0.5839060 & 1.0000000 & 0.0004088\\
\textbf{800lm} & 0.0003885 & 0.0002263 & 0.0004088 & 1.0000000\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
\item Interpretieren Sie das \textit{Compact letter display (CLD)} für Yuki und Jessica! \textbf{(2 Punkte)} 
\end{enumerate}
...
Yuki hat sich ein Herz gefasst und war für seiner Abschlussarbeit in die Niederlande gegangen. Das war eine super Zeit in der er viel gelernt hat. Klar gab es auch die ein oder andere Besonderheit, aber das gehört hier eher nicht hin. Yuki ist schon eine ganze Zeit im Büro, da sein Betreuer möchte, dass er jetzt auf seinen Daten mit $n = 134$ Beobachtungen von Lauch einen $\mathcal{X}^2$-Test rechnet. Das ginge, da er als Behandlung \textit{Mechanische Bearbeitung [ja/nein]} bestimmt und zum anderen die Variable \textit{Proteingehalt im Zielbereich [ja/nein]} ermittelt hat. Wie genau, das ist jetzt eine andere Frage.
...
Am Ende hätte Steffen dann doch einen normalverteilten Endpunkt in seiner Hausarbeit nehmen sollen. Vor ihm liegen jetzt die Daten von zwei Variablen als Kategorien oder wie es in \Rlogo so schön heißt, als Faktoren. Aber immerhin, hofft er das was bei den Daten rausgekommen ist. Gezählt hat Steffen einiges mit $n = 151$ Beobachtungen von Lauch. Zum einen hat er als Behandlung \textit{Mechanische Bearbeitung [ja/nein]} bestimmt und zum anderen die Variable \textit{Proteingehalt im Zielbereich [ja/nein]} ermittelt. Nun möchte sein Betreuer gerne einen $\mathcal{X}^2$-Test auf einer $2x2$-Kreuztabelle berechnet bekommen.
...
'Der $\mathcal{X}^2$-Test auf einer $2x2$-Kreuztabelle berechnet.', liest Paula in ihrer Mitschrift. So richtig helfen tut ihr das jetzt eherlichweise dann doch nicht. Paula hatte sich in einen Versuch in einer Klimakammer $n = 151$ Beobachtungen von Lauch angeschaut. Dabei hat er als Behandlung \textit{Herbizideinsatz [ja/nein]} bestimmt und zum anderen die Variable \textit{Trockengewicht über Zielwert [ja/nein]} ermittelt. Am Ende möchte dann ihr Betreuer gerne einen $\mathcal{X}^2$-Test auf einer $2x2$-Kreuztabelle berechnet bekommen. Nach ihrem Experiment erhielt sie folgende $2x2$ Kreuztabelle aus ihren erhobenen Daten.
...
'Ich glaube du bringst da was durcheinander. Wir nutzen zwar auch für die ANOVA die Funktion \texttt{lm()} aber hier wollen wir, glaube ich, eine Gerade durch die Punkte zeichnen.', merkt Alex an. 'Ich sehe keine Punkte...', antwortet Steffen sichtlich übernächtigt. 'Wir müssen die Daten ja auch erst visualisieren!', spricht Alex sehr deutlich und langsam. Die beiden hatten ein Gewächshausexperiment in der Uckermark mit Lauch durchgeführt. Dabei wurden die beiden folgenden Variablen gemessen: durchschnittlicher Regenwurmdichte [Anzahl/l] und Trockengewicht [kg/ha]. Jetzt wollen sie erstmal schauen, ob es einen Zusammenhang gibt.
...
Leider kennen sich Alex und Steffen mit der linearen Regression für kontinuierliche Daten überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe!
...
'Wichtig ist es, dass wir jetzt eine Gerade durch die Punkte zeichnen!', ruft Jessica. 'Ich sehe nur zwei Zeilen und keine Punkte. Wie soll ich da denn jetzt eine Gerade durchzeichnen?', fragt Alex. Jessica atmet schwer ein und starrt auf die \Rlogo Ausgabe der Funktion \texttt{lm()}. Die beiden hatten ein Gewächshausexperiment im Oldenburger Land mit Lauch durchgeführt. Dabei wurden die beiden folgenden Variablen gemessen: durchschnittliche Regenwurmdichte [Anzahl/l] und Proteingehalt [g/kg]. Jetzt will die Betreuung von den beiden einmal die Visualisierung der Daten und auch gleich noch die lineare Regression gerechnet bekommen. Das haben beide in \Rlogo gemacht, aber wie soll das jetzt gehen?
...
\midrule
(Intercept) & 11.44 & 3.96 &  & \\
Durchschnittliche Regenwurmdichte & 1.11 & 0.39 &  & \\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
## 
## Call:
## Frischegewicht ~ Durchschnittlicher_Niederschlag
## 
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -3.2221 -1.0402 -0.0752  1.0117  2.4838 
## 
## Coefficients:
##                                 Estimate Std. Error t value Pr(>|t|)
## (Intercept)                       1.2187     1.7776   0.686    0.497
## Durchschnittlicher_Niederschlag   2.0856     0.1758  11.863 1.64e-14
## 
## Residual standard error: 1.523 on 39 degrees of freedom
## Multiple R-squared:  0.783,	Adjusted R-squared:  0.7774 
## F-statistic: 140.7 on 1 and 39 DF,  p-value: 1.638e-14
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erklären Sie \textit{kurz} den Begriff \texttt{R-squared}! Was sagt Ihnen der Wert $0.78$ aus? \textbf{(2 Punkte)}
\end{enumerate}
...
'Hä? Was ist denn das? Das wird ja immer wilder! Hatten wir als Aufgabe eine Korrelation zu berechnen? Wir bauen aus kontinuierlichen Daten eine Abbildung und interpretieren diese dann?', fragt sich Jessica laut. 'Keine Ahnung... das ist jetzt jedenfalls keine Abbildung von irgendwas sondern eine \Rlogo Ausgabe mit ganz wilden Bezeichnungen...', denkt sie. Jessica hatte ein Gewächshausexperiment im Wendland mit Lauch durchgeführt. Dabei wurden die beiden folgenden Variablen gemessen: durchschnittliche UV-Einstrahlung [UV/d] und Proteingehalt [g/kg]. Jetzt hat sie eigentlich alles zusammen. \textit{Eigentlich...}, denn mit der \Rlogo Ausgabe hat Jessica jetzt ein Problem.
...
## 
## data:  Durchschnittliche UV-Einstrahlung [UV/d] and Proteingehalt [g/kg]
## t = 1.1148, df = 8, p-value = 0.2973
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, S und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
Tina und Yuki sind bei Jonas um sich Hilfe in \Rlogo zu holen. Dabei ging es um den Zusammenhang zwischen der Behandlung Genotypen ($AA$, $AB$ und $BB$) und dem Messwert Chlorophyllgehalt (SPAD-502Plus) [SPAD]. Der Versuch wurde in ein Feldexperiment im Teuteburgerwald durchgeführt. Nach seine Betreuerin ist der Messwert Chlorophyllgehalt (SPAD-502Plus) [SPAD] normalverteilt.

Nach einem erfolgreichen Pilotversuch zur Wirksamkeit von Belüftungen bei Lauch in ein Feldexperiment wollen Sie nun den Versuch eine Nummer größer anlegen. Dafür entscheiden Sie sich für ein faktorielles Versuchsdesign. In Ihrem Hauptversuch stellt die Wirksamkeit von Belüftungen den ersten Faktor mit insgesamt 3 Leveln dar. Der zweite Faktor mit dem Trockenstress beinhaltet 3 Level. \\
...
Leider kennen sich Jonas mit dem \textit{experimentelles Design} überhaupt nicht aus. Deshalb braucht er bei der Erstellung Ihre Hilfe!
...
Paula muss ihrem Projektbericht mit \Rlogo arbeiten. Deshalb sitzt sie jetzt mit Ihnen zusammen und hat einige Fragen zu den Grundlagen in \Rlogo an Sie! Na dann wollen Sie mal helfen. Immerhin will ihre Betreuerin, dass \Rlogo genutzt wird.\\[1Ex]
...
Paula: \textit{Was ist der Unterschied zwischen dem RStudio und R?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]
...
'Unter den Blinden ist der Einäuge König!', ruft Ihnen Mark entgegen. Das können Sie schon nicht mehr hören. Nur weil Sie einmal gesagt haben, dass Sie sich schonmal mit \Rlogo beschäftigt haben, stehen hier alle Schlange. Aber gut, das hat Sie dann doch vorangebracht. Leider kennt sich Mark auch wieder überhaupt nicht mit \Rlogo aus aber seine Betreuerin möchte gerne, dass die Auswertung in \Rlogo gemacht wird. Da müssen Sie dann wohl mal nochmal ran und helfen.\\[1Ex]

Mark fragt: \textit{Man kann doch die Funktion \texttt{emmeans()} von Varianzhomogenität auf Varianzheterogenität umstellen. Wie ging das noch gleich? \textbf{(1 Punkt)}}\\[1ex]
Sie antworten:\\[2Ex]

Mark fragt: \textit{Wozu war nochmal die Funktion \texttt{mutate()} gut?  \textbf{(1 Punkt)}}\\[1ex]
Sie antworten:\\[2Ex]

Mark fragt: \textit{Wenn ich die Spalten in Excel benenne, was muss ich da beachten? \textbf{(1 Punkt)}}\\[1ex]
Sie antworten:\\[2Ex]

Mark fragt: \textit{Ich will das R-Paket \texttt{\{ggplot\}} nutzen, da war so eine Analogie an die ich mich nicht erinnern kann. Was war noch gleich das Prinzip von \texttt{\{ggplot\}}? Wie funktioniert \texttt{\{ggplot\}} konzeptionell? \textbf{(2 Punkte)}}\\[1ex]
Sie antworten:\\[2Ex]

Mark fragt: \textit{Wenn ich Daten in R mit Gruppen eingelesen habe, welche Funktion nutze ich dann meistens als erstes und warum muss ich das machen? Was muss ich da machen? \textbf{(2 Punkte)}}\\[1ex]
Sie antworten:\\[2Ex]
...
Paula hält die wissenschaftliche Veröffentlichung \textit{Selle, P. H., et al. (2010). Implications of sorghum in broiler chicken nutrition} unter einem Schnaufen in die Luft. 'Worum geht es denn eigentlich in dieser Arbeit?', fragt sie stirnrunzelnd. 
...
Leider kennt sich Paula mit dem Lesen einer wissenschaftlichen Veröffentlichung mit Fokus auf die Statistik überhaupt nicht aus. Deshalb braucht sie bei der Erstellung Ihre Hilfe!
...
Leider kennt sich Steffen mit dem Lesen einer wissenschaftlichen Veröffentlichung mit Fokus auf die Statistik überhaupt nicht aus. Deshalb braucht er bei der Erstellung Ihre Hilfe!
...
$75$cm sowie eine L{\"a}nge von  $240$cm.
...
\begin{enumerate}
\item Wenn 4 Blaubeerschalen 7.16 Euro kosten,  wie viel kosten 5 Schalen? \textbf{(2 Punkte)}
\item Wenn Sie die 5 Blaubeerschalen gekauft haben, wie viele Aligatorbirnen zu je 0.99 EUR können Sie sich dann noch für 100 EUR leisten? \textbf{(1 Punkt)}
\end{enumerate}
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2024 blieben die Erträge von Blaubeeren mit \ensuremath{9\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge steigerte sich um 8.6\%. Die Exporte für Avocados fielen in dem gleichen Zeitraum um 22.1\% auf \ensuremath{2.1\times 10^{5}}t.
...
\item $i$ dem Verhalten: (1) standing, (2) dustbathing, (3)
  foraging incl. scratching und (4) preening.
\end{itemize}
...
\midrule
standing & 32cm; 28cm; 8.9\% & 31cm; 21cm; 3.5\% & 38cm; 27cm; 3.5\%\\
dustbathing & 39cm; 24cm; 0.4\% & 36cm; 21cm; 0.8\% & 38cm; 31cm; 0.2\%\\
foraging incl. scratching & 38cm; 18cm; 1.2\% & 27cm; 20cm; 8.1\% & 22cm; 23cm; 7.6\%\\
preening & 28cm; 24cm; 3.6\% & 35cm; 27cm; 3.6\% & 36cm; 23cm; 6.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\item Stellen Sie den Zusammenhang zwischen dem sich verringernden Radius
  ...
  \textbf{(2 Punkte)}
 \item Ein Auto und eine Klorolle st{\"u}rzen aus gro{\ss}er und gleicher H{\"o}he
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCPXYUI & 1.0 | 5.0 | Klein \\
    B & GCTXFLV & 4.0 | 3.0 | Normal \\ 
    C & GC57UIQ & 3.0 | 4.0 | Klein \\ 
    D & GCXJZ1C & 3.5 | 3.5 | Normal \\ 
    E & GCFN5WE & 5.0 | 2.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 301 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{9\times 10^{8}} \cdot 1.9^{-0.3 \cdot t + 2.4}
\end{equation*}
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  5-mal-gefaltete, 0.6mm, 50-cm-Karton} durch
