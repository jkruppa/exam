...
\begin{graybox}{Ergebnis der Klausur}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 47 Punkten sind aus dem Rechen- und
    Textteil erreicht. 
  \item[] \rule[0ex]{3em}{.4pt}\, von 67 Punkten in Summe.
...
\end{center}
\begin{itemize}
\item Es sind \rule[0ex]{2em}{.4pt}\, von 47 Punkten erreicht worden.
\end{itemize}
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.03, 0.001 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.0075, 3e-04 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3.56, 0.12, 0.004 und 1.68. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.0075, 3e-04 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.004 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.004 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 15, 14, 6 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12 +/- 1.77
\item [\textbf{B} \msquare] Es ergibt sich 13 +/- 1.77
\item [\textbf{C} \msquare] Es ergibt sich 12 +/- 12.5
\item [\textbf{D} \msquare] Es ergibt sich 11 +/- 6.25
\item [\textbf{E} \msquare] Es ergibt sich 12 +/- 3.54
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 23, 35, 25, 18, 11, 15, 30, 16, 18, 22 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 [17, 31]
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 16
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 16
\item [\textbf{D} \msquare] Es ergibt sich 22 +/- 30
\item [\textbf{E} \msquare] Es ergibt sich 22 [16, 30]
\end{enumerate} 
...
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.2, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.25, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.2, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
$y = \{20, 20, 19, 9, 14, 24, 21\}$. Berechnen Sie folgende
...
\begin{center}
$8.2, 13.4, 9.2, 8.9, 8.3, 5.5, 8.2, 7.8, 11.6, 8.3, 8.2, 11.1$
\end{center}
...
## t = -0.69491, df = 12, p-value = 0.5003
...
## 
## data:  waterintake by infusion
## t = -0.25856, df = 14, p-value = 0.7997
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.901742  4.631901
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 97.56 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 41.11 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  6.8889  3.4444  3.2069 0.0583
## Residuals 24 25.7778  1.0741
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 104 116 115  87  91  98 148 145 151 151 151 174
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 37.16 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 106.44 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 33.5 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 259.76 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 347.97 173.985  8.8345 0.002122
## form       1  34.94  34.935  1.7739 0.199518
## dose:form  2 160.56  80.281  4.0765 0.034655
## Residuals 18 354.49  19.694
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.2857 -2.8500  0.0571  2.7286  5.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   14.600      1.712   8.526 6.71e-06
## trtB          11.686      2.242   5.212 0.000395
## 
## Residual standard error: 3.829 on 10 degrees of freedom
## Multiple R-squared:  0.7309,	Adjusted R-squared:  0.704 
## F-statistic: 27.16 on 1 and 10 DF,  p-value: 0.0003945
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -6.2995, df = 8, p-value = 0.0002329
...
Einflussvariablen ($x$) wurden erhoben: variety, height und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.70 & 0 & 10.92 & 97.55 & 67.99 & 4\\
8.76 & 1 & 9.26 & 98.66 & 71.53 & 8\\
10.11 & 0 & 9.94 & 96.30 & 71.61 & 8\\
12.86 & 0 & 12.30 & 106.43 & 72.37 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.6183 -2.0721  0.0013  2.2481  8.2382 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 74.63312    2.41410  30.915   <2e-16
## nematodes    0.01385    0.10262   0.135   0.8929
## light        0.79273    0.74800   1.060   0.2915
## P           -0.54200    0.21323  -2.542   0.0124
## 
## Residual standard error: 3.367 on 114 degrees of freedom
## Multiple R-squared:  0.06667,	Adjusted R-squared:  0.04211 
## F-statistic: 2.715 on 3 and 114 DF,  p-value: 0.04813
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & maxdepth & temp & do2\\
\midrule
DORSEY\_RUN & 8 & 0.44 & 160 & 22.6 & 6.8\\
HOLLANDS\_BR & 38 & 2.34 & 85 & 12.0 & 10.5\\
SOUTH\_FORK\_LINGANORE\_CR & 20 & 2.62 & 96 & 15.4 & 10.0\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.058  -3.844  -1.690   1.657  13.961  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -1.438079   1.684196  -0.854  0.39733
## no3          0.220030   0.075826   2.902  0.00555
## maxdepth     0.012799   0.003995   3.203  0.00239
## temp         0.086150   0.042871   2.010  0.05001
## do2          0.195845   0.124039   1.579  0.12079
## 
## (Dispersion parameter for quasipoisson family taken to be 33.36871)
## 
##     Null deviance: 2070.2  on 53  degrees of freedom
## Residual deviance: 1312.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.64      1.26    0.207
## 2 water           0.156    -0.917   0.359
## 3 nematodes       0.149    -1.40    0.161
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.37053 -0.57809 -0.09614  0.48923  3.08233 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  203.4   14.26   
##  subject  (Intercept) 3952.5   62.87   
##  Residual              701.9   26.49   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.235     26.543   7.619
## attitudepop  -20.481      5.821  -3.519
## 
...
\begin{verbatim}
##           ctrl     high       low       mid
## ctrl 1.0000000 1.00e-07 0.0090141 0.0443720
## high 0.0000001 1.00e+00 0.0000000 0.0000458
## low  0.0090141 0.00e+00 1.0000000 0.0000287
## mid  0.0443720 4.58e-05 0.0000287 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 4, 3, 15, 12 und 12!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 11, 11, 10, 4 und 11! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, grade und P an vier verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCJD7JZ & 2.0 | 2.5 | Mikro \\
    B & GCI0RYP & 1.0 | 1.5 | Normal \\ 
    C & GC0BHG2 & 5.0 | 4.5 | Normal \\ 
    D & GCK4I2C & 4.0 | 4.0 | Normal \\ 
    E & GCRFD26 & 2.5 | 3.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 187 n. Chr. f{\"u}r den neuen Lehnsherren
...
Disease Virus (RHDV) kosten 9\$ und der durchf{\"u}hrende Arzt
verlangt ca. 35\$.
...
Sie haben den Vektor $A = \{11, 11, 16\}$ und den Vektor $B = \{1, -1, 3\}$ gegeben.
