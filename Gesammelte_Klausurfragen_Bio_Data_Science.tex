...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.03, 0.89, 0.42 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.15, 4.45, 2.1 und 1.7. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.006, 0.178, 0.084 und 0.068. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.15, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.15, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.006, 0.178, 0.084 und 0.068. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 14, 8, 8 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.4 +/- 1.565
\item [\textbf{B} \msquare] Es ergibt sich 8.4 +/- 4.9
\item [\textbf{C} \msquare] Es ergibt sich 9.4 +/- 9.8
\item [\textbf{D} \msquare] Es ergibt sich 10.4 +/- 1.565
\item [\textbf{E} \msquare] Es ergibt sich 9.4 +/- 3.13
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 26, 26, 28, 11, 22, 25 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 [22, 28]
\item [\textbf{B} \msquare] Es ergibt sich 26 [22, 28]
\item [\textbf{C} \msquare] Es ergibt sich 26 +/- 28
\item [\textbf{D} \msquare] Es ergibt sich 26 +/- 22
\item [\textbf{E} \msquare] Es ergibt sich 26 +/- 22
\end{enumerate}
...
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.14 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.14 liegt keine Overdispersion vor.
...
\midrule
(Intercept) & 38.61 & 0.24\\
light\_binhigh & 3.35 & 0.35\\
\bottomrule
\end{tabular}
\end{table}
...
\item [\textbf{B} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 3.35
\item [\textbf{C} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 11.19
\item [\textbf{D} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 11.19
...
\item [\textbf{B} \msquare] Wir machen Aussagen über den Nicht-Zustand/Keinen Effekt!
...
$y = \{11, 14, 18, 18, 12, 17, 13, 15, 15, 13, 15\}$. Berechnen Sie folgende
...
\begin{center}
$12.2, 8.5, 9, 10.5, 12.6, 9.6, 8.2, 12, 10.4, 8.4, 8.5, 10.8$
\end{center}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 127 121 116  83  87  87 145 132 136 138 147 167
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{group}  & 2 & 3.98 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.48 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  4.8004 2.40020  6.3303 0.005566 **
## Residuals 27 10.2374 0.37916                    
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{supp}  & 1 & 209.46 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2421.46 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 111.78 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 711.36 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 81 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: len
##           Df  Sum Sq Mean Sq  F value    Pr(>F)    
## supp       1  153.54  153.54  13.8147 0.0003864 ***
## dose       2 2940.04 1470.02 132.2655 < 2.2e-16 ***
## supp:dose  2   88.76   44.38   3.9929 0.0224981 *  
## Residuals 75  833.56   11.11                       
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
## -4.4286 -1.3929 -0.2857  1.3571  5.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   17.429      1.150  15.152 3.46e-09 ***
## trtB          -4.143      1.627  -2.547   0.0256 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.043 on 12 degrees of freedom
## Multiple R-squared:  0.3509,	Adjusted R-squared:  0.2968 
## F-statistic: 6.486 on 1 and 12 DF,  p-value: 0.02562
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, weight und N. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & temp & no3 & acerage & so4\\
\midrule
BLUE\_LICK\_RUN & 1 & 14.3 & 1.20 & 2217 & 10.85\\
CARROLL\_BR & 23 & 18.4 & 2.77 & 3896 & 12.79\\
BUFFALO\_RUN & 16 & 16.8 & 0.61 & 12620 & 18.87\\
SAVAGE\_R & 106 & 21.4 & 0.63 & 29708 & 12.28\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -8.2955  -3.5007  -0.9931   1.6975  21.4364  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -4.087e-02  1.213e+00  -0.034 0.973250    
## temp         1.187e-01  5.035e-02   2.357 0.022476 *  
## no3          3.204e-01  8.410e-02   3.810 0.000388 ***
## acerage      6.587e-05  1.613e-05   4.084 0.000163 ***
## so4         -9.289e-03  2.589e-02  -0.359 0.721268    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 38.47806)
## 
##     Null deviance: 2364.7  on 53  degrees of freedom
## Residual deviance: 1413.0  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     2.09      2.86  0.00417
## 2 water           0.202    -2.77  0.00562
## 3 nematodes       0.164    -0.977 0.329
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
9.43 & 0 & 10.07 & 99.46 & 74.65 & 9\\
10.86 & 0 & 9.80 & 105.90 & 74.06 & 9\\
9.22 & 1 & 11.20 & 97.84 & 66.61 & 13\\
8.69 & 0 & 11.82 & 101.31 & 68.05 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.1477 -1.6202 -0.2172  1.2950  5.1802 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  5.95040    6.67068   0.892    0.375    
## water       -0.21165    0.15792  -1.340    0.183    
## light        0.73136    0.55542   1.317    0.191    
## Fe           0.66105    0.06721   9.836 3.35e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.283 on 96 degrees of freedom
## Multiple R-squared:  0.5023,	Adjusted R-squared:  0.4867 
## F-statistic: 32.29 on 3 and 96 DF,  p-value: 1.613e-14
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 801.3
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9640 -0.5299 -0.1025  0.4892  3.5029 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  229.5   15.15   
##  subject  (Intercept) 3830.9   61.89   
##  Residual              721.2   26.86   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.768     26.238   7.690
## attitudepop  -17.588      5.901  -2.981
## 
...
\begin{verbatim}
##         A       B         C         D
## A 1.0e+00 0.00039 0.0000230 0.0000006
## B 3.9e-04 1.00000 0.0000000 0.0000000
## C 2.3e-05 0.00000 1.0000000 0.2137518
## D 6.0e-07 0.00000 0.2137518 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
