...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.01, 0.001 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.0025, 3e-04 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.0025, 3e-04 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 0.04, 0.004 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 0.04, 0.004 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 0.04, 0.004 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
\item [\textbf{E} \msquare] Der Korrelationskoeffizienten nach Spearman wird genutzt, wenn der Korrelationskoeffizienten zwischen -1 und 1 liegt. Dann sind die Residuen normalverteilt.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 4, 9, 11, 11 und 15.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9 +/- 8
\item [\textbf{B} \msquare] Es ergibt sich 10 +/- 2
\item [\textbf{C} \msquare] Es ergibt sich 10 +/- 16
\item [\textbf{D} \msquare] Es ergibt sich 11 +/- 2
\item [\textbf{E} \msquare] Es ergibt sich 10 +/- 4
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 17, 31, 31, 23, 21, 10 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 28 [17, 31]
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 17
\item [\textbf{C} \msquare] Es ergibt sich 23 +/- 31
\item [\textbf{D} \msquare] Es ergibt sich 28 +/- 17
\item [\textbf{E} \msquare] Es ergibt sich 23 [17, 31]
\end{enumerate}
...
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.87 liegt keine Overdispersion vor.
...
\item [\textbf{B} \msquare] Y beinhaltet mehrere Spalten. Die Spalten enthalten die Behandlung und weitere potenzielle Einflussvariablen
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.3, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.43, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 2.33, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.43, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.3, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
In einem Stallexperiment mit $n = 107$ Ferkeln wurden verschiedene
...
\midrule
(Intercept) & 38.23 & 0.26\\
light\_binhigh & 3.27 & 0.36\\
\bottomrule
\end{tabular}
\end{table}
...
\item [\textbf{B} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 10.69
...
\item [\textbf{D} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 3.27
\item [\textbf{E} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 10.69
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 550
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 548
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 275
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 274
...
$y = \{17, 17, 14, 12, 18, 13, 10\}$. Berechnen Sie folgende
...
\begin{center}
$10.5, 11.3, 6.2, 9.5, 8.6, 12.5, 9.7, 9.8, 11.2, 9.3, 8.4, 5.8$
\end{center}
...
## t = -2.5191, df = 10, p-value = 0.03044
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.645733 -0.468553
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 103.75 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 50.86 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 197.576  98.788  44.368 1.903e-08
## Residuals 22  48.984   2.227
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 129 127 132 106  99  90 153 123 136 150 157 132
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 19.19 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 214.82 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 150.51 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 30 & 683.36 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value  Pr(>F)
## dose       2 147.828  73.914  4.7218 0.02246
## form       1  14.198  14.198  0.9070 0.35353
## dose:form  2 240.085 120.043  7.6685 0.00390
## Residuals 18 281.770  15.654
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.222 -2.356 -1.311  3.600  6.778 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   21.222      1.287   16.50  1.3e-09
## trtB           6.178      2.153    2.87   0.0141
## 
## Residual standard error: 3.86 on 12 degrees of freedom
## Multiple R-squared:  0.407,	Adjusted R-squared:  0.3576 
## F-statistic: 8.235 on 1 and 12 DF,  p-value: 0.0141
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -10.197, df = 8, p-value = 7.336e-06
...
Einflussvariablen ($x$) wurden erhoben: region, S und weight. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.24 & 0 & 10.85 & 100.90 & 66.85 & 7\\
12.44 & 0 & 10.38 & 97.85 & 62.69 & 11\\
10.11 & 0 & 10.89 & 103.20 & 67.49 & 12\\
6.59 & 0 & 11.46 & 96.98 & 72.63 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.3502 -2.4971  0.2447  2.1961  8.5763 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 75.92304    2.47259  30.706  < 2e-16
## nematodes    0.06943    0.12801   0.542  0.58907
## light        0.64331    0.77718   0.828  0.41027
## P           -0.71695    0.21319  -3.363  0.00119
## 
## Residual standard error: 3.364 on 80 degrees of freedom
## Multiple R-squared:  0.128,	Adjusted R-squared:  0.09533 
## F-statistic: 3.915 on 3 and 80 DF,  p-value: 0.01158
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & so4 & maxdepth & acerage\\
\midrule
SENECA\_CR & 23 & 20.1 & 8.37 & 45 & 18422\\
BENNETT\_CR & 2 & 12.9 & 8.81 & 51 & 583\\
LITTLE\_BEAR\_CR & 6 & 14.9 & 8.16 & 67 & 3330\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.066  -4.521  -2.295   1.681  15.389  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 6.024e-01  1.125e+00   0.536  0.59467
## temp        8.299e-02  4.305e-02   1.928  0.05970
## so4         4.411e-03  2.293e-02   0.192  0.84827
## maxdepth    1.533e-02  5.167e-03   2.966  0.00465
## acerage     3.236e-05  1.480e-05   2.186  0.03362
## 
## (Dispersion parameter for quasipoisson family taken to be 41.42566)
## 
##     Null deviance: 2440.5  on 53  degrees of freedom
## Residual deviance: 1732.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.82      2.35   0.0186
## 2 nematodes       0.156     0.603  0.546 
## 3 water           0.179    -2.55   0.0107
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9481 -0.5880 -0.1323  0.5891  3.4563 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  184.3   13.58   
##  subject  (Intercept) 4106.9   64.08   
##  Residual              661.3   25.72   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   201.33      26.95   7.469
## attitudepop   -18.46       5.65  -3.267
## 
...
\begin{verbatim}
##          ctrl      high       low       mid
## ctrl 1.00e+00 0.0000833 0.0000104 0.0000011
## high 8.33e-05 1.0000000 0.4782934 0.1439956
## low  1.04e-05 0.4782934 1.0000000 0.4409496
## mid  1.10e-06 0.1439956 0.4409496 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, 18, 9, 3 und 14!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 15, 17, 4, 12 und 8! \textbf{(2 Punkte)}
...
einen Radius von 4.5cm und eine H{\"o}he von 7cm. Der
...
\item Berechnen Sie die Wahrscheinlichkeit in Summe gleich oder weniger als
  4 zu w{\"u}rfeln! \textbf{(1 Punkt)}  
\end{enumerate}



Sie haben den Vektor $A = 5, 6, 4$ und den Vektor $B = 4, 6, 6$ gegeben.
...
\item Erstellen Sie eine Diagonalmatrix, Einheitsmatrix, stochastische Matrix mit $m \times n$ Dimensionen!
