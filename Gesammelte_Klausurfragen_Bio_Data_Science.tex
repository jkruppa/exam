...
\begin{graybox}{Checkbox für die Version vom \today}
  ...
  Choice Fragen sowie \textbf{75} Rechen- und
  Textaufgaben.
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.21, 0.03, 0.001, 0.89 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1, 0.18, 0.006, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1, 0.18, 0.006, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0033, 0.035, 0.005, 2e-04, 0.1483 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1.26, 0.18, 0.006, 5.34 und 2.52. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0033, 0.035, 0.005, 2e-04, 0.1483 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 8, 7, 15, 3 und 4.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 7.4 +/- 2.36
\item [\textbf{B} \msquare] Es ergibt sich 7.4 +/- 4.72
\item [\textbf{C} \msquare] Es ergibt sich 8.4 +/- 2.36
\item [\textbf{D} \msquare] Es ergibt sich 7.4 +/- 22.3
\item [\textbf{E} \msquare] Es ergibt sich 6.4 +/- 11.15
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 22, 13, 29, 26, 10, 4 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 [10, 29]
\item [\textbf{B} \msquare] Es ergibt sich 22 [10, 29]
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 29
\item [\textbf{D} \msquare] Es ergibt sich 22 +/- 10
\item [\textbf{E} \msquare] Es ergibt sich 22 +/- 10
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.95 liegt Overdispersion vor. Damit kann keine Possion-Regression gerechnet werden. Die L{"o}sung ist eine Gaussian Regression mit Nullanpassung.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.95 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.95 liegt keine Overdispersion vor.
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.74 ist
richtig?
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.25, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.2, da es sich um ein Anteil handelt.
...
\item [\textbf{C} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 0
\item [\textbf{D} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 0.05
\item [\textbf{E} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 0
\end{enumerate}
...
$y = \{19, 21, 18, 19, 21, 22, 17, 18, 21, 19, 15\}$. Berechnen Sie folgende
...
\begin{center}
$10.7, 12.6, 12, 9.2, 8.3, 8.6, 13.3, 8.4, 8, 10.2, 11, 13.7, 13.5, 8.3$
\end{center}
...
## t = 0.12016, df = 10, p-value = 0.9067
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 59.45 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 54.98 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 32.000  16.000  4.4211 0.02742
## Residuals 18 65.143   3.619
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 110 114 114 103 103 118 131 120 155 161 164 162
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 3.99 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 23.62 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 262.6 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 39 & 369.59 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2 267.35 133.673  5.8082 0.01131
## form       1 242.71 242.710 10.5460 0.00447
## dose:form  2 138.19  69.096  3.0023 0.07496
## Residuals 18 414.26  23.014
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 148$ Sauen. In dem Experiment wurde gemessen,
...
## -6.2000 -2.3643 -0.5286  2.5571  5.1429 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.857      1.361  13.121 1.26e-07
## trtB          10.343      2.108   4.906 0.000618
## 
## Residual standard error: 3.601 on 10 degrees of freedom
## Multiple R-squared:  0.7064,	Adjusted R-squared:  0.6771 
## F-statistic: 24.06 on 1 and 10 DF,  p-value: 0.000618
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -5.4752, df = 8, p-value = 0.0005908
...
Einflussvariablen ($x$) wurden erhoben: dry, weight und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.65 & 0 & 8.69 & 101.95 & 68.28 & 10\\
9.84 & 0 & 8.58 & 100.53 & 70.77 & 8\\
9.76 & 0 & 7.02 & 98.88 & 71.50 & 7\\
11.59 & 0 & 8.10 & 98.55 & 69.63 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -3.9534 -1.6078 -0.1088  1.4454  5.4772 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.43914    6.63059   0.368  0.71383
## P           -0.43707    0.14058  -3.109  0.00251
## nematodes    0.03779    0.06774   0.558  0.57826
## Fe           0.71269    0.06381  11.169  < 2e-16
## 
## Residual standard error: 2.141 on 91 degrees of freedom
## Multiple R-squared:  0.5953,	Adjusted R-squared:  0.582 
## F-statistic: 44.62 on 3 and 91 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & acerage & do2 & so4\\
\midrule
PATAPSCO\_R & 28 & 19.7 & 4706 & 8.9 & 9.90\\
CABIN\_JOHN\_CR & 21 & 15.0 & 8612 & 8.2 & 16.09\\
GREENE\_BR & 33 & 20.5 & 2225 & 9.1 & 9.72\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##      Min        1Q    Median        3Q       Max  
## -10.1584   -3.6410   -1.9156    0.8912   22.5272  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  9.176e-01  1.920e+00   0.478  0.63482
## temp         2.258e-02  5.051e-02   0.447  0.65687
## acerage      4.905e-05  1.419e-05   3.456  0.00114
## do2          2.242e-01  1.478e-01   1.518  0.13556
## so4         -1.196e-02  2.543e-02  -0.470  0.64025
## 
## (Dispersion parameter for quasipoisson family taken to be 44.5332)
## 
##     Null deviance: 2095.4  on 53  degrees of freedom
## Residual deviance: 1504.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.337    -0.784  0.433 
## 2 light           0.466     1.97   0.0493
## 3 nematodes       0.132     0.862  0.389
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 795.3
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9582 -0.6165 -0.0811  0.6415  3.5064 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  240.0   15.49   
##  subject  (Intercept) 4032.6   63.50   
##  Residual              658.6   25.66   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.513     26.871   7.536
## attitudepop  -20.532      5.639  -3.641
## 
...
\begin{verbatim}
##           ctrl      high      low      mid
## ctrl 1.0000000 0.0281024 0.00e+00 5.91e-05
## high 0.0281024 1.0000000 0.00e+00 1.00e-07
## low  0.0000000 0.0000000 1.00e+00 4.15e-05
## mid  0.0000591 0.0000001 4.15e-05 1.00e+00
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 19, 9, 11, 13 und 12!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 16, 16, 11, 4 und 12! \textbf{(2 Punkte)}
...
die Behandlungen A bis D sowie die Bl{\"o}cke I bis IV
vorliegen. Sie messen die Outcomes pigs, Fe und freshmatter an vier verschiedenen Messterminen.
...
In der Klausur zu dem Modul \textbf{Mathematik \& Statistik} werden \textit{zwei Aufgaben} aus den folgenden Aufgaben zur Mathematik ausgewählt. \\
\end{graybox}
\clearpage
% -----------------------------------------------------------------------  
...
Sie haben den Vektor $A = 11, -6, 2$ und den Vektor $B = 6, 6, 4$ gegeben.
