...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.03, 0.42, 0.001 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.7, 0.15, 2.1, 0.005 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.006, 0.084, 2e-04 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 1, 0.005 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.006, 0.084, 2e-04 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 1, 0.005 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 15, 17, 11 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 13.4 +/- 2.61
\item [\textbf{B} \msquare] Es ergibt sich 12.4 +/- 3.4
\item [\textbf{C} \msquare] Es ergibt sich 13.4 +/- 6.8
\item [\textbf{D} \msquare] Es ergibt sich 14.4 +/- 1.305
\item [\textbf{E} \msquare] Es ergibt sich 13.4 +/- 1.305
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 23, 21, 32, 25, 27, 25, 21, 17, 18, -1 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 [18, 27]
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 27
\item [\textbf{C} \msquare] Es ergibt sich 23 +/- 18
\item [\textbf{D} \msquare] Es ergibt sich 24 [19, 28]
\item [\textbf{E} \msquare] Es ergibt sich 24 +/- 18
\end{enumerate} 
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.27, da es sich um eine Chancenverh{"a}ltnis handelt.
...
$y = \{16, 22, 20, 18, 17, 18, 19\}$. Berechnen Sie folgende
...
Frischgewicht (\textit{freshmatter}) von Erbsen.
...
\begin{center}
$12, 11.8, 12.1, 5.8, 9.5, 11, 12.5, 13.1, 3.7, 11.9, 8.2, 9.5, 10.3, 11.6$
\end{center}
...
ob die D{\"u}ngestufe \textit{low} im Bezug auf das Trockengewicht von Erbsen
...
\begin{minipage}[c]{.4\linewidth} % [b] => Ausrichtung an \caption
  \includegraphics[width=\linewidth]{/Users/kruppajo/Documents/GitHub/exam/question/img/boxplot-03-a.png}
\end{minipage}
\hspace{.1\linewidth}% Abstand zwischen Bilder
\begin{minipage}[c]{.4\linewidth} % [b] => Ausrichtung an \caption
  \includegraphics[width=\linewidth]{/Users/kruppajo/Documents/GitHub/exam/question/img/boxplot-03-b.png}
\end{minipage}
...
den Boniturnoten (\textit{grade}) von Erbsen.
...
## 
## data:  weight by group
## t = -0.14434, df = 12, p-value = 0.8876
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.299323  2.013608
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 86.69 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 63.87 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 175.792  87.896  88.023 3.179e-11
## Residuals 22  21.968   0.999
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 118 113 136 103  95 103 145 113 123 138 155 175
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 0.01 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 112.49 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 370.11 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 339.8 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2 176.747  88.373  5.9666 0.010282
## form       1  53.552  53.552  3.6156 0.073369
## dose:form  2 298.188 149.094 10.0662 0.001164
## Residuals 18 266.604  14.811
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 98$ Sauen. In dem Experiment wurde gemessen,
...
## -6.8000 -2.9214  0.9571  2.8357  5.2000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   14.800      1.722   8.596 6.24e-06
## waterB        11.486      2.254   5.095 0.000467
## 
## Residual standard error: 3.85 on 10 degrees of freedom
## Multiple R-squared:  0.7219,	Adjusted R-squared:  0.6941 
## F-statistic: 25.96 on 1 and 10 DF,  p-value: 0.0004675
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7219$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: N, dosage und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.50 & 0 & 11.19 & 102.20 & 70.19 & 7\\
11.39 & 0 & 7.63 & 100.24 & 73.24 & 6\\
9.14 & 0 & 10.63 & 101.39 & 72.25 & 10\\
8.73 & 0 & 11.03 & 90.16 & 60.43 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.6950 -1.4639 -0.2291  1.3383  4.7030 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.39537    7.22355   0.193  0.84723
## Fe           0.72591    0.06686  10.858  < 2e-16
## P           -0.48946    0.14838  -3.299  0.00136
## water        0.06846    0.14846   0.461  0.64576
## 
## Residual standard error: 2.07 on 96 degrees of freedom
## Multiple R-squared:  0.6089,	Adjusted R-squared:  0.5966 
## F-statistic: 49.81 on 3 and 96 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
LITTLE\_CONOCOCHEAGUE\_CR & 15 & 2227 & 54 & 0.33 & 6.8\\
BIG\_PIPE\_CR & 18 & 25440 & 120 & 3.53 & 7.5\\
NORTHWEST\_BR & 6 & 8735 & 63 & 1.56 & 8.2\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.511  -4.203  -1.571   1.242  16.244  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.108e+00  1.512e+00   0.733  0.46711
## acerage     2.145e-05  1.738e-05   1.234  0.22308
## maxdepth    1.209e-02  4.528e-03   2.670  0.01026
## no3         2.145e-01  6.931e-02   3.094  0.00326
## do2         8.914e-02  1.551e-01   0.575  0.56815
## 
## (Dispersion parameter for quasipoisson family taken to be 35.99033)
## 
##     Null deviance: 2201.0  on 53  degrees of freedom
## Residual deviance: 1516.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.47       1.77  0.0762
## 2 light           0.464      2.08  0.0374
## 3 water           0.147     -2.01  0.0440
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4904 -0.6455 -0.1271  0.6197  3.4365 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  216.7   14.72   
##  subject  (Intercept) 3935.1   62.73   
##  Residual              659.4   25.68   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.656     26.505   7.646
## attitudepop  -21.103      5.642  -3.740
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.7379095 0.0000000 0.0000104
## high 0.7379095 1.0000000 0.0000000 0.0000039
## low  0.0000000 0.0000000 1.0000000 0.0006908
## mid  0.0000104 0.0000039 0.0006908 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 11, 15, 7, 3 und 6!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 12, 9, 5, 11 und 19! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes Fe, pigs und drymatter an vier verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC56JMH & 2.0 | 3.0 | Klein \\
    B & GC3IFMX & 3.0 | 2.0 | Mikro \\ 
    C & GCS7OUT & 5.0 | 3.5 | Mikro \\ 
    D & GC22NZW & 1.5 | 5.0 | Mikro \\ 
    E & GCZHITQ & 4.0 | 1.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
\item Welche Strecke in $km$ legen Sie bei der Bew{\"a}ltigung der
  abw{"a}rts Terrainchallenge zur{\"u}ck? \textbf{(6
    Punkte)}
...
man nicht alles im Jahr 1188 n. Chr. f{\"u}r den neuen Lehnsherren
...
1860 ungef{\"a}hr 22 Kaninchen entlassen hat, Millionen
...
Kaninchenweibchens pro Jahr bei ca. 8 Jungtieren. Trotz
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  6-mal-gefaltete, 0.6mm, 40-cm-Karton} durch
...
Wenn man n\footnote{Die Quelle der Inspiration f{\"u}r die Aufgabe war der folgende
...
Im Jahr 2021 leben ca. \ensuremath{8\times 10^{7}} Menschen in Deutschland und
ca. \ensuremath{1.79\times 10^{8}} Menschen in Nigeria 
...
\end{knitrout}
  \captionof{figure}{Fleischkonsum im Jahr 2021}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
\begin{knitrout}
...
\end{knitrout}
  \captionof{figure}{CO$_2$-Emission nach Lebensmittel}
\end{minipage}
\end{figure}
...
\item Stellen Sie den Fleischkonsum in Deutschland und Nigeria im Jahr
  ...
  \textbf{(2 Punkte)}
\item Erg{\"a}nzen Sie in der Tabelle den \textit{gesamten} Fleischkonsum in
  Deutschland und Nigeria im Jahr 2021! \textbf{(1 Punkt)}
\item Erg{\"a}nzen Sie in der Tabelle die Treibhausgasemissionen an $CO_2$, die durch den
  Fleischkonsum in Deutschland und Nigeria im Jahr 2021 entstehen!
  \textbf{(1 Punkt)}
\end{enumerate}

In der folgenden Abbildung (\textit{n{\"a}chste Seite}) sehen Sie die
Bev{\"o}lkerungsentwicklung in Nigeria von 1950 bis ins Jahr 2030 fortgef{\"u}hrt.

\begin{enumerate}
  \setcounter{enumi}{4}  
\item Berechnen Sie zu erwartende Bev{\"o}lkerung in Nigerias im Jahr 2050, die sich
  anhand der Informationen aus der Abbildung zur "`Bev{\"o}lkerungsentwicklung in
  Nigeria"' ergibt! \textbf{(2 Punkte)}
\begin{enumerate}
\item Ohne die Ber{\"u}cksichtigung der Covid-19 Pandemie! \textbf{(1
    Punkt)}
\item Mit der Ber{\"u}cksichtigung der Covid-19 Pandemie! \textbf{(1
    Punkt)}
\end{enumerate}
\item Berechnen Sie den \textit{gesamten} Fleischkonsum von Nigeria im Jahr
...
\item Berechnen Sie die prozentuale Steigerung der Treibhausgasemissionen
  ...
  angeglichenen Fleischkonsum ergibt!
\item Welche Steigerung der Treibhausgasemissionen
  an $CO_2$
\end{enumerate}

Ungef{\"a}hr 50\% sind von einem Rind essbar wohingegen von
einem Insekt ungef{\"a}hr 75\% essbar sind.

\begin{enumerate}
  \setcounter{enumi}{4}  
\item Berechnen Sie die prozentuale Steigerung der Treibhausgasemissionen
  an $CO_2$ in Nigeria, wenn die gesamte Proteinaufnahme durch Fleisch
...
\end{knitrout}
  \captionof{figure}{Bev{\"o}lkerungsentwicklung in Nigeria}
\end{figure}
...
Sie haben den Vektor $A = \{9, 7, 9\}$ und den Vektor $B = \{0, 8, 5\}$ gegeben.
