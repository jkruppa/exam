...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.42, 0.89, 0.03 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 1, 1, 0.15 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 2.1, 4.45, 0.15 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.084, 0.178, 0.006 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.084, 0.178, 0.006 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 1, 1, 0.15 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 7, 13, 11 und 6.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.6 +/- 1.605
\item [\textbf{B} \msquare] Es ergibt sich 7.6 +/- 5.15
\item [\textbf{C} \msquare] Es ergibt sich 9.6 +/- 1.605
\item [\textbf{D} \msquare] Es ergibt sich 8.6 +/- 10.3
\item [\textbf{E} \msquare] Es ergibt sich 8.6 +/- 3.21
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 27, 43, 4, 21, 23, 28, 23, 19, 22, 27 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 +/- 21
\item [\textbf{B} \msquare] Es ergibt sich 23 [21, 28]
\item [\textbf{C} \msquare] Es ergibt sich 23 +/- 21
\item [\textbf{D} \msquare] Es ergibt sich 26 [22, 29]
\item [\textbf{E} \msquare] Es ergibt sich 23 +/- 28
\end{enumerate} 
...
$y = \{19, 21, 18, 20, 21, 24, 16\}$. Berechnen Sie folgende
...
\begin{center}
$9.7, 8.7, 10.6, 11.4, 7.3, 8.8, 14.2, 8.7, 7.4, 6.5, 7.7, 10.5, 12.1, 7.6, 7.5$
\end{center}
...
## t = -2.0586, df = 16, p-value = 0.0562
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.15743497  0.04632386
## sample estimates:
...
## t = -4.6007, df = 16, p-value = 0.0002953
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -8.440062 -3.115494
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = -0.28104, df = 14, p-value = 0.7828
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.247261  3.263134
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 20.22 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 30.44 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 18.296  9.1481  3.8898 0.03442
## Residuals 24 56.444  2.3519
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 114 124 121 105 112 100 139 115 128 127 154 146
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 107.88 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 51.86 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 150.38 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 220.27 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: weight
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2   9.27   4.636  0.1811 0.83582
## form       1  72.52  72.523  2.8338 0.10957
## dose:form  2 255.92 127.961  4.9999 0.01875
## Residuals 18 460.67  25.593
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Visualisieren Sie in zwei getrennten Abbildungen 
  eine mittelere und eine schwache Interaktion zwischen
...
## -7.8000 -1.7357  0.7857  2.2000  5.2000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   15.714      1.311  11.991 2.94e-07
## trtB          -2.914      2.030  -1.435    0.182
## 
## Residual standard error: 3.467 on 10 degrees of freedom
## Multiple R-squared:  0.1708,	Adjusted R-squared:  0.08792 
## F-statistic:  2.06 on 1 and 10 DF,  p-value: 0.1817
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{Multiple R-squared}!
  Was sagt Ihnen der Wert $0.1708$ aus? \textbf{(2 Punkte)}
...
## t = -5.8858, df = 8, p-value = 0.0003676
...
Einflussvariablen ($x$) wurden erhoben: height, center und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
7.46 & 0 & 11.39 & 96.71 & 65.61 & 8\\
11.53 & 0 & 8.89 & 97.10 & 68.94 & 7\\
9.08 & 0 & 9.24 & 97.47 & 66.83 & 7\\
8.91 & 0 & 7.88 & 103.34 & 70.21 & 14\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.3851 -1.4381  0.2502  1.6030  4.3570 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -6.87145    6.21732  -1.105   0.2715
## P           -0.27149    0.14628  -1.856   0.0662
## Fe           0.79503    0.06040  13.164   <2e-16
## nematodes    0.01874    0.06247   0.300   0.7648
## 
## Residual standard error: 2.13 on 107 degrees of freedom
## Multiple R-squared:  0.6222,	Adjusted R-squared:  0.6116 
## F-statistic: 58.75 on 3 and 107 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
PINEY\_CR & 18 & 18.6 & 6949 & 9.3 & 4.57\\
FALLS\_RUN & 15 & 14.3 & 1745 & 9.4 & 2.19\\
OWENS\_CR & 80 & 21.8 & 9961 & 8.6 & 1.02\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.834  -3.072  -1.420   1.476   7.548  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -1.230e+00  1.467e+00  -0.838   0.4058
## temp         6.851e-02  3.328e-02   2.059   0.0449
## acerage      5.412e-05  8.674e-06   6.240 9.98e-08
## do2          3.058e-01  1.215e-01   2.516   0.0152
## no3          6.107e-02  5.374e-02   1.136   0.2613
## 
## (Dispersion parameter for quasipoisson family taken to be 16.20106)
## 
##     Null deviance: 1533.3  on 53  degrees of freedom
## Residual deviance:  781.0  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.50      1.90   0.0581
## 2 nematodes       0.168     0.257  0.797 
## 3 water           0.139    -1.96   0.0499
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1340 -0.5641 -0.0999  0.5080  3.4391 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  212.2   14.57   
##  subject  (Intercept) 4070.6   63.80   
##  Residual              683.9   26.15   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.576     26.926   7.560
## attitudepop  -19.955      5.746  -3.473
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0000010 0.0191726
## high 0.0000000 1.0000000 0.0119631 0.0000006
## low  0.0000010 0.0119631 1.0000000 0.0011967
## mid  0.0191726 0.0000006 0.0011967 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 11, 4, 12, 3 und 9!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 9, 10, 10 und 7! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes freshmatter, pigs und leaf an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCASKN7 & 4.5 | 3.5 | Normal \\
    B & GCSFFYH & 1.0 | 4.0 | Normal \\ 
    C & GCM2TRZ & 1.5 | 4.5 | Klein \\ 
    D & GCJMLYO & 2.5 | 1.5 | Normal \\ 
    E & GCT3IY9 & 2.0 | 5.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
Sie haben den Vektor $A = \{0, 2, 9\}$ und den Vektor $B = \{-7, 3, 2\}$ gegeben.
