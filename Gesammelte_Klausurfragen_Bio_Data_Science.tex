...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.89, 0.03 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.2225, 0.0075 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 3.56, 0.12 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.2225, 0.0075 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 0.12 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 0.12 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 15, 11, 15, 15 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 13.8 +/- 1.595
\item [\textbf{B} \msquare] Es ergibt sich 12.8 +/- 10.2
\item [\textbf{C} \msquare] Es ergibt sich 12.8 +/- 1.595
\item [\textbf{D} \msquare] Es ergibt sich 11.8 +/- 5.1
\item [\textbf{E} \msquare] Es ergibt sich 12.8 +/- 3.19
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 26, 34, 26, 24, 25, 20 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 +/- 34
\item [\textbf{B} \msquare] Es ergibt sich 26 [24, 34]
\item [\textbf{C} \msquare] Es ergibt sich 29 +/- 24
\item [\textbf{D} \msquare] Es ergibt sich 29 [24, 34]
\item [\textbf{E} \msquare] Es ergibt sich 26 +/- 24
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.57 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung einer anderen Verteilungsfamilie wie die Quasipossion Verteilung.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.57 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.57 liegt keine Overdispersion vor.
...
\begin{enumerate}
\item [\textbf{A} \msquare] X beinhaltet die Zeilen. Die Zeilen geben die Verteilungsfamilie vor.
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.75, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.43, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.75, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
In einem Stallexperiment mit $n = 89$ Ferkeln wurden verschiedene
...
\item [\textbf{C} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -3.4
\item [\textbf{D} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 11.57
\item [\textbf{E} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 11.57
\end{enumerate}
...
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 18
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 9
...
$y = \{12, 13, 8, 15, 18, 14, 18, 24, 17, 16, 14\}$. Berechnen Sie folgende
...
\begin{center}
$10.7, 13.3, 9.7, 7.1, 8.8, 10.7, 13.4, 13.1, 12.3, 10.7, 11.6, 12.5$
\end{center}
...
## t = -2.5444, df = 14, p-value = 0.02337
...
## t = 0.91181, df = 16, p-value = 0.3754
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.061039  5.172150
## sample estimates:
...
## t = -2.1271, df = 10, p-value = 0.05931
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -6.0839296  0.1410724
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 121.88 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 95.43 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 73.814  36.907  11.331 0.0005127
## Residuals 20 65.143   3.257
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 125 133 112  99  93  99 140 126 140 163 143 149
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 52.34 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 99.89 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 575.93 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 30 & 817.25 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 478.60 239.298 18.0104 5.063e-05
## form       1  62.19  62.186  4.6803   0.04421
## dose:form  2   4.04   2.022  0.1522   0.85994
## Residuals 18 239.16  13.287
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -3.4444 -1.6111  0.2778  1.4167  4.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   15.000      1.002  14.972 3.97e-09
## trtB          12.444      1.250   9.959 3.74e-07
## 
## Residual standard error: 2.24 on 12 degrees of freedom
## Multiple R-squared:  0.8921,	Adjusted R-squared:  0.8831 
## F-statistic: 99.19 on 1 and 12 DF,  p-value: 3.742e-07
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 6.7006, df = 8, p-value = 0.0001526
...
Einflussvariablen ($x$) wurden erhoben: rainfall, dry und variety. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.84 & 0 & 10.37 & 98.42 & 71.27 & 15\\
11.63 & 0 & 10.18 & 97.31 & 66.61 & 6\\
11.89 & 0 & 10.67 & 100.15 & 69.72 & 13\\
9.83 & 1 & 10.70 & 101.54 & 68.09 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.9292 -1.4679 -0.0047  1.0135  5.5691 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   4.3232     7.1405   0.605    0.546
## light         0.1708     0.5036   0.339    0.735
## Fe            0.7184     0.0684  10.502  < 2e-16
## P            -0.6522     0.1365  -4.777 5.75e-06
## 
## Residual standard error: 2.202 on 106 degrees of freedom
## Multiple R-squared:  0.5869,	Adjusted R-squared:  0.5752 
## F-statistic:  50.2 on 3 and 106 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & maxdepth & so4 & acerage\\
\midrule
BIG\_PIPE\_CR & 18 & 7.5 & 120 & 8.20 & 25440\\
SOUTH\_BR\_PATAPSCO & 26 & 7.9 & 60 & 8.84 & 1450\\
SAVAGE\_R & 106 & 7.7 & 73 & 12.28 & 29708\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -10.535   -4.685   -1.649    2.257   22.037  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  9.707e-01  1.500e+00   0.647  0.52053
## do2          1.897e-01  1.464e-01   1.296  0.20102
## maxdepth     1.062e-02  4.796e-03   2.214  0.03151
## so4         -1.815e-02  2.890e-02  -0.628  0.53284
## acerage      4.115e-05  1.485e-05   2.772  0.00785
## 
## (Dispersion parameter for quasipoisson family taken to be 46.83372)
## 
##     Null deviance: 2435.8  on 53  degrees of freedom
## Residual deviance: 1736.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.403     0.123   0.902
## 2 light           0.545     1.56    0.119
## 3 nematodes       0.149    -1.07    0.286
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4208 -0.6787 -0.0923  0.5141  3.4706 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  210.0   14.49   
##  subject  (Intercept) 4182.3   64.67   
##  Residual              651.5   25.53   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.849     27.250   7.407
## attitudepop  -18.172      5.608  -3.240
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0178476 0.0000000 0.0000324
## high 0.0178476 1.0000000 0.0000000 0.0000000
## low  0.0000000 0.0000000 1.0000000 0.0002366
## mid  0.0000324 0.0000000 0.0002366 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 6, 7, 7, 8 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 9, 13, 8, 0 und 16! \textbf{(2 Punkte)}
...
$0.75mm$ pro Jahr aus. Es ist bekannt, dass die Eiche im
...
Gehen Sie davon aus, dass sich Herodot in der 1000-j{\"a}hrigen Eiche $bequem$ um
...
\begin{quote}
  ...
  nach 112 Tagen rafft die Skorbut eine ganze Schiffsbesatzung dahin<<
\end{quote}
...
Wir treffen folgende Annahmen. Eine au{\ss}erirdische Zivilisation schickt $3$ Sonden mit
$10$\%iger Lichtgeschwindigkeit los um sich auf den erreichten
Planeten selbst zu replizieren. Nach $1000$ Jahren ist die
Replikation abgeschlossen und wiederum $3$ Sonden werden
ausgesendet. Gehen Sie von $7.81$ Lichtjahren als mittlerer
...
\begin{enumerate}
\item Stellen Sie alle m{\"o}glichen Ergebnisse von zwei vierseitigen W{\"u}rfel
  als Diagramm dar! \textbf{(2 Punkte)}
\item Erg{\"a}nzen Sie die relativen H{\"a}ufigkeiten der einzelnen Ergebnisse!
  \textbf{(1 Punkt)}  
\item Berechnen Sie die Wahrscheinlichkeit in Summe gleich oder weniger als
  3 zu w{\"u}rfeln! \textbf{(1 Punkt)}  
\end{enumerate}
