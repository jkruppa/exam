...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.001, 0.34, 0.02 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.0002, 0.068, 0.004 und 0.042. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 0.005, 1, 0.1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 0.005, 1.7, 0.1 und 1.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 0.005, 1, 0.1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.0002, 0.068, 0.004 und 0.042. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Funktion tbl\_summary() erlaubt einen Datensatz in eine Tabelle zusammenzufassen. Leider ist eine Stratifizierung nach der Behandlung nicht m{"o}glich. Deshalb nutzt man dann das \Rlogo Package \texttt{tableone}.
...
\item [\textbf{E} \msquare] Die Funktion tbl\_summary() erlaubt das Ergebnis einer Regressionsanalyse schnell in eine {"U}bersichtstabelle umzuwandeln. Insbesondere die Zusammenfassung der Sch{"a}tzwerte in eine Zeile macht die Analyse sehr praktisch.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -4.24
\item [\textbf{B} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 17.94
...
\item [\textbf{D} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 17.94
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.75 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.33 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 208.66 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2446.64 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 106.7 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 715.18 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  4.17822 2.089109 5.10671 0.013151 *
## Residuals 27 11.04546 0.409091                   
## ---
...
wurde an 69 Mastschweinen durchgef{\"u}hrt, wobei jedes Tier
...
## Response: len
##           Df   Sum Sq  Mean Sq   F value                 Pr(>F)    
## supp       1 1432.427 1432.427 117.16383 0.00000000000000052019 ***
## dose       2 2275.876 1137.938  93.07643 < 0.000000000000000222 ***
## supp:dose  2  186.011   93.005   7.60728              0.0010982 ** 
## Residuals 63  770.228   12.226                                     
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
\begin{enumerate}
\item Visualisieren Sie in zwei getrennten Abbildungen eine starke und eine mittelere Interaktion zwischen den Faktoren $f_1$ und $f_2$! \textbf{(2 Punkte)}
...
Sie haben folgende Zahlenreihe $y$ vorliegen
$y = \{14, 13, 13, 14, 8, 18, 16\}$. Berechnen Sie folgende
...
Einflussvariablen ($x$) wurden erhoben: center, weight und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
COLLIER\_RUN & 18 & 18.2 & 6298 & 8.6 & 0.26\\
DEAD\_RUN & 25 & 23.0 & 4145 & 8.7 & 0.34\\
CONOWINGO\_CR & 112 & 24.1 & 27350 & 8.5 & 6.95\\
SOUTH\_FORK\_LINGANORE\_CR & 20 & 15.4 & 4106 & 10.0 & 2.62\\
\bottomrule
\end{tabular}
\end{table}
...
## -6.9296  -3.8072  -2.1491   1.1376  22.0172  
## 
## Coefficients:
##                Estimate  Std. Error t value Pr(>|t|)   
## (Intercept) 0.620759474 1.795018034  0.3458 0.730956   
## temp        0.047521470 0.045832973  1.0368 0.304900   
## acerage     0.000043617 0.000013339  3.2700 0.001972 **
## do2         0.147408825 0.148867711  0.9902 0.326941   
## no3         0.157847198 0.072452425  2.1786 0.034198 * 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 47.000651)
## 
##     Null deviance: 2310.95  on 53  degrees of freedom
## Residual deviance: 1558.25  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.47       1.51  0.130 
## 2 water           0.150     -1.73  0.0842
## 3 nematodes       0.156      1.51  0.132
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
9.06 & 1 & 10.45 & 101.53 & 77.66 & 6\\
12.93 & 1 & 11.07 & 105.51 & 76.06 & 12\\
10.11 & 0 & 11.21 & 102.53 & 72.88 & 5\\
13.32 & 1 & 7.95 & 95.26 & 67.79 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -6.04321 -1.70125 -0.35522  1.67442  6.61787 
## 
## Coefficients:
##              Estimate Std. Error t value          Pr(>|t|)    
## (Intercept) 11.000124   7.942626  1.3849            0.1696    
## P           -0.435600   0.187214 -2.3268            0.0223 *  
## Fe           0.640107   0.079909  8.0105 0.000000000004712 ***
## nematodes   -0.066015   0.069092 -0.9555            0.3420    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.3989 on 87 degrees of freedom
## Multiple R-squared:  0.43175,	Adjusted R-squared:  0.41216 
## F-statistic: 22.034 on 3 and 87 DF,  p-value: 0.00000000010514
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Coefficients:
##             Estimate Std. Error t value      Pr(>|t|)    
## (Intercept) 17.60000    0.94868 18.5520 0.00000007348 ***
## trtB        -3.80000    1.34164 -2.8324       0.02207 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.1213 on 8 degrees of freedom
## Multiple R-squared:  0.50069,	Adjusted R-squared:  0.43828 
## F-statistic: 8.0222 on 1 and 8 DF,  p-value: 0.02207
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##       Min        1Q    Median        3Q       Max 
## -2.325045 -0.587555 -0.055694  0.530879  3.067051 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  204.24  14.291  
##  subject  (Intercept) 4022.66  63.424  
##  Residual              670.28  25.890  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 202.7616    26.7503  7.5798
## attitudepop -20.0372     5.6885 -3.5224
## 
...
\midrule
A & 17.00 & 16 & 14 & 20 & 15.0 & 19.5 & 6.67\\
B & 17.86 & 18 & 16 & 21 & 16.0 & 19.0 & 3.81\\
C & 10.71 & 11 & 7 & 13 & 10.5 & 11.5 & 3.57\\
D & 5.00 & 4 & 2 & 11 & 2.5 & 6.5 & 10.67\\
\bottomrule
\end{tabular}
\end{table}
...
## t = -5.50926, df = 14, p-value = 0.000076945
...
## t = 0.270377, df = 12, p-value = 0.79146
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.1370743  4.0259632
## sample estimates:
...
## t = 0.0590281, df = 12, p-value = 0.9539
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.3940953  2.5274287
## sample estimates:
...
\item Folgende statistische Fachbegriffe bzw. Methoden sind gegeben:
  \begin{itemize}
  \item[] Paired t-Test, ANOVA, Mann-Whitney-U-Test, Kruskal-Wallis-Test, Simple Gaussian linear Regression, t-Test, Pearson Korrelation, Spearman Korrelation und Wilcoxon-Test.
  \end{itemize}
