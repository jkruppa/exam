...
\begin{graybox}{Ergebnis der Klausur}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 55 Punkten sind aus dem Rechen- und
    Textteil erreicht. 
  \item[] \rule[0ex]{3em}{.4pt}\, von 75 Punkten in Summe.
...
\end{center}
\begin{itemize}
\item Es sind \rule[0ex]{2em}{.4pt}\, von 55 Punkten erreicht worden.
\end{itemize}
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.34, 0.001 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.004 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.085, 3e-04 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3.56, 1.36, 0.004 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.004 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.085, 3e-04 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 19, 15, 5 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.2 +/- 33.2
\item [\textbf{B} \msquare] Es ergibt sich 11.2 +/- 5.76
\item [\textbf{C} \msquare] Es ergibt sich 11.2 +/- 2.88
\item [\textbf{D} \msquare] Es ergibt sich 12.2 +/- 2.88
\item [\textbf{E} \msquare] Es ergibt sich 10.2 +/- 16.6
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 9, 12, 7, 19, 17, 0, 9, 13, 15, 20 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 13 [9, 19]
\item [\textbf{B} \msquare] Es ergibt sich 13 +/- 9
\item [\textbf{C} \msquare] Es ergibt sich 17 [10, 20]
\item [\textbf{D} \msquare] Es ergibt sich 13 +/- 19
\item [\textbf{E} \msquare] Es ergibt sich 17 +/- 9
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.2, da es sich um eine Chancenverh{"a}ltnis handelt.
...
$y = \{16, 18, 19, 17, 12, 14, 11, 15, 14, 16, 13\}$. Berechnen Sie folgende
...
\begin{center}
$10.8, 10.2, 11.5, 11.8, 7.8, 11.2, 11.3, 11, 10.6, 12.7, 11.6, 9.8, 10.7, 9.6, 8.5$
\end{center}
...
## t = 0.24167, df = 10, p-value = 0.8139
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 158.42 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 42.54 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  7.714  3.8571  0.9033 0.4228
## Residuals 18 76.857  4.2698
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 134 123  86  95  97  97 143 156 144 166 145 157
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 32.17 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 297.16 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 126.98 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 426.69 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2  55.78  27.889  1.1908 0.32682
## form       1 123.92 123.916  5.2909 0.03361
## dose:form  2 269.17 134.584  5.7464 0.01175
## Residuals 18 421.57  23.421
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.4000 -0.8571  0.1429  1.2571  2.6000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  16.4000     1.0204  16.073  1.8e-08
## trtB         -0.5429     1.3360  -0.406    0.693
## 
## Residual standard error: 2.282 on 10 degrees of freedom
## Multiple R-squared:  0.01624,	Adjusted R-squared:  -0.08213 
## F-statistic: 0.1651 on 1 and 10 DF,  p-value: 0.6931
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: block, S und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.14 & 0 & 11.46 & 106.09 & 74.66 & 16\\
9.36 & 0 & 10.77 & 96.48 & 66.41 & 10\\
9.26 & 1 & 12.85 & 96.77 & 68.20 & 11\\
10.72 & 1 & 11.97 & 103.93 & 70.41 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.7533 -2.1480  0.2115  1.6842  7.4021 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -3.00026    8.71947  -0.344    0.731
## water       -0.33538    0.20855  -1.608    0.111
## Fe           0.75556    0.08428   8.965 1.47e-14
## nematodes    0.04640    0.09058   0.512    0.610
## 
## Residual standard error: 2.744 on 103 degrees of freedom
## Multiple R-squared:  0.4539,	Adjusted R-squared:  0.438 
## F-statistic: 28.54 on 3 and 103 DF,  p-value: 1.633e-13
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & so4 & maxdepth & acerage & no3\\
\midrule
BUSH\_CR & 32 & 11.31 & 120 & 19046 & 2.93\\
MILL\_CR & 6 & 15.77 & 53 & 1097 & 1.71\\
NORTH\_BR & 23 & 7.36 & 121 & 3836 & 1.32\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.377  -4.494  -2.234   1.413  15.689  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.149e+00  5.401e-01   3.979 0.000228
## so4         -2.423e-02  2.427e-02  -0.998 0.322945
## maxdepth     1.122e-02  4.155e-03   2.701 0.009465
## acerage      1.380e-05  1.737e-05   0.795 0.430659
## no3          2.450e-01  7.071e-02   3.465 0.001112
## 
## (Dispersion parameter for quasipoisson family taken to be 35.09122)
## 
##     Null deviance: 2248.1  on 53  degrees of freedom
## Residual deviance: 1521.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.394     0.250   0.803
## 2 light           0.467     0.889   0.374
## 3 nematodes       0.147    -0.429   0.668
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2084 -0.6583 -0.1083  0.6299  3.3271 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  195.0   13.96   
##  subject  (Intercept) 4120.8   64.19   
##  Residual              656.5   25.62   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   202.66      27.02   7.500
## attitudepop   -21.30       5.63  -3.783
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0309697 0.0000000 0.0000073
## high 0.0309697 1.0000000 0.0000003 0.0041507
## low  0.0000000 0.0000003 1.0000000 0.0023112
## mid  0.0000073 0.0041507 0.0023112 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 14, 15, 8, 12 und 10!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 5, 13, 8 und 14! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes freshmatter, Fe und drymatter an drei verschiedenen Messterminen.
...
zu Verf{\"u}gung. Sie starten an dem Ort E.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCH7Q5D & 5.0 | 3.5 | Klein \\
    B & GCE9OZN & 1.0 | 1.0 | Klein \\ 
    C & GCLZ2WT & 4.0 | 4.0 | Mikro \\ 
    D & GC8BAEE & 3.0 | 2.5 | Normal \\ 
    E & GC9JRAI & 2.5 | 4.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 653 n. Chr. f{\"u}r den neuen Lehnsherren
...
Wir schreiben das Jahr 2023. Dies sind die Abenteuer des
H{"a}ngebauchschweins Fridolin und Ihnen. Gr{\"u}nes Gras unter Ihren F{\"u}{\ss}en und ein
strammer Wind im Gesicht, egal wohin Sie schauen. Ein schmatzendes Ger{\"a}usch
unter Ihnen.


\begin{enumerate}
\item Skizzieren Sie den Versuchsplan auf  Tischen im
  Gew{\"a}chshaus! \textbf{(2 Punkte)}
\end{enumerate}

Auf dem Weg zu Ihrer Pink Ladyplantage wurden Sie mit Ihrem Trecker von
einer Gruppe elektrifizierter Renter abgedr{\"a}ngt. Der Trecker muss wieder
aus dem Graben.  

https://www.ingenieurkurse.de/technische-mechanik-statik/einzelkraefte-mit-gemeinsamen-angriffspunkt/resultierende-analytisch-bestimmen/kraefte-mit-unterschiedlicher-wirkungslinie/kraefte-mit-unterschiedlicher-wirkungslinie.html

https://www.sofatutor.com/physik/videos/kraefteparallelogramm-rechnerische-ermittlung-von-betrag-und-richtung-einer-resultierenden-kraft
...
\begin{enumerate}
  \setcounter{enumi}{3}  
\item Wie lange in Jahren dauert es bis eine Kaninchenpopulation nach einer
  Viruspandemie wieder auf  \textbf{(2 Punkte)}
\end{enumerate}
...
Sie haben den Vektor $A = \{6, 2, 10\}$ und den Vektor $B = \{-8, 3, 1\}$ gegeben.
