...
\begin{graybox}{Checkbox für die Version vom \today}
  ...
  Choice Fragen sowie \textbf{65} Rechen- und
  Textaufgaben.
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.89, 0.21, 0.02, 0.34 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.52, 5.34, 1.26, 0.12, 2.04 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1, 0.12, 1 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1, 0.12, 1 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.1483, 0.035, 0.0033, 0.0567 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.1483, 0.035, 0.0033, 0.0567 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
$\eta^2 = 0.12$. Welche Aussage ist richtig?
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 7, 16, 5 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.8 +/- 4.32
\item [\textbf{B} \msquare] Es ergibt sich 9.8 +/- 18.7
\item [\textbf{C} \msquare] Es ergibt sich 8.8 +/- 9.35
\item [\textbf{D} \msquare] Es ergibt sich 9.8 +/- 2.16
\item [\textbf{E} \msquare] Es ergibt sich 10.8 +/- 2.16
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 7, 18, 21, 18, 23, 17, 20, 16, 19, 7 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 [16, 21]
\item [\textbf{B} \msquare] Es ergibt sich 18 +/- 21
\item [\textbf{C} \msquare] Es ergibt sich 18 [16, 21]
\item [\textbf{D} \msquare] Es ergibt sich 19 +/- 16
\item [\textbf{E} \msquare] Es ergibt sich 18 +/- 16
\end{enumerate}
...
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.97 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.97 liegt keine Overdispersion vor.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.21 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.57, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.57, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.36, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.36, da es sich um ein Anteil handelt.
...
\midrule
(Intercept) & 38.05 & 0.27\\
light\_binhigh & 4.00 & 0.39\\
\bottomrule
\end{tabular}
\end{table}
...
\item [\textbf{B} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 4
\item [\textbf{C} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 16.02
\item [\textbf{D} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 16.02
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 18
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 34
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 36
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 17
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 9
\end{enumerate}
...
$y = \{17, 22, 19, 18, 19, 23, 21\}$. Berechnen Sie folgende
...
\begin{center}
$9.5, 12.6, 9.9, 9.6, 9.1, 10.8, 13.3, 6.3, 11.6, 8.9, 9.1, 9.8$
\end{center}
...
## 
## data:  weight by group
## t = 0.55569, df = 14, p-value = 0.5872
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -1.997262  3.394087
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{group}  & 2 & 3.78 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.22 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  4.3265  2.1632  5.1567 0.01268
## Residuals 27 11.3265  0.4195
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 115 115 129  72 101 104 131 142 140 151 161 161
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 205.43 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2412.36 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 110.47 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 707.36 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## supp       1  466.85  466.85  48.133 2.565e-09
## dose       2 3004.46 1502.23 154.879 < 2.2e-16
## supp:dose  2  238.69  119.34  12.304 3.083e-05
## Residuals 63  611.06    9.70
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## (Intercept)   16.000      1.233  12.978 1.18e-06
## trtB          13.200      1.744   7.571 6.48e-05
## 
## Residual standard error: 2.757 on 8 degrees of freedom
## Multiple R-squared:  0.8775,	Adjusted R-squared:  0.8622 
## F-statistic: 57.32 on 1 and 8 DF,  p-value: 6.481e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Nennen Sie die zwei Eigenschaften des Korrelationskoeffizienten!
  Erkl{\"a}ren Sie die beiden Eigenschaften an einem Beispiel! \textbf{(3 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: rainfall, height und block. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.46 & 0 & 8.57 & 96.18 & 68.67 & 11\\
9.12 & 0 & 8.82 & 101.48 & 72.01 & 12\\
7.60 & 0 & 9.25 & 98.66 & 72.49 & 15\\
10.59 & 0 & 11.00 & 100.57 & 68.52 & 14\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.0995 -1.9145  0.1976  2.1795  7.4821 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -12.79211   10.73782  -1.191    0.236
## nematodes     0.12031    0.08871   1.356    0.178
## Fe            0.83670    0.10476   7.987 2.56e-12
## water        -0.24849    0.20488  -1.213    0.228
## 
## Residual standard error: 2.843 on 99 degrees of freedom
## Multiple R-squared:  0.3974,	Adjusted R-squared:  0.3791 
## F-statistic: 21.76 on 3 and 99 DF,  p-value: 6.622e-11
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
SECOND\_MINE\_BR & 62 & 4.17 & 60 & 2511 & 10.75\\
BLUE\_LICK\_RUN & 1 & 1.20 & 46 & 2217 & 10.85\\
DEEP\_RUN & 5 & 1.30 & 57 & 1175 & 21.68\\
SOUTH\_FORK\_LINGANORE\_CR & 20 & 2.62 & 96 & 4106 & 5.45\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -13.318   -4.273   -1.673    2.294   15.909  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.211e+00  5.133e-01   4.306 7.94e-05
## no3          2.261e-01  7.345e-02   3.078  0.00341
## maxdepth     9.079e-03  4.332e-03   2.096  0.04126
## acerage      3.953e-05  1.366e-05   2.895  0.00565
## so4         -1.622e-02  2.194e-02  -0.739  0.46341
## 
## (Dispersion parameter for quasipoisson family taken to be 34.1498)
## 
##     Null deviance: 2364.4  on 53  degrees of freedom
## Residual deviance: 1539.2  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.386     0.971  0.332 
## 2 nematodes       0.151    -0.642  0.521 
## 3 light           0.593     2.38   0.0174
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 791.2
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0442 -0.6038 -0.0752  0.4624  3.2768 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  236.8   15.39   
##  subject  (Intercept) 3975.7   63.05   
##  Residual              623.0   24.96   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.485     26.670   7.592
## attitudepop  -20.298      5.484  -3.701
## 
...
\begin{verbatim}
##           ctrl      high low       mid
## ctrl 1.0000000 0.0000160   0 0.3787771
## high 0.0000160 1.0000000   0 0.0002094
## low  0.0000000 0.0000000   1 0.0000000
## mid  0.3787771 0.0002094   0 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 10, 18, 6, 12 und 18!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 13, 16, 9, 11 und 9! \textbf{(2 Punkte)}
