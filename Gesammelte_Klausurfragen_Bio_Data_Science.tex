...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.001, 0.89, 0.21 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.005, 4.45, 1.05 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 2e-04, 0.178, 0.042 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 2e-04, 0.178, 0.042 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.005, 1, 1 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.005, 1, 1 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 7, 14, 6 und 4.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 6.4 +/- 7.4
\item [\textbf{B} \msquare] Es ergibt sich 7.4 +/- 14.8
\item [\textbf{C} \msquare] Es ergibt sich 8.4 +/- 1.925
\item [\textbf{D} \msquare] Es ergibt sich 7.4 +/- 1.925
\item [\textbf{E} \msquare] Es ergibt sich 7.4 +/- 3.85
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 23, 27, 33, 14, 12, 23, 11, 10, 23, 25 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 [13, 28]
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 27
\item [\textbf{C} \msquare] Es ergibt sich 23 [12, 27]
\item [\textbf{D} \msquare] Es ergibt sich 23 +/- 12
\item [\textbf{E} \msquare] Es ergibt sich 24 +/- 12
\end{enumerate} 
...
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.62, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.62, da es sich um ein Anteil handelt.
\end{enumerate}
...
$y = \{16, 14, 15, 13, 15, 15, 14\}$. Berechnen Sie folgende
...
(\textit{freshmatter}) von Erdbeeren.
...
\begin{center}
$7.9, 5.3, 11.5, 11, 7.5, 10.4, 12.3, 9, 9, 8.9, 8, 13$
\end{center}
...
ob die D{\"u}ngestufe \textit{low} im Bezug auf das Trockengewicht von Maiss
...
## t = 1.8647, df = 16, p-value = 0.08068
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.3801951  5.9357507
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = -2.5451, df = 10, p-value = 0.02911
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -8.7342381 -0.5800476
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 102.88 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 70.86 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 50.583 25.2914  13.618 0.0001417
## Residuals 22 40.857  1.8571
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 131 114 126  92 109  92 157 142 144 160 151 164
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 0.63 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 415.38 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 59.24 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 518.88 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2 298.30 149.150  5.0885 0.01772
## form       1 132.56 132.556  4.5224 0.04754
## dose:form  2 297.81 148.906  5.0801 0.01781
## Residuals 18 527.60  29.311
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.1111 -2.0278  0.4444  1.9167  4.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   15.111      0.921  16.406 1.55e-10
## waterB         8.889      1.393   6.383 1.70e-05
## 
## Residual standard error: 2.763 on 14 degrees of freedom
## Multiple R-squared:  0.7443,	Adjusted R-squared:  0.726 
## F-statistic: 40.75 on 1 and 14 DF,  p-value: 1.701e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7443$ aus? \textbf{(2 Punkte)}
...
## t = 3.4807, df = 8, p-value = 0.008312
...
\midrule
8.25 & 1 & 11.79 & 99.96 & 71.77 & 9\\
10.60 & 0 & 10.70 & 95.76 & 61.27 & 7\\
10.20 & 0 & 10.41 & 102.35 & 72.23 & 7\\
11.24 & 0 & 8.51 & 99.21 & 67.64 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.9008 -1.6025  0.0749  1.5831  5.7890 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.48407    7.89760  -0.315    0.754
## water        0.03937    0.14931   0.264    0.793
## Fe           0.71259    0.07643   9.323 2.56e-15
## light        0.78652    0.50282   1.564    0.121
## 
## Residual standard error: 2.311 on 102 degrees of freedom
## Multiple R-squared:  0.4811,	Adjusted R-squared:  0.4658 
## F-statistic: 31.52 on 3 and 102 DF,  p-value: 1.681e-14
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
PATAPSCO\_R & 28 & 19.7 & 4.06 & 4706 & 9.90\\
SAVAGE\_R & 106 & 21.4 & 0.63 & 29708 & 12.28\\
ISRAEL\_CR & 30 & 21.0 & 2.41 & 6260 & 13.77\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.127  -3.966  -1.108   2.378  20.622  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.845e+00  8.160e-01   3.486 0.001045
## temp         1.482e-02  3.954e-02   0.375 0.709365
## no3          1.145e-01  7.037e-02   1.627 0.110257
## acerage      4.787e-05  1.261e-05   3.797 0.000405
## so4         -2.306e-02  2.524e-02  -0.913 0.365472
## 
## (Dispersion parameter for quasipoisson family taken to be 35.06986)
## 
##     Null deviance: 1917.6  on 53  degrees of freedom
## Residual deviance: 1364.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.61       2.17  0.0297
## 2 water           0.149     -1.75  0.0794
## 3 nematodes       0.166     -1.89  0.0582
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2741 -0.6342 -0.0718  0.4838  3.5316 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  211.6   14.55   
##  subject  (Intercept) 4027.3   63.46   
##  Residual              678.1   26.04   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.714     26.788   7.567
## attitudepop  -20.944      5.722  -3.660
## 
...
\begin{verbatim}
##          ctrl      high   low       mid
## ctrl 1.000000 0.0000080 0e+00 0.0886260
## high 0.000008 1.0000000 1e-07 0.0011943
## low  0.000000 0.0000001 1e+00 0.0000000
## mid  0.088626 0.0011943 0e+00 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 5, 19, 9, 12 und 14!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 9, 17, 8, 8 und 10! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, P und Fe an drei verschiedenen Messterminen.
...
wir aber als vorsorgliche Enten-Halter:innen aber
...
Enten f{\"u}r vier T{\"a}tigkeiten und versuchen die notwendige Fl{\"a}che
...
\midrule
standing & 43cm; 27cm; 3.5\% & 37cm; 23cm; 8.9\% & 40cm; 33cm; 12.1\%\\
preening & 28cm; 19cm; 4.3\% & 28cm; 18cm; 1.8\% & 35cm; 20cm; 3.5\%\\
walking & 35cm; 29cm; 0.4\% & 37cm; 20cm; 0.4\% & 33cm; 18cm; 0.9\%\\
foraging incl. scratching & 35cm; 17cm; 8.1\% & 28cm; 22cm; 6.3\% & 40cm; 21cm; 5.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCZQS2E & 2.0 | 2.0 | Normal \\
    B & GCZSE2N & 1.5 | 4.5 | Mikro \\ 
    C & GCGYNFH & 5.0 | 4.0 | Klein \\ 
    D & GCMWYPU & 4.0 | 1.0 | Mikro \\ 
    E & GCCJUTK & 3.0 | 1.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 325 n. Chr. f{\"u}r den neuen Lehnsherren
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  4-mal-gefaltete, 0.8mm, 50-cm-Karton} durch
...
Sie haben den Vektor $A = \{18, 10, 18\}$ und den Vektor $B = \{2, 1, 1\}$ gegeben.
...
lassen. Tja, woanders leider keinen Termin gekriegt... Immerhin denken Sie und
...
Menschen in Europa wird mit 0.01\% angenommen. In
92\% der F{\"a}lle ist ein HIV-Test positiv, wenn der Patient
erkrankt ist. In 4\% der F{\"a}lle ist ein HIV-Test positiv,
...
einem diagnostischen Test f{\"u}r AIDS aus. Sie nehmen sich also einen Kuli und
fangen an auf der historischen Ausgabe des Spiegels zu rechnen.
...
\item Zeichnen Sie einen H{\"a}ufigkeitsdoppelbaum zur Bestimmung der gesuchten
  Wahrscheinlichkeit! \textbf{(2 Punkte)} 
\item Beschriften Sie den H{\"a}ufigkeitsdoppelbaum, mit denen Ihnen bekannten
  Informationen zu der AIDS Erkrankung und dem AIDS-Test! \textbf{(2 Punkte)}
\item F{\"u}llen Sie den H{\"a}ufigkeitsdoppelbaum mit den sich ergebenden, absoluten
  Patientenzahlen aus! \textbf{(3 Punkte)}
\end{enumerate}

Bei dem folgenden Arztgespr{\"a}ch erfahren Sie, dass beim diagnostischen
Testen \textit{True Positives (TP)}, \textit{True Negatives
  (TN)}, \textit{False Positives (FP)} und \textit{False Negatives (FN)} auftreten.
