...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.03, 0.01, 0.34 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 0.05, 1 und 0.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.006, 0.002, 0.068 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.05, 0.15, 0.05, 1.7 und 0.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 0.05, 1 und 0.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.006, 0.002, 0.068 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 12, 7, 12, 10 und 9.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11 +/- 1.06
\item [\textbf{B} \msquare] Es ergibt sich 9 +/- 2.25
\item [\textbf{C} \msquare] Es ergibt sich 10 +/- 2.12
\item [\textbf{D} \msquare] Es ergibt sich 10 +/- 1.06
\item [\textbf{E} \msquare] Es ergibt sich 10 +/- 4.5
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 2, 6, 19, 16, 12, 20 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 16 +/- 20
\item [\textbf{B} \msquare] Es ergibt sich 20 +/- 6
\item [\textbf{C} \msquare] Es ergibt sich 20 [6, 20]
\item [\textbf{D} \msquare] Es ergibt sich 16 +/- 6
\item [\textbf{E} \msquare] Es ergibt sich 16 [6, 20]
\end{enumerate}
...
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.88 liegt keine Overdispersion vor.
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.88 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 1.17, da es sich um ein Anteil handelt.
...
In einem Stallexperiment mit $n = 84$ Ferkeln wurden verschiedene
...
\begin{enumerate}
\item [\textbf{A} \msquare] Eine logistischen Regression basiert auf dem maximum Likelihood Prinzip. Hierbei kann kein Effekt beschrieben werden. Im Zweifel hilft aber eine Quadrierung der Fehlerqudrate $\epsilon$.
...
\item [\textbf{C} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 16.35
\item [\textbf{D} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -4.04
\item [\textbf{E} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 16.35
\end{enumerate}
...
$y = \{13, 14, 12, 13, 14, 16, 12\}$. Berechnen Sie folgende
...
\begin{center}
$9.6, 10.6, 7.3, 10, 13.5, 6.4, 9.9, 11.4, 9.2, 11.3, 9.1, 7.6, 9.1, 10.1$
\end{center}
...
## t = -0.83603, df = 12, p-value = 0.4195
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.83 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 11.62 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  3.2842 1.64210  4.0138 0.02978
## Residuals 27 11.0459 0.40911
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 113 108 127  88  98 115 138 149 129 152 169 130
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 200.77 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2434 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 112.06 &  &  &  \strut\\
    \hline
...
## Response: len
##           Df  Sum Sq Mean Sq  F value    Pr(>F)
## supp       1   15.68   15.68   1.3855  0.244429
## dose       2 2464.28 1232.14 108.9051 < 2.2e-16
## supp:dose  2  118.42   59.21   5.2336  0.008429
## Residuals 53  599.64   11.31
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##  -8.00  -2.30   0.40   1.45   8.00 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.000      1.792   9.486 2.57e-06
## trtB          -6.800      2.776  -2.449   0.0343
## 
## Residual standard error: 4.741 on 10 degrees of freedom
## Multiple R-squared:  0.375,	Adjusted R-squared:  0.3125 
## F-statistic: 5.999 on 1 and 10 DF,  p-value: 0.03429
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: variety, dry und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.51 & 0 & 8.49 & 95.76 & 67.13 & 7\\
10.87 & 0 & 8.69 & 98.12 & 66.64 & 7\\
11.65 & 0 & 9.25 & 101.65 & 69.03 & 9\\
9.42 & 0 & 9.12 & 102.03 & 73.20 & 11\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.4457 -2.5373 -0.5087  2.6682  8.3075 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 77.51163    3.56714  21.729  < 2e-16
## light        0.75653    0.84019   0.900  0.37001
## water       -0.01373    0.24972  -0.055  0.95626
## P           -0.76649    0.24409  -3.140  0.00221
## 
## Residual standard error: 3.65 on 102 degrees of freedom
## Multiple R-squared:  0.09089,	Adjusted R-squared:  0.06415 
## F-statistic: 3.399 on 3 and 102 DF,  p-value: 0.02066
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & maxdepth & do2 & no3\\
\midrule
NORTH\_BR\_CASSELMAN\_R & 16 & 17419 & 48 & 7.4 & 0.29\\
HOLLANDS\_BR & 38 & 1934 & 85 & 10.5 & 2.34\\
HERRINGTON\_RUN & 1 & 7056 & 60 & 6.4 & 0.25\\
FISHING\_CR & 11 & 5046 & 109 & 7.6 & 0.73\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -11.523   -3.927   -1.519    1.694   16.177  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 9.874e-01  1.278e+00   0.773  0.44329
## acerage     3.772e-05  1.335e-05   2.826  0.00681
## maxdepth    1.023e-02  4.294e-03   2.383  0.02110
## do2         1.001e-01  1.324e-01   0.756  0.45343
## no3         2.401e-01  7.988e-02   3.006  0.00417
## 
## (Dispersion parameter for quasipoisson family taken to be 33.82532)
## 
##     Null deviance: 2378.2  on 53  degrees of freedom
## Residual deviance: 1479.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.386    -0.397   0.692
## 2 nematodes       0.158     0.417   0.677
## 3 light           0.518     0.992   0.321
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 800.3
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0107 -0.6011 -0.1354  0.5483  3.5637 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  220.1   14.84   
##  subject  (Intercept) 3911.6   62.54   
##  Residual              712.1   26.69   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.804     26.464   7.663
## attitudepop  -20.325      5.863  -3.466
## 
...
\begin{verbatim}
##       ctrl      high   low       mid
## ctrl 1e+00 0.0000000 2e-07 0.0000000
## high 0e+00 1.0000000 0e+00 0.0708583
## low  2e-07 0.0000000 1e+00 0.0000000
## mid  0e+00 0.0708583 0e+00 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 6, 11, 9, 14 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 9, 7, 6 und 10! \textbf{(2 Punkte)}
