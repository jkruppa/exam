...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.02, 0.001, 0.21, 0.01 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.0033, 2e-04, 0.035, 0.0017 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.0033, 2e-04, 0.035, 0.0017 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.006, 1, 0.06 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.04, 0.12, 0.006, 1.26, 0.06 und 2.52. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.006, 1, 0.06 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 12, 13, 12 und 3.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.4 +/- 9.15
\item [\textbf{B} \msquare] Es ergibt sich 10.4 +/- 2.14
\item [\textbf{C} \msquare] Es ergibt sich 9.4 +/- 18.3
\item [\textbf{D} \msquare] Es ergibt sich 9.4 +/- 4.28
\item [\textbf{E} \msquare] Es ergibt sich 9.4 +/- 2.14
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 24, 14, 24, 25, 14, 18, 33, 39, 21, 12 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 +/- 33
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 14
\item [\textbf{C} \msquare] Es ergibt sich 24 [14, 33]
\item [\textbf{D} \msquare] Es ergibt sich 25 +/- 14
\item [\textbf{E} \msquare] Es ergibt sich 25 [14, 33]
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.11 liegt keine Overdispersion vor.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.11 liegt Overdispersion vor. Damit kann keine Possion-Regression gerechnet werden. Die L{"o}sung ist eine Gaussian Regression mit Nullanpassung.
...
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.11 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
\item [\textbf{B} \msquare] Es handelt sich um eine Normalverteilung mit N(15, 5).
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.29, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.42, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.42, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.29, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 2.4, da es sich um ein Anteil handelt.
\end{enumerate}
...
\midrule
(Intercept) & 38.32 & 0.20\\
light\_binhigh & 3.60 & 0.31\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 3.6
...
\item [\textbf{C} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 12.99
\item [\textbf{D} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 12.99
...
$y = \{19, 15, 18, 15, 14, 18, 16, 17, 20, 17, 15\}$. Berechnen Sie folgende
...
\begin{center}
$12.7, 12.4, 10.8, 8, 11.8, 7.6, 10.1, 10.4, 6.3, 11.4, 9.4, 9.8, 11.1, 6.6, 13.1$
\end{center}
...
## t = 2.5907, df = 12, p-value = 0.02363
...
## 
## data:  freshmatter by N
## t = 2.3459, df = 12, p-value = 0.03699
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  0.2441827 6.6129602
## sample estimates:
...
## t = -4.0573, df = 12, p-value = 0.001589
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -10.178451  -3.065993
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 78.4 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 65.08 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 32.262 16.1311  3.5201  0.049
## Residuals 20 91.651  4.5825
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 124 131 109 115  84 109 141 134 138 139 162 147
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 201.7 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2421.66 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 106.98 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 707.93 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df Sum Sq Mean Sq F value    Pr(>F)
## supp       1  270.0  270.01  29.203 1.063e-06
## dose       2 3660.4 1830.22 197.941 < 2.2e-16
## supp:dose  2  206.4  103.21  11.162 7.088e-05
## Residuals 63  582.5    9.25
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 157$ Sauen. In dem Experiment wurde gemessen,
...
## -6.2000 -3.3333 -0.7667  3.7667  8.6667 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   15.200      2.140   7.102 1.24e-05
## trtB           1.133      2.669   0.425    0.679
## 
## Residual standard error: 4.785 on 12 degrees of freedom
## Multiple R-squared:  0.0148,	Adjusted R-squared:  -0.0673 
## F-statistic: 0.1803 on 1 and 12 DF,  p-value: 0.6786
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 6.8961, df = 8, p-value = 0.000125
...
\midrule
8.76 & 1 & 9.89 & 104.32 & 74.04 & 15\\
10.06 & 1 & 12.34 & 98.28 & 63.99 & 9\\
9.44 & 0 & 8.18 & 105.59 & 73.57 & 9\\
12.16 & 0 & 9.81 & 103.42 & 73.09 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.2825 -1.7214 -0.2445  1.8260  6.2442 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -7.72566    9.16993  -0.842  0.40177
## Fe           0.83571    0.08383   9.969 3.71e-16
## water       -0.07954    0.17320  -0.459  0.64719
## P           -0.53751    0.18558  -2.896  0.00475
## 
## Residual standard error: 2.511 on 89 degrees of freedom
## Multiple R-squared:  0.596,	Adjusted R-squared:  0.5824 
## F-statistic: 43.76 on 3 and 89 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & so4 & do2 & temp & acerage\\
\midrule
ISRAEL\_CR & 30 & 13.77 & 9.5 & 21.0 & 6260\\
NORTH\_BR\_CASSELMAN\_R & 16 & 2.50 & 7.4 & 18.0 & 17419\\
SENECA\_CR & 23 & 8.37 & 9.9 & 20.1 & 18422\\
HOLLANDS\_BR & 38 & 11.44 & 10.5 & 12.0 & 1934\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.604  -4.456  -2.500   1.352  22.400  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.556e-01  1.992e+00   0.078   0.9381
## so4         -8.482e-03  2.603e-02  -0.326   0.7459
## do2          2.024e-01  1.607e-01   1.259   0.2140
## temp         7.808e-02  5.248e-02   1.488   0.1432
## acerage      4.148e-05  1.614e-05   2.570   0.0133
## 
## (Dispersion parameter for quasipoisson family taken to be 58.80651)
## 
##     Null deviance: 2443.9  on 53  degrees of freedom
## Residual deviance: 1949.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.357    -1.47    0.141
## 2 light           0.459     1.11    0.266
## 3 nematodes       0.131     0.521   0.603
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9763 -0.6131 -0.0742  0.5726  3.6029 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  213.3   14.60   
##  subject  (Intercept) 3995.0   63.21   
##  Residual              673.0   25.94   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   202.02      26.69   7.569
## attitudepop   -19.39       5.70  -3.401
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0007989 0.0000000 0.0000007
## high 0.0007989 1.0000000 0.0000002 0.0194729
## low  0.0000000 0.0000002 1.0000000 0.0002498
## mid  0.0000007 0.0194729 0.0002498 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 16, 15, 9, 12 und 9!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 14, 12, 11, 10 und 14! \textbf{(2 Punkte)}
