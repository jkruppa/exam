...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.03, 0.001, 0.42 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 0.005, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 0.005, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 0.006, 2e-04, 0.084 und 0.068. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 0.006, 2e-04, 0.084 und 0.068. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 4.45, 0.15, 0.005, 2.1 und 1.7. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 21, 8, 11, 14 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12.2 +/- 11.85
\item [\textbf{B} \msquare] Es ergibt sich 13.2 +/- 4.87
\item [\textbf{C} \msquare] Es ergibt sich 13.2 +/- 2.435
\item [\textbf{D} \msquare] Es ergibt sich 13.2 +/- 23.7
\item [\textbf{E} \msquare] Es ergibt sich 14.2 +/- 2.435
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 26, 32, 21, 14, 30, 20, 23, 10, 10, 19 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 [14, 30]
\item [\textbf{B} \msquare] Es ergibt sich 21 +/- 30
\item [\textbf{C} \msquare] Es ergibt sich 24 [15, 31]
...
$y = \{20, 21, 18, 18, 15, 17, 13\}$. Berechnen Sie folgende
...
\begin{center}
$2, 4, 1, 5, 10, 3, 3, 3, 2, 3, 4, 2, 4, 9, 6$
\end{center}
...
\begin{center}
$9.9, 10.3, 10.1, 10.3, 10.7, 8.5, 9.7, 9.7, 6.8, 10.4, 9.6, 9.1, 11, 12.7$
\end{center}
...
## t = -2.5545, df = 12, p-value = 0.02526
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -10.1706093  -0.8071685
## sample estimates:
...
## t = -0.16136, df = 12, p-value = 0.8745
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -6.215533  5.358391
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = -0.29881, df = 12, p-value = 0.7702
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.763901  2.097234
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 57.88 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 97.56 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  36.952 18.4762  3.2333 0.06314
## Residuals 18 102.857  5.7143
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 122 112 118 113  90 109 157 168 134 155 156 149
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 48.29 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 300.42 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 141.98 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 287.67 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 347.16 173.579  9.9680 0.001219
## form       1  30.29  30.285  1.7392 0.203779
## dose:form  2 155.12  77.561  4.4541 0.026822
## Residuals 18 313.44  17.414
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -7.8889 -2.2722 -0.1444  1.4778 10.1111 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.400      2.058   9.427 6.75e-07
## trtB          -5.511      2.567  -2.147   0.0529
## 
## Residual standard error: 4.602 on 12 degrees of freedom
## Multiple R-squared:  0.2776,	Adjusted R-squared:  0.2174 
## F-statistic: 4.611 on 1 and 12 DF,  p-value: 0.0529
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: S, P und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.62 & 0 & 9.72 & 99.30 & 69.81 & 16\\
9.17 & 0 & 10.42 & 94.49 & 67.90 & 6\\
10.82 & 1 & 11.76 & 96.07 & 66.91 & 9\\
8.50 & 0 & 10.25 & 100.02 & 68.80 & 16\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.9457 -1.7283  0.0169  1.8938  5.8602 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  79.8801     3.0271  26.388  < 2e-16
## light         0.8303     0.6574   1.263     0.21
## P            -0.8557     0.2034  -4.207  6.1e-05
## water        -0.1647     0.1990  -0.827     0.41
## 
## Residual standard error: 2.849 on 90 degrees of freedom
## Multiple R-squared:  0.1814,	Adjusted R-squared:  0.1541 
## F-statistic: 6.648 on 3 and 90 DF,  p-value: 0.0004169
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
WATTS\_BR & 19 & 82 & 6.7 & 5.25 & 26.5\\
RED\_RUN & 32 & 73 & 8.4 & 2.09 & 17.7\\
BEAR\_BR & 12 & 83 & 8.5 & 5.34 & 19.4\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.215  -4.381  -2.089   1.268  13.861  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -1.091992   1.722232  -0.634  0.52899
## maxdepth     0.012586   0.004148   3.034  0.00385
## do2          0.229620   0.129265   1.776  0.08188
## no3          0.194047   0.071751   2.704  0.00938
## temp         0.064577   0.042412   1.523  0.13428
## 
## (Dispersion parameter for quasipoisson family taken to be 39.28386)
## 
##     Null deviance: 2389.8  on 53  degrees of freedom
## Residual deviance: 1631.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.377     0.555 0.579  
## 2 nematodes       0.157    -1.08  0.280  
## 3 light           0.666     3.26  0.00113
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2694 -0.5284 -0.1251  0.4793  3.2737 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  268.2   16.38   
##  subject  (Intercept) 4010.4   63.33   
##  Residual              615.4   24.81   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.896     26.858   7.592
## attitudepop  -21.641      5.451  -3.970
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.3267159 0.1417564 0.0000209
## high 0.3267159 1.0000000 0.0176345 0.0000012
## low  0.1417564 0.0176345 1.0000000 0.0014864
## mid  0.0000209 0.0000012 0.0014864 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 13, 13, 9, 8 und 4!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 9, 11, 17 und 14! \textbf{(2 Punkte)}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCDZAOD & 4.0 | 1.5 | Mikro \\
    B & GCTOEPE & 1.0 | 4.0 | Normal \\ 
    C & GCY6Y4G & 2.0 | 5.0 | Mikro \\ 
    D & GCDALP7 & 5.0 | 4.5 | Mikro \\ 
    E & GC16D7H & 4.5 | 3.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 706 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{15, 10, 7\}$ und den Vektor $B = \{1, -5, 6\}$ gegeben.
