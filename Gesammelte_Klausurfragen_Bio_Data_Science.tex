...
\begin{graybox}{Checkbox für die Version vom \today}
  ...
  Choice Fragen sowie \textbf{60} Rechen- und
  Textaufgaben.
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.02, 0.001 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 0.004 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 0.004 und 1.36. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.005, 0.0003 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.005, 0.0003 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 0.004 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 11, 4, 12 und 14.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.8 +/- 7.85
\item [\textbf{B} \msquare] Es ergibt sich 10.8 +/- 1.98
\item [\textbf{C} \msquare] Es ergibt sich 10.8 +/- 3.96
\item [\textbf{D} \msquare] Es ergibt sich 10.8 +/- 15.7
\item [\textbf{E} \msquare] Es ergibt sich 11.8 +/- 1.98
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 36, 30, 26, 18, 22, 32, -3, 13, 37, 33 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 [18, 36]
\item [\textbf{B} \msquare] Es ergibt sich 26 +/- 18
\item [\textbf{C} \msquare] Es ergibt sich 30 [18, 36]
\item [\textbf{D} \msquare] Es ergibt sich 30 +/- 18
\item [\textbf{E} \msquare] Es ergibt sich 30 +/- 36
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.36 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung einer anderen Verteilungsfamilie wie die Quasipossion Verteilung.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.36 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.36 liegt keine Overdispersion vor.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.85 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.46, da es sich um ein Anteil handelt.
...
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.86, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.46, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
In einem Stallexperiment mit $n = 119$ Ferkeln wurden verschiedene
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.04
...
\item [\textbf{C} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 0
\item [\textbf{D} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 0
...
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 155
...
$y = \{16, 21, 17, 16, 18, 17, 17, 17, 18, 17, 14\}$. Berechnen Sie folgende
...
## t = 3.2712, df = 10, p-value = 0.0084133
...
## 
## data:  waterintake by infusion
## t = -1.75131, df = 14, p-value = 0.10176
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -6.53278725  0.65977138
## sample estimates:
...
## t = 1.02329, df = 8, p-value = 0.33612
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.5070436  6.5070436
## sample estimates:
...
## 
## data:  freshmatter by N
## t = 3.31135, df = 4, p-value = 0.029617
## alternative hypothesis: true mean difference is not equal to 0
## 95 percent confidence interval:
##   0.90460527 10.29539473
## sample estimates:
## mean difference 
##             5.6
\end{verbatim}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 4.11 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.16 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 3.53887 1.769433 4.97578 0.014467 *
## Residuals 27 9.60145 0.355609                   
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 203.85 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2429.5 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 108.89 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 716.22 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 61 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: len
##           Df   Sum Sq  Mean Sq  F value                 Pr(>F)    
## supp       1  118.849  118.849  13.5408             0.00053264 ***
## dose       2 2616.382 1308.191 149.0464 < 0.000000000000000222 ***
## supp:dose  2  210.882  105.441  12.0132            0.000046907 ***
## Residuals 55  482.739    8.777                                    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   90   \strut\\
    \hline
     &  87 &  82 &  169  \strut\\
  \end{tabular}
\end{center}
...
In einem Stallexperiment mit $n = 106$ Ferkeln wurde der
...
## -8.42857 -2.94048 -0.77778  3.55952  6.57143 
## 
## Coefficients:
##             Estimate Std. Error t value     Pr(>|t|)    
## (Intercept) 13.77778    1.55653  8.8516 0.0000004139 ***
## trtB        -0.34921    2.35325 -0.1484       0.8841    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 4.6696 on 14 degrees of freedom
## Multiple R-squared:  0.0015704,	Adjusted R-squared:  -0.069746 
## F-statistic: 0.022021 on 1 and 14 DF,  p-value: 0.88415
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: variety, fertilizier und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & so4 & no3 & acerage & temp\\
\midrule
CABIN\_JOHN\_CR & 21 & 16.09 & 1.57 & 8612 & 15.0\\
SOUTH\_BR\_CASSELMAN\_R & 2 & 21.16 & 0.64 & 6311 & 18.5\\
NORTHWEST\_BR\_ANACOSTIA\_R & 100 & 14.45 & 1.41 & 22550 & 23.0\\
PATAPSCO\_R & 28 & 9.90 & 4.06 & 4706 & 19.7\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##      Min        1Q    Median        3Q       Max  
## -8.86187  -4.02915  -0.82856   1.32648  20.58364  
## 
## Coefficients:
##                 Estimate   Std. Error t value  Pr(>|t|)    
## (Intercept)  0.635293712  1.058928756  0.5999 0.5513107    
## so4         -0.018498759  0.026350008 -0.7020 0.4859758    
## no3          0.272441233  0.093136053  2.9252 0.0052026 ** 
## acerage      0.000063957  0.000015719  4.0687 0.0001715 ***
## temp         0.099039503  0.044488969  2.2262 0.0306342 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 40.113306)
## 
##     Null deviance: 2421.27  on 53  degrees of freedom
## Residual deviance: 1565.15  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.90       2.35  0.0188
## 2 light           0.506      2.19  0.0284
## 3 water           0.181     -2.52  0.0118
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
10.25 & 0 & 12.27 & 103.40 & 68.61 & 7\\
7.70 & 0 & 11.97 & 99.98 & 67.09 & 7\\
7.33 & 0 & 7.84 & 100.35 & 70.86 & 17\\
10.35 & 1 & 11.99 & 101.12 & 69.67 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -5.72911 -1.33728 -0.26117  1.27730  5.80573 
## 
## Coefficients:
##              Estimate Std. Error t value             Pr(>|t|)    
## (Intercept)  9.052606   7.189354  1.2592               0.2109    
## Fe           0.669556   0.072331  9.2568 0.000000000000004213 ***
## nematodes    0.080759   0.070923  1.1387               0.2576    
## P           -0.691338   0.161376 -4.2840 0.000042259113753374 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.2494 on 100 degrees of freedom
## Multiple R-squared:  0.48645,	Adjusted R-squared:  0.47104 
## F-statistic: 31.574 on 3 and 100 DF,  p-value: 0.000000000000019156
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.17666 -0.55548 -0.05862  0.58807  3.33577 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  237.52  15.412  
##  subject  (Intercept) 4053.15  63.664  
##  Residual              664.44  25.777  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 203.2882    26.9309  7.5485
## attitudepop -19.9596     5.6638 -3.5241
## 
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.0000000 0.0000014 0.2159243
## B 0.0000000 1.0000000 0.0003733 0.0000000
## C 0.0000014 0.0003733 1.0000000 0.0000000
## D 0.2159243 0.0000000 0.0000000 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
