\documentclass[a4paper, 9pt]{scrartcl}\usepackage[]{graphicx}\usepackage[]{color}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.01, 0.02 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.04, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.04, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.04, 0.08 und 1.68. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0025, 0.005 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0025, 0.005 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 9, 13, 9 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.6 +/- 1.095
\item [\textbf{B} \msquare] Es ergibt sich 9.6 +/- 4.8
\item [\textbf{C} \msquare] Es ergibt sich 8.6 +/- 2.4
\item [\textbf{D} \msquare] Es ergibt sich 9.6 +/- 1.095
\item [\textbf{E} \msquare] Es ergibt sich 9.6 +/- 2.19
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 16, 6, 10, 16, 22, 6, 33, 14, 16, 24 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 [11, 25]
\item [\textbf{B} \msquare] Es ergibt sich 16 +/- 10
\item [\textbf{C} \msquare] Es ergibt sich 16 +/- 24
\item [\textbf{D} \msquare] Es ergibt sich 16 [10, 24]
\item [\textbf{E} \msquare] Es ergibt sich 19 +/- 10
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.43, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.75, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.75, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.43, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 1.33, da es sich um ein Anteil handelt.
\end{enumerate}
...
$y = \{22, 18, 23, 18, 17, 22, 19\}$. Berechnen Sie folgende
...
Nach einem Freilandexperiment mit zwei Substrattypen ($torf$ und $70p30n$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Datentabelle mit dem
...
\begin{center}
$9.7, 11.4, 10.6, 9.7, 5.9, 13.3, 10.5, 5.7, 9.8, 10.7, 9, 10.5, 7, 8.6$
\end{center}
...
\begin{minipage}[c]{.4\linewidth} % [b] => Ausrichtung an \caption
  \includegraphics[width=\linewidth]{C:/Users/jokruppa/Documents/GitHub/exam/question/img/boxplot-03-b.png}
\end{minipage}
...
## t = -0.73938, df = 12, p-value = 0.4739
...
## t = -0.21409, df = 12, p-value = 0.8341
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.483748  2.039304
## sample estimates:
...
## 
## data:  drymatter by Fe
## t = -0.16277, df = 10, p-value = 0.8739
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -6.714871  5.800586
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 87.08 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 67.08 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 84.738  42.369  27.182 1.98e-06
## Residuals 20 31.175   1.559
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 77.22 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 92.66 &  &  &  \strut\\
    \hline
...
## Response: weight
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2  16.62   8.308  0.3310 0.722481
## form       1  59.58  59.582  2.3738 0.140783
## dose:form  2 323.59 161.794  6.4459 0.007742
## Residuals 18 451.80  25.100
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -8.857 -1.107 -0.800  2.436  6.143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.800      1.853   9.067 3.87e-06
## waterB         4.057      2.426   1.672    0.125
## 
## Residual standard error: 4.143 on 10 degrees of freedom
## Multiple R-squared:  0.2186,	Adjusted R-squared:  0.1404 
## F-statistic: 2.797 on 1 and 10 DF,  p-value: 0.1254
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.2186$ aus? \textbf{(2 Punkte)}
...
## t = -7.0992, df = 8, p-value = 0.0001021
...
Einflussvariablen ($x$) wurden erhoben: weight, P und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.21 & 0 & 8.55 & 95.65 & 69.27 & 11\\
12.33 & 1 & 8.62 & 99.55 & 67.36 & 15\\
8.47 & 1 & 8.52 & 98.13 & 68.55 & 10\\
9.23 & 0 & 10.50 & 97.03 & 70.40 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.2185 -1.5331 -0.1308  1.8426  4.5910 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.61224    8.49675  -0.307    0.759
## Fe           0.71944    0.08325   8.642 3.41e-13
## light        0.34820    0.58421   0.596    0.553
## nematodes    0.01695    0.08200   0.207    0.837
## 
## Residual standard error: 2.463 on 83 degrees of freedom
## Multiple R-squared:  0.4748,	Adjusted R-squared:  0.4558 
## F-statistic: 25.01 on 3 and 83 DF,  p-value: 1.265e-11
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
FLINTSTONE\_CR & 11 & 9.2 & 0.25 & 50 & 18943\\
CONOWINGO\_CR & 112 & 8.5 & 6.95 & 65 & 27350\\
MEADOW\_BR & 234 & 8.5 & 5.01 & 93 & 4803\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -11.434   -3.502   -1.404    1.706   15.664  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.900e+00  1.495e+00   1.940 0.058193
## do2         -1.376e-01  1.685e-01  -0.817 0.418095
## no3          2.312e-01  6.480e-02   3.568 0.000815
## maxdepth     1.338e-02  3.916e-03   3.415 0.001288
## acerage      1.859e-05  1.607e-05   1.157 0.252894
## 
## (Dispersion parameter for quasipoisson family taken to be 29.39463)
## 
##     Null deviance: 2101.5  on 53  degrees of freedom
## Residual deviance: 1277.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.77      2.14   0.0324
## 2 light           0.461     0.291  0.771 
## 3 water           0.172    -2.28   0.0228
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9177 -0.5680 -0.0744  0.4452  3.4076 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  230.4   15.18   
##  subject  (Intercept) 3999.7   63.24   
##  Residual              659.2   25.67   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.267     26.744   7.526
## attitudepop  -18.193      5.641  -3.225
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.3349326 0.7181309 0.0096439
## high 0.3349326 1.0000000 0.1886738 0.0855361
## low  0.7181309 0.1886738 1.0000000 0.0038403
## mid  0.0096439 0.0855361 0.0038403 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
drinking/eating & 34cm; 27cm; 64.1\% & 37cm; 24cm; 54.1\% & 30cm; 23cm; 64.1\%\\
sitting & 28cm; 26cm; 3.2\% & 35cm; 31cm; 3.2\% & 35cm; 28cm; 5.1\%\\
wing/leg stretching & 26cm; 24cm; 7.3\% & 40cm; 27cm; 0.9\% & 36cm; 20cm; 0.1\%\\
wingflapping & 29cm; 23cm; 18.1\% & 36cm; 25cm; 16.4\% & 39cm; 25cm; 12.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCHMM3Z & 1.0 | 5.0 | Normal \\
    B & GCSIOQO & 2.0 | 4.0 | Klein \\ 
    C & GC8GNDD & 3.0 | 2.5 | Normal \\ 
    D & GC0ZVJG & 2.5 | 3.5 | Klein \\ 
    E & GCN83PC & 5.0 | 1.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 406 n. Chr. f{\"u}r den neuen Lehnsherren
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in year(Sys.Date()): could not find function "{}year"{}}}\end{kframe}
\end{knitrout}
...
3.5\% p.a. {\"u}ber 48 Monate finanzieren.
...
Sie haben den Vektor $A = \{-7, 4, -8\}$ und den Vektor $B = \{12, 3, 5\}$ gegeben.
