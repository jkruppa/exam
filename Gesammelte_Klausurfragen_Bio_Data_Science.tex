...
\begin{graybox}{Ergebnis der Klausur}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 54 Punkten sind aus dem Rechen- und
    Textteil erreicht. 
  \item[] \rule[0ex]{3em}{.4pt}\, von 74 Punkten in Summe.
...
\end{center}
\begin{itemize}
\item Es sind \rule[0ex]{2em}{.4pt}\, von 54 Punkten erreicht worden.
\end{itemize}
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.03, 0.01 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.0075, 0.0025 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.0075, 0.0025 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.04 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.04 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3.56, 0.12, 0.04 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 14, 17, 7, 11 und 14.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12.6 +/- 3.78
\item [\textbf{B} \msquare] Es ergibt sich 12.6 +/- 1.89
\item [\textbf{C} \msquare] Es ergibt sich 11.6 +/- 7.15
\item [\textbf{D} \msquare] Es ergibt sich 12.6 +/- 14.3
\item [\textbf{E} \msquare] Es ergibt sich 13.6 +/- 1.89
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 17, 19, 25, 8, 18, 31 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 [17, 31]
\item [\textbf{B} \msquare] Es ergibt sich 19 +/- 17
\item [\textbf{C} \msquare] Es ergibt sich 26 +/- 17
\item [\textbf{D} \msquare] Es ergibt sich 26 [18, 32]
\item [\textbf{E} \msquare] Es ergibt sich 19 +/- 31
\end{enumerate} 
...
$y = \{12, 14, 14, 14, 16, 15, 13, 16, 19, 14, 13\}$. Berechnen Sie folgende
...
\begin{center}
$9.4, 9, 5.9, 8.7, 10.4, 14.4, 10.1, 11.2, 8.2, 10, 7.4, 9.8, 11.7, 9.2$
\end{center}
...
\item Zeichnen Sie unter die untenstehenden Boxplots die entsprechende
  zugeh{\"o}rige Beobachtungen! \textbf{(3 Punkte)}
...
## t = -2.6312, df = 12, p-value = 0.02193
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.8346126 -0.7368159
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = 4.1641, df = 14, p-value = 0.0009551
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  3.025029 9.451162
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 20.83 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 57.17 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  2.5521  1.2760  0.9012 0.4219
## Residuals 20 28.3175  1.4159
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 112 114 116 100  91 110 129 128 139 155 137 158
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 37.66 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 0.84 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 93.24 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 39 & 687.81 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 631.64 315.822 34.0357 7.651e-07
## form       1 225.97 225.974 24.3529 0.0001069
## dose:form  2  26.89  13.447  1.4491 0.2608955
## Residuals 18 167.02   9.279
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.2000 -2.6786  0.5714  2.8000  3.5714 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.429      1.234  14.129  6.2e-08
## trtB          -3.229      1.911  -1.689    0.122
## 
## Residual standard error: 3.264 on 10 degrees of freedom
## Multiple R-squared:  0.2221,	Adjusted R-squared:  0.1443 
## F-statistic: 2.854 on 1 and 10 DF,  p-value: 0.122
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
15.22 & 1 & 10.90 & 97.05 & 71.47 & 9\\
10.35 & 0 & 11.21 & 103.60 & 70.99 & 9\\
7.91 & 1 & 8.21 & 97.35 & 67.23 & 9\\
10.37 & 0 & 10.35 & 104.46 & 73.93 & 14\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.0335 -1.4093 -0.2826  1.4379  4.8151 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 11.49622    7.69820   1.493   0.1386
## Fe           0.62600    0.07272   8.609 1.44e-13
## nematodes   -0.10922    0.06832  -1.599   0.1132
## P           -0.31168    0.15519  -2.008   0.0474
## 
## Residual standard error: 2.237 on 96 degrees of freedom
## Multiple R-squared:  0.4827,	Adjusted R-squared:  0.4665 
## F-statistic: 29.86 on 3 and 96 DF,  p-value: 1.008e-13
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & so4 & acerage & temp & no3\\
\midrule
HAY\_MEADOW\_BR & 5 & 4.46 & 639 & 20.1 & 3.53\\
NORTH\_BR\_CASSELMAN\_R & 16 & 2.50 & 17419 & 18.0 & 0.29\\
PINEY\_RUN & 36 & 10.17 & 11405 & 23.6 & 2.17\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.651  -4.356  -1.592   2.171  20.714  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  8.500e-01  1.125e+00   0.755 0.453616
## so4         -1.319e-02  2.345e-02  -0.562 0.576370
## acerage      5.806e-05  1.637e-05   3.547 0.000869
## temp         8.788e-02  4.671e-02   1.881 0.065879
## no3          2.703e-01  8.346e-02   3.238 0.002160
## 
## (Dispersion parameter for quasipoisson family taken to be 42.53107)
## 
##     Null deviance: 2398.2  on 53  degrees of freedom
## Residual deviance: 1643.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.32      0.762   0.446
## 2 light           0.491     1.35    0.177
## 3 water           0.136    -0.884   0.376
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2389 -0.5351 -0.1164  0.5657  3.3476 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  190.1   13.79   
##  subject  (Intercept) 3992.9   63.19   
##  Residual              678.3   26.04   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.005     26.623   7.550
## attitudepop  -18.552      5.722  -3.242
## 
...
\begin{verbatim}
##           ctrl      high low       mid
## ctrl 1.0000000 0.0037005   0 0.8129436
## high 0.0037005 1.0000000   0 0.0068107
## low  0.0000000 0.0000000   1 0.0000000
## mid  0.8129436 0.0068107   0 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 11, 15, 14, 5 und 21!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 12, 11, 11, 12 und 11! \textbf{(2 Punkte)}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCWLS3V & 3.0 | 4.5 | Normal \\
    B & GCQ3RXP & 4.5 | 2.0 | Mikro \\ 
    C & GCT48OS & 2.5 | 5.0 | Normal \\ 
    D & GCVOSI2 & 4.0 | 1.0 | Klein \\ 
    E & GCC8SKZ & 2.0 | 2.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1155 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{3, -5, 13\}$ und den Vektor $B = \{1, -4, 2\}$ gegeben.
