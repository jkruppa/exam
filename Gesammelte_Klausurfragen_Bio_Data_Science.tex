...
wurde an 59 Schweinen durchgef{\"u}hrt, wobei jedes Tier eine von
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 15, 15, 9, 9 und 9.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.4 +/- 10.8
\item [\textbf{B} \msquare] Es ergibt sich 10.4 +/- 5.4
\item [\textbf{C} \msquare] Es ergibt sich 12.4 +/- 1.645
\item [\textbf{D} \msquare] Es ergibt sich 11.4 +/- 1.645
\item [\textbf{E} \msquare] Es ergibt sich 11.4 +/- 3.29
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 32, 21, 15, 21, 16, 13 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 +/- 32
\item [\textbf{B} \msquare] Es ergibt sich 26 +/- 15
\item [\textbf{C} \msquare] Es ergibt sich 21 [15, 32]
\item [\textbf{D} \msquare] Es ergibt sich 26 [16, 33]
...
Sie wollen nach einem Feldversuch die Standardabweichung berechnen. Welche folgende Rechenoperationen m{"u}ssen durchgef{"u}hrt werden?
...
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 2.67, da es sich um ein Anteil handelt.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.02, 0.21 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 0.84 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.005, 0.0525 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 0.84 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.005, 0.0525 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 0.84 und 1.68. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
statistischen Testen wird das "`signal"' mit dem "`noise"' zu einer
...
\item [\textbf{B} \msquare] Ja, ein untersuchtes Individuum k{"o}nnen wir mit einem statistischen Test auswerten. Wir erhalten eine Aussage zum Individuum.
...
In einem Gew{\"a}chshausexperiment mit drei L{"u}ftungssystemen und Folientunneln ($ctrl$, $storm$ und $tornado$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Barplots mit dem
gemessenen Frischgewicht (\textit{freshmatter}) von Kartoffel.
...
Nach einem Freilandexperiment mit zwei Bew{"a}sserungstypen ($low$, $mid$ und $high$) als Behandlung
...
Nach einem Freilandexperiment mit zwei Bew{"a}sserungstypen ($low$ und $high$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Datentabelle mit dem
...
\begin{center}
$5, 5, 5, 5, 5, 10, 5, 4, 4, 5, 5, 5, 6, 9, 4, 4, 7, 4, 3, 3, 5, 4, 1, 6, 5, 3, 6, 2, 2, 3, 8, 1, 4$
\end{center}
...
\begin{center}
$12.2, 8.5, 11.3, 7.1, 9.2, 10.5, 10, 6.6, 8.1, 8.1, 11.1, 12.5, 12.2, 11, 9.6, 9.9, 10.7, 10.9, 11.5, 8.1, 8, 11.8, 8.2$
\end{center}
...
## t = -0.14919, df = 14, p-value = 0.8835
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -5.857616  5.095712
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = -0.95974, df = 12, p-value = 0.3561
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -5.232323  2.032323
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 28.07 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 43.56 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 35.429 17.7143  9.6207 0.00144
## Residuals 18 33.143  1.8413
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 55.25 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 437.89 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 138.69 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 257.04 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2  33.62  16.812  0.9263 0.414103
## form       1 183.27 183.274 10.0978 0.005212
## dose:form  2 356.59 178.296  9.8235 0.001306
## Residuals 18 326.70  18.150
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0227395 0.9426628 0.1132631
## high 0.0227395 1.0000000 0.0192223 0.4499493
## low  0.9426628 0.0192223 1.0000000 0.0986775
## mid  0.1132631 0.4499493 0.0986775 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   61  \strut\\
    \hline
...
## -4.000 -1.611  0.000  1.639  3.000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  17.4444     0.7082  24.632 3.77e-14
## waterB        6.5556     1.0015   6.545 6.74e-06
## 
## Residual standard error: 2.125 on 16 degrees of freedom
## Multiple R-squared:  0.7281,	Adjusted R-squared:  0.7111 
## F-statistic: 42.84 on 1 and 16 DF,  p-value: 6.742e-06
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7281$ aus? \textbf{(2 Punkte)}
...
## t = 2.2999, df = 8, p-value = 0.05048
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  0.002098021 0.902157320
## sample estimates:
##       cor 
## 0.6308909
\end{verbatim}
...
Einflussvariablen ($x$) wurden erhoben: dry, height und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
preening & 38cm; 17cm; 8.9\% & 30cm; 20cm; 3.5\% & 37cm; 28cm; 3.5\%\\
wingflapping & 36cm; 25cm; 4.1\% & 36cm; 25cm; 4.1\% & 44cm; 20cm; 3.5\%\\
walking & 39cm; 17cm; 4.1\% & 39cm; 27cm; 6.3\% & 31cm; 30cm; 3.6\%\\
standing & 29cm; 30cm; 7.3\% & 29cm; 27cm; 0.8\% & 34cm; 29cm; 1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCWFLTY & 3.5 | 4.0 | Klein \\
    B & GC65BI8 & 2.0 | 3.5 | Klein \\ 
    C & GCGS53M & 1.0 | 1.5 | Klein \\ 
    D & GCVAHYB & 4.0 | 2.5 | Normal \\ 
    E & GCYG6BB & 4.5 | 2.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 689 n. Chr. f{\"u}r den neuen Lehnsherren
...
\item Wie viele Millionen Kaninchen w{\"u}rden bei einem ungebremsten
  Wachstum \textit{im dritten Jahr} geboren? Berechnen Sie hierf{\"u}r
  zuerst die Anzahl an geboren Weibchen im dritten Jahr! \textbf{(2 Punkte)}
...
4.5\% p.a. {\"u}ber 60 Monate finanzieren.
...
Sie haben den Vektor $A = \{6, 8, 5\}$ und den Vektor $B = \{2, 7, 9\}$ gegeben.
