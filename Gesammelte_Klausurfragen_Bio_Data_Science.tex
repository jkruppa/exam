...
\begin{graybox}{Checkbox für die Version vom \today}
  ...
  Choice Fragen sowie \textbf{70} Rechen- und
  Textaufgaben.
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.03, 0.02, 0.21, 0.89 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.005, 0.0033, 0.035, 0.1483 und 0.0017. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.18, 0.12, 1, 1 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.005, 0.0033, 0.035, 0.1483 und 0.0017. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.18, 0.12, 1, 1 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.52, 0.18, 0.12, 1.26, 5.34 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 5, 3, 6 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8 +/- 1.77
\item [\textbf{B} \msquare] Es ergibt sich 7 +/- 1.77
\item [\textbf{C} \msquare] Es ergibt sich 6 +/- 6.25
\item [\textbf{D} \msquare] Es ergibt sich 7 +/- 12.5
\item [\textbf{E} \msquare] Es ergibt sich 7 +/- 3.54
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 13, 29, 20, 29, 22, 27, 24, 28, 40, 17 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 28 +/- 20
\item [\textbf{B} \msquare] Es ergibt sich 27 +/- 29
\item [\textbf{C} \msquare] Es ergibt sich 27 +/- 20
\item [\textbf{D} \msquare] Es ergibt sich 28 [20, 29]
\item [\textbf{E} \msquare] Es ergibt sich 27 [20, 29]
\end{enumerate}
...
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.17 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.17 liegt keine Overdispersion vor.
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.55 ist
richtig?
...
\item [\textbf{B} \msquare] X beinhaltet eine Spalte. Die Spalte gibt die Verteilungsfamilie vor.
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.38, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 2.67, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.27, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.27, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
\item [\textbf{E} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 0.02
\end{enumerate}
...
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 69
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 136
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 35
...
$y = \{16, 17, 14, 14, 14, 14, 17, 14, 13, 18, 14\}$. Berechnen Sie folgende
...
\begin{center}
$8.9, 11, 11.3, 11.2, 8.8, 10.2, 8.6, 8.6, 11.7, 9.8, 9.8, 9, 10.5, 11.6, 14.6$
\end{center}
...
## t = 0.46145, df = 10, p-value = 0.6544
...
## 
## data:  drymatter by Fe
## t = 0.66579, df = 10, p-value = 0.5206
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.821652  7.078795
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 94.93 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 66.98 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 70.571  35.286  17.784 5.461e-05
## Residuals 18 35.714   1.984
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 137 119 103 103 113  86 139 138 141 158 138 149
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Sch{\"a}tzen Sie den p-Wert der Tabelle mit der Information von den
  ...
  $F_{supp} = 4.17$ und
  $F_{dose} = 3.32$ sowie
  $F_{supp:dose} = 3.32$ ab. Begr{\"u}nden Sie Ihre
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 65.39 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 427.49 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 32.62 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 30 & 909.68 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 36 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 534.32 267.159 15.4656 0.0001234
## form       1  91.37  91.367  5.2892 0.0336404
## dose:form  2  24.92  12.461  0.7214 0.4996142
## Residuals 18 310.94  17.274
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 115$ Sauen. In dem Experiment wurde gemessen,
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   55   \strut\\
    \hline
     &  73 &  42 &  115  \strut\\
  \end{tabular}
\end{center}
...
## -11.2000  -1.1071   0.4714   2.8000   7.1429 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.200      2.261   8.491 6.96e-06
## trtB          10.657      2.961   3.600  0.00485
## 
## Residual standard error: 5.056 on 10 degrees of freedom
## Multiple R-squared:  0.5644,	Adjusted R-squared:  0.5208 
## F-statistic: 12.96 on 1 and 10 DF,  p-value: 0.004851
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: N, weight und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.62 & 0 & 9.66 & 102.40 & 70.78 & 9\\
10.01 & 1 & 11.03 & 105.69 & 75.78 & 10\\
9.22 & 0 & 8.50 & 98.13 & 72.63 & 5\\
11.47 & 0 & 10.98 & 100.30 & 70.55 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.3032 -2.2851 -0.1042  1.8646  6.9351 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  79.6623     3.2721  24.346   <2e-16
## P            -0.5438     0.2207  -2.464   0.0154
## light         1.1462     0.6838   1.676   0.0968
## water        -0.4742     0.2211  -2.145   0.0344
## 
## Residual standard error: 3.103 on 100 degrees of freedom
## Multiple R-squared:  0.1193,	Adjusted R-squared:  0.09285 
## F-statistic: 4.514 on 3 and 100 DF,  p-value: 0.005179
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & maxdepth & so4 & acerage & do2\\
\midrule
BIG\_PIPE\_CR & 18 & 120 & 8.20 & 25440 & 7.5\\
PINEY\_CR & 18 & 100 & 17.84 & 6949 & 9.3\\
DEER\_CR & 26 & 60 & 6.36 & 8297 & 9.9\\
COLLIER\_RUN & 18 & 42 & 17.63 & 6298 & 8.6\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -10.304   -3.684   -1.540    1.365   13.352  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.700e-01  1.346e+00   0.126  0.89999
## maxdepth     1.317e-02  3.857e-03   3.414  0.00129
## so4         -3.160e-02  2.618e-02  -1.207  0.23314
## acerage      3.941e-05  1.763e-05   2.235  0.02999
## do2          2.584e-01  1.258e-01   2.054  0.04536
## 
## (Dispersion parameter for quasipoisson family taken to be 24.76116)
## 
##     Null deviance: 1741.7  on 53  degrees of freedom
## Residual deviance: 1121.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.364    -0.284   0.776
## 2 light           0.460     0.377   0.706
## 3 nematodes       0.147     1.18    0.239
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2054 -0.6410 -0.0868  0.5562  3.2309 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  227.9   15.10   
##  subject  (Intercept) 3917.3   62.59   
##  Residual              701.3   26.48   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.661     26.498   7.648
## attitudepop  -20.503      5.818  -3.524
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0048487 0.1036100 0.7270789
## high 0.0048487 1.0000000 0.1859845 0.0116797
## low  0.1036100 0.1859845 1.0000000 0.1951231
## mid  0.7270789 0.0116797 0.1951231 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 6, 15, 9, 20 und 10!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 9, 5, 7, 5 und 10! \textbf{(2 Punkte)}
...
Sie wollen 80 Sonnenblumen pflanzen und auswerten. Die T{\"o}pfe
haben einen Radius von 4.5cm und eine H{\"o}he von 9cm. Der
