...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.34, 0.21, 0.03 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.068, 0.042, 0.006 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.068, 0.042, 0.006 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1, 1, 0.15 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1.7, 1.05, 0.15 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1, 1, 0.15 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 11, 5, 4 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 7.2 +/- 1.555
\item [\textbf{B} \msquare] Es ergibt sich 7.2 +/- 9.7
\item [\textbf{C} \msquare] Es ergibt sich 8.2 +/- 1.555
\item [\textbf{D} \msquare] Es ergibt sich 7.2 +/- 3.11
\item [\textbf{E} \msquare] Es ergibt sich 6.2 +/- 4.85
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 21, 33, 17, 16, 20, 29, 27, 7, 25, 17 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 +/- 17
\item [\textbf{B} \msquare] Es ergibt sich 21 +/- 29
\item [\textbf{C} \msquare] Es ergibt sich 21 [17, 29]
\item [\textbf{D} \msquare] Es ergibt sich 24 [18, 30]
\item [\textbf{E} \msquare] Es ergibt sich 24 +/- 17
\end{enumerate} 
...
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 3, da es sich um ein Anteil handelt.
\end{enumerate}
...
$y = \{17, 16, 17, 10, 17, 16, 18, 16, 16, 14, 17\}$. Berechnen Sie folgende
...
\begin{center}
$12.6, 9.1, 8.6, 12.5, 10.2, 11.7, 7.6, 11.3, 11, 13.8, 9.6, 8, 6.7, 12.6$
\end{center}
...
\item Treffen Sie mit $T_{\alpha = 5\%} = 1.76$ und dem berechneten $T_{calc}$ eine Aussage
...
## t = -0.97763, df = 12, p-value = 0.3476
...
## t = -2.7765, df = 16, p-value = 0.01348
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.8784189 -0.7882477
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 37 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 52.44 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 89.877  44.939  42.638 6.124e-08
## Residuals 20 21.079   1.054
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 116 120 108 102  95  91 147 142 134 135 167 139
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 3.56 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 21.48 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 407.83 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 204.22 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 376.72 188.360  7.8358 0.003565
## form       1 248.17 248.172 10.3240 0.004822
## dose:form  2  71.89  35.944  1.4953 0.250750
## Residuals 18 432.69  24.038
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   96   \strut\\
    \hline
     &  81 &  75 &  156  \strut\\
  \end{tabular}
\end{center}
...
## -6.5714 -1.4000 -0.4857  1.8071  7.4286 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   12.571      1.419   8.860 4.76e-06
## trtB           2.829      2.198   1.287    0.227
## 
## Residual standard error: 3.754 on 10 degrees of freedom
## Multiple R-squared:  0.1421,	Adjusted R-squared:  0.05628 
## F-statistic: 1.656 on 1 and 10 DF,  p-value: 0.2271
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 5.1745, df = 8, p-value = 0.0008484
...
Einflussvariablen ($x$) wurden erhoben: region, center und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.77 & 0 & 7.51 & 94.91 & 68.68 & 10\\
11.90 & 1 & 11.27 & 100.96 & 66.43 & 9\\
9.24 & 0 & 8.37 & 102.82 & 68.80 & 11\\
9.98 & 1 & 10.11 & 101.30 & 69.49 & 5\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.4057 -1.5540 -0.1894  1.3182  5.6864 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -6.47921    6.55467  -0.988   0.3257
## Fe           0.78635    0.06501  12.095   <2e-16
## light        0.14523    0.44974   0.323   0.7475
## water       -0.23773    0.14129  -1.683   0.0961
## 
## Residual standard error: 2.014 on 85 degrees of freedom
## Multiple R-squared:  0.6346,	Adjusted R-squared:  0.6217 
## F-statistic:  49.2 on 3 and 85 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & maxdepth & no3 & so4 & acerage\\
\midrule
LITTLE\_HUNTING\_CR & 18 & 58 & 0.51 & 7.41 & 7121\\
CABIN\_JOHN\_CR & 21 & 103 & 1.57 & 16.09 & 8612\\
WATTS\_BR & 19 & 82 & 5.25 & 14.19 & 510\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.109  -3.724  -1.929   1.883  16.440  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.533e+00  5.168e-01   2.967 0.004638
## maxdepth     1.392e-02  3.895e-03   3.573 0.000804
## no3          2.568e-01  6.107e-02   4.206 0.000110
## so4         -1.710e-02  2.086e-02  -0.820 0.416310
## acerage      4.622e-05  1.208e-05   3.825 0.000371
## 
## (Dispersion parameter for quasipoisson family taken to be 29.77784)
## 
##     Null deviance: 2443.7  on 53  degrees of freedom
## Residual deviance: 1258.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.400    -0.507  0.612 
## 2 light           0.431     2.13   0.0330
## 3 nematodes       0.150     0.628  0.530
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2806 -0.5177 -0.0728  0.5891  3.3256 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  217.0   14.73   
##  subject  (Intercept) 4099.9   64.03   
##  Residual              686.4   26.20   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.349     27.031   7.486
## attitudepop  -19.616      5.757  -3.408
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000145 0.0381104 0.0000176
## high 0.0000145 1.0000000 0.0000000 0.9474514
## low  0.0381104 0.0000000 1.0000000 0.0000000
## mid  0.0000176 0.9474514 0.0000000 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 12, 12, 5, 11 und 14!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 9, 9, 13, 10 und 4! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes P, Fe und leaf an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCHCTWG & 5.0 | 2.0 | Normal \\
    B & GCWQJ60 & 2.5 | 1.0 | Mikro \\ 
    C & GCUXFYQ & 1.5 | 3.5 | Mikro \\ 
    D & GCGRPTT & 2.0 | 2.5 | Normal \\ 
    E & GCHSEGM & 3.0 | 5.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 888 n. Chr. f{\"u}r den neuen Lehnsherren
...
Disease Virus (RHDV) kosten 10\$ und der durchf{\"u}hrende Arzt
verlangt ca. 40\$.
...
\item Stellen Sie das lineare Gleichungssystem aus der Temperaturtabelle
  auf!  \textbf{(1 Punkt)}
\item Bestimmen Sie die Stammfunktionen f{\"u}r Ihr lineares Gleichungsystem!
  \textbf{(1 Punkt)}
...
\item Im zweiten Versuch ziehen Fridolin und die Rentner mit einem
  $80^\circ$ Winkel mit ihrem Seil an dem Traktor. Welche Kraft
...
Sie haben den Vektor $A = \{12, 6, 14\}$ und den Vektor $B = \{-6, 6, -4\}$ gegeben.
