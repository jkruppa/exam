...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.001, 0.01 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0003, 0.0025 und 0.2225. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0003, 0.0025 und 0.2225. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.004, 0.04 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.004, 0.04 und 3.56. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.004, 0.04 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.2 +/- 12.6
\item [\textbf{B} \msquare] Es ergibt sich 11.2 +/- 5.02
\item [\textbf{C} \msquare] Es ergibt sich 11.2 +/- 2.51
\item [\textbf{D} \msquare] Es ergibt sich 11.2 +/- 25.2
\item [\textbf{E} \msquare] Es ergibt sich 12.2 +/- 2.51
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 16 [9, 23]
\item [\textbf{B} \msquare] Es ergibt sich 21 [9, 23]
\item [\textbf{C} \msquare] Es ergibt sich 16 +/- 9
\item [\textbf{D} \msquare] Es ergibt sich 21 +/- 9
\item [\textbf{E} \msquare] Es ergibt sich 16 +/- 23
\end{enumerate}
...
In einem Stallexperiment mit $n = 109$ Ferkeln wurden verschiedene
...
\item [\textbf{C} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -2.72
\item [\textbf{D} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 7.42
\item [\textbf{E} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 7.42
\end{enumerate}
...
$y = \{18, 21, 18, 20, 17, 19, 21\}$. Berechnen Sie folgende
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.94 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 9.88 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 210.5 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2413.38 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 108.05 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 717.62 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 74 Mastschweinen durchgef{\"u}hrt, wobei
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   92  \strut\\
    \hline
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, S und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
CABIN\_JOHN\_CR & 21 & 15.0 & 8612 & 103 & 16.09\\
HERRINGTON\_RUN & 1 & 24.5 & 7056 & 60 & 9.82\\
MORGAN\_RUN & 76 & 16.9 & 9765 & 130 & 5.74\\
HAINES\_BR & 98 & 16.8 & 1967 & 50 & 26.44\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.0000001 0.0000005 0.0000000
## B 0.0000001 1.0000000 0.6354730 0.0123340
## C 0.0000005 0.6354730 1.0000000 0.0037075
## D 0.0000000 0.0123340 0.0037075 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
