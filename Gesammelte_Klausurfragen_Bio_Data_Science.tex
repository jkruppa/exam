...
\midrule
dustbathing & 33cm; 35cm; 3.5\% & 36cm; 25cm; 4.5\% & 33cm; 33cm; 8.9\%\\
standing & 31cm; 26cm; 0.8\% & 30cm; 22cm; 0.2\% & 43cm; 27cm; 0.4\%\\
foraging incl. scratching & 39cm; 25cm; 1.2\% & 24cm; 19cm; 1.2\% & 40cm; 23cm; 1.2\%\\
drinking/eating & 32cm; 18cm; 12.8\% & 31cm; 25cm; 14.2\% & 31cm; 13cm; 18.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCYWLOG & 3.5 | 3.5 | Klein \\
    B & GCAAUIF & 2.5 | 4.0 | Klein \\ 
    C & GC7KPXB & 1.0 | 5.0 | Mikro \\ 
    D & GCOYDUC & 1.5 | 3.0 | Mikro \\ 
    E & GCJBE6Q & 5.0 | 2.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 860 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.1\times 10^{10}} - \ensuremath{1.2\times 10^{9}} \cdot 2^{-0.3 \cdot t + 4.1}
\end{equation*}
...
und blicken in das puderrote Gesicht einem M{"a}dchen mit Z{"o}pfen und Zahnspange. "'Wieso?"', entfährt es
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2021 blieben die Erträge von Blaubeeren mit \ensuremath{8\times 10^{4}}t in dem prognostizierten Rahmen aber hinter den Erwartungen zurück. Die Menge reduzierte sich um 6.1\%. Die Exporte für Avocados stiegen in dem gleichen Zeitraum um 22.1\% auf \ensuremath{2.1\times 10^{5}} an.
