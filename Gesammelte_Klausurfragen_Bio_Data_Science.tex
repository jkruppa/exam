...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.34, 0.01 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.085, 0.0025 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 0.04 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1.36, 0.04 und 1.68. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.085, 0.0025 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 0.04 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 6, 11, 11 und 3.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 7.2 +/- 6.35
\item [\textbf{B} \msquare] Es ergibt sich 8.2 +/- 1.78
\item [\textbf{C} \msquare] Es ergibt sich 8.2 +/- 12.7
\item [\textbf{D} \msquare] Es ergibt sich 9.2 +/- 1.78
\item [\textbf{E} \msquare] Es ergibt sich 8.2 +/- 3.56
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 28, 0, 11, 22, 12, 18, 13, 20, 30, 25 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 20 +/- 28
\item [\textbf{B} \msquare] Es ergibt sich 21 [13, 29]
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 12
\item [\textbf{D} \msquare] Es ergibt sich 20 +/- 12
\item [\textbf{E} \msquare] Es ergibt sich 20 [12, 28]
\end{enumerate} 
...
$y = \{17, 12, 16, 16, 14, 13, 13, 17, 16, 13, 13\}$. Berechnen Sie folgende
...
\begin{center}
$9, 11.7, 8.2, 10.2, 9.1, 7.9, 9.2, 9.2, 11.9, 10, 10.6, 9.9, 15.5, 7.6, 11.6$
\end{center}
...
## 
## data:  waterintake by infusion
## t = -0.12734, df = 12, p-value = 0.9008
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.587116  2.301401
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 14.38 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 32.57 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  79.342  39.671  7.3078 0.004146
## Residuals 20 108.571   5.429
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 101 125 118 111  84  93 150 133 144 153 162 160
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 488.46 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 71.72 &  &  &  \strut\\
    \hline
...
## Response: weight
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 325.63 162.813 17.5148 5.981e-05
## form       1   2.13   2.135  0.2296    0.6376
## dose:form  2 351.69 175.843 18.9164 3.762e-05
## Residuals 18 167.32   9.296
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 103$ Sauen. In dem Experiment wurde gemessen,
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   54  \strut\\
    \hline
...
## -2.6000 -1.4286 -0.5143  0.7786  4.5714 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  19.4286     0.8528  22.781 5.99e-10
## waterB        4.1714     1.3212   3.157   0.0102
## 
## Residual standard error: 2.256 on 10 degrees of freedom
## Multiple R-squared:  0.4992,	Adjusted R-squared:  0.4491 
## F-statistic: 9.968 on 1 and 10 DF,  p-value: 0.01021
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.4992$ aus? \textbf{(2 Punkte)}
...
## t = 8.0028, df = 8, p-value = 4.356e-05
...
Einflussvariablen ($x$) wurden erhoben: P, fertilizier und dry. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.91 & 0 & 9.16 & 96.55 & 68.12 & 15\\
10.28 & 0 & 10.02 & 103.62 & 71.70 & 6\\
8.35 & 1 & 9.64 & 102.47 & 67.36 & 6\\
10.79 & 0 & 10.78 & 103.55 & 76.23 & 15\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.5878 -2.0226  0.0852  1.7579  7.1462 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 76.82176    2.83247  27.122  < 2e-16
## water       -0.05774    0.20493  -0.282  0.77871
## light        0.04639    0.68945   0.067  0.94649
## P           -0.57099    0.20470  -2.789  0.00632
## 
## Residual standard error: 3.106 on 100 degrees of freedom
## Multiple R-squared:  0.07395,	Adjusted R-squared:  0.04617 
## F-statistic: 2.662 on 3 and 100 DF,  p-value: 0.05214
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & acerage & temp & so4\\
\midrule
OWENS\_CR & 80 & 8.6 & 9961 & 21.8 & 9.07\\
BLUE\_LICK\_RUN & 1 & 8.5 & 2217 & 14.3 & 10.85\\
LITTLE\_PAINT\_BR & 63 & 9.4 & 5794 & 17.5 & 12.27\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -10.056   -3.805   -1.849    2.146   23.186  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.379e-01  1.763e+00   0.078  0.93798
## do2          2.917e-01  1.422e-01   2.052  0.04553
## acerage      4.761e-05  1.556e-05   3.060  0.00358
## temp         3.559e-02  4.979e-02   0.715  0.47818
## so4         -2.600e-02  2.788e-02  -0.932  0.35570
## 
## (Dispersion parameter for quasipoisson family taken to be 40.93206)
## 
##     Null deviance: 1927.5  on 53  degrees of freedom
## Residual deviance: 1382.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.393     0.585   0.558
## 2 light           0.429     0.381   0.703
## 3 nematodes       0.146    -0.895   0.371
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 798.7
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2396 -0.5802 -0.0971  0.5852  3.3425 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  239.7   15.48   
##  subject  (Intercept) 3953.8   62.88   
##  Residual              692.1   26.31   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   202.57      26.64   7.604
## attitudepop   -19.68       5.78  -3.404
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.1981804 0.0221624 0.5947641
## high 0.1981804 1.0000000 0.0007671 0.0733681
## low  0.0221624 0.0007671 1.0000000 0.0710803
## mid  0.5947641 0.0733681 0.0710803 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 5, 14, 10, 16 und 10!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 6, 17, 15, 9 und 9! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, leaf und P an drei verschiedenen Messterminen.
...
\midrule
foraging incl. scratching & 42cm; 25cm; 50.1\% & 29cm; 32cm; 50.1\% & 24cm; 24cm; 50.1\%\\
wingflapping & 33cm; 22cm; 2.1\% & 33cm; 28cm; 1.8\% & 30cm; 20cm; 1.8\%\\
sitting & 29cm; 33cm; 0.8\% & 29cm; 21cm; 0.2\% & 28cm; 38cm; 0.9\%\\
walking & 30cm; 20cm; 1.2\% & 35cm; 26cm; 0.9\% & 36cm; 23cm; 0.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCTSIFQ & 1.5 | 2.5 | Normal \\
    B & GCCDB1J & 2.5 | 4.5 | Klein \\ 
    C & GCMYO4L & 4.5 | 3.5 | Normal \\ 
    D & GCSDU5C & 2.0 | 2.0 | Normal \\ 
    E & GCXHKF5 & 4.0 | 4.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 588 n. Chr. f{\"u}r den neuen Lehnsherren
...
\paragraph{Network-Marketing, eine Art Schneeballschlacht!}
...
viel Aufwand und von zu Hause aus. Dann wollen wir
mal loslegen. Schnell ein YouTube-Werbevideo gedreht und auf geht es mit
unserem Network-Marketing. Aber Moment, wie funktioniert Network-Marketing
eigentlich und was hat das alles mit einer Schneeballschlacht zu tun? Dann
wollen wir mal in die Untiefen des "`Business"' abtauchen\footnote{Die
  Quelle der Inspiration f{\"u}r die Aufgabe war der folgendes YouTube Video:
  \href{https://youtu.be/UOKkZF_qK9M?si=uf4foJVFKfeQMwSw}{Simplicissimus --
    Die meistgesuchte Betr{\"u}gerin der Welt}}.
...
Sie haben den Vektor $A = \{12, 15, 9\}$ und den Vektor $B = \{0, 2, 1\}$ gegeben.
