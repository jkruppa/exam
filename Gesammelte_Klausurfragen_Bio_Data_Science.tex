...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 8, 11, 14, 9 und 13.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11 +/- 1.275
\item [\textbf{B} \msquare] Es ergibt sich 11 +/- 6.5
\item [\textbf{C} \msquare] Es ergibt sich 10 +/- 3.25
\item [\textbf{D} \msquare] Es ergibt sich 11 +/- 2.55
\item [\textbf{E} \msquare] Es ergibt sich 12 +/- 1.275
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 21, 31, 27, 14, 20, 25, 30, 23, 22, 19 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 20
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 30
\item [\textbf{C} \msquare] Es ergibt sich 26 +/- 20
\item [\textbf{D} \msquare] Es ergibt sich 26 [21, 31]
\item [\textbf{E} \msquare] Es ergibt sich 23 [20, 30]
\end{enumerate} 
...
In dem folgenden Histogramm von $n = 189$ Pflanzen ist welche
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.02, 0.03, 0.89 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.1, 0.15, 1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.1, 0.15, 1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.004, 0.006, 0.178 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.004, 0.006, 0.178 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.7, 0.1, 0.15, 4.45 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\begin{center}
$3, 6, 5, 4, 4, 2, 2, 4, 9, 2, 5, 5, 6, 4, 5, 7, 3, 6, 5, 7, 2, 1, 3, 5, 5, 5, 5, 5, 6, 9, 4, 6, 4$
\end{center}
...
\begin{center}
$12, 9.8, 10.4, 11.4, 11.9, 11, 11.5, 11.9, 11.5, 9.9, 12.9, 9.7, 8.7, 11.4, 12, 11.1, 9.4, 11, 9.7, 11.7$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ beibehalten & Testentscheidung & Richtige Entscheidung & 5\% \\
  \end{tabular}
  \end{center}
...
## t = -5.0102, df = 12, p-value = 0.0003041
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -9.634154 -3.794418
## sample estimates:
...
In einem Gew{"a}chshausexperiment wurde der Ertrag von Erbsen unter drei verschiedenen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 113.41 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 76.22 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 88.667  44.333  18.019 5.048e-05
## Residuals 18 44.286   2.460
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 7.05 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 169.54 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 280.59 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 282.25 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2 211.806 105.903  8.7279 0.002240
## form       1 183.834 183.834 15.1506 0.001067
## dose:form  2  70.628  35.314  2.9104 0.080324
## Residuals 18 218.409  12.134
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000024 0.2200175 0.1400841
## high 0.0000024 1.0000000 0.0000001 0.0001927
## low  0.2200175 0.0000001 1.0000000 0.0093918
## mid  0.1400841 0.0001927 0.0093918 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 165$ Sauen. In dem Experiment wurde gemessen,
...
## -6.8571 -0.6143  1.1429  2.3071  3.1429 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.200      1.573  12.209 2.48e-07
## waterB         7.657      2.059   3.719  0.00398
## 
## Residual standard error: 3.516 on 10 degrees of freedom
## Multiple R-squared:  0.5803,	Adjusted R-squared:  0.5384 
## F-statistic: 13.83 on 1 and 10 DF,  p-value: 0.003983
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.5803$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: dry, S und weight. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
wingflapping & 41cm; 15cm; 0.6\% & 37cm; 24cm; 0.8\% & 35cm; 23cm; 0.2\%\\
foraging incl. scratching & 35cm; 21cm; 8.1\% & 34cm; 25cm; 6.3\% & 31cm; 30cm; 3.6\%\\
wing/leg stretching & 30cm; 23cm; 1.2\% & 28cm; 25cm; 5.1\% & 37cm; 21cm; 5.1\%\\
preening & 42cm; 26cm; 1\% & 35cm; 17cm; 1.2\% & 25cm; 25cm; 0.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\item Sie entnehmen der Literatur folgende Aussage zur Verteilung der
  ...
  Abbildung!  \textbf{(1 Punkt)}
\item Ein Gans braucht Platz f{\"u}r sich
  selbst. Berechnen Sie nun die K{\"o}rperfl{\"a}che $a$, die ein Tier
  Gans einnimmt. Welche Annahmen haben Sie f{\"u}r die
  Berechnung der G{"a}nsek{\"o}rperfl{\"a}che getroffen? \textbf{(2
    Punkte)}
\end{enumerate}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC3YJXD & 4.5 | 2.0 | Klein \\
    B & GCX6CL0 & 2.0 | 3.0 | Mikro \\ 
    C & GCJMIZH & 2.5 | 4.5 | Klein \\ 
    D & GCFMMEZ & 5.0 | 1.5 | Mikro \\ 
    E & GCOTO1S & 1.5 | 1.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 518 n. Chr. f{\"u}r den neuen Lehnsherren
...
\item Wie viele Wochen ben{\"o}tigen die Viren um theoretisch die gesamte
  Kaninchenpopulation nach 9 Jahren Wachstum zu durchseuchen? \textbf{(1
    Punkt)}
\end{enumerate}
...
Sie haben den Vektor $A = \{-3, 14, -2\}$ und den Vektor $B = \{0, 2, -3\}$ gegeben.
