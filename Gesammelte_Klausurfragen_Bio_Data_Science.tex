...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\square\!\square\!\square\!\square\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\blacksquare\!\square\!\square\!\square\!\blacksquare\!\square\!\square\!\square\!\blacksquare\!\square\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\item [\textbf{D} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Behandlungsbedingungen erklärt wird. Daher werden 23\% der Varianz erklärt.
...
In einer Studie zur Bewertung der Wirkung von Vitamin D auf das Zahnwachstum bei Igeln entstand folgende Abbildung. Der Versuch wurde an 51 Tieren durchgeführt, wobei jedes Tier eine von  drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Welche Aussage ist im Bezug auf eine zweifaktorielle ANOVA richtig?
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 11, 13, 14 und 13.



\begin{enumerate}
\item [\textbf{A} \msquare] Es berechnet sich 11.6 +/- 2.79
\item [\textbf{B} \msquare] Es ergibt sich 10.6 +/- 3.9
\item [\textbf{C} \msquare] Sie erhalten 11.6 +/- 1.395
\item [\textbf{D} \msquare] Es berechnet sich 12.6 +/- 7.8
\item [\textbf{E} \msquare] Sie erhalten 11.6 +/- 1.67
\end{enumerate} 
...
Gegeben ist $y$ mit 9, 31, 25, 23, 14, 27 und 42. Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile.




\begin{enumerate}
\item [\textbf{A} \msquare] Es berechnet sich 24 [15; 32]
\item [\textbf{B} \msquare] Es berechnet sich 26 [15; 30]
\item [\textbf{C} \msquare] Es ergibt sich 25 [14; 31]
\item [\textbf{D} \msquare] Es ergibt sich 24 +/- 14
...
Sie haben $n = 179$ Pflanzen geerntet und wollen sich nun die Verteilung der Pflanzen einmal in einem Histogramm anschauen. Welche Verteilung ist dargestellt?
...
Sie führen ein Experiment zur Behandlung von Klaueninfektionen bei Kühen durch. Bei 4 Tieren finden Sie eine Erkrankung der Klauen vor und 12 Tiere sind gesund. Welche Aussage über den Effektschätzer Risk ratio ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Das Verhältnis der Chancen Risk ratio ergibt ein Chancenverhältnis von 0.25. Wir sind an der Chance krank zu sein interessiert.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.25, da es sich um eine Chancenverhältnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.33, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Da es sich um ein Chancenverhältnis handelt ergibt sich ein Risk ratio von 0.33.
\item [\textbf{E} \msquare] Das Verhältnis der Anteile Risk ratio ergibt ein Anteilsverhältnis von 0.25. Wir sind am Anteil der Kranken interessiert.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.21, 0.42 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.84, 1 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0525, 0.105 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.84, 1 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.84, 1.68 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0525, 0.105 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\item [\textbf{C} \msquare] Es liegt ein signifikanter Unterschied vor. Der Effekt liegt bei 0.5.
...
\item [\textbf{E} \msquare] Der Test deutet auf keinen signifikanten Unterschied hin. Der Effekt liegt vermutlich bei 5.
\end{enumerate}
...
Steffen steht vor einem ersten Problem, denn wenn es nach seiner Betreuer geht, soll er in einem einer Klimakammer Erbsen auswertet. Soweit eigentlich alles passend. Besser wäre was anderes gewesen. Am Ende dann doch besser Klemmbausteine. Wunderbar. Eine echte Ablenkung für Steffen. Das heißt erstmal überlegen für Steffen. Aus den Boxen wummert Taylor Swift und sein Mund ist verklebt von Oreos. 'Herrlich', denkt Steffen. Die Behandlung werden verschiedene Substrattypen ($torf$, $40p60n$ und $70p30n$) sein. In seiner Exceldatei wird er den Endpunkt ($Y$) \textit{Frischegewicht} als \textit{freshmatter} aufnehmen. Vorab soll Steffen aber eimal die folgenden Barplots seiner Betreuer nachbauen, damit er den \Rlogo Code schonmal für später vorliegen hat. Damit geht das Problem schon los. Steffen und die innere Leere, eine unendliche Geschichte mit kniffeligen Wendungen.
...
Paula steht vor einem ersten Problem, denn wenn es nach ihrer Betreuerin geht, soll sie in einem einem Freilandversuch Brokoli auswertet. Soweit eigentlich alles passend. Besser wäre was anderes gewesen. Harry Potter. Ein wunderbares Hobby um sich drin zu verlieren und Abstand zu bekommen. Paula denkt gerne über Harry Potter nach. Die Behandlung waren verschiedene Substrattypen ($torf$, $40p60n$ und $70p30n$). In ihrer Exceldatei hat sie den Messwert ($Y$) \textit{Proteingehalt} als \textit{protein} aufgenommen. Nun soll Paula die Daten eimal als Barplots in einer Präsentation visualisieren, damit ihrer Betreuerin wieder klar wird, was sie eigentlich nochmal gemacht hat und was für ein Ergbnis in einem statistischen Test zu erwarten wäre. Wäre da nicht noch etwas. Wenn der Perfektionismus nicht wäre, ja dann wäre wohl vieles möglich für Paula! Aber so... Aber egal. Einfach mal raus um zu Fechten. Ohne Ziel und Uhr. Das ist was für Paula.
...
\item Wenn Paula \textit{keinen Effekt} zwischen den Behandlungen von Brokoli erwarten würde, wie sehen dann die Barplots aus? \textit{Antworten Sie mit einer Skizze der Barplots!}
  \textbf{(1 Punkt)}
\end{enumerate} 
\clearpage
% -----------------------------------------------------------------------
...
Boxplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Jonas nicht gemerkt, welche statistischen Maßzahlen für einen Barplot erhoben werden müssen. Besser wäre was anderes gewesen. Am Ende dann doch besser Stricken. Wunderbar. Eine echte Ablenkung für Jonas. Das ist in soweit doof, da nach seinem Betreuer erstmal ein Barplot nachgebaut werden soll, bevor es mit seinem Projektbericht losgeht. Dann hat er schonmal den \Rlogo Code vorliegen und nachher geht dann alles schneller. Na dann mal los. Jonas schafft sich die nötige Stimmung. Wenn Iron Maiden ertönt, dann sucht das Meerschweinchen schleunigst Schutz unter dem Sofa. Jonas schüttelt den Kopf. In der Behandlung für Erbsen werden verschiedene Genotypen ($AA$, $AB$ und $BB$) sein. Erfasst wird als Messwert ($Y$) \textit{Frischegewicht}. Jonas soll dann \textit{freshmatter} in seiner Exceldatei eintragen. Aber nur in passender Atmospäre! Schon dutzende Male gesehen: Mission Impossible. Aber immer noch großartig zusammen mit Werther's Popcorn.
...
In ihrem Projektbericht möchte Tina gerne die Daten aus einem Kreuzungsexperiment mit Schweinen in einem Histogramm darstellen. Das Histogramm erlaubt ihr dabei Rückschlüsse auf die Verteilung über den Messwert ($Y$) zu treffen. Aus den Boxen wummert Tocotronic und ihr Mund ist verklebt von Katjes. 'Herrlich', denkt Tina. In seinem Experiment hat Tina die Anzahl an weißen Blutkörperchen gezählt. Es wäre einfacher, wenn da nicht noch was wäre. Tina und die Vergesslichkeit, eine unendliche Geschichte mit kniffeligen Wendungen. Tina streichelt liebevoll die Spinne. Der Kopf ist in ihrem Schloß vergraben um den Klang von Tocotronic zu dämpfen.

\begin{center}
Die Anzahl an weißen Blutkörperchen: 4, 2, 3, 1, 3, 3, 1, 6, 3, 1, 6, 2, 6, 3, 5, 5, 3, 3, 4, 5, 5, 2, 3, 2, 7, 3, 6, 4, 9, 7
\end{center}
...
In ihrer Projektbericht möchte Paula gerne die Daten aus einem Leistungssteigerungsversuch mit Schweinen in einem Histogramm darstellen. Das Histogramm erlaubt ihr dabei Rückschlüsse auf die Verteilung über den Endpunkt ($Y$) zu treffen Aus den Boxen wummert White Lies und ihr Mund ist verklebt von Smarties. 'Herrlich', denkt Paula. In seinem Experiment hat Paula die mittlere Anzahl an weißen Blutkörperchen gezählt. Es wäre einfacher, wenn da nicht noch was wäre. Paula und der Perfektionismus, eine unendliche Geschichte mit kniffeligen Wendungen. Wenn White Lies ertönt, dann sucht die Ratte schleunigst Schutz unter dem Sofa. Paula schüttelt den Kopf.

\begin{center}
Die mittlere Anzahl an weißen Blutkörperchen: 6.7, 9.2, 11.2, 9.8, 11.2, 7.2, 10.6, 8.5, 10.6, 11.4, 7.1, 11, 11.2, 8.4, 6.9, 12.4, 12.5, 13.7, 7.8, 11.4, 14.4, 9.3, 10.3, 9.3, 11.5
\end{center}
...
Wenn es nach Steffen ginge, wäre er schon längst fertig mit seiner Abschlussarbeit. In seiner Abschlussarbeit hatte er ein Kreuzungsexperiment in der Uckermark durchgeführt. Nach der Meinung seiner Betreuerin sieht das jedoch etwas anders aus. Jetzt soll er doch noch eine explorative Datenanalyse für den Zusammenhang zwischen durchschnittlichen Bewegungsscore [Movement/h] und Protein/Fettrate [\%/kg] in Schweinen durchführen. Wie nervig! Da zwei kontinuierliche Variablen vorliegen, geht die explorative Datenanalyse leider nicht mit Boxplots oder Barplots.

\begin{table}[!h]
\centering
\begin{tabular}{cc}
\toprule
Protein/Fettrate [\%/kg] & Durchschnittlichen Bewegungsscore [Movement/h]\\
\midrule
14.9 & 26.1\\
13.2 & 18.6\\
14.1 & 21.8\\
...
Zwei kategoriale Variablen darzustellen ist nicht so einfach. Nilufar hatte erst über einen Mittelwert nachgedacht, dann aber die Idee verworfen. In ein Kreuzungsexperiment im Wendland hatte sie sich zum einen die Behandlung Außenklimakontakt [ja/nein] und zum anderen die Messung Schlachtgewicht im Zielbereich [ja/nein] im Kontext von Schweinen angeschaut. Jetzt möchte ihre Betreuerin erstmal die langen Tabellen mit ja/nein in einer explorativen Datenanalyse zusammengefasst bekommen. Sonst geht es bei ihrem Projektbericht nicht weiter.
...
\toprule
Außenklimakontakt & Schlachtgewicht im Zielbereich\\
\midrule
ja & nein\\
nein & nein\\
ja & nein\\
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ wahr & 20\% & 5\% & H$_0$ beibehalten \\
  \end{tabular}
  \end{center}
...
Steffen ist im Wendland für einen Pilotexperiment mit sehr geringer Fallzahl $(n_1 = n_2 = 3)$ mit Schweinen. Allein diese Tatsache ist für ihn eine Erzählung wert. Für seine Abschlussarbeit musste er ein Kreuzungsexperiment mit Schweinen durchführen und das sollte laut seinem Betreuer an diesem Ort besonders gut gelingen, da man hier gut neue technische Anlagen und Behandlungen fernab der Bevölkerung testen könne. Zeugen gibt es hier jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn seine Behandlung Flüssignahrung ($ctrl$ und $flOw$) und der Messwert Protein/Fettrate [\%/kg] sollen mit einem t-Test ausgewertet werden. Immerhin weiß er, dass sein Messwert einer Normalverteilung folgt. 
...
Der t-Test. Mark erschaudert. Ein mächtiges Werkzeug in den Händen desjenigen, der einen normalverteilten Messwert ($Y$) hat. Aber erstmal überhaupt den t-Test rechnen können. Wie sah das Experiment von Mark überhaupt aus? Mark hat ein Kreuzungsexperiment mit Schweinen durchgeführt. Dabei wurde die Behandlung Genotypen ($AA$ und $BB$) an den Schweinen getestet. Gemessen hat Mark dann als Messwert Protein/Fettrate [\%/kg]. Warum der Versuch im Wendland für seinen Projektbericht stattfinden musste, ist ihm bis heute ein Rätsel. Egal. Gibt es jetzt einen Zusammenhang zwischen der Behandlung und Protein/Fettrate [\%/kg]?
...
Jessica ist im Teuteburgerwald für einen Versuch mit Schweinen. Allein diese Tatsache ist für sie eine Erzählung wert. Für ihre Abschlussarbeit musste sie ein Kreuzungsexperiment mit Schweinen durchführen und das sollte laut ihrer Betreuerin an diesem Nichtort besonders gut gelingen. Ablenkung gibt es jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn ihre Behandlung Flüssignahrung ($ctrl$ und $flOw$) und der Messwert Schlachtgewicht [kg] sollen mit einem t-Test ausgewertet werden. Immerhin weiß sie, dass ihr Messwert einer Normalverteilung folgt. 
...
Alles voll mit Schweinen. Das haben Steffen und Jessica gemeinsam in einem Projektbericht gemacht! Worum ging es aber konkret? Beide haben als einen normalverteilten Messwert ($Y$) Gewichtszuwachs in der 1LW von Schweinen bestimmt. Die Daten haben beide zusammen in einem Stallexperiment erhoben. In dem Experiment ging es um eine vorher/nachher Untersuchung an den gleichen Schweinen. Als Behandlung wurde Flüssignahrung ($1l/d$ und $5l/d$) eingesetzt. Nach der Meinung des Betreuers muss hier ein gepaarter t-Test gerechnet werden.
...
Leider kennen sich Steffen und Jessica mit der Berechnung eines gepaarten t-Tests überhaupt nicht aus. Deshalb brauchen sie beide bei der Berechnung Ihre Hilfe!
...
'Wir waren im Oldenburger Land um Schweinen in einem Stallexperiment zu messen.', Yuki legt das Dokument auf den Tisch und schaut Tina und Mark fragend an. Beide schauen fragend zurück. Die beiden sind zu ihr gekommen, da sie sich nicht mit \Rlogo auskennen und daher Hilfe bei der Interpretation des t-Tests brauchen. Kein Problem. Aber worum es in dem Versuch geht, lässt sich nur aus dem Text in seiner Hand erahnen. Vielleicht hilft da ja die Ausgabe des t-Tests in R weiter.
...
## t = 4.0199, df = 16, p-value = 0.0009898
...
Helfen Sie Yuki bei der Interpretation des t-Tests! Sonst geht es auch für Tina und Mark nicht weiter.
...
\Rlogo ist schon ein tolles Programm, wenn man mit dem Ding umgehen kann. Super umgehen kann damit Nilufar. Deshalb sind auch Mark und Alex bei ihr um sich bei einem gemeinsamen Projekt helfen zu lassen. Beide arbeiten gemeinsam an einer Abschlussarbeit. In dem zu beschreibenden Versuch geht es im Teuteburgerwald um einem Stallexperiment mit Schweinen. Dabei ging darum herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Genotypen ($AA$ und $BB$) und dem Messwert Fettgehalt [\%/kg] gibt. Da der Messwert Fettgehalt [\%/kg] normalverteilt ist kann ein t-Test gerechnet werden.
...
## t = 3.7842, df = 17, p-value = 0.001481
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##   3.794155 13.355845
## sample estimates:
...
Nilufar und Alex haben sich dazu entschieden zusammenzuarbeiten. Das sollte alles etwas einfacher machen. Jeder hat zwar ein getrenntes Themenfeld aber den Hauptversuch machen beide gemeinsam. Das hat sich schonmal als gut Idee soweit herausgestellt. In einer Abschlussarbeit sollen beide herausfinden, ob es einen Zusammenhang zwischen Ernährungszusatz ($ohne$ und $14d$) und Fettgehalt [\%/kg] gibt. Die Besonderheit ist hierbei, dass die Messungen an der gleichen Beobachtung stattfinden. Beide messen also zweimal an den gleichen Schweinen. Hier muss dann wohl auf einen normalverteilten Messwert ($Y$) ein gepaarter t-Test gerechnet werden. Leider kennen sich beide nicht sehr gut in \Rlogo aus.
...
Jetzt brauchen Nilufar und Alex Ihre Hilfe bei der Berechnung eines gepaarten t-Tests in \Rlogo um ihre Arbeit dann in diesem Semester noch abschließen zu können.
...
Leider kennen sich Nilufar und Steffen mit Darstellung einer einfaktoriellen ANOVA überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe! 
...
'Uff... die einfaktorielle ANOVA. Und wie füllen wir jetzt die Tabelle der ANOVA aus und schauen, ob da was signifikant ist?', Steffen hebt die Augenbraue. 'Das ist eine sehr gute Frage. Ich glaube man kann alles in der Tabelle relativ einfach mit wenigen Informationen berechnen.', meint Jessica dazu. Steffen hatte sich in ein Stallexperiment verschiedene Schweinen angeschaut. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Flüssignahrung ($ctrl$, $superIn$ und $flOw$) und dem Messwert Fettgehalt [\%/kg] gibt.
...
\toprule
    ...
    \midrule
   \textbf{Flüssignahrung}  & 2 & 46.02 &  &  &  \strut\\
   \textbf{error}  & 17 & 88.53 &  &  &  \strut\\
...
'Als erstes bauen wir uns aus unsere Daten die ANOVA Tabelle dann sehen wir schon, ob unser Gruppenvergleich in der ANOVA signifikant ist.', Mark schaut Tina fragend an und hofft auf eine positive Regung im Gesicht. Wird aber enttäuscht. Tina tut sich auch sehr schwer mit der einfaktoriellen ANOVA. Nun möchte erstmal ihre Betreuung der Arbeit eine ANOVA Tabelle sehen. Was immer da auch drin zu erkennen sein mag. Beide waren im Teuteburgerwald um ein Kreuzungsexperiment mit Schweinen durchzuführen. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Lüftungssystem ($keins$, $storm$, $tornado$ und $thunder$) und dem Messwert Gewichtszuwachs in der 1LW gibt.
...
\toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Lüftungssystem}  & 3 & 7738.8 &  &  &  \strut\\
   \textbf{Error}  & 34 & 2086.68 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
keins & 10 & 3.50 & 8.95\\
storm & 10 & 8.60 & 7.11\\
tornado & 9 & 34.56 & 6.98\\
thunder & 9 & 34.22 & 8.07\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
Nilufar schaut sich fragend in der Bibliothek um. Nilufar hatte gehofft, dass jemand hier sein würde, den sie kennt und sich mit \Rlogo auskennt. Wird aber enttäuscht. Nilufar war im Teuteburgerwald um ein Stallexperiment mit Schweinen durchzuführen. Nun möchte ihr Betreuer ihrem Projektbericht erstmal eine ANOVA sehen und die Ergebnisse präsentiert bekommen. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Flüssignahrung ($ctrl$, $superIn$ und $flOw$) und dem Messwert Fettgehalt [\%/kg] gibt.
...
## Flüssignahrung  2 241.30 120.650  4.2264 0.02734
## Residuals      23 656.58  28.547
\end{verbatim}
\end{kframe}
\end{knitrout}
...
In einen Leistungssteigerungsversuch wurden Schweinen mit dem Behandlung Genotypen ($AA$, $AB$ und $BB$) sowie der Behandlung Ernährungszusatz ($ctrl$ und $getIt$) untersucht. Es wurde als Messwert Schlachtgewicht [kg] bestimmt. Mark ahnte schon, dass es komplexer wird, als er mit seiner Hausarbeit angefangen hat. Das es jetzt aber so kompliziert wird, hätte er jetzt aber auch nicht gedacht. Mark kratzt sich am Kopf. Eventuell muss er dann doch nochmal Hilfe in der statistischen Beratung holen. Jetzt versucht er es aber erstmal selber.
...
\begin{center}
  ...
  \toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Genotypen}  & 3 & 264.77 &  &  &  \strut\\
    \textbf{Ernährungszusatz}  & 1 & 92.42 &  &  &  \strut\\
    \textbf{Genotypen:Ernährungszusatz}  & 3 & 90.99 &  &  &  \strut\\
   \textbf{Error}  & 18 & 233.16 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
\midrule
  ...
  \textbf{Genotypen:Ernährungszusatz} & $5.23$ \\
  \bottomrule
  \end{tabular}
\end{center}
...
\item Was sagt der Term \textit{Genotypen:Ernährungszusatz} aus? Interpretieren Sie das Ergebnis! \textbf{(2 Punkte)}
\end{enumerate}
...
'Mit der zweifaktoriellen ANOVA lässt sich die Interaktion zwischen den beiden Behandlungen nachweisen!', ihr Betreuer scheint die zweifaktoriellen ANOVA zu verstehen. Warum jetzt sie jetzt nochmal alles wiederkäuen muss, wird Paula echt nicht so klar. Wenn es doch so klar ist? Paula war im Teuteburgerwald und hatte dort ein Kreuzungsexperiment mit Schweinen durchgeführt. Die Komune wo sie untergekommen war, war cool gewesen. Nur jetzt muss eben das Experiment fertig ausgewertet werden. Paula hatte zwei Behandlungen auf Schweinen angewendet. Einmal Lüftungssystem ($keins$, $storm$, $tornado$ und $thunder$) sowie als zweite Behandlung Elterlinie ($ctrl$, und $Xray$). Gemessen wurde der Messwert ($Y$) Schlachtgewicht [kg]. Jetzt muss das hier zu einem Ende kommen!
...
##                           Df  Sum Sq Mean Sq F value    Pr(>F)
## Lüftungssystem             2  78.561  39.280  3.1229 0.0685070
## Elterlinie                 1  68.346  68.346  5.4337 0.0315773
## Lüftungssystem:Elterlinie  2 281.001 140.500 11.1701 0.0007012
## Residuals                 18 226.409  12.578
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Jessica und Mark untersuchen gemeinsam in ihrer Abschlussarbeit den Messwert Protein/Fettrate [\%/kg] in Schweinen. Es ist einiges schiefgelaufen, wie es immer so passiert. Hauptsächlich waren es Katzen, auch wenn man erstmal bei dem Messwert nicht unbedingt an Katzen denken würde. Aber das ist eine andere Geschichte. Jetzt wollen Jessica und Mark ihre Ergebnisse nochmal mit einer Studie von Totsdorf et al. (2018) vergleichen und schauen, ob was ähnliches rauskommt. Angeschaut wurde sich als Behandlung Elterlinie ($ctrl$, $Standard$, $TOP$, $Yray$, $SLOW$, und $Xray$). Es ergab sich dann die folgende Tabelle der rohen p-Werte für die Vergleiche zu Totsdorf et al. (2018).
...
Jonas betrachtet in sich gekehrt die Poster vor dem Büro von seiner Betreuerin. Viele der explorativen Abbildungen sagen ihm etwas. Die Barplots und die Boxplots könnte er dann schon nachbauen. Das macht ihn dann zuversichtlich die Abschlussarbeit auch hinzukriegen. Etwas komischer sind die seltsamen Buchstaben über den Barplots. Jonas betrachtet ein Poster das sich mit Schweinen beschäftigt. Ernährungszusatz ($ctrl$, $fedX$, $proteinX$ und $getIt$) und Protein/Fettrate [\%/kg] wurden dort bestimmt. So richtig schlau, wird er daraus nicht.
...
Jonas sitzt schon etwas länger bei sein Betreuer. So langsam macht Jonas sich Gedanken, ob er nicht doch mal anmerken sollte, dass er von CLD noch nie was gehört hat. Aber noch kann gelauscht werden, ein Ende ist erstmal nicht in Sicht! Jonas hatte in seine Abschlussarbeit ein Kreuzungsexperiment durchgeführt. Deshalb sitzt er hier. Also eigentlich nein, deshalb nicht. Jonas will fertig werden. Hat er sich doch mit Genotypen ($00$, $AA$, $AB$ und $BB$) und Protein/Fettrate [\%/kg] schon eine Menge angeschaut. Jonas beugt sich leicht nach vorne. Nein, doch keine Pause. Weiter warten auf eine Lücke im Fluss... 'Wir müssen als erstes die Gruppen nach absteigender Effektstärke sortieren!', hört Jonas noch aus der Ferne bevor er einnickt.
...
\item Interpretieren Sie das \textit{Compact letter display (CLD)} für Jonas und Mark! \textbf{(1 Punkt)} 
\end{enumerate}
...
'Das Problem ist, dass SPSS eben keine CLD kann. Die bräuchten wir dann schon dringend für unser Poster!', merkt sein Betreuer mit Nachdruck an. Mark neigt den Kopf. 'Das wussten wir nicht vorher?', entfährt es ihm leicht entnervt. Da schaut sein Betreuer seltsam betroffen. Hilft jetzt auch so gar nicht. Mark hatte sich zwei Variablen mit Lüftungssystem ($keins$, $storm$, $tornado$ und $thunder$) und Fettgehalt [\%/kg] in einen Leistungssteigerungsversuch mit Schweinen angeschaut. Jetzt möchte er eigentlich fertig werden und nicht nochmal alles neu in \Rlogo und \texttt\{emmeans\} machen. Dabei hatte er schon echt ne Menge in im Teuteburgerwald gemacht. Dann eben per Hand aus der Matrix der $p$-Wert. Mark muss sich echt zusammenreißen.
...
\midrule
\textbf{keins} & 1.0000000 & 0.0006880 & 0.0013102 & 0.0519295\\
\textbf{storm} & 0.0006880 & 1.0000000 & 0.6433047 & 0.0419488\\
\textbf{tornado} & 0.0013102 & 0.6433047 & 1.0000000 & 0.0881975\\
\textbf{thunder} & 0.0519295 & 0.0419488 & 0.0881975 & 1.0000000\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
Yuki hat sich ein Herz gefasst und war für ihrem Projektbericht in die Niederlande gegangen. Das war eine super Zeit in der sie viel gelernt hat. Klar gab es auch die ein oder andere Besonderheit, aber das gehört hier eher nicht hin. Yuki ist schon eine ganze Zeit im Büro, da ihr Betreuer möchte, dass sie jetzt auf ihren Daten mit $n = 124$ Beobachtungen von Schweinen einen $\mathcal{X}^2$-Test rechnet. Das ginge, da sie als Behandlung \textit{Automatische Fütterung [ja/nein]} bestimmt und zum anderen die Variable \textit{Protein/Fettrate im Zielbereich [ja/nein]} ermittelt hat. Wie genau, das ist jetzt eine andere Frage.
...
Nilufar hat sich ein Herz gefasst und war für ihrem Projektbericht in die Niederlande gegangen. Das war eine super Zeit in der sie viel gelernt hat. Klar gab es auch die ein oder andere Besonderheit, aber das gehört hier eher nicht hin. Nilufar ist schon eine ganze Zeit im Büro, da ihr Betreuer möchte, dass sie jetzt auf ihren Daten mit $n = 161$ Beobachtungen von Schweinen einen $\mathcal{X}^2$-Test rechnet. Das ginge, da sie als Behandlung \textit{Klimakontrolle [ja/nein]} bestimmt und zum anderen die Variable \textit{Schlachtgewicht im Zielbereich [ja/nein]} ermittelt hat. Wie genau, das ist jetzt eine andere Frage.
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
   ...
   \phantom{\textbf{Pestizid (ja)}} & \phantom{100}  & \phantom{100}  &   67  \strut\\
    \hline
    \phantom{\textbf{Pestizid (ja)}} & \phantom{100}  & \phantom{100}  &   94   \strut\\
    \hline
     &  107 &  54 &  161  \strut\\
  \end{tabular}
\end{center}
...
Paula hat sich ein Herz gefasst und war für ihrem Projektbericht in die Niederlande gegangen. Das war eine super Zeit in der sie viel gelernt hat. Klar gab es auch die ein oder andere Besonderheit, aber das gehört hier eher nicht hin. Paula ist schon eine ganze Zeit im Büro, da ihr Betreuer möchte, dass sie jetzt auf ihren Daten mit $n = 161$ Beobachtungen von Schweinen einen $\mathcal{X}^2$-Test rechnet. Das ginge, da sie als Behandlung \textit{Außenklimakontakt [ja/nein]} bestimmt und zum anderen die Variable \textit{Fettgehalt erreicht [ja/nein]} ermittelt hat. Wie genau, das ist jetzt eine andere Frage. Nach ihrem Experiment erhielt sie folgende $2x2$ Kreuztabelle aus ihren erhobenen Daten.
...
'Wichtig ist es, dass wir jetzt eine Gerade durch die Punkte zeichnen!', ruft Steffen. 'Ich sehe nur zwei Zeilen und keine Punkte. Wie soll ich da denn jetzt eine Gerade durchzeichnen?', fragt Jonas. Steffen atmet schwer ein und starrt auf die \Rlogo Ausgabe der Funktion \texttt{lm()}. Die beiden hatten ein Stallexperiment in der Uckermark mit Schweinen durchgeführt. Dabei wurden die beiden folgenden Variablen gemessen: mittlere Anzahl an weißen Blutkörperchen [LEU/ml] und Protein/Fettrate [\%/kg]. Jetzt will die Betreuung von den beiden einmal die Visualisierung der Daten und auch gleich noch die lineare Regression gerechnet bekommen. Das haben beide in \Rlogo gemacht, aber wie soll das jetzt gehen?
...
## -2.69225 -0.57691  0.01442  0.88063  2.67331 
## 
## Coefficients:
##                 Estimate Std. Error t value Pr(>|t|)
## (Intercept)       1.3591     1.5024   0.905 0.371543
## Mittlere_Anzahl   0.5816     0.1463   3.976 0.000313
## 
## Residual standard error: 1.353 on 37 degrees of freedom
## Multiple R-squared:  0.2993,	Adjusted R-squared:  0.2804 
## F-statistic: 15.81 on 1 and 37 DF,  p-value: 0.0003133
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erklären Sie \textit{kurz} den Begriff \texttt{R-squared}! Was sagt Ihnen der Wert $0.3$ aus? \textbf{(2 Punkte)}
\end{enumerate}
...
'Hä? Was ist denn das? Das wird ja immer wilder! Hatten wir als Aufgabe eine Korrelation zu berechnen? Wir bauen aus kontinuierlichen Daten eine Abbildung und interpretieren diese dann?', fragt sich Nilufar laut. 'Keine Ahnung... das ist jetzt jedenfalls keine Abbildung von irgendwas sondern eine \Rlogo Ausgabe mit ganz wilden Bezeichnungen...', denkt sie. Nilufar hatte ein Stallexperiment in der Uckermark mit Schweinen durchgeführt. Dabei wurden die beiden folgenden Variablen gemessen: durchschnittlicher Bewegungsscore [Movement/h] und Fettgehalt [\%/kg]. Jetzt hat sie eigentlich alles zusammen. \textit{Eigentlich...}, denn mit der \Rlogo Ausgabe hat Nilufar jetzt ein Problem.
...
## t = 6.0008, df = 8, p-value = 0.0003231
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, N und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
Nilufar und Jessica sind bei Mark um sich Hilfe für eine Versuchsplanung in \Rlogo zu holen. Dabei geht es um den Zusammenhang zwischen der Behandlung Elterlinie ($ctrl$, $Standard$, $Yray$ und $Xray$) sowie Ernährungszusatz ($ctrl$ und $getIt$) und dem Messwert Protein/Fettrate [\%/kg] in Schweinen. Der Versuch soll in einem Kreuzungsexperiment im Emsland durchgeführt werden. Nach dem Dozenten ist der Messwert Protein/Fettrate [\%/kg] normalverteilt. Die beiden entschieden sich für ein faktorielles Versuchsdesign. Im ersten Schritt überlegt Mark ein einfaches experimentelles Design zu probieren. Daher entscheiden sich alle drei für ein \textit{Complete randomized design (CRD)} mit nur einem der beiden Faktoren. Das sollte für den anfang erstmal reichen. 'Und jetzt, was machen wir jetzt?', Jessica schaut die anderen beiden mit großen Augen an. Die zucken mit der Schulter.\\

Leider kennen sich Mark, Nilufar und Jessica mit dem \textit{Complete randomized design (CRD)} überhaupt nicht aus. Deshalb brauchen die Drei bei der Erstellung Ihre Hilfe!
...
Paula und Alex sind bei Nilufar um sich Hilfe für eine Versuchsplanung in \Rlogo zu holen. Dabei geht es um den Zusammenhang zwischen der Behandlung Genotypen ($AA$, $AB$ und $BB$) sowie Ernährungszusatz ($ctrl$ und $getIt$) sowie drei Blöcken und dem Messwert Gewichtszuwachs in der 1LW in Schweinen. Der Versuch soll in einem Stallversuch im Wendland durchgeführt werden. Nach der Dozentin ist der Messwert Gewichtszuwachs in der 1LW normalverteilt. Die beiden entschieden sich für ein faktorielles Versuchsdesign. Im ersten Schritt überlegt Nilufar ein komplexeres experimentelles Design zu probieren. Daher entscheiden sich alle drei für ein \textit{Randomized complete block design} mit Berücksichtigung einer Interaktion. Das sollte für den anfang erstmal reichen. 'Und jetzt, was machen wir jetzt?', Alex schaut die anderen beiden mit großen Augen an. Die zucken mit der Schulter.\\

Leider kennen sich Nilufar, Paula und Alex mit dem \textit{Randomized complete block design} überhaupt nicht aus. Deshalb brauchen die Drei bei der Erstellung Ihre Hilfe!
...
Steffen: \textit{Warum brauche ich eigentlich das RStudio und R? Wo ist denn da der Unterschied?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]
...
Steffen: \textit{Der Pipe-Operator wird sehr häufig genutzt. Wie sieht der aus und wie funktioniert der an einem Beispiel?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]
...
'Unter den Blinden ist der Einäuge König!', ruft Ihnen Mark entgegen. Das können Sie schon nicht mehr hören. Nur weil Sie einmal gesagt haben, dass Sie sich schonmal mit \Rlogo beschäftigt haben, stehen hier alle Schlange. Aber gut, das hat Sie dann doch vorangebracht. Leider kennt sich Mark auch wieder überhaupt nicht mit \Rlogo aus aber sein Betreuer möchte gerne, dass die Auswertung in \Rlogo gemacht wird. Da müssen Sie dann wohl mal nochmal ran und helfen.\\[1Ex]

Mark fragt: \textit{Was muss ich bei der Eingabe eines Datums in Excel beachten, wenn ich später die Exceldatei in R einlesen will? Wie lautet das Format? \textbf{(1 Punkt)}}\\[1ex]
Sie antworten:\\[2Ex]

Mark fragt: \textit{Die Funktion \texttt{emmeans()} erlaubt es den Faktor $f_1$ getrennt in jedem Level des Faktors $f_2$ auszuwerten. Wie mache ich das? \textbf{(1 Punkt)}}\\[1ex]
Sie antworten:\\[2Ex]
...
Mark fragt: \textit{Ich will eine ANOVA in R rechnen. Dazu brauche ich zwei Funktionen. Welche waren das noch gleich und wie war die Reihenfolge? \textbf{(1 Punkt)}}\\[1ex]
Sie antworten:\\[2Ex]

Mark fragt: \textit{Wenn ich die Spalten in Excel benenne, was muss ich da beachten? \textbf{(1 Punkt)}}\\[1ex]
Sie antworten:\\[2Ex]

Mark fragt: \textit{Wozu nutze ich die Funktion \texttt{mutate()} hauptsächlich? \textbf{(1 Punkt)}}\\[1ex]
Sie antworten:\\[2Ex]
...
Jessica hält die wissenschaftliche Veröffentlichung \textit{Selle, P. H., et al. (2010). Implications of sorghum in broiler chicken nutrition} unter einem Schnaufen in die Luft. 'Worum geht es denn eigentlich in dieser Arbeit?', fragt sie stirnrunzelnd. Jessica soll die Veröffentlichung nutzen um das eigene Experiment zu planen. Als eine Vorlage sozusagen. Daher möchte ihre Betreuerin, dass sie einmal die Veröffentlichung sinnvoll zusammenfasst. Das sollte dann doch etwas aufwendiger werden.\\
...
'Uff', denkt Jonas Das ist jetzt doch etwas umfangreicher. Jonas soll die wissenschaftlichen Daten \textit{data4} einmal sinnvoll analysieren und zusammenfassen. Die Daten sollen als eine Vorlage für seine eigene Arbeit und Experiment dienen. Daher möchte seine Betreuerin, dass er einmal die Daten in einer PowerPoint Präsentation zusammenfasst. 'Das ist jetzt aber doch umfangreicher als gedacht.', mault Jonas in sich hinein. Dann starrt er eine Weile in seinen Laptop.\\
...
\begin{enumerate}
\item Wenn 6 Blaubeerschalen 11.94 Euro kosten,  wie viel kosten 8 Schalen? \textbf{(2 Punkte)}
...
\midrule
wingflapping & 45cm; 22cm; 7.2\% & 34cm; 34cm; 8.9\% & 30cm; 20cm; 12.1\%\\
foraging incl. scratching & 42cm; 22cm; 4.3\% & 52cm; 32cm; 4.1\% & 40cm; 30cm; 1.8\%\\
walking & 29cm; 22cm; 0.4\% & 39cm; 23cm; 0.4\% & 40cm; 12cm; 0.2\%\\
standing & 33cm; 25cm; 0.8\% & 37cm; 26cm; 0.9\% & 39cm; 27cm; 1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCOEIHL & 5.0 | 3.5 | Normal \\
    B & GCIJPTA & 3.5 | 3.0 | Mikro \\ 
    C & GCIJ4IO & 4.5 | 5.0 | Mikro \\ 
    D & GCUUEQS & 1.0 | 4.5 | Mikro \\ 
    E & GC2QJ2N & 2.5 | 4.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
\item Wie lange dauert es in Stunden bis Ihre kritische Radonbelastung von
  280$Bq/m^3$ auf unter 120$Bq/m^3$ gefallen ist?
  \textbf{(4 Punkte)}
\end{enumerate}
...
man nicht alles im Jahr 1038 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{1.4\times 10^{9}} \cdot 1.7^{-0.3 \cdot t + 2.4}
\end{equation*}
...
24 Prozent von 280 Millionen Euro im Jahr
