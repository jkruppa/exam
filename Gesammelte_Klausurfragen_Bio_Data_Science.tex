...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.21, 0.02, 0.34 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1, 0.1, 1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.042, 0.004, 0.068 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1, 0.1, 1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1.05, 0.1, 1.7 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.042, 0.004, 0.068 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 5, 13, -1, 9 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 6.6 +/- 16.4
\item [\textbf{B} \msquare] Es ergibt sich 7.6 +/- 32.8
\item [\textbf{C} \msquare] Es ergibt sich 7.6 +/- 5.73
\item [\textbf{D} \msquare] Es ergibt sich 8.6 +/- 2.865
\item [\textbf{E} \msquare] Es ergibt sich 7.6 +/- 2.865
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 18, 21, 17, 18, 18, 14, 25, 19, 24, 19 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 +/- 18
\item [\textbf{B} \msquare] Es ergibt sich 19 [18, 24]
\item [\textbf{C} \msquare] Es ergibt sich 23 +/- 18
\item [\textbf{D} \msquare] Es ergibt sich 19 +/- 24
\item [\textbf{E} \msquare] Es ergibt sich 23 [19, 25]
\end{enumerate} 
...
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 1.4, da es sich um ein Anteil handelt.
\end{enumerate}
...
$y = \{13, 15, 14, 18, 14, 13, 15\}$. Berechnen Sie folgende
...
\begin{center}
$10.2, 14.1, 12.4, 8.7, 10, 9.6, 12.7, 10.7, 8.5, 13, 11.4, 10.3$
\end{center}
...
\item Berechnen Sie das 90\% Konfidentintervall! \textbf{(3 Punkte)}
...
## t = 2.1267, df = 12, p-value = 0.05488
...
## 
## data:  drymatter by Fe
## t = -1.8486, df = 12, p-value = 0.08929
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -6.7294851  0.5517073
## sample estimates:
...
## 
## data:  drymatter by Fe
## t = -0.88852, df = 12, p-value = 0.3917
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.370047  2.258936
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 25.4 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 90.6 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 35.175 17.5873  5.9687 0.008496
## Residuals 22 64.825  2.9466
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 122 110 126  83  86  95 149 137 139 163 158 157
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 177.31 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 117.81 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 144.23 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 731.76 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 414.94 207.468 15.7470 0.0001113
## form       1   0.08   0.075  0.0057 0.9406225
## dose:form  2 121.34  60.669  4.6048 0.0242632
## Residuals 18 237.15  13.175
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 171$ Sauen. In dem Experiment wurde gemessen,
...
##  -3.00  -2.35  -0.10   1.75   4.40 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   18.600      1.237   15.04 3.78e-07
## trtB           7.400      1.749    4.23  0.00288
## 
## Residual standard error: 2.766 on 8 degrees of freedom
## Multiple R-squared:  0.6911,	Adjusted R-squared:  0.6524 
## F-statistic:  17.9 on 1 and 8 DF,  p-value: 0.002875
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: dosage, region und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.43 & 0 & 12.15 & 108.86 & 72.99 & 10\\
8.75 & 1 & 11.00 & 101.04 & 68.53 & 10\\
11.68 & 1 & 11.69 & 100.62 & 71.44 & 11\\
9.33 & 0 & 8.93 & 104.78 & 74.94 & 8\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.6321 -1.7406 -0.0942  1.8148  7.0044 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 68.50024    2.74539  24.951   <2e-16
## water       -0.05942    0.24326  -0.244    0.808
## light        0.07544    0.76759   0.098    0.922
## nematodes    0.16863    0.10269   1.642    0.104
## 
## Residual standard error: 3.118 on 85 degrees of freedom
## Multiple R-squared:  0.03313,	Adjusted R-squared:  -0.0009986 
## F-statistic: 0.9707 on 3 and 85 DF,  p-value: 0.4105
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
LITTLE\_GUNPOWDER\_R & 3 & 17.5 & 85 & 9.7 & 2.60\\
BENNETT\_CR & 2 & 12.9 & 51 & 9.2 & 2.26\\
LITTLE\_ANTIETAM\_CR & 24 & 24.0 & 44 & 9.3 & 2.11\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.311  -4.337  -2.274   1.571  14.180  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.214573   1.805130  -0.119  0.90587
## temp         0.032073   0.047053   0.682  0.49868
## maxdepth     0.014113   0.004469   3.158  0.00272
## do2          0.180350   0.138890   1.299  0.20019
## no3          0.166900   0.076795   2.173  0.03462
## 
## (Dispersion parameter for quasipoisson family taken to be 36.71088)
## 
##     Null deviance: 2057.2  on 53  degrees of freedom
## Residual deviance: 1513.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.349    -1.17    0.243
## 2 light           0.477     1.45    0.148
## 3 nematodes       0.158     0.170   0.865
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0762 -0.5789 -0.1584  0.5161  3.5242 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  220.5   14.85   
##  subject  (Intercept) 4170.9   64.58   
##  Residual              691.8   26.30   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.446     27.260   7.463
## attitudepop  -22.132      5.779  -3.830
## 
...
\begin{verbatim}
##           ctrl      high low       mid
## ctrl 1.0000000 0.9850182   0 0.0317202
## high 0.9850182 1.0000000   0 0.0304074
## low  0.0000000 0.0000000   1 0.0000000
## mid  0.0317202 0.0304074   0 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 14, 11, 7, 7 und 7!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 6, 10, 11 und 5! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, grade und freshmatter an drei verschiedenen Messterminen.
...
Seitenl{\"a}nge einer Pyramide betr{\"a}gt 44 K{\"o}nigsellen. Eine K{\"o}nigselle
misst 52.4cm.\\
...
\begin{enumerate}
\item Die K{\"o}nigspyramide von Meroe soll eine Seitenl{\"a}nge von 44
...
Verf{\"u}gung. Sie starten an dem Ort C.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC50EKR & 3 | 1.5 | Normal \\
    B & GCIQO1Q & 4.5 | 2 | Mikro \\ 
    C & GCNH2OE & 5 | 3.5 | Klein \\ 
    D & GCYDK9S & 2 | 1 | Klein \\ 
    E & GCR4WSL & 1.5 | 2.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
Sie haben den Vektor $A = \{9, 8, 1\}$ und den Vektor $B = \{8, 3, 10\}$ gegeben.
