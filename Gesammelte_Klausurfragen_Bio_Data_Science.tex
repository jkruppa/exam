...
\begin{graybox}{Ergebnis der Klausur}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 48 Punkten sind aus dem Rechen- und
    Textteil erreicht. 
  \item[] \rule[0ex]{3em}{.4pt}\, von 68 Punkten in Summe.
...
\end{center}
\begin{itemize}
\item Es sind \rule[0ex]{2em}{.4pt}\, von 48 Punkten erreicht worden.
\end{itemize}
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.34, 0.21 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.085, 0.0525 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 1, 0.84 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 1.36, 0.84 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 1, 0.84 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.085, 0.0525 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 9, 14, 7 und 13.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.8 +/- 1.43
\item [\textbf{B} \msquare] Es ergibt sich 10.8 +/- 1.43
\item [\textbf{C} \msquare] Es ergibt sich 10.8 +/- 2.86
\item [\textbf{D} \msquare] Es ergibt sich 9.8 +/- 4.1
\item [\textbf{E} \msquare] Es ergibt sich 10.8 +/- 8.2
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 18, 26, 11, 20, 19, 7, 29, 31, 26, 24 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 +/- 18
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 29
\item [\textbf{C} \msquare] Es ergibt sich 24 +/- 18
\item [\textbf{D} \msquare] Es ergibt sich 24 [19, 30]
\item [\textbf{E} \msquare] Es ergibt sich 24 [18, 29]
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 2.67, da es sich um ein Anteil handelt.
...
$y = \{20, 14, 15, 16, 18, 13, 15\}$. Berechnen Sie folgende
...
\begin{center}
$9.4, 11.3, 14.2, 7.2, 6.5, 9.1, 10.5, 9.5, 10.7, 11.9, 11.2, 9, 12.2, 11.4, 11.2$
\end{center}
...
\item Berechnen Sie das 90\% Konfidentintervall unter der
...
## t = -1.81212, df = 14, p-value = 0.091465
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.10528964  0.59735313
## sample estimates:
...
## t = -0.995037, df = 12, p-value = 0.33936
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.5566854  1.6995426
## sample estimates:
...
## 
## data:  freshmatter by N
## t = 1.48327, df = 10, p-value = 0.16882
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -1.5495840  7.7210126
## sample estimates:
...
## t = -0.387202, df = 8, p-value = 0.7087
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 39.32 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 30.51 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 79.1553 39.5776 28.5612 0.0000013756
## Residuals 20 27.7143  1.3857
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 121 105  93  95  91 100 131 129 131 156 145 139
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 0.05 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 272.67 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 117.82 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 198.65 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq  Mean Sq  F value     Pr(>F)
## dose       2 238.114 119.0569  8.52203 0.00248841
## form       1  25.349  25.3491  1.81447 0.19468765
## dose:form  2 433.132 216.5660 15.50168 0.00012174
## Residuals 18 251.469  13.9705
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   59  \strut\\
    \hline
...
## -6.88889 -2.05952  0.26984  1.67857  4.11111 
## 
## Coefficients:
##             Estimate Std. Error t value         Pr(>|t|)
## (Intercept)  18.8889     1.0103  18.697 0.00000000002675
## trtB         -3.3175     1.5274  -2.172          0.04753
## 
## Residual standard error: 3.0308 on 14 degrees of freedom
## Multiple R-squared:  0.25204,	Adjusted R-squared:  0.19861 
## F-statistic: 4.7175 on 1 and 14 DF,  p-value: 0.047529
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -1.04226, df = 8, p-value = 0.32776
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  -0.80100926  0.36285631
## sample estimates:
##         cor 
## -0.34576474
\end{verbatim}
...
Einflussvariablen ($x$) wurden erhoben: dry, region und variety. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.28 & 0 & 10.53 & 102.27 & 71.94 & 12\\
9.51 & 0 & 10.58 & 103.03 & 71.26 & 13\\
10.29 & 0 & 11.50 & 94.54 & 65.86 & 10\\
10.86 & 0 & 7.44 & 100.15 & 72.94 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -6.91968 -1.63995 -0.17633  1.69360  6.14547 
## 
## Coefficients:
##              Estimate Std. Error t value             Pr(>|t|)
## (Intercept) -3.429932   7.842790 -0.4373              0.66277
## nematodes   -0.024903   0.078186 -0.3185              0.75073
## Fe           0.767883   0.075476 10.1739 < 0.0000000000000002
## water       -0.319274   0.170207 -1.8758              0.06346
## 
## Residual standard error: 2.609 on 105 degrees of freedom
## Multiple R-squared:  0.50702,	Adjusted R-squared:  0.49294 
## F-statistic: 35.997 on 3 and 105 DF,  p-value: 0.00000000000000044212
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & so4 & do2 & no3 & temp\\
\midrule
FALLS\_RUN & 15 & 10.27 & 9.4 & 2.19 & 14.3\\
SOUTH\_BR\_CASSELMAN\_R & 2 & 21.16 & 7.6 & 0.64 & 18.5\\
WATTS\_BR & 19 & 14.19 & 6.7 & 5.25 & 26.5\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -9.1363  -4.1848  -2.1194   1.3731  21.8490  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.567013   2.387481  0.2375  0.81326
## so4         -0.037221   0.037255 -0.9991  0.32266
## do2          0.103849   0.191045  0.5436  0.58919
## no3          0.136920   0.088136  1.5535  0.12674
## temp         0.108592   0.059777  1.8166  0.07539
## 
## (Dispersion parameter for quasipoisson family taken to be 48.228417)
## 
##     Null deviance: 2169.75  on 53  degrees of freedom
## Residual deviance: 1744.58  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.43       1.12  0.263 
## 2 water           0.144     -1.51  0.130 
## 3 nematodes       0.131      1.77  0.0760
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##       Min        1Q    Median        3Q       Max 
## -2.538417 -0.649188 -0.063997  0.539907  3.074612 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  212.44  14.575  
##  subject  (Intercept) 4055.83  63.685  
##  Residual              652.33  25.541  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 202.7692    26.8673  7.5471
## attitudepop -19.7672     5.6119 -3.5224
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0000685 0.0238725
## high 0.0000000 1.0000000 0.0000000 0.0000002
## low  0.0000685 0.0000000 1.0000000 0.0000001
## mid  0.0238725 0.0000002 0.0000001 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, 18, 13, 11 und 7!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 7, 7, 11, 10 und 9! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes drymatter, leaf und grade an zwei verschiedenen Messterminen.
...
Milchstra{\ss}e aus. Es gibt $200000000000$ Sterne in der Milchstra{\ss}e. Nehmen
Sie eine Lichtgeschwindigkeit von $280000000m/s$ an.
...
\item Bei einem vermutetet Alter der Erde von $4500000000$ Jahren,
  ...
  Kontinentalplatten einmal alle $120000000$ Jahre vollst{\"a}ndig im
...
zu Verf{\"u}gung. Sie starten an dem Ort D.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCB5BAY & 3.5 | 3.5 | Klein \\
    B & GCFNYIG & 1.5 | 1.5 | Normal \\ 
    C & GCQGPRM & 2.0 | 4.5 | Klein \\ 
    D & GCH9GKZ & 1.0 | 5.0 | Mikro \\ 
    E & GCRQEYE & 3.0 | 2.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 870 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben jetzt die 1200000 Bleikugeln zusammen. Blei hat eine Dichte
von $10.32g/cm^3$.

\begin{enumerate}
  \setcounter{enumi}{3}
\item Wie schwer in Kilogramm $kg$ sind die 1200000 produzierten
...
1875 ungef{\"a}hr 24 Kaninchen entlassen hat, Millionen
...
Kaninchenpopulation.
\begin{equation*}
  f(t) = 9000000000 - 900000000 \cdot 2^{-0.1 \cdot t + 3.4}
\end{equation*}
...
ber{\"u}hmte \textit{Doppelt gewellte, 4-mal-gefaltete,
  0.6mm, 50-cm-Karton} durch Falzung hergestellt. Beim
letzten Mal war Rektor Skinner die Stimmung zu schlecht und deshalb geht es
erst nach Hause, wenn ein paar Aufgaben gel{\"o}st sind. Martin freut das. An
dem Vorrat
an Zigaretten von Mrs. Krabappel meinen Sie wenig Zuversicht zu erkennen.\\

Der nun zu optimierende Karton hat eine L{\"a}nge von 50cm und eine
Breite von 18cm. Die Kartonagenmaschine in Flint soll dann einen
...
\item Sie wollen noch einen b{\"u}ndig mit dem Boden abschlie{\ss}enden Deckel f{\"u}r
  ...
  Kartondeckel\textit{blatt}rohlings? \textbf{(2 Punkte)}
\end{enumerate}
...
Seitenl{\"a}ngen $a$ und $b$ bei der Verwendung von 120m bestimmen!

\begin{enumerate}
  \setcounter{enumi}{4}  
\item  Welche Seitenl{\"a}ngen f{\"u}r $a$ und $b$ ergeben sich f{\"u}r die
...
Sie haben den Vektor $A = \{6, -10, -1\}$ und den Vektor $B = \{1, 2, -6\}$ gegeben.
