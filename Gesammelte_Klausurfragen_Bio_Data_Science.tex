...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\blacksquare\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\square\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\item [\textbf{B} \msquare] Es ergibt sich 10.4 +/- 1.305
\item [\textbf{C} \msquare] Es ergibt sich 9.4 +/- 3.4
\item [\textbf{D} \msquare] Es ergibt sich 11.4 +/- 1.305
\item [\textbf{E} \msquare] Es ergibt sich 10.4 +/- 6.8
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 [18, 30]
\item [\textbf{B} \msquare] Es ergibt sich 21 [17, 29]
\item [\textbf{C} \msquare] Es ergibt sich 26 +/- 17
\item [\textbf{D} \msquare] Es ergibt sich 21 +/- 17
...
\item [\textbf{D} \msquare]  erhalten, sollten wir mindestens zwanzig Beobachtungen haben.
...
In einer Studie wollen Sie den Effektschätzer Risk ratio berechnen. Sie finden in Ihrem Experiment zur Behandlung von Klaueninfektionen bei Schweinen in 4 Tieren Erkrankung der Klauen vor. 7 Tiere sind gesund. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 1.75, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Der Anteil der Kranken wird berechnet. Da es sich um ein Anteil handelt ergibt sich ein Risk ratio von 0.36.
\item [\textbf{C} \msquare] Der Anteil der Gesunden wird berechnet. Da es sich um ein Anteil handelt ergibt sich ein Risk ratio von 0.36.
\item [\textbf{D} \msquare] Das Verhältnis der Chancen Risk ratio ergibt ein Chancenverhältnis von 0.36. Wir sind an der Chance krank zu sein interessiert.
\item [\textbf{E} \msquare] Da es sich um ein Chancenverhältnis handelt ergibt sich ein Risk ratio von 0.57.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.02, 0.03, 0.001, 0.21 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.0033, 0.005, 2e-04, 0.035 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.18, 0.006, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.04, 0.12, 0.18, 0.006, 1.26 und 2.52. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.0033, 0.005, 2e-04, 0.035 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.18, 0.006, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
Die folgende Abbildung enthält die Daten aus einer Studie zur Bewertung der Wirkung des Mikronährstoff Sulfit auf den Ertrag in t/ha von Weizen im Vergleich zu einer Kontrolle. Der Versuch wurde in 17 Parzellen pro Gruppe durchgeführt. Welche Aussage im Bezug auf eine statistische Auswertung ist richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Barplots deuten auf keinen signifikanten Unterschied. Der Effekt liegt vermutlich bei 1. Wir müssen aber einen Posthoc-Test rechnen um den Effekt wirklich bestimmen zu können.
...
\item [\textbf{D} \msquare] Die Barplots deuten auf einen signifikanten Unterschied. Der Effekt liegt vermutlich bei 1 unter einer groben Abschätzung.
\item [\textbf{E} \msquare] Es liegt kein signifikanter Unterschied vor. Der Effekt liegt bei 1.
\end{enumerate}
...
Nach einem Feldexperiment mit drei D{"u}ngestufen ($ctrl$, $low$ und $high$) als Behandlung
...
\begin{center}
$4, 5, 8, 5, 0, 3, 1, 5, 2, 1, 6, 4, 6, 5, 2, 3, 1, 2, 2, 4, 4, 1, 4, 5, 3, 6, 5, 0, 4, 5$
\end{center}
...
\begin{center}
$9, 9.4, 11.3, 10.6, 12.7, 13, 11.9, 10.3, 10, 9.1, 11.5, 7.3, 11.5, 11.2, 10.2, 8.6, 11.3$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ abgelehnt & Richtige Entscheidung & (Unbekannte) Wahrheit & H$_0$ wahr \\
  \end{tabular}
  \end{center}
...
## t = -0.49614, df = 12, p-value = 0.6288
...
## t = -0.66739, df = 14, p-value = 0.5154
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -5.216966  2.740775
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 25.33 &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 &  &  &  &  \strut\\
        \hline
   \textbf{total}  & 24 & 77.04 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 35.21 &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 & 96.63 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 128.701  64.351   26.48 2.396e-06
## Residuals 20  48.603   2.430
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 134.39 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 61.43 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 28.09 &  &  &  \strut\\
    \hline
   \textbf{error}  & 40 & 342.54 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 61 H{"u}hnern durchgef{\"u}hrt, wobei
...
## Response: gain
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2  86.085  43.042  2.4524 0.114320
## form       1 184.707 184.707 10.5239 0.004504
## dose:form  2  79.014  39.507  2.2509 0.134117
## Residuals 18 315.923  17.551
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0106331 0.0026757 0.2287256
## high 0.0106331 1.0000000 0.0000012 0.1469919
## low  0.0026757 0.0000012 1.0000000 0.0000887
## mid  0.2287256 0.1469919 0.0000887 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   57  \strut\\
    \hline
...
## -4.8571 -0.6310  0.2937  1.4444  3.1429 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  13.8571     0.7764  17.847 5.01e-11
## waterB       -2.3016     1.0352  -2.223   0.0432
## 
## Residual standard error: 2.054 on 14 degrees of freedom
## Multiple R-squared:  0.2609,	Adjusted R-squared:  0.2081 
## F-statistic: 4.943 on 1 and 14 DF,  p-value: 0.04318
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.2609$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: weight, variety und dry. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\begin{enumerate}
\item Wenn 7 Blaubeerschalen 13.23 Euro kosten,  wie viel kosten 12 Schalen? \textbf{(1 Punkt)}
...
\midrule
dustbathing & 29cm; 21cm; 25.4\% & 35cm; 24cm; 54.1\% & 35cm; 32cm; 50.1\%\\
sitting & 37cm; 22cm; 0.8\% & 28cm; 24cm; 0.8\% & 37cm; 20cm; 0.9\%\\
foraging incl. scratching & 33cm; 24cm; 0.5\% & 32cm; 23cm; 8.1\% & 34cm; 22cm; 1.2\%\\
wing/leg stretching & 42cm; 23cm; 1.2\% & 34cm; 25cm; 3.2\% & 42cm; 27cm; 1.2\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCM6GNJ & 1.0 | 4.0 | Normal \\
    B & GCQQXMG & 2.0 | 3.5 | Klein \\ 
    C & GCDPWOP & 4.5 | 3.0 | Klein \\ 
    D & GCEZSOT & 3.0 | 4.5 | Mikro \\ 
    E & GCDSTOH & 2.5 | 5.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 602 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.2\times 10^{10}} - \ensuremath{1.4\times 10^{9}} \cdot 1.7^{-0.15 \cdot t + 2.4}
\end{equation*}
