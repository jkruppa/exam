...
wurde an 46 Schweinen durchgef{\"u}hrt, wobei jedes Tier eine von
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 8, 2, 17, 11 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.2 +/- 5.45
\item [\textbf{B} \msquare] Es ergibt sich 10.2 +/- 2.725
\item [\textbf{C} \msquare] Es ergibt sich 9.2 +/- 29.7
\item [\textbf{D} \msquare] Es ergibt sich 8.2 +/- 14.85
\item [\textbf{E} \msquare] Es ergibt sich 9.2 +/- 2.725
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 37, 24, 13, 7, 15, 24 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 13
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 13
\item [\textbf{C} \msquare] Es ergibt sich 24 +/- 37
\item [\textbf{D} \msquare] Es ergibt sich 23 [14, 38]
\item [\textbf{E} \msquare] Es ergibt sich 24 [13, 37]
\end{enumerate} 
...
In dem folgenden Histogramm von $n = 196$ Pflanzen ist welche
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.42, da es sich um ein Anteil handelt.
...
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.42, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.89, 0.03 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 3.56, 0.12 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.2225, 0.0075 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.2225, 0.0075 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 0.12 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 0.12 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\item [\textbf{D} \msquare] Das R Paket emmeans erlaubt die Durchf{"u}hrung eines multiplen Gruppenvergleichs. Aus einem emmeans Objekt l{"a}sst sich leider kein CLD erstellen. Dennoch ist das Paket einfach zu bedienen und wird deshalb genutzt. Die Interpretation der statistischen Auswertung wird {"u}ber einen Barplot abgebildet.
\item [\textbf{E} \msquare] Das R Paket emmeans erlaubt die Durchf{"u}hrung eines multiplen Gruppenvergleichs. Aus einem emmeans Objekt l{"a}sst sich recht einfach das CLD erstellen und so {"u}ber Barplots eine schnelle Interpration der statistischen Auswertung durchf{"u}hren.
\end{enumerate}
...
\item [\textbf{C} \msquare] Beim multiplen Testen kann es zu Varianzheterogenit{"a}t kommen. Das globale Signifikanzniveau liegt nicht mehr bei $5\%$. Daher m{"u}ssen die p-Werte entsprechend adjustiert werden. Das Verfahren nach Welch, bekannt aus dem t-Test, ist hier h{"a}ufig anzuwenden.
...
\item [\textbf{B} \msquare] In der Analogie der Durchschnittstemperatur: Wie oft tritt ein Effekt durchschnittlich ein? Wir erhalten eine Wahrscheinlichkeit f{"u}r die Effekte. Zum Beispiel, wie hoch ist die Wahrscheinlichkeit f{"u}r einen Mittelwert als Durchschnitt.
...
\item [\textbf{E} \msquare] In der Analogie der Regenwahrscheinlichkeit: ein statistischer Test gibt die Wahrscheinlichkeit f{"u}r das Auftreten eines Ereignisses wieder. Die St{"a}rke des Effektes wird nicht wiedergeben.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Nein, die untersuchte Population k{"o}nnen wir mit einem statistischen Test nicht auswerten. Wir erhalten keine Aussage zur Population.
...
\item [\textbf{D} \msquare] Ja, die untersuchte Population k{"o}nnen wir mit einem statistischen Test auswerten. Wir erhalten eine Aussage zur Population.
...
%% --------------------------------------------------------------------
\hfill\href{}{\includegraphics[width = 2cm]{img/caution}}\\[1Ex] %%youtube
%% --------------------------------------------------------------------



Nach einem Feldexperiment mit zwei D{"u}ngestufen ($ctrl$, $low$ und $high$) als Behandlung
...
Nach einem Feldexperiment mit zwei L{"u}ftungssystemen und Folientunneln ($ctrl$ und $tornado$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Datentabelle mit dem
...
\begin{center}
$2, 4, 3, 5, 3, 5, 5, 2, 5, 4, 4, 4, 12, 2, 4, 6, 4, 6, 6, 2, 4, 7, 4, 7, 5, 5, 4$
\end{center}
...
\begin{center}
$6.7, 9.6, 13.4, 10.1, 10.5, 10.4, 11.3, 12.8, 10.4, 9.3, 10.9, 11.9, 11, 9.8, 13.2, 9.4, 8.9, 7.7, 6.9, 9.7$
\end{center}
...
Nach einer Bonitur von Kartoffeln mit einer Kontrolle und drei
...
\begin{minipage}[c]{.4\linewidth} % [b] => Ausrichtung an \caption
  \includegraphics[width=\linewidth]{/Users/kruppajo/work/GitHub/exam/question/img/boxplot-03-a.png}
\end{minipage}
...
\item Erweitern Sie das Schaubild um die Entstehung von $Pr(D|H_0)$!
  \textit{Nutzen Sie hierf{\"u}r als Beispiel die K{\"o}rpergr{\"o}{\ss}e von M{\"a}nnern und
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ wahr & H$_0$ abgelehnt & 5\% & H$_0$ falsch \\
  \end{tabular}
  \end{center}
...
Trockengewicht (\textit{drymatter}) von Lauch.
...
Der Datensatz \texttt{plant\_growth\_tbl} enth{\"a}lt den Ertrag pro Hektar der Kartoffeln
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 12.45 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 47.46 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Der Datensatz \textit{crop\_tbl} enth{\"a}lt das Outcome \textit{drymatter} f{\"u}r ein Experiment in einer Klimakammer mit 
...
## trt        2 155.302  77.651  58.169 4.615e-09
## Residuals 20  26.698   1.335
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 40.68 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 331.36 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 643.4 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 296.04 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 52 Ziegen durchgef{\"u}hrt, wobei
...
## Response: fat_perc
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2 297.134 148.567 15.3937 0.0001267
## form       1   0.046   0.046  0.0048 0.9457768
## dose:form  2 134.526  67.263  6.9694 0.0057356
## Residuals 18 173.720   9.651
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0757636 0.0195681 0.0805874
## high 0.0757636 1.0000000 0.0001526 0.9755087
## low  0.0195681 0.0001526 1.0000000 0.0001666
## mid  0.0805874 0.9755087 0.0001666 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -9.222 -1.056  0.000  2.028  4.778 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   20.000      1.284  15.577 3.09e-10
## waterB         6.222      1.712   3.635  0.00271
## 
## Residual standard error: 3.397 on 14 degrees of freedom
## Multiple R-squared:  0.4855,	Adjusted R-squared:  0.4487 
## F-statistic: 13.21 on 1 and 14 DF,  p-value: 0.002706
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.4855$ aus? \textbf{(2 Punkte)}
...
## t = 6.3101, df = 8, p-value = 0.0002303
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, N und dosage. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
wollen wir aber als vorsorgliche Enten-Halter:innen aber
...
\midrule
preening & 32cm; 24cm; 0.2\% & 46cm; 26cm; 0.2\% & 31cm; 21cm; 0.4\%\\
wing/leg stretching & 39cm; 30cm; 0.5\% & 29cm; 21cm; 2.4\% & 40cm; 33cm; 8.1\%\\
foraging incl. scratching & 39cm; 22cm; 8.1\% & 33cm; 27cm; 8.1\% & 41cm; 35cm; 3.6\%\\
dustbathing & 35cm; 20cm; 6.2\% & 42cm; 29cm; 3.2\% & 41cm; 19cm; 5.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\item Skizzieren Sie die Werte $r_i$, $R_i$ und $A_i$ f{\"u}r zwei nebeneinander
  agierender Enten f{\"u}r ein Verhalten $i$. Nutzen Sie hierf{\"u}r vereinfachte
...
\item Sie entnehmen der Literatur folgende Aussage zur Verteilung der
  ...
  Abbildung!  \textbf{(1 Punkt)}
\item Welche Fl{\"a}che $a$ nimmt eine Ente ein? Welche Annahmen haben
  Sie f{\"u}r die Berechnung der Entenfl{\"a}che getroffen? \textbf{(2 Punkte)}
\end{enumerate}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC3CFQ9 & 3.0 | 4.5 | Mikro \\
    B & GCHZSOC & 5.0 | 1.5 | Klein \\ 
    C & GCR4T4H & 2.5 | 5.0 | Mikro \\ 
    D & GCXLIKP & 3.5 | 3.0 | Mikro \\ 
    E & GCDJZOF & 2.0 | 2.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 744 n. Chr. f{\"u}r den neuen Lehnsherren
...
Kaninchenweibchens pro Jahr bei ca. 10 Tieren pro Wurf. Ein
Weibchen hat im Durchschnitt 3 W{\"u}rfe pro Jahr. Trotz fehlender
Fressfeinde liegt die Mortalit{\"a}t der S{\"a}uglinge bei 30\%.
...
\item Die durchschnittliche, australische Lebenserwartung eines weiblichen
  Kaninchens liegt bei 9 Jahren. Wie viele weibliche Kaninchen
...
Kaninchenpopulation.
\begin{equation*}
  f(t) = \ensuremath{1.1\times 10^{10}} - \ensuremath{1.1\times 10^{9}} \cdot 2^{-0.1 \cdot t + 3.4}
\end{equation*}
...
L{\"a}nder z{\"a}hlen. Im Jahr 2023 leben ca. \ensuremath{8\times 10^{7}} Menschen in Deutschland und
...
\item Stellen Sie den Fleischkonsum in Deutschland und Nigeria im Jahr
  2023 in einer aussagekr{\"a}ftigen Tabelle dar! 
  \textbf{(2 Punkte)}
...
\item Erg{\"a}nzen Sie Ihre erstellte Tabelle die Treibhausgasemissionen an $CO_2$, die durch den
  Fleischkonsum in Deutschland und Nigeria im Jahr 2023 entstehen!
  \textbf{(1 Punkte)}
\end{enumerate}
...
\item Berechnen Sie die prozentuale Steigerung der Treibhausgasemissionen
  an $CO_2$ in Nigeria im Jahr 2050 im Vergleich zum Jahr 2023, der sich durch den
...
3200EUR im Monat \textit{passiv} erwirtschaften.
...
3.5\% p.a. {\"u}ber 72 Monate finanzieren.
...
Sie haben den Vektor $A = \{7, 12, 1\}$ und den Vektor $B = \{2, 6, 0\}$ gegeben.
