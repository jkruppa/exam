...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.42, 0.01, 0.03, 0.02 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.07, 0.0017, 0.005, 0.0033 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.06, 0.18, 0.12 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.07, 0.0017, 0.005, 0.0033 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.06, 0.18, 0.12 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.04, 2.52, 0.06, 0.18, 0.12 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 12, 11, 6 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.4 +/- 4.9
\item [\textbf{B} \msquare] Es ergibt sich 9.4 +/- 1.565
\item [\textbf{C} \msquare] Es ergibt sich 10.4 +/- 1.565
\item [\textbf{D} \msquare] Es ergibt sich 9.4 +/- 3.13
\item [\textbf{E} \msquare] Es ergibt sich 9.4 +/- 9.8
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit -2, 28, 15, 18, 10, 18, 12, 14, 27, 10 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 15 [10, 27]
\item [\textbf{B} \msquare] Es ergibt sich 15 +/- 27
\item [\textbf{C} \msquare] Es ergibt sich 18 [10, 27]
\item [\textbf{D} \msquare] Es ergibt sich 18 +/- 10
\item [\textbf{E} \msquare] Es ergibt sich 15 +/- 10
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.05 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.05 liegt keine Overdispersion vor.
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.97 ist
richtig?
...
\item [\textbf{B} \msquare] X beinhaltet eine Spalte. Die Spalte gibt nicht die Verteilungsfamilie vor.
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 3, da es sich um ein Anteil handelt.
...
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.25, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\midrule
(Intercept) & 38.29 & 0.28\\
light\_binhigh & 2.70 & 0.41\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 7.31
...
\item [\textbf{D} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 2.7
\item [\textbf{E} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 7.31
\end{enumerate}
...
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 10
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 3
...
\item [\textbf{E} \msquare] Wir machen Aussagen über Populationen!
\end{enumerate}
...
$y = \{12, 17, 17, 19, 17, 19, 13\}$. Berechnen Sie folgende
...
\begin{center}
$9.5, 5.8, 11.5, 9, 9.5, 9.1, 8.4, 10, 7.1, 7.2, 12, 12.5, 11.3, 12, 9.4$
\end{center}
...
\item Skizieren Sie in die
  ...
  \item[(e)] Ein Konfidenzintervall mit niedriger Fallzahl $n$ in der Stichprobe als der Rest der Konfidenzintervalle
  \end{itemize}
\end{enumerate}
...
## t = -0.74278, df = 16, p-value = 0.4684
...
## t = 0.091192, df = 8, p-value = 0.9296
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 72.9 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 60.32 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 185.968  92.984  61.924 2.699e-09
## Residuals 20  30.032   1.502
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 129 108 129 100  94  94 124 153 136 126 147 140
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Sch{\"a}tzen Sie den p-Wert der Tabelle mit der Information von den
  ...
  $F_{supp} = 4.26$ und
  $F_{dose} = 3.01$ sowie
  $F_{supp:dose} = 3.01$ ab. Begr{\"u}nden Sie Ihre
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 1.32 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 153.23 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 197.68 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 468.97 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 32 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 400.08 200.038 22.9735 1.109e-05
## form       1 146.41 146.413 16.8148 0.0006713
## dose:form  2  43.41  21.705  2.4927 0.1107560
## Residuals 18 156.73   8.707
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   69   \strut\\
    \hline
     &  93 &  56 &  149  \strut\\
  \end{tabular}
\end{center}
...
## -6.7778 -2.1429  0.2222  2.2222  4.8571 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   18.143      1.311  13.840 1.47e-09
## trtB          -3.365      1.748  -1.925   0.0748
## 
## Residual standard error: 3.468 on 14 degrees of freedom
## Multiple R-squared:  0.2093,	Adjusted R-squared:  0.1529 
## F-statistic: 3.707 on 1 and 14 DF,  p-value: 0.07476
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: variety, N und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.60 & 1 & 9.43 & 99.38 & 68.80 & 6\\
9.58 & 0 & 9.42 & 101.32 & 73.14 & 15\\
9.99 & 0 & 10.73 & 96.09 & 65.29 & 9\\
11.40 & 0 & 11.26 & 99.71 & 63.86 & 17\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.9055 -2.6277 -0.0822  1.9966 11.1813 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  83.6508     3.6966  22.629  < 2e-16
## water        -0.4030     0.2656  -1.517 0.132656
## nematodes    -0.1365     0.1010  -1.351 0.179912
## P            -0.8824     0.2588  -3.409 0.000965
## 
## Residual standard error: 3.532 on 93 degrees of freedom
## Multiple R-squared:  0.1587,	Adjusted R-squared:  0.1315 
## F-statistic: 5.847 on 3 and 93 DF,  p-value: 0.001055
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
NORTH\_BR & 23 & 1.32 & 7.36 & 18.5 & 121\\
HERRINGTON\_RUN & 1 & 0.25 & 9.82 & 24.5 & 60\\
LITTLE\_FALLS & 84 & 3.54 & 5.69 & 19.5 & 56\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.620  -4.435  -2.256   1.229  16.117  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.359522   1.012469   1.343  0.18553
## no3          0.204773   0.079470   2.577  0.01304
## so4         -0.003190   0.022306  -0.143  0.88688
## temp         0.038465   0.043891   0.876  0.38510
## maxdepth     0.012625   0.004354   2.900  0.00558
## 
## (Dispersion parameter for quasipoisson family taken to be 44.26375)
## 
##     Null deviance: 2443.2  on 53  degrees of freedom
## Residual deviance: 1791.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.368    -1.30    0.193
## 2 light           0.435     0.729   0.466
## 3 nematodes       0.143     0.488   0.626
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 790.7
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3107 -0.5512 -0.1657  0.5942  3.6130 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  237.2   15.40   
##  subject  (Intercept) 4076.6   63.85   
##  Residual              617.9   24.86   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.725     26.982   7.513
## attitudepop  -20.936      5.462  -3.833
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0000005 0.0012374
## high 0.0000000 1.0000000 0.0063214 0.0000033
## low  0.0000005 0.0063214 1.0000000 0.0110165
## mid  0.0012374 0.0000033 0.0110165 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, 12, 9, 6 und 13!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 12, 11, 9 und 9! \textbf{(2 Punkte)}
...
\begin{quote}
  >>Ohne ausreichende Zufuhr von Vitamin C stellen sich nach 55 Tagen die
  ersten Symptome ein; die ersten Toten sind nach 83 Tagen zu beklagen;
...
Eine au{\ss}erirdische Zivilisation schickt $2$ Sonden mit
$20$\%iger Lichtgeschwindigkeit los um sich auf den erreichten
Planeten selbst zu replizieren. Nach $500$ Jahren ist die
Replikation abgeschlossen und wiederum $2$ Sonden werden
ausgesendet. Gehen Sie von $4.24$ Lichtjahren als mittlerer
Abstand der Sterne in der Milchstra{\ss}e aus. Es gibt $\ensuremath{1.5\times 10^{11}}$
Sternen in der Milchstra{\ss}e.

\begin{enumerate}
\item Skizzieren Sie in einer Abbildung die ersten vier Schritte der
  Vervielf{\"a}ltigung der Sonden in der Galaxie! Beschriften Sie die Abbildung
  mit der Dauer jedes Schrittes!
  \textbf{(2 Punkte)}
\item Berechnen Sie die Dauer, die eine Zivilisation ben{\"o}tigt, um die ganze
  Milchstra{\ss}e zu besuchen! \textbf{(3 Punkte)} 
\item  $4.1e+09$ Jahre Alter der Erde
\end{enumerate}


Skizzieren Sie den Zusammenhang zwischen Zeit und Raum.

ODER

Skizzieren Sie in einer Abbildung den Zusammenhang zwischen Zeit, Raum und
Geschwindigkeit. Zeichnen Sie ein ruhendes Raumschiff, ein mit 50\%
Lichtegschwindigkeit und mit Lichtegeschwindigkeit fliegendes Raumschiff.

Warum ist die Lichtgeschwindigkeit die maximale m{\"o}gliche Geschwindigkeit?
Begr{\"u}nden Sie Ihre Antwort anhand der Abbilung!
