...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.89, 0.42, 0.34 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 4.45, 2.1, 1.7 und 1.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 1, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.178, 0.084, 0.068 und 0.042. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 1, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.178, 0.084, 0.068 und 0.042. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 6, 15, 12 und 17.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12 +/- 4.3
\item [\textbf{B} \msquare] Es ergibt sich 12 +/- 18.5
\item [\textbf{C} \msquare] Es ergibt sich 13 +/- 2.15
\item [\textbf{D} \msquare] Es ergibt sich 12 +/- 2.15
\item [\textbf{E} \msquare] Es ergibt sich 11 +/- 9.25
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 26, 17, 19, 4, 22, 17, 23, 18, 8, 34 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 +/- 26
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 17
\item [\textbf{C} \msquare] Es ergibt sich 23 [18, 27]
\item [\textbf{D} \msquare] Es ergibt sich 19 [17, 26]
\item [\textbf{E} \msquare] Es ergibt sich 19 +/- 17
\end{enumerate} 
...
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.29, da es sich um ein Anteil handelt.
...
$y = \{20, 19, 12, 9, 17, 16, 15\}$. Berechnen Sie folgende
...
\begin{center}
$9.5, 10.8, 8.1, 12.2, 10.4, 11.8, 8.6, 11.2, 10.8, 9.3, 12.2, 10.6, 12.1, 8.1$
\end{center}
...
## 
## data:  drymatter by Fe
## t = 3.0439, df = 14, p-value = 0.008755
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  1.242461 7.170237
## sample estimates:
...
## 
## data:  drymatter by Fe
## t = 3.3955, df = 8, p-value = 0.009423
...
## trt        2 18.952  9.4762  4.6279 0.0239
## Residuals 18 36.857  2.0476
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 112 117 115  91  95  79 155 136 143 137 139 149
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 16.77 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 46.69 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 156.5 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 39 & 634.36 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 460.17 230.084 10.1341 0.001127
## form       1  86.04  86.037  3.7895 0.067352
## dose:form  2 343.49 171.747  7.5647 0.004126
## Residuals 18 408.67  22.704
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## (Intercept)  15.0000     0.8685  17.271 8.96e-09
## trtB         10.2000     1.3455   7.581 1.88e-05
## 
## Residual standard error: 2.298 on 10 degrees of freedom
## Multiple R-squared:  0.8518,	Adjusted R-squared:  0.837 
## F-statistic: 57.47 on 1 and 10 DF,  p-value: 1.88e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{Multiple R-squared}!
  Was sagt Ihnen der Wert $0.8518$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: region, rainfall und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.56 & 0 & 9.27 & 103.25 & 74.71 & 10\\
7.72 & 0 & 8.21 & 98.12 & 68.24 & 9\\
10.49 & 1 & 10.60 & 97.67 & 67.41 & 8\\
9.43 & 0 & 11.23 & 100.31 & 69.87 & 4\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.8665 -1.5876  0.3136  1.6168  5.8767 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.10774    8.66940  -0.012 0.990106
## P           -0.68659    0.18532  -3.705 0.000327
## Fe           0.76054    0.08218   9.255 1.42e-15
## light        1.20468    0.51809   2.325 0.021814
## 
## Residual standard error: 2.547 on 115 degrees of freedom
## Multiple R-squared:  0.4981,	Adjusted R-squared:  0.485 
## F-statistic: 38.05 on 3 and 115 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & maxdepth & do2 & so4\\
\midrule
SOUTH\_BR\_PATAPSCO & 26 & 2.96 & 60 & 7.9 & 8.84\\
BLUE\_LICK\_RUN & 1 & 1.20 & 46 & 8.5 & 10.85\\
LITTLE\_GUNPOWDER\_R & 3 & 2.60 & 85 & 9.7 & 6.96\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -7.8445  -4.2517  -2.0915   0.8512  17.1495  
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 0.214703   1.354815   0.158   0.8747
## no3         0.195393   0.082101   2.380   0.0213
## maxdepth    0.008461   0.005054   1.674   0.1005
## do2         0.221965   0.131288   1.691   0.0973
## so4         0.019339   0.023933   0.808   0.4230
## 
## (Dispersion parameter for quasipoisson family taken to be 38.81374)
## 
##     Null deviance: 2000.4  on 53  degrees of freedom
## Residual deviance: 1484.4  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.360     0.283   0.778
## 2 nematodes       0.157    -1.08    0.278
## 3 light           0.477     1.38    0.169
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2126 -0.6103 -0.0541  0.4630  3.2424 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  214     14.63   
##  subject  (Intercept) 3899     62.44   
##  Residual              695     26.36   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.350     26.399   7.665
## attitudepop  -20.193      5.792  -3.486
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000934 0.0000309 0.0022554
## high 0.0000934 1.0000000 0.7045020 0.2608189
## low  0.0000309 0.7045020 1.0000000 0.1364938
## mid  0.0022554 0.2608189 0.1364938 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 13, 7, 11, 12 und 15!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 6, 12, 10 und 16! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes leaf, pigs und P an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC39MDK & 1.0 | 2.5 | Normal \\
    B & GCUPGMG & 1.5 | 1.0 | Mikro \\ 
    C & GCBIGIW & 3.0 | 2.0 | Mikro \\ 
    D & GCRDRCM & 5.0 | 4.5 | Normal \\ 
    E & GCBXFTT & 3.5 | 1.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 557 n. Chr. f{\"u}r den neuen Lehnsherren
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  8-mal-gefaltete, 0.8mm, 40-cm-Karton} durch
...
Sie haben den Vektor $A = \{4, 24, 11\}$ und den Vektor $B = \{1, -2, 3\}$ gegeben.
