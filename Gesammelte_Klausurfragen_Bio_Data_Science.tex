...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.03, 0.001, 0.34 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.006, 2e-04, 0.068 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 0.15, 0.005, 1.7 und 2.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 0.15, 0.005, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 0.15, 0.005, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.006, 2e-04, 0.068 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 7, 16, 4 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.2 +/- 4.55
\item [\textbf{B} \msquare] Es ergibt sich 8.2 +/- 2.275
\item [\textbf{C} \msquare] Es ergibt sich 8.2 +/- 20.7
\item [\textbf{D} \msquare] Es ergibt sich 9.2 +/- 2.275
\item [\textbf{E} \msquare] Es ergibt sich 7.2 +/- 10.35
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 16, 22, 29, 25, 12, 14, 16, 19, 12, 21 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 [14, 25]
\item [\textbf{B} \msquare] Es ergibt sich 21 +/- 14
\item [\textbf{C} \msquare] Es ergibt sich 21 [15, 26]
\item [\textbf{D} \msquare] Es ergibt sich 19 +/- 25
...
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.57, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
$y = \{17, 16, 14, 17, 16, 12, 14, 12, 15, 16, 16\}$. Berechnen Sie folgende
...
\begin{center}
$11.4, 6, 11.3, 12.2, 10.7, 8.1, 10.4, 8.2, 13.5, 7.3, 9.8, 9.1, 6.6, 10.4, 6.9$
\end{center}
...
## t = -2.5784, df = 12, p-value = 0.02417
...
## 
## data:  waterintake by infusion
## t = 0.96542, df = 12, p-value = 0.3534
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -1.436401  3.722116
## sample estimates:
...
## t = 0.081541, df = 10, p-value = 0.9366
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.256461  2.427889
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 96.18 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 39.65 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 46.538 23.2692  17.471 2.864e-05
## Residuals 22 29.302  1.3319
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 132 121 119 111  93 110 149 124 143 136 137 139
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 28.09 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 97.18 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 293.92 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 39 & 566.54 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 604.47 302.237 18.3026 4.596e-05
## form       1   0.15   0.146  0.0089    0.9260
## dose:form  2 123.97  61.984  3.7535    0.0434
## Residuals 18 297.24  16.513
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   97   \strut\\
    \hline
     &  82 &  74 &  156  \strut\\
  \end{tabular}
\end{center}
...
## -4.4286 -2.3929 -0.0714  1.5000  6.5714 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.714      1.150  17.139 8.39e-10
## trtB           6.714      1.627   4.127   0.0014
## 
## Residual standard error: 3.043 on 12 degrees of freedom
## Multiple R-squared:  0.5867,	Adjusted R-squared:  0.5523 
## F-statistic: 17.04 on 1 and 12 DF,  p-value: 0.001402
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 8.9209, df = 8, p-value = 1.977e-05
...
\midrule
9.62 & 0 & 11.30 & 103.39 & 73.18 & 10\\
8.57 & 0 & 10.04 & 92.44 & 64.78 & 10\\
9.39 & 0 & 9.42 & 103.57 & 71.08 & 9\\
10.22 & 1 & 8.98 & 102.63 & 69.75 & 11\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##    Min     1Q Median     3Q    Max 
## -4.663 -1.375 -0.380  1.441  5.942 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -3.87651    6.79106  -0.571    0.569
## light        0.37226    0.52604   0.708    0.481
## Fe           0.73352    0.06733  10.894   <2e-16
## nematodes    0.03555    0.06705   0.530    0.597
## 
## Residual standard error: 2.274 on 105 degrees of freedom
## Multiple R-squared:  0.5335,	Adjusted R-squared:  0.5202 
## F-statistic: 40.03 on 3 and 105 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
BEAVER\_RUN & 37 & 1722 & 19.3 & 5.91 & 8.1\\
MILL\_CR & 6 & 1097 & 13.1 & 15.77 & 8.3\\
PINEY\_CR & 18 & 6949 & 18.6 & 17.84 & 9.3\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -7.123  -2.865  -1.711   1.185  11.733  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -3.955e-01  1.296e+00  -0.305 0.761536
## acerage      4.234e-05  1.174e-05   3.605 0.000729
## temp         3.098e-02  3.869e-02   0.801 0.427158
## so4          7.087e-03  1.637e-02   0.433 0.666957
## do2          3.158e-01  1.034e-01   3.054 0.003644
## 
## (Dispersion parameter for quasipoisson family taken to be 20.21921)
## 
##     Null deviance: 1288.51  on 53  degrees of freedom
## Residual deviance:  851.29  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.81      3.04  0.00236
## 2 water           0.175    -2.96  0.00305
## 3 nematodes       0.160    -0.775 0.439
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0963 -0.5979 -0.0756  0.6194  3.5058 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  206.3   14.36   
##  subject  (Intercept) 4079.6   63.87   
##  Residual              623.2   24.96   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.909     26.912   7.540
## attitudepop  -20.510      5.485  -3.739
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0001155 0.0000003
## high 0.0000000 1.0000000 0.0003446 0.0548083
## low  0.0001155 0.0003446 1.0000000 0.0526554
## mid  0.0000003 0.0548083 0.0526554 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 13, 12, 8, 12 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 12, 8, 7, 4 und 8! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes freshmatter, P und pigs an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCR2ST1 & 4.0 | 3.5 | Mikro \\
    B & GCTY4U2 & 4.5 | 4.5 | Klein \\ 
    C & GCHQ32J & 5.0 | 1.5 | Klein \\ 
    D & GCQG4HN & 3.5 | 5.0 | Klein \\ 
    E & GCCN9Z8 & 3.0 | 3.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
\item Wie viele Millionen Kaninchen leben nach der S{\"a}ttigungsfunktion
  nach 40 Jahren auf dem australischen Kontinent? \textbf{(1
    Punkt)}
\end{enumerate}
...
Disease Virus (RHDV) kosten 11\$ und der durchf{\"u}hrende Arzt
verlangt ca. 35\$.
...
ein strammer Wind im Gesicht, egal wohin man schaut. Ein schmatzendes
...
\textit{Gr{\"u}nlandtemperatur}! Die Gr{\"u}nlandtemperatur ist die Summe aller
...
\item Im zweiten Versuch ziehen Fridolin und die Rentner mit einem
  $110^\circ$ Winkel mit ihrem Seil an dem Trecker. Welche Kraft
...
Jetzt hei{\ss}t es erstmal Preise und eine Kaffemaschine von Mitropa
gewinnen. Jemand gewinnt die Kaffeemaschine von Mitropa, wenn nicht alle
Kandidat*innen {\"u}berbieten (eng. \textit{outbid}). Mit Ihnen bieten
Annegret und Helmut.
...
\item Mit welcher Wahrscheinlichkeit gewinnen Sie die Kaffeemaschine von
  Mitropa, wenn keiner der Kandidat*innen {\"u}berbietet? \textbf{(1 Punkt)}
\item Wenn Ihre {\"U}berbietungswahrscheinlichkeit bei 0.01
  liegt, mit welcher Wahrscheinlichkeit gewinnt keiner die Kaffeemaschine
  von Mitropa? \textbf{(1 Punkt)}
\end{enumerate}
...
Wenn man sich zu sp{\"a}t anmeldet, dann ist die Exkursion nicht so toll.
...
Sie haben den Vektor $A = \{5, -3, 22\}$ und den Vektor $B = \{1, 6, 1\}$ gegeben.
