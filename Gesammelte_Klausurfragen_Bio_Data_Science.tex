...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.01, 0.34 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.04, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0025, 0.085 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0025, 0.085 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.04, 1.36 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.04, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 12, 3, 5, 10 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.2 +/- 3.96
\item [\textbf{B} \msquare] Es ergibt sich 9.2 +/- 1.98
\item [\textbf{C} \msquare] Es ergibt sich 7.2 +/- 7.85
\item [\textbf{D} \msquare] Es ergibt sich 8.2 +/- 1.98
\item [\textbf{E} \msquare] Es ergibt sich 8.2 +/- 15.7
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 3, 23, 8, 31, 20, 29, 22, 26, 18, 26 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 [18, 29]
\item [\textbf{B} \msquare] Es ergibt sich 24 [19, 30]
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.86, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.86, da es sich um eine Chancenverh{"a}ltnis handelt.
...
$y = \{21, 19, 18, 19, 19, 23, 22\}$. Berechnen Sie folgende
...
\begin{center}
$11, 8.9, 10.5, 8.1, 10, 10.5, 12.4, 10.1, 11.3, 10.9, 8.9, 8.4, 9.5, 8.6, 10.4$
\end{center}
...
Nach einem Experiment mit zwei D{"u}ngestufen ($ctrl$und $high$) ergibt sich die
folgende Datentabelle mit dem gemessenen Trockengewicht
(\textit{drymatter})  von Erbsen. 
...
## t = 0.22573, df = 16, p-value = 0.8243
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -1.864712  2.309157
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 2.65 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 63.11 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 103.049  51.524   25.38 3.254e-06
## Residuals 20  40.603   2.030
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 117 104 122 108  96  97 134 138 141 154 156 140
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 25.09 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 60.68 &  &  &  \strut\\
    \hline
...
## Response: weight
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  23.93   11.96  1.0730   0.36286
## form       1 324.93  324.93 29.1440 3.951e-05
## dose:form  2  82.62   41.31  3.7052   0.04491
## Residuals 18 200.69   11.15
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   104  \strut\\
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   44   \strut\\
    \hline
     &  85 &  63 &  148  \strut\\
  \end{tabular}
\end{center}
...
## -3.000 -1.321  0.000  1.179  4.000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  14.2857     0.8045   17.76 5.36e-11
## waterB       14.7143     1.0727   13.72 1.65e-09
## 
## Residual standard error: 2.129 on 14 degrees of freedom
## Multiple R-squared:  0.9308,	Adjusted R-squared:  0.9258 
## F-statistic: 188.2 on 1 and 14 DF,  p-value: 1.651e-09
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.9308$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: height, fertilizier und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.44 & 0 & 7.36 & 98.27 & 72.36 & 12\\
8.52 & 1 & 8.93 & 101.55 & 70.32 & 12\\
8.08 & 1 & 10.69 & 100.30 & 68.49 & 17\\
11.41 & 0 & 9.98 & 107.27 & 77.12 & 13\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.9902 -1.4413  0.1236  1.7845  5.8602 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.58846    7.37934   0.215 0.830038
## Fe           0.73716    0.07129  10.341  < 2e-16
## water        0.04940    0.18253   0.271 0.787269
## P           -0.62455    0.16966  -3.681 0.000389
## 
## Residual standard error: 2.464 on 93 degrees of freedom
## Multiple R-squared:  0.5556,	Adjusted R-squared:  0.5413 
## F-statistic: 38.76 on 3 and 93 DF,  p-value: 2.426e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & so4 & temp & maxdepth & no3\\
\midrule
COLLIER\_RUN & 18 & 17.63 & 18.2 & 42 & 0.26\\
TUSCARORA\_CR & 38 & 24.76 & 15.0 & 90 & 5.45\\
BIG\_ELK\_CR & 164 & 17.53 & 13.8 & 81 & 3.20\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.482  -4.347  -1.414   1.517  15.557  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.620729   0.905293   1.790   0.0796
## so4         -0.007993   0.021109  -0.379   0.7066
## temp         0.032035   0.041434   0.773   0.4432
## maxdepth     0.012377   0.003978   3.111   0.0031
## no3          0.204907   0.071330   2.873   0.0060
## 
## (Dispersion parameter for quasipoisson family taken to be 38.52535)
## 
##     Null deviance: 2237.3  on 53  degrees of freedom
## Residual deviance: 1562.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.377    -1.50    0.135
## 2 light           0.490     0.607   0.544
## 3 nematodes       0.146     1.37    0.172
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2833 -0.5549 -0.0676  0.5515  3.5180 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  224.2   14.97   
##  subject  (Intercept) 4033.0   63.51   
##  Residual              650.8   25.51   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.675     26.827   7.555
## attitudepop  -20.906      5.605  -3.730
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0000000 0.0033044
## high 0.0000000 1.0000000 0.5419382 0.0000001
## low  0.0000000 0.5419382 1.0000000 0.0000000
## mid  0.0033044 0.0000001 0.0000000 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 6, 9, 10, 10 und 16!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 11, 2, 13, 12 und 13! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes grade, leaf und freshmatter an vier verschiedenen Messterminen.
...
wir aber als vorsorgliche H{"u}hner-Halter:innen aber
...
H{"u}hner f{\"u}r vier T{\"a}tigkeiten und versuchen die notwendige Fl{\"a}che
...
\midrule
drinking/eating & 41cm; 21cm; 4.1\% & 27cm; 35cm; 2.1\% & 41cm; 16cm; 1.8\%\\
walking & 34cm; 19cm; 3.6\% & 35cm; 25cm; 6.3\% & 33cm; 35cm; 5.1\%\\
wingflapping & 38cm; 20cm; 0.8\% & 35cm; 24cm; 1.2\% & 25cm; 26cm; 0.1\%\\
preening & 22cm; 25cm; 18.1\% & 29cm; 31cm; 14.2\% & 27cm; 30cm; 16.4\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCYUJVU & 3.0 | 2.5 | Normal \\
    B & GCCHORP & 4.5 | 1.0 | Klein \\ 
    C & GCEARL9 & 1.5 | 2.0 | Mikro \\ 
    D & GCW0FOQ & 1.0 | 3.5 | Klein \\ 
    E & GCQ2ROX & 3.5 | 1.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1075 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{2, 7, 16\}$ und den Vektor $B = \{-2, 0, 0\}$ gegeben.
