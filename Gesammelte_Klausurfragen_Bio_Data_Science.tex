...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.03, 0.42, 0.001, 0.89 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.18, 1, 0.006, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.005, 0.07, 0.0002, 0.1483 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.005, 0.07, 0.0002, 0.1483 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.04, 0.18, 2.52, 0.006, 5.34 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.18, 1, 0.006, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
\begin{center}
  \includegraphics[width=10cm]{C:/Users/jokruppa/lehre/intern/exam/question/img/boxplot-03-c.png}
\end{center}
...
\begin{center}
  \includegraphics[width=17cm]{C:/Users/jokruppa/lehre/intern/exam/question/img/diag-doppelbaum.PNG}
\end{center}
...
In einem Stallexperiment mit $n = 87$ Ferkeln wurde der
...
\midrule
HAWLINGS\_R & 1 & 20.5 & 1172 & 2.62 & 73\\
RED\_RUN & 32 & 17.7 & 3332 & 2.09 & 73\\
MUDDY\_BR & 25 & 17.0 & 4266 & 2.05 & 68\\
DEAD\_RUN & 25 & 23.0 & 4145 & 0.34 & 51\\
\bottomrule
\end{tabular}
\end{table}
...
## -9.5785  -4.0437  -1.8515   1.3992  14.6244  
## 
## Coefficients:
##                Estimate  Std. Error t value Pr(>|t|)   
## (Intercept) 1.294425881 0.884459458  1.4635  0.14971   
## temp        0.037596839 0.037408001  1.0050  0.31981   
## acerage     0.000032944 0.000012945  2.5449  0.01413 * 
## no3         0.214523119 0.065667928  3.2668  0.00199 **
## maxdepth    0.009445773 0.004165502  2.2676  0.02780 * 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 35.020077)
## 
##     Null deviance: 2369.60  on 53  degrees of freedom
## Residual deviance: 1521.09  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.51      1.28    0.202
## 2 nematodes       0.143     0.888   0.375
## 3 water           0.150    -1.15    0.250
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
12.51 & 0 & 9.84 & 97.81 & 67.59 & 10\\
10.85 & 0 & 7.95 & 103.24 & 73.26 & 8\\
10.20 & 1 & 9.48 & 95.67 & 67.94 & 8\\
6.89 & 1 & 10.48 & 106.12 & 75.04 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -8.70795 -2.10612  0.00306  2.17074 10.88125 
## 
## Coefficients:
##               Estimate Std. Error t value             Pr(>|t|)    
## (Intercept) 77.7147214  4.1261285 18.8348 < 0.0000000000000002 ***
## nematodes   -0.0025753  0.0919046 -0.0280              0.97770    
## P           -0.5543730  0.2411155 -2.2992              0.02359 *  
## water       -0.2084776  0.2588355 -0.8054              0.42249    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.3289 on 99 degrees of freedom
## Multiple R-squared:  0.050985,	Adjusted R-squared:  0.022227 
## F-statistic: 1.7729 on 3 and 99 DF,  p-value: 0.15728
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -5.00000 -2.53571  0.00000  0.71429  8.00000 
## 
## Coefficients:
##             Estimate Std. Error t value     Pr(>|t|)    
## (Intercept) 15.28571    1.38628 11.0264 0.0000001234 ***
## trtB        -0.28571    1.96049 -0.1457       0.8865    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.6677 on 12 degrees of freedom
## Multiple R-squared:  0.0017668,	Adjusted R-squared:  -0.081419 
## F-statistic: 0.021239 on 1 and 12 DF,  p-value: 0.88655
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Skizieren Sie in die
  ...
  \begin{itemize}
  \item[(a)] Ein Konfidenzintervall mit niedriger Delta $\Delta$ in der Stichprobe als der Rest der Konfidenzintervalle 	
...
## t = 6.19463, df = 16, p-value = 0.000012854
...
## 
## data:  drymatter by P
## t = 4.01391, df = 16, p-value = 0.0010023
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  1.7825848 5.7729707
## sample estimates:
...
\item Folgende statistische Fachbegriffe bzw. Methoden sind gegeben:
  \begin{itemize}
  \item[] Pearson Korrelation, Wilcoxon-Test, Spearman Korrelation, Simple Gaussian linear Regression, Kruskal-Wallis-Test, Paired t-Test, ANOVA, Mann-Whitney-U-Test und t-Test.
  \end{itemize}
