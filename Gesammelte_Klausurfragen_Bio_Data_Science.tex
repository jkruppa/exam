...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.21, 0.03, 0.01, 0.02 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 1.26, 0.18, 0.06, 0.12 und 2.52. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.035, 0.005, 0.0017, 0.0033 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.035, 0.005, 0.0017, 0.0033 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 1, 0.18, 0.06, 0.12 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 1, 0.18, 0.06, 0.12 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 18, 9, 9, 16 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 13.6 +/- 2.08
\item [\textbf{B} \msquare] Es ergibt sich 12.6 +/- 4.16
\item [\textbf{C} \msquare] Es ergibt sich 11.6 +/- 8.65
\item [\textbf{D} \msquare] Es ergibt sich 12.6 +/- 2.08
\item [\textbf{E} \msquare] Es ergibt sich 12.6 +/- 17.3
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 8, 17, 25, 29, 25, 9 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 [10, 30]
\item [\textbf{B} \msquare] Es ergibt sich 25 +/- 29
\item [\textbf{C} \msquare] Es ergibt sich 25 +/- 9
\item [\textbf{D} \msquare] Es ergibt sich 25 [9, 29]
\item [\textbf{E} \msquare] Es ergibt sich 25 +/- 9
\end{enumerate} 
...
$y = \{13, 20, 15, 14, 18, 14, 16, 13, 21, 13, 18\}$. Berechnen Sie folgende
...
\begin{center}
$10.9, 9.5, 10, 9.4, 6.1, 9.9, 9.5, 10.7, 8.1, 10.3, 10.6, 11$
\end{center}
...
## 
## data:  drymatter by Fe
## t = -3.2128, df = 16, p-value = 0.005429
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -6.086025 -1.247308
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 8.58 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 50.03 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 16.072  8.0359   2.985 0.07338
## Residuals 20 53.841  2.6921
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 125 114 110 112  94 102 146 149 154 149 160 170
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 45.63 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 55.99 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 155.52 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 39 & 828.21 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 326.19 163.093 23.7934 8.833e-06
## form       1  80.70  80.700 11.7732  0.002978
## dose:form  2 125.85  62.924  9.1799  0.001786
## Residuals 18 123.38   6.855
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.2857 -1.2214  0.2571  1.7357  3.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.200      1.098  15.672 2.29e-08
## trtB          10.086      1.437   7.019 3.63e-05
## 
## Residual standard error: 2.454 on 10 degrees of freedom
## Multiple R-squared:  0.8313,	Adjusted R-squared:  0.8144 
## F-statistic: 49.26 on 1 and 10 DF,  p-value: 3.633e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{Multiple R-squared}!
  Was sagt Ihnen der Wert $0.8313$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: variety, rainfall und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.52 & 0 & 7.91 & 100.74 & 69.86 & 10\\
9.89 & 0 & 11.38 & 100.04 & 68.88 & 12\\
10.16 & 0 & 11.48 & 96.07 & 64.72 & 9\\
9.53 & 0 & 9.93 & 91.95 & 66.41 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.5730 -1.5952  0.1935  1.5293  5.2585 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  6.23427    7.30942   0.853  0.39560
## nematodes    0.03519    0.06585   0.534  0.59416
## Fe           0.67912    0.07108   9.554 4.83e-16
## P           -0.51174    0.16548  -3.093  0.00253
## 
## Residual standard error: 2.424 on 108 degrees of freedom
## Multiple R-squared:  0.4873,	Adjusted R-squared:  0.4731 
## F-statistic: 34.22 on 3 and 108 DF,  p-value: 1.265e-15
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & do2 & maxdepth & so4\\
\midrule
PINEY\_CR & 18 & 18.6 & 9.3 & 100 & 17.84\\
DEAD\_RUN & 25 & 23.0 & 8.7 & 51 & 44.93\\
CARROLL\_BR & 23 & 18.4 & 10.4 & 105 & 12.79\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.292  -4.445  -2.561   2.374  15.775  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -1.987209   2.217949  -0.896   0.3747
## temp         0.100739   0.052651   1.913   0.0616
## do2          0.321445   0.172705   1.861   0.0687
## maxdepth     0.009301   0.005049   1.842   0.0715
## so4          0.014031   0.018968   0.740   0.4630
## 
## (Dispersion parameter for quasipoisson family taken to be 40.10635)
## 
##     Null deviance: 2028.0  on 53  degrees of freedom
## Residual deviance: 1655.6  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.31      1.20    0.232
## 2 water           0.132    -1.14    0.254
## 3 light           0.455     0.561   0.575
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.08473 -0.65849 -0.07194  0.51108  3.11001 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  201.0   14.18   
##  subject  (Intercept) 4066.4   63.77   
##  Residual              669.4   25.87   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.318     26.877   7.527
## attitudepop  -19.160      5.685  -3.370
## 
...
\begin{verbatim}
##          ctrl      high       low      mid
## ctrl 1.00e+00 0.0000226 0.0000000 0.000000
## high 2.26e-05 1.0000000 0.0044935 0.031999
## low  0.00e+00 0.0044935 1.0000000 0.421518
## mid  0.00e+00 0.0319990 0.4215180 1.000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 14, 14, 13, 8 und -1!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 6, 8, 12, 4 und 9! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, freshmatter und grade an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCJOAZW & 1.0 | 2.0 | Mikro \\
    B & GCWMI34 & 3.5 | 1.5 | Klein \\ 
    C & GC5YIVA & 2.5 | 5.0 | Klein \\ 
    D & GC6ZYGA & 5.0 | 4.5 | Mikro \\ 
    E & GC1A5SO & 3.0 | 2.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 151 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{-3, 12, 4\}$ und den Vektor $B = \{3, 4, 7\}$ gegeben.
