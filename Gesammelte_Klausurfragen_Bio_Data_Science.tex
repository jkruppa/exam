...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.03, 0.42 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.0075, 0.105 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.0075, 0.105 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.12, 1.68 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.12, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.12, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 22, 5, 14, 13 und 13.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 13.4 +/- 6.02
\item [\textbf{B} \msquare] Es ergibt sich 13.4 +/- 3.01
\item [\textbf{C} \msquare] Es ergibt sich 13.4 +/- 36.3
\item [\textbf{D} \msquare] Es ergibt sich 14.4 +/- 3.01
\item [\textbf{E} \msquare] Es ergibt sich 12.4 +/- 18.15
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 16, 29, 27, 25, 26, 16 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 [16, 29]
\item [\textbf{B} \msquare] Es ergibt sich 26 [17, 30]
\item [\textbf{C} \msquare] Es ergibt sich 26 +/- 16
\item [\textbf{D} \msquare] Es ergibt sich 26 +/- 16
\item [\textbf{E} \msquare] Es ergibt sich 26 +/- 29
\end{enumerate} 
...
$y = \{19, 21, 16, 18, 21, 18, 21\}$. Berechnen Sie folgende
...
\begin{center}
$8.6, 11.8, 8.8, 12, 9.3, 11.5, 9.9, 8.4, 7.2, 6.9, 12.7, 11.9, 9.8, 13.3$
\end{center}
...
## t = -0.59747, df = 14, p-value = 0.5597
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.642693  2.055392
## sample estimates:
...
## 
## data:  weight by group
## t = 0.19098, df = 12, p-value = 0.8517
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.163386  4.963386
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 39.19 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 93.78 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 92.254  46.127  12.117 0.0002831
## Residuals 22 83.746   3.807
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 119  98 114 122 104  92 133 139 148 170 151 151
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 30.61 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 83.75 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 480.75 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 65 & 1056.76 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2  43.11  21.555  1.0156 0.382006
## form       1 275.59 275.590 12.9857 0.002031
## dose:form  2 185.02  92.511  4.3591 0.028589
## Residuals 18 382.01  21.223
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -3.400 -2.286 -0.900  1.964  7.600 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.286      1.257  15.341 2.82e-08
## trtB           3.114      1.948   1.599    0.141
## 
## Residual standard error: 3.326 on 10 degrees of freedom
## Multiple R-squared:  0.2036,	Adjusted R-squared:  0.124 
## F-statistic: 2.557 on 1 and 10 DF,  p-value: 0.1409
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{Multiple R-squared}!
  Was sagt Ihnen der Wert $0.2036$ aus? \textbf{(2 Punkte)}
...
\midrule
11.52 & 1 & 12.15 & 102.03 & 72.07 & 7\\
10.60 & 1 & 9.54 & 103.09 & 77.03 & 8\\
10.32 & 0 & 7.19 & 96.26 & 65.49 & 9\\
9.55 & 0 & 10.19 & 103.30 & 68.72 & 11\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.0795 -1.5110  0.0391  1.5094  6.5128 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.04882    6.55476  -0.007  0.99407
## water       -0.36556    0.12497  -2.925  0.00417
## Fe           0.75464    0.06321  11.938  < 2e-16
## P           -0.24499    0.14727  -1.664  0.09898
## 
## Residual standard error: 2.326 on 112 degrees of freedom
## Multiple R-squared:  0.5762,	Adjusted R-squared:  0.5648 
## F-statistic: 50.76 on 3 and 112 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & so4 & temp & do2\\
\midrule
BEAR\_CR & 54 & 19611 & 10.92 & 19.5 & 8.3\\
DEAD\_RUN & 25 & 4145 & 44.93 & 23.0 & 8.7\\
PRETTYBOY\_BR & 19 & 904 & 9.20 & 19.2 & 9.8\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -7.761  -3.648  -1.930   1.518  18.334  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -1.443e+00  1.707e+00  -0.846   0.4019
## acerage      3.253e-05  1.663e-05   1.956   0.0562
## so4          1.135e-03  2.023e-02   0.056   0.9555
## temp         1.299e-01  5.100e-02   2.547   0.0141
## do2          2.447e-01  1.287e-01   1.901   0.0632
## 
## (Dispersion parameter for quasipoisson family taken to be 35.79975)
## 
##     Null deviance: 1887.2  on 53  degrees of freedom
## Residual deviance: 1397.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.368    -1.41    0.160
## 2 nematodes       0.143     1.35    0.176
## 3 light           0.473    -0.709   0.478
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3355 -0.5839 -0.0870  0.5428  3.4122 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  232.9   15.26   
##  subject  (Intercept) 3945.8   62.82   
##  Residual              682.7   26.13   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.148     26.592   7.639
## attitudepop  -20.604      5.741  -3.589
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0095330 0.5045268 0.0001544
## high 0.0095330 1.0000000 0.0453307 0.1355387
## low  0.5045268 0.0453307 1.0000000 0.0010210
## mid  0.0001544 0.1355387 0.0010210 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 7, 7, 9, 8 und 23!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 6, -3, 5 und 12! \textbf{(2 Punkte)}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCP9EF6 & 4.5 | 4.0 | Mikro \\
    B & GCNGQDQ & 5.0 | 3.5 | Normal \\ 
    C & GC1942O & 3.0 | 3.0 | Normal \\ 
    D & GCPD8ST & 2.5 | 4.5 | Mikro \\ 
    E & GCYVCF4 & 1.5 | 2.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 536 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{12, -1, 4\}$ und den Vektor $B = \{4, 4, -1\}$ gegeben.
