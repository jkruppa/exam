...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\square\!\blacksquare\!\blacksquare$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
Ein Versuch wurde an 50 Tieren durchgeführt, wobei jedes Tier eine von drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Die folgende Abbildung enthält die Daten aus diesem Versuch zur Bewertung der Wirkung von Vitamin C auf das Zahnwachstum bei Igeln.  Welche Aussage ist richtig, wenn Sie eine zweifaktorielle ANOVA rechnen?
...
\item [\textbf{B} \msquare] Es ergibt sich 11 +/- 1.935
\item [\textbf{C} \msquare] Es ergibt sich 10 +/- 15
\item [\textbf{D} \msquare] Es ergibt sich 10 +/- 1.935
\item [\textbf{E} \msquare] Es ergibt sich 9 +/- 7.5
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 20, 23, -2, 24, 15, 15, 18, 14, 2, 19 und 42.
...
\item [\textbf{B} \msquare] Es ergibt sich 17 +/- 14
\item [\textbf{C} \msquare] Es ergibt sich 17 [15, 24]
\item [\textbf{D} \msquare] Es ergibt sich 18 [14, 23]
...
\begin{enumerate}
\item [\textbf{A} \msquare] Einen Dotplot. Die Punkte müssen sich wie an einer Perlenschnurr audreihen. Eine Abweichung führt zur Ablehnung der Annahme.
\item [\textbf{B} \msquare] Einen Violinplot. Der Bauch der Violine muss hierbei einen höhren Wert annehmen als der Steg der Violine. Dann kann die Annahme angenommen werden.
...
In dem folgenden Histogramm von $n = 229$ Pflanzen ist welche Verteilung abgebildet?
...
Einträge in englischer Sprache zu verfassen, wenn Sie später die Daten in
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.46, da es sich um ein Anteil handelt. Wir berechnen den Anteil der Kranken.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 1.17, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Das Verhältnis der Chancen Odds ratio ergibt ein Chancenverhältnis von 0.46. Wir sind an der Chance krank zu sein interessiert.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.86, da es sich um eine Chancenverhältnis handelt
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.34, 0.001 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1.36, 0.004 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 0.004 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 0.004 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.085, 3e-04 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.085, 3e-04 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate}
...
Sie haben die \textit{Power} berechnet. Was sagt Ihnen dieser Begriff aus?



\begin{enumerate}
\item [\textbf{A} \msquare] Alle statistischen Tests sind so konstruiert, dass die $H_A$ mit 20\% \textit{bewiesen wird}. Die Power ist $1-\beta$ mit auf $\beta$ gleich 80\% gesetzt.
...
Ein Versuch wurde in 6 Parzellen pro Gruppe durchgeführt. Die folgende Abbildung enthält die Daten aus diesem Versuch zur Bewertung der Wirkung des Mikronährstoff Eisen auf den Ertrag in t/ha von Papaya im Vergleich zu einer Kontrolle.  Welche Aussage ist richtig, wenn Sie einen t-Test rechnen?
...
\item [\textbf{D} \msquare] Der Test deutet auf ein signifikanten Unterschied hin. Der Effekt liegt vermutlich bei -5.
\item [\textbf{E} \msquare] Nach Betrachtung des Barplots liegt kein signifikanter Unterschied vor. Der Effekt liegt bei -5.
\end{enumerate}
...
Sie führen paarweise t-Tests für alle Vergleiche der verschiedenen Rapssorten in Ihrem Experiment durch. Nach der Adjustierung für multiples Testen ist kein p-Wert unter der $\alpha$-Schwelle. Ihr Experiment beinhaltet fünf Rapssorten und eine ANOVA ergibt $p = 0.049$ für den Ertrag. Sie schauen sich auch die rohen, unadjustierten p-Werte an und finden hier als niedrigsten p-Wert $p_{3-2} = 0.052$. Welche Aussage ist richtig?
...
In einer Klimakammer mit drei D{"u}ngestufen ($ctrl$, $low$ und $high$) als Behandlung
...
Nach einem Freilandversuch mit drei Lichtstufen ($none$, $200lm$ und $600lm$) als Behandlung
...
\begin{center}
$4, 3, 6, 6, 3, 3, 2, 5, 7, 5, 4, 2, 0, 3, 2, 1, 5, 1, 7, 2, 7, 6, 2, 3, 3, 3, 3, 0, 1, 1, 1, 5, 5$
\end{center}
...
\begin{center}
$6.5, 8.9, 8.8, 14.6, 11.9, 13.2, 8.1, 11, 13.1, 7.4, 11.3, 10.5, 10.9, 10.1, 9, 10.4, 8.1$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ abgelehnt & $\alpha$-Fehler & 5\% & H$_0$ falsch \\
  \end{tabular}
  \end{center}
...
Trockengewicht (\textit{drymatter}) von Erdbeeren in $kg/ha$.
...
## t = 4.1975, df = 10, p-value = 0.001836
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  2.332447 7.610410
## sample estimates:
...
## t = 0.086744, df = 10, p-value = 0.9326
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -2.821313  3.049884
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{group}  & 2 &  &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 & 45.97 &  &  &  \strut\\
        \hline
   \textbf{total}  & 24 & 74.24 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Faktorstufen \textit{pos}, \textit{mid} und
\textit{neg} vorliegen.
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 333.21 &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 & 65.43 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  2.006  1.0028  0.2076 0.8143
## Residuals 20 96.603  4.8302
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 117.55 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 171.55 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 71.39 &  &  &  \strut\\
    \hline
   \textbf{error}  & 32 & 214.72 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 65 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: fat_perc
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2 161.617  80.809  8.1210 0.0030649
## form       1  19.391  19.391  1.9487 0.1797074
## dose:form  2 215.115 107.557 10.8092 0.0008249
## Residuals 18 179.110   9.951
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0316374 0.0004685 0.8339155
## high 0.0316374 1.0000000 0.0000007 0.0500960
## low  0.0004685 0.0000007 1.0000000 0.0002587
## mid  0.8339155 0.0500960 0.0002587 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 126$ Pflanzen untersucht.
\vspace{5Ex}
...
## -5.7143 -1.6286  0.3429  1.3143  4.4000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   14.714      1.211   12.15 2.59e-07
## waterB         9.886      1.876    5.27 0.000363
## 
## Residual standard error: 3.204 on 10 degrees of freedom
## Multiple R-squared:  0.7353,	Adjusted R-squared:  0.7088 
## F-statistic: 27.77 on 1 and 10 DF,  p-value: 0.0003628
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7353$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: N, block und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
Maiss in einem Gew{"a}chshausexperiment wollen Sie nun den Versuch eine Nummer gr{\"o}{\ss}er
...
$95$cm sowie eine L{\"a}nge von  $220$cm.
...
\item Wenn Sie die 7 Blaubeerschalen gekauft haben, wie viele Aligatorbirnen zu je 1.79 EUR können Sie sich dann noch für 200 EUR leisten? \textbf{(1 Punkt)}
\end{enumerate}
...
\midrule
dustbathing & 38cm; 24cm; 2.1\% & 37cm; 30cm; 5.2\% & 46cm; 22cm; 2.1\%\\
wingflapping & 33cm; 27cm; 1.6\% & 40cm; 25cm; 8.1\% & 40cm; 12cm; 7.6\%\\
wing/leg stretching & 36cm; 28cm; 3.2\% & 36cm; 27cm; 3.2\% & 43cm; 30cm; 1.2\%\\
walking & 34cm; 18cm; 0.8\% & 37cm; 23cm; 1\% & 41cm; 22cm; 0.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCP3K8V & 2.0 | 2.5 | Mikro \\
    B & GCCPVWX & 1.0 | 4.5 | Klein \\ 
    C & GCBBQWX & 3.0 | 3.0 | Normal \\ 
    D & GCEWLNU & 5.0 | 1.5 | Klein \\ 
    E & GCM8B6O & 3.5 | 3.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 691 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{8\times 10^{9}} - \ensuremath{1.4\times 10^{9}} \cdot 2.3^{-0.3 \cdot t + 3.2}
\end{equation*}
