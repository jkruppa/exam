...
wurde an 62 Schweinen durchgef{\"u}hrt, wobei jedes Tier eine von
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 15, 9, 17, 16 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 13.4 +/- 1.825
\item [\textbf{B} \msquare] Es ergibt sich 12.4 +/- 6.65
\item [\textbf{C} \msquare] Es ergibt sich 13.4 +/- 13.3
\item [\textbf{D} \msquare] Es ergibt sich 14.4 +/- 1.825
\item [\textbf{E} \msquare] Es ergibt sich 13.4 +/- 3.65
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 24, 30, 18, 2, 25, 31 und 51.
...
\item [\textbf{C} \msquare] Es ergibt sich 26 [19, 32]
\item [\textbf{D} \msquare] Es ergibt sich 25 [18, 31]
\item [\textbf{E} \msquare] Es ergibt sich 25 +/- 31
\end{enumerate} 
...
In dem folgenden Histogramm von $n = 209$ Pflanzen ist welche
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.42, 0.02 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.105, 0.005 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.105, 0.005 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1.68, 0.08 und 1.36. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
Nach einem Freilandversuch mit zwei Bew{"a}sserungstypen ($low$ und $high$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Datentabelle mit dem
...
\begin{center}
$2, 6, 6, 5, 4, 5, 5, 7, 5, 5, 5, 3, 2, 2, 4, 4, 4, 2, 2, 6, 5, 6, 4, 6, 3, 7, 4$
\end{center}
...
\begin{center}
$11, 10, 7.2, 9.3, 6.7, 14.1, 10.7, 11.4, 9.5, 10.6, 10.6, 10.5, 10.9, 9.1, 9.3, 13.3, 12.8, 10.8, 11.3, 9.6, 10.5, 9, 8.1$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  20\% & H$_0$ abgelehnt & Testentscheidung & (Unbekannte) Wahrheit \\
  \end{tabular}
  \end{center}
...
## t = -0.33093, df = 14, p-value = 0.7456
...
Der Datensatz \texttt{plant\_growth\_tbl} enth{\"a}lt das Trockengewicht der Kartoffeln
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 126.02 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 76.41 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 116.222  58.111   41.29 1.7e-08
## Residuals 24  33.778   1.407
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 1.89 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 69.23 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 38.91 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 209.5 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: weight
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 134.38   67.19  4.3819   0.02815
## form       1 655.68  655.68 42.7613 3.807e-06
## dose:form  2 107.41   53.70  3.5024   0.05191
## Residuals 18 276.00   15.33
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0004750 0.6279669 0.0253470
## high 0.0004750 1.0000000 0.0018135 0.1320752
## low  0.6279669 0.0018135 1.0000000 0.0726115
## mid  0.0253470 0.1320752 0.0726115 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## (Intercept)   18.400      1.187  15.496 2.99e-07
## waterB        -8.000      1.679  -4.764  0.00142
## 
## Residual standard error: 2.655 on 8 degrees of freedom
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7394$ aus? \textbf{(2 Punkte)}
...
## t = -4.2346, df = 8, p-value = 0.002858
...
Einflussvariablen ($x$) wurden erhoben: variety, region und weight. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\item $i$ dem Verhalten: (1) wingflapping, (2) wing/leg stretching, (3)
...
\midrule
wingflapping & 37cm; 28cm; 3.5\% & 45cm; 24cm; 12.1\% & 40cm; 28cm; 8.9\%\\
wing/leg stretching & 40cm; 30cm; 1.2\% & 28cm; 22cm; 1.2\% & 28cm; 28cm; 8.1\%\\
dustbathing & 43cm; 28cm; 3.2\% & 35cm; 26cm; 5.1\% & 33cm; 26cm; 1.2\%\\
standing & 32cm; 36cm; 7.3\% & 25cm; 27cm; 1.2\% & 32cm; 35cm; 1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCQRGMH & 2.0 | 3.0 | Klein \\
    B & GCVJUNW & 4.0 | 4.5 | Normal \\ 
    C & GCVNDEO & 4.5 | 2.0 | Klein \\ 
    D & GC4D3UJ & 3.0 | 4.0 | Normal \\ 
    E & GCOI5DH & 3.5 | 5.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 510 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.2\times 10^{10}} - \ensuremath{10^{9}} \cdot 2^{-0.3 \cdot t + 3.2}
\end{equation*}
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  6-mal-gefaltete, 0.5mm, 50-cm-Karton} durch
...
Sie haben den Vektor $A = \{11, 9, 5\}$ und den Vektor $B = \{-2, -1, 5\}$ gegeben.
