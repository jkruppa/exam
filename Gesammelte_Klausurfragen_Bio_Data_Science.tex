...
wurde an 64 Schweinen durchgef{\"u}hrt, wobei jedes Tier eine von
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 4, 7, 15, 11 und 15.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.4 +/- 2.44
\item [\textbf{B} \msquare] Es ergibt sich 10.4 +/- 23.8
\item [\textbf{C} \msquare] Es ergibt sich 10.4 +/- 4.88
\item [\textbf{D} \msquare] Es ergibt sich 9.4 +/- 11.9
\item [\textbf{E} \msquare] Es ergibt sich 10.4 +/- 2.44
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 14, 21, 4, 9, 22, 14 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 14 +/- 22
\item [\textbf{B} \msquare] Es ergibt sich 21 +/- 9
\item [\textbf{C} \msquare] Es ergibt sich 14 [9, 22]
\item [\textbf{D} \msquare] Es ergibt sich 14 +/- 9
\item [\textbf{E} \msquare] Es ergibt sich 21 [10, 23]
\end{enumerate} 
...
Sie wollen nach einem Feldversuch die Standardabweichung berechnen. Welche der folgenden Rechenoperationen m{"u}ssen durchgef{"u}hrt werden?
...
\item [\textbf{D} \msquare] Einen Violinplot. Der Bauch der Violine muss hierbei einen h{"o}hren Wert annehmen als der Steg der Violine. Dann kann die Annahme angenommen werden.
...
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.33, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.02, 0.03 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.005, 0.0075 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.08, 0.12 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3.56, 0.08, 0.12 und 1.36. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.08, 0.12 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.005, 0.0075 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate}
...
\item [\textbf{D} \msquare] Contrast letter display. Unterschiede in den Behandlungen werden durch den gleichen Buchstaben oder Symbol dargestellt. Die Interpretation des CLD f{"u}hrt h{"a}ufig in die Irre.
...
\begin{enumerate}
\item [\textbf{A} \msquare] Das R Paket ggplot. Wir erhalten hier sofort eine Visualisierung der Daten. Anhand der Visualisierung l{"a}sst sich eine explorative Datenanalyse durchf{"u}hren, die gleichwertig zu einem Posthoc-Test ist.
...
\item [\textbf{C} \msquare] Das R Paket hmisc erlaubt die Durchf{"u}hrung eines multiplen Gruppenvergleichs aus verschiedenen Modellen heraus. Aus einem hmisc Objekt l{"a}sst sich recht einfach das CL-h erstellen und so {"u}ber Barplots eine schnelle Interpration der statistischen Auswertung durchf{"u}hren.
...
\item [\textbf{D} \msquare] In der Analogie der Durchschnittstemperatur: Wie oft tritt ein Effekt durchschnittlich ein? Wir erhalten eine Wahrscheinlichkeit f{"u}r die Effekte. Zum Beispiel, wie hoch ist die Wahrscheinlichkeit f{"u}r einen Mittelwert als Durchschnitt.
...
Nach einem Feldexperiment mit drei Genotypen ($AA$, $AB$ und $BB$) als Behandlung
...
\item Beschriften Sie \textit{einen} der beiden Boxplots mit den g{\"a}ngigen
  statistischen Ma{\ss}zahlen! \textbf{(2 Punkte)}
\item Wenn Sie \textit{keinen Effekt} zwischen den Behandlungen von
  Kartoffeln erwarten w{\"u}rden, wie sehen dann die beiden Boxplots aus?
  \textbf{(1 Punkt)}
\end{enumerate} 
\clearpage
% -----------------------------------------------------------------------
...
\begin{center}
$4, 6, 1, 4, 1, 4, 3, 4, 4, 2, 3, 7, 2, 10, 7, 3, 4, 5, 3, 2, 6, 1, 5, 5, 5, 0, 3$
\end{center}
...
\begin{center}
$8.4, 9.3, 8.3, 9.1, 9.3, 8.1, 9.9, 10.4, 13.7, 11, 7.9, 9, 11.9, 11.1, 8.1, 10, 8.7, 6.5, 8.2, 9.9$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  (Unbekannte) Wahrheit & H$_0$ wahr & H$_0$ falsch & 5\% \\
  \end{tabular}
  \end{center}
...
Trockengewicht (\textit{drymatter}) von Kartoffeln.
...
## t = -0.37318, df = 14, p-value = 0.7146
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -4.712416  3.315591
## sample estimates:
...
## 
## data:  freshmatter by N
## t = -0.20991, df = 14, p-value = 0.8368
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -2.314737  1.902039
## sample estimates:
...
## t = -4.0818, df = 8, p-value = 0.003525
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -3.999297 -1.111814
## sample estimates:
...
Der Datensatz \texttt{plant\_growth\_tbl} enth{\"a}lt das Frischgewicht der Lauchstangen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 45.89 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 88.98 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Der Datensatz \textit{crop\_tbl} enth{\"a}lt das Outcome \textit{freshmatter} f{\"u}r ein Feldexperiment mit 
...
## trt        2 162.032  81.016  40.537 4.188e-08
## Residuals 22  43.968   1.999
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 7.66 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 291.77 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 351.09 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 407.29 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 68 Ziegen durchgef{\"u}hrt, wobei
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 194.45  97.227  5.3277 0.0152268
## form       1 289.25 289.245 15.8495 0.0008758
## dose:form  2  92.70  46.348  2.5397 0.1067646
## Residuals 18 328.49  18.249
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.8468590 0.0013064 0.1564901
## high 0.8468590 1.0000000 0.0007672 0.1095970
## low  0.0013064 0.0007672 1.0000000 0.0463520
## mid  0.1564901 0.1095970 0.0463520 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 118$ Pflanzen untersucht.
\vspace{5Ex}
...
## -5.4444 -2.3333 -0.7222  3.1667  6.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   20.000      1.220  16.398 1.99e-11
## waterB         5.444      1.725   3.156  0.00611
## 
## Residual standard error: 3.659 on 16 degrees of freedom
## Multiple R-squared:  0.3837,	Adjusted R-squared:  0.3452 
## F-statistic: 9.963 on 1 and 16 DF,  p-value: 0.006113
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.3837$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: block, dosage und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\begin{enumerate}
\item Wie gro{\ss} war der Durchmesser der Eiche im Jahr $1820$ als
...
\midrule
walking & 23cm; 20cm; 3.5\% & 32cm; 20cm; 4.5\% & 22cm; 25cm; 8.9\%\\
preening & 36cm; 33cm; 25.4\% & 32cm; 23cm; 64.1\% & 35cm; 29cm; 50.1\%\\
sitting & 23cm; 26cm; 1.8\% & 34cm; 28cm; 5.2\% & 36cm; 25cm; 2.1\%\\
standing & 30cm; 29cm; 4.1\% & 26cm; 20cm; 3.6\% & 37cm; 25cm; 6.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCICP4D & 3.0 | 3.0 | Mikro \\
    B & GCT4CMK & 4.5 | 1.0 | Normal \\ 
    C & GCXXH7I & 4.0 | 5.0 | Mikro \\ 
    D & GCRJLJG & 2.0 | 2.5 | Mikro \\ 
    E & GCTDQSV & 1.5 | 1.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1004 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{1.4\times 10^{9}} \cdot 2.3^{-0.15 \cdot t + 3.2}
\end{equation*}
...
L{\"a}nder z{\"a}hlen. Im Jahr 2021 leben ca. \ensuremath{8.4\times 10^{7}} Menschen in Deutschland und
...
\item Beschriften Sie den H{\"a}ufigkeitsdoppelbaum, mit denen Ihnen bekannten
  Informationen zuder AIDS Erkrankung und dem AIDS-Test! \textbf{(1 Punkt)}
...
Sie haben den Vektor $A = \{-7, 14, 9\}$ und den Vektor $B = \{2, -2, 3\}$ gegeben.
