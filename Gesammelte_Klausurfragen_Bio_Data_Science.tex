...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.03, 0.42, 0.34, 0.01 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.18, 1, 1, 0.06 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.26, 0.18, 2.52, 2.04, 0.06 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.005, 0.07, 0.0567, 0.0017 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.005, 0.07, 0.0567, 0.0017 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.18, 1, 1, 0.06 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 15, 13, 15, 19 und 9.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 15.2 +/- 1.815
\item [\textbf{B} \msquare] Es ergibt sich 14.2 +/- 13.2
\item [\textbf{C} \msquare] Es ergibt sich 14.2 +/- 1.815
\item [\textbf{D} \msquare] Es ergibt sich 13.2 +/- 6.6
\item [\textbf{E} \msquare] Es ergibt sich 14.2 +/- 3.63
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 23, 25, 22, 21, 11, 10 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 +/- 25
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 11
\item [\textbf{C} \msquare] Es ergibt sich 22 [11, 25]
\item [\textbf{D} \msquare] Es ergibt sich 23 [11, 25]
\item [\textbf{E} \msquare] Es ergibt sich 22 +/- 11
\end{enumerate}
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.03 liegt keine Overdispersion vor.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.5, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.5, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.33, da es sich um ein Anteil handelt.
...
\item [\textbf{B} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 10.3
...
\item [\textbf{D} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 10.3
\item [\textbf{E} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -3.21
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 20
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 39
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 78
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 76
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 38
\end{enumerate}
...
\item [\textbf{D} \msquare] Wir machen Aussagen über Populationen!
...
$y = \{24, 18, 15, 18, 18, 21, 15, 15, 22, 23, 26\}$. Berechnen Sie folgende
...
\begin{center}
$8.5, 13.8, 7.1, 10.6, 11.4, 10.6, 10.2, 8.1, 9.4, 13.2, 7.5, 7.5, 12.7, 11.7$
\end{center}
...
## t = -2.9426, df = 12, p-value = 0.01231
...
## t = 2.8876, df = 14, p-value = 0.01193
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  0.8819744 5.9751685
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 39.8 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 78.44 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  25.407 12.7037  2.7115 0.08676
## Residuals 24 112.444  4.6852
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 128 126 115  95  88 105 147 141 147 150 156 152
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 952.03 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 5.59 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 208.46 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 487.08 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 438.29 219.147 13.3022 0.0002838
## form       1   0.00   0.000  0.0000 0.9981255
## dose:form  2  48.19  24.094  1.4625 0.2579095
## Residuals 18 296.54  16.475
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   80   \strut\\
    \hline
     &  74 &  66 &  140  \strut\\
  \end{tabular}
\end{center}
...
## -10.1111  -2.6944   0.1111   2.6944   7.8889 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.111      1.433  11.241 5.27e-09
## trtB          -2.222      2.027  -1.096    0.289
## 
## Residual standard error: 4.3 on 16 degrees of freedom
## Multiple R-squared:  0.06988,	Adjusted R-squared:  0.01175 
## F-statistic: 1.202 on 1 and 16 DF,  p-value: 0.2891
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -7.9028, df = 8, p-value = 4.768e-05
...
%% --------------------------------------------------------------------
\hfill\href{https://youtu.be/Nre6kTd39dQ}{\includegraphics[width =
  2cm]{img/youtube}}\\[1Ex]
%% --------------------------------------------------------------------
...
%% --------------------------------------------------------------------
%\hfill\href{https://youtu.be/SYWw33dNz7k}{\includegraphics[width =
%  2cm]{img/youtube}}\\[1Ex]
%% --------------------------------------------------------------------
...
Einflussvariablen ($x$) wurden erhoben: height, block und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.59 & 0 & 10.52 & 99.43 & 68.48 & 6\\
9.94 & 0 & 11.89 & 96.17 & 66.33 & 10\\
7.51 & 0 & 9.68 & 97.60 & 66.01 & 12\\
12.43 & 0 & 10.83 & 106.17 & 75.17 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.4263 -1.9461  0.1105  1.9394  6.1262 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  71.4552     2.8526  25.049   <2e-16
## P            -0.3425     0.1912  -1.791   0.0762
## light         0.3759     0.6512   0.577   0.5650
## water         0.1643     0.2176   0.755   0.4519
## 
## Residual standard error: 2.967 on 102 degrees of freedom
## Multiple R-squared:  0.04085,	Adjusted R-squared:  0.01264 
## F-statistic: 1.448 on 3 and 102 DF,  p-value: 0.2333
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & maxdepth & do2 & temp\\
\midrule
PINEY\_BR & 48 & 4011 & 52 & 8.3 & 18.9\\
LITTLE\_HUNTING\_CR & 18 & 7121 & 58 & 9.5 & 16.0\\
CABIN\_JOHN\_CR & 21 & 8612 & 103 & 8.2 & 15.0\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.891  -3.995  -1.652   2.215  16.344  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.197e+00  1.834e+00  -1.198  0.23677
## acerage      4.349e-05  1.453e-05   2.994  0.00431
## maxdepth     1.480e-02  4.552e-03   3.252  0.00208
## do2          2.651e-01  1.311e-01   2.021  0.04873
## temp         1.035e-01  4.832e-02   2.143  0.03714
## 
## (Dispersion parameter for quasipoisson family taken to be 33.38548)
## 
##     Null deviance: 2297.8  on 53  degrees of freedom
## Residual deviance: 1443.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.66      2.01   0.0442
## 2 water           0.162    -2.07   0.0381
## 3 nematodes       0.157    -0.635  0.525
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1752 -0.6413 -0.0784  0.4949  3.2381 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  205.3   14.33   
##  subject  (Intercept) 3924.8   62.65   
##  Residual              701.8   26.49   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  200.909     26.461   7.593
## attitudepop  -17.413      5.821  -2.991
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0583065 0.1057610 0.0726538
## high 0.0583065 1.0000000 0.0009825 0.0005793
## low  0.1057610 0.0009825 1.0000000 0.8492461
## mid  0.0726538 0.0005793 0.8492461 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, 11, 8, 9 und 5!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 9, 11, 7, 11 und 12! \textbf{(2 Punkte)}
