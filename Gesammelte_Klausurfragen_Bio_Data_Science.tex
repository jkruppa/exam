...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.21, 0.34 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3.56, 0.84, 1.36 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.0525, 0.085 und 0.0003. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.0525, 0.085 und 0.0003. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.84, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.84, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 15, 6, 9, 8 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.2 +/- 3.42
\item [\textbf{B} \msquare] Es ergibt sich 8.2 +/- 5.85
\item [\textbf{C} \msquare] Es ergibt sich 9.2 +/- 1.71
\item [\textbf{D} \msquare] Es ergibt sich 10.2 +/- 1.71
\item [\textbf{E} \msquare] Es ergibt sich 9.2 +/- 11.7
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 14, 22, 20, -4, 24, 31, 14, 15, 23, 13 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 +/- 14
\item [\textbf{B} \msquare] Es ergibt sich 20 [14, 24]
\item [\textbf{C} \msquare] Es ergibt sich 20 +/- 24
\item [\textbf{D} \msquare] Es ergibt sich 21 [14, 24]
\item [\textbf{E} \msquare] Es ergibt sich 20 +/- 14
\end{enumerate}
...
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.12 liegt keine Overdispersion vor.
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.12 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.93 ist
richtig?
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 1.75, da es sich um ein Anteil handelt.
...
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.36, da es sich um ein Anteil handelt.
\end{enumerate}
...
\item [\textbf{C} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.42
\item [\textbf{D} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 0.18
\item [\textbf{E} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 0.18
\end{enumerate}
...
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 69
\end{enumerate}
...
$y = \{16, 20, 24, 22, 22, 17, 21\}$. Berechnen Sie folgende
...
## t = -0.625937, df = 10, p-value = 0.54538
...
## t = -0.637407, df = 12, p-value = 0.53583
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.7491295  1.5046851
## sample estimates:
...
## 
## data:  weight by group
## t = -0.0726832, df = 12, p-value = 0.94326
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.5069916  5.1514360
## sample estimates:
...
## 
## data:  drymatter by Fe
## t = 0.911922, df = 8, p-value = 0.38846
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 127 113 128 100 106  94 132 139 140 128 161 149
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{group}  & 2 & 3.68 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 11.13 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  4.10875 2.054377 4.09138 0.028052 *
## Residuals 27 13.55732 0.502123                   
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 206.03 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2418.13 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 109.66 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 701.94 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 68 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: len
##           Df   Sum Sq  Mean Sq   F value                 Pr(>F)    
## supp       1  263.764  263.764  22.84635            0.000011184 ***
## dose       2 2537.235 1268.618 109.88317 < 0.000000000000000222 ***
## supp:dose  2  149.413   74.707   6.47082              0.0028036 ** 
## Residuals 62  715.799   11.545                                     
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
In einem Stallexperiment mit $n = 104$ Ferkeln wurde der
...
## -4.55556 -1.05556  0.11111  1.44444  6.44444 
## 
## Coefficients:
##             Estimate Std. Error t value         Pr(>|t|)    
## (Intercept) 15.55556    0.88104 17.6559 0.00000000000648 ***
## trtB         0.66667    1.24598  0.5351              0.6    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.6431 on 16 degrees of freedom
## Multiple R-squared:  0.017578,	Adjusted R-squared:  -0.043823 
## F-statistic: 0.28628 on 1 and 16 DF,  p-value: 0.59997
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: rainfall, fertilizier und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & maxdepth & so4 & temp & acerage\\
\midrule
BUSH\_CR & 32 & 120 & 11.31 & 18.0 & 19046\\
MEADOW\_BR & 234 & 93 & 10.98 & 24.3 & 4803\\
LITTLE\_ANTIETAM\_CR & 24 & 44 & 13.37 & 24.0 & 3488\\
LITTLE\_FALLS & 84 & 56 & 5.69 & 19.5 & 1600\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##      Min        1Q    Median        3Q       Max  
## -10.3844   -4.5377   -1.5770    1.6983   17.4010  
## 
## Coefficients:
##                 Estimate   Std. Error t value Pr(>|t|)   
## (Intercept)  1.293723933  0.915145975  1.4137 0.163778   
## maxdepth     0.009577519  0.004047544  2.3663 0.021967 * 
## so4         -0.031533302  0.027480050 -1.1475 0.256748   
## temp         0.083109631  0.041572213  1.9992 0.051153 . 
## acerage      0.000041022  0.000014265  2.8758 0.005949 **
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 39.291982)
## 
##     Null deviance: 2385.09  on 53  degrees of freedom
## Residual deviance: 1663.49  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.45      3.00  0.00272
## 2 nematodes       0.145     0.659 0.510  
## 3 water           0.142    -3.17  0.00152
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
9.59 & 0 & 10.57 & 100.76 & 72.64 & 4\\
7.67 & 0 & 8.06 & 95.78 & 66.43 & 12\\
11.03 & 0 & 10.08 & 98.64 & 65.66 & 14\\
9.64 & 0 & 11.68 & 97.12 & 64.74 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -5.08673 -1.52128  0.09287  1.36288  6.04803 
## 
## Coefficients:
##               Estimate Std. Error t value             Pr(>|t|)    
## (Intercept) -15.528501   8.250559 -1.8821              0.06288 .  
## light         0.515209   0.520433  0.9900              0.32471    
## Fe            0.862089   0.078611 10.9665 < 0.0000000000000002 ***
## water        -0.094923   0.183181 -0.5182              0.60553    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.3118 on 95 degrees of freedom
## Multiple R-squared:  0.56315,	Adjusted R-squared:  0.54935 
## F-statistic: 40.822 on 3 and 95 DF,  p-value: < 0.000000000000000222
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.16552 -0.59156 -0.17676  0.49844  3.40166 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  225.70  15.023  
##  subject  (Intercept) 3987.27  63.145  
##  Residual              643.33  25.364  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 204.2897    26.6853  7.6555
## attitudepop -23.0956     5.5731 -4.1441
## 
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.0009127 0.0000006 0.0029744
## B 0.0009127 1.0000000 0.0166842 0.6630237
## C 0.0000006 0.0166842 1.0000000 0.0056674
## D 0.0029744 0.6630237 0.0056674 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
