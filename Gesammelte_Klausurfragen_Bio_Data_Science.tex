...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.001, 0.42, 0.01 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.005, 1, 0.05 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.0002, 0.084, 0.002 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.7, 0.005, 2.1, 0.05 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.0002, 0.084, 0.002 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.005, 1, 0.05 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 15, 14, 9 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.8 +/- 1.295
\item [\textbf{B} \msquare] Es ergibt sich 12.8 +/- 1.295
\item [\textbf{C} \msquare] Es ergibt sich 11.8 +/- 6.7
\item [\textbf{D} \msquare] Es ergibt sich 11.8 +/- 2.59
\item [\textbf{E} \msquare] Es ergibt sich 10.8 +/- 3.35
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 6, 13, 22, 31, 21, 27 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 [13, 31]
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 13
\item [\textbf{C} \msquare] Es ergibt sich 24 [13, 31]
\item [\textbf{D} \msquare] Es ergibt sich 22 +/- 31
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.1 liegt Overdispersion vor. Damit kann keine Possion-Regression gerechnet werden. Die L{"o}sung ist eine Gaussian Regression mit Nullanpassung.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.1 liegt keine Overdispersion vor.
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.1 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\end{enumerate}
...
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.25, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 6.17
...
\item [\textbf{C} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 6.17
\item [\textbf{D} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -2.48
...
$y = \{21, 17, 16, 14, 13, 22, 12\}$. Berechnen Sie folgende
...
## t = -1.13412, df = 12, p-value = 0.27889
...
## t = 0.123198, df = 12, p-value = 0.90399
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.8202301  5.3980079
## sample estimates:
...
## t = -2.5926, df = 14, p-value = 0.021281
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.91817653 -0.74849013
## sample estimates:
## mean in group ctrl mean in group trt2 
##          14.000000          18.333333
\end{verbatim}
...
## t = 0.127343, df = 6, p-value = 0.90283
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.59 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.32 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  3.59474 1.797372 3.75599 0.036376 *
## Residuals 27 12.92043 0.478534                   
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 204.58 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2414.62 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 109.43 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 709.28 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df   Sum Sq  Mean Sq   F value               Pr(>F)    
## supp       1    3.152    3.152   0.26320             0.609982    
## dose       2 2476.477 1238.239 103.39092 < 0.0000000000000002 ***
## supp:dose  2   78.809   39.405   3.29023             0.044699 *  
## Residuals 55  658.695   11.976                                   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
Experiment mit $n = 131$ Sauen. In dem Experiment wurde gemessen,
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   48  \strut\\
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   83   \strut\\
    \hline
     &  70 &  61 &  131  \strut\\
  \end{tabular}
\end{center}
...
Einflussvariablen ($x$) wurden erhoben: S, weight und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
## (Intercept) 14.00000    0.41231  33.955 0.0000000006183 ***
## trtB         0.80000    0.58310   1.372          0.2073    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.92195 on 8 degrees of freedom
## Multiple R-squared:  0.19048,	Adjusted R-squared:  0.089286 
## F-statistic: 1.8824 on 1 and 8 DF,  p-value: 0.2073
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\toprule
stream & longnose & temp & acerage & no3 & do2\\
\midrule
LITTLE\_DEER\_CR & 38 & 20.5 & 8115 & 3.40 & 9.6\\
SOUTH\_FORK\_LINGANORE\_CR & 20 & 15.4 & 4106 & 2.62 & 10.0\\
RED\_RUN & 32 & 17.7 & 3332 & 2.09 & 8.4\\
LITTLE\_HUNTING\_CR & 18 & 16.0 & 7121 & 0.51 & 9.5\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##      Min        1Q    Median        3Q       Max  
## -9.01596  -3.07435  -0.77352   1.94463  13.28136  
## 
## Coefficients:
##                 Estimate   Std. Error t value   Pr(>|t|)    
## (Intercept) -2.157253749  1.380411936 -1.5628  0.1245449    
## temp         0.117047031  0.036318338  3.2228  0.0022593 ** 
## acerage      0.000063979  0.000016136  3.9651  0.0002385 ***
## no3          0.272140160  0.063843855  4.2626 0.00009162 ***
## do2          0.245104484  0.103160596  2.3760  0.0214579 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 20.725162)
## 
##     Null deviance: 1695.027  on 53  degrees of freedom
## Residual deviance:  991.157  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.378   -0.177    0.859
## 2 nematodes       0.144   -0.0691   0.945
## 3 light           0.488    1.23     0.218
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
8.26 & 0 & 9.92 & 98.09 & 66.37 & 9\\
8.95 & 0 & 10.68 & 98.69 & 71.23 & 9\\
10.22 & 0 & 9.93 & 101.57 & 73.57 & 14\\
11.14 & 0 & 10.13 & 94.83 & 69.19 & 14\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.8391 -2.5005  0.0194  2.3699  7.9855 
## 
## Coefficients:
##             Estimate Std. Error t value             Pr(>|t|)    
## (Intercept) 75.12995    3.71243 20.2374 < 0.0000000000000002 ***
## P           -0.40570    0.27195 -1.4918              0.13916    
## light        1.89692    0.74959  2.5306              0.01309 *  
## water       -0.17995    0.23004 -0.7823              0.43607    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.4198 on 92 degrees of freedom
## Multiple R-squared:  0.10019,	Adjusted R-squared:  0.070848 
## F-statistic: 3.4146 on 3 and 92 DF,  p-value: 0.020676
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.08433 -0.67315 -0.06283  0.64303  3.18664 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  228.52  15.117  
##  subject  (Intercept) 3892.63  62.391  
##  Residual              626.19  25.024  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 203.1096    26.3880  7.6970
## attitudepop -19.3828     5.4983 -3.5252
## 
...
\midrule
A & 17.14 & 17 & 16 & 18 & 16.5 & 18.0 & 0.81\\
B & 11.57 & 12 & 5 & 18 & 8.0 & 15.0 & 22.62\\
C & 11.86 & 14 & 3 & 20 & 8.0 & 15.0 & 34.81\\
D & 12.57 & 13 & 9 & 16 & 10.5 & 14.5 & 6.95\\
\bottomrule
\end{tabular}
\end{table}
