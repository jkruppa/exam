...
\begin{graybox}{Rechen- und Textaufgaben}
  ...
  \begin{center}
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
      ...
      \hspace{1Ex}\Large\textcolor{gray!70}{23}\hspace{1Ex}  & 
      \hspace{1Ex}\Large\textcolor{gray!70}{2}\hspace{1Ex}  & 
      \hspace{1Ex}\Large\textcolor{gray!70}{2}\hspace{1Ex}  & 
      \hspace{1Ex}\Large\textcolor{gray!70}{1}\hspace{1Ex} \strut\\
      \hline
  \end{tabular}
\end{center}
\begin{itemize}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.02, 0.01 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.005, 0.0025 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.08, 0.04 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.08, 0.04 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.08, 0.04 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.005, 0.0025 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 4, 10, 12, 14 und 4.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 7.8 +/- 10.6
\item [\textbf{B} \msquare] Es ergibt sich 8.8 +/- 4.6
\item [\textbf{C} \msquare] Es ergibt sich 9.8 +/- 2.3
\item [\textbf{D} \msquare] Es ergibt sich 8.8 +/- 2.3
\item [\textbf{E} \msquare] Es ergibt sich 8.8 +/- 21.2
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 15, 32, 17, 19, 10, 13, 17, 27, 18, 38 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 18 +/- 15
\item [\textbf{B} \msquare] Es ergibt sich 24 [16, 33]
\item [\textbf{C} \msquare] Es ergibt sich 18 +/- 32
\item [\textbf{D} \msquare] Es ergibt sich 18 [15, 32]
...
$y = \{18, 8, 19, 13, 18, 15, 13\}$. Berechnen Sie folgende
...
\begin{center}
$10.4, 14.2, 8.5, 12.7, 10.2, 7.8, 14.6, 11.5, 8, 8.1, 10.4, 14.2$
\end{center}
...
## t = 0.10449, df = 12, p-value = 0.9185
...
## t = -0.14142, df = 12, p-value = 0.8899
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.343790  2.058076
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 151.26 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 30.98 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 129.735  64.867  15.712 5.774e-05
## Residuals 22  90.825   4.128
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 127 115 114 129 100  84 126 138 141 148 164 148
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 28.7 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 188.57 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 107.15 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 307.27 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 381.95 190.976 20.1970 2.513e-05
## form       1   3.15   3.150  0.3332   0.57095
## dose:form  2 108.70  54.348  5.7476   0.01174
## Residuals 18 170.20   9.456
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.1429 -1.2143  0.5714  1.1786  2.2857 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  16.1429     0.7582  21.292 6.71e-11
## trtB         10.5714     1.0722   9.859 4.17e-07
## 
## Residual standard error: 2.006 on 12 degrees of freedom
## Multiple R-squared:  0.8901,	Adjusted R-squared:  0.881 
## F-statistic: 97.21 on 1 and 12 DF,  p-value: 4.173e-07
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 5.8228, df = 8, p-value = 0.0003948
...
\midrule
10.12 & 0 & 11.25 & 100.82 & 69.70 & 13\\
8.55 & 1 & 11.07 & 101.11 & 70.06 & 8\\
9.61 & 0 & 7.69 & 97.21 & 70.10 & 8\\
9.19 & 1 & 8.49 & 98.21 & 71.17 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.4203 -1.4995  0.0425  1.3224  4.7180 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 11.56128    6.43753   1.796  0.07520
## P           -0.61387    0.13048  -4.705 7.32e-06
## nematodes   -0.17995    0.06026  -2.986  0.00347
## Fe           0.66076    0.06374  10.367  < 2e-16
## 
## Residual standard error: 2.077 on 112 degrees of freedom
## Multiple R-squared:  0.5535,	Adjusted R-squared:  0.5415 
## F-statistic: 46.27 on 3 and 112 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & do2 & so4 & no3\\
\midrule
CABIN\_JOHN\_CR & 21 & 8612 & 8.2 & 16.09 & 1.57\\
LITTLE\_ANTIETAM\_CR & 24 & 3488 & 9.3 & 13.37 & 2.11\\
MILL\_CR & 6 & 1097 & 8.3 & 15.77 & 1.71\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.295  -4.239  -1.700   1.155  22.152  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.394e+00  1.291e+00   1.080  0.28548
## acerage      4.455e-05  1.282e-05   3.476  0.00107
## do2          1.627e-01  1.390e-01   1.170  0.24755
## so4         -3.415e-03  2.421e-02  -0.141  0.88841
## no3          1.447e-01  6.980e-02   2.073  0.04350
## 
## (Dispersion parameter for quasipoisson family taken to be 38.87773)
## 
##     Null deviance: 1991.2  on 53  degrees of freedom
## Residual deviance: 1357.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.66      2.81  0.00492
## 2 light           0.477     0.726 0.468  
## 3 water           0.167    -2.63  0.00853
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3493 -0.6752 -0.1065  0.5789  3.3476 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  219.0   14.80   
##  subject  (Intercept) 4182.1   64.67   
##  Residual              638.1   25.26   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   201.41      27.27   7.387
## attitudepop   -17.01       5.55  -3.065
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0491287 0.0000000 0.0000008
## high 0.0491287 1.0000000 0.0000002 0.0002787
## low  0.0000000 0.0000002 1.0000000 0.0173385
## mid  0.0000008 0.0002787 0.0173385 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 17, 0, 6, 12 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 13, 8, 11 und 14! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes Fe, P und leaf an vier verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{2, 14, -4\}$ und den Vektor $B = \{0, 3, 2\}$ gegeben.
