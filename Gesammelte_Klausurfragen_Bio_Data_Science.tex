...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.34, 0.89 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0003, 0.085, 0.2225 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0003, 0.085, 0.2225 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1.36, 3.56 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 11, 3, 4 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9 +/- 2.06
\item [\textbf{B} \msquare] Es ergibt sich 8 +/- 2.06
\item [\textbf{C} \msquare] Es ergibt sich 8 +/- 17
\item [\textbf{D} \msquare] Es ergibt sich 8 +/- 4.12
\item [\textbf{E} \msquare] Es ergibt sich 7 +/- 8.5
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 21, 31, 23, 7, 27, 21, 24, 29, 14, 18 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 29
\item [\textbf{B} \msquare] Es ergibt sich 24 [18, 29]
\item [\textbf{C} \msquare] Es ergibt sich 23 [18, 29]
...
\item [\textbf{D} \msquare] Der Begriff \textit{ordinary mean} beschreibt die einzelnen Mittelwerte der Level eines Faktors wohingegen der \textit{marginal mean} den Mittelwert {"u}ber alle Level des Faktors wiedergibt.
...
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.98 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.98 liegt keine Overdispersion vor.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.27, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.38, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.27, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 2.67, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.38, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
\item [\textbf{B} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 0.1
...
Mehr Informationen zu den Aufgaben in den folgenden Kapiteln aus dem Skript Bio Data Science.
  \begin{itemize}
  \item foo  \href{http://www.overleaf.com}{Something Linky}
  \end{itemize}
\end{graybox}
% -----------------------------------------------------------------------
...
Sie haben folgende Zahlenreihe $y$ vorliegen
$y = \{19, 18, 20, 23, 22, 20, 19\}$. Berechnen Sie folgende
...
## t = -0.163599, df = 10, p-value = 0.87331
...
## 
## data:  waterintake by infusion
## t = 0.587427, df = 8, p-value = 0.57312
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.0958421  6.8958421
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = 2.73726, df = 14, p-value = 0.016041
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  0.71118296 5.86024561
## sample estimates:
...
## t = -0.101404, df = 6, p-value = 0.92253
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.05 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 11.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  3.92234 1.961169 3.91828 0.032058 *
## Residuals 27 13.51398 0.500518                   
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 208.46 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2424.44 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 110.8 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 711.33 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 54 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: len
##           Df   Sum Sq Mean Sq  F value                 Pr(>F)    
## supp       1  400.207 400.207  42.6881         0.000000038192 ***
## dose       2 1893.149 946.574 100.9662 < 0.000000000000000222 ***
## supp:dose  2  198.596  99.298  10.5916              0.0001548 ***
## Residuals 48  450.008   9.375                                    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
Einflussvariablen ($x$) wurden erhoben: height, weight und dosage. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & acerage & do2 & no3 & temp\\
\midrule
BIG\_BR & 72 & 4790 & 9.4 & 4.10 & 16.7\\
SOUTH\_BR\_CASSELMAN\_R & 2 & 6311 & 7.6 & 0.64 & 18.5\\
LITTLE\_DEER\_CR & 38 & 8115 & 9.6 & 3.40 & 20.5\\
BROAD\_RUN & 53 & 1971 & 11.9 & 3.25 & 22.2\\
\bottomrule
\end{tabular}
\end{table}
...
## -6.30700  -3.96683  -1.78806   0.96021  22.48310  
## 
## Coefficients:
##                Estimate  Std. Error t value  Pr(>|t|)    
## (Intercept) 0.403250970 1.665172868  0.2422 0.8096610    
## acerage     0.000047984 0.000012228  3.9240 0.0002716 ***
## do2         0.217369872 0.139265334  1.5608 0.1249993    
## no3         0.114040881 0.072873310  1.5649 0.1240378    
## temp        0.030172033 0.041171514  0.7328 0.4671489    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 38.836672)
## 
##     Null deviance: 2063.02  on 53  degrees of freedom
## Residual deviance: 1302.87  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.88       2.30  0.0212
## 2 water           0.186     -2.37  0.0179
## 3 light           0.504      1.44  0.149
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
9.91 & 1 & 9.80 & 102.20 & 70.50 & 10\\
9.68 & 1 & 10.20 & 97.88 & 66.67 & 13\\
10.62 & 0 & 8.33 & 104.11 & 74.61 & 12\\
10.29 & 1 & 8.99 & 100.00 & 68.77 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -5.19330 -1.61211  0.17867  1.67415  5.59119 
## 
## Coefficients:
##               Estimate Std. Error t value             Pr(>|t|)    
## (Intercept) -18.529589   8.683297 -2.1339              0.03525 *  
## Fe            0.859449   0.086020  9.9913 < 0.0000000000000002 ***
## light         0.378487   0.578985  0.6537              0.51477    
## nematodes     0.144734   0.071986  2.0106              0.04701 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.3686 on 102 degrees of freedom
## Multiple R-squared:  0.50685,	Adjusted R-squared:  0.49235 
## F-statistic: 34.945 on 3 and 102 DF,  p-value: 0.0000000000000012816
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Residuals:
##    Min     1Q Median     3Q    Max 
##  -7.60  -2.60   0.40   3.15   8.40 
## 
## Coefficients:
##             Estimate Std. Error t value   Pr(>|t|)    
## (Intercept)  17.6000     2.2605  7.7858 0.00005306 ***
## trtB         -1.0000     3.1969 -0.3128     0.7624    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 5.0547 on 8 degrees of freedom
## Multiple R-squared:  0.012083,	Adjusted R-squared:  -0.11141 
## F-statistic: 0.097847 on 1 and 8 DF,  p-value: 0.76243
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.37767 -0.56030 -0.10331  0.53823  3.46984 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  267.19  16.346  
##  subject  (Intercept) 4020.39  63.407  
##  Residual              680.54  26.087  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.557     26.915  7.4886
## attitudepop  -19.887      5.732 -3.4694
## 
...
\midrule
A & 16.71 & 16 & 16 & 18 & 16.0 & 17.5 & 0.90\\
B & 17.86 & 18 & 10 & 22 & 17.0 & 20.5 & 16.81\\
C & 15.00 & 14 & 13 & 19 & 13.5 & 16.0 & 5.00\\
D & 6.57 & 8 & 0 & 9 & 6.5 & 8.0 & 9.29\\
\bottomrule
\end{tabular}
\end{table}
