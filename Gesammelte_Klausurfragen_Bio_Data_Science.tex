...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.03, 0.21 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.105, 0.0075, 0.0525 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.84 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.68, 0.12, 0.84 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.84 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.105, 0.0075, 0.0525 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 9, 10, 11 und 15.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.2 +/- 2.28
\item [\textbf{B} \msquare] Es ergibt sich 10.2 +/- 2.6
\item [\textbf{C} \msquare] Es ergibt sich 11.2 +/- 1.14
\item [\textbf{D} \msquare] Es ergibt sich 11.2 +/- 5.2
\item [\textbf{E} \msquare] Es ergibt sich 12.2 +/- 1.14
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 25, 17, 30, 13, 37, 14 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 28 [15, 38]
\item [\textbf{B} \msquare] Es ergibt sich 25 [14, 37]
\item [\textbf{C} \msquare] Es ergibt sich 25 +/- 37
\item [\textbf{D} \msquare] Es ergibt sich 28 +/- 14
...
$y = \{16, 14, 13, 15, 20, 19, 19, 20, 17, 13, 19\}$. Berechnen Sie folgende
...
\begin{center}
$7.7, 8.6, 12.1, 10, 9.9, 10.5, 10.2, 10.6, 9.8, 8.4, 12, 8.8$
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 179.85 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 68 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 194.894  97.447  44.584 4.26e-08
## Residuals 20  43.714   2.186
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 109 133 107 101  87 103 137 139 144 134 158 152
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 237.16 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 98.13 &  &  &  \strut\\
    \hline
...
## Response: fat_perc
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2  71.161  35.581  2.1745 0.142607
## form       1   2.644   2.644  0.1616 0.692460
## dose:form  2 213.399 106.700  6.5208 0.007412
## Residuals 18 294.532  16.363
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 191$ Sauen. In dem Experiment wurde gemessen,
...
## -10.4444  -1.4762   0.4286   2.5556   4.5556 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   14.444      1.303  11.085 2.57e-08
## waterB        11.127      1.970   5.648 6.01e-05
## 
## Residual standard error: 3.909 on 14 degrees of freedom
## Multiple R-squared:  0.695,	Adjusted R-squared:  0.6732 
## F-statistic:  31.9 on 1 and 14 DF,  p-value: 6.011e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.695$ aus? \textbf{(2 Punkte)}
...
## t = 3.4287, df = 8, p-value = 0.008972
...
Einflussvariablen ($x$) wurden erhoben: rainfall, P und dry. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
12.13 & 0 & 10.38 & 102.43 & 68.71 & 10\\
11.43 & 0 & 7.05 & 106.29 & 75.28 & 6\\
10.83 & 0 & 10.33 & 102.73 & 76.25 & 11\\
11.66 & 0 & 10.63 & 95.32 & 67.54 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.8396 -1.4307  0.0803  1.5044  4.2545 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -4.753425   6.452705  -0.737   0.4632
## Fe           0.772979   0.062658  12.336   <2e-16
## nematodes    0.007351   0.075195   0.098   0.9223
## P           -0.265260   0.143295  -1.851   0.0674
## 
## Residual standard error: 2.084 on 90 degrees of freedom
## Multiple R-squared:  0.6359,	Adjusted R-squared:  0.6237 
## F-statistic: 52.39 on 3 and 90 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & so4 & do2 & acerage & temp\\
\midrule
BASIN\_RUN & 13 & 16.75 & 9.6 & 2528 & 15.3\\
SENECA\_CR & 23 & 8.37 & 9.9 & 18422 & 20.1\\
COLLIER\_RUN & 18 & 17.63 & 8.6 & 6298 & 18.2\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -8.7758  -3.4207  -2.0837   0.7801  20.7199  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.3511324  1.9249242  -0.182  0.85601
## so4          0.0040746  0.0209256   0.195  0.84642
## do2          0.2314805  0.1497969   1.545  0.12871
## acerage      0.0000431  0.0000152   2.836  0.00663
## temp         0.0759221  0.0470823   1.613  0.11327
## 
## (Dispersion parameter for quasipoisson family taken to be 38.8887)
## 
##     Null deviance: 1819.1  on 53  degrees of freedom
## Residual deviance: 1407.2  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.83       2.27  0.0234
## 2 water           0.183     -2.44  0.0145
## 3 light           0.476      1.36  0.174
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 804.8
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.7809 -0.5776 -0.1062  0.5503  3.3852 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  237.3   15.41   
##  subject  (Intercept) 3912.7   62.55   
##  Residual              754.7   27.47   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.251     26.533   7.585
## attitudepop  -17.843      6.036  -2.956
## 
...
\begin{verbatim}
##           ctrl high       low       mid
## ctrl 1.0000000    0 0.0090204 0.9814768
## high 0.0000000    1 0.0000000 0.0000000
## low  0.0090204    0 1.0000000 0.0085128
## mid  0.9814768    0 0.0085128 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 12, 16, 9, 15 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 9, 7, 13, 5 und 13! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes drymatter, Fe und leaf an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCJIIIK & 4.0 | 3.0 | Klein \\
    B & GCAMRU5 & 2.0 | 4.0 | Normal \\ 
    C & GCMEKDV & 4.5 | 2.5 | Normal \\ 
    D & GCJJWWV & 1.5 | 1.5 | Mikro \\ 
    E & GCLH4EC & 1.0 | 4.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 856 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{6, 5, 8\}$ und den Vektor $B = \{-1, 5, 1\}$ gegeben.
