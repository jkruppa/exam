...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.02, 0.42, 0.03 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.004, 0.084, 0.006 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.004, 0.084, 0.006 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.1, 2.1, 0.15 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.1, 1, 0.15 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.1, 1, 0.15 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 16, 8, 8 und 19.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12.8 +/- 2.435
\item [\textbf{B} \msquare] Es ergibt sich 11.8 +/- 11.85
\item [\textbf{C} \msquare] Es ergibt sich 12.8 +/- 4.87
\item [\textbf{D} \msquare] Es ergibt sich 12.8 +/- 23.7
\item [\textbf{E} \msquare] Es ergibt sich 13.8 +/- 2.435
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 17, 14, 14, 28, 27, 10 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 17 [14, 28]
\item [\textbf{B} \msquare] Es ergibt sich 25 [15, 29]
\item [\textbf{C} \msquare] Es ergibt sich 25 +/- 14
\item [\textbf{D} \msquare] Es ergibt sich 17 +/- 14
\item [\textbf{E} \msquare] Es ergibt sich 17 +/- 28
\end{enumerate} 
...
$y = \{13, 17, 15, 17, 16, 14, 16\}$. Berechnen Sie folgende
...
\begin{center}
$9.4, 8, 8.8, 9.1, 9, 10.7, 9.7, 7.8, 14.5, 12.7, 12.6, 9.3, 9.8, 10.2, 7.6$
\end{center}
...
## 
## data:  freshmatter by N
## t = 2.1131, df = 12, p-value = 0.05622
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.106651  6.963794
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 6.74 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 91.11 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 24.909 12.4546    3.44 0.05013
## Residuals 22 79.651  3.6205
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 113 114 111  85 102 104 135 143 139 146 157 144
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 0.02 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 260.74 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 137.06 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 401.1 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2   4.25    2.13  0.2397 0.7893613
## form       1 375.62  375.62 42.3414 4.058e-06
## dose:form  2 270.71  135.35 15.2578 0.0001332
## Residuals 18 159.68    8.87
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -2.8571 -1.3810 -0.5397  1.0278  5.7778 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  17.2222     0.7889  21.831 3.27e-12
## trtB          9.6349     1.1927   8.078 1.22e-06
## 
## Residual standard error: 2.367 on 14 degrees of freedom
## Multiple R-squared:  0.8234,	Adjusted R-squared:  0.8108 
## F-statistic: 65.26 on 1 and 14 DF,  p-value: 1.222e-06
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: center, region und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.70 & 1 & 12.94 & 95.39 & 68.53 & 7\\
9.39 & 1 & 12.45 & 100.11 & 70.68 & 10\\
11.07 & 1 & 9.07 & 101.65 & 70.57 & 7\\
9.93 & 0 & 8.98 & 96.25 & 68.27 & 14\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.8656 -1.5459 -0.0024  1.5308  4.8439 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  5.73665    7.92055   0.724  0.47057
## Fe           0.69770    0.07893   8.840  3.2e-14
## water       -0.06748    0.15811  -0.427  0.67043
## P           -0.49724    0.15516  -3.205  0.00181
## 
## Residual standard error: 2.259 on 101 degrees of freedom
## Multiple R-squared:  0.4477,	Adjusted R-squared:  0.4313 
## F-statistic: 27.29 on 3 and 101 DF,  p-value: 5.212e-13
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & acerage & maxdepth & so4\\
\midrule
CONOWINGO\_CR & 112 & 6.95 & 27350 & 65 & 14.94\\
PINEY\_BR & 48 & 4.70 & 4011 & 52 & 5.38\\
BIG\_PIPE\_CR & 18 & 3.53 & 25440 & 120 & 8.20\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -11.552   -4.479   -1.985    1.542   16.529  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.157e+00  5.428e-01   3.974 0.000232
## no3          2.210e-01  6.862e-02   3.221 0.002269
## acerage      3.326e-05  1.322e-05   2.516 0.015177
## maxdepth     9.064e-03  4.209e-03   2.153 0.036236
## so4         -1.162e-02  2.706e-02  -0.430 0.669396
## 
## (Dispersion parameter for quasipoisson family taken to be 37.49386)
## 
##     Null deviance: 2416.0  on 53  degrees of freedom
## Residual deviance: 1629.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>    <dbl>
## 1 (Intercept)     1.82       3.25 0.00115 
## 2 water           0.187     -3.46 0.000539
## 3 light           0.525      1.75 0.0794
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4016 -0.6050 -0.0497  0.4983  3.3824 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  203.8   14.28   
##  subject  (Intercept) 3989.5   63.16   
##  Residual              644.7   25.39   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.632     26.634   7.645
## attitudepop  -20.576      5.579  -3.688
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0157812 0.0019781 0.0000015
## high 0.0157812 1.0000000 0.4183137 0.0021625
## low  0.0019781 0.4183137 1.0000000 0.0170802
## mid  0.0000015 0.0021625 0.0170802 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 13, 7, 15, 14 und 3!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 11, 16, 13 und 12! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes freshmatter, leaf und drymatter an drei verschiedenen Messterminen.
...
Milchstra{\ss}e aus. Es gibt $\ensuremath{10^{11}}$ Sterne in der Milchstra{\ss}e. Gehen
Sie von einer Lichtgeschwindigkeit von $\ensuremath{2.9\times 10^{8}}m/s$ aus.
...
\item Berechnen Sie die theoretische Anzahl an Replikationen die ben{\"o}tigt
  werden um mit \textit{einer einzigen Replikation} die gesamten Sterne der
  Milchstra{\ss}e zu besuchen! \textbf{(1 Punkt)}
\item Folgende Formel f{\"u}r eine geometrische Serie ist gegeben.
  \begin{equation*}
    \sum_{n=0}^N a \cdot r^n = a\left(\cfrac{r^{N + 1} -1}{r - 1}\right)
\end{equation*}
Berechnen Sie die Dauer, die eine au{\ss}erirdische Zivilisation
ann{\"a}hrungsweise ben{\"o}tigt um die gesamten Sterne der Milchstra{\ss}e mit Sonden
zu besuchen! \textbf{(3 Punkte)}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC2CGLL & 2.0 | 3.5 | Normal \\
    B & GC74SMU & 3.0 | 1.5 | Normal \\ 
    C & GCNN7T6 & 2.5 | 1.0 | Normal \\ 
    D & GC5P2EF & 4.0 | 2.0 | Klein \\ 
    E & GC90MAC & 3.5 | 4.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
Leider hat es mit Ihrer Koalakuschelnschule in Down Under nicht geklappt. War vielleicht
...
\item Die durchschnittliche, australische Lebenserwartung eines Kaninchens
  liegt bei 9 Jahren. Folgende Formel f{\"u}r eine geometrische Serie
  ist gegeben.
  \begin{equation*}
  \sum_{n=0}^N a \cdot r^n = a\left(\cfrac{r^{N + 1} -1}{r - 1}\right)
\end{equation*}
Wie viele Kaninchen bev{\"o}lkern bei einem ungebremsten Wachstum den
australischen Kontinent bevor die ersten, australischen Kaninchen an
Altersschw{\"a}che sterben w{\"u}rden? \textbf{(2 Punkte)}
\end{enumerate}
...
\item Wie viele Milliarden Kaninchen leben nach der S{\"a}ttigungsfunktion
  nach 20 Jahren auf dem australischen Kontinent? \textbf{(1
    Punkt)}
\end{enumerate}
...
\begin{enumerate}
  \setcounter{enumi}{3}  
\item Wie lange dauert es in Jahren, unter Verwendung der
  S{\"a}ttigungsfunktion, bis die Kaninchenpopulation nach einer Viruspandemie
  wieder auf 50\% der maximal Population angewachsen ist?
  \textbf{(2 Punkte)}
\end{enumerate}
...
\item In Ihrem Stall leben 1200 Mastkaninchen. Mit welchen
  j{\"a}hrlichen Zusatzkosten m{\"u}ssen Sie daher kalkulieren? \textbf{(1 Punkt)}
\end{enumerate}
...
Sie haben den Vektor $A = \{0, 11, 18\}$ und den Vektor $B = \{5, 3, -3\}$ gegeben.
