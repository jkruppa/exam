...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.01, 0.42 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 0.04, 1.68 und 3.56. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.0025, 0.105 und 0.2225. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.0025, 0.105 und 0.2225. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 0.04, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 0.04, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 6, 11, 10 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.2 +/- 2.59
\item [\textbf{B} \msquare] Es ergibt sich 9.2 +/- 6.7
\item [\textbf{C} \msquare] Es ergibt sich 9.2 +/- 1.295
\item [\textbf{D} \msquare] Es ergibt sich 8.2 +/- 3.35
\item [\textbf{E} \msquare] Es ergibt sich 10.2 +/- 1.295
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 19, 23, 10, 24, 27, 15, 18, 17, 16, 51 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 +/- 16
\item [\textbf{B} \msquare] Es ergibt sich 26 +/- 16
\item [\textbf{C} \msquare] Es ergibt sich 19 [16, 27]
\item [\textbf{D} \msquare] Es ergibt sich 26 [16, 27]
\item [\textbf{E} \msquare] Es ergibt sich 19 +/- 27
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.52 liegt keine Overdispersion vor.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.52 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt drei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.52 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung von nur zwei der drei Verteilungsparameter: $\gamma_1$ und $\gamma_3$.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.17 ist
richtig?
...
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 3, da es sich um ein Anteil handelt.
...
In einem Stallexperiment mit $n = 94$ Ferkeln wurden verschiedene
...
\item [\textbf{B} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 0.01
...
\item [\textbf{D} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 0.01
...
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 36
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 18
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 34
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 17
\end{enumerate}
...
$y = \{16, 15, 22, 21, 12, 15, 17, 17, 21, 19, 18\}$. Berechnen Sie folgende
...
\begin{center}
$7.2, 10.1, 8.4, 11.2, 5.6, 8.9, 10.5, 8.7, 11.4, 10.5, 9.3, 8.6, 10.9, 10.1$
\end{center}
...
## t = -0.13986, df = 16, p-value = 0.8905
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.590599  3.146154
## sample estimates:
...
## t = -2.216, df = 12, p-value = 0.04678
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.58037059 -0.06407385
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 50.67 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 92.29 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  45.81 22.9048  9.8163 0.00131
## Residuals 18  42.00  2.3333
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 116 122 138 106 103  98 140 142 144 145 158 156
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 3.41 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 126.02 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 292.83 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 498.23 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2  93.499  46.749  4.4951 0.0260970
## form       1 240.024 240.024 23.0793 0.0001421
## dose:form  2 228.126 114.063 10.9676 0.0007678
## Residuals 18 187.200  10.400
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 127$ Sauen. In dem Experiment wurde gemessen,
...
## -4.4000 -1.4786  0.2857  1.6000  2.6000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  19.4000     0.9657  20.089 2.05e-09
## trtB          7.3143     1.2644   5.785 0.000177
## 
## Residual standard error: 2.159 on 10 degrees of freedom
## Multiple R-squared:  0.7699,	Adjusted R-squared:  0.7469 
## F-statistic: 33.46 on 1 and 10 DF,  p-value: 0.0001766
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -6.9824, df = 8, p-value = 0.0001146
...
Einflussvariablen ($x$) wurden erhoben: region, fertilizier und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.35 & 0 & 9.61 & 99.20 & 65.71 & 9\\
8.77 & 0 & 7.81 & 105.26 & 75.39 & 12\\
8.50 & 0 & 11.09 & 95.21 & 67.76 & 6\\
11.43 & 1 & 7.24 & 98.76 & 71.24 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.2473 -1.3027 -0.0589  1.1261  5.8475 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  8.29462    7.07055   1.173    0.243
## water       -0.01035    0.13936  -0.074    0.941
## P           -0.67667    0.14927  -4.533 1.49e-05
## Fe           0.68349    0.06697  10.205  < 2e-16
## 
## Residual standard error: 2.181 on 110 degrees of freedom
## Multiple R-squared:  0.5391,	Adjusted R-squared:  0.5266 
## F-statistic: 42.89 on 3 and 110 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & no3 & maxdepth & acerage\\
\midrule
CARROLL\_BR & 23 & 10.4 & 2.77 & 105 & 3896\\
LITTLE\_HUNTING\_CR & 18 & 9.5 & 0.51 & 58 & 7121\\
GUNPOWDER\_FALLS & 22 & 9.7 & 3.30 & 65 & 12659\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.684  -4.286  -1.832   1.801  17.711  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 8.939e-01  1.486e+00   0.601   0.5503
## do2         1.334e-01  1.481e-01   0.901   0.3721
## no3         1.755e-01  8.096e-02   2.167   0.0351
## maxdepth    1.041e-02  4.609e-03   2.260   0.0283
## acerage     3.099e-05  1.724e-05   1.797   0.0785
## 
## (Dispersion parameter for quasipoisson family taken to be 38.16359)
## 
##     Null deviance: 2190.8  on 53  degrees of freedom
## Residual deviance: 1592.0  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.51      2.61  0.00916
## 2 water           0.149    -2.48  0.0133 
## 3 light           0.465     0.958 0.338
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 796.2
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1162 -0.5383 -0.1174  0.6128  3.3132 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  223.6   14.95   
##  subject  (Intercept) 4006.5   63.30   
##  Residual              670.5   25.89   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   204.13      26.75   7.631
## attitudepop   -20.24       5.69  -3.558
## 
...
\begin{verbatim}
##           ctrl high       low       mid
## ctrl 1.0000000    0 0.0070145 0.3513356
## high 0.0000000    1 0.0000000 0.0000000
## low  0.0070145    0 1.0000000 0.0005677
## mid  0.3513356    0 0.0005677 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 10, 11, 8, 10 und 6!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 14, 14, 9 und 8! \textbf{(2 Punkte)}
...
ausgesendet. Gehen Sie von $5.16$ Lichtjahren als mittlerer
...
Sie haben den Vektor $A = 6, 10, 4$ und den Vektor $B = 4, 0, 2$ gegeben.
