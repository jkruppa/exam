...
\begin{graybox}{Multiple Choice Aufgaben}
  ...
  \item Im Laufe der Zeit werden einzelne Fragen durch andere Fragen \textit{ersetzt}, bitte beachten Sie dies, wenn Sie eine \textit{Wiederholungsklausur} im nächsten Semester schreiben. 
  \end{itemize}
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.02, 0.89 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 3.56 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 1 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.005, 0.2225 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 1 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.005, 0.2225 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Wir lesen als erstes die Daten über \texttt{read\_excel()} ein, transformieren die Spalten über \texttt{mutate()} in die richtige Form und können dann abschließend über \text{ggplot()} uns die Abbildungen erstellen lassen. Wichtig ist, dass wir keine Faktoren sondern nur numerische Variablen vorliegen haben.
...
\item [\textbf{D} \msquare] Wir lesen als erstes die Daten über \texttt{read\_excel()} ein, transformieren die Spalten über \texttt{mutate()} in die richtige Form und können dann abschließend über \text{ggplot()} uns die Abbildungen erstellen lassen.
\item [\textbf{E} \msquare] Wir transformieren die Spalten über \texttt{mutate()} in ein \texttt{tibble} und können dann abschließend über \text{ggplot()} uns die Abbildungen erstellen lassen. Dabei beachten wir das wir keine Faktoren in den Daten haben.
\end{enumerate}
...
\begin{enumerate}
\item Visualisieren Sie in zwei getrennten Abbildungen eine schwache und eine starke Interaktion zwischen den Faktoren $f_1$ und $f_2$! \textbf{(2 Punkte)}
...
Sie haben folgende Zahlenreihe $y$ vorliegen
$y = \{17, 15, 16, 18, 18, 20, 15, 21, 17, 17, 17\}$. Berechnen Sie folgende
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, S und dry. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & do2 & maxdepth & no3 & acerage\\
\midrule
HAY\_MEADOW\_BR & 5 & 9.5 & 26 & 3.53 & 639\\
BUSH\_CR & 32 & 8.3 & 120 & 2.93 & 19046\\
BASIN\_RUN & 13 & 9.6 & 80 & 2.28 & 2528\\
PATAPSCO\_R & 28 & 8.9 & 61 & 4.06 & 4706\\
\bottomrule
\end{tabular}
\end{table}
...
## -9.0992  -3.0150  -1.5887   2.3132  13.1412  
## 
## Coefficients:
##                 Estimate   Std. Error t value  Pr(>|t|)    
## (Intercept) -0.780843202  1.222317909 -0.6388 0.5259139    
## do2          0.246828312  0.116044012  2.1270 0.0384775 *  
## maxdepth     0.015376426  0.004014962  3.8298 0.0003650 ***
## no3          0.169512285  0.071370176  2.3751 0.0215014 *  
## acerage      0.000037850  0.000010763  3.5167 0.0009524 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 22.328397)
## 
##     Null deviance: 1892.88  on 53  degrees of freedom
## Residual deviance: 1010.69  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.356     0.584   0.559
## 2 nematodes       0.132    -0.276   0.783
## 3 light           0.430     1.16    0.245
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
9.38 & 1 & 10.22 & 97.71 & 67.95 & 11\\
9.88 & 1 & 9.67 & 103.95 & 73.16 & 20\\
9.53 & 1 & 8.34 & 99.57 & 65.45 & 13\\
11.05 & 0 & 9.98 & 99.43 & 75.30 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.9604 -2.0689 -0.3150  2.0613  6.7441 
## 
## Coefficients:
##               Estimate Std. Error t value        Pr(>|t|)    
## (Intercept) -14.661629  11.394191 -1.2868         0.20171    
## Fe            0.832248   0.112687  7.3855 0.0000000001015 ***
## light         1.597924   0.718271  2.2247         0.02878 *  
## nematodes     0.046712   0.091946  0.5080         0.61276    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.8072 on 84 degrees of freedom
## Multiple R-squared:  0.41457,	Adjusted R-squared:  0.39366 
## F-statistic: 19.828 on 3 and 84 DF,  p-value: 0.00000000082751
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -3.20000 -1.36429 -0.02857  1.30714  3.14286 
## 
## Coefficients:
##             Estimate Std. Error t value      Pr(>|t|)    
## (Intercept) 19.20000    0.97629 19.6663 0.00000000253 ***
## trtB         7.65714    1.27826  5.9903     0.0001338 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.1831 on 10 degrees of freedom
## Multiple R-squared:  0.78206,	Adjusted R-squared:  0.76026 
## F-statistic: 35.883 on 1 and 10 DF,  p-value: 0.00013384
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.18970 -0.59820 -0.07496  0.54675  3.55587 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  221.34  14.878  
##  subject  (Intercept) 4023.67  63.432  
##  Residual              698.98  26.438  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.933     26.812  7.6061
## attitudepop  -21.464      5.809 -3.6949
## 
...
\midrule
A & 16.29 & 16 & 16 & 17 & 16 & 16.5 & 0.24\\
B & 19.00 & 18 & 11 & 28 & 18 & 20.0 & 26.33\\
C & 11.14 & 11 & 9 & 13 & 10 & 12.5 & 2.48\\
D & 6.14 & 6 & 0 & 13 & 4 & 8.0 & 18.14\\
\bottomrule
\end{tabular}
\end{table}
...
## t = -0.469596, df = 16, p-value = 0.64498
...
## t = -2.42218, df = 14, p-value = 0.029584
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.78851702 -0.29084806
## sample estimates:
...
## t = -0.314223, df = 14, p-value = 0.75799
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.8569950  2.1268362
## sample estimates:
...
\item Folgende statistische Fachbegriffe bzw. Methoden sind gegeben:
  \begin{itemize}
  \item[] Mann-Whitney-U-Test, Pearson Korrelation, Kruskal-Wallis-Test, t-Test, Simple Gaussian linear Regression, Spearman Korrelation, ANOVA, Wilcoxon-Test und Paired t-Test.
  \end{itemize}
