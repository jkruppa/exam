...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.02, 0.34 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.005, 0.085 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.005, 0.085 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 1.36 und 1.68. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
\item [\textbf{D} \msquare] Der Korrelationskoeffizienten nach Pearson wird genutzt, wenn das Outcome Y normalverteilt ist. Der Korrelationskoeffizienten liegt zwischen -1 und 1.
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 12, 15, 1 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.2 +/- 2.63
\item [\textbf{B} \msquare] Es ergibt sich 8.2 +/- 13.85
\item [\textbf{C} \msquare] Es ergibt sich 9.2 +/- 27.7
\item [\textbf{D} \msquare] Es ergibt sich 9.2 +/- 2.63
\item [\textbf{E} \msquare] Es ergibt sich 9.2 +/- 5.26
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 19, 23, 13, 19, 21, 16, 31, 9, 12, 23 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 [13, 23]
\item [\textbf{B} \msquare] Es ergibt sich 19 +/- 23
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 13
\item [\textbf{D} \msquare] Es ergibt sich 19 [13, 23]
\item [\textbf{E} \msquare] Es ergibt sich 19 +/- 13
\end{enumerate}
...
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.03 liegt keine Overdispersion vor.
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.03 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.92 ist
richtig?
...
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.75, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.75, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 1.33, da es sich um ein Anteil handelt.
\end{enumerate}
...
\item [\textbf{B} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 7.99
...
\item [\textbf{D} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -2.83
\item [\textbf{E} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 7.99
\end{enumerate}
...
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 154
...
$y = \{20, 18, 23, 21, 18, 18, 19\}$. Berechnen Sie folgende
...
## t = -2.98174, df = 8, p-value = 0.017554
...
## 
## data:  freshmatter by N
## t = 1.63273, df = 10, p-value = 0.13358
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.89605164  5.81033736
## sample estimates:
## mean in group ctrl  mean in group low 
##          16.857143          14.400000
\end{verbatim}
...
## 
## data:  freshmatter by N
## t = 1.08314, df = 10, p-value = 0.30417
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.5370822  7.3370822
## sample estimates:
...
## t = -1.67332, df = 6, p-value = 0.14529
## alternative hypothesis: true mean difference is not equal to 0
## 95 percent confidence interval:
##  -4.92461905  0.92461905
## sample estimates:
## mean difference 
##              -2
\end{verbatim}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.46 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.94 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  3.78224 1.891120 4.75761 0.016983 *
## Residuals 27 10.73233 0.397494                   
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 204.08 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2422.24 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 108.41 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 707.12 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 73 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: len
##           Df  Sum Sq  Mean Sq   F value                 Pr(>F)    
## supp       1  175.83  175.826  12.10785             0.00088763 ***
## dose       2 3249.01 1624.504 111.86802 < 0.000000000000000222 ***
## supp:dose  2  238.67  119.333   8.21758             0.00064315 ***
## Residuals 67  972.95   14.522                                     
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   73  \strut\\
    \hline
...
Einflussvariablen ($x$) wurden erhoben: S, variety und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
## -3.44444 -1.38889  0.16667  1.55556  3.55556 
## 
## Coefficients:
##             Estimate Std. Error t value            Pr(>|t|)    
## (Intercept) 16.44444    0.68606  23.969 0.00000000000005773 ***
## trtB        10.77778    0.97024  11.108 0.00000000624355947 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.0582 on 16 degrees of freedom
## Multiple R-squared:  0.88522,	Adjusted R-squared:  0.87805 
## F-statistic:  123.4 on 1 and 16 DF,  p-value: 0.0000000062436
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\toprule
stream & longnose & acerage & so4 & no3 & do2\\
\midrule
CONOWINGO\_CR & 112 & 27350 & 14.94 & 6.95 & 8.5\\
DEAD\_RUN & 25 & 4145 & 44.93 & 0.34 & 8.7\\
SOUTH\_BR\_PATAPSCO & 26 & 1450 & 8.84 & 2.96 & 7.9\\
SECOND\_MINE\_BR & 62 & 2511 & 10.75 & 4.17 & 10.2\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -9.6270  -4.3386  -1.9003   1.1435  20.1196  
## 
## Coefficients:
##                 Estimate   Std. Error t value Pr(>|t|)   
## (Intercept)  2.403357360  1.368764164  1.7559 0.085362 . 
## acerage      0.000044825  0.000014299  3.1347 0.002905 **
## so4         -0.021146316  0.029650375 -0.7132 0.479112   
## no3          0.173820059  0.077310503  2.2483 0.029087 * 
## do2          0.069110570  0.154489196  0.4473 0.656595   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 47.967567)
## 
##     Null deviance: 2381.13  on 53  degrees of freedom
## Residual deviance: 1710.89  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.399    -0.949   0.343
## 2 nematodes       0.147    -0.352   0.725
## 3 light           0.485     1.02    0.306
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
8.30 & 0 & 10.20 & 106.34 & 71.19 & 4\\
10.51 & 0 & 9.33 & 103.80 & 72.22 & 8\\
11.00 & 1 & 10.91 & 101.40 & 69.03 & 13\\
8.87 & 0 & 9.37 & 99.24 & 72.11 & 8\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.4770 -1.5061 -0.3531  1.2691  6.7816 
## 
## Coefficients:
##                Estimate  Std. Error t value             Pr(>|t|)    
## (Intercept) -18.2836154   7.8226946 -2.3373              0.02142 *  
## water        -0.1482332   0.1442968 -1.0273              0.30677    
## Fe            0.8940979   0.0756392 11.8206 < 0.0000000000000002 ***
## nematodes    -0.0034457   0.0652785 -0.0528              0.95801    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.3103 on 100 degrees of freedom
## Multiple R-squared:  0.5895,	Adjusted R-squared:  0.57719 
## F-statistic: 47.869 on 3 and 100 DF,  p-value: < 0.000000000000000222
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.23333 -0.59616 -0.17451  0.52434  3.54224 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  251.28  15.852  
##  subject  (Intercept) 3928.22  62.676  
##  Residual              677.29  26.025  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 202.1945    26.5843  7.6058
## attitudepop -17.8196     5.7183 -3.1162
## 
...
\midrule
A & 17.42 & 17.0 & 16 & 20 & 16.75 & 18.25 & 1.72\\
B & 18.67 & 18.5 & 13 & 23 & 17.00 & 21.00 & 9.15\\
C & 12.83 & 12.0 & 11 & 17 & 11.00 & 14.25 & 4.88\\
D & 6.50 & 7.5 & -1 & 15 & 2.25 & 10.00 & 26.64\\
\bottomrule
\end{tabular}
\end{table}
