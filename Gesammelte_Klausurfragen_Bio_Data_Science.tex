...
\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.004, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 3e-04, 0.105 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 3e-04, 0.105 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
...
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.004, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 5, 7, 8, 11 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 7.8 +/- 4.7
\item [\textbf{B} \msquare] Es ergibt sich 6.8 +/- 2.35
\item [\textbf{C} \msquare] Es ergibt sich 8.8 +/- 1.085
\item [\textbf{D} \msquare] Es ergibt sich 7.8 +/- 1.085
\item [\textbf{E} \msquare] Es ergibt sich 7.8 +/- 2.17
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 7, 31, 24, 24, 14, 23, 39, 25, 12, 37 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 +/- 14
\item [\textbf{B} \msquare] Es ergibt sich 24 [14, 37]
\item [\textbf{C} \msquare] Es ergibt sich 24 +/- 37
\item [\textbf{D} \msquare] Es ergibt sich 24 +/- 14
\item [\textbf{E} \msquare] Es ergibt sich 25 [15, 38]
\end{enumerate} 
...
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 1.17, da es sich um ein Anteil handelt.
...
$y = \{19, 20, 21, 21, 22, 20, 25\}$. Berechnen Sie folgende
...
\begin{center}
$10.9, 7.2, 10, 11.5, 10.7, 11, 12.4, 12, 11.8, 8.4, 7.7, 10.4, 9.5, 8.8$
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 8.46 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 37.3 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 82.992  41.496  13.839 0.0001285
## Residuals 22 65.968   2.999
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 134 122 101 103 108  93 144 125 131 134 144 146
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 155.02 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 155.71 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 145.32 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 240.02 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 532.94 266.468 13.5863 0.0002533
## form       1 266.93 266.926 13.6096 0.0016789
## dose:form  2  47.48  23.739  1.2104 0.3212281
## Residuals 18 353.03  19.613
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.4444 -1.7897 -0.0714  1.4286  5.5556 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  15.4444     0.9756  15.830 2.49e-10
## trtB          0.1270     1.4750   0.086    0.933
## 
## Residual standard error: 2.927 on 14 degrees of freedom
## Multiple R-squared:  0.0005291,	Adjusted R-squared:  -0.07086 
## F-statistic: 0.007411 on 1 and 14 DF,  p-value: 0.9326
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -5.1166, df = 8, p-value = 0.000911
...
Einflussvariablen ($x$) wurden erhoben: region, S und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.37 & 1 & 7.63 & 103.42 & 70.00 & 8\\
9.58 & 1 & 8.76 & 102.35 & 72.98 & 5\\
9.91 & 1 & 8.85 & 91.19 & 64.65 & 7\\
11.29 & 0 & 9.01 & 98.78 & 66.89 & 11\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.3338 -1.4844  0.2742  1.5799  5.4588 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -6.53731    6.95145  -0.940    0.349
## nematodes   -0.04362    0.07434  -0.587    0.559
## Fe           0.76680    0.06899  11.114   <2e-16
## light        0.58714    0.46415   1.265    0.209
## 
## Residual standard error: 2.233 on 109 degrees of freedom
## Multiple R-squared:  0.5336,	Adjusted R-squared:  0.5208 
## F-statistic: 41.57 on 3 and 109 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & temp & maxdepth & do2\\
\midrule
CARROLL\_BR & 23 & 3896 & 18.4 & 105 & 10.4\\
BROAD\_RUN & 53 & 1971 & 22.2 & 56 & 11.9\\
HAWLINGS\_R & 1 & 1172 & 20.5 & 73 & 8.3\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -6.594  -3.249  -1.238   1.704   7.882  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -1.934e+00  1.235e+00  -1.566  0.12381
## acerage      5.188e-05  8.674e-06   5.981 2.51e-07
## temp         6.518e-02  3.007e-02   2.168  0.03506
## maxdepth     5.668e-03  3.578e-03   1.584  0.11954
## do2          3.650e-01  8.967e-02   4.071  0.00017
## 
## (Dispersion parameter for quasipoisson family taken to be 15.36278)
## 
##     Null deviance: 1493.80  on 53  degrees of freedom
## Residual deviance:  708.42  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>    <dbl>
## 1 (Intercept)     2.03       3.40 0.000679
## 2 water           0.203     -3.37 0.000751
## 3 light           0.547      2.37 0.0176
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9979 -0.5587 -0.0953  0.5594  3.5072 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  232.8   15.26   
##  subject  (Intercept) 4063.2   63.74   
##  Residual              674.9   25.98   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.311     26.954   7.543
## attitudepop  -19.996      5.708  -3.503
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0459268 0.0470291 0.7468032
## high 0.0459268 1.0000000 0.0002342 0.0222576
## low  0.0470291 0.0002342 1.0000000 0.0914541
## mid  0.7468032 0.0222576 0.0914541 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 10, 9, 4, 11 und 13!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 13, 11, 19, 6 und 11! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes P, drymatter und freshmatter an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCZYRRG & 4.0 | 4.5 | Normal \\
    B & GCSIGXQ & 2.0 | 5.0 | Mikro \\ 
    C & GC1137H & 4.5 | 4.0 | Mikro \\ 
    D & GCR41NR & 2.5 | 3.0 | Klein \\ 
    E & GCSGHAH & 5.0 | 1.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 112 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{11, -2, 2\}$ und den Vektor $B = \{-5, 4, -3\}$ gegeben.
