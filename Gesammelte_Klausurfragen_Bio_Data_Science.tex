...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.02, 0.89 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.08, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.005, 0.2225 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.08, 3.56 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.08, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.005, 0.2225 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 13, 13, 11 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.2 +/- 3.2
\item [\textbf{B} \msquare] Es ergibt sich 11.2 +/- 1.79
\item [\textbf{C} \msquare] Es ergibt sich 10.2 +/- 1.6
\item [\textbf{D} \msquare] Es ergibt sich 11.2 +/- 0.895
\item [\textbf{E} \msquare] Es ergibt sich 12.2 +/- 0.895
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 24, 9, 17, 30, 18, 20 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 20 +/- 17
\item [\textbf{B} \msquare] Es ergibt sich 20 +/- 30
\item [\textbf{C} \msquare] Es ergibt sich 24 +/- 17
\item [\textbf{D} \msquare] Es ergibt sich 20 [17, 30]
\item [\textbf{E} \msquare] Es ergibt sich 24 [18, 31]
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 2.4, da es sich um ein Anteil handelt.
...
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.29, da es sich um ein Anteil handelt.
\end{enumerate}
...
$y = \{17, 15, 15, 17, 13, 19, 19\}$. Berechnen Sie folgende
...
\begin{center}
$7, 11, 4.4, 9.3, 7.3, 12.2, 13.2, 10.9, 11.7, 8.7, 5.6, 6.2, 12.1, 8.3$
\end{center}
...
## 
## data:  waterintake by infusion
## t = -0.98784, df = 10, p-value = 0.3465
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -8.557468  3.300326
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 23.94 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 43.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 92.037  46.018  17.276 3.089e-05
## Residuals 22 58.603   2.664
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 142 122 103 101 106  97 152 146 136 154 145 149
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 0.03 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2.33 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 173.28 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 39 & 739.55 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 110.83  55.418  3.6463 0.046830
## form       1 130.79 130.794  8.6057 0.008877
## dose:form  2 216.57 108.285  7.1247 0.005257
## Residuals 18 273.57  15.199
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -3.7143 -1.8135  0.0873  1.1389  5.8889 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  21.1111     0.8833  23.899  9.5e-13
## trtB          5.6032     1.3355   4.196 0.000898
## 
## Residual standard error: 2.65 on 14 degrees of freedom
## Multiple R-squared:  0.557,	Adjusted R-squared:  0.5254 
## F-statistic:  17.6 on 1 and 14 DF,  p-value: 0.0008982
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
11.84 & 0 & 9.36 & 100.59 & 66.69 & 15\\
11.03 & 0 & 7.32 & 102.53 & 71.58 & 16\\
8.69 & 0 & 8.23 & 102.89 & 70.86 & 9\\
9.21 & 0 & 10.27 & 97.02 & 66.25 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.1085 -2.4573 -0.0365  2.1010  7.6720 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 80.54823    3.30255  24.390   <2e-16
## P           -0.51951    0.21216  -2.449   0.0161
## water       -0.53076    0.23529  -2.256   0.0263
## nematodes   -0.02053    0.10084  -0.204   0.8391
## 
## Residual standard error: 3.106 on 100 degrees of freedom
## Multiple R-squared:  0.09937,	Adjusted R-squared:  0.07235 
## F-statistic: 3.678 on 3 and 100 DF,  p-value: 0.01464
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & maxdepth & do2 & temp & no3\\
\midrule
LITTLE\_DEER\_CR & 38 & 110 & 9.6 & 20.5 & 3.40\\
BROAD\_RUN & 53 & 56 & 11.9 & 22.2 & 3.25\\
NORTHWEST\_BR\_ANACOSTIA\_R & 100 & 107 & 8.4 & 23.0 & 1.41\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -7.9676  -3.9409  -1.7460   0.5858  15.0663  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -1.099714   1.585975  -0.693   0.4913
## maxdepth     0.011453   0.005720   2.002   0.0508
## do2          0.298316   0.124846   2.389   0.0208
## temp         0.057557   0.042453   1.356   0.1814
## no3         -0.007818   0.093335  -0.084   0.9336
## 
## (Dispersion parameter for quasipoisson family taken to be 28.15718)
## 
##     Null deviance: 1417.5  on 53  degrees of freedom
## Residual deviance: 1136.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.45       2.47  0.0136
## 2 water           0.142     -2.15  0.0313
## 3 nematodes       0.142     -1.32  0.188
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3035 -0.6391 -0.0544  0.5927  3.4970 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  233.2   15.27   
##  subject  (Intercept) 4121.0   64.19   
##  Residual              675.8   26.00   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.337     27.134   7.494
## attitudepop  -20.890      5.712  -3.657
## 
...
\begin{verbatim}
##           ctrl      high      low       mid
## ctrl 1.0000000 0.0568574 7.05e-05 0.2296708
## high 0.0568574 1.0000000 2.00e-07 0.4580316
## low  0.0000705 0.0000002 1.00e+00 0.0000020
## mid  0.2296708 0.4580316 2.00e-06 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, 13, 12, 17 und 5!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 12, 0, 10, 12 und 12! \textbf{(2 Punkte)}
...
die Sorten 1 bis 4 sowie die Bl{\"o}cke I bis IV
vorliegen. Sie messen die Outcomes P, Fe und drymatter an vier verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCPA55W & 4.5 | 5.0 | Normal \\
    B & GC03PHE & 4.0 | 3.0 | Normal \\ 
    C & GCVQLEY & 1.0 | 3.5 | Mikro \\ 
    D & GCM1O4V & 2.0 | 1.5 | Normal \\ 
    E & GCMLWZV & 3.5 | 4.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 193 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{5, 9, 17\}$ und den Vektor $B = \{3, -2, -2\}$ gegeben.
