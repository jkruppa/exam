...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.02, 0.21, 0.03 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 0.004, 0.042, 0.006 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.1, 1, 0.15 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.1, 1, 0.15 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 0.004, 0.042, 0.006 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 4.45, 0.1, 1.05, 0.15 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 4, 7, 11 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.4 +/- 1.44
\item [\textbf{B} \msquare] Es ergibt sich 8.4 +/- 2.88
\item [\textbf{C} \msquare] Es ergibt sich 9.4 +/- 1.44
\item [\textbf{D} \msquare] Es ergibt sich 8.4 +/- 8.3
...
Berechnen Sie den Median und das IQR von $x$ mit 10, 13, 20, 25, 15, 25 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 13
\item [\textbf{B} \msquare] Es ergibt sich 20 [13, 25]
\item [\textbf{C} \msquare] Es ergibt sich 20 +/- 13
\item [\textbf{D} \msquare] Es ergibt sich 23 [13, 25]
\item [\textbf{E} \msquare] Es ergibt sich 20 +/- 25
\end{enumerate}
...
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.07 liegt keine Overdispersion vor.
...
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.07 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.58 ist
richtig?
...
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.43, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 0.01
\item [\textbf{B} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 0.12
\item [\textbf{C} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 0.01
...
$y = \{17, 21, 18, 18, 17, 18, 13, 17, 16, 23, 14\}$. Berechnen Sie folgende
...
\begin{center}
$9.7, 11.6, 7.6, 7.7, 11.6, 13.2, 6, 9.2, 11.8, 13.2, 8.8, 10.3$
\end{center}
...
## t = -0.50104, df = 10, p-value = 0.6272
...
## t = -0.30025, df = 12, p-value = 0.7691
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.077133  5.362847
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 89.93 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 50.51 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  36.54  18.270  5.1133 0.01608
## Residuals 20  71.46   3.573
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 134 132 125  91  91  96 142 142 132 161 168 165
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 206.31 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2439.61 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 108.08 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 712.59 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## supp       1  535.79  535.79 50.4266 3.413e-09
## dose       2 2076.80 1038.40 97.7296 < 2.2e-16
## supp:dose  2   82.91   41.45  3.9015   0.02638
## Residuals 52  552.51   10.63
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   71   \strut\\
    \hline
     &  79 &  71 &  150  \strut\\
  \end{tabular}
\end{center}
...
## -6.1111 -2.6111 -0.4286  2.6508 11.8889 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.111      1.555  12.291 6.87e-09
## trtB           8.317      2.351   3.538  0.00328
## 
## Residual standard error: 4.664 on 14 degrees of freedom
## Multiple R-squared:  0.4721,	Adjusted R-squared:  0.4344 
## F-statistic: 12.52 on 1 and 14 DF,  p-value: 0.003276
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: N, S und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.58 & 0 & 12.17 & 99.27 & 65.09 & 12\\
6.83 & 1 & 12.38 & 97.71 & 69.66 & 16\\
13.11 & 0 & 11.23 & 95.35 & 60.71 & 10\\
11.21 & 0 & 11.15 & 99.19 & 70.06 & 8\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.6266 -1.5401 -0.1984  1.6874  7.1429 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  77.4912     2.9688  26.102   <2e-16
## nematodes    -0.1433     0.1013  -1.415   0.1603
## P            -0.4471     0.2039  -2.193   0.0306
## water        -0.2061     0.2010  -1.025   0.3078
## 
## Residual standard error: 2.966 on 99 degrees of freedom
## Multiple R-squared:  0.08298,	Adjusted R-squared:  0.0552 
## F-statistic: 2.986 on 3 and 99 DF,  p-value: 0.03481
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & acerage & so4 & temp\\
\midrule
GUNPOWDER\_FALLS & 22 & 9.7 & 12659 & 5.98 & 18.0\\
HAY\_MEADOW\_BR & 5 & 9.5 & 639 & 4.46 & 20.1\\
MORGAN\_RUN & 76 & 9.3 & 9765 & 5.74 & 16.9\\
NORTHWEST\_BR\_ANACOSTIA\_R & 100 & 8.4 & 22550 & 14.45 & 23.0\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -9.7582  -4.0915  -2.6111   0.7861  23.0011  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -4.913e-01  2.047e+00  -0.240   0.8113
## do2          2.647e-01  1.641e-01   1.613   0.1132
## acerage      4.311e-05  1.758e-05   2.453   0.0178
## so4         -6.009e-03  2.820e-02  -0.213   0.8322
## temp         7.962e-02  5.417e-02   1.470   0.1480
## 
## (Dispersion parameter for quasipoisson family taken to be 61.65728)
## 
##     Null deviance: 2482.3  on 53  degrees of freedom
## Residual deviance: 1967.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.336     0.328  0.743 
## 2 light           0.440     1.79   0.0733
## 3 nematodes       0.113    -0.432  0.666
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1070 -0.5793 -0.0862  0.5524  3.3694 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  236.3   15.37   
##  subject  (Intercept) 3938.2   62.76   
##  Residual              668.2   25.85   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   203.96      26.57   7.676
## attitudepop   -19.89       5.68  -3.502
## 
...
\begin{verbatim}
##           ctrl      high   low       mid
## ctrl 1.0000000 0.0190095 0e+00 0.0001931
## high 0.0190095 1.0000000 0e+00 0.0000002
## low  0.0000000 0.0000000 1e+00 0.0000001
## mid  0.0001931 0.0000002 1e-07 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 5, 10, 17, 6 und 13!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 3, 12, 15, 4 und 15! \textbf{(2 Punkte)}
...
\clearpage
% -----------------------------------------------------------------------  
\begin{graybox}{Aufgaben zur Mathematik}
...
haben einen Radius von 4cm und eine H{\"o}he von 8cm. Der
