...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.02, 0.42, 0.03 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.004, 0.084, 0.006 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.7, 0.1, 2.1, 0.15 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.1, 1, 0.15 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.004, 0.084, 0.006 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.1, 1, 0.15 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 7, 8, 9 und 13.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.6 +/- 1.35
\item [\textbf{B} \msquare] Es ergibt sich 9.6 +/- 1.35
\item [\textbf{C} \msquare] Es ergibt sich 8.6 +/- 7.3
\item [\textbf{D} \msquare] Es ergibt sich 8.6 +/- 2.7
\item [\textbf{E} \msquare] Es ergibt sich 7.6 +/- 3.65
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 21, 18, 22, 20, 22, 23, 15, 29, 16, 10 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 [17, 24]
\item [\textbf{B} \msquare] Es ergibt sich 21 +/- 16
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 23
\item [\textbf{D} \msquare] Es ergibt sich 21 [16, 23]
\item [\textbf{E} \msquare] Es ergibt sich 24 +/- 16
\end{enumerate} 
...
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.2, da es sich um eine Chancenverh{"a}ltnis handelt.
...
$y = \{18, 14, 14, 13, 14, 16, 18\}$. Berechnen Sie folgende
...
\begin{center}
$11.1, 10, 11, 11.8, 8.8, 11.3, 9.9, 11.5, 7, 12, 8.2, 8.2$
\end{center}
...
## t = -3.0014, df = 10, p-value = 0.01331
...
## 
## data:  waterintake by infusion
## t = 0.85317, df = 12, p-value = 0.4103
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.416988  5.528100
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 7.63 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 80.89 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  18.025  9.0124  1.5851 0.2296
## Residuals 20 113.714  5.6857
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 113 116 106  92 115 107 131 158 130 147 155 144
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 105.66 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 99.52 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 348.74 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 689.22 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2  56.056  28.028  3.2103 0.0642176
## form       1 244.240 244.240 27.9748 4.987e-05
## dose:form  2 227.600 113.800 13.0345 0.0003164
## Residuals 18 157.152   8.731
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   44  \strut\\
    \hline
...
## -3.8000 -1.0286  0.2429  1.2857  4.2000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.714      0.830  20.137 2.01e-09
## trtB          10.086      1.286   7.843 1.40e-05
## 
## Residual standard error: 2.196 on 10 degrees of freedom
## Multiple R-squared:  0.8602,	Adjusted R-squared:  0.8462 
## F-statistic: 61.52 on 1 and 10 DF,  p-value: 1.4e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -2.4931, df = 8, p-value = 0.03734
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  -0.91141136 -0.05415025
## sample estimates:
##        cor 
## -0.6612322
\end{verbatim}
...
Einflussvariablen ($x$) wurden erhoben: region, dry und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.08 & 0 & 10.88 & 103.14 & 71.93 & 6\\
9.08 & 0 & 8.29 & 101.28 & 70.72 & 9\\
10.97 & 0 & 13.16 & 100.91 & 67.18 & 6\\
11.02 & 1 & 10.55 & 101.50 & 68.59 & 11\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.5813 -1.5229  0.0677  1.3884  5.9847 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.45996    8.83878  -0.052  0.95861
## Fe           0.69570    0.08712   7.986 3.05e-12
## nematodes    0.02955    0.06617   0.447  0.65617
## light        1.35880    0.47689   2.849  0.00536
## 
## Residual standard error: 2.307 on 96 degrees of freedom
## Multiple R-squared:  0.4423,	Adjusted R-squared:  0.4248 
## F-statistic: 25.38 on 3 and 96 DF,  p-value: 3.572e-12
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
LITTLE\_CONOCOCHEAGUE\_CR & 15 & 0.33 & 54 & 2227 & 7.60\\
MUDDY\_BR & 25 & 2.05 & 68 & 4266 & 12.77\\
NORTHWEST\_BR & 6 & 1.56 & 63 & 8735 & 13.22\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -11.542   -4.081   -1.751    1.422   17.124  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.1071984  0.5237025   4.024 0.000198
## no3          0.1977132  0.0665288   2.972 0.004578
## maxdepth     0.0091708  0.0041079   2.232 0.030185
## acerage      0.0000353  0.0000126   2.801 0.007269
## so4         -0.0034794  0.0215400  -0.162 0.872337
## 
## (Dispersion parameter for quasipoisson family taken to be 35.80706)
## 
##     Null deviance: 2315.2  on 53  degrees of freedom
## Residual deviance: 1509.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.74      1.22    0.222
## 2 water           0.177    -1.36    0.174
## 3 light           0.547     0.908   0.364
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9991 -0.6444 -0.0579  0.5443  3.3090 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  238.5   15.44   
##  subject  (Intercept) 4095.9   64.00   
##  Residual              728.8   27.00   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.468     27.094   7.473
## attitudepop  -19.821      5.932  -3.342
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0134272 0.1945118 0.0000123
## high 0.0134272 1.0000000 0.2056124 0.0158232
## low  0.1945118 0.2056124 1.0000000 0.0005473
## mid  0.0000123 0.0158232 0.0005473 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 4, 11, 10, 17 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 15, 2, 3 und 13! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes P, grade und freshmatter an vier verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCKO4GH & 4.0 | 3.0 | Mikro \\
    B & GCRJXUS & 1.0 | 3.5 | Mikro \\ 
    C & GCCW0NM & 1.5 | 5.0 | Normal \\ 
    D & GCGYZDE & 3.0 | 1.5 | Mikro \\ 
    E & GCVLHB9 & 5.0 | 1.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 789 n. Chr. f{\"u}r den neuen Lehnsherren
...
ber{\"u}hmte \textit{Doppelt gewellte, 4-mal-gefaltete,
  0.7mm, 40-cm-Karton} durch Falzung hergestellt. Beim
...
Der nun zu optimierende Karton hat eine L{\"a}nge von 40cm und eine
Breite von 23cm. Die Kartonagenmaschine in Flint soll dann einen
...
Seitenl{\"a}ngen $a$ und $b$ bei der Verwendung von 120m Zaun bestimmen!
...
Sie haben den Vektor $A = \{-3, 17, 0\}$ und den Vektor $B = \{3, 9, 7\}$ gegeben.
