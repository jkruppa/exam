...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 4, 10, 15 und 3.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10 +/- 2.67
\item [\textbf{B} \msquare] Es ergibt sich 9 +/- 2.67
\item [\textbf{C} \msquare] Es ergibt sich 9 +/- 28.5
\item [\textbf{D} \msquare] Es ergibt sich 8 +/- 14.25
\item [\textbf{E} \msquare] Es ergibt sich 9 +/- 5.34
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 6, 12, 29, 23, 21, 10, 23, 16, 22, 37 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 [13, 30]
\item [\textbf{B} \msquare] Es ergibt sich 22 +/- 29
\item [\textbf{C} \msquare] Es ergibt sich 22 [12, 29]
...
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.71, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.71, da es sich um ein Anteil handelt.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.21, 0.01 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.84, 0.04 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.84, 0.04 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.0525, 0.0025 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.84, 0.04 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.0525, 0.0025 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate}
...
\begin{center}
$3, 4, 4, 7, 3, 4, 3, 1, 4, 6, 5, 5, 3, 5, 6, 3, 4, 2, 8, 7, 12, 4, 3, 5, 4, 6, 3, 3, 3, 7, 3, 4, 5$
\end{center}
...
\begin{center}
$9, 10.1, 8, 8.9, 10.5, 7.9, 11.5, 10.4, 12.8, 7.3, 9.5, 11.7, 10.2, 10.1, 11.7, 12.5, 7.1, 7.2, 7.4, 9.7, 12.1, 9.1, 8.5$
\end{center}
...
## t = 2.1791, df = 14, p-value = 0.0469
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  0.04543106 5.73234672
## sample estimates:
...
## t = 2.1384, df = 12, p-value = 0.05375
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -0.07945563  8.47945563
## sample estimates:
...
## 
## data:  freshmatter by N
## t = 0.20016, df = 10, p-value = 0.8454
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -2.894794  3.466222
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 94.74 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 70.67 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 26.963 13.4815  6.1695 0.006888
## Residuals 24 52.444  2.1852
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 189.35 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 97.92 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 171.14 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 262.3 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 332.26 166.129  9.7677 0.001341
## form       1 204.14 204.144 12.0028 0.002766
## dose:form  2 249.82 124.909  7.3441 0.004655
## Residuals 18 306.14  17.008
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000463 0.0815314 0.0009855
## high 0.0000463 1.0000000 0.0000003 0.2878483
## low  0.0815314 0.0000003 1.0000000 0.0000058
## mid  0.0009855 0.2878483 0.0000058 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.8000 -0.7111 -0.4444  1.3056  4.2000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.444      0.918  21.180 7.13e-11
## waterB         8.356      1.536   5.439  0.00015
## 
## Residual standard error: 2.754 on 12 degrees of freedom
## Multiple R-squared:  0.7114,	Adjusted R-squared:  0.6874 
## F-statistic: 29.58 on 1 and 12 DF,  p-value: 0.0001503
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7114$ aus? \textbf{(2 Punkte)}
...
## t = -5.0504, df = 8, p-value = 0.0009887
...
Einflussvariablen ($x$) wurden erhoben: weight, dry und N. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
dustbathing & 36cm; 23cm; 12.1\% & 34cm; 32cm; 3.5\% & 32cm; 28cm; 12.1\%\\
standing & 30cm; 23cm; 2.1\% & 40cm; 18cm; 2.1\% & 31cm; 23cm; 2.1\%\\
walking & 35cm; 30cm; 1.2\% & 32cm; 22cm; 0.5\% & 38cm; 27cm; 8.1\%\\
preening & 33cm; 26cm; 4.1\% & 34cm; 21cm; 5.2\% & 30cm; 23cm; 8.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCA2H2Q & 5.0 | 1.5 | Mikro \\
    B & GCT8QMT & 2.5 | 4.5 | Mikro \\ 
    C & GCKMCJF & 3.0 | 3.0 | Mikro \\ 
    D & GCM5UVO & 3.5 | 2.5 | Klein \\ 
    E & GC7YANX & 2.0 | 5.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 438 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{17, 13, 7\}$ und den Vektor $B = \{7, 2, 1\}$ gegeben.
