...
\begin{graybox}{Ergebnis der Klausur}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 53 Punkten sind aus dem Rechen- und
    Textteil erreicht. 
  \item[] \rule[0ex]{3em}{.4pt}\, von 73 Punkten in Summe.
...
\end{center}
\begin{itemize}
\item Es sind \rule[0ex]{2em}{.4pt}\, von 53 Punkten erreicht worden.
\end{itemize}
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.42, 0.89 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1.68, 3.56 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.105, 0.2225 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 1 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 1 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.105, 0.2225 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 3, 9, 15 und 13.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.2 +/- 2.3
\item [\textbf{B} \msquare] Es ergibt sich 10.2 +/- 21.2
\item [\textbf{C} \msquare] Es ergibt sich 10.2 +/- 4.6
\item [\textbf{D} \msquare] Es ergibt sich 9.2 +/- 10.6
\item [\textbf{E} \msquare] Es ergibt sich 10.2 +/- 2.3
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 19, 25, 16, 13, 8, 37 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 +/- 37
\item [\textbf{B} \msquare] Es ergibt sich 26 [14, 38]
\item [\textbf{C} \msquare] Es ergibt sich 19 [13, 37]
\item [\textbf{D} \msquare] Es ergibt sich 26 +/- 13
...
$y = \{13, 14, 15, 12, 10, 13, 9, 19, 18, 13, 13\}$. Berechnen Sie folgende
...
\begin{center}
$5, 9.2, 7.8, 13.9, 10.8, 7.9, 8, 8.9, 10.5, 11, 6.8, 9.8, 12.6, 8.7, 11.4$
\end{center}
...
## t = -2.7236, df = 12, p-value = 0.01848
...
## t = -0.23475, df = 10, p-value = 0.8191
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.793566  6.307851
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 110.3 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 75.11 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 101.587  50.794  22.166 5.341e-06
## Residuals 22  50.413   2.291
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 113 127 125 111  94  90 159 143 151 161 155 146
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 60.17 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 202.43 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 42.46 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 39 & 467.14 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2 303.167 151.584 16.6742 7.993e-05
## form       1  89.441  89.441  9.8385  0.005703
## dose:form  2  96.554  48.277  5.3105  0.015392
## Residuals 18 163.636   9.091
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##  -1.00  -1.00  -0.50   0.75   2.00 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  19.0000     0.5916   32.12 9.62e-10
## trtB          9.0000     0.8367   10.76 4.91e-06
## 
## Residual standard error: 1.323 on 8 degrees of freedom
## Multiple R-squared:  0.9353,	Adjusted R-squared:  0.9273 
## F-statistic: 115.7 on 1 and 8 DF,  p-value: 4.91e-06
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 7.2645, df = 8, p-value = 8.682e-05
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, height und weight. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.99 & 0 & 9.50 & 105.11 & 76.52 & 15\\
10.64 & 0 & 8.11 & 104.58 & 75.66 & 7\\
7.76 & 0 & 9.78 & 106.73 & 71.67 & 10\\
7.46 & 0 & 8.04 & 105.51 & 74.83 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.2077 -2.1560 -0.1341  1.8774  7.5897 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 78.43345    4.10740  19.096   <2e-16
## nematodes   -0.08072    0.10497  -0.769   0.4438
## water        0.02251    0.23739   0.095   0.9247
## P           -0.77001    0.29969  -2.569   0.0117
## 
## Residual standard error: 3.294 on 96 degrees of freedom
## Multiple R-squared:  0.07766,	Adjusted R-squared:  0.04883 
## F-statistic: 2.694 on 3 and 96 DF,  p-value: 0.05032
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & do2 & no3 & so4\\
\midrule
GUNPOWDER\_FALLS & 22 & 12659 & 9.7 & 3.30 & 5.98\\
MILL\_CR & 6 & 1097 & 8.3 & 1.71 & 15.77\\
PATAPSCO\_R & 28 & 4706 & 8.9 & 4.06 & 9.90\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -6.269  -4.239  -1.952   1.467  20.148  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.672e+00  1.392e+00   1.201  0.23550
## acerage      4.386e-05  1.509e-05   2.907  0.00547
## do2          1.186e-01  1.459e-01   0.813  0.42004
## no3          1.784e-01  5.956e-02   2.995  0.00429
## so4         -9.402e-04  2.110e-02  -0.045  0.96464
## 
## (Dispersion parameter for quasipoisson family taken to be 32.64223)
## 
##     Null deviance: 1723.2  on 53  degrees of freedom
## Residual deviance: 1213.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.401    -0.748   0.455
## 2 nematodes       0.161    -0.598   0.550
## 3 light           0.461     0.772   0.440
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1221 -0.5779 -0.0230  0.5194  3.3881 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  231.5   15.22   
##  subject  (Intercept) 4085.5   63.92   
##  Residual              683.4   26.14   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.788     27.023   7.467
## attitudepop  -18.563      5.744  -3.232
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000031 0.2012619 0.0007908
## high 0.0000031 1.0000000 0.0000001 0.0620301
## low  0.2012619 0.0000001 1.0000000 0.0000192
## mid  0.0007908 0.0620301 0.0000192 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 17, 10, 10, 13 und 16!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 12, 9, 7, 8 und 11! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes drymatter, pigs und Fe an drei verschiedenen Messterminen.
...
\item Berechnen Sie die theoretische Anzahl an Vervielf{\"a}ltigungsschritten die
  ...
  gesamten Sterne der Milchstra{\ss}e zu besuchen! \textbf{(1 Punkt)}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCRDFKE & 1.5 | 5.0 | Mikro \\
    B & GC8LSEX & 3.0 | 2.0 | Normal \\ 
    C & GCVZWYX & 4.5 | 4.5 | Klein \\ 
    D & GCJW8D2 & 1.0 | 3.0 | Normal \\ 
    E & GC4DCDC & 4.0 | 2.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1169 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{1, 4, 7\}$ und den Vektor $B = \{-6, 9, -1\}$ gegeben.
