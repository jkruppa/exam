...
\begin{graybox}{Erlaubte Hilfsmittel für die Klausur}
  ...
  \item Eine DIN A4-Seite \textbf{einseitig} als selbstgeschriebene,
    handschriftliche
    Formelsammlung. % ausschließlich mit Formeln und ohne erklärende Sätze;
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.02, 0.89, 0.03 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.1, 1, 0.15 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.1, 1, 0.15 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.004, 0.178, 0.006 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.05, 0.1, 4.45, 0.15 und 2.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.004, 0.178, 0.006 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
\begin{center}
  \includegraphics[width = 9cm]{\mainDir/exam/question/img/mc-modeling-03}
\end{center}
...
\begin{tikzpicture}
  \node (image) at (0,0) {
    \includegraphics[width=\textwidth]{C:/Users/jokruppa/lehre/intern/exam/question/img/diag-doppelbaum}
  };
...
\begin{center}
  \includegraphics[width = 14cm]{\mainDir/exam/question/img/text-error-cross-table}
\end{center}
...
\item Skizieren Sie in die
  ...
  \item[(b)] Ein Konfidenzintervall mit h{"o}herer Fallzahl $n$ in der Stichprobe als der Rest der Konfidenzintervalle 	
...
\begin{center}
  \includegraphics[height = 8cm]{\mainDir/exam/question/img/statistisches-testen-04}
\end{center}
