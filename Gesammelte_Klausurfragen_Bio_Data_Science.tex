...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\square\!\square\!\square\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\square\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\item [\textbf{B} \msquare] Es werden 25\% der Varianz durch den Versuch erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der durch Fehler in der Versuchsdurchführung entsteht.
\item [\textbf{C} \msquare] Es werden 25\% der Varianz durch die Behandlung erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der von den unterschiedlichen Behandlungsbedingungen erklärt wird.
...
In einer Studie zur Bewertung der Wirkung von Vitamin C auf das Zahnwachstum bei Schweine entstand folgende Abbildung. Der Versuch wurde an 73 Tieren durchgeführt, wobei jedes Tier eine von  drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Welche Aussage ist im Bezug auf eine zweifaktorielle ANOVA richtig?
...
Wie lautet der Mittelwert und Standardabweichung von $y$ mit 11, 7, 9, 9 und 15.



\begin{enumerate}
\item [\textbf{A} \msquare] Sie erhalten 10.2 +/- 3.03
\item [\textbf{B} \msquare] Es ergibt sich 11.2 +/- 1.515
\item [\textbf{C} \msquare] Es berechnet sich 10.2 +/- 9.2
\item [\textbf{D} \msquare] Es berechnet sich 11.2 +/- 9.2
\item [\textbf{E} \msquare] Sie erhalten 10.2 +/- 1.74
\end{enumerate} 
...
Wie lautet der Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 10, 22, 34, 22, 25, 32 und 51.




\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 +/- 22
\item [\textbf{B} \msquare] Es berechnet sich 26 [23; 33]
\item [\textbf{C} \msquare] Es berechnet sich 28 [23; 35]
\item [\textbf{D} \msquare] Sie erhalten 25 [20; 32]
\item [\textbf{E} \msquare] Es ergibt sich 25 [22; 34]
\end{enumerate} 
...
Sie haben $n = 183$ Pflanzen geerntet und wollen sich nun die Verteilung der Pflanzen einmal in einem Histogramm anschauen. Welche Verteilung ist dargestellt?
...
\item [\textbf{D} \msquare] Wenn ein prädiktives Modell gerechnet werden soll, dann muss zum einen ein Traingsdatensatz sowie ein Testdatensatz definiert werden. Dabei ist der Trainingsdatensatz meist 2/3 und der Testdatensatz 1/3 der Fallzahl groß. Der Testdatensatz dient zur Validierung.
...
In einer lineren Regression kann es vorkommen, dass der Effekt repräsentiert durch den $\beta$ Koeffizienten nicht so richtig von der Größenordnung zu dem p-Wert passen will. So liefert eine Untersuchung des Einflusses von der $CO_2$-Konzentration in [$\mu g$] im Wasser auf das Wachstum in [$kg$] an Erbsen folgende Effekte und p-Werte: $1e-04$ als p-Wert und einen $\beta_{CO_2}$ Koeffizienten von $6.9\times 10^{-7}$. Welche Aussage ist richtig?
...
\item [\textbf{C} \msquare] Die Einheit der $CO_2$-Konzentration ist zu klein gewählt. Die Erhöhung der $CO_2$-Konzentration um 1 Einheit führt nur zu einem sehr winzigen Anstieg von $\beta_{CO_2}$ im Gewicht der Wasserlinsen. Die Einheit [$\mu g$] muss besser gewählt werden.
...
In einer Studie wollen Sie den Effektschätzer Risk ratio berechnen. Sie finden in Ihrem Experiment zur Behandlung von Klaueninfektionen bei Kühen in 4 Tieren Erkrankung der Klauen vor. 12 Tiere sind gesund. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Das Verhältnis von Chancen Risk ratio ergibt ein Chancenverhältnis von 0.33.
\item [\textbf{B} \msquare] Der Anteil der Gesunden wird berechnet. Da es sich um ein Anteil handelt ergibt sich ein Risk ratio von 0.25.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.25, da es sich um eine Chancenverhältnis handelt.
\item [\textbf{D} \msquare] Da es sich um ein Chancenverhältnis handelt ergibt sich ein Risk ratio von 4.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.25, da es sich um ein Anteil handelt. Wir berechnen den Anteil der Kranken.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.21, 0.89 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.84, 1 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.84, 1 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.105, 0.0525, 0.2225 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.105, 0.0525, 0.2225 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.68, 0.84, 3.56 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
Die folgende Abbildung enthält die Daten aus einer Studie zur Bewertung der Wirkung des Mikronährstoff Nitrat auf den Ertrag in t/ha von Weizen im Vergleich zu einer Kontrolle. Der Versuch wurde in 12 Parzellen pro Gruppe durchgeführt. Welche Aussage im Bezug auf eine statistische Auswertung ist richtig?
...
\item [\textbf{B} \msquare] Die Barplots deuten auf ein signifikanten Unterschied. Der Effekt liegt vermutlich bei -5.
\item [\textbf{C} \msquare] Die Barplots deuten auf einen signifikanten Unterschied. Der Effekt liegt vermutlich bei -5. Wir müssen aber einen Posthoc-Test rechnen um den Effekt wirklich bestimmen zu können.
\item [\textbf{D} \msquare] Es liegt ein signifikanter Unterschied vor. Der Effekt liegt bei -0.5.
...
Barplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Jonas nicht gemerkt, welche statistischen Maßzahlen für einen Barplot erhoben werden müssen. Das ist in soweit doof, da nach seiner Betreuer erstmal ein Barplot nachgebaut werden soll, bevor es mit seiner Abschlussarbeit losgeht. Dann hat er schonmal den \Rlogo Code vorliegen und nachher geht dann alles schneller. Die Behandlung für Lauch werden verschiedene Lüftungssysteme und Folientunnel ($ctrl$, $storm$ und $tornado$) sein. Erfasst wird als Endpunkt ($Y$) \textit{Ertrag}. Jonas soll dann \textit{yield} in seiner Exceldatei eintragen.
...
\item Wenn Alex \textit{keinen Effekt} zwischen den Behandlungen von Lauch erwarten würde, wie sehen dann die Barplots aus? \textit{Antworten Sie mit einer Skizze der Barplots!}
  \textbf{(1 Punkt)}
\end{enumerate} 
\clearpage
% -----------------------------------------------------------------------
...
Jessica steht vor einem ersten Problem, denn wenn es nach ihrem Betreuer geht, soll sie in einem einem Feldexperiment Erbsen auswertet. Soweit eigentlich alles passend. Die Behandlung werden verschiedene Genotypen ($AA$, $AB$ und $BB$) sein. In ihrer Exceldatei wird sie den Outcome ($Y$) \textit{Trockengewicht} als \textit{drymatter} aufnehmen. Vorab soll Jessica aber eimal die folgenden Boxplots ihrem Betreuer nachbauen, damit sie den \Rlogo Code schonmal für später vorliegen hat. Anhand von Boxplots lässt sich eine Aussage über die Varianzhomogenität über die Behandlungsgruppen treffen. Damit geht das Problem schon los.
...
Anschauen, was andere vor einem gemacht haben, ist eine Möglichkeit schnell ans Ziel zu gelangen. Deshalb hat sich Jessica viele Poster in der Fakultät angeschaut und ist zum Schluß gekommen, dass Boxplots eine häufig genutzte Abbildung sind. Jessica soll nun in ihrer Hausarbeit Lauch untersuchen. Die Behandlung in ihrer Hausarbeit sind verschiedene Düngestufen ($ctrl$ und $high$). Erhoben wurden von Jessica als Messwert ($Y$) \textit{Proteingehalt} benannt als \textit{protein} in ihrer Exceldatei. Erwartungsgemäß erhält sie von ihrer Betreuerin den Auftrag die erhobenen Daten als Boxplots darzustellen. Dann kann Jessica auch schonmal abschätzen, was bei einem statistischen Test rauskommen könnte. Darüber hinaus kann Jessica anhand Boxplots eine Aussage über die Varianzhomogenität über die Behandlungsgruppen treffen.
...
Mark betrachtet die folgenden Daten nach einem Freilandversuch mit Erbsen. In dem Experiment wurden die Knötchen gezählt. Nach der Meinung seinem Betreuer muss als erstes geschaut werden, wie diese verteilt sind. Also welcher statistischen Verteilung die Knötchen folgen. Dazu soll Mark ein Histogramm verwenden. Dann hätte man auch einen guten Überblick über den Endpunkt ($Y$).

\begin{center}
Die Knötchen: 5, 3, 3, 2, 8, 4, 6, 5, 5, 7, 2, 6, 5, 8, 4, 4, 7, 1, 7, 4, 3, 3, 0, 7, 3, 1, 5, 3, 3, 4
\end{center}
...
In einem Gespräch mit ihrem Betreuer wird Jessica gebeten seine Daten aus einem Gewächshausexperiment mit Erbsen in einem Histogramm darzustellen. In ihrem Experiment hat er die mittleren Mehltauspots erst fotographiert und dann ausgezählt. Laut ihrem Betreuer soll das Histogramm helfen, die Verteilung der die mittleren Mehltauspots zu bestimmen.

\begin{center}
Die mittleren Mehltauspots: 9.3, 8.2, 10.2, 10.2, 9.5, 10.6, 9.5, 7.8, 9.3, 11.6, 10.7, 9.4, 10.3, 10.5, 8, 7.3, 6.9, 12.8, 9.7, 11.2, 8.6, 10.6, 9.5, 11.5, 10.2, 10.5, 11.3, 7.2
\end{center}
...
Mark möchte gerne den Zusammenhang zwischen durchschnittlichen Anteil an Ton [\%/l] und Frischegewicht [kg/ha] im Kontext von Erbsen herausfinden. Hierfür hat Mark einen Versuch in einer Klimakammer im Wendland durchgeführt. Nach einigen unvorgesehenen Ereignissen hat er es geschafft folgende Datentabelle zu erstellen. Nun stellt sich die Frage für ihn, ob es überhaupt einen Zusammenhang zwischen den gemessenen Variablen gibt. Deshalb möchte Mark als erstes eine explorative Datenanalyse durchführen.

\begin{table}[!h]
\centering
\begin{tabular}{cc}
\toprule
Durchschnittlichen Anteil an Ton [\%/l] & Frischegewicht [kg/ha]\\
\midrule
14.2 & 18.3\\
12.9 & 19.8\\
18.5 & 25.1\\
...
In einen Versuch in einer Klimakammer im Oldenburger Land hatte Alex sich zum einen die Behandlung Mechanische Bearbeitung [ja/nein] und zum anderen die Messung Frischegewicht über Zielwert [ja/nein] im Kontext von Erbsen angeschaut. Nun steht Alex vor dem Problem, dass er zwei kategoriale Variablen in seiner Abschlussarbeit gemessen hat. Da sein Betreuer erstmal die langen Tabellen mit ja/nein in einer explorativen Datenanalyse zusammengefasst und präsentiert bekommen möchte bevor es überhaupt weitergeht, muss er jetzt eine Lösung finden.
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ abgelehnt & 20\% & 5\% & Testentscheidung \\
  \end{tabular}
  \end{center}
...
Tina ist im Wendland für einen Pilotexperiment mit sehr geringer Fallzahl $(n_1 = n_2 = 3)$ mit Erbsen. Allein diese Tatsache ist für sie eine Erzählung wert. Für ihren Projektbericht musste sie einen Versuch in einer Klimakammer mit Erbsen durchführen und das sollte laut ihrer Betreuerin an diesem Ort besonders gut gelingen, da man hier gut neue technische Anlagen und Behandlungen fernab der Bevölkerung testen könne. Zeugen gibt es hier jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn ihre Behandlung Lüftungssystemen und Folientunneln ($ctrl$ und $tornado$) und der Messwert Proteingehalt [g/kg] sollen mit einem t-Test ausgewertet werden. Immerhin weiß sie, dass ihr Messwert einer Normalverteilung folgt. 
...
Nilufar ist im Wendland für einen Versuch mit Erbsen. Allein diese Tatsache ist für sie eine Erzählung wert. Für ihre Abschlussarbeit musste sie ein Freilandversuch mit Erbsen durchführen und das sollte laut ihrer Betreuerin an diesem Nichtort besonders gut gelingen. Ablenkung gibt es jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn ihre Behandlung Substrattypen ($torf$ und $70p30n$) und der Messwert Frischegewicht [kg/ha] sollen mit einem t-Test ausgewertet werden. Immerhin weiß sie, dass ihr Messwert einer Normalverteilung folgt. 
...
Alles voll mit Erbsen. Das haben Steffen und Nilufar gemeinsam in einem Projektbericht gemacht! Worum ging es aber konkret? Beide haben als ein normalverteiltes Outcome ($Y$) Chlorophyllgehalt (SPAD-502Plus) [SPAD] von Erbsen bestimmt. Die Daten haben beide zusammen in einem Gewächshausexperiment erhoben. In dem Experiment ging es um eine vorher/nachher Untersuchung an den gleichen Erbsen. Als Behandlung wurde Ausgeizen ($ctrl$ und $28d$) eingesetzt. Nach der Meinung des Betreuers muss hier ein gepaarter t-Test gerechnet werden.
...
Leider kennen sich Steffen und Nilufar mit der Berechnung eines gepaarten t-Tests überhaupt nicht aus. Deshalb brauchen sie beide bei der Berechnung Ihre Hilfe!
...
'Wir waren in der Uckermark um Erbsen in einem Versuch in einer Klimakammer zu messen.', Steffen legt das Dokument auf den Tisch und schaut Jessica und Yuki fragend an. Beide schauen fragend zurück. Die beiden sind zu ihm gekommen, da sie sich nicht mit \Rlogo auskennen und daher Hilfe bei der Interpretation des t-Tests brauchen. Kein Problem. Aber worum es in dem Versuch geht, lässt sich nur aus dem Text in seiner Hand erahnen. Vielleicht hilft da ja die Ausgabe des t-Tests in R weiter.
...
## t = 2.7728, df = 19, p-value = 0.01212
...
Helfen Sie Steffen bei der Interpretation des t-Tests! Sonst geht es auch für Jessica und Yuki nicht weiter.
...
Tina und Steffen sind bei Yuki um sich Hilfe in \Rlogo zu holen. Die beiden hatten zwar schon erste Kontakte mit \Rlogo sind sich aber unsicher bei der Interpetierung der Ausgabe eines t-Tests für ihren gemeinsamen Versuch. In einem Projektbericht haben sie zusammen Erbsen untersucht. Dabei ging es um den Zusammenhang zwischen der Behandlung Düngestufen ($ctrl$ und $high$) und dem Messwert Frischegewicht [kg/ha]. Der Versuch wurde in einem Gewächshausexperiment in der Uckermark durchgeführt. Nach der Betreuerin ist der Messwert Frischegewicht [kg/ha] normalverteilt und ein t-Test passt daher. Das wird jetzt nicht mehr angezweifel...
...
## t = -0.14094, df = 17, p-value = 0.8896
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -10.815449   9.460903
## sample estimates:
...
Helfen Sie Yuki bei der Interpretation des t-Tests! Sonst geht es auch für Tina und Steffen nicht weiter.
...
Almería. Spanien. Sonne und Strand. Jonas und Tina haben ihren gemeinsamen Auslandsaufenthalt sichtlich genossen. Dann hatte sich auch noch angeboten ihre Abschlussarbeit gemeinsam in Almería durchzuführen. Nur muss jetzt alles in \Rlogo gerechnet werden, da \Rlogo international der Standard in der Datenauswertung ist und die Betreuer in Spanien nur \Rlogo können. Während beide Yuki Oliven füttern, hoffen sie mehr Informationen von ihr über ihm seltsamen \Rlogo Ausgabe des t-Tests. Immerhin erinnern beide sich an die Behandlung Düngestufen ($ctrl$ und $high$) und das es um Erbsen ging.
...
## 
## data:  Frischegewicht by Düngestufen
## t = 0.034989, df = 16, p-value = 0.9725
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -9.931329 10.264662
## sample estimates:
...
Helfen Sie Yuki bei der Interpretation des t-Tests! Sonst geht es auch für Jonas und Tina nicht weiter.
...
Es gibt ja immer die Möglichkeit sich Hilfe zu holen. Das geht natürlich auch immer in einer Hausarbeit. Deshalb arbeiten Tina und Mark gemeinsam an einer Hausarbeit. Das macht dann auch die Analyse ihres Hauptversuches einfacher. Zwar hat jeder von ihnen noch ein Subthema, aber auch da kann man sich ja helfen. In dem Hauptversuch wurde Folgendes von den beiden gemacht. Tina und Mark haben sich Erbsen angeschaut. Dabei geht um Zusammenhang zwischen Düngung ($vorher$ und $nachher$) und Chlorophyllgehalt (SPAD-502Plus) [SPAD]. Jetzt sollen beide einen gepaarten t-Test rechnen. Leider kennen sich beide nicht sehr gut in \Rlogo aus.
...
## 	Paired t-test
## 
## data:  Chlorophyllgehalt by Düngung
## t = 0.43743, df = 8, p-value = 0.6734
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -9.587496 14.076385
## sample estimates:
...
'Uff... die einfaktorielle ANOVA. Und wir können jetzt anhand der Visualisuierung sehen, ob da schon was signifikant ist?', Alex hebt die Augenbraue. 'Ja, können wir. Dafür müssen wir aber erstmal in \texttt{\{ggplot\}} uns die Daten anschauen. Oder wir zeichnen es flott mit der Hand. Geht auch.', meint Yuki dazu. Alex hatte sich in einen Versuch in einer Klimakammer verschiedene Erbsen angeschaut. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Substrattypen ($torf$, $40p60n$ und $70p30n$) und dem Messwert Chlorophyllgehalt (SPAD-502Plus) [SPAD] gibt.
...
Leider kennen sich Alex und Yuki mit Darstellung einer einfaktoriellen ANOVA überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe! 
...
\toprule
    ...
    \midrule
   \textbf{Lichtstufen}  & 3 & 378.87 &  &  &  \strut\\
   \textbf{error}  & 21 & 222.89 &  &  &  \strut\\
...
'Uff... die einfaktorielle ANOVA. Und wie füllen wir jetzt 	extit{genau} die Tabelle der ANOVA aus und schauen, ob da was signifikant ist?', Mark hebt die Augenbraue. 'Das ist eine sehr gute Frage. Ich glaube man kann alles in der Tabelle relativ einfach mit wenigen Informationen berechnen.', meint Yuki dazu. Mark hatte sich in ein Freilandversuch verschiedene Erbsen angeschaut. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Lüftungssystemen und Folientunneln ($ctrl$, $storm$, $thunder$ und $tornado$) und dem Messwert Frischegewicht [kg/ha] gibt. Nun möchte erstmal seine Betreuerin eine ANOVA Tabelle sehen. Was immer da auch drin zu erkennen sein mag.
...
\toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Lüftungssystemen}  & 3 & 6620.21 &  &  &  \strut\\
   \textbf{Error}  & 26 & 839.16 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
ctrl & 10 & 2.40 & 2.12\\
storm & 9 & 2.56 & 5.73\\
thunder & 6 & 32.33 & 9.67\\
tornado & 5 & 34.40 & 4.16\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
Tina schaut entnervt auf und klappt den Laptop zu. Nun möchte ihre Betreuerin ihrem Projektbericht erstmal eine ANOVA sehen und \textit{dann} die Ergebnisse präsentiert bekommen bevor es überhaupt mit der Abschlussarbeit weitergeht. Dabei war sie extra im Oldenburger Land um ein Gewächshausexperiment mit Erbsen durchzuführen. Und dort was es wirklich nicht schön geschweige denn spannend wie bei ihren Kommilitonen, die in Almería waren. Hätte sie es vorher gewusst, dann hätte sie die Abschlussarbeit bei wem anders geschrieben. Aber gut, jetzt als die ANOVA in \Rlogo.
...
## Lichtstufen  3 3749.0 1249.66  64.879 1.169e-11
## Residuals   24  462.3   19.26
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Steffen steht im Oldenburger Land. Und das ist noch langweiliger als es sich anhört. Wäre es nur so spannend wie bei seinen Kommilitonen, die in Almería waren. Ödnis wohin man nur blickt. Oder eben Erbsen. Ja, darum geht es in seiner Hausarbeit. Und wäre das nicht noch alles genug, ist sein Experiment auch noch als ein Feldexperiment komplex geraten. Es wurde der Messwert Proteingehalt [g/kg] mit dem Behandlung Genotypen ($AA$, $AB$ und $BB$) sowie der Behandlung Lüftungssystemen und Folientunneln ($ctrl$, und $tornado$) untersucht. 'Hmpf', denkt Steffen und ruft 'Und jetzt!?' in die Leere.
...
\begin{center}
  ...
  \toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Genotypen}  & 3 & 110.31 &  &  &  \strut\\
    \textbf{Lüftungssystemen}  & 1 & 36.59 &  &  &  \strut\\
    \textbf{Genotypen:Lüftungssystemen}  & 3 & 191.82 &  &  &  \strut\\
   \textbf{Error}  & 18 & 303 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
Es ist schon kurz nach fünf und Nilufar wird langsam nervös. Nilufar wollte heute Abend noch seine E-Sport Qualifikation schauen. Stattdessen versucht ihr Betreuer die Ausgabe der zweifaktoriellen ANOVA zu visualieren und zu überprüfen, ob es mit der Visualisierung der Daten als Boxplots zusammenpasst. Nilufar hatte im Oldenburger Land ein Gewächshausexperiment mit Erbsen durchgeführt. Es gab dabei zwei Behandlungen. Einmal Düngestufen ($ctrl$, $low$, $mid$ und $high$) sowie als zweite Behandlung Substrattypen ($torf$, $70p30n$). Gemessen wurde der Messwert ($Y$) Trockengewicht [kg/ha]. So kompliziert kann das jetzt doch nicht sein!
...
##                           Df Sum Sq Mean Sq F value    Pr(>F)
## Düngestufen                2 453.33 226.665 15.4461 0.0001242
## Substrattypen              1   0.01   0.011  0.0007 0.9787229
## Düngestufen:Substrattypen  2 260.82 130.412  8.8869 0.0020671
## Residuals                 18 264.14  14.675
\end{verbatim}
\end{kframe}
\end{knitrout}
...
In ein Gewächshausexperiment mit Erbsen wurde die Behandlung Lichtstufen ($none$, $200lm$, $400lm$, $600lm$, $700lm$ und $800lm$) gegen die Ergebnisse einer früheren Studie von Almar et al. (2012) verglichen. Im Rahmen des Experiments haben Jessica und Alex verschiedene Student t-Tests für den Mittelwertsvergleich für den Messwert Chlorophyllgehalt (SPAD-502Plus) [SPAD] gerechnet. Es ergab sich dann die folgende Tabelle der rohen p-Werte für die Vergleiche zu Almar et al. (2012). Jetzt sollen die beiden einmal schauen, was in den Daten so drin ist.
...
Tina hatte in ihrer Abschlussarbeit ein Freilandversuch durchgeführt. Soweit so gut. Dabei hat sie sich mit Erbsen beschäftigt. Angeblich der neueste heiße Kram... aber das ist wiederum was anderes. So richtig mitgenommen hat Tina das Thema dann doch nicht. Hat sie sich doch mit Lüftungssysteme ($ctrl$, $storm$, $thunder$ und $tornado$) und Frischegewicht [kg/ha] schon eine Menge an Daten angeschaut. Nach ihrem Betreuer soll sie nun ein CLD bestimmen. Weder weiß sie was ein CLD ist, noch war ihr erster Gedanke mit Köln und die LGBTQ Community richtig...
...
Nilufar hatte in ihre Abschlussarbeit ein Feldexperiment durchgeführt. Soweit so gut. Dabei hat sie sich mit Erbsen beschäftigt. Angeblich der neueste heiße Kram... aber das ist wiederum was anderes. So richtig mitgenommen hat Nilufar das Thema dann doch nicht. Hat sie sich doch mit Lichtstufen ($none$, $200lm$, $400lm$, $600lm$, $700lm$ und $800lm$) und Proteingehalt [g/kg] schon eine Menge an Daten angeschaut. Nach ihre Betreuerin soll sie nun ein CLD bestimmen. Weder weiß sie was ein CLD ist, noch war ihr erster Gedanke mit Köln und die LGBTQ Community richtig... Als erstes solle sie die Gruppen nach absteigender Effektstärke sortieren. Was immer das jetzt bringen soll.
...
'Oh, nee!', ruft Paula aus und rollt entnervt mit ihren Augen. Paula hatte ihre gesamte Analyse in SPSS gerechnet. Das war ja auch alles in Ordnung. Abbilungen haben geklappt und auch die statistischen Tests gingen dann irgendwie doch. Aber das CLD nicht. Paula findet einfach keine Möglichkeit ein CLD in SPSS zu erhalten. Aber ihr Betreuer möchte unbedingt ein CLD. Sonst wird es mit der Abgabe nichts. Dabei hatte sie schon wirklich eine Menge gemacht! Paula hatte sich zwei Variablen mit Düngestufen ($ctrl$, $low$, $mid$ und $high$) und Frischegewicht [kg/ha] in ein Gewächshausexperiment mit Erbsen angeschaut. Wo kriegt sie jetzt ein CLD her? Dann eben per Hand aus der Matrix der $p$-Wert. Paula stöhnt...
...
\midrule
\textbf{ctrl} & 1.0000000 & 0.6745198 & 0.0106689 & 0.0241311\\
\textbf{low} & 0.6745198 & 1.0000000 & 0.0423305 & 0.0770663\\
\textbf{mid} & 0.0106689 & 0.0423305 & 1.0000000 & 0.8303704\\
\textbf{high} & 0.0241311 & 0.0770663 & 0.8303704 & 1.0000000\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
Mark hat sich ein Herz gefasst und war für seinem Projektbericht in die Niederlande gegangen. Das war eine super Zeit in der er viel gelernt hat. Klar gab es auch die ein oder andere Besonderheit, aber das gehört hier eher nicht hin. Mark ist schon eine ganze Zeit im Büro, da sein Betreuer möchte, dass er jetzt auf seinen Daten mit $n = 122$ Beobachtungen von Erbsen einen $\mathcal{X}^2$-Test rechnet. Das ginge, da er als Behandlung \textit{Herbizideinsatz [ja/nein]} bestimmt und zum anderen die Variable \textit{Proteingehalt im Zielbereich [ja/nein]} ermittelt hat. Wie genau, das ist jetzt eine andere Frage.
...
Am Ende war es für Steffen in seiner Abschlussarbeit dann doch kein normalverteiltes Outcome. Das was jetzt etwas doff, da er sich auf eine ANOVA gefreut hatte. Prinzipiell ginge das auch irgendwie, aber nun möchte sein Betreuer gerne einen $\mathcal{X}^2$-Test auf einer $2x2$-Kreuztabelle berechnet bekommen. Steffen hatte sich in ein Freilandversuch $n = 133$ Beobachtungen von Erbsen angeschaut. Dabei hat er als Behandlung \textit{Mechanische Bearbeitung [ja/nein]} bestimmt und zum anderen die Variable \textit{Chlorophyllgehalt unter Zielwert [ja/nein]} ermittelt. Jetzt muss Steffen mal schauen, wie er das jetzt rechnet.
...
Am Ende war es für Alex in seiner Abschlussarbeit dann doch kein normalverteiltes Outcome. Das was jetzt etwas doff, da er sich auf eine ANOVA gefreut hatte. Prinzipiell ginge das auch irgendwie, aber nun möchte seine Betreuerin gerne einen $\mathcal{X}^2$-Test auf einer $2x2$-Kreuztabelle berechnet bekommen. Alex hatte sich in einen Versuch in einer Klimakammer $n = 133$ Beobachtungen von Erbsen angeschaut. Dabei hat er als Behandlung \textit{Pestizideinsatz [ja/nein]} bestimmt und zum anderen die Variable \textit{Frischegewicht über Zielwert [ja/nein]} ermittelt. Jetzt muss Alex mal schauen, wie er das jetzt rechnet. Nach seinem Experiment erhielt er folgende $2x2$ Kreuztabelle aus seinen erhobenen Daten.
...
'Wichtig ist es, dass wir jetzt eine Gerade durch die Punkte zeichnen!', ruft Yuki. 'Ich sehe nur zwei Zeilen und keine Punkte. Wie soll ich da denn jetzt eine Gerade durchzeichnen?', fragt Tina. Yuki atmet schwer ein und starrt auf die \Rlogo Ausgabe der Funktion \texttt{lm()}. Die beiden hatten ein Freilandversuch im Emsland mit Erbsen durchgeführt. Dabei wurden die beiden folgenden Variablen gemessen: durchschnittlicher Anteil an Ton [\%/l] und Trockengewicht [kg/ha]. Jetzt will die Betreuung von den beiden einmal die Visualisierung der Daten und auch gleich noch die lineare Regression gerechnet bekommen. Das haben beide in \Rlogo gemacht, aber wie soll das jetzt gehen?
...
\midrule
(Intercept) & -2.20 & 2.28 &  & \\
Durchschnittlicher Anteil & 0.44 & 0.23 &  & \\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
## 
## Call:
## Proteingehalt ~ Durschnittlicher_Niederschlag
## 
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.7046 -0.8386 -0.0271  0.8388  2.2346 
## 
## Coefficients:
##                               Estimate Std. Error t value Pr(>|t|)
## (Intercept)                     4.6346     1.6925   2.738   0.0117
## Durschnittlicher_Niederschlag   2.2870     0.1675  13.657 1.61e-12
## 
## Residual standard error: 1.069 on 23 degrees of freedom
## Multiple R-squared:  0.8902,	Adjusted R-squared:  0.8854 
## F-statistic: 186.5 on 1 and 23 DF,  p-value: 1.605e-12
\end{verbatim}
\end{kframe}
\end{knitrout}

Leider kennen sich Alex und Jessica mit der linearen Regression für kontinuierliche Daten in \Rlogo überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe!
...
\item Erklären Sie \textit{kurz} den Begriff \texttt{R-squared}! Was sagt Ihnen der Wert $0.89$ aus? \textbf{(2 Punkte)}
\end{enumerate}
...
\item Sind die Variablen \texttt{weight and fertilizer} normalverteilt? Begründen Sie Ihre Antwort! \textbf{(1 Punkt)}
\end{enumerate} 
\clearpage
% -----------------------------------------------------------------------
...
Einflussvariablen ($x$) wurden erhoben: variety, N und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
[1] "\\textit{Was ist eigentlich der Unterschied zwischen einem Objekt, einer Funktion und einem Wort in \\\\\\\\Rlogo?}\\\\ Sie:"
...
\item Wenn Sie die 10 Blaubeerschalen gekauft haben, wie viele Aligatorbirnen zu je 2.89 EUR können Sie sich dann noch für 50 EUR leisten? \textbf{(1 Punkt)}
\end{enumerate}
...
\item Ein Kilo Salat benötigt 130l Wasser. Ein Salatkopf wiegt 310 - 520g.
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2021 blieben die Erträge von Blaubeeren mit \ensuremath{9\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge steigerte sich um 6.1\%. Die Exporte für Avocados fielen in dem gleichen Zeitraum um 21.2\% auf \ensuremath{2.3\times 10^{5}}t.
...
\midrule
standing & 36cm; 23cm; 3.5\% & 32cm; 26cm; 4.5\% & 36cm; 24cm; 10.1\%\\
sitting & 33cm; 32cm; 64.1\% & 30cm; 22cm; 54.1\% & 36cm; 15cm; 25.4\%\\
preening & 33cm; 16cm; 6.3\% & 41cm; 28cm; 5.2\% & 38cm; 20cm; 5.1\%\\
drinking/eating & 33cm; 19cm; 12.8\% & 39cm; 27cm; 14.2\% & 26cm; 32cm; 18.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC5EFKB & 5.0 | 3.0 | Klein \\
    B & GCJ4BPT & 2.0 | 2.0 | Normal \\ 
    C & GCEVAOH & 3.0 | 4.0 | Klein \\ 
    D & GCT6NPK & 4.5 | 3.5 | Normal \\ 
    E & GCBOVX9 & 4.0 | 5.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1129 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.1\times 10^{10}} - \ensuremath{9\times 10^{8}} \cdot 2.2^{-0.3 \cdot t + 3.1}
\end{equation*}
