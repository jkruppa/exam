...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.01, 0.02 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.04, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.36, 0.04, 0.08 und 1.68. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.0025, 0.005 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.0025, 0.005 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.04, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 6, 16, 10 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9 +/- 7.75
\item [\textbf{B} \msquare] Es ergibt sich 11 +/- 1.97
\item [\textbf{C} \msquare] Es ergibt sich 10 +/- 15.5
\item [\textbf{D} \msquare] Es ergibt sich 10 +/- 3.94
\item [\textbf{E} \msquare] Es ergibt sich 10 +/- 1.97
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 26, 36, 17, 23, 37, 19 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 [19, 37]
\item [\textbf{B} \msquare] Es ergibt sich 29 +/- 19
\item [\textbf{C} \msquare] Es ergibt sich 26 +/- 19
\item [\textbf{D} \msquare] Es ergibt sich 29 [19, 37]
\item [\textbf{E} \msquare] Es ergibt sich 26 +/- 37
\end{enumerate}
...
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.52 liegt keine Overdispersion vor.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.28 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.27, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 2.67, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.27, da es sich um ein Anteil handelt.
...
\midrule
(Intercept) & 38.21 & 0.27\\
light\_binhigh & 3.48 & 0.41\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 3.48
...
\item [\textbf{C} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 12.1
\item [\textbf{D} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 12.1
...
$y = \{14, 23, 16, 15, 20, 17, 16, 18, 17, 13, 25\}$. Berechnen Sie folgende
...
\begin{center}
$10.4, 8.2, 8.2, 12.2, 10.4, 10.9, 11, 12.9, 12.5, 8.1, 9.9, 10.9$
\end{center}
...
## t = 1.9964, df = 12, p-value = 0.06909
...
## t = -0.18257, df = 10, p-value = 0.8588
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.772577  3.201148
## sample estimates:
...
## t = -10.247, df = 6, p-value = 5.039e-05
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 128 113 127 112 105 100 148 152 114 148 144 152
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 4.09 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 11.84 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  3.5503 1.77513  4.2586 0.02469 *
## Residuals 27 11.2545 0.41683                  
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 206.87 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2412.55 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 109.51 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 713.18 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df  Sum Sq Mean Sq F value    Pr(>F)    
## supp       1  456.48  456.48 39.2998 6.738e-08 ***
## dose       2 1432.88  716.44 61.6805 1.458e-14 ***
## supp:dose  2  111.77   55.89  4.8114   0.01202 *  
## Residuals 53  615.61   11.62                      
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
## (Intercept)  17.0000     0.9169  18.540 3.37e-10 ***
## trtB          8.8000     1.5343   5.736 9.37e-05 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.751 on 12 degrees of freedom
## Multiple R-squared:  0.7327,	Adjusted R-squared:  0.7104 
## F-statistic:  32.9 on 1 and 12 DF,  p-value: 9.374e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, height und dosage. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & temp & acerage & do2 & no3\\
\midrule
BIG\_ELK\_CR & 164 & 13.8 & 35971 & 10.2 & 3.20\\
BEAVER\_DAM\_CR & 19 & 17.0 & 3570 & 9.2 & 5.44\\
PRETTYBOY\_BR & 19 & 19.2 & 904 & 9.8 & 6.81\\
BIG\_BR & 72 & 16.7 & 4790 & 9.4 & 4.10\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -8.4258  -4.5324  -2.1682   0.4343  22.8884  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)  
## (Intercept) 1.082e-01  2.312e+00   0.047   0.9629  
## temp        5.642e-02  5.552e-02   1.016   0.3145  
## acerage     3.948e-05  1.518e-05   2.601   0.0123 *
## do2         1.718e-01  1.913e-01   0.898   0.3734  
## no3         1.838e-01  7.829e-02   2.347   0.0230 *
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 51.43121)
## 
##     Null deviance: 2424.6  on 53  degrees of freedom
## Residual deviance: 1665.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.51      1.99   0.0466
## 2 nematodes       0.142     0.355  0.723 
## 3 water           0.145    -2.09   0.0363
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
7.83 & 0 & 8.77 & 98.83 & 70.42 & 12\\
8.97 & 1 & 9.66 & 98.94 & 68.94 & 8\\
9.41 & 0 & 9.96 & 103.61 & 72.55 & 8\\
11.71 & 0 & 7.63 & 100.92 & 68.13 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.7087 -1.5233  0.0787  1.4673  4.8480 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -6.25373    7.38086  -0.847   0.3990    
## Fe           0.78520    0.07109  11.045   <2e-16 ***
## light        0.58106    0.48894   1.188   0.2377    
## P           -0.27394    0.15987  -1.714   0.0899 .  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.135 on 94 degrees of freedom
## Multiple R-squared:  0.5798,	Adjusted R-squared:  0.5664 
## F-statistic: 43.24 on 3 and 94 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.8885 -0.5385 -0.0898  0.5408  3.4401 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  234.2   15.30   
##  subject  (Intercept) 3991.6   63.18   
##  Residual              664.4   25.78   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.335     26.731   7.607
## attitudepop  -20.450      5.664  -3.611
## 
...
Mehr Informationen zu den Aufgaben in den folgenden Kapiteln aus dem Skript Bio Data Science.
  ...
  \item \href{https://jkruppa.github.io/stat-tests-posthoc.html#sec-compact-letter}{31.7 Compact letter display}
  \end{itemize}
\end{graybox}
% ----------------------------------------------------------------------- 
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.0023392 0.0000201 0.0000174
## B 0.0023392 1.0000000 0.0000000 0.0000000
## C 0.0000201 0.0000000 1.0000000 0.9605377
## D 0.0000174 0.0000000 0.9605377 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
Error: object 'grass_tbl' not found
\end{verbatim}
