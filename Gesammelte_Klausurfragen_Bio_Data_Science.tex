...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.21, 0.02, 0.01 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.042, 0.004, 0.002 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.1, 0.05 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.1, 0.05 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.042, 0.004, 0.002 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.7, 1.05, 0.1, 0.05 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 7, 10, 13 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.6 +/- 3.15
\item [\textbf{B} \msquare] Es ergibt sich 11.6 +/- 1.255
\item [\textbf{C} \msquare] Es ergibt sich 10.6 +/- 1.255
\item [\textbf{D} \msquare] Es ergibt sich 10.6 +/- 2.51
\item [\textbf{E} \msquare] Es ergibt sich 10.6 +/- 6.3
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 18, 18, 13, 21, 18, 13 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 18 +/- 21
\item [\textbf{B} \msquare] Es ergibt sich 20 [14, 22]
\item [\textbf{C} \msquare] Es ergibt sich 18 +/- 13
\item [\textbf{D} \msquare] Es ergibt sich 18 [13, 21]
\item [\textbf{E} \msquare] Es ergibt sich 20 +/- 13
\end{enumerate} 
...
$y = \{26, 19, 18, 17, 16, 21, 16, 19, 20, 13, 20\}$. Berechnen Sie folgende
...
\begin{center}
$8.7, 12.8, 8.7, 9.4, 5.9, 8.1, 7.9, 10.4, 13.4, 8.1, 11.4, 5.8$
\end{center}
...
## t = 0.49487, df = 12, p-value = 0.6296
...
## t = -0.26923, df = 14, p-value = 0.7917
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.977567  4.644234
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 21.14 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 40.51 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 68.963  34.481  8.9305 0.001261
## Residuals 24 92.667   3.861
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 116 118 120  99 102 116 135 136 137 170 156 158
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 7.52 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 353.01 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 85.55 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 258.13 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 264.45 132.225  6.6234 0.006986
## form       1   1.74   1.743  0.0873 0.771022
## dose:form  2  16.88   8.440  0.4228 0.661577
## Residuals 18 359.34  19.963
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.5556 -1.3056  0.1667  1.4444  4.8889 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  15.5556     0.8041  19.345 1.60e-12
## trtB          7.5556     1.1372   6.644 5.64e-06
## 
## Residual standard error: 2.412 on 16 degrees of freedom
## Multiple R-squared:  0.734,	Adjusted R-squared:  0.7173 
## F-statistic: 44.14 on 1 and 16 DF,  p-value: 5.641e-06
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{Multiple R-squared}!
  Was sagt Ihnen der Wert $0.734$ aus? \textbf{(2 Punkte)}
...
## t = 9.8496, df = 8, p-value = 9.504e-06
...
Einflussvariablen ($x$) wurden erhoben: height, fertilizier und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.15 & 0 & 11.49 & 106.50 & 76.08 & 6\\
9.91 & 0 & 11.71 & 95.12 & 60.66 & 5\\
12.44 & 0 & 10.40 & 97.02 & 66.79 & 8\\
12.12 & 0 & 9.62 & 100.41 & 69.32 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.3571 -1.8989  0.2598  2.4121  7.0073 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 69.71459    2.62005  26.608   <2e-16
## nematodes    0.08252    0.11614   0.711   0.4793
## water       -0.11202    0.23977  -0.467   0.6415
## light        1.55069    0.84237   1.841   0.0691
## 
## Residual standard error: 3.134 on 86 degrees of freedom
## Multiple R-squared:  0.04235,	Adjusted R-squared:  0.008948 
## F-statistic: 1.268 on 3 and 86 DF,  p-value: 0.2906
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
BEAR\_CR & 54 & 10.92 & 8.3 & 0.99 & 19.5\\
NORTHWEST\_BR\_ANACOSTIA\_R & 100 & 14.45 & 8.4 & 1.41 & 23.0\\
MUDDY\_BR & 25 & 12.77 & 8.9 & 2.05 & 17.0\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.419  -4.727  -1.605   1.414  21.042  
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.06231    1.76725   0.601   0.5505
## so4         -0.02243    0.02483  -0.903   0.3707
## do2         -0.01425    0.14641  -0.097   0.9228
## no3          0.18877    0.07049   2.678   0.0101
## temp         0.12649    0.04962   2.549   0.0140
## 
## (Dispersion parameter for quasipoisson family taken to be 42.08881)
## 
##     Null deviance: 2274.0  on 53  degrees of freedom
## Residual deviance: 1641.6  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.52      0.669   0.504
## 2 nematodes       0.130    -1.01    0.311
## 3 water           0.147    -0.464   0.642
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3970 -0.5477 -0.1094  0.6022  3.4634 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  203.6   14.27   
##  subject  (Intercept) 3914.2   62.56   
##  Residual              682.8   26.13   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.077     26.414   7.688
## attitudepop  -20.248      5.741  -3.527
## 
...
\begin{verbatim}
##           ctrl      high low       mid
## ctrl 1.0000000 0.6128187   0 0.0741760
## high 0.6128187 1.0000000   0 0.0247095
## low  0.0000000 0.0000000   1 0.0000000
## mid  0.0741760 0.0247095   0 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 6, 9, 16, 11 und 15!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 12, 11, 5, 8 und 7! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, grade und Fe an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCQM9OZ & 5.0 | 3.5 | Mikro \\
    B & GCCMZWE & 4.0 | 1.5 | Mikro \\ 
    C & GCUMZ6X & 1.5 | 2.0 | Klein \\ 
    D & GCOXGSY & 2.0 | 1.0 | Normal \\ 
    E & GCDZSKJ & 2.5 | 4.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 129 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{12, 6, 9\}$ und den Vektor $B = \{2, 3, 5\}$ gegeben.
