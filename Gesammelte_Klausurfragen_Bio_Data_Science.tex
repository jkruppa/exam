...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.34, 0.03 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 1.36, 0.12 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 1, 0.12 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0525, 0.085, 0.0075 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 1, 0.12 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0525, 0.085, 0.0075 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 12, 17, 12, 16 und 6.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12.6 +/- 4.34
\item [\textbf{B} \msquare] Es ergibt sich 13.6 +/- 2.17
\item [\textbf{C} \msquare] Es ergibt sich 11.6 +/- 9.4
\item [\textbf{D} \msquare] Es ergibt sich 12.6 +/- 2.17
\item [\textbf{E} \msquare] Es ergibt sich 12.6 +/- 18.8
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 30, 19, 19, 35, 21, 23, 9, 22, 13, 9 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 +/- 13
\item [\textbf{B} \msquare] Es ergibt sich 21 +/- 13
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 30
\item [\textbf{D} \msquare] Es ergibt sich 21 [13, 30]
...
$y = \{19, 9, 25, 14, 20, 24, 11\}$. Berechnen Sie folgende
...
\begin{center}
$11.4, 10.5, 13.2, 11, 9.8, 10, 9.3, 16.8, 10.7, 12.3, 9, 9.8$
\end{center}
...
## 
## data:  freshmatter by N
## t = -0.64327, df = 12, p-value = 0.5322
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.094629  2.227962
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 192.63 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 61.21 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 84.484  42.242  21.427 1.064e-05
## Residuals 20 39.429   1.971
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1]  93 108 135 101 120 100 144 149 146 156 147 157
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 2.08 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 70.62 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 226.13 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 785.53 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 285.92 142.959  7.6560 0.003927
## form       1 172.82 172.824  9.2553 0.007010
## dose:form  2  54.49  27.247  1.4592 0.258646
## Residuals 18 336.11  18.673
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -3.143 -1.307 -0.300  1.200  3.857 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  18.8000     0.9763  19.257 3.11e-09
## trtB         -4.6571     1.2783  -3.643  0.00451
## 
## Residual standard error: 2.183 on 10 degrees of freedom
## Multiple R-squared:  0.5703,	Adjusted R-squared:  0.5274 
## F-statistic: 13.27 on 1 and 10 DF,  p-value: 0.004512
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -10.646, df = 8, p-value = 5.31e-06
...
Einflussvariablen ($x$) wurden erhoben: N, rainfall und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.92 & 0 & 9.56 & 101.97 & 68.50 & 8\\
9.86 & 0 & 8.84 & 96.83 & 67.26 & 10\\
8.93 & 0 & 9.65 & 103.07 & 71.42 & 8\\
9.67 & 1 & 8.41 & 103.85 & 71.50 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -9.7381 -1.8940 -0.0716  2.1936  7.1546 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  75.8678     2.4752  30.652   <2e-16
## P            -0.5182     0.2130  -2.433   0.0168
## nematodes    -0.1180     0.1053  -1.121   0.2650
## light         1.0876     0.6958   1.563   0.1212
## 
## Residual standard error: 3.227 on 98 degrees of freedom
## Multiple R-squared:  0.09061,	Adjusted R-squared:  0.06277 
## F-statistic: 3.255 on 3 and 98 DF,  p-value: 0.02493
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & so4 & acerage & maxdepth\\
\midrule
DORSEY\_RUN & 8 & 22.6 & 20.24 & 7814 & 160\\
FISHING\_CR & 11 & 19.0 & 7.10 & 5046 & 109\\
MILL\_CR & 6 & 13.1 & 15.77 & 1097 & 53\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -12.059   -4.602   -2.388    2.377   15.162  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  7.658e-01  1.083e+00   0.707   0.4827
## temp         1.133e-01  5.170e-02   2.191   0.0333
## so4         -2.580e-02  2.760e-02  -0.935   0.3545
## acerage      2.294e-05  1.832e-05   1.252   0.2163
## maxdepth     1.020e-02  4.448e-03   2.294   0.0261
## 
## (Dispersion parameter for quasipoisson family taken to be 45.07363)
## 
##     Null deviance: 2354.8  on 53  degrees of freedom
## Residual deviance: 1783.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.389     1.46    0.144
## 2 light           0.462    -0.120   0.905
## 3 nematodes       0.173    -0.929   0.353
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4419 -0.6040 -0.0624  0.5257  3.4097 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  236.6   15.38   
##  subject  (Intercept) 4024.5   63.44   
##  Residual              661.0   25.71   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.746     26.838   7.592
## attitudepop  -20.601      5.649  -3.647
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0001586 0.0000205
## high 0.0000000 1.0000000 0.0070854 0.0376766
## low  0.0001586 0.0070854 1.0000000 0.4834513
## mid  0.0000205 0.0376766 0.4834513 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 11, 11, 1, 15 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 9, 6, 6 und 6! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes leaf, P und drymatter an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCKIEVE & 1.0 | 5.0 | Klein \\
    B & GCLW0K8 & 2.5 | 1.5 | Normal \\ 
    C & GCB6JVN & 4.0 | 3.0 | Mikro \\ 
    D & GC2WJIA & 3.5 | 3.5 | Mikro \\ 
    E & GCUYEGV & 3.0 | 2.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 228 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{-3, 7, -1\}$ und den Vektor $B = \{-1, -7, 5\}$ gegeben.
