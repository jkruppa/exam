...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\blacksquare\!\square\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\square\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\item [\textbf{B} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Behandlungsbedingungen erklärt wird. Daher werden 29\% der Varianz erklärt.
\item [\textbf{C} \msquare] Es werden 71\% der Varianz durch die Behandlung erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der von den unterschiedlichen Behandlungsbedingungen nicht erklärt wird.
...
\item [\textbf{E} \msquare] Es werden 29\% der Varianz durch den Versuch erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der durch Fehler in der Versuchsdurchführung entsteht.
\end{enumerate} 
...
Die folgende Abbildung enthält die Daten aus einer Studie zur Bewertung der Wirkung von Vitamin C auf das Zahnwachstum bei Kanarienvögel. Der Versuch wurde an 50 Tieren durchgeführt, wobei jedes Tier eine von  drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Welche Aussage ist richtig im Bezug auf eine zweifaktorielle ANOVA?
...
Gegeben ist $y$ mit 7, 3, 11, 4 und 9. Berechnen Sie den Mittelwert und Standardabweichung.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 6.8 +/- 3.35
\item [\textbf{B} \msquare] Es berechnet sich 7.8 +/- 11.2
\item [\textbf{C} \msquare] Sie erhalten 6.8 +/- 1.675
\item [\textbf{D} \msquare] Es berechnet sich 6.8 +/- 11.2
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 15, 17, 10, 36, 14, 27 und 51.




\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 17 +/- 14
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 14
\item [\textbf{C} \msquare] Es berechnet sich 24 [15; 37]
\item [\textbf{D} \msquare] Sie erhalten 17 [14; 36]
\item [\textbf{E} \msquare] Sie erhalten 17 +/- 36
\end{enumerate} 
...
Der Mittelwert $\bar{y}$ und der Median $\tilde{y}$ unterscheiden sich nicht in Ihren Feldexperiment zu Leistungssteigerung von Maiss.  Welche Aussage ist richtig?
...
\item [\textbf{D} \msquare] Es wird ein Trainingsdatensatz zum Trainieren des Modells benötigt. Der Testdatensatz dient zur Validierung. Dies gilt insbesondere für ein prädiktives Modell.
...
\item [\textbf{D} \msquare] Der Korrelationskoeffizienten $\rho$ ist eine standardisierte, statistische Maßzahl, die zwischen -1 und 1 liegt. Dabei ist Korrelationskoeffizienten $\rho$ einheitslos.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.02, 0.42 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.08, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.08, 1.68 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.005, 0.105 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.08, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.005, 0.105 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\item [\textbf{D} \msquare] Nein, wir können ein untersuchtes Individuum nicht mit einem t-Test auswerten. Wir erhalten keine Aussage zum Individuum. Wir können aber den Effekt als Quelle der Relevanz nutzen.
...
In einer Studie zur Bewertung der Wirkung des Mikronährstoff Nitrat auf den Ertrag in t/ha  von Papaya im Vergleich zu einer Kontrolle entstand folgende Abbildung. Der Versuch wurde in 7 Parzellen pro Gruppe durchgeführt. Welche Aussage ist im Bezug auf einen t-Test ist richtig?
...
\item [\textbf{C} \msquare] Der Test deutet auf ein signifikanten Unterschied hin. Der Effekt liegt vermutlich bei 8.
\item [\textbf{D} \msquare] Es liegt ein signifikanter Unterschied vor. Der Effekt liegt bei 0.8.
\item [\textbf{E} \msquare] Die Barplots deuten auf keinen signifikanten Unterschied. Der Effekt liegt vermutlich bei 8 unter einer groben Abschätzung.
\end{enumerate}
...
Mark steht vor einem ersten Problem, denn wenn es nach seiner Betreuerin geht, soll er in einem einem Freilandversuch Lauch auswertet. Soweit eigentlich alles passend. Besser wäre was anderes gewesen. Am Ende dann doch besser Geocaching. Wunderbar. Eine echte Ablenkung für Mark. Das heißt erstmal überlegen für Mark. Aus den Boxen wummert Andrea Berg und sein Mund ist verklebt von Marzipankugeln. 'Herrlich', denkt Mark. Die Behandlung werden verschiedene Lichtstufen ($none$, $200lm$ und $600lm$) sein. In seiner Exceldatei wird er den Endpunkt ($Y$) \textit{Proteingehalt} als \textit{protein} aufnehmen. Vorab soll Mark aber eimal die folgenden Barplots seiner Betreuerin nachbauen, damit er den \Rlogo Code schonmal für später vorliegen hat. Damit geht das Problem schon los. Mark und der Suff, eine unendliche Geschichte mit kniffeligen Wendungen.
...
\item Wenn Tina \textit{keinen Effekt} zwischen den Behandlungen von Maiss erwarten würde, wie sehen dann die Barplots aus? \textit{Antworten Sie mit einer Skizze der Barplots!}
  \textbf{(1 Punkt)}
\end{enumerate} 
\clearpage
% -----------------------------------------------------------------------
...
Boxplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Paula nicht gemerkt, welche statistischen Maßzahlen für einen Boxplot erhoben werden müssen. Besser wäre was anderes gewesen. Harry Potter. Ein wunderbares Hobby um sich drin zu verlieren und Abstand zu bekommen. Paula denkt gerne über Harry Potter nach. Das ist in soweit doof, da nach ihrem Betreuer nun Boxplots aus ihren Daten gebaut werden sollen, bevor es mit dem statistischen Testen weitergeht. Anhand von Boxplots lässt sich eine Aussage über die Normalverteilung von $Y$ treffen. Die Behandlung für Maiss waren verschiedene Substrattypen ($torf$ und $70p30n$). Erfasst wurde von Paula als Endpunkt ($Y$) \textit{Trockengewicht}. Paula hat dann \textit{drymatter} in ihrer Exceldatei eintragen. Aber nur in passender Atmospäre! Schon dutzende Male gesehen: Jagd auf roter Oktober. Aber immer noch großartig zusammen mit Smarties.
...
Aus den Boxen wummert Tocotronic und ihr Mund ist verklebt von Katjes. 'Herrlich', denkt Tina. Tina betrachtet die folgenden Daten nach einem Stallexperiment mit Puten. In dem Experiment wurden die auffälligen Hautflecken gezählt. Nach der Meinung ihrer Betreuerin muss als erstes geschaut werden, wie diese verteilt sind. Also welcher statistischen Verteilung die auffälligen Hautflecken folgen. Dazu soll Tina ein Histogramm verwenden. Dann hätte man auch einen guten Überblick über das Outcome ($Y$). Es wäre einfacher, wenn da nicht noch was wäre. Wenn das Rauchen nicht wäre, ja dann wäre wohl vieles möglich für Tina! Aber so... Tina nickt im Takt von Tocotronic und bemerkt dabei gar nicht was die Spinne schon wieder anstellt.

\begin{center}
Die auffälligen Hautflecken: 1, 5, 2, 5, 3, 2, 3, 5, 2, 3, 6, 3, 4, 2, 2, 2, 6, 4, 3, 6, 4, 6, 4, 5, 6, 1, 11, 3, 4, 6, 4, 5, 3, 3, 2, 2
\end{center}
...
In ihrer Hausarbeit möchte Yuki gerne die Daten aus einem Kreuzungsexperiment mit Puten in einem Histogramm darstellen. Das Histogramm erlaubt ihr dabei Rückschlüsse auf die Verteilung über den Endpunkt ($Y$) zu treffen Aus den Boxen wummert London Grammar und ihr Mund ist verklebt von Reese's Peanut Butter Cups. 'Herrlich', denkt Yuki. In seinem Experiment hat Yuki die mittlere Anzahl an gedrehten Haaren pro $cm^2$ gezählt. Es wäre einfacher, wenn da nicht noch was wäre. Eine echte Herausforderung für sie war schon immer die Faulheit gewesen. Ein leidiges Lied. Yuki nickt im Takt von London Grammar und bemerkt dabei gar nicht was das Minischwein schon wieder anstellt.

\begin{center}
Die mittlere Anzahl an gedrehten Haaren pro $cm^2$: 13.6, 12, 8.2, 6.9, 9.2, 12.4, 8.5, 8.6, 9.7, 16.1, 9.2, 10.8, 8.6, 11.1, 9.1, 9.7, 10.2, 11.5, 10.8, 10, 9.4, 9.2, 9.3, 7.1, 9, 8.5, 8.7, 10.6
\end{center}
...
Wenn es nach Alex ginge, wäre er schon längst fertig mit seiner Abschlussarbeit. Geht es aber nicht. Hm..., Gummibärchen und Abba. Das ist und bleibt die beste Kombination zum Nachdenken für Alex. In seiner Abschlussarbeit hatte er einen Leistungssteigerungsversuch im Oldenburger Land durchgeführt. Nach der Meinung seiner Betreuerin sieht das jedoch etwas anders aus. Jetzt soll er doch noch eine explorative Datenanalyse für den Zusammenhang zwischen mittlerer Anzahl an weißen Blutkörperchen [LEU/ml] und Protein/Fettrate [\%/kg] in Puten durchführen. Wie nervig! Alex und das Aufstehen, eine unendliche Geschichte mit kniffeligen Wendungen. Da zwei kontinuierliche Variablen vorliegen, geht die explorative Datenanalyse leider nicht mit Boxplots oder Barplots. Dann was anderes. Das Verrückte ist, dass die Katze Alien wirklich liebt. Das ist Alex sehr recht, denn er braucht Entspannung.
...
Wenn Matrix läuft, dann findet Yuki das Minischwein nicht mehr. Aber jetzt braucht sie mal Entspannung! Aber Ablenkung hilft nur begrenzt. 'Uff!', denkt sich Yuki. Jetzt hat sie doch tatsächlich zwei kategoriale Variablen in ihrer Hausarbeit gemessen. Zum einen die Behandlung Ökologisch [ja/nein] und zum anderen die Messung Fettgehalt erreicht [ja/nein] im Kontext von Puten. Hierfür hat sie ein Stallexperiment im Wendland durchgeführt. Jetzt möchte Yuki die Daten einmal in einer explorativen Datenanalyse darstellen. Danach kann sie dann über den passenden statistischen Test nachdenken. Dabei unterstützt ihre Betreuerin diesen Ansatz bevor es in der Datenanalyse weiter geht. So schön wie so gut. Yuki und die Faulheit, eine unendliche Geschichte mit kniffeligen Wendungen.
...
\toprule
Ökologisch & Fettgehalt erreicht\\
\midrule
ja & ja\\
ja & nein\\
ja & nein\\
...
Alex ist in der Uckermark für einen Pilotexperiment mit sehr geringer Fallzahl $(n_1 = n_2 = 3)$ mit Puten. Allein diese Tatsache ist für ihn eine Erzählung wert. Für seine Abschlussarbeit musste er ein Stallexperiment mit Puten durchführen und das sollte laut seinem Betreuer an diesem Ort besonders gut gelingen, da man hier gut neue technische Anlagen und Behandlungen fernab der Bevölkerung testen könne. Zeugen gibt es hier jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn seine Behandlung Ernährungszusatz ($ctrl$ und $fedX$) und der Messwert Fettgehalt [\%/kg] sollen mit einem t-Test ausgewertet werden. Immerhin weiß er, dass sein Messwert einer Normalverteilung folgt. 
...
Es gibt ja immer die Möglichkeit sich Hilfe zu holen. Das geht natürlich auch immer in einem Projektbericht. Deshalb arbeiten Mark und Paula gemeinsam an einem Projektbericht. Das macht dann auch die Analyse ihres Hauptversuches einfacher. Zwar hat jeder von ihnen noch ein Subthema, aber auch da kann man sich ja helfen. In dem Hauptversuch wurde Folgendes von den beiden gemacht. Mark und Paula haben sich Puten angeschaut. Dabei geht um Zusammenhang zwischen Bestandsdichte ($hoch$ und $niedrig$) und Fettgehalt [\%/kg]. Jetzt sollen beide einen gepaarten t-Test rechnen.
...
Leider kennen sich Mark und Paula mit der Berechnung eines gepaarten t-Tests überhaupt nicht aus. Deshalb brauchen sie beide bei der Berechnung Ihre Hilfe!
...
'Mit dem R Paket \texttt{\{emmeans\}} können wir gleich die Gruppenvergleiche rechnen und uns das \textit{compact letter displac}' ausgeben lassen!', verkündet Jonas sichtlich stolz. 'Nach Meinung der Betreuerin soll es aber nur erstmal ein t-Test sein. Und die Ausgabe ist schon wirr genug.', merkt Paula an. Steffen und Paula sind bei Jonas um sich in \Rlogo helfen zu lassen. Die beiden waren 3 Monate in der Uckermark um einen Versuch mit Puten in einem Leistungssteigerungsversuch durchzuführen. Ziel war es das Outcome ($Y$) Protein/Fettrate [\%/kg] zu bestimmen.
...
## t = -3.5981, df = 17, p-value = 0.002218
...
Helfen Sie Jonas bei der Interpretation des t-Tests! Sonst geht es auch für Steffen und Paula nicht weiter.
...
'Programmieren ist wie eine Sprache lernen. Man muss es nur machen, dann wird man mit der Zeit immer besser!', gibt Mark zwinkernd zu Protokoll. Das hilft jetzt Yuki und Jessica nur bedingt, da beide jetzt die \Rlogo Ausgabe interpretieren müssen und nicht vor drei Wochen, wo noch Zeit gewesen wäre. Die beiden hatten im Teuteburgerwald einen Versuch mit Puten in einem Leistungssteigerungsversuch durchgeführt. Das war schon anstrengend genug! 'Wir haben Protein/Fettrate [\%/kg] gemessen, vieleicht hilft das ja...', meint Yuki leicht genervt. Alle starren auf die \Rlogo Ausgabe des t-Tests.
...
## t = 0.031439, df = 14, p-value = 0.9754
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -7.5622  7.7872
## sample estimates:
...
## t = -1.985, df = 18, p-value = 0.0626
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -13.2924263   0.3772748
## sample estimates:
...
Helfen Sie Yuki bei der Interpretation des t-Tests! Sonst geht es auch für Paula und Jonas nicht weiter.
...
Alles voll mit Puten. Aber das haben Nilufar und Steffen eben gemeinsam in einem Projektbericht gemacht! Worum ging es aber konkret? Beide haben als einen normalverteilten Endpunkt ($Y$) Schlachtgewicht [kg] von Puten bestimmt. Die Daten haben beide zusammen in einem Stallexperiment erhoben. In dem Experiment ging es um eine vorher/nachher Untersuchung an den gleichen Puten. Als Behandlung wurde Bestandsdichte ($hoch$ und $niedrig$) eingesetzt. Nach der Meinung der Betreuerin muss hier ein gepaarter t-Test gerechnet werden. Leider kennen sich beide nicht sehr gut in \Rlogo aus.
...
## t = 3.8111, df = 8, p-value = 0.005154
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##   5.366616 21.811162
## sample estimates:
...
'Uff... die einfaktorielle ANOVA. Und wir können jetzt anhand der Visualisuierung sehen, ob da schon was signifikant ist?', Jonas hebt die Augenbraue. 'Ja, können wir. Dafür müssen wir aber erstmal in \texttt{\{ggplot\}} uns die Daten anschauen. Oder wir zeichnen es flott mit der Hand. Geht auch.', meint Steffen dazu. Jonas hatte sich in einen Leistungssteigerungsversuch verschiedene Puten angeschaut. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Lüftungssystem ($keins$, $storm$ und $thunder$) und dem Messwert Gewichtszuwachs in der 1LW gibt.
...
Leider kennen sich Jonas und Steffen mit Darstellung einer einfaktoriellen ANOVA überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe! 
...
'Uff... die einfaktorielle ANOVA. Und wie füllen wir jetzt die Tabelle der ANOVA aus und schauen, ob da was signifikant ist?', Nilufar hebt die Augenbraue. 'Das ist eine sehr gute Frage. Ich glaube man kann alles in der Tabelle relativ einfach mit wenigen Informationen berechnen.', meint Tina dazu. Nilufar hatte sich in einen Leistungssteigerungsversuch verschiedene Puten angeschaut. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Flüssignahrung ($ctrl$, $superIn$ und $flOw$) und dem Messwert Fettgehalt [\%/kg] gibt.
...
\toprule
    ...
    \midrule
   \textbf{Flüssignahrung}  & 2 & 1009.02 &  &  &  \strut\\
   \textbf{error}  & 17 &  &  &  &  \strut\\
   \textbf{Total}  & 19 & 1374.95 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
'Als erstes bauen wir uns aus unsere Daten die ANOVA Tabelle dann sehen wir schon, ob unser Gruppenvergleich in der ANOVA signifikant ist.', Tina schaut Jessica fragend an und hofft auf eine positive Regung im Gesicht. Wird aber enttäuscht. Jessica tut sich auch sehr schwer mit der einfaktoriellen ANOVA. Nun möchte erstmal ihre Betreuung der Arbeit eine ANOVA Tabelle sehen. Was immer da auch drin zu erkennen sein mag. Beide waren im Wendland um ein Kreuzungsexperiment mit Puten durchzuführen. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Ernährungszusatz ($ctrl$, $fedX$ und $getIt$) und dem Messwert Schlachtgewicht [kg] gibt.
...
\toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Ernährungszusatz}  & 2 & 4758.72 &  &  &  \strut\\
   \textbf{Error}  & 23 & 1087.32 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
'Uff... die einfaktorielle ANOVA und \Rlogo. Nicht so einfach... Was sagt mir jetzt die Ausgabe der ANOVA und wo sehe ich, ob da was signifikant ist?', denkt Yuki und hebt die Augenbraue. Yuki hatte sich ein Kreuzungsexperiment mit Puten angeschaut. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Genotypen ($AA$, $AB$ und $BB$) und dem Messwert Gewichtszuwachs in der 1LW gibt. Nun möchte seine Betreuerin seinem Projektbericht erstmal eine ANOVA sehen und die Ergebnisse präsentiert bekommen.
...
## Genotypen  2 3097.2 1548.62  27.109 1.159e-06
## Residuals 22 1256.8   57.13
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Nilufar steht im Wendland. Und das ist noch langweiliger als es sich anhört. Wäre es nur so spannend wie bei ihren Kommilitonen, die in Almería waren. Ödnis wohin man nur blickt. Oder eben Puten. Ja, darum geht es in ihrem Projektbericht. Und wäre das nicht noch alles genug, ist ihr Experiment auch noch als ein Stallexperiment komplex geraten. Es wurde der Messwert Protein/Fettrate [\%/kg] mit dem Behandlung Elterlinie ($ctrl$, $Standard$, $Yray$ und $Xray$) sowie der Behandlung Genotypen ($AA$ und $BB$) untersucht. 'Hmpf', denkt Nilufar und ruft 'Und jetzt!?' in die Leere.
...
\begin{center}
  ...
  \toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Elterlinie}  & 3 & 197.32 &  &  &  \strut\\
    \textbf{Genotypen}  & 1 & 0.52 &  &  &  \strut\\
    \textbf{Elterlinie:Genotypen}  & 3 & 94.8 &  &  &  \strut\\
   \textbf{Error}  & 18 & 274.56 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
\midrule
  ...
  \textbf{Elterlinie:Genotypen} & $5.23$ \\
  \bottomrule
  \end{tabular}
\end{center}
...
\item Was sagt der Term \textit{Elterlinie:Genotypen} aus? Interpretieren Sie das Ergebnis! \textbf{(2 Punkte)}
\end{enumerate}
...
In einen Leistungssteigerungsversuch wurden Puten mit der Behandlung Ernährungszusatz ($ctrl$, $fedX$ und $getIt$) sowie der Behandlung Genotypen ($AA$ und $BB$) untersucht. Es wurde als Messwert Schlachtgewicht [kg] bestimmt. Jetzt starrt Mark mit auf die \Rlogo Ausgabe einer zweifaktoriellen ANOVA. Leider starrt sein Betreuer in der gleichen Art Mark zurück an. Das wird ein langer Nachmmittag, denkt er sich und kreuselt seinen Mund. 'Und was machen wir jetzt?' entfährt es ihm überrascht entnervt. Immerhin war geht es ja um seine Hausarbeit. Mark hätte doch nichts mit Puten machen sollen. Puten -- was soll das auch bedeutendes sein?
...
##                            Df Sum Sq Mean Sq F value   Pr(>F)
## Ernährungszusatz            2   4.94   2.471  0.0927 0.911878
## Genotypen                   1  97.78  97.780  3.6697 0.071434
## Ernährungszusatz:Genotypen  2 418.69 209.347  7.8568 0.003525
## Residuals                  18 479.62  26.645
\end{verbatim}
\end{kframe}
\end{knitrout}
...
In ein Stallexperiment mit Puten wurde die Behandlung Genotypen ($00$, $AA$, $AB$ und $BB$) gegen die Ergebnisse einer früheren Studie von Almar et al. (2012) verglichen. Im Rahmen des Experiments haben Mark und Tina verschiedene Student t-Tests für den Mittelwertsvergleich für den Messwert Fettgehalt [\%/kg] gerechnet. Es ergab sich dann die folgende Tabelle der rohen p-Werte für die Vergleiche zu Almar et al. (2012). Jetzt sollen die beiden einmal schauen, was in den Daten so drin ist.
...
Alex hatte in seinem Projektbericht ein Kreuzungsexperiment durchgeführt. Soweit so gut. Dabei hat er sich mit Puten beschäftigt. Angeblich der neueste heiße Kram... aber das ist wiederum was anderes. So richtig mitgenommen hat Alex das Thema dann doch nicht. Hat er sich doch mit Lüftungssystem ($keins$, $storm$, $tornado$ und $thunder$) und Fettgehalt [\%/kg] schon eine Menge an Daten angeschaut. Nach seiner Betreuerin soll er nun ein CLD bestimmen. Weder weiß er was ein CLD ist, noch war sein erster Gedanke mit Köln und die LGBTQ Community richtig...
...
Tina sitzt schon etwas länger bei ihr Betreuer. So langsam macht Tina sich Gedanken, ob sie nicht doch mal anmerken sollte, dass sie von CLD noch nie was gehört hat. Aber noch kann gelauscht werden, ein Ende ist erstmal nicht in Sicht! Tina hatte in die Projektbericht einen Leistungssteigerungsversuch durchgeführt. Deshalb sitzt sie hier. Also eigentlich nein, deshalb nicht. Tina will fertig werden. Hat sie sich doch mit Genotypen ($00$, $AA$, $AB$ und $BB$) und Gewichtszuwachs in der 1LW schon eine Menge angeschaut. Tina beugt sich leicht nach vorne. Nein, doch keine Pause. Weiter warten auf eine Lücke im Fluss... 'Wir müssen als erstes die Gruppen nach absteigender Effektstärke sortieren!', hört Tina noch aus der Ferne bevor sie einnickt.
...
\item Interpretieren Sie das \textit{Compact letter display (CLD)} für Tina und Tina! \textbf{(1 Punkt)} 
\end{enumerate}
...
'Oh, nee!', ruft Steffen aus und rollt entnervt mit seinen Augen. Steffen hatte seine gesamte Analyse in DataTab gerechnet. Das war ja auch alles in Ordnung. Abbilungen haben geklappt und auch die statistischen Tests gingen dann irgendwie doch. Aber das CLD nicht. Steffen findet einfach keine Möglichkeit ein CLD in DataTab zu erhalten. Aber seine Betreuerin möchte unbedingt ein CLD. Sonst wird es mit der Abgabe nichts. Dabei hatte er schon wirklich eine Menge gemacht! Steffen hatte sich zwei Variablen mit Genotypen ($00$, $AA$, $AB$ und $BB$) und Protein/Fettrate [\%/kg] in einen Leistungssteigerungsversuch mit Puten angeschaut. Wo kriegt er jetzt ein CLD her? Dann eben per Hand aus der Matrix der $p$-Wert. Steffen stöhnt...
...
\midrule
\textbf{00} & 1.0000000 & 0.1832616 & 0.5494088 & 0.3798064\\
\textbf{AA} & 0.1832616 & 1.0000000 & 0.3951414 & 0.0454168\\
\textbf{AB} & 0.5494088 & 0.3951414 & 1.0000000 & 0.1505667\\
\textbf{BB} & 0.3798064 & 0.0454168 & 0.1505667 & 1.0000000\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
\item Interpretieren Sie das \textit{Compact letter display (CLD)} für Steffen und Tina! \textbf{(2 Punkte)} 
\end{enumerate}
...
Am Ende war es für Mark in seiner Hausarbeit dann doch kein normalverteiltes Outcome. Das was jetzt etwas doff, da er sich auf eine ANOVA gefreut hatte. Prinzipiell ginge das auch irgendwie, aber nun möchte sein Betreuer gerne einen $\mathcal{X}^2$-Test auf einer $2x2$-Kreuztabelle berechnet bekommen. Mark hatte sich in ein Kreuzungsexperiment $n = 162$ Beobachtungen von Puten angeschaut. Dabei hat er als Behandlung \textit{Ökologisch [ja/nein]} bestimmt und zum anderen die Variable \textit{Protein/Fettrate im Zielbereich [ja/nein]} ermittelt. Jetzt muss Mark mal schauen, wie er das jetzt rechnet.
...
Am Ende war es für Steffen in seiner Abschlussarbeit dann doch kein normalverteiltes Outcome. Das was jetzt etwas doff, da er sich auf eine ANOVA gefreut hatte. Prinzipiell ginge das auch irgendwie, aber nun möchte sein Betreuer gerne einen $\mathcal{X}^2$-Test auf einer $2x2$-Kreuztabelle berechnet bekommen. Steffen hatte sich in einen Leistungssteigerungsversuch $n = 162$ Beobachtungen von Puten angeschaut. Dabei hat er als Behandlung \textit{Außenklimakontakt [ja/nein]} bestimmt und zum anderen die Variable \textit{Fettgehalt erreicht [ja/nein]} ermittelt. Jetzt muss Steffen mal schauen, wie er das jetzt rechnet. Nach seinem Experiment erhielt er folgende $2x2$ Kreuztabelle aus seinen erhobenen Daten.
...
Dann rechnete Steffen den Fisher-Exakt-Test auf der $2x2$-Kreuztabelle in \Rlogo und erhielt folgende \Rlogo Ausgabe der Funktion \texttt{fisher.test()}.
...
'Hä? Hatten wir das als Aufgabe nicht schon mal, das wir aus kontinuierlichen Daten eine Abbildung bauen sollten?', fragt Paula. Nilufar schaut fragend zurück. 'Kann mich wie immer an nichts erinnern. Können wir trotzdem jetzt erstmal die Daten auswerten? Columbo?', antwortet Nilufar leicht angespannt. Die beiden hatten ein Stallexperiment im Oldenburger Land mit Puten durchgeführt. Dabei wurden die beiden folgenden Variablen gemessen: durchschnittlichen Bewegungsscore [Movement/h] und Protein/Fettrate [\%/kg]. Jetzt haben die beiden eigentlich alles zusammen. \textit{Eigentlich...}
...
Leider kennen sich Paula und Nilufar mit der linearen Regression für kontinuierliche Daten überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe!
...
\midrule
(Intercept) & 1.54 & 2.46 &  & \\
Durchschnittlicher Bewegungsscore & 0.10 & 0.24 &  & \\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
## -3.7792 -0.6833  0.0900  0.8431  2.8645 
## 
## Coefficients:
##                             Estimate Std. Error t value Pr(>|t|)
## (Intercept)                   5.0194     1.8210   2.756  0.00922
## Mittlere_Eisenkonzentration  -0.1947     0.1896  -1.027  0.31142
## 
## Residual standard error: 1.498 on 35 degrees of freedom
## Multiple R-squared:  0.02926,	Adjusted R-squared:  0.001524 
## F-statistic: 1.055 on 1 and 35 DF,  p-value: 0.3114
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erklären Sie \textit{kurz} den Begriff \texttt{R-squared}! Was sagt Ihnen der Wert $0.05$ aus? \textbf{(2 Punkte)}
\end{enumerate}
...
## 
## data:  Durchschnittlicher Bewegungsscore [Movement/h] and Fettgehalt [%/kg]
## t = 5.0099, df = 8, p-value = 0.00104
...
Einflussvariablen ($x$) wurden erhoben: P, weight und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
Steffen und Mark sind bei Jessica um sich Hilfe für eine Versuchsplanung in \Rlogo zu holen. Dabei geht es um den Zusammenhang zwischen der Behandlung Bestandsdichte ($standard$, $eng$, $weit$ und $kontakt$) sowie Genotypen ($AA$ und $BB$) und dem Messwert Schlachtgewicht [kg] in Puten. Der Versuch soll in einem Stallversuch in der Uckermark durchgeführt werden. Nach der Dozentin ist der Messwert Schlachtgewicht [kg] normalverteilt. Die beiden entschieden sich für ein faktorielles Versuchsdesign. Im ersten Schritt überlegt Jessica ein einfaches experimentelles Design zu probieren. Daher entscheiden sich alle drei für ein \textit{Randomized complete block design (RCBD)} mit nur einem der beiden Faktoren. Das sollte für den anfang erstmal reichen. 'Und jetzt, was machen wir jetzt?', Mark schaut die anderen beiden mit großen Augen an. Die zucken mit der Schulter.\\

Leider kennen sich Jessica, Steffen und Mark mit dem \textit{Randomized complete block design (RCBD)} überhaupt nicht aus. Deshalb brauchen die Drei bei der Erstellung Ihre Hilfe!
...
Jessica und Steffen sind bei Yuki um sich Hilfe für eine Versuchsplanung in \Rlogo zu holen. Dabei geht es um den Zusammenhang zwischen der Behandlung Flüssignahrung ($ctrl$, $superIn$ und $flOw$) sowie Genotypen ($AA$ und $BB$) sowie drei Blöcken und dem Messwert Gewichtszuwachs in der 1LW in Puten. Der Versuch soll in einem Kreuzungsexperiment im Wendland durchgeführt werden. Nach dem Dozenten ist der Messwert Gewichtszuwachs in der 1LW normalverteilt. Die beiden entschieden sich für ein faktorielles Versuchsdesign. Im ersten Schritt überlegt Yuki ein komplexeres experimentelles Design zu probieren. Daher entscheiden sich alle drei für ein \textit{Strip plot design oder auch Streifenanlage} mit Berücksichtigung einer Interaktion. Das sollte für den anfang erstmal reichen. 'Und jetzt, was machen wir jetzt?', Steffen schaut die anderen beiden mit großen Augen an. Die zucken mit der Schulter.\\

Leider kennen sich Yuki, Jessica und Steffen mit dem \textit{Strip plot design oder auch Streifenanlage} überhaupt nicht aus. Deshalb brauchen die Drei bei der Erstellung Ihre Hilfe!
...
Nilufar: \textit{Hä? Warum ändert sich nichts an meinen Daten? In R sehe ich doch die Änderungen aber irgendwie speicher R meine Änderungen meines Datensatzes ab. Was ist da los?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]
...
Vor dem Start der eigenen Arbeit möchte seine Betreuerin, dass Yuki einmal die wissenschaftliche Veröffentlichung \textit{Selle, P. H., et al. (2010). Implications of sorghum in broiler chicken nutrition} sinnvoll zusammenfasst. Dann würde die eigene Arbeit auch leichter von der Hand gehen und Yuki hätte dann schon eine Vorlage. 'Das ist jetzt aber umfangreicher als gedacht!', schnauft er und runzelt die Stirn.\\
...
Vor dem Start der eigenen Arbeit möchte seine Betreuerin, dass Alex einmal die wissenschaftlichen Daten \textit{data3} sinnvoll zusammenfasst. Dann würde die eigene Arbeit auch leichter von der Hand gehen und Alex hätte dann schon eine Vorlage um die eigenen erhobenen Daten in eine Tabelle eintragen zu können. 'Das ist jetzt aber umfangreicher als gedacht!', schnauft er und runzelt die Stirn als er in seinen Laptop starrt.\\
...
\item Wenn Sie die 4 Blaubeerschalen gekauft haben, wie viele Aligatorbirnen zu je 2.59 EUR können Sie sich dann noch für 200 EUR leisten? \textbf{(1 Punkt)}
\end{enumerate}
...
\begin{itemize}[noitemsep]
\item Ein Kilo Strauchtomaten benötigt 180l Wasser. Eine Strauchtomate wiegt 120 - 115g.
\item Ein Kilo Salat benötigt 140l Wasser. Ein Salatkopf wiegt 280 - 510g.
\item Ein Kilo Avocado benötigt 1100l Wasser. Eine Avocado wiegt 130 - 420g.
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2023 blieben die Erträge von Blaubeeren mit \ensuremath{8\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge reduzierte sich um 8.6\%. Die Exporte für Avocados fielen in dem gleichen Zeitraum um 21.2\% auf \ensuremath{2.3\times 10^{5}}t.
...
\midrule
standing & 39cm; 23cm; 7.2\% & 28cm; 26cm; 4.5\% & 32cm; 32cm; 12.1\%\\
foraging incl. scratching & 25cm; 23cm; 4.3\% & 32cm; 37cm; 4.1\% & 27cm; 29cm; 4.1\%\\
walking & 28cm; 28cm; 0.8\% & 37cm; 24cm; 0.2\% & 25cm; 18cm; 0.2\%\\
dustbathing & 36cm; 27cm; 1.2\% & 39cm; 27cm; 0.5\% & 40cm; 31cm; 8.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCNQ1RC & 1.0 | 5.0 | Mikro \\
    B & GC8ARXQ & 2.0 | 3.5 | Mikro \\ 
    C & GC8Q5WL & 4.0 | 1.0 | Normal \\ 
    D & GC2MCCJ & 5.0 | 1.5 | Klein \\ 
    E & GCBQGN4 & 3.0 | 3.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 466 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.1\times 10^{10}} - \ensuremath{1.4\times 10^{9}} \cdot 2^{-0.1 \cdot t + 2.7}
\end{equation*}
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  5-mal-gefaltete, 0.8mm, 30-cm-Karton} durch
...
Thorsten und Frida das Team der drei Kandidaten.
