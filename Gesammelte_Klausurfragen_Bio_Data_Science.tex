...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.89, 0.42 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.2225, 0.105 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.2225, 0.105 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 3.56, 1.68 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 1 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 1 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
$\eta^2 = 0.38$. Welche Aussage ist richtig?
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 15, 11, 8, 6 und 2.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.4 +/- 2.465
\item [\textbf{B} \msquare] Es ergibt sich 8.4 +/- 2.465
\item [\textbf{C} \msquare] Es ergibt sich 7.4 +/- 12.15
\item [\textbf{D} \msquare] Es ergibt sich 8.4 +/- 24.3
\item [\textbf{E} \msquare] Es ergibt sich 8.4 +/- 4.93
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 14, 19, 27, 19, 26, 31 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 +/- 19
\item [\textbf{B} \msquare] Es ergibt sich 26 +/- 31
\item [\textbf{C} \msquare] Es ergibt sich 25 [20, 32]
\item [\textbf{D} \msquare] Es ergibt sich 25 +/- 19
\item [\textbf{E} \msquare] Es ergibt sich 26 [19, 31]
\end{enumerate} 
...
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 4, da es sich um ein Anteil handelt.
\end{enumerate}
...
$y = \{14, 16, 9, 14, 14, 8, 16, 18, 12, 18, 10\}$. Berechnen Sie folgende
...
\begin{center}
$10.2, 9.7, 10.4, 6.2, 6.1, 11.2, 7.8, 13.1, 11, 12.8, 7.3, 7.2, 13.1, 8.4$
\end{center}
...
## t = -4.6604, df = 10, p-value = 0.0008937
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -9.417598 -3.325259
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 165.34 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 65.27 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 28.974  14.487  4.8729 0.01888
## Residuals 20 59.460   2.973
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 127 131 125 112  98  96 128 147 135 150 177 139
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 189.31 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 183.42 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 327.14 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 65 & 674.88 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  25.04  12.518  0.5568 0.5825855
## form       1 196.83 196.831  8.7554 0.0084020
## dose:form  2 485.61 242.803 10.8003 0.0008282
## Residuals 18 404.66  22.481
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.2857 -1.1786  0.1429  0.5714  4.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  15.8571     0.8186  19.372 2.02e-10
## trtB         -1.5714     1.1576  -1.357      0.2
## 
## Residual standard error: 2.166 on 12 degrees of freedom
## Multiple R-squared:  0.1331,	Adjusted R-squared:  0.06087 
## F-statistic: 1.843 on 1 and 12 DF,  p-value: 0.1996
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -5.0657, df = 8, p-value = 0.0009702
...
Einflussvariablen ($x$) wurden erhoben: N, dry und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
13.22 & 0 & 9.32 & 103.30 & 69.89 & 12\\
9.98 & 1 & 9.11 & 106.44 & 71.97 & 11\\
9.40 & 0 & 10.85 & 95.71 & 66.15 & 14\\
12.42 & 0 & 9.50 & 99.51 & 73.29 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.1428 -1.7751  0.2359  2.2138  6.6425 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  75.2656     2.9684  25.356   <2e-16
## water        -0.1935     0.1851  -1.045    0.298
## light         0.8410     0.6227   1.351    0.179
## P            -0.3526     0.2102  -1.677    0.096
## 
## Residual standard error: 3.08 on 121 degrees of freedom
## Multiple R-squared:  0.04227,	Adjusted R-squared:  0.01852 
## F-statistic:  1.78 on 3 and 121 DF,  p-value: 0.1546
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & so4 & do2 & temp\\
\midrule
MUDDY\_BR & 25 & 4266 & 12.77 & 8.9 & 17.0\\
PATAPSCO\_R & 28 & 4706 & 9.90 & 8.9 & 19.7\\
BROAD\_RUN & 53 & 1971 & 11.12 & 11.9 & 22.2\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -9.3496  -4.2030  -2.7593   0.9724  22.8557  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.588e-01  2.037e+00  -0.127   0.8994
## acerage      4.064e-05  1.718e-05   2.365   0.0220
## so4         -1.799e-03  3.442e-02  -0.052   0.9585
## do2          2.121e-01  1.553e-01   1.365   0.1783
## temp         9.185e-02  5.366e-02   1.712   0.0933
## 
## (Dispersion parameter for quasipoisson family taken to be 57.63249)
## 
##     Null deviance: 2332.6  on 53  degrees of freedom
## Residual deviance: 1879.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.46       2.62 0.00884
## 2 light           0.460      2.36 0.0183 
## 3 water           0.144     -2.67 0.00757
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0229 -0.5872 -0.1661  0.5596  3.5749 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  204.1   14.29   
##  subject  (Intercept) 3954.4   62.88   
##  Residual              727.3   26.97   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.984     26.562   7.642
## attitudepop  -20.161      5.925  -3.403
## 
...
\begin{verbatim}
##           ctrl      high low       mid
## ctrl 1.0000000 0.0321391   0 0.7472383
## high 0.0321391 1.0000000   0 0.0151938
## low  0.0000000 0.0000000   1 0.0000000
## mid  0.7472383 0.0151938   0 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 4, 7, 12, 10 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 6, 9, 5 und 1! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes P, grade und drymatter an vier verschiedenen Messterminen.
...
Seitenl{\"a}nge einer Pyramide betr{\"a}gt 38 K{\"o}nigsellen. Eine K{\"o}nigselle
misst 52.2cm.\\
...
\begin{enumerate}
\item Die K{\"o}nigspyramide von Meroe soll eine Seitenl{\"a}nge von 38
...
wollen diesmal endlich die aufw{"a}rts Terrainchallenge durchf{\"u}hren. Die
Reihenfolge der Caches nach Terrainwertung gibt daher die von Ihnen
abzufahrenden Orte vor. Folgende Informationen zu den Orten und den
entsprechenden Caches stehen Ihnen f{\"u}r Ihre Planung der Route zu
Verf{\"u}gung. Sie starten an dem Ort E.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCVOYTE & 1.5 | 3.5 | Normal \\
    B & GCJWBRY & 3.0 | 3.0 | Klein \\ 
    C & GCDKTHH & 1.0 | 2.5 | Klein \\ 
    D & GC599DV & 4.0 | 1.5 | Mikro \\ 
    E & GCIXEIH & 5.0 | 5.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
\item Welche Strecke in $km$ legen Sie bei der Bew{\"a}ltigung der
  aufw{"a}rts Terrainchallenge zur{\"u}ck? Geben Sie
...
man nicht alles im Jahr 388 n. Chr. f{\"u}r den neuen Lehnsherren
...
Geschwindigkeit von $12m/s$ bilden. 
...
Sie haben den Vektor $A = \{-4, 7, 8\}$ und den Vektor $B = \{4, 6, -4\}$ gegeben.
