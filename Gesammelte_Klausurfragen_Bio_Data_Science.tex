...
wurde an 57 Schweinen durchgef{\"u}hrt, wobei jedes Tier eine von
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 8, 13, 13, 8 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.4 +/- 1.255
\item [\textbf{B} \msquare] Es ergibt sich 9.4 +/- 3.15
\item [\textbf{C} \msquare] Es ergibt sich 10.4 +/- 2.51
\item [\textbf{D} \msquare] Es ergibt sich 10.4 +/- 6.3
\item [\textbf{E} \msquare] Es ergibt sich 10.4 +/- 1.255
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 20, 35, 22, 7, 23, 35, 18, 20, 15, 24 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 [19, 36]
\item [\textbf{B} \msquare] Es ergibt sich 26 +/- 18
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 18
\item [\textbf{D} \msquare] Es ergibt sich 22 [18, 35]
\item [\textbf{E} \msquare] Es ergibt sich 22 +/- 35
\end{enumerate} 
...
\item [\textbf{B} \msquare] Einen Dotplot. Die Punkte m{"u}ssen sich wie an einer Perlenschnurr audreihen. Eine Abweichung f{"u}hrt zur Ablehnung der Annahme.
...
In dem folgenden Histogramm von $n = 202$ Pflanzen ist welche
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.03, 0.89, 0.21, 0.001 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0033, 0.005, 0.1483, 0.035, 2e-04 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.18, 5.34, 1.26, 0.006 und 2.52. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.18, 1, 1, 0.006 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0033, 0.005, 0.1483, 0.035, 2e-04 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.18, 1, 1, 0.006 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate}
...
\item [\textbf{C} \msquare] Ja, ein untersuchtes Individuum k{"o}nnen wir mit einem statistischen Test auswerten. Wir erhalten eine Aussage zum Individuum.
...
\begin{center}
$2, 1, 4, 5, 4, 4, 2, 8, 3, 3, 4, 6, 6, 6, 5, 1, 4, 2, 7, 4, 3, 4, 3, 3, 5, 2, 1$
\end{center}
...
\begin{center}
$11.9, 7.8, 7.6, 14.1, 10.1, 7.9, 8, 10.8, 8.9, 6.9, 12.5, 11.5, 11.2, 9.4, 11.7, 7.8, 8.4, 10.9, 13.3, 8.6$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  $\alpha$-Fehler & H$_0$ wahr & H$_0$ abgelehnt & 5\% \\
  \end{tabular}
  \end{center}
...
## t = 2.2478, df = 12, p-value = 0.04417
...
## t = -0.67226, df = 10, p-value = 0.5166
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -3.821313  2.049884
## sample estimates:
...
## 
## data:  weight by group
## t = -0.51402, df = 14, p-value = 0.6153
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -4.844166  2.971150
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 16.4 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 32.16 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 12.376  6.1879  1.9178 0.1707
## Residuals 22 70.984  3.2266
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 57.03 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 479.1 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 176.6 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 492.29 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2  31.49  15.746  0.7093 0.505233
## form       1 188.98 188.981  8.5130 0.009187
## dose:form  2 209.19 104.594  4.7116 0.022614
## Residuals 18 399.58  22.199
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0004650 0.3975581 0.0118495
## high 0.0004650 1.0000000 0.0046732 0.2277028
## low  0.3975581 0.0046732 1.0000000 0.0794694
## mid  0.0118495 0.2277028 0.0794694 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 128$ Pflanzen untersucht.
\vspace{5Ex}
...
Experiment mit $n = 158$ Sauen. In dem Experiment wurde gemessen,
...
## -4.0000 -1.1429  0.8571  1.0000  3.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  15.1429     0.7308  20.722 9.22e-11
## waterB       -3.1429     1.0335  -3.041   0.0103
## 
## Residual standard error: 1.933 on 12 degrees of freedom
## Multiple R-squared:  0.4353,	Adjusted R-squared:  0.3882 
## F-statistic: 9.248 on 1 and 12 DF,  p-value: 0.01025
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.4353$ aus? \textbf{(2 Punkte)}
...
## t = -5.8271, df = 8, p-value = 0.0003928
...
Einflussvariablen ($x$) wurden erhoben: dosage, S und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
wing/leg stretching & 26cm; 31cm; 8.9\% & 46cm; 28cm; 4.5\% & 30cm; 19cm; 12.1\%\\
drinking/eating & 41cm; 20cm; 0.5\% & 27cm; 32cm; 2.4\% & 27cm; 27cm; 0.5\%\\
standing & 41cm; 26cm; 5.1\% & 42cm; 11cm; 5.1\% & 34cm; 26cm; 1.2\%\\
dustbathing & 41cm; 20cm; 12.8\% & 28cm; 24cm; 16.4\% & 38cm; 20cm; 12.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCITX7T & 3.5 | 2.0 | Klein \\
    B & GC6GDWZ & 1.0 | 3.5 | Mikro \\ 
    C & GC8IBJW & 3.0 | 5.0 | Klein \\ 
    D & GCXQXGK & 4.0 | 1.5 | Mikro \\ 
    E & GCZ5PG3 & 4.5 | 4.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 679 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{5, -8, 5\}$ und den Vektor $B = \{4, 2, 1\}$ gegeben.
