...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 9, 16, 14 und 9.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.4 +/- 11.3
\item [\textbf{B} \msquare] Es ergibt sich 11.4 +/- 3.36
\item [\textbf{C} \msquare] Es ergibt sich 12.4 +/- 1.68
\item [\textbf{D} \msquare] Es ergibt sich 11.4 +/- 1.68
\item [\textbf{E} \msquare] Es ergibt sich 10.4 +/- 5.65
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 23, 31, 23, 19, 23, 11, 13, 22, 26, 18 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 18
\item [\textbf{B} \msquare] Es ergibt sich 23 [19, 27]
\item [\textbf{C} \msquare] Es ergibt sich 23 [18, 26]
\item [\textbf{D} \msquare] Es ergibt sich 23 +/- 26
...
\item [\textbf{C} \msquare] Den Median berechen, dann die quadratischen Abst{"a}nde zum Median aufsummieren, dann die Wurzel ziehen.
...
\item [\textbf{E} \msquare] Einen Barplot. Die Mittelwerte m{"u}ssen alle auf einer H{"o}he liegen. Die Fehlerbalken haben hier keine Informationen.
\end{enumerate}
...
\item [\textbf{C} \msquare] Der Korrelationskoeffizienten nach Kendall wird genutzt, wenn das Outcome Y nicht normalverteilt ist. Der Korrelationskoeffizienten liegt zwischen 0 und 1.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.02, 0.001, 0.34 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.004, 2e-04, 0.068 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 0.1, 0.005, 1 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.004, 2e-04, 0.068 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 0.1, 0.005, 1.7 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 0.1, 0.005, 1 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\item [\textbf{E} \msquare] Contrast letter display. Unterschiede in den Behandlungen werden durch den gleichen Buchstaben oder Symbol dargestellt. Die Interpretation des CLD f{"u}hrt h{"a}ufig in die Irre.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In der Analogie der Sonnenscheindauer: Wie lange kann mit einem entsprechenden Effekt gerechnet werden? Die Wahrscheinlichkeit f{"u}r den Effekt gibt der statistische Test wieder.
...
\item [\textbf{C} \msquare] Nein, ein untersuchtes Individuum k{"o}nnen wir mit einem statistischen Test nicht auswerten. Wir erhalten keine Aussage zum Individuum.
...
Nach einem Freilandexperiment mit zwei Lichtstufen ($none$ und $600lm$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Datentabelle mit dem
...
\begin{center}
$5, 3, 3, 3, 8, 4, 7, 14, 2, 3, 4, 1, 3, 5, 8, 4, 4, 5, 4, 5, 5, 1, 4, 4, 4, 4, 1$
\end{center}
...
\begin{center}
$11.3, 11.5, 7.2, 11.4, 8.2, 11.9, 13, 8.8, 7.3, 12.4, 4.8, 10.2, 11.3, 8.6, 10.4, 13.9, 9.1, 10.3, 8.5, 10.2$
\end{center}
...
## 
## data:  drymatter by Fe
## t = 2.2399, df = 10, p-value = 0.04901
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  0.01792302 6.78207698
## sample estimates:
...
## t = 0.88449, df = 12, p-value = 0.3938
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -2.299545  5.442403
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 54.95 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 36.79 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 22.296 11.1481  3.1273 0.06209
## Residuals 24 85.556  3.5648
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 19.37 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 93.2 &  &  &  \strut\\
    \hline
...
Versuch wurde an 15 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 323.75 161.873  9.3954 0.001606
## form       1   0.58   0.576  0.0334 0.856984
## dose:form  2 239.71 119.856  6.9566 0.005777
## Residuals 18 310.12  17.229
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0200321 0.0091195 0.0062877
## high 0.0200321 1.0000000 0.0000104 0.6367350
## low  0.0091195 0.0000104 1.0000000 0.0000026
## mid  0.0062877 0.6367350 0.0000026 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.0000 -0.7143 -0.2143  1.2143  3.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  19.7143     0.7023  28.072 2.59e-12
## waterB       -7.7143     0.9932  -7.767 5.08e-06
## 
## Residual standard error: 1.858 on 12 degrees of freedom
## Multiple R-squared:  0.8341,	Adjusted R-squared:  0.8203 
## F-statistic: 60.33 on 1 and 12 DF,  p-value: 5.08e-06
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.8341$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: P, rainfall und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
wing/leg stretching & 29cm; 25cm; 0.4\% & 34cm; 20cm; 0.4\% & 43cm; 35cm; 0.2\%\\
drinking/eating & 31cm; 31cm; 3.2\% & 39cm; 18cm; 6.1\% & 27cm; 22cm; 5.1\%\\
foraging incl. scratching & 37cm; 21cm; 0.8\% & 38cm; 29cm; 0.8\% & 31cm; 17cm; 0.1\%\\
wingflapping & 25cm; 34cm; 13.2\% & 37cm; 21cm; 12.8\% & 43cm; 20cm; 12.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCAOFAD & 5.0 | 1.0 | Mikro \\
    B & GC2QPWE & 4.0 | 4.5 | Mikro \\ 
    C & GCLHB9Z & 1.5 | 3.0 | Mikro \\ 
    D & GCB6XGR & 2.0 | 4.0 | Klein \\ 
    E & GCVDKAU & 3.0 | 2.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 714 n. Chr. f{\"u}r den neuen Lehnsherren
...
Kaninchenweibchens pro Jahr bei ca. 12 Tieren pro Wurf. Ein
Weibchen hat im Durchschnitt 7 W{\"u}rfe pro Jahr. Trotz fehlender
Fressfeinde liegt die Mortalit{\"a}t der S{\"a}uglinge bei 40\%.
...
Kaninchenpopulation.
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{1.1\times 10^{9}} \cdot 2^{-0.1 \cdot t + 3.4}
\end{equation*}
...
transmittiert von Stechm{\"u}cken, t{\"o}ten 99.9\% der
...
Sie haben den Vektor $A = \{4, 5, 17\}$ und den Vektor $B = \{-2, 7, -1\}$ gegeben.
