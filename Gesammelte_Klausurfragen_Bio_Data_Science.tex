...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.21, 0.89, 0.02, 0.01 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1, 0.12, 0.06 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1, 0.12, 0.06 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.04, 1.26, 5.34, 0.12, 0.06 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.035, 0.1483, 0.0033, 0.0017 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.035, 0.1483, 0.0033, 0.0017 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 8, 3, 10 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.4 +/- 13.3
\item [\textbf{B} \msquare] Es ergibt sich 7.4 +/- 6.65
\item [\textbf{C} \msquare] Es ergibt sich 8.4 +/- 3.65
\item [\textbf{D} \msquare] Es ergibt sich 8.4 +/- 1.825
\item [\textbf{E} \msquare] Es ergibt sich 9.4 +/- 1.825
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 18, 28, 26, 22, 3, 17 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 [17, 28]
\item [\textbf{B} \msquare] Es ergibt sich 25 [18, 29]
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 17
\item [\textbf{D} \msquare] Es ergibt sich 25 +/- 17
\item [\textbf{E} \msquare] Es ergibt sich 22 +/- 28
\end{enumerate} 
...
$y = \{14, 14, 11, 13, 17, 13, 15, 13, 14, 17, 13\}$. Berechnen Sie folgende
...
\begin{center}
$11.8, 12.9, 8.2, 12.3, 7.2, 11.1, 11.2, 8.5, 12.4, 8.8, 9.8, 9.6, 12.4, 13.9$
\end{center}
...
Nach einem Experiment mit zwei Lichtstufen ($none$ und $600lm$) ergibt sich die
folgende Datentabelle mit dem gemessenen Trockengewicht
(\textit{drymatter})  von Brokoli. 
...
## t = 0.54925, df = 12, p-value = 0.5929
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 5.81 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 25.14 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 53.238 26.6190   16.77 7.73e-05
## Residuals 18 28.571  1.5873
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 111 129 111 102 111  98 136 142 146 177 138 155
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 17.01 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 108.57 &  &  &  \strut\\
    \hline
...
## Response: weight
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  10.86   5.432  0.4296 0.6572540
## form       1  78.05  78.049  6.1731 0.0230344
## dose:form  2 386.24 193.118 15.2742 0.0001324
## Residuals 18 227.58  12.643
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -13.00  -2.00  -0.60   2.25   9.00 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   13.000      1.843   7.054 1.33e-05
## waterB        -2.800      3.084  -0.908    0.382
## 
## Residual standard error: 5.529 on 12 degrees of freedom
## Multiple R-squared:  0.06429,	Adjusted R-squared:  -0.01369 
## F-statistic: 0.8244 on 1 and 12 DF,  p-value: 0.3818
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.0643$ aus? \textbf{(2 Punkte)}
...
## t = -3.3846, df = 8, p-value = 0.009576
...
Einflussvariablen ($x$) wurden erhoben: weight, fertilizier und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.22 & 0 & 10.65 & 94.98 & 65.53 & 11\\
10.70 & 0 & 11.26 & 100.04 & 68.67 & 14\\
8.04 & 1 & 10.88 & 99.74 & 68.18 & 12\\
10.39 & 0 & 10.43 & 102.05 & 67.18 & 8\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.6291 -1.0809 -0.1527  1.3319  3.5638 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -7.10733    6.35424  -1.119  0.26646
## Fe           0.80074    0.06083  13.163  < 2e-16
## P           -0.35597    0.13090  -2.719  0.00791
## light        0.62895    0.43069   1.460  0.14784
## 
## Residual standard error: 1.816 on 86 degrees of freedom
## Multiple R-squared:  0.6912,	Adjusted R-squared:  0.6804 
## F-statistic: 64.17 on 3 and 86 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & temp & so4 & acerage\\
\midrule
LIBERTY\_RES & 12 & 8.3 & 20.2 & 5.82 & 424\\
MORGAN\_RUN & 76 & 9.3 & 16.9 & 5.74 & 9765\\
TUSCARORA\_CR & 38 & 9.3 & 15.0 & 24.76 & 10274\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.666  -4.369  -2.542   1.078  21.842  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.702e-01  1.991e+00   0.085   0.9322
## do2          1.806e-01  1.587e-01   1.138   0.2607
## temp         9.327e-02  5.623e-02   1.659   0.1036
## so4         -1.478e-02  2.626e-02  -0.563   0.5761
## acerage      4.049e-05  1.781e-05   2.274   0.0274
## 
## (Dispersion parameter for quasipoisson family taken to be 55.59692)
## 
##     Null deviance: 2286.6  on 53  degrees of freedom
## Residual deviance: 1889.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.71      2.90  0.00370
## 2 water           0.160    -2.75  0.00595
## 3 nematodes       0.157    -0.700 0.484
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 801.8
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9620 -0.6573 -0.1361  0.6398  3.1173 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  218.4   14.78   
##  subject  (Intercept) 3982.0   63.10   
##  Residual              726.8   26.96   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.359     26.687   7.620
## attitudepop  -19.700      5.923  -3.326
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.3886869 0.0849099 0.0001517
## high 0.3886869 1.0000000 0.0123481 0.0000121
## low  0.0849099 0.0123481 1.0000000 0.0170225
## mid  0.0001517 0.0000121 0.0170225 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 14, 7, 11, 15 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 17, 5, 6, 8 und 10! \textbf{(2 Punkte)}
...
die Behandlungen A bis D sowie die Bl{\"o}cke eins bis drei
vorliegen. Sie messen die Outcomes grade, pigs und leaf an vier verschiedenen Messterminen.
...
Kannibalismus. Denn wenn der Nachbar nervt, dann muss zu Ma{\ss}nahmen gegriffen
werden. Kennt jeder aus einer mittelm{\"a}{\ss}igen Wohngemeinschaft. Das wollen
wir aber als vorsorgliche Puten-Halter:innen aber
nicht\footnote{Die Quelle der Inspiration f{\"u}r die Aufgabe war der folgende
  Artikel: \href{https://www.efsa.europa.eu/en/efsajournal/pub/7788}{EFSA
    Panel on Animal Health and Welfare, et al. (2023) Welfare of broilers
    on farm. EFSA Journal 21.2}}. Betrachten wir also einmal das
Platzangebot (eng. \textit{space allowance}, abk. \textit{SA}) der
Puten f{\"u}r vier T{\"a}tigkeiten und versuchen die notwendige Fl{\"a}che
zu optimieren. Wie immer gibt es daf{\"u}r mathematische Formel:
...
\item $i$ dem Verhalten: (1) foraging incl. scratching, (2) drinking/eating, (3)
...
\midrule
foraging incl. scratching & 32cm; 30cm; 8.9\% & 35cm; 27cm; 8.9\% & 32cm; 25cm; 8.9\%\\
drinking/eating & 33cm; 22cm; 4.3\% & 33cm; 19cm; 1.8\% & 46cm; 24cm; 4.1\%\\
standing & 41cm; 29cm; 0.2\% & 22cm; 22cm; 0.2\% & 36cm; 23cm; 0.4\%\\
walking & 38cm; 19cm; 16.4\% & 39cm; 28cm; 14.2\% & 31cm; 18cm; 12.8\%\\
\bottomrule
\end{tabular}
\end{table}
...
\item Skizzieren Sie die Werte $r_i$, $R_i$ und $A_i$ f{\"u}r zwei nebeneinander
  agierender Puten f{\"u}r ein Verhalten $i$. Nutzen Sie hierf{\"u}r vereinfachte
...
\item Sie entnehmen der Literatur folgende Aussage zur Verteilung der
  ...
  Abbildung!  \textbf{(1 Punkt)}
\item Welche Fl{\"a}che $a$ nimmt eine Pute ein? Welche Annahmen haben
  Sie f{\"u}r die Berechnung der Putenfl{\"a}che getroffen? \textbf{(2 Punkte)}
\end{enumerate}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCGK2IL & 4.0 | 3.5 | Mikro \\
    B & GCBS6YJ & 5.0 | 3.0 | Klein \\ 
    C & GCIWXFA & 1.0 | 4.0 | Normal \\ 
    D & GCPJUA2 & 4.5 | 5.0 | Normal \\ 
    E & GCQC8MG & 2.0 | 2.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1138 n. Chr. f{\"u}r den neuen Lehnsherren
...
1859 ungef{\"a}hr 24 Kaninchen entlassen hat, Millionen
...
Sie haben den Vektor $A = \{-4, 21, 20\}$ und den Vektor $B = \{6, -1, -3\}$ gegeben.
...
lassen. Tja, woanders keinen Termin gekriegt... Immerhin denken Sie und
...
AIDS-Test, den Sie nun machen werden? Die Pr{\"a}valenz von AIDS bei einem
Menschen in Europa wird mit 0.8\% angenommen. In
92\% der F{\"a}lle ist ein HIV-Test positiv, wenn der Patient
erkrankt ist. In 1\% der F{\"a}lle ist ein HIV-Test positiv,
wenn der Patient \textit{nicht} erkrankt ist und somit gesund ist. Sie
stutzen. Wie wahrscheinlich ist es denn eigentlich an AIDS erkrankt zu sein
$K^+$, wenn Sie einen positiven AIDS-Test vorliegen haben $T^+$? Gehen Sie
f{\"u}r die folgenden Berechnungen von $n = \ensuremath{3\times 10^{4}}$ Patienten mit
einem diagnostischen Test auf AIDS aus. Sie nehmen sich also einen Kuli und
fangen auf der historischen Ausgabe des Spiegels an zu rechnen.

\begin{enumerate}
\item Welche Wahrscheinlichkeit wollen Sie berechnen? \textbf{(1 Punkt)}
\item Zeichnen Sie einen Doppelbaum zur Berechnung der gesuchten
  Wahrscheinlichkeit!  
\item Beschriften
  Sie auch die {\"A}ste des Doppelbaumes, mit denen Ihnen bekannten
  Informationen!  \textbf{(8 Punkte)}
