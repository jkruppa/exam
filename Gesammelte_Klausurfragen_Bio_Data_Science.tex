...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 11, 3, 2 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 5.8 +/- 9.1
\item [\textbf{B} \msquare] Es ergibt sich 7.8 +/- 2.135
\item [\textbf{C} \msquare] Es ergibt sich 6.8 +/- 2.135
\item [\textbf{D} \msquare] Es ergibt sich 6.8 +/- 4.27
\item [\textbf{E} \msquare] Es ergibt sich 6.8 +/- 18.2
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 24, 34, 31, 18, 18, 29 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 29 +/- 18
\item [\textbf{B} \msquare] Es ergibt sich 28 [19, 35]
\item [\textbf{C} \msquare] Es ergibt sich 29 +/- 34
\item [\textbf{D} \msquare] Es ergibt sich 29 [18, 34]
\item [\textbf{E} \msquare] Es ergibt sich 28 +/- 18
\end{enumerate} 
...
In dem folgenden Histogramm von $n = 180$ Pflanzen ist welche
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.001, 0.42, 0.21 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 2e-04, 0.084, 0.042 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.005, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.7, 0.005, 2.1, 1.05 und 4.45. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 2e-04, 0.084, 0.042 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.005, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Beim multiplen Testen kann es zu einer $\beta$-Inflation kommen. Das globale Signifikanzniveau liegt nicht mehr bei $20\%$. Daher m{"u}ssen die p-Werte entsprechend adjustiert werden. Hierf{"u}r gibt es verschiedene Verfahren, wobei das Verfahren zur Adjustierung der p-Werte nach Bonferroni das bekanneste Verfahren ist.
...
\begin{enumerate}
\item [\textbf{A} \msquare] In der Analogie der Maximaltemperatur: Was ist der maximale Unterschied zwischen zwei Gruppen. Wir erhalten hier eine Aussage {"u}ber die Spannweite und den maximalen Effekt.
...
\item [\textbf{B} \msquare] Nein, ein untersuchtes Individuum k{"o}nnen wir mit einem statistischen Test nicht auswerten. Wir erhalten keine Aussage zum Individuum.
...
\item [\textbf{D} \msquare] Weder eine Ausssage {"u}ber die Population noch {"u}ber das Individuum ist mit einem statistischen Test m{"o}glich. Wir erhalten eine Aussage {"u}ber ein Experiment.
...
Nach einem Versuch in einer Klimakammer mit zwei Substrattypen ($torf$ und $70p30n$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Datentabelle mit dem
gemessenen Trockengewicht (\textit{drymatter}) von Brokoli.
...
\begin{center}
$5, 2, 4, 7, 4, 3, 3, 4, 2, 3, 5, 7, 7, 6, 6, 3, 2, 5, 5, 3, 7, 8, 3, 2, 3, 6, 6, 4, 1, 6, 4, 2, 2$
\end{center}
...
Brokoli nach einer durchgestandenen Infektion der Pflanzen. 

\begin{center}
$9.9, 9.7, 9, 10.1, 6, 9, 8.6, 11.5, 12.5, 8.5, 11.7, 8.7, 13.5, 7.9, 9.6, 9.2, 9.3, 8, 9.3, 12.3$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ beibehalten & 20\% & $\beta$-Fehler & H$_0$ wahr \\
  \end{tabular}
  \end{center}
...
Trockengewicht (\textit{drymatter}) von Erdbeeren.
...
## t = -0.85896, df = 16, p-value = 0.4031
...
## t = 2.2502, df = 10, p-value = 0.04817
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  0.03357749 6.82356537
## sample estimates:
...
## 
## data:  weight by group
## t = -2.6698, df = 12, p-value = 0.02042
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -10.129762  -1.025793
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 113.59 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 95.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Der Datensatz \textit{crop\_tbl} enth{\"a}lt das Outcome \textit{freshmatter} f{\"u}r ein Gew{"a}chshausexperiment mit 
...
## trt        2 152.254  76.127  24.722 2.361e-06
## Residuals 22  67.746   3.079
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 166.68 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 93.56 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 116.11 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 223.83 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 63 Rindern durchgef{\"u}hrt, wobei
...
## Response: gain
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2  43.07  21.537  0.9454 0.40697
## form       1  68.65  68.650  3.0136 0.09965
## dose:form  2 273.17 136.586  5.9959 0.01010
## Residuals 18 410.04  22.780
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0154088 0.6270371 0.0030319
## high 0.0154088 1.0000000 0.0467128 0.5212823
## low  0.6270371 0.0467128 1.0000000 0.0105295
## mid  0.0030319 0.5212823 0.0105295 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 148$ Pflanzen untersucht.
\vspace{5Ex}
...
## -3.8571 -0.8571  0.2857  1.4286  2.4286 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  14.8571     0.7911   18.78 2.90e-10
## waterB       11.7143     1.1188   10.47 2.17e-07
## 
## Residual standard error: 2.093 on 12 degrees of freedom
## Multiple R-squared:  0.9013,	Adjusted R-squared:  0.8931 
## F-statistic: 109.6 on 1 and 12 DF,  p-value: 2.175e-07
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.9013$ aus? \textbf{(2 Punkte)}
...
## t = 0.022427, df = 8, p-value = 0.9827
...
Einflussvariablen ($x$) wurden erhoben: variety, center und dry. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
foraging incl. scratching & 35cm; 28cm; 4.3\% & 37cm; 33cm; 4.1\% & 33cm; 25cm; 3.5\%\\
drinking/eating & 28cm; 33cm; 0.6\% & 29cm; 27cm; 0.2\% & 38cm; 35cm; 0.2\%\\
wing/leg stretching & 29cm; 30cm; 3.2\% & 35cm; 24cm; 6.1\% & 28cm; 22cm; 3.2\%\\
walking & 41cm; 25cm; 12.8\% & 48cm; 31cm; 14.2\% & 35cm; 25cm; 12.8\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC2HHRN & 2.5 | 5.0 | Mikro \\
    B & GCTLVMO & 3.0 | 3.5 | Normal \\ 
    C & GCPBBUA & 4.5 | 2.0 | Normal \\ 
    D & GC1YKUG & 2.0 | 4.5 | Mikro \\ 
    E & GCOY62C & 5.0 | 1.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 906 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{8\times 10^{9}} - \ensuremath{1.4\times 10^{9}} \cdot 2.3^{-0.1 \cdot t + 3.1}
\end{equation*}
...
4.5\% p.a. {\"u}ber 48 Monate finanzieren.
...
Sie haben den Vektor $A = \{8, 7, 7\}$ und den Vektor $B = \{2, -4, -1\}$ gegeben.
