...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.01, 0.001, 0.03, 0.21 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.06, 0.006, 0.18, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.0017, 2e-04, 0.005, 0.035 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.06, 0.006, 0.18, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.0017, 2e-04, 0.005, 0.035 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.04, 0.06, 0.006, 0.18, 1.26 und 2.52. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
$\eta^2 = 0.16$. Welche Aussage ist richtig?
...
\item [\textbf{E} \msquare] Der Korrelationskoeffizienten nach Pearson wird genutzt, wenn das Outcome Y normalverteilt ist. Der Korrelationskoeffizienten liegt zwischen -1 und 1.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 18, 3, 11, 5 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.8 +/- 2.985
\item [\textbf{B} \msquare] Es ergibt sich 9.8 +/- 5.97
\item [\textbf{C} \msquare] Es ergibt sich 9.8 +/- 35.7
\item [\textbf{D} \msquare] Es ergibt sich 10.8 +/- 2.985
\item [\textbf{E} \msquare] Es ergibt sich 8.8 +/- 17.85
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 15, 27, 28, 23, 24, 26 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 [23, 28]
\item [\textbf{B} \msquare] Es ergibt sich 26 +/- 23
\item [\textbf{C} \msquare] Es ergibt sich 26 +/- 23
\item [\textbf{D} \msquare] Es ergibt sich 26 +/- 28
\item [\textbf{E} \msquare] Es ergibt sich 26 [23, 28]
\end{enumerate}
...
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.41 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.41 liegt keine Overdispersion vor.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.2 ist
richtig?
...
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.46, da es sich um eine Chancenverh{"a}ltnis handelt.
...
In einem Stallexperiment mit $n = 124$ Ferkeln wurden verschiedene
...
\item [\textbf{C} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 10.27
\item [\textbf{D} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 10.27
...
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 550
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 138
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 275
\end{enumerate}
...
$y = \{23, 20, 17, 21, 16, 25, 13\}$. Berechnen Sie folgende
...
\begin{center}
$13.1, 11.2, 13.4, 6.1, 7.7, 8.9, 10.4, 12.2, 10.3, 6, 11.2, 10.4$
\end{center}
...
## t = 0.061604, df = 16, p-value = 0.9516
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 25.05 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 29.11 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  9.852  4.9259    1.52  0.239
## Residuals 24 77.778  3.2407
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 103 112 128  96  99  97 146 128 143 159 149 155
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 62.65 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 65.99 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 187.51 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 264.29 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  21.39   10.69  0.6065   0.55601
## form       1 467.67  467.67 26.5273 6.711e-05
## dose:form  2 118.89   59.45  3.3719   0.05705
## Residuals 18 317.34   17.63
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   78  \strut\\
    \hline
...
## -5.2000 -2.7778 -0.2778  1.8000  6.2222 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   20.200      1.572  12.846 2.26e-08
## trtB          -3.422      1.961  -1.745    0.107
## 
## Residual standard error: 3.516 on 12 degrees of freedom
## Multiple R-squared:  0.2024,	Adjusted R-squared:  0.1359 
## F-statistic: 3.045 on 1 and 12 DF,  p-value: 0.1065
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 5.4155, df = 8, p-value = 0.0006342
...
Einflussvariablen ($x$) wurden erhoben: block, rainfall und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.35 & 0 & 10.16 & 106.11 & 74.15 & 8\\
9.74 & 0 & 12.05 & 100.38 & 67.81 & 14\\
7.33 & 1 & 10.94 & 104.24 & 72.68 & 15\\
10.26 & 0 & 11.25 & 93.49 & 60.59 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.5622 -1.1653  0.1093  1.5052  4.9168 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  -9.2172     6.3502  -1.451 0.149942
## Fe            0.8669     0.0611  14.188  < 2e-16
## water        -0.1654     0.1538  -1.075 0.284916
## P            -0.6043     0.1560  -3.874 0.000197
## 
## Residual standard error: 2.18 on 95 degrees of freedom
## Multiple R-squared:  0.6891,	Adjusted R-squared:  0.6793 
## F-statistic: 70.19 on 3 and 95 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & maxdepth & temp & so4\\
\midrule
NORTHWEST\_BR & 6 & 1.56 & 63 & 20.8 & 13.22\\
HAINES\_BR & 98 & 7.71 & 50 & 16.8 & 26.44\\
PRETTYBOY\_BR & 19 & 6.81 & 39 & 19.2 & 9.20\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -7.925  -3.952  -2.095   1.395  18.262  
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 0.397962   1.004838   0.396 0.693791
## no3         0.256601   0.067502   3.801 0.000399
## maxdepth    0.008710   0.004689   1.858 0.069248
## temp        0.087304   0.043680   1.999 0.051202
## so4         0.006231   0.020201   0.308 0.759047
## 
## (Dispersion parameter for quasipoisson family taken to be 36.30376)
## 
##     Null deviance: 2041.3  on 53  degrees of freedom
## Residual deviance: 1321.4  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.29      0.637   0.524
## 2 nematodes       0.119     1.02    0.310
## 3 water           0.124    -0.859   0.390
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 799.3
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1690 -0.6129 -0.1151  0.5747  3.4509 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  208.7   14.44   
##  subject  (Intercept) 3973.1   63.03   
##  Residual              704.0   26.53   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   202.37      26.62   7.601
## attitudepop   -19.25       5.83  -3.303
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0482111 0.0000015
## high 0.0000000 1.0000000 0.0000000 0.0379287
## low  0.0482111 0.0000000 1.0000000 0.0000000
## mid  0.0000015 0.0379287 0.0000000 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 11, 2, 15, 13 und 12!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 19, 16, 12, 9 und 15! \textbf{(2 Punkte)}
...
die Futterzus{"a}tze 1 bis 4 sowie die Bl{\"o}cke eins bis drei
vorliegen. Sie messen die Outcomes drymatter, leaf und P an zwei verschiedenen Messterminen.
...
Sicherheitstoleranz von $20\%$ ein. In fl{\"u}ssiger Form hat
...
Sie haben den Vektor $A = \{11, 10, -9\}$ und den Vektor $B = \{-6, 0, 1\}$ gegeben.
