...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.34, 0.01, 0.02 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 1.7, 0.05, 0.1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 1, 0.05, 0.1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 1, 0.05, 0.1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.068, 0.002, 0.004 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.068, 0.002, 0.004 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 12, 10, 11, 10 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.8 +/- 0.35
\item [\textbf{B} \msquare] Es ergibt sich 11.8 +/- 0.42
\item [\textbf{C} \msquare] Es ergibt sich 10.8 +/- 0.42
\item [\textbf{D} \msquare] Es ergibt sich 10.8 +/- 0.84
\item [\textbf{E} \msquare] Es ergibt sich 10.8 +/- 0.7
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 12, 23, 23, 1, 27, 5 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 5
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 27
\item [\textbf{C} \msquare] Es ergibt sich 20 [5, 27]
\item [\textbf{D} \msquare] Es ergibt sich 23 [5, 27]
\item [\textbf{E} \msquare] Es ergibt sich 20 +/- 5
\end{enumerate}
...
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.59 liegt keine Overdispersion vor.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.05 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.2, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 4, da es sich um ein Anteil handelt.
...
\item [\textbf{B} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 0.01
\item [\textbf{C} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.1
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 275
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 274
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 138
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 548
...
$y = \{21, 23, 19, 18, 17, 19, 19, 19, 20, 20, 18\}$. Berechnen Sie folgende
...
\begin{center}
$4, 4, 2, 3, 4, 4, 3, 5, 3, 4, 6, 4, 7, 0, 10$
\end{center}
...
\begin{center}
$9.8, 9.3, 7.6, 12.8, 7.3, 7.3, 11.6, 7.5, 10.2, 11.2, 9.2, 9.4$
\end{center}
...
Mittelwert und Median f{\"u}r Fertilizer high einzeichnen
...
mit der Funktion \textbf{(2 Punkte)} 
\end{enumerate}

p-Werte f{\"u}r Shapiro und Varianz test f{\"u}r D{\"u}nger low

\begin{center}
  \large
  \begin{tabular}[c]{l|l|l}
  Fallzahl  & p Saphiro & p Varianz \strut\\ 
    \hline
    \textbf{$n = 5$} & \hspace{2cm} & \hspace{2cm} \strut\\
    \hline
    \textbf{$n = 20$} & \hspace{2cm} & \hspace{2cm} \strut\\
    \hline
    \textbf{$n = 50$} & \hspace{2cm} & \hspace{2cm} \strut\\
    \hline
  \end{tabular}
\end{center} 
\clearpage
...
## t = 0.58524, df = 14, p-value = 0.5677
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 131 103 130  96 119 115 136 134 132 151 143 158
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.78 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.64 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  2.973 1.48648  3.1303 0.05989 .
## Residuals 27 12.821 0.47487                  
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 209.46 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2428.06 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 106.73 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 713.96 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df  Sum Sq Mean Sq F value  Pr(>F)    
## supp       1   38.80   38.80  2.3606 0.12936    
## dose       2 2952.02 1476.01 89.7984 < 2e-16 ***
## supp:dose  2   82.57   41.29  2.5118 0.08909 .  
## Residuals 64 1051.96   16.44                    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
## -8.286 -2.421  0.700  2.579  8.714 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   19.286      1.994   9.674 2.15e-06 ***
## trtB          -3.486      3.089  -1.129    0.285    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 5.275 on 10 degrees of freedom
## Multiple R-squared:  0.113,	Adjusted R-squared:  0.02428 
## F-statistic: 1.274 on 1 and 10 DF,  p-value: 0.2854
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: S, region und variety. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & temp & acerage & no3 & maxdepth\\
\midrule
DEER\_CR & 26 & 19.1 & 8297 & 5.26 & 60\\
FLINTSTONE\_CR & 11 & 18.5 & 18943 & 0.25 & 50\\
SECOND\_MINE\_BR & 62 & 17.7 & 2511 & 4.17 & 60\\
MUDLICK\_RUN & 8 & 21.0 & 1507 & 0.84 & 51\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.429  -3.990  -1.967   2.113  14.639  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)   
## (Intercept) 9.301e-01  8.811e-01   1.056  0.29633   
## temp        4.990e-02  3.768e-02   1.324  0.19151   
## acerage     3.704e-05  1.279e-05   2.895  0.00564 **
## no3         2.093e-01  6.524e-02   3.209  0.00235 **
## maxdepth    1.020e-02  4.128e-03   2.472  0.01696 * 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 35.34778)
## 
##     Null deviance: 2503  on 53  degrees of freedom
## Residual deviance: 1548  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.50       1.46 0.144  
## 2 water           0.149     -1.81 0.0700 
## 3 light           0.440      2.72 0.00648
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
11.33 & 0 & 12.01 & 100.69 & 68.37 & 13\\
10.33 & 1 & 11.79 & 99.98 & 69.28 & 8\\
10.18 & 1 & 7.97 & 99.23 & 72.54 & 7\\
8.02 & 1 & 9.53 & 101.56 & 66.45 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.8258 -1.3948 -0.1988  1.5372  6.3985 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 12.76710    8.00537   1.595   0.1146    
## nematodes    0.13123    0.08304   1.580   0.1179    
## P           -0.56998    0.19844  -2.872   0.0052 ** 
## Fe           0.61486    0.07744   7.940 9.85e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.54 on 81 degrees of freedom
## Multiple R-squared:  0.4766,	Adjusted R-squared:  0.4572 
## F-statistic: 24.59 on 3 and 81 DF,  p-value: 2.074e-11
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 796.7
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2385 -0.5862 -0.1081  0.5387  3.2322 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  195.1   13.97   
##  subject  (Intercept) 4017.7   63.39   
##  Residual              681.5   26.10   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.005     26.715   7.561
## attitudepop  -20.055      5.736  -3.497
## 
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.0310445 0.0000002 0.0000288
## B 0.0310445 1.0000000 0.0000000 0.0000000
## C 0.0000002 0.0000000 1.0000000 0.0926775
## D 0.0000288 0.0000000 0.0926775 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{enumerate}
\item Erkl{\"a}ren Sie den Pipe-Operator am Beispiel der Berechnung des Mittelwertes
mit der Funktion \texttt{mean} und den Zahlen 10, 10, 5 und 8!  \textbf{(2 Punkte)} 
\item Erkl{\"a}ren Sie den Pfeil-Operator am Beispiel eines Zahlenvektors mit der
Funktion \texttt{c()} und den Zahlen 10, 10, 5 und 8!
