...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\blacksquare\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\square\!\blacksquare\!\square\!\blacksquare\!\square\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\square\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\begin{enumerate}
\item [\textbf{A} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Behandlungsbedingungen erklärt wird. Daher werden 16\% der Varianz erklärt.
...
\item [\textbf{C} \msquare] Es werden 16\% der Varianz durch den Versuch erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der durch Fehler in der Versuchsdurchführung entsteht.
...
\item [\textbf{E} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Umweltbedingungen erklärt wird. Daher werden 16\% der Varianz durch die Umweltbedingungen erklärt. Der Anteil der Varianz durch die Behandlungsgruppen ist dann 84\%.
\end{enumerate} 
...
Ein Versuch wurde an 61 Tieren durchgeführt, wobei jedes Tier eine von drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Die folgende Abbildung enthält die Daten aus diesem Versuch zur Bewertung der Wirkung von Vitamin D auf das Zahnwachstum bei Schweine.  Welche Aussage ist richtig, wenn Sie eine zweifaktorielle ANOVA rechnen?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.4 +/- 2.31
\item [\textbf{B} \msquare] Es ergibt sich 10.4 +/- 10.65
\item [\textbf{C} \msquare] Es ergibt sich 11.4 +/- 4.62
\item [\textbf{D} \msquare] Es ergibt sich 12.4 +/- 2.31
\item [\textbf{E} \msquare] Es ergibt sich 11.4 +/- 21.3
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 +/- 27
\item [\textbf{B} \msquare] Es ergibt sich 22 +/- 19
\item [\textbf{C} \msquare] Es ergibt sich 22 [19, 27]
\item [\textbf{D} \msquare] Es ergibt sich 25 +/- 4.62
\item [\textbf{E} \msquare] Es ergibt sich 25 [20, 28]
\end{enumerate} 
...
Die empfohlene Mindestanzahl an Beobachtungen füreinen Boxplot sind...
...
\item [\textbf{B} \msquare] Durch die Abbildung desBoxplot erhalten wir die Informationen über die Mittelwerte und die Varianz.
...
Sie führen ein Experiment zur Behandlung von Klaueninfektionen bei Ziegen durch. Bei 5 Tieren finden Sie eine Erkrankung der Klauen vor und 12 Tiere sind gesund. Welche Aussage über den Effektschätzer Risk ratio ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Der Anteil der Gesunden wird berechnet. Da es sich um ein Anteil handelt ergibt sich ein Risk ratio von 0.29.
\item [\textbf{B} \msquare] Das Verhältnis von Chancen Risk ratio ergibt ein Chancenverhältnis von 0.42.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.29, da es sich um ein Anteil handelt. Wir berechnen den Anteil der Kranken.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.89, 0.21, 0.01 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.7, 4.45, 1.05, 0.05 und 2.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.178, 0.042, 0.002 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1, 0.05 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1, 0.05 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.178, 0.042, 0.002 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
Ein Versuch wurde in 12 Parzellen pro Gruppe durchgeführt. Die folgende Abbildung enthält die Daten aus diesem Versuch zur Bewertung der Wirkung des Mikronährstoff Sulfit auf den Ertrag in t/ha von Mais im Vergleich zu einer Kontrolle.  Welche Aussage ist richtig, wenn Sie einen t-Test rechnen?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es liegt kein signifikanter Unterschied vor. Der Effekt liegt bei -5.
\item [\textbf{B} \msquare] Nach Betrachtung des Barplots liegt ein signifikanter Unterschied vor. Der Effekt liegt bei -5.
...
In einem Freilandversuch mit drei L{"u}ftungssystemen und Folientunneln ($ctrl$, $storm$ und $tornado$) als Behandlung
...
\begin{center}
$3, 3, 3, 5, 5, 2, 6, 3, 3, 2, 2, 3, 2, 4, 3, 1, 2, 7, 1, 5, 3, 7, 4, 3, 3, 9, 7, 8, 7, 9$
\end{center}
...
\begin{center}
$11.1, 8.3, 13.4, 8.2, 14.2, 10.7, 11.5, 8.2, 10.2, 9.5, 6.5, 11.6, 9.7, 11.8, 11.6, 8.9, 13$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ beibehalten & $\beta$-Fehler & (Unbekannte) Wahrheit & H$_0$ abgelehnt \\
  \end{tabular}
  \end{center}
...
\item Treffen Sie mit $T_{\alpha = 1\%} = 2.62$ und dem berechneten $T_{D}$ eine Aussage
  zur Nullhypothese! Begr{\"u}nden Sie Ihre Antwort! \textbf{(2 Punkte)}
...
## t = -0.85391, df = 10, p-value = 0.4131
...
In einem Feldexperiment wurde der Ertrag von Kartoffeln unter drei verschiedenen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 79.82 &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 &  &  &  &  \strut\\
        \hline
   \textbf{total}  & 24 & 127.76 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Faktorstufen \textit{ctrl}, \textit{mid} und
\textit{neg} vorliegen.
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 123.52 &  &  &  \strut\\
    \hline
   \textbf{error}  & 18 & 103.43 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Der Datensatz \textit{plant\_tbl} enth{\"a}lt das Outcome \textit{freshmatter} f{\"u}r ein Experiment in einer Klimakammer mit 
...
## trt        2  0.909  0.4546  0.1396 0.8705
## Residuals 22 71.651  3.2569
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 185.48 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 183.35 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 162.26 &  &  &  \strut\\
    \hline
   \textbf{error}  & 40 & 317.62 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 69 Ziegen durchgef{\"u}hrt, wobei
jedes Tier eine von drei Selen-Dosen $dose$ ($0.2$ ng/Tag, $3$ ng/Tag und $15$ ng/Tag)
...
## Response: weight
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 198.67  99.333  5.8982 0.010715
## form       1 258.09 258.090 15.3248 0.001016
## dose:form  2 143.18  71.591  4.2509 0.030759
## Residuals 18 303.14  16.841
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000505 0.0011983 0.3155089
## high 0.0000505 1.0000000 0.0000000 0.0009036
## low  0.0011983 0.0000000 1.0000000 0.0000680
## mid  0.3155089 0.0009036 0.0000680 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 164$ Sauen. In dem Experiment wurde gemessen,
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   82  \strut\\
    \hline
...
## -4.2222 -1.5556  0.3889  1.5833  4.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   18.000      1.208  14.901 4.19e-09
## waterB         5.222      1.507   3.466  0.00466
## 
## Residual standard error: 2.701 on 12 degrees of freedom
## Multiple R-squared:  0.5003,	Adjusted R-squared:  0.4587 
## F-statistic: 12.01 on 1 and 12 DF,  p-value: 0.004664
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.5003$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: height, P und variety. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\begin{enumerate}
\item Wenn 4 Blaubeerschalen 6.36 Euro kosten,  wie viel kosten 5 Schalen? \textbf{(1 Punkt)}
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2021 blieben die Erträge von Blaubeeren mit \ensuremath{8\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge steigerte sich um 6.1\%. Die Exporte für Avocados stiegen in dem gleichen Zeitraum um 21.2\% auf \ensuremath{2.3\times 10^{5}}t.
...
\item $i$ dem Verhalten: (1) standing, (2) dustbathing, (3)
  wingflapping und (4) drinking/eating.
\end{itemize}
...
\midrule
standing & 37cm; 24cm; 3.5\% & 32cm; 20cm; 12.1\% & 28cm; 38cm; 8.9\%\\
dustbathing & 33cm; 36cm; 1.2\% & 27cm; 27cm; 1.2\% & 33cm; 25cm; 8.1\%\\
wingflapping & 32cm; 32cm; 0.8\% & 50cm; 25cm; 0.8\% & 34cm; 25cm; 0.1\%\\
drinking/eating & 38cm; 19cm; 13.2\% & 33cm; 25cm; 12.8\% & 32cm; 21cm; 16.4\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCM2PVJ & 3.0 | 4.5 | Mikro \\
    B & GC6QZ6S & 3.5 | 3.5 | Normal \\ 
    C & GCAO3UF & 1.0 | 3.0 | Klein \\ 
    D & GCGYAWD & 2.5 | 5.0 | Klein \\ 
    E & GCRBSIV & 4.0 | 1.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 446 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.2\times 10^{10}} - \ensuremath{9\times 10^{8}} \cdot 1.9^{-0.2 \cdot t + 3.2}
\end{equation*}
