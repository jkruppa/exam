...
\item \texttt{chickentype\_class.xlsx} % Clusteranalyse -> kann raus
\end{itemize}
...
\large
  \begin{tabular}{ccccc}
  \toprule
   $\boldsymbol{f_1}$  & $\boldsymbol{f_2}$ & $\boldsymbol{x_1}$ & $\boldsymbol{y_1}$ & $\boldsymbol{y_2}$ \\
  \midrule
  1  & 1 & 2.3 & 10.1 & 0 \\  
  1  & 1 & 4.1 & 13.1 & 0 \\ 
  1  & 1 & 5.7 & 16.5 & 1 \\ 
...
\begin{graybox}{}
\begin{center}
Zum Lösen der folgenden Aufgaben betrachten Sie die Variablen $f_1$, $f_2$ und $y_2$.
\end{center}
\end{graybox}
