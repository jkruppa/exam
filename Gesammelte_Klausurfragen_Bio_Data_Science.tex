...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.42, 0.03, 0.001, 0.02 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0017, 0.07, 0.005, 2e-04, 0.0033 und 0.0567. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.06, 1, 0.18, 0.006, 0.12 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0017, 0.07, 0.005, 2e-04, 0.0033 und 0.0567. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.06, 2.52, 0.18, 0.006, 0.12 und 2.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.06, 1, 0.18, 0.006, 0.12 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 14, 11, 17, 11 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12 +/- 3.25
\item [\textbf{B} \msquare] Es ergibt sich 14 +/- 1.275
\item [\textbf{C} \msquare] Es ergibt sich 13 +/- 1.275
\item [\textbf{D} \msquare] Es ergibt sich 13 +/- 2.55
\item [\textbf{E} \msquare] Es ergibt sich 13 +/- 6.5
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 29, 16, 14, 21, 30, 19, 26, 17, 14, 9 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 [15, 30]
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 14
\item [\textbf{C} \msquare] Es ergibt sich 19 [14, 29]
\item [\textbf{D} \msquare] Es ergibt sich 19 +/- 29
...
$y = \{16, 25, 19, 20, 21, 23, 22, 16, 21, 18, 19\}$. Berechnen Sie folgende
...
\begin{center}
$7.8, 9, 13.9, 8, 8.4, 7.2, 8.3, 10, 7.9, 9, 11.7, 9.5, 7.4, 9.2$
\end{center}
...
## t = 2.0456, df = 12, p-value = 0.06336
...
## t = -3.0059, df = 14, p-value = 0.009441
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.751683 -1.295936
## sample estimates:
...
## 
## data:  weight by group
## t = 5.4772, df = 4, p-value = 0.005408
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 39.61 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 71.75 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 58.584 29.2919  9.4057 0.00132
## Residuals 20 62.286  3.1143
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 126 126 101 102  89  87 141 133 139 159 157 152
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 142.35 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 137.41 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 182.4 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 1141.74 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2 161.525  80.762  5.0909 0.017690
## form       1  63.637  63.637  4.0114 0.060488
## dose:form  2 300.476 150.238  9.4704 0.001548
## Residuals 18 285.552  15.864
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## (Intercept)   15.400      1.669   9.230  3.3e-06
## trtB          -1.400      2.185  -0.641    0.536
## 
## Residual standard error: 3.731 on 10 degrees of freedom
## Multiple R-squared:  0.03945,	Adjusted R-squared:  -0.05661 
## F-statistic: 0.4107 on 1 and 10 DF,  p-value: 0.536
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -6.6535, df = 8, p-value = 0.0001602
...
Einflussvariablen ($x$) wurden erhoben: weight, rainfall und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.64 & 0 & 8.65 & 104.18 & 69.95 & 11\\
11.06 & 0 & 11.78 & 103.38 & 65.68 & 9\\
9.19 & 1 & 10.89 & 100.51 & 68.16 & 14\\
9.76 & 1 & 9.92 & 105.40 & 74.37 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -11.2530  -2.7075   0.0882   2.7636   6.2374 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 71.21799    3.10843  22.911  < 2e-16
## water       -0.20674    0.27304  -0.757 0.450730
## nematodes   -0.02724    0.12499  -0.218 0.827888
## light        3.02037    0.88220   3.424 0.000897
## 
## Residual standard error: 3.569 on 100 degrees of freedom
## Multiple R-squared:  0.1164,	Adjusted R-squared:  0.08993 
## F-statistic: 4.393 on 3 and 100 DF,  p-value: 0.006019
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & maxdepth & so4 & no3\\
\midrule
ISRAEL\_CR & 30 & 6260 & 133 & 13.77 & 2.41\\
LITTLE\_DEER\_CR & 38 & 8115 & 110 & 9.22 & 3.40\\
BEAR\_BR & 12 & 3333 & 83 & 7.74 & 5.34\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -12.017   -3.840   -2.017    1.254   16.567  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.306e+00  5.049e-01   4.567 3.35e-05
## acerage      3.598e-05  1.238e-05   2.905  0.00549
## maxdepth     8.265e-03  3.932e-03   2.102  0.04071
## so4         -2.188e-02  2.388e-02  -0.916  0.36408
## no3          2.253e-01  6.456e-02   3.490  0.00103
## 
## (Dispersion parameter for quasipoisson family taken to be 33.7497)
## 
##     Null deviance: 2258.0  on 53  degrees of freedom
## Residual deviance: 1409.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.386     0.430 0.668  
## 2 light           0.442     2.73  0.00634
## 3 nematodes       0.189    -2.01  0.0441
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9708 -0.5871 -0.1649  0.5237  3.5360 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  198.1   14.07   
##  subject  (Intercept) 3920.9   62.62   
##  Residual              707.8   26.60   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.374     26.432   7.657
## attitudepop  -19.639      5.845  -3.360
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0657917 0.1144631 0.6811672
## high 0.0657917 1.0000000 0.0012918 0.0268937
## low  0.1144631 0.0012918 1.0000000 0.2358743
## mid  0.6811672 0.0268937 0.2358743 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 13, 7, 7, 10 und 7!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 3, 17, 13, 5 und 13! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes freshmatter, grade und drymatter an drei verschiedenen Messterminen.
...
Seitenl{\"a}nge einer Pyramide betr{\"a}gt 34 K{\"o}nigsellen. Eine K{\"o}nigselle
misst 52.2cm.\\
...
\begin{enumerate}
\item Die K{\"o}nigspyramide von Meroe soll eine Seitenl{\"a}nge von 34
...
Sie haben den Vektor $A = \{-2, 17, 2\}$ und den Vektor $B = \{4, -4, 1\}$ gegeben.
