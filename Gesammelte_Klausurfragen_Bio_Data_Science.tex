...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.34, 0.89, 0.02, 0.01 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 1, 1, 0.12, 0.06 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.0567, 0.1483, 0.0033, 0.0017 und 0.035. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 2.04, 5.34, 0.12, 0.06 und 1.26. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.0567, 0.1483, 0.0033, 0.0017 und 0.035. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 1, 1, 0.12, 0.06 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 11, 16, 9 und 13.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.2 +/- 1.745
\item [\textbf{B} \msquare] Es ergibt sich 10.2 +/- 6.1
\item [\textbf{C} \msquare] Es ergibt sich 12.2 +/- 1.745
\item [\textbf{D} \msquare] Es ergibt sich 11.2 +/- 12.2
\item [\textbf{E} \msquare] Es ergibt sich 11.2 +/- 3.49
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 23, 40, 29, 18, 19, 38, 22, 18, 31, 14 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 28 [18, 38]
\item [\textbf{B} \msquare] Es ergibt sich 23 [18, 38]
\item [\textbf{C} \msquare] Es ergibt sich 28 +/- 18
\item [\textbf{D} \msquare] Es ergibt sich 23 +/- 38
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.94 liegt keine Overdispersion vor.
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.94 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\end{enumerate}
...
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.27, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.27, da es sich um ein Anteil handelt.
\end{enumerate}
...
\item [\textbf{C} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 0.08
\item [\textbf{D} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 0.08
\item [\textbf{E} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.28
\end{enumerate}
...
$y = \{15, 10, 15, 16, 19, 15, 19, 20, 19, 19, 15\}$. Berechnen Sie folgende
...
\begin{center}
$9.3, 11.2, 11, 11.1, 12.8, 9.3, 12.9, 12, 9.4, 14.6, 9.6, 9$
\end{center}
...
## t = -3.9168, df = 12, p-value = 0.002047
...
## 
## data:  drymatter by Fe
## t = -3.519, df = 10, p-value = 0.005548
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.885896 -1.771247
## sample estimates:
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 127 131 142 102 113 109 127 151 141 158 151 167
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 4.53 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 11.65 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  5.1955  2.5978   5.265 0.01173 *
## Residuals 27 13.3218  0.4934                  
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 202.54 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2433.09 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 105.61 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 710.6 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df Sum Sq Mean Sq  F value    Pr(>F)    
## supp       1  155.0  155.01  13.2628 0.0006077 ***
## dose       2 3295.6 1647.78 140.9817 < 2.2e-16 ***
## supp:dose  2  105.2   52.59   4.4997 0.0155789 *  
## Residuals 54  631.1   11.69                       
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
## -3.1429 -1.4643  0.3571  1.7143  2.8571 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  16.7143     0.8186  20.419 1.09e-10 ***
## trtB         11.4286     1.1576   9.872 4.11e-07 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.166 on 12 degrees of freedom
## Multiple R-squared:  0.8904,	Adjusted R-squared:  0.8812 
## F-statistic: 97.46 on 1 and 12 DF,  p-value: 4.114e-07
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: height, center und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & no3 & acerage & maxdepth & do2\\
\midrule
RED\_RUN & 32 & 2.09 & 3332 & 73 & 8.4\\
CARROLL\_BR & 23 & 2.77 & 3896 & 105 & 10.4\\
MORGAN\_RUN & 76 & 4.38 & 9765 & 130 & 9.3\\
SENECA\_CR & 23 & 1.58 & 18422 & 45 & 9.9\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.884  -4.255  -2.706   2.229  16.977  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)   
## (Intercept) 5.875e-01  1.447e+00   0.406  0.68660   
## no3         2.127e-01  8.325e-02   2.555  0.01376 * 
## acerage     2.885e-05  1.569e-05   1.839  0.07202 . 
## maxdepth    1.242e-02  4.562e-03   2.722  0.00897 **
## do2         1.353e-01  1.490e-01   0.908  0.36842   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 36.85573)
## 
##     Null deviance: 2377.2  on 53  degrees of freedom
## Residual deviance: 1564.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.363   -0.211   0.833 
## 2 nematodes       0.140    0.0809  0.936 
## 3 light           0.445    2.00    0.0458
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
8.48 & 0 & 7.62 & 99.87 & 70.15 & 7\\
10.60 & 0 & 9.47 & 100.12 & 68.04 & 8\\
11.71 & 1 & 11.05 & 103.74 & 74.13 & 12\\
10.41 & 0 & 8.18 & 98.57 & 68.21 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -12.0866  -1.8659   0.1649   2.3527   6.2789 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 70.30188    2.28491  30.768   <2e-16 ***
## light        1.02303    0.78129   1.309    0.194    
## water       -0.20817    0.22214  -0.937    0.351    
## nematodes    0.13697    0.09886   1.386    0.169    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.4 on 88 degrees of freedom
## Multiple R-squared:  0.03858,	Adjusted R-squared:  0.005802 
## F-statistic: 1.177 on 3 and 88 DF,  p-value: 0.3232
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0394 -0.5969 -0.1127  0.4704  3.3738 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  214.3   14.64   
##  subject  (Intercept) 4073.8   63.83   
##  Residual              690.0   26.27   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.335     26.945   7.509
## attitudepop  -18.786      5.772  -3.255
## 
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.0049134 0.0000057 0.8696478
## B 0.0049134 1.0000000 0.0218882 0.0032020
## C 0.0000057 0.0218882 1.0000000 0.0000035
## D 0.8696478 0.0032020 0.0000035 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 23, 40, 29, 18, 19, 38, 22, 18, 31, 14 und 51!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 23, 40, 29, 18, 19, 38, 22, 18, 31, 14 und 51! \textbf{(2 Punkte)}
