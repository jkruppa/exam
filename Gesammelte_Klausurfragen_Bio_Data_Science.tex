...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\blacksquare\!\square\!\square\!\square\!\square\!\square\!\square\!\blacksquare\!\square\!\blacksquare\!\square\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\item [\textbf{D} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Behandlungsbedingungen erklärt wird. Daher werden 22\% der Varianz erklärt.
...
In einer Studie zur Bewertung der Wirkung von Vitamin E auf das Zahnwachstum bei Kanarienvögel entstand folgende Abbildung. Der Versuch wurde an 62 Tieren durchgeführt, wobei jedes Tier eine von  drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Welche Aussage ist im Bezug auf eine zweifaktorielle ANOVA richtig?
...
Wie lautet der Mittelwert und Standardabweichung von $y$ mit 13, 6, 10, 5 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es berechnet sich 8.4 +/- 10.3
\item [\textbf{B} \msquare] Sie erhalten 8.4 +/- 1.605
\item [\textbf{C} \msquare] Es ergibt sich 8.4 +/- 3.21
\item [\textbf{D} \msquare] Es ergibt sich 9.4 +/- 1.605
\item [\textbf{E} \msquare] Es berechnet sich 9.4 +/- 10.3
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 20, 17, 22, 28, 20, 11, 21, 25, 25, 25 und 51.




\begin{enumerate}
\item [\textbf{A} \msquare] Sie erhalten 22 [18; 23]
\item [\textbf{B} \msquare] Es ergibt sich 22 +/- 20
\item [\textbf{C} \msquare] Es ergibt sich 22 [20; 25]
\item [\textbf{D} \msquare] Es berechnet sich 23 [21; 24]
\item [\textbf{E} \msquare] Sie erhalten 22 +/- 25
\end{enumerate} 
...
Der Mittelwert $\bar{y}$ und der Median $\tilde{y}$ unterscheiden sich in Ihren Feldexperiment zu Leistungssteigerung von Kartoffel.  Welche Aussage ist richtig?
...
Sie haben $n = 205$ Pflanzen geerntet und wollen sich nun die Verteilung der Pflanzen einmal in einem Histogramm anschauen. Welche Verteilung ist dargestellt?
...
Sie haben ein Feldexperiment mit Erbsen durchgeführt und wollen nun in einer simplen linearen Regression den Einfluss der $CO_2$-Konzentration in [$\mu g$] im Wasser auf den absoluten Proteingehalt in [$kg$] untersuchen. Sie erhalten einen $\beta_{CO_2}$ Koeffizienten von $1.1\times 10^{-5}$ und einen $p$-Wert mit $2e-04$. Welche Aussage zu der Signifikanz und dem Effekt ist richtig?
...
In einer Studie wollen Sie den Effektschätzer Risk ratio berechnen. Sie finden in Ihrem Experiment zur Behandlung von Klaueninfektionen bei Ziegen in 5 Tieren Erkrankung der Klauen vor. 12 Tiere sind gesund. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 2.4, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Der Anteil der Kranken wird berechnet. Da es sich um ein Anteil handelt ergibt sich ein Risk ratio von 0.29.
\item [\textbf{C} \msquare] Da es sich um ein Chancenverhältnis handelt ergibt sich ein Risk ratio von 3.4.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.42, 0.34, 0.89 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1, 1, 1 und 0.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1, 1, 1 und 0.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.084, 0.068, 0.178 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.084, 0.068, 0.178 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 2.1, 1.7, 4.45 und 0.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
Ein Versuch wurde in 9 Parzellen pro Gruppe durchgeführt. Die folgende Abbildung enthält die Daten aus diesem Versuch zur Bewertung der Wirkung des Mikronährstoff Sulfit auf den Ertrag in t/ha von Mango im Vergleich zu einer Kontrolle.  Welche Aussage ist richtig, wenn Sie einen t-Test rechnen?
...
\item [\textbf{D} \msquare] Nach Betrachtung des Barplots liegt kein signifikanter Unterschied vor. Der Effekt liegt bei -3.
\item [\textbf{E} \msquare] Es liegt ein signifikanter Unterschied vor. Der Effekt liegt bei -3.
\end{enumerate}
...
Mark steht vor einem ersten Problem, denn wenn es nach seiner Betreuerin geht, soll er in einem einem Feldexperiment Erdbeeren auswertet. Soweit eigentlich alles passend. Die Behandlung werden verschiedene Substrattypen ($torf$, $40p60n$ und $70p30n$) sein. In seiner Exceldatei wird er den Outcome ($Y$) \textit{Proteingehalt} als \textit{protein} aufnehmen. Vorab soll Mark aber eimal die folgenden Barplots seiner Betreuerin nachbauen, damit er den \Rlogo Code schonmal für später vorliegen hat. Damit geht das Problem schon los.
...
Anschauen, was andere vor einem gemacht haben, ist eine Möglichkeit schnell ans Ziel zu gelangen. Tina soll in ihrem Projektbericht Lauch untersuchen. Die Behandlung in ihrem Projektbericht werden verschiedene Düngestufen ($ctrl$, $low$ und $high$) sein. Erheben wird Tina als Endpunkt ($Y$) \textit{Proteingehalt} benannt als \textit{protein} in ihrer Exceldatei. Von ihrem Betreuer erhält sie nun folgende Abbildung von Boxplots, die sie erstmal zur Übung nachbauen soll, bevor sie mit dem eigentlichen Versuch beginnt. Anhand von Boxplots lässt sich eine Aussage über die Normalverteilung von $Y$ treffen.
...
In seiner Hausarbeit möchte Jonas gerne die Daten aus einem Versuch in einer Klimakammer mit Lauch in einem Histogramm darstellen. Das Histogramm erlaubt ihm dabei Rückschlüsse auf die Verteilung über den Endpunkt ($Y$) zu treffen. In seinem Experiment hat Jonas die seltsamen Verdickungen gezählt.

\begin{center}
Die seltsamen Verdickungen: 6, 2, 5, 4, 0, 3, 3, 6, 3, 6, 3, 4, 7, 2, 4, 1, 5, 5, 7, 3, 5, 2, 3, 6, 4, 1, 6, 8, 8, 3, 3, 2, 6, 2, 3, 3
\end{center}
...
In einem Gespräch mit ihrer Betreuerin wird Tina gebeten seine Daten aus einem Versuch in einer Klimakammer mit Lauch in einem Histogramm darzustellen. In ihrem Experiment hat er die mittleren Läsionen auf den Blättern erst fotographiert und dann ausgezählt. Laut ihrer Betreuerin soll das Histogramm helfen, die Verteilung der die mittleren Läsionen auf den Blättern zu bestimmen.

\begin{center}
Die mittleren Läsionen auf den Blättern: 9.5, 9.3, 8.5, 8.7, 12.3, 7.8, 11.8, 9.5, 8.5, 9.4, 11, 15.4, 8.6, 10.1, 12.2, 9.1, 10.5, 5.8, 10.8, 8.4, 9.3, 10.7
\end{center}
...
Jonas möchte gerne den Zusammenhang zwischen durchschnittlicher Regenwurmdichte [Anzahl/l] und Frischegewicht [kg/ha] im Kontext von Lauch herausfinden. Hierfür hat Jonas ein Gewächshausexperiment im Teuteburgerwald durchgeführt. Nach einigen unvorgesehenen Ereignissen hat er es geschafft folgende Datentabelle zu erstellen. Nun stellt sich die Frage für ihn, ob es überhaupt einen Zusammenhang zwischen den gemessenen Variablen gibt. Deshalb möchte Jonas als erstes eine explorative Datenanalyse durchführen.
...
Zwei kategoriale Variablen darzustellen ist nicht so einfach. Jonas hatte erst über einen Mittelwert nachgedacht, dann aber die Idee verworfen. In ein Gewächshausexperiment in der Uckermark hatte er sich zum einen die Behandlung Pestizideinsatz [ja/nein] und zum anderen die Messung Chlorophyllgehalt unter Zielwert [ja/nein] im Kontext von Lauch angeschaut. Jetzt möchte sein Betreuer erstmal die langen Tabellen mit ja/nein in einer explorativen Datenanalyse zusammengefasst bekommen. Sonst geht es bei seinem Projektbericht nicht weiter.
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  Testentscheidung & Richtige Entscheidung & H$_0$ beibehalten & $\alpha$-Fehler \\
  \end{tabular}
  \end{center}
...
Der t-Test. Jessica erschaudert. Ein mächtiges Werkzeug in den Händen desjenigen, der einen normalverteilten Messwert ($Y$) hat. Aber erstmal überhaupt den t-Test rechnen können. Wie sah das Experiment von Jessica überhaupt aus? Jessica hat ein Feldexperiment mit Lauch durchgeführt. Dabei wurde die Behandlung Bewässerungstypen ($low$ und $high$) an den Lauch getestet. Gemessen hat Jessica dann als Messwert Proteingehalt [g/kg]. Warum der Versuch in der Uckermark für ihren Projektbericht stattfinden musste, ist ihr bis heute ein Rätsel. Egal. Gibt es jetzt einen Zusammenhang zwischen der Behandlung und Proteingehalt [g/kg]?
...
Es gibt ja immer die Möglichkeit sich Hilfe zu holen. Das geht natürlich auch immer in einem Projektbericht. Deshalb arbeiten Nilufar und Paula gemeinsam an einem Projektbericht. Das macht dann auch die Analyse ihres Hauptversuches einfacher. Zwar hat jeder von ihnen noch ein Subthema, aber auch da kann man sich ja helfen. In dem Hauptversuch wurde Folgendes von den beiden gemacht. Nilufar und Paula haben sich Lauch angeschaut. Dabei geht um Zusammenhang zwischen Jäten ($Aussaat$ und $Ernte$) und Frischegewicht [kg/ha]. Jetzt sollen beide einen gepaarten t-Test rechnen.
...
'Mit dem R Paket \texttt{\{emmeans\}} können wir gleich die Gruppenvergleiche rechnen und uns das \textit{compact letter displac}' ausgeben lassen!', verkündet Steffen sichtlich stolz. 'Nach Meinung der Betreuerin soll es aber nur erstmal ein t-Test sein. Und die Ausgabe ist schon wirr genug.', merkt Mark an. Jessica und Mark sind bei Steffen um sich in \Rlogo helfen zu lassen. Die beiden waren 1 Monate im Emsland um einen Versuch mit Lauch in einem Versuch in einer Klimakammer durchzuführen. Ziel war es das Outcome ($Y$) Chlorophyllgehalt (SPAD-502Plus) [SPAD] zu bestimmen.
...
## t = 12.151, df = 18, p-value = 4.125e-10
...
Helfen Sie Steffen bei der Interpretation des t-Tests! Sonst geht es auch für Jessica und Mark nicht weiter.
...
\Rlogo ist schon ein tolles Programm, wenn man mit dem Ding umgehen kann. Super umgehen kann damit Jessica. Deshalb sind auch Steffen und Paula bei ihr um sich bei einem gemeinsamen Projekt helfen zu lassen. Beide arbeiten gemeinsam an einer Abschlussarbeit. In dem zu beschreibenden Versuch geht es im Oldenburger Land um einem Feldexperiment mit Lauch. Dabei ging darum herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Düngestufen ($ctrl$ und $high$) und dem Messwert Trockengewicht [kg/ha] gibt. Da der Messwert Trockengewicht [kg/ha] normalverteilt ist kann ein t-Test gerechnet werden.
...
Helfen Sie Jessica bei der Interpretation des t-Tests! Sonst geht es auch für Steffen und Paula nicht weiter.
...
Jonas und Tina sind bei Mark um sich Hilfe in \Rlogo zu holen. Die beiden hatten zwar schon erste Kontakte mit \Rlogo sind sich aber unsicher bei der Interpetierung der Ausgabe eines t-Tests für ihren gemeinsamen Versuch. In einem Projektbericht haben sie zusammen Lauch untersucht. Dabei ging es um den Zusammenhang zwischen der Behandlung Lüftungssystemen und Folientunneln ($ctrl$ und $tornado$) und dem Messwert Frischegewicht [kg/ha]. Der Versuch wurde in einem Freilandversuch im Teuteburgerwald durchgeführt. Nach der Betreuerin ist der Messwert Frischegewicht [kg/ha] normalverteilt und ein t-Test passt daher. Das wird jetzt nicht mehr angezweifel...
...
## t = 2.8198, df = 16, p-value = 0.01233
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##   3.386057 23.898943
## sample estimates:
...
In einem Experiment in einer Klimakammer wurde der Ertrag von Lauch unter drei verschiedenen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{group}  & 2 &  &  &  &  \strut\\
    \hline
   \textbf{error}  & 20 & 62.51 &  &  &  \strut\\
        \hline
   \textbf{total}  & 22 & 125.91 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Faktorstufen \textit{low}, \textit{neg} und
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 264.61 &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 & 128.83 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 21.578 10.7888  4.2428 0.02911
## Residuals 20 50.857  2.5429
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 8.12 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 436.62 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 150.71 &  &  &  \strut\\
    \hline
   \textbf{error}  & 32 & 298.39 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 57 H{"a}ngebauchschweinen durchgef{\"u}hrt, wobei
...
## Response: weight
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2  18.00   8.999  0.4434 0.648650
## form       1   1.44   1.439  0.0709 0.793066
## dose:form  2 300.05 150.026  7.3932 0.004531
## Residuals 18 365.27  20.293
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000369 0.0154530 0.5417281
## high 0.0000369 1.0000000 0.0000000 0.0002169
## low  0.0154530 0.0000000 1.0000000 0.0033046
## mid  0.5417281 0.0002169 0.0033046 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   77   \strut\\
    \hline
     &  93 &  52 &  145  \strut\\
  \end{tabular}
\end{center}
...
##  -1.80  -0.75  -0.20   1.20   1.40 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  17.6000     0.5916  29.749 1.77e-09
## waterB        5.2000     0.8367   6.215 0.000255
## 
## Residual standard error: 1.323 on 8 degrees of freedom
## Multiple R-squared:  0.8284,	Adjusted R-squared:  0.807 
## F-statistic: 38.63 on 1 and 8 DF,  p-value: 0.0002552
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.8284$ aus? \textbf{(2 Punkte)}
...
## t = -8.7075, df = 8, p-value = 2.361e-05
...
Einflussvariablen ($x$) wurden erhoben: P, N und weight. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
mit insgesamt 3 Leveln dar. Der zweite Faktor mit dem Feld
beinhaltet
4 Level. \\
...
$h_v$ von $6.5m$. Die hintere Seite des Schweinestall hat eine
...
\item Wenn Sie die 9 Blaubeerschalen gekauft haben, wie viele Aligatorbirnen zu je 0.99 EUR können Sie sich dann noch für 100 EUR leisten? \textbf{(1 Punkt)}
\end{enumerate}
...
\item Ein Kilo Salat benötigt 130l Wasser. Ein Salatkopf wiegt 310 - 530g.
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2022 blieben die Erträge von Blaubeeren mit \ensuremath{7.9\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge steigerte sich um 6.8\%. Die Exporte für Avocados fielen in dem gleichen Zeitraum um 21.2\% auf \ensuremath{2\times 10^{5}}t.
...
\midrule
sitting & 34cm; 18cm; 8.9\% & 25cm; 30cm; 3.5\% & 40cm; 23cm; 10.1\%\\
standing & 36cm; 29cm; 52.2\% & 41cm; 29cm; 54.1\% & 37cm; 21cm; 24.1\%\\
foraging incl. scratching & 38cm; 20cm; 1.8\% & 33cm; 29cm; 1.8\% & 27cm; 22cm; 1.8\%\\
walking & 28cm; 18cm; 0.6\% & 45cm; 27cm; 0.6\% & 30cm; 29cm; 0.9\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCGOSWU & 2.5 | 3.5 | Klein \\
    B & GCPEON9 & 3.5 | 3.0 | Mikro \\ 
    C & GCNRRLW & 4.0 | 4.5 | Normal \\ 
    D & GCJ9J7G & 3.0 | 2.0 | Normal \\ 
    E & GCTGXLH & 2.0 | 4.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 404 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.2\times 10^{10}} - \ensuremath{1.2\times 10^{9}} \cdot 1.9^{-0.1 \cdot t + 3.1}
\end{equation*}
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  8-mal-gefaltete, 0.5mm, 40-cm-Karton} durch
