...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.03, 0.21, 0.42 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.15, 1, 1 und 0.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.006, 0.042, 0.084 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.15, 1, 1 und 0.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.006, 0.042, 0.084 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.15, 1.05, 2.1 und 0.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 3, 4, 10 und 14.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8 +/- 4.53
\item [\textbf{B} \msquare] Es ergibt sich 7 +/- 10.25
\item [\textbf{C} \msquare] Es ergibt sich 8 +/- 2.265
\item [\textbf{D} \msquare] Es ergibt sich 9 +/- 2.265
\item [\textbf{E} \msquare] Es ergibt sich 8 +/- 20.5
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 19, 29, 30, 24, 21, 12, 11, 10, 14, 14 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 +/- 29
\item [\textbf{B} \msquare] Es ergibt sich 21 [12, 29]
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 12
\item [\textbf{D} \msquare] Es ergibt sich 19 +/- 12
\item [\textbf{E} \msquare] Es ergibt sich 19 [12, 29]
\end{enumerate}
...
\item [\textbf{C} \msquare] Der Begriff \textit{ordinary mean} beschreibt einen einzelnen Mittelwert eines Levels eines Faktors wohingegen der \textit{marginal mean} die unbedeutenden Mittelwerte beschreibt.
\item [\textbf{D} \msquare] Der Begriff \textit{ordinary mean} beschreibt gew{"o}hnliche Mittelwerte und wohingegen \textit{marginal mean} kleine Mittelwerte beschreibt.
...
Nachdem in einem Experiment die Daten $D$ erhoben haben, berechnen Sie den
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.14 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.14 liegt keine Overdispersion vor.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.01 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 1.33, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.75, da es sich um ein Anteil handelt.
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 11.38
\item [\textbf{B} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -3.37
...
\item [\textbf{E} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 11.38
\end{enumerate}
...
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 10
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 4
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.88 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 11.85 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 205.27 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2424.27 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 109.49 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 713.11 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 4.56144 2.280719 6.31246 0.0056343 **
## Residuals 27 9.75521 0.361304                     
## ---
...
Versuch wurde an 71 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: len
##           Df  Sum Sq  Mean Sq   F value               Pr(>F)    
## supp       1   44.90   44.901   3.09644             0.083169 .  
## dose       2 3213.07 1606.537 110.78955 < 0.0000000000000002 ***
## supp:dose  2   51.33   25.665   1.76987             0.178465    
## Residuals 65  942.55   14.501                                   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
Sie haben folgende Zahlenreihe $y$ vorliegen
$y = \{21, 17, 22, 19, 19, 12, 13\}$. Berechnen Sie folgende
...
Einflussvariablen ($x$) wurden erhoben: dosage, variety und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
CARROLL\_BR & 23 & 12.79 & 3896 & 10.4 & 18.4\\
MAINSTEM\_PATUXENT\_R & 239 & 5.95 & 8636 & 8.4 & 18.1\\
LITTLE\_FALLS & 84 & 5.69 & 1600 & 10.2 & 19.5\\
DEER\_CR & 26 & 6.36 & 8297 & 9.9 & 19.1\\
\bottomrule
\end{tabular}
\end{table}
...
## -9.4743  -4.1400  -2.5464   1.0991  22.7650  
## 
## Coefficients:
##                 Estimate   Std. Error t value Pr(>|t|)  
## (Intercept) -0.022867857  2.088397758 -0.0109  0.99131  
## so4         -0.007982949  0.027339272 -0.2920  0.77152  
## acerage      0.000044198  0.000017592  2.5124  0.01533 *
## do2          0.204036978  0.158305172  1.2889  0.20349  
## temp         0.083461193  0.055951587  1.4917  0.14220  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 59.726714)
## 
##     Null deviance: 2380.52  on 53  degrees of freedom
## Residual deviance: 1914.36  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.42     0.166    0.868
## 2 light           0.572    1.56     0.119
## 3 water           0.142   -0.0704   0.944
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
9.35 & 1 & 9.14 & 96.90 & 68.54 & 10\\
9.05 & 1 & 13.20 & 97.55 & 66.68 & 9\\
11.60 & 1 & 11.66 & 102.45 & 72.16 & 11\\
9.15 & 0 & 11.90 & 100.43 & 67.28 & 16\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -4.12907 -1.35181  0.05521  1.39401  4.09890 
## 
## Coefficients:
##              Estimate Std. Error t value             Pr(>|t|)    
## (Intercept) -0.159236   7.685790 -0.0207             0.983518    
## Fe           0.735256   0.076493  9.6121 0.000000000000002507 ***
## light        1.142874   0.497513  2.2972             0.024010 *  
## P           -0.410490   0.154641 -2.6545             0.009444 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.1036 on 87 degrees of freedom
## Multiple R-squared:  0.53866,	Adjusted R-squared:  0.52276 
## F-statistic: 33.861 on 3 and 87 DF,  p-value: 0.000000000000013488
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -6.44444 -2.33333  0.55556  3.30556  4.00000 
## 
## Coefficients:
##             Estimate Std. Error t value      Pr(>|t|)    
## (Intercept)  18.0000     1.5928 11.3008 0.00000009412 ***
## trtB          7.4444     1.9866  3.7474      0.002784 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.5616 on 12 degrees of freedom
## Multiple R-squared:  0.53922,	Adjusted R-squared:  0.50082 
## F-statistic: 14.043 on 1 and 12 DF,  p-value: 0.0027843
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.33666 -0.60078 -0.10352  0.69211  3.39713 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  225.99  15.033  
##  subject  (Intercept) 4062.11  63.735  
##  Residual              688.04  26.230  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 202.2563    26.9385  7.5081
## attitudepop -20.1518     5.7634 -3.4965
## 
...
\midrule
A & 15.57 & 16 & 14 & 18 & 14.5 & 16.0 & 1.95\\
B & 14.57 & 14 & 10 & 19 & 13.0 & 16.5 & 9.29\\
C & 8.86 & 10 & 3 & 12 & 8.0 & 10.5 & 8.81\\
D & 13.57 & 15 & 6 & 19 & 12.0 & 15.5 & 17.29\\
\bottomrule
\end{tabular}
\end{table}
...
## t = 1.04475, df = 14, p-value = 0.31384
...
## t = -2.86122, df = 14, p-value = 0.012569
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -8.4980800 -1.2162057
## sample estimates:
...
## t = -4.48359, df = 16, p-value = 0.00037609
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -6.8731341 -2.4601993
## sample estimates:
...
## t = 5.66667, df = 4, p-value = 0.0047825
