...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.02, 0.34, 0.21, 0.001 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1483, 0.0033, 0.0567, 0.035, 2e-04 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 1, 1, 0.006 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 5.34, 0.12, 2.04, 1.26, 0.006 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
...
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1483, 0.0033, 0.0567, 0.035, 2e-04 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 7, 20, 2 und 17.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.6 +/- 28.65
\item [\textbf{B} \msquare] Es ergibt sich 10.6 +/- 57.3
\item [\textbf{C} \msquare] Es ergibt sich 11.6 +/- 3.785
\item [\textbf{D} \msquare] Es ergibt sich 10.6 +/- 7.57
\item [\textbf{E} \msquare] Es ergibt sich 10.6 +/- 3.785
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 16, 17, 17, 16, 27, 45, 26, 13, 26, 2 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 16
\item [\textbf{B} \msquare] Es ergibt sich 17 +/- 27
\item [\textbf{C} \msquare] Es ergibt sich 23 [17, 28]
\item [\textbf{D} \msquare] Es ergibt sich 17 [16, 27]
\item [\textbf{E} \msquare] Es ergibt sich 17 +/- 16
\end{enumerate} 
...
$y = \{18, 18, 20, 15, 19, 14, 17\}$. Berechnen Sie folgende
...
\begin{center}
$9.8, 10.1, 10.1, 11.2, 10.4, 11.7, 10.8, 7.5, 6.7, 8.2, 9, 9.5$
\end{center}
...
## t = 2.3046, df = 10, p-value = 0.04391
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##   0.1753487 10.3960799
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 11.56 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 82.44 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 76.544  38.272  10.017 0.0009682
## Residuals 20 76.413   3.821
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1]  95 123 113  97 109  89 138 143 144 166 133 155
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 34.7 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 19.6 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 332.26 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 215.7 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
jedes Tier eine von drei Selen-Dosen $dose$ ($0.5$ ng/Tag, $1$ ng/Tag und $15$ ng/Tag)
...
## Response: weight
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  42.33   21.17  1.2873   0.30024
## form       1 489.04  489.04 29.7439 3.515e-05
## dose:form  2 260.96  130.48  7.9361   0.00338
## Residuals 18 295.95   16.44
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Skizzieren Sie eine 2x2 Tabelle mit
  $n = 42$ Pflanzen in dem
  \textit{vermutlich} die Nullhypothese nicht abgelehnt werden kann!
  \textbf{(1 Punkt)}
\end{enumerate} 
\clearpage
% -----------------------------------------------------------------------
...
## -4.444 -1.444  0.300  1.556  3.556 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.200      1.133  15.181 3.39e-09
## waterB        -4.756      1.413  -3.365  0.00562
## 
## Residual standard error: 2.533 on 12 degrees of freedom
## Multiple R-squared:  0.4855,	Adjusted R-squared:  0.4427 
## F-statistic: 11.33 on 1 and 12 DF,  p-value: 0.005619
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -3.6269, df = 8, p-value = 0.006715
...
Einflussvariablen ($x$) wurden erhoben: weight, block und variety. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.84 & 1 & 6.95 & 98.62 & 73.11 & 9\\
8.87 & 0 & 12.19 & 96.63 & 66.24 & 9\\
7.07 & 0 & 11.67 & 97.41 & 67.82 & 11\\
9.18 & 0 & 12.57 & 98.20 & 70.83 & 15\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.7329 -1.3444  0.1509  1.3555  5.4330 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -10.01179    6.09501  -1.643    0.104
## Fe            0.85056    0.05989  14.202  < 2e-16
## light         0.18344    0.41977   0.437    0.663
## P            -0.49311    0.12042  -4.095 8.48e-05
## 
## Residual standard error: 1.994 on 102 degrees of freedom
## Multiple R-squared:  0.6871,	Adjusted R-squared:  0.6779 
## F-statistic: 74.66 on 3 and 102 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & maxdepth & temp & acerage\\
\midrule
NORTHWEST\_BR & 6 & 8.2 & 63 & 20.8 & 8735\\
OWENS\_CR & 80 & 8.6 & 79 & 21.8 & 9961\\
LITTLE\_PAINT\_BR & 63 & 9.4 & 34 & 17.5 & 5794\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -9.0590  -3.2736  -0.7603   1.5088   7.4320  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.294e+00  1.245e+00  -1.842 0.071471
## do2          3.976e-01  9.518e-02   4.177 0.000121
## maxdepth     6.444e-03  3.560e-03   1.810 0.076425
## temp         6.173e-02  2.962e-02   2.084 0.042411
## acerage      5.051e-05  9.308e-06   5.426 1.77e-06
## 
## (Dispersion parameter for quasipoisson family taken to be 14.34161)
## 
##     Null deviance: 1421.73  on 53  degrees of freedom
## Residual deviance:  688.44  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.368    -0.629   0.529
## 2 nematodes       0.127     1.03    0.303
## 3 light           0.431     0.243   0.808
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2804 -0.6115 -0.0628  0.4943  3.4282 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  223.7   14.96   
##  subject  (Intercept) 4048.9   63.63   
##  Residual              686.7   26.20   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.938     26.891   7.509
## attitudepop  -21.033      5.758  -3.653
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0024190 0.1768739 0.0000089
## high 0.0024190 1.0000000 0.0647529 0.0559303
## low  0.1768739 0.0647529 1.0000000 0.0004680
## mid  0.0000089 0.0559303 0.0004680 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 10, 15, 10, 10 und 7!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 17, 15, 11, 9 und 6! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes drymatter, pigs und Fe an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCSA00Z & 5.0 | 1.5 | Mikro \\
    B & GCINCNT & 3.5 | 3.5 | Normal \\ 
    C & GCAY49W & 1.0 | 1.0 | Mikro \\ 
    D & GCSZL0C & 4.0 | 2.0 | Klein \\ 
    E & GCNOFYB & 2.5 | 2.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 542 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{6, 12, 10\}$ und den Vektor $B = \{2, -1, 4\}$ gegeben.
