...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.001, 0.01 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.36, 0.004, 0.04 und 1.68. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.004, 0.04 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 3e-04, 0.0025 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.004, 0.04 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 3e-04, 0.0025 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 10, 11, 8 und 9.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.4 +/- 1.3
\item [\textbf{B} \msquare] Es ergibt sich 9.4 +/- 1.14
\item [\textbf{C} \msquare] Es ergibt sich 8.4 +/- 0.65
\item [\textbf{D} \msquare] Es ergibt sich 9.4 +/- 0.57
\item [\textbf{E} \msquare] Es ergibt sich 10.4 +/- 0.57
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 11, 14, 16, 23, 20, 25 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 [15, 26]
\item [\textbf{B} \msquare] Es ergibt sich 20 [14, 25]
\item [\textbf{C} \msquare] Es ergibt sich 20 +/- 25
...
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.46, da es sich um ein Anteil handelt.
...
$y = \{14, 15, 21, 15, 14, 13, 13, 22, 20, 19, 14\}$. Berechnen Sie folgende
...
\begin{center}
$11, 10.4, 11.6, 8.9, 9.9, 6.1, 10.2, 8.4, 11.6, 8.4, 8.6, 9.7, 12.4, 10.2$
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 60.1 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 48.86 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  4.889  2.4444  0.9098 0.4172
## Residuals 22 59.111  2.6869
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 255.34 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 100.19 &  &  &  \strut\\
    \hline
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2   4.99    2.49  0.1487    0.8628
## form       1   5.53    5.53  0.3298    0.5729
## dose:form  2 883.27  441.64 26.3508 4.494e-06
## Residuals 18 301.68   16.76
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -3.6000 -1.5611 -0.4444  1.3056  5.4000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  14.4444     0.8789  16.435 1.36e-09
## waterB       -3.8444     1.4706  -2.614   0.0226
## 
## Residual standard error: 2.637 on 12 degrees of freedom
## Multiple R-squared:  0.3628,	Adjusted R-squared:  0.3097 
## F-statistic: 6.834 on 1 and 12 DF,  p-value: 0.02263
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.3628$ aus? \textbf{(2 Punkte)}
...
## t = 7.7091, df = 8, p-value = 5.696e-05
...
Einflussvariablen ($x$) wurden erhoben: weight, N und block. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.08 & 0 & 10.93 & 94.51 & 66.69 & 13\\
10.47 & 0 & 9.20 & 107.77 & 78.08 & 13\\
12.34 & 0 & 11.07 & 101.37 & 71.60 & 15\\
10.01 & 1 & 12.50 & 102.26 & 72.03 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.0577 -1.5661 -0.2914  1.3948  4.3875 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -18.38664    7.92007  -2.322  0.02271
## Fe            0.92779    0.07655  12.121  < 2e-16
## nematodes     0.12885    0.07948   1.621  0.10875
## P            -0.53292    0.19357  -2.753  0.00725
## 
## Residual standard error: 2.254 on 83 degrees of freedom
## Multiple R-squared:  0.6465,	Adjusted R-squared:  0.6337 
## F-statistic:  50.6 on 3 and 83 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & maxdepth & acerage & temp & no3\\
\midrule
CONOWINGO\_CR & 112 & 65 & 27350 & 24.1 & 6.95\\
LITTLE\_GUNPOWDER\_R & 3 & 85 & 15305 & 17.5 & 2.60\\
TUSCARORA\_CR & 38 & 90 & 10274 & 15.0 & 5.45\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.746  -4.268  -1.787   1.607  13.920  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.084e+00  8.316e-01   1.304 0.198428
## maxdepth    9.978e-03  4.170e-03   2.393 0.020601
## acerage     3.478e-05  1.207e-05   2.881 0.005869
## temp        4.676e-02  3.540e-02   1.321 0.192680
## no3         2.132e-01  6.071e-02   3.513 0.000963
## 
## (Dispersion parameter for quasipoisson family taken to be 34.16897)
## 
##     Null deviance: 2495.7  on 53  degrees of freedom
## Residual deviance: 1543.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.64       1.21   0.226
## 2 light           0.538      1.62   0.105
## 3 water           0.164     -1.58   0.114
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0358 -0.6986 -0.1150  0.5373  3.3496 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  225.0   15.00   
##  subject  (Intercept) 4087.6   63.93   
##  Residual              645.9   25.42   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.939     26.996   7.480
## attitudepop  -20.364      5.584  -3.647
## 
...
\begin{verbatim}
##           ctrl      high low       mid
## ctrl 1.0000000 0.0033782   0 0.8643058
## high 0.0033782 1.0000000   0 0.0052692
## low  0.0000000 0.0000000   1 0.0000000
## mid  0.8643058 0.0052692   0 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 1, 11, 5, 12 und 7!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 13, 3, 2, 13 und 11! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes freshmatter, P und leaf an zwei verschiedenen Messterminen.
...
\item $i$ dem Verhalten: (1) sitting, (2) walking, (3)
  drinking/eating und (4) dustbathing.
\end{itemize}
...
\midrule
sitting & 36cm; 20cm; 50.1\% & 42cm; 30cm; 50.1\% & 34cm; 21cm; 24.1\%\\
walking & 37cm; 19cm; 4.1\% & 33cm; 19cm; 5.2\% & 25cm; 30cm; 1.8\%\\
drinking/eating & 35cm; 29cm; 8.1\% & 39cm; 29cm; 1.2\% & 27cm; 30cm; 1.2\%\\
dustbathing & 34cm; 24cm; 18.1\% & 44cm; 26cm; 12.8\% & 37cm; 24cm; 12.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCTS2UO & 3.5 | 5.0 | Klein \\
    B & GCL7UKT & 2.0 | 4.5 | Klein \\ 
    C & GCI9Y5Z & 4.5 | 4.0 | Normal \\ 
    D & GC7GYUR & 2.5 | 2.0 | Mikro \\ 
    E & GCAFQZV & 5.0 | 1.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 745 n. Chr. f{\"u}r den neuen Lehnsherren
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  4-mal-gefaltete, 0.7mm, 60-cm-Karton} durch
...
Sie haben den Vektor $A = \{1, 8, -7\}$ und den Vektor $B = \{6, 3, 5\}$ gegeben.
