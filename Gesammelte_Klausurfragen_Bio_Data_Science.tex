...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.42, 0.02, 0.01, 0.89 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.18, 1, 0.12, 0.06, 1 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.18, 1, 0.12, 0.06, 1 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.07, 0.0033, 0.0017, 0.1483 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.18, 2.52, 0.12, 0.06, 5.34 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.07, 0.0033, 0.0017, 0.1483 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 10, 9, 11 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.6 +/- 1.67
\item [\textbf{B} \msquare] Es ergibt sich 9.6 +/- 0.835
\item [\textbf{C} \msquare] Es ergibt sich 8.6 +/- 1.4
\item [\textbf{D} \msquare] Es ergibt sich 10.6 +/- 0.835
\item [\textbf{E} \msquare] Es ergibt sich 9.6 +/- 2.8
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 17, 11, 30, 9, 24, 12, 19, 19, 25, 13 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 [12, 25]
\item [\textbf{B} \msquare] Es ergibt sich 19 +/- 12
\item [\textbf{C} \msquare] Es ergibt sich 19 +/- 25
\item [\textbf{D} \msquare] Es ergibt sich 21 +/- 12
\item [\textbf{E} \msquare] Es ergibt sich 21 [13, 26]
\end{enumerate} 
...
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.27, da es sich um ein Anteil handelt.
\end{enumerate}
...
$y = \{20, 19, 20, 17, 20, 20, 19, 18, 19, 19, 21\}$. Berechnen Sie folgende
...
Nach einem Gew{\"a}chshausexperiment mit drei Substrattypen ($torf$, $40+60$ und $70+30$) als Behandlung 
...
\begin{center}
$9.1, 16.2, 8.4, 9.9, 6.6, 8.7, 10.8, 9.4, 6.9, 9.1, 10.9, 10.9, 12.3, 7.2, 12.9$
\end{center}
...
Nach einem Feldexperiment mit zwei D{"u}ngestufen ($ctrl$ und $high$) ergibt sich die
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 64.53 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 128.83 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 136.095  68.048  24.638 7.026e-06
## Residuals 18  49.714   2.762
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 123 111 128  92 102 110 148 154 121 160 145 155
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 0.77 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 505 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 56.83 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 351.63 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2  83.154  41.577  2.4795 0.1119090
## form       1 282.215 282.215 16.8304 0.0006685
## dose:form  2 105.367  52.683  3.1419 0.0675476
## Residuals 18 301.827  16.768
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -6.8889 -2.5722  0.1556  2.1111  6.1111 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   15.889      1.201  13.234 1.61e-08
## waterB        10.911      2.009   5.431 0.000152
## 
## Residual standard error: 3.602 on 12 degrees of freedom
## Multiple R-squared:  0.7108,	Adjusted R-squared:  0.6867 
## F-statistic: 29.49 on 1 and 12 DF,  p-value: 0.0001523
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7108$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, block und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.38 & 0 & 9.77 & 100.93 & 68.80 & 9\\
10.17 & 1 & 11.36 & 97.41 & 67.53 & 10\\
11.82 & 0 & 9.13 & 95.71 & 63.87 & 5\\
8.47 & 1 & 9.09 & 99.84 & 70.19 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.5580 -1.2463 -0.0205  1.4938  5.0798 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -4.80314    7.35717  -0.653   0.5155
## nematodes   -0.03004    0.06297  -0.477   0.6344
## Fe           0.78568    0.07218  10.885   <2e-16
## P           -0.39134    0.15810  -2.475   0.0152
## 
## Residual standard error: 2.156 on 91 degrees of freedom
## Multiple R-squared:  0.5735,	Adjusted R-squared:  0.5594 
## F-statistic: 40.79 on 3 and 91 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & acerage & no3 & maxdepth\\
\midrule
HAY\_MEADOW\_BR & 5 & 9.5 & 639 & 3.53 & 26\\
LITTLE\_HUNTING\_CR & 18 & 9.5 & 7121 & 0.51 & 58\\
CONOWINGO\_CR & 112 & 8.5 & 27350 & 6.95 & 65\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.408  -4.242  -2.421   1.957  17.255  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.789e-01  1.365e+00   0.131  0.89627
## do2         1.685e-01  1.322e-01   1.274  0.20853
## acerage     2.904e-05  1.336e-05   2.174  0.03455
## no3         2.238e-01  7.214e-02   3.102  0.00318
## maxdepth    1.288e-02  4.298e-03   2.996  0.00428
## 
## (Dispersion parameter for quasipoisson family taken to be 35.13117)
## 
##     Null deviance: 2404.6  on 53  degrees of freedom
## Residual deviance: 1503.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.59       1.25   0.212
## 2 nematodes       0.153      1.05   0.295
## 3 water           0.157     -1.55   0.121
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1545 -0.5554 -0.1259  0.6240  3.3305 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  241.5   15.54   
##  subject  (Intercept) 4120.5   64.19   
##  Residual              640.0   25.30   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.458     27.138   7.497
## attitudepop  -21.591      5.559  -3.884
## 
...
\begin{verbatim}
##           ctrl  high       low       mid
## ctrl 1.0000000 0e+00 0.0003391 0.1232781
## high 0.0000000 1e+00 0.0000000 0.0000002
## low  0.0003391 0e+00 1.0000000 0.0000035
## mid  0.1232781 2e-07 0.0000035 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, 12, 12, 10 und 9!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 14, 4, 12, 14 und 11! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes Fe, grade und drymatter an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCY25OM & 4.0 | 2.5 | Normal \\
    B & GCONP7I & 3.0 | 1.0 | Mikro \\ 
    C & GCP7OGV & 5.0 | 4.5 | Normal \\ 
    D & GCCADFX & 1.0 | 3.0 | Mikro \\ 
    E & GCBPZ9E & 2.5 | 2.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 535 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{-11, 16, 19\}$ und den Vektor $B = \{3, 4, 4\}$ gegeben.
