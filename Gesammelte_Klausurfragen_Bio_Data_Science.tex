...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.03, 0.21, 0.89, 0.01 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0033, 0.005, 0.035, 0.1483, 0.0017 und 0.0567. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.18, 1.26, 5.34, 0.06 und 2.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
...
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0033, 0.005, 0.035, 0.1483, 0.0017 und 0.0567. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 9, 16, 14 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.4 +/- 5.9
\item [\textbf{B} \msquare] Es ergibt sich 11.4 +/- 1.72
\item [\textbf{C} \msquare] Es ergibt sich 11.4 +/- 3.44
\item [\textbf{D} \msquare] Es ergibt sich 11.4 +/- 11.8
\item [\textbf{E} \msquare] Es ergibt sich 12.4 +/- 1.72
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 7, 24, 15, 35, 23, 18 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 15
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 35
\item [\textbf{C} \msquare] Es ergibt sich 23 +/- 15
\item [\textbf{D} \msquare] Es ergibt sich 23 [15, 35]
\item [\textbf{E} \msquare] Es ergibt sich 23 [16, 36]
\end{enumerate} 
...
$y = \{11, 14, 11, 17, 19, 14, 15\}$. Berechnen Sie folgende
...
\begin{center}
$9.8, 9.6, 8.4, 11.7, 11, 8.7, 13.7, 8.5, 6.1, 9, 8.8, 6.6, 12.3, 7.4, 8.1$
\end{center}
...
## t = -1.9746, df = 10, p-value = 0.07656
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.3784612  0.2641755
## sample estimates:
...
## trt        2 32.453  16.226  4.0841 0.03256
## Residuals 20 79.460   3.973
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 0.17 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 274.52 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 149.8 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 269.17 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 701.81  350.91 18.3054 4.591e-05
## form       1  24.26   24.26  1.2658    0.2753
## dose:form  2  27.95   13.97  0.7289    0.4961
## Residuals 18 345.05   19.17
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.1111 -1.5556 -0.1111  1.4444  5.8889 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  18.1111     0.8625  21.000 4.51e-13
## waterB        7.4444     1.2197   6.104 1.52e-05
## 
## Residual standard error: 2.587 on 16 degrees of freedom
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.6995$ aus? \textbf{(2 Punkte)}
...
## t = -3.8262, df = 8, p-value = 0.005045
...
Einflussvariablen ($x$) wurden erhoben: center, height und weight. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.66 & 0 & 12.57 & 98.81 & 68.76 & 5\\
8.22 & 0 & 10.31 & 99.58 & 75.44 & 7\\
9.48 & 0 & 13.00 & 94.93 & 62.49 & 11\\
12.24 & 1 & 10.46 & 106.43 & 76.05 & 13\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.7760 -1.5046 -0.2693  1.5757  5.9051 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -3.09509    6.39682  -0.484    0.629
## light        0.59955    0.47069   1.274    0.206
## Fe           0.73834    0.06302  11.716   <2e-16
## water       -0.10880    0.13992  -0.778    0.439
## 
## Residual standard error: 2.31 on 107 degrees of freedom
## Multiple R-squared:  0.5719,	Adjusted R-squared:  0.5599 
## F-statistic: 47.65 on 3 and 107 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & do2 & so4 & maxdepth\\
\midrule
LITTLE\_HUNTING\_CR & 18 & 7121 & 9.5 & 7.41 & 58\\
BIG\_BR & 72 & 4790 & 9.4 & 5.65 & 91\\
MORGAN\_RUN & 76 & 9765 & 9.3 & 5.74 & 130\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -8.9441  -4.6242  -1.7604   0.6524  20.4793  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 6.030e-03  1.611e+00   0.004 0.997029
## acerage     1.600e-05  1.769e-05   0.905 0.370144
## do2         2.046e-01  1.612e-01   1.269 0.210544
## so4         1.475e-02  2.904e-02   0.508 0.613922
## maxdepth    1.887e-02  5.255e-03   3.591 0.000761
## 
## (Dispersion parameter for quasipoisson family taken to be 42.48724)
## 
##     Null deviance: 2372.8  on 53  degrees of freedom
## Residual deviance: 1581.0  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.384    -0.386   0.700
## 2 light           0.464     1.28    0.202
## 3 nematodes       0.155     0.305   0.760
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1737 -0.5699 -0.1314  0.5385  3.1706 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  210.7   14.52   
##  subject  (Intercept) 4133.1   64.29   
##  Residual              675.6   25.99   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.807     27.112   7.480
## attitudepop  -17.630      5.711  -3.087
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.2090737 0.2509650 0.0000134
## high 0.2090737 1.0000000 0.0198863 0.0000003
## low  0.2509650 0.0198863 1.0000000 0.0003842
## mid  0.0000134 0.0000003 0.0003842 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 13, 6, 11, 18 und 3!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 12, 11, 5, 12 und 13! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes P, freshmatter und leaf an zwei verschiedenen Messterminen.
...
\midrule
wingflapping & 31cm; 24cm; 2.1\% & 38cm; 29cm; 2.1\% & 39cm; 24cm; 3.5\%\\
walking & 40cm; 19cm; 3.6\% & 28cm; 25cm; 6.3\% & 47cm; 26cm; 3.6\%\\
preening & 31cm; 23cm; 7.3\% & 39cm; 20cm; 1.2\% & 36cm; 33cm; 0.1\%\\
drinking/eating & 38cm; 29cm; 13.2\% & 27cm; 28cm; 14.2\% & 41cm; 30cm; 16.4\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCZ3OPX & 2.5 | 5.0 | Mikro \\
    B & GCLNGKY & 1.5 | 2.0 | Mikro \\ 
    C & GC4YH7M & 2.0 | 4.0 | Normal \\ 
    D & GC23NTF & 1.0 | 1.0 | Normal \\ 
    E & GCGEMIL & 3.0 | 4.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 381 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{1, -11, 11\}$ und den Vektor $B = \{11, -2, 3\}$ gegeben.
