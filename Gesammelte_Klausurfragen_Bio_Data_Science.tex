...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\square\!\blacksquare\!\square\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\square\!\square\!\square\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\square\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\item [\textbf{C} \msquare] Es werden 79\% der Varianz durch die Behandlung erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der von den unterschiedlichen Behandlungsbedingungen nicht erklärt wird.
\item [\textbf{D} \msquare] Es werden 21\% der Varianz durch den Versuch erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der durch Fehler in der Versuchsdurchführung entsteht.
\item [\textbf{E} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Behandlungsbedingungen erklärt wird. Daher werden 21\% der Varianz erklärt.
\end{enumerate} 
...
Ein Versuch wurde an 66 Tieren durchgeführt, wobei jedes Tier eine von drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Die folgende Abbildung enthält die Daten aus diesem Versuch zur Bewertung der Wirkung von Vitamin D auf das Zahnwachstum bei Kanarienvögel.  Welche Aussage ist richtig, wenn Sie eine zweifaktorielle ANOVA rechnen?
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 16, 9, 13 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Sie erhalten 11.8 +/- 1.385
\item [\textbf{B} \msquare] Es berechnet sich 12.8 +/- 7.7
\item [\textbf{C} \msquare] Sie erhalten 11.8 +/- 1.66
\item [\textbf{D} \msquare] Es ergibt sich 12.8 +/- 1.385
\item [\textbf{E} \msquare] Es berechnet sich 11.8 +/- 2.77
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 24, 5, 6, 15, 27, 20 und 63.




\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 20 [6; 27]
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 6
\item [\textbf{C} \msquare] Sie erhalten 20 [4; 25]
\item [\textbf{D} \msquare] Es berechnet sich 21 [7; 26]
...
\item [\textbf{B} \msquare] Histogramm
...
Sie haben $n = 203$ Pflanzen geerntet und wollen sich nun die Verteilung der Pflanzen einmal in einem Histogramm anschauen. Welche Verteilung ist dargestellt?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Wenn ein kausales Modell gerechnet werden soll dann kann dies auf dem gesamten Datensatz geschehen. Das Ziel ist es einen Zusammenhang von $X$ auf $Y$ zu modellieren. Wie wirken sich die Einflussvariablen $X$ auf den gemessenen Endpunkt $Y$ aus?
...
\item [\textbf{B} \msquare] Wir betrachten die Gerade. Wenn die Punkte einigermaßen gleichmäßig um die Gerade verteilt liegen, dann gehen wir von normalverteilten Residuen aus. Wir können hier von normalverteilten Residuen ausgehen.
...
\item [\textbf{B} \msquare] Manchmal ist die Einheit der Einflussvariable $X$ zu groß gewählt, so dass der Ansteig von 1 Einheit in $X$ zu einer zu großen Änderung in $y$ führt. Daher kann der Effekt $\beta_{Fe_3O_4}$ sehr klein wirken, da der p-Wert wird auf einer einheitslosen Teststatistik bestimmt wird.
\item [\textbf{C} \msquare] Wenn der Effekt $\beta_{Fe_3O_4}$ winzig ist, dann kann es an einer falsch gewählten Einheit liegen. Der Anstieg von einer Einheit in $X$ führt ja zu einer Änderung von $\beta_{Fe_3O_4}$ in $x$. Wir müssen daher die Einheit von $y$ entsprechend anpassen.
...
Neben der Mittelwertsdifferenz als Effektschätzer bei normalverteilten Endpunkten wird auch häufig der Effektschätzer Risk ratio bei binären Endpunkten verwendet. Welche Aussage über den Effektschätzer Risk ratio ist im folgenden Beispiel zur Behandlung von Klaueninfektionen bei Kühen richtig? Dabei sind 5 Tiere krank und 12 Tiere sind gesund.



\begin{enumerate}
\item [\textbf{A} \msquare] Das Verhältnis von Chancen Risk ratio ergibt ein Chancenverhältnis von 0.42.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.29, da es sich um eine Chancenverhältnis handelt.
\item [\textbf{C} \msquare] Das Verhältnis der Anteile Risk ratio ergibt ein Anteilsverhältnis von 0.29. Wir sind am Anteil der Kranken interessiert.
\item [\textbf{D} \msquare] Der Anteil der Gesunden wird berechnet. Da es sich um ein Anteil handelt ergibt sich ein Risk ratio von 0.29.
\item [\textbf{E} \msquare] Da es sich um ein Chancenverhältnis handelt ergibt sich ein Risk ratio von 3.4.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.03, 0.01 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.04 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.105, 0.0075, 0.0025 und 0.2225. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.68, 0.12, 0.04 und 3.56. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.105, 0.0075, 0.0025 und 0.2225. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.04 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es liegt ein signifikanter Unterschied vor. Der Effekt liegt bei -2.
...
\item [\textbf{E} \msquare] Die Barplots deuten auf keinen signifikanten Unterschied. Der Effekt liegt vermutlich bei -2 unter einer groben Abschätzung.
\end{enumerate}
...
\begin{center}
$3, 4, 6, 4, 7, 6, 3, 6, 2, 4, 4, 3, 3, 3, 2, 0, 2, 1, 3, 2, 7, 9, 3, 3, 8, 1, 3, 6, 2, 3, 8, 1, 7$
\end{center}
...
Erbsen nach einer durchgestandenen Infektion der Pflanzen. 

\begin{center}
$10.3, 7.8, 11.4, 8.3, 13.3, 8.9, 10.9, 12.4, 9.5, 12.3, 10.4, 9.2, 9.1, 7, 12.1, 9.3, 9.1, 12.7, 7.5, 9.4$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ falsch & $\alpha$-Fehler & Testentscheidung & H$_0$ wahr \\
  \end{tabular}
  \end{center}
...
Gewicht (\textit{weight}) von Kartoffeln.
...
\item Berechnen Sie den Effekt der Behandlungen \textit{ctrl} und
  \textit{dose} auf das Gewicht von Kartoffeln! \textbf{(1 Punkt)}
\end{enumerate} 
\clearpage
% -----------------------------------------------------------------------
...
## t = -3.816, df = 16, p-value = 0.001521
...
## t = 2.3917, df = 10, p-value = 0.03785
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  0.1758753 4.9669818
## sample estimates:
...
## t = -0.39923, df = 12, p-value = 0.6967
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -6.457513  4.457513
## sample estimates:
...
In einem Experiment in einer Klimakammer wurde der Ertrag von Brokoli unter drei verschiedenen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{group}  & 2 &  &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 & 46.32 &  &  &  \strut\\
        \hline
   \textbf{total}  & 24 & 46.96 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Faktorstufen \textit{lethal}, \textit{low} und
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 78.42 &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 & 132.54 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Der Datensatz \textit{plant\_tbl} enth{\"a}lt das Outcome \textit{freshmatter} f{\"u}r einen Freilandversuch mit 
...
## trt        2 46.081 23.0406  16.808 3.711e-05
## Residuals 22 30.159  1.3709
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 10.66 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 583.74 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 27.39 &  &  &  \strut\\
    \hline
   \textbf{error}  & 40 & 395.75 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 55 H{"a}ngebauchschweinen durchgef{\"u}hrt, wobei
jedes Tier eine von drei Selen-Dosen $dose$ ($0.2$ ng/Tag, $1$ ng/Tag und $10$ ng/Tag)
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2 136.23  68.116  1.5457 0.24016
## form       1 186.09 186.089  4.2228 0.05469
## dose:form  2 289.10 144.549  3.2802 0.06100
## Residuals 18 793.22  44.068
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high      low       mid
## ctrl 1.0000000 0.0011441 0.000736 0.8756223
## high 0.0011441 1.0000000 0.000000 0.0017526
## low  0.0007360 0.0000000 1.000000 0.0004750
## mid  0.8756223 0.0017526 0.000475 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 116$ Pflanzen untersucht.
\vspace{5Ex}
...
## -6.4444 -2.4000 -0.4222  1.5556  5.6000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.444      1.230  14.181 7.37e-09
## waterB         6.956      2.058   3.379  0.00548
## 
## Residual standard error: 3.69 on 12 degrees of freedom
## Multiple R-squared:  0.4876,	Adjusted R-squared:  0.4449 
## F-statistic: 11.42 on 1 and 12 DF,  p-value: 0.005477
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.4876$ aus? \textbf{(2 Punkte)}
...
## t = 7.185, df = 8, p-value = 9.382e-05
...
Einflussvariablen ($x$) wurden erhoben: S, variety und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
Kartoffeln in einem Feldexperiment wollen Sie nun den Versuch eine Nummer gr{\"o}{\ss}er
...
\begin{enumerate}
\item Wenn 3 Blaubeerschalen 5.67 Euro kosten,  wie viel kosten 8 Schalen? \textbf{(1 Punkt)}
...
\item $i$ dem Verhalten: (1) wing/leg stretching, (2) walking, (3)
  dustbathing und (4) sitting.
\end{itemize}
...
\midrule
wing/leg stretching & 34cm; 29cm; 50.1\% & 36cm; 23cm; 25.4\% & 36cm; 34cm; 25.4\%\\
walking & 30cm; 16cm; 1.8\% & 39cm; 18cm; 1.8\% & 30cm; 28cm; 4.1\%\\
dustbathing & 35cm; 14cm; 1.6\% & 40cm; 28cm; 1.2\% & 37cm; 24cm; 7.6\%\\
sitting & 44cm; 22cm; 6.2\% & 35cm; 30cm; 5.1\% & 40cm; 21cm; 6.9\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCGPH4A & 4.0 | 3.0 | Klein \\
    B & GCBZTGZ & 2.0 | 1.0 | Normal \\ 
    C & GCJPT7U & 2.5 | 4.5 | Mikro \\ 
    D & GCJSEIP & 3.5 | 1.5 | Normal \\ 
    E & GCBVVKH & 3.0 | 3.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 724 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{10^{9}} \cdot 1.7^{-0.3 \cdot t + 4.1}
\end{equation*}
...
5\% p.a. {\"u}ber 36 Monate finanzieren.
...
Frida und Helmut das Team der drei Kandidaten.
