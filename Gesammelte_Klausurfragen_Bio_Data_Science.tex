...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.001, 0.42 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 3e-04, 0.105 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.004, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.004, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.36, 0.004, 1.68 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 3e-04, 0.105 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 14, 9, 17, 10 und 3.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.6 +/- 5.32
\item [\textbf{B} \msquare] Es ergibt sich 10.6 +/- 28.3
\item [\textbf{C} \msquare] Es ergibt sich 11.6 +/- 2.66
\item [\textbf{D} \msquare] Es ergibt sich 10.6 +/- 2.66
\item [\textbf{E} \msquare] Es ergibt sich 9.6 +/- 14.15
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 16, 16, 19, 7, 28, 25, 17, 10, 17, 21 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 17 [16, 25]
\item [\textbf{B} \msquare] Es ergibt sich 20 [17, 26]
\item [\textbf{C} \msquare] Es ergibt sich 17 +/- 16
...
$y = \{22, 18, 13, 15, 12, 23, 20, 22, 16, 16, 7\}$. Berechnen Sie folgende
...
\begin{center}
$9.1, 10.7, 7.6, 12.4, 11.3, 12.7, 11.2, 8.1, 13.9, 11, 9.8, 10.3, 8.6, 7.9$
\end{center}
...
## t = 0.75089, df = 14, p-value = 0.4652
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.357245  4.896928
## sample estimates:
...
## trt        2 73.314  36.657   37.49 1.714e-07
## Residuals 20 19.556   0.978
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 111 124 104  98  90  94 148 139 143 146 145 142
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 20.3 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 172.17 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 256.6 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 398.19 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: weight
##           Df  Sum Sq Mean Sq F value  Pr(>F)
## dose       2  86.719  43.359  2.9021 0.08083
## form       1  53.909  53.909  3.6082 0.07364
## dose:form  2 116.594  58.297  3.9020 0.03911
## Residuals 18 268.928  14.940
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 112$ Sauen. In dem Experiment wurde gemessen,
...
## (Intercept)  15.0000     0.4907   30.57 9.41e-13
## waterB       12.0000     0.8210   14.62 5.23e-09
## 
## Residual standard error: 1.472 on 12 degrees of freedom
## Multiple R-squared:  0.9468,	Adjusted R-squared:  0.9424 
## F-statistic: 213.6 on 1 and 12 DF,  p-value: 5.226e-09
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.9468$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: region, S und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.00 & 0 & 9.01 & 101.80 & 74.49 & 7\\
10.55 & 0 & 9.39 & 97.61 & 68.09 & 12\\
11.10 & 0 & 10.13 & 101.86 & 71.81 & 9\\
10.02 & 0 & 8.66 & 103.56 & 73.93 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -9.6563 -2.0525  0.0665  1.6593  7.8872 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  75.7026     2.5369  29.841  < 2e-16
## light         2.1344     0.7415   2.878  0.00494
## nematodes    -0.1201     0.1070  -1.122  0.26456
## P            -0.4858     0.2358  -2.060  0.04210
## 
## Residual standard error: 3.24 on 95 degrees of freedom
## Multiple R-squared:  0.1507,	Adjusted R-squared:  0.1238 
## F-statistic: 5.617 on 3 and 95 DF,  p-value: 0.001374
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & no3 & temp & so4\\
\midrule
ISRAEL\_CR & 30 & 9.5 & 2.41 & 21.0 & 13.77\\
SENECA\_CR & 23 & 9.9 & 1.58 & 20.1 & 8.37\\
DORSEY\_RUN & 8 & 6.8 & 0.44 & 22.6 & 20.24\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.959  -4.608  -1.722   0.295  22.636  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.4721518  2.0691784   0.228   0.8205
## do2          0.1978016  0.1606574   1.231   0.2241
## no3          0.2108306  0.0819750   2.572   0.0132
## temp         0.0399051  0.0565708   0.705   0.4839
## so4         -0.0006112  0.0249436  -0.025   0.9806
## 
## (Dispersion parameter for quasipoisson family taken to be 54.67693)
## 
##     Null deviance: 2402.9  on 53  degrees of freedom
## Residual deviance: 1848.2  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.43       2.07  0.0384
## 2 light           0.497      1.63  0.104 
## 3 water           0.145     -2.14  0.0326
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 790.9
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1812 -0.6070 -0.0519  0.5121  3.1792 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  216.6   14.72   
##  subject  (Intercept) 3992.6   63.19   
##  Residual              624.0   24.98   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.425     26.669   7.590
## attitudepop  -19.466      5.489  -3.547
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.5979078 0.0005138 0.0239989
## high 0.5979078 1.0000000 0.0001139 0.0066525
## low  0.0005138 0.0001139 1.0000000 0.1451445
## mid  0.0239989 0.0066525 0.1451445 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 5, 12, 5, 9 und -1!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 12, 9, 7, 3 und 9! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes P, pigs und Fe an vier verschiedenen Messterminen.
...
\midrule
dustbathing & 43cm; 26cm; 4.3\% & 35cm; 29cm; 4.1\% & 30cm; 28cm; 4.1\%\\
preening & 38cm; 17cm; 0.4\% & 36cm; 21cm; 0.6\% & 35cm; 28cm; 0.9\%\\
walking & 29cm; 22cm; 1.6\% & 31cm; 30cm; 0.5\% & 26cm; 30cm; 0.5\%\\
foraging incl. scratching & 34cm; 33cm; 8.1\% & 32cm; 17cm; 3.6\% & 33cm; 21cm; 8.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCWHZRO & 4.0 | 2.5 | Klein \\
    B & GCJLEU9 & 2.0 | 1.5 | Klein \\ 
    C & GCNNOXN & 3.0 | 4.0 | Klein \\ 
    D & GCIU8WU & 3.5 | 3.5 | Mikro \\ 
    E & GC7PIR5 & 1.5 | 3.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1036 n. Chr. f{\"u}r den neuen Lehnsherren
...
f{\"u}r die erste Stufe betr{\"a}gt 35\%. F{\"u}r die zweite, dritte und vierte
Stufe betragen die indirekten Provisionen jeweils 2.5\%, 
1.5\% und 1\%. Im Schnitt wirbt jeder Ihrer
angeworbenen "`Partner"' wiederum drei Partner f{\"u}r sich selber
an. Sie wollen 2100EUR im Monat \textit{passiv} erwirtschaften.  
...
Sie haben den Vektor $A = \{-2, -6, 5\}$ und den Vektor $B = \{-1, 4, 6\}$ gegeben.
