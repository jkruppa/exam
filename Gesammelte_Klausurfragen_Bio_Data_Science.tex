...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.02, 0.001, 0.03, 0.42 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.0033, 2e-04, 0.005, 0.07 und 0.1483. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.26, 0.12, 0.006, 0.18, 2.52 und 5.34. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.006, 0.18, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.0033, 2e-04, 0.005, 0.07 und 0.1483. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.006, 0.18, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 9, 13, 12 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.8 +/- 1.34
\item [\textbf{B} \msquare] Es ergibt sich 10.8 +/- 2.68
\item [\textbf{C} \msquare] Es ergibt sich 10.8 +/- 1.34
\item [\textbf{D} \msquare] Es ergibt sich 10.8 +/- 7.2
\item [\textbf{E} \msquare] Es ergibt sich 9.8 +/- 3.6
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 18, 15, 20, 15, 9, 24 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 20 [16, 25]
\item [\textbf{B} \msquare] Es ergibt sich 18 [15, 24]
\item [\textbf{C} \msquare] Es ergibt sich 20 +/- 15
\item [\textbf{D} \msquare] Es ergibt sich 18 +/- 24
\item [\textbf{E} \msquare] Es ergibt sich 18 +/- 15
\end{enumerate} 
...
$y = \{23, 17, 23, 22, 16, 9, 22, 15, 16, 21, 21\}$. Berechnen Sie folgende
...
\begin{center}
$9.2, 12.9, 10.8, 10, 10.3, 10.7, 12.2, 11.8, 10.9, 6.4, 9.3, 13.1, 10.5, 9$
\end{center}
...
## t = -0.17896, df = 16, p-value = 0.8602
...
## 
## data:  freshmatter by N
## t = 2.155, df = 14, p-value = 0.04906
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  0.01476986 6.20745236
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 11.81 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 36.86 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 56.401 28.2006  9.1025 0.001317
## Residuals 22 68.159  3.0981
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 111 128 119  97  91 107 142 113 136 152 144 138
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 30.42 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 433.78 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 50.04 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 65 & 1165.82 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 406.60 203.301 10.5233 0.0009402
## form       1  86.97  86.968  4.5016 0.0480014
## dose:form  2 173.81  86.905  4.4984 0.0260400
## Residuals 18 347.74  19.319
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -6.889 -2.889  0.127  2.385  8.111 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.889      1.430  11.808 1.15e-08
## waterB        -4.032      2.162  -1.865   0.0833
## 
## Residual standard error: 4.291 on 14 degrees of freedom
## Multiple R-squared:  0.1989,	Adjusted R-squared:  0.1417 
## F-statistic: 3.477 on 1 and 14 DF,  p-value: 0.08335
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.1989$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: center, variety und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.18 & 0 & 9.39 & 100.34 & 70.89 & 15\\
8.33 & 0 & 8.61 & 97.51 & 64.27 & 11\\
11.39 & 1 & 10.42 & 99.60 & 68.73 & 6\\
10.54 & 0 & 9.69 & 106.61 & 75.42 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.3214 -1.6622 -0.0525  1.5120  6.5062 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   6.2381     7.6750   0.813    0.418
## water        -0.2511     0.1637  -1.534    0.128
## P            -0.6805     0.1492  -4.562 1.24e-05
## Fe            0.7299     0.0685  10.656  < 2e-16
## 
## Residual standard error: 2.371 on 119 degrees of freedom
## Multiple R-squared:  0.587,	Adjusted R-squared:  0.5766 
## F-statistic: 56.38 on 3 and 119 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & maxdepth & so4 & temp\\
\midrule
DEER\_CR & 26 & 9.9 & 60 & 6.36 & 19.1\\
ISRAEL\_CR & 30 & 9.5 & 133 & 13.77 & 21.0\\
NORTHWEST\_BR & 6 & 8.2 & 63 & 13.22 & 20.8\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##      Min        1Q    Median        3Q       Max  
## -11.1428   -4.1023   -1.9967    0.8746   15.1404  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -1.337326   1.854916  -0.721  0.47436
## do2          0.181561   0.136533   1.330  0.18974
## maxdepth     0.012193   0.004364   2.794  0.00741
## so4         -0.022318   0.025579  -0.873  0.38719
## temp         0.137014   0.052499   2.610  0.01198
## 
## (Dispersion parameter for quasipoisson family taken to be 41.7244)
## 
##     Null deviance: 2245.8  on 53  degrees of freedom
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.42       2.09  0.0366
## 2 light           0.439      1.28  0.202 
## 3 water           0.144     -2.23  0.0256
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 799.2
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0168 -0.5992 -0.0778  0.5061  3.2959 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  225.2   15.01   
##  subject  (Intercept) 4002.4   63.26   
##  Residual              699.5   26.45   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.257     26.756   7.597
## attitudepop  -20.083      5.811  -3.456
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000046 0.0155931 0.0000000
## high 0.0000046 1.0000000 0.0000000 0.0096617
## low  0.0155931 0.0000000 1.0000000 0.0000000
## mid  0.0000000 0.0096617 0.0000000 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 6, 10, 11, 15 und 13!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 2, 3, 12 und 14! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes Fe, P und drymatter an vier verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCKREB5 & 1.5 | 1.5 | Klein \\
    B & GCYES2M & 1.0 | 2.5 | Klein \\ 
    C & GCYKPCZ & 4.5 | 5.0 | Mikro \\ 
    D & GCPDR6Q & 3.5 | 4.5 | Normal \\ 
    E & GCXQBGO & 3.0 | 2.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 132 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{24, 6, 14\}$ und den Vektor $B = \{5, -1, 1\}$ gegeben.
