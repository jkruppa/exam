...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.34, 0.21 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 0.84 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.085, 0.0525 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 0.84 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.085, 0.0525 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1.36, 0.84 und 1.68. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 13, 12, 8 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.6 +/- 4.3
\item [\textbf{B} \msquare] Es ergibt sich 9.6 +/- 2.15
\item [\textbf{C} \msquare] Es ergibt sich 11.6 +/- 1.035
\item [\textbf{D} \msquare] Es ergibt sich 10.6 +/- 2.07
\item [\textbf{E} \msquare] Es ergibt sich 10.6 +/- 1.035
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 8, 20, 13, 19, 17, 25, 25, 16, 23, 20 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 20 +/- 16
\item [\textbf{B} \msquare] Es ergibt sich 20 +/- 25
\item [\textbf{C} \msquare] Es ergibt sich 20 [16, 25]
\item [\textbf{D} \msquare] Es ergibt sich 22 +/- 16
\item [\textbf{E} \msquare] Es ergibt sich 22 [17, 26]
\end{enumerate} 
...
$y = \{18, 15, 23, 18, 20, 19, 20\}$. Berechnen Sie folgende
...
\begin{center}
$13.3, 10.4, 10.7, 6.3, 11.3, 6.7, 10.5, 7.3, 12.3, 7.5, 11.7, 13.7, 12.7, 14$
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 110.73 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 41.27 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 55.368 27.6839  17.337 4.291e-05
## Residuals 20 31.937  1.5968
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 130 122 115 107 110  97 124 144 135 137 145 165
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 4.85 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 314.56 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 180.03 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 175.15 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2 212.906 106.453  8.1881 0.002959
## form       1  86.238  86.238  6.6332 0.019055
## dose:form  2 144.333  72.166  5.5509 0.013249
## Residuals 18 234.016  13.001
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -7.0000 -2.7143  0.1429  1.1429  8.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   13.000      1.614   8.054 3.51e-06
## waterB        12.857      2.283   5.632  0.00011
## 
## Residual standard error: 4.271 on 12 degrees of freedom
## Multiple R-squared:  0.7255,	Adjusted R-squared:  0.7027 
## F-statistic: 31.72 on 1 and 12 DF,  p-value: 0.0001103
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7255$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: height, block und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.70 & 0 & 10.06 & 97.14 & 66.16 & 10\\
9.40 & 1 & 12.74 & 103.34 & 74.91 & 8\\
9.52 & 1 & 10.95 & 96.18 & 67.22 & 9\\
11.51 & 0 & 12.40 & 104.19 & 72.10 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.3323 -1.3587  0.1064  1.5766  7.2750 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  4.32675    8.25148   0.524   0.6012
## Fe           0.68607    0.08112   8.457 3.04e-13
## light        0.55530    0.53296   1.042   0.3001
## water       -0.32556    0.17903  -1.819   0.0721
## 
## Residual standard error: 2.417 on 96 degrees of freedom
## Multiple R-squared:  0.4362,	Adjusted R-squared:  0.4185 
## F-statistic: 24.75 on 3 and 96 DF,  p-value: 5.992e-12
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
FISHING\_CR & 11 & 7.10 & 109 & 5046 & 0.73\\
BEAR\_BR & 12 & 7.74 & 83 & 3333 & 5.34\\
WATTS\_BR & 19 & 14.19 & 82 & 510 & 5.25\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -12.862   -3.806   -2.053    1.437   16.640  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.136e+00  5.075e-01   4.208 0.000109
## so4         -1.611e-02  2.427e-02  -0.664 0.510058
## maxdepth     1.019e-02  4.038e-03   2.523 0.014921
## acerage      3.783e-05  1.236e-05   3.060 0.003584
## no3          2.078e-01  6.678e-02   3.112 0.003100
## 
## (Dispersion parameter for quasipoisson family taken to be 35.73244)
## 
##     Null deviance: 2423.6  on 53  degrees of freedom
## Residual deviance: 1566.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.45       2.00  0.0459
## 2 nematodes       0.156      1.37  0.172 
## 3 water           0.142     -2.41  0.0162
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2411 -0.5897 -0.0750  0.5710  3.6901 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  210.1   14.49   
##  subject  (Intercept) 3891.6   62.38   
##  Residual              679.4   26.06   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.179     26.359   7.632
## attitudepop  -16.634      5.727  -2.904
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000576 0.0000238 0.1831000
## high 0.0000576 1.0000000 0.7619481 0.0025637
## low  0.0000238 0.7619481 1.0000000 0.0011291
## mid  0.1831000 0.0025637 0.0011291 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 14, 7, 12, 16 und 16!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 9, 10, 11, 11 und 11! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes Fe, grade und freshmatter an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCZ4ODJ & 4.0 | 2.0 | Klein \\
    B & GCR9HDK & 3.5 | 1.5 | Normal \\ 
    C & GCYF78K & 2.0 | 3.5 | Normal \\ 
    D & GCTKROQ & 5.0 | 5.0 | Mikro \\ 
    E & GCFKQSW & 1.0 | 2.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
Sie haben den Vektor $A = \{13, 18, 11\}$ und den Vektor $B = \{-2, 5, -3\}$ gegeben.
