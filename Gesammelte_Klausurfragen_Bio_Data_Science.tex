...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\square\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es werden 88\% der Varianz durch die Behandlung erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der von den unterschiedlichen Behandlungsbedingungen nicht erklärt wird.
...
\item [\textbf{C} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Umweltbedingungen erklärt wird. Daher werden 12\% der Varianz durch die Umweltbedingungen erklärt. Der Anteil der Varianz durch die Behandlungsgruppen ist dann 88\%.
\item [\textbf{D} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Behandlungsbedingungen erklärt wird. Daher werden 12\% der Varianz erklärt.
\item [\textbf{E} \msquare] Es werden 12\% der Varianz durch den Versuch erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der durch Fehler in der Versuchsdurchführung entsteht.
\end{enumerate} 
...
In einer Studie zur Bewertung der Wirkung von Vitamin D auf das Zahnwachstum bei Kanarienvögel entstand folgende Abbildung. Der Versuch wurde an 78 Tieren durchgeführt, wobei jedes Tier eine von  drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Welche Aussage ist im Bezug auf eine zweifaktorielle ANOVA richtig?
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 12, 8, 11, 5 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.6 +/- 2.88
\item [\textbf{B} \msquare] Sie erhalten 8.6 +/- 1.44
\item [\textbf{C} \msquare] Es ergibt sich 9.6 +/- 1.44
\item [\textbf{D} \msquare] Es ergibt sich 7.6 +/- 4.15
\item [\textbf{E} \msquare] Es berechnet sich 8.6 +/- 8.3
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 25, 10, 15, 17, 21, 27 und 63.




\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 +/- 15
\item [\textbf{B} \msquare] Sie erhalten 21 [13; 25]
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 15
\item [\textbf{D} \msquare] Sie erhalten 21 [15; 27]
\item [\textbf{E} \msquare] Es berechnet sich 22 [16; 26]
\end{enumerate} 
...
Sie haben $n = 200$ Pflanzen geerntet und wollen sich nun die Verteilung der Pflanzen einmal in einem Histogramm anschauen. Welche Verteilung ist dargestellt?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Da es sich um ein Chancenverhältnis handelt ergibt sich ein Odds ratio von 5.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.25, da es sich um eine Chancenverhältnis handelt
...
\item [\textbf{D} \msquare] Das Verhältnis der Anteile Odds ratio ergibt ein Anteilsverhältnis von 0.2. Wir sind am Anteil der Kranken interessiert.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.02, 0.001 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0525, 0.005, 3e-04 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0525, 0.005, 3e-04 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 0.08, 0.004 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 0.08, 0.004 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 0.08, 0.004 und 1.68. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\item [\textbf{B} \msquare] Sie nutzen das R Paket \{emmeans\} für die Berechnung des multipnen Gruppenvergleichs. Die Ausgabe der Funktion emmeans() erlaubt zügig über \{ggplot\} einen Barplot zu erstellen und dann auch das CLD zu berechnen. Sie haben alles sofort zusammen.
...
\item [\textbf{D} \msquare] Nein, wir können die untersuchte Population nicht mit einer ANOVA auswerten. Wir erhalten keine Aussage zur Population.
...
In einer Studie zur Bewertung der Wirkung des Mikronährstoff Eisen auf den Ertrag in t/ha  von Mango im Vergleich zu einer Kontrolle entstand folgende Abbildung. Der Versuch wurde in 11 Parzellen pro Gruppe durchgeführt. Welche Aussage ist im Bezug auf einen t-Test ist richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Nach Betrachtung des Barplots liegt ein signifikanter Unterschied vor. Der Effekt liegt bei 1.
\item [\textbf{B} \msquare] Die Barplots deuten auf einen signifikanten Unterschied. Der Effekt liegt vermutlich bei 1 unter einer groben Abschätzung. Wir müssen aber eine ANOVA rechnen um den Effekt wirklich bestimmen zu können.
...
Barplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Noa nicht gemerkt, welche statistischen Maßzahlen für einen Barplot erhoben werden müssen. Das ist in soweit doof, da nach seiner Betreuerin erstmal ein Barplot nachgebaut werden soll, bevor es mit seiner Hausarbeit losgeht. Dann hat er schonmal den \Rlogo Code vorliegen und nachher geht dann alles schneller. Die Behandlung für Erdbeeren werden verschiedene Bewässerungstypen ($low$, $mid$ und $high$) sein. Erfasst wird als Messwert ($Y$) \textit{Frischegewicht}. Noa soll dann \textit{freshmatter} in seiner Exceldatei eintragen.
...
Leider kennt sich Noa mit der Erstellung von Barplots in \Rlogo nicht aus. Deshalb braucht er bei der Visualisierung Ihre Hilfe!
...
Barplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Eric nicht gemerkt, welche statistischen Maßzahlen für einen Barplot erhoben werden müssen. Das ist in soweit doof, da nach seinem Betreuer nun Barplots aus seinen Daten gebaut werden sollen, bevor es mit dem statistischen Testen weitergeht. Die Behandlung für Lauch waren verschiedene Düngestufen ($ctrl$, $low$ und $high$). Erfasst wurde von Eric als Messwert ($Y$) \textit{Proteingehalt}. Eric hat dann \textit{protein} in seiner Exceldatei eintragen.
...
Leider kennt sich Eric mit der Erstellung von Barplots nicht aus. Deshalb braucht er bei der Visualisierung Ihre Hilfe!
...
Boxplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Sabine nicht gemerkt, welche statistischen Maßzahlen für einen Boxplot erhoben werden müssen. Das ist in soweit doof, da nach ihrer Betreuerin erstmal ein Boxplot nachgebaut werden soll, bevor es mit ihrer Abschlussarbeit losgeht. Anhand von Boxplots lässt sich eine Aussage über die Varianzhomogenität über die Behandlungsgruppen treffen. Dann hat sie schonmal den \Rlogo Code vorliegen und nachher geht dann alles schneller. Die Behandlung für Erdbeeren werden verschiedene Bewässerungstypen ($low$, $mid$ und $high$) sein. Erfasst wird als Messwert ($Y$) \textit{Ertrag}. Sabine soll dann \textit{yield} in ihrer Exceldatei eintragen.
...
Leider kennt sich Sabine mit der Erstellung von Boxplots in \Rlogo nicht aus. Deshalb braucht sie bei der Visualisierung Ihre Hilfe!
...
Boxplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Tina nicht gemerkt, welche statistischen Maßzahlen für einen Boxplot erhoben werden müssen. Das ist in soweit doof, da nach ihrer Betreuerin nun Boxplots aus ihren Daten gebaut werden sollen, bevor es mit dem statistischen Testen weitergeht. Anhand von Boxplots lässt sich eine Aussage über die Normalverteilung von $Y$ treffen. Die Behandlung für Lauch waren verschiedene Lüftungssystemen und Folientunneln ($ctrl$ und $tornado$). Erfasst wurde von Tina als Endpunkt ($Y$) \textit{Proteingehalt}. Tina hat dann \textit{protein} in ihrer Exceldatei eintragen.
...
Eric betrachtet die folgenden Daten nach einem Stallexperiment mit Puten. In dem Experiment wurden die Hautflecken gezählt. Nach der Meinung seiner Betreuerin muss als erstes geschaut werden, wie diese verteilt sind. Also welcher statistsichen Verteilung die Hautflecken folgen. Dazu soll Eric ein Histogramm verwenden. Dann hätte man auch einen guten Überblick über den Endpunkt ($Y$).

\begin{center}
Hautflecken: 8, 5, 4, 6, 5, 5, 1, 4, 7, 1, 4, 4, 4, 4, 7, 7, 3, 3, 1, 9, 4, 4, 2, 2, 6, 7, 4
\end{center}

Leider kennt sich Eric mit der Erstellung von Histogrammen überhaupt nicht aus. Deshalb braucht er bei der Erstellung Ihre Hilfe!
...
Maiss nach einer durchgestandenen Infektion der Pflanzen. 

\begin{center}
$9.8, 11.1, 11.7, 9.1, 9.3, 11.2, 12.2, 9.4, 11.1, 12.9, 10, 10.3, 9.6, 5.4, 10, 15.3, 15.4, 9.7, 11, 11.8$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ abgelehnt & $\alpha$-Fehler & H$_0$ falsch & H$_0$ wahr \\
  \end{tabular}
  \end{center}
...
## t = -0.90874, df = 10, p-value = 0.3849
...
## t = 2.1788, df = 10, p-value = 0.05436
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -0.1009215  9.0152072
## sample estimates:
...
## t = 2.4641, df = 6, p-value = 0.04885
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  0.02592922 7.40264221
## sample estimates:
## mean difference 
##        3.714286
\end{verbatim}
...
In einem Gew{"a}chshausexperiment wurde der Ertrag von Erdbeeren unter drei verschiedenen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 153.88 &  &  &  \strut\\
    \hline
   \textbf{error}  & 20 & 27.43 &  &  &  \strut\\
        \hline
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 227.43 &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 & 27.21 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 23.523 11.7613  7.5398 0.003207
## Residuals 22 34.317  1.5599
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 23.95 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 88.35 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 389.29 &  &  &  \strut\\
    \hline
   \textbf{error}  & 24 & 314.54 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 53 Puten durchgef{\"u}hrt, wobei
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 128.54   64.27  4.1458   0.03305
## form       1 648.64  648.64 41.8398 4.381e-06
## dose:form  2  94.36   47.18  3.0434   0.07269
## Residuals 18 279.05   15.50
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0170469 0.0029285 0.1100824
## high 0.0170469 1.0000000 0.0000023 0.3889386
## low  0.0029285 0.0000023 1.0000000 0.0000294
## mid  0.1100824 0.3889386 0.0000294 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -8.2222 -3.0278  0.5556  3.1111  8.7778 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.222      1.683  11.423 4.19e-09
## waterB        -4.778      2.380  -2.008   0.0619
## 
## Residual standard error: 5.048 on 16 degrees of freedom
## Multiple R-squared:  0.2012,	Adjusted R-squared:  0.1513 
## F-statistic: 4.031 on 1 and 16 DF,  p-value: 0.06188
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.2012$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: dry, S und N. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\begin{enumerate}
\item Wenn 7 Blaubeerschalen 12.53 Euro kosten,  wie viel kosten 10 Schalen? \textbf{(1 Punkt)}
\item Wenn Sie die 10 Blaubeerschalen gekauft haben, wie viele Aligatorbirnen zu je 2.59 EUR können Sie sich dann noch für 200 EUR leisten? \textbf{(1 Punkt)}
\end{enumerate}
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2023 blieben die Erträge von Blaubeeren mit \ensuremath{7.5\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge reduzierte sich um 7.2\%. Die Exporte für Avocados fielen in dem gleichen Zeitraum um 21.2\% auf \ensuremath{2.1\times 10^{5}}t.
...
\item $i$ dem Verhalten: (1) wingflapping, (2) walking, (3)
...
\midrule
wingflapping & 36cm; 24cm; 4.3\% & 33cm; 36cm; 5.2\% & 27cm; 28cm; 2.1\%\\
walking & 42cm; 27cm; 1.6\% & 37cm; 29cm; 8.1\% & 43cm; 20cm; 0.5\%\\
dustbathing & 31cm; 20cm; 6.3\% & 32cm; 21cm; 5.2\% & 37cm; 20cm; 6.3\%\\
preening & 27cm; 20cm; 7.3\% & 40cm; 21cm; 0.8\% & 40cm; 28cm; 1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC4G7CB & 3.0 | 3.5 | Klein \\
    B & GCZACXJ & 3.5 | 2.5 | Mikro \\ 
    C & GCMCUBV & 4.0 | 1.0 | Klein \\ 
    D & GCIE5VH & 4.5 | 4.0 | Normal \\ 
    E & GCY41GM & 2.0 | 3.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 829 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{10^{10}} - \ensuremath{10^{9}} \cdot 1.9^{-0.2 \cdot t + 4.1}
\end{equation*}
