...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.89, 0.03, 0.01, 0.001 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.18, 0.06, 0.006 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.18, 0.06, 0.006 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.26, 5.34, 0.18, 0.06, 0.006 und 2.52. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.1483, 0.005, 0.0017, 2e-04 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.1483, 0.005, 0.0017, 2e-04 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 8, 10, 0, 6 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 7.2 +/- 4.6
\item [\textbf{B} \msquare] Es ergibt sich 6.2 +/- 10.6
\item [\textbf{C} \msquare] Es ergibt sich 8.2 +/- 2.3
\item [\textbf{D} \msquare] Es ergibt sich 7.2 +/- 21.2
\item [\textbf{E} \msquare] Es ergibt sich 7.2 +/- 2.3
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 23, 14, 16, 19, 22, 30 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 +/- 16
\item [\textbf{B} \msquare] Es ergibt sich 22 [16, 30]
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 30
\item [\textbf{D} \msquare] Es ergibt sich 25 +/- 16
\item [\textbf{E} \msquare] Es ergibt sich 25 [17, 31]
\end{enumerate} 
...
$y = \{16, 13, 16, 16, 18, 14, 8, 14, 11, 18, 16\}$. Berechnen Sie folgende
...
\begin{center}
$12.2, 11.3, 7.6, 11.9, 8.7, 11.5, 12.2, 10.2, 7.7, 8.4, 8.8, 9.7$
\end{center}
...
## t = 2.0742, df = 10, p-value = 0.06482
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.2862125  8.0004982
## sample estimates:
...
## 
## data:  freshmatter by N
## t = -0.32516, df = 12, p-value = 0.7507
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.400462  3.257605
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 9.82 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 43.94 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  7.2809  3.6404  2.4321 0.1134
## Residuals 20 29.9365  1.4968
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 120 110 113 110  87  93 145 151 148 137 156 155
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{supp}  & 1 & 0.05 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 46.41 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 275.12 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 743.14 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2 101.777  50.888  4.0143 0.0361741
## form       1  14.479  14.479  1.1422 0.2993113
## dose:form  2 270.617 135.308 10.6737 0.0008774
## Residuals 18 228.182  12.677
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##  -5.00  -2.10  -0.40   2.25   6.00 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   21.400      1.632   13.11 1.26e-07
## trtB           5.600      2.137    2.62   0.0256
## 
## Residual standard error: 3.65 on 10 degrees of freedom
## Multiple R-squared:  0.4071,	Adjusted R-squared:  0.3478 
## F-statistic: 6.867 on 1 and 10 DF,  p-value: 0.02558
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -3.4173, df = 8, p-value = 0.009125
...
Einflussvariablen ($x$) wurden erhoben: center, fertilizier und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.42 & 0 & 10.66 & 103.27 & 68.70 & 7\\
9.21 & 0 & 9.36 & 101.47 & 72.77 & 15\\
10.91 & 1 & 8.60 & 99.23 & 70.01 & 11\\
9.77 & 0 & 11.35 & 97.39 & 66.67 & 11\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.4429 -2.1615 -0.0791  1.9411  7.2321 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 71.63883    2.84113  25.215   <2e-16
## nematodes    0.07967    0.10097   0.789   0.4322
## water       -0.29525    0.24566  -1.202   0.2327
## light        1.17473    0.67977   1.728   0.0875
## 
## Residual standard error: 3.009 on 87 degrees of freedom
## Multiple R-squared:  0.05367,	Adjusted R-squared:  0.02104 
## F-statistic: 1.645 on 3 and 87 DF,  p-value: 0.1849
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
HAINES\_BR & 98 & 7.71 & 1967 & 8.6 & 26.44\\
PINEY\_CR & 18 & 4.57 & 6949 & 9.3 & 17.84\\
BEAVER\_RUN & 37 & 5.66 & 1722 & 8.1 & 5.91\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -9.1903  -4.0099  -2.1558   0.8025  20.0578  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.336e+00  1.581e+00   1.478  0.14588
## no3          2.191e-01  7.464e-02   2.935  0.00506
## acerage      3.732e-05  1.543e-05   2.418  0.01935
## do2          6.716e-02  1.734e-01   0.387  0.70020
## so4         -2.032e-02  2.571e-02  -0.791  0.43304
## 
## (Dispersion parameter for quasipoisson family taken to be 45.11523)
## 
##     Null deviance: 2280.3  on 53  degrees of freedom
## Residual deviance: 1617.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.58      1.62   0.105 
## 2 light           0.594     0.766  0.444 
## 3 water           0.155    -1.75   0.0793
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1339 -0.6669 -0.0344  0.5679  3.1837 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  210.8   14.52   
##  subject  (Intercept) 4099.9   64.03   
##  Residual              626.1   25.02   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.131     26.988   7.527
## attitudepop  -21.347      5.498  -3.883
## 
...
\begin{verbatim}
##           ctrl      high   low       mid
## ctrl 1.0000000 0.0009089 0e+00 0.5243463
## high 0.0009089 1.0000000 2e-07 0.0050255
## low  0.0000000 0.0000002 1e+00 0.0000000
## mid  0.5243463 0.0050255 0e+00 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 8, 9, 11, 14 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 4, 16, 7, 14 und 12! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes drymatter, leaf und grade an vier verschiedenen Messterminen.
...
Seitenl{\"a}nge einer Pyramide betr{\"a}gt 36 K{\"o}nigsellen. Eine K{\"o}nigselle
misst 52.4cm.\\
...
\begin{enumerate}
\item Die K{\"o}nigspyramide von Meroe soll eine Seitenl{\"a}nge von 36
...
Sie haben den Vektor $A = \{10, -1, 9\}$ und den Vektor $B = \{-2, 5, -8\}$ gegeben.
