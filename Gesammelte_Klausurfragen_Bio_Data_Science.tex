...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\blacksquare\!\square\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\begin{enumerate}
\item [\textbf{A} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Umweltbedingungen erklärt wird. Daher werden 25\% der Varianz durch die Umweltbedingungen erklärt. Der Anteil der Varianz durch die Behandlungsgruppen ist dann 75\%.
\item [\textbf{B} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Behandlungsbedingungen erklärt wird. Daher werden 25\% der Varianz erklärt.
...
Die folgende Abbildung enthält die Daten aus einer Studie zur Bewertung der Wirkung von Vitamin D auf das Zahnwachstum bei Igeln. Der Versuch wurde an 60 Tieren durchgeführt, wobei jedes Tier eine von  drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Welche Aussage ist richtig im Bezug auf eine zweifaktorielle ANOVA?
...
Wie lautet der Mittelwert und Standardabweichung von $y$ mit 6, 8, 11, 10 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Sie erhalten 9.2 +/- 1.47
\item [\textbf{B} \msquare] Es berechnet sich 9.2 +/- 2.17
\item [\textbf{C} \msquare] Es ergibt sich 8.2 +/- 2.35
\item [\textbf{D} \msquare] Es berechnet sich 10.2 +/- 4.7
\item [\textbf{E} \msquare] Es ergibt sich 10.2 +/- 1.085
\end{enumerate} 
...
Wie lautet der Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 22, 13, 26, 5, 30, 27, 34, 19, 30, 27 und 51.




\begin{enumerate}
\item [\textbf{A} \msquare] Sie erhalten 27 [17; 28]
\item [\textbf{B} \msquare] Es berechnet sich 27 [19; 30]
\item [\textbf{C} \msquare] Es berechnet sich 28 [20; 29]
\item [\textbf{D} \msquare] Sie erhalten 27 +/- 30
\item [\textbf{E} \msquare] Es berechnet sich 26 [20; 31]
\end{enumerate} 
...
\item [\textbf{E} \msquare] Der Barplot stellt den Median und die Streuung dar.
\end{enumerate}
...
\item [\textbf{E} \msquare] Einen Violinplot. Der Bauch der Violine muss hierbei einen höhren Wert annehmen als der Steg der Violine. Dann kann die Annahme einer Varianzhomogenität angenommen werden.
\end{enumerate}
...
Neben der Mittelwertsdifferenz als Effektschätzer bei normalverteilten Endpunkten wird auch häufig der Effektschätzer Risk ratio bei binären Endpunkten verwendet. Welche Aussage über den Effektschätzer Risk ratio ist im folgenden Beispiel zur Behandlung von Klaueninfektionen bei Schafe richtig? Dabei sind 3 Tiere krank und 7 Tiere sind gesund.



\begin{enumerate}
\item [\textbf{A} \msquare] Der Anteil der Kranken wird berechnet. Da es sich um ein Anteil handelt ergibt sich ein Risk ratio von 0.3.
\item [\textbf{B} \msquare] Da es sich um ein Chancenverhältnis handelt ergibt sich ein Risk ratio von 3.33.
\item [\textbf{C} \msquare] Der Anteil der Gesunden wird berechnet. Da es sich um ein Anteil handelt ergibt sich ein Risk ratio von 0.3.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 2.33, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Das Verhältnis von Chancen Risk ratio ergibt ein Chancenverhältnis von 0.43.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.34, 0.02, 0.001, 0.03 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.12, 0.006, 0.18 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.0567, 0.0033, 2e-04, 0.005 und 0.0017. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.12, 0.006, 0.18 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.26, 2.04, 0.12, 0.006, 0.18 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.0567, 0.0033, 2e-04, 0.005 und 0.0017. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\item [\textbf{B} \msquare] Die Barplots deuten auf keinen signifikanten Unterschied. Der Effekt liegt vermutlich bei 7 unter einer groben Abschätzung.
...
\item [\textbf{E} \msquare] Die Barplots deuten auf keinen signifikanten Unterschied. Der Effekt liegt vermutlich bei 7 unter einer groben Abschätzung. Wir müssen aber eine ANOVA rechnen um den Effekt wirklich bestimmen zu können.
\end{enumerate}
...
Mark steht vor einem ersten Problem, denn wenn es nach seiner Betreuer geht, soll er in einem einem Freilandversuch Lauch auswertet. Soweit eigentlich alles passend. Die Behandlung werden verschiedene Genotypen ($AA$, $AB$ und $BB$) sein. In seiner Exceldatei wird er den Messwert ($Y$) \textit{Proteingehalt} als \textit{protein} aufnehmen. Vorab soll Mark aber eimal die folgenden Barplots seiner Betreuer nachbauen, damit er den \Rlogo Code schonmal für später vorliegen hat. Damit geht das Problem schon los.
...
\item Wenn Mark \textit{keinen Effekt} zwischen den Behandlungen von Erdbeeren erwarten würde, wie sehen dann die Barplots aus? \textit{Antworten Sie mit einer Skizze der Barplots!}
  \textbf{(1 Punkt)}
\end{enumerate} 
\clearpage
% -----------------------------------------------------------------------
...
Mark steht vor einem ersten Problem, denn wenn es nach seinem Betreuer geht, soll er in einem einem Gewächshausexperiment Lauch auswertet. Soweit eigentlich alles passend. Die Behandlung werden verschiedene Lüftungssystemen und Folientunneln ($ctrl$, $storm$ und $tornado$) sein. In seiner Exceldatei wird er den Endpunkt ($Y$) \textit{Ertrag} als \textit{yield} aufnehmen. Vorab soll Mark aber eimal die folgenden Boxplots seinem Betreuer nachbauen, damit er den \Rlogo Code schonmal für später vorliegen hat. Anhand von Boxplots lässt sich eine Aussage über die Varianzhomogenität über die Behandlungsgruppen treffen. Damit geht das Problem schon los.
...
Tina steht vor einem ersten Problem, denn wenn es nach ihrer Betreuerin geht, soll sie in einem einem Gewächshausexperiment Maiss auswertet. Soweit eigentlich alles passend. Die Behandlung waren verschiedene Lichtstufen ($none$ und $600lm$). In ihrer Exceldatei hat sie den Outcome ($Y$) \textit{Frischegewicht} als \textit{freshmatter} aufgenommen. Nun soll Tina die Daten eimal als Boxplots in einer Präsentation visualisieren, damit ihrer Betreuerin wieder klar wird, was sie eigentlich nochmal gemacht hat und was für ein Ergbnis in einem statistischen Test zu erwarten wäre. Anhand von Boxplots lässt sich eine Aussage über die Normalverteilung von $Y$ treffen.
...
In einem Gespräch mit ihrer Betreuerin wird Yuki gebeten seine Daten aus einem Versuch in einer Klimakammer mit Kartoffeln in einem Histogramm darzustellen. In ihrem Experiment hat er die seltsamen Verdickungen erst fotographiert und dann ausgezählt. Laut ihrer Betreuerin soll das Histogramm helfen, die Verteilung der die seltsamen Verdickungen zu bestimmen.

\begin{center}
Die seltsamen Verdickungen: 2, 3, 3, 6, 7, 1, 6, 4, 6, 1, 4, 5, 1, 1, 3, 3, 4, 5, 4, 6, 1, 3, 5, 2, 5, 2, 4, 8, 2, 2
\end{center}
...
In einem Gespräch mit seinem Betreuer wird Steffen gebeten seine Daten aus einem Feldexperiment mit Kartoffeln in einem Histogramm darzustellen. In seinem Experiment hat er die mittleren Läsionen auf den Blättern erst fotographiert und dann ausgezählt. Laut seinem Betreuer soll das Histogramm helfen, die Verteilung der die mittleren Läsionen auf den Blättern zu bestimmen.

\begin{center}
Die mittleren Läsionen auf den Blättern: 9, 6.2, 7.7, 8.6, 8.2, 9, 9.8, 8.3, 10, 8.3, 8.7, 9.3, 4.4, 9.9, 12.7, 8.9, 9.3, 7.4, 11, 12.4, 8.9, 9.7, 9.8, 10.4, 10.9
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  20\% & $\alpha$-Fehler & H$_0$ wahr & Testentscheidung \\
  \end{tabular}
  \end{center}
...
Tina ist im Teuteburgerwald für einen Pilotexperiment mit sehr geringer Fallzahl $(n_1 = n_2 = 3)$ mit Kartoffeln. Allein diese Tatsache ist für sie eine Erzählung wert. Für ihre Abschlussarbeit musste sie ein Gewächshausexperiment mit Kartoffeln durchführen und das sollte laut ihrem Betreuer an diesem Ort besonders gut gelingen, da man hier gut neue technische Anlagen und Behandlungen fernab der Bevölkerung testen könne. Zeugen gibt es hier jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn ihre Behandlung Lichtstufen ($none$ und $600lm$) und der Messwert Trockengewicht [kg/ha] sollen mit einem t-Test ausgewertet werden. Immerhin weiß sie, dass ihr Messwert einer Normalverteilung folgt. 
...
Alex ist im Emsland für einen Versuch mit Kartoffeln. Allein diese Tatsache ist für ihn eine Erzählung wert. Für seiner Hausarbeit musste er ein Gewächshausexperiment mit Kartoffeln durchführen und das sollte laut seinem Betreuer an diesem Nichtort besonders gut gelingen. Ablenkung gibt es jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn seine Behandlung Düngestufen ($ctrl$ und $high$) und der Messwert Proteingehalt [g/kg] sollen mit einem t-Test ausgewertet werden. Immerhin weiß er, dass sein Messwert einer Normalverteilung folgt. 
...
Es gibt ja immer die Möglichkeit sich Hilfe zu holen. Das geht natürlich auch immer in einer Hausarbeit. Deshalb arbeiten Nilufar und Tina gemeinsam an einer Hausarbeit. Das macht dann auch die Analyse ihres Hauptversuches einfacher. Zwar hat jeder von ihnen noch ein Subthema, aber auch da kann man sich ja helfen. In dem Hauptversuch wurde Folgendes von den beiden gemacht. Nilufar und Tina haben sich Kartoffeln angeschaut. Dabei geht um Zusammenhang zwischen Düngung ($vorher$ und $nachher$) und Frischegewicht [kg/ha]. Jetzt sollen beide einen gepaarten t-Test rechnen.
...
Leider kennen sich Nilufar und Tina mit der Berechnung eines gepaarten t-Tests überhaupt nicht aus. Deshalb brauchen sie beide bei der Berechnung Ihre Hilfe!
...
'Wir sind uns relativ sicher, dass unser Messwert Trockengewicht [kg/ha] ist!', ruft Tina wild gestikulierend. Als würde sowas die Ausgabe von \Rlogo interessieren. Tina und Steffen sind in einem Cafè mit Nilufar um sich Hilfe von ihr in \Rlogo zu holen. Während Nilufar Kirschstreuselkuchen mampft, versuchen die beiden ihren Versuch im Teuteburgerwald mit Kartoffeln in einem Freilandversuch zu erklären. Nilufar hofft, dass die \Rlogo Ausgabe des t-Tests ihr mehr Informationen liefert.
...
Helfen Sie Nilufar bei der Interpretation des t-Tests! Sonst geht es auch für Tina und Steffen nicht weiter.
...
'Programmieren ist wie eine Sprache lernen. Man muss es nur machen, dann wird man mit der Zeit immer besser!', gibt Mark zwinkernd zu Protokoll. Das hilft jetzt Nilufar und Steffen nur bedingt, da beide jetzt die \Rlogo Ausgabe interpretieren müssen und nicht vor drei Wochen, wo noch Zeit gewesen wäre. Die beiden hatten im Teuteburgerwald einen Versuch mit Kartoffeln in einem Freilandversuch durchgeführt. Das war schon anstrengend genug! 'Wir haben Trockengewicht [kg/ha] gemessen, vieleicht hilft das ja...', meint Nilufar leicht genervt. Alle starren auf die \Rlogo Ausgabe des t-Tests.
...
Helfen Sie Mark bei der Interpretation des t-Tests! Sonst geht es auch für Nilufar und Steffen nicht weiter.
...
'Programmieren ist wie eine Sprache lernen. Man muss es nur machen, dann wird man mit der Zeit immer besser!', gibt Paula zwinkernd zu Protokoll. Das hilft jetzt Yuki und Alex nur bedingt, da beide jetzt die \Rlogo Ausgabe interpretieren müssen und nicht vor drei Wochen, wo noch Zeit gewesen wäre. Die beiden hatten im Teuteburgerwald einen Versuch mit Kartoffeln in einem Feldexperiment durchgeführt. Das war schon anstrengend genug! 'Wir haben Proteingehalt [g/kg] gemessen, vieleicht hilft das ja...', meint Alex leicht genervt. Alle starren auf die \Rlogo Ausgabe des t-Tests.
...
## t = -5.8712, df = 19, p-value = 1.182e-05
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -24.89656 -11.81071
## sample estimates:
...
Helfen Sie Paula bei der Interpretation des t-Tests! Sonst geht es auch für Yuki und Alex nicht weiter.
...
Alles voll mit Kartoffeln. Aber das haben Mark und Steffen eben gemeinsam in einer Abschlussarbeit gemacht! Worum ging es aber konkret? Beide haben als ein normalverteiltes Outcome ($Y$) Trockengewicht [kg/ha] von Kartoffeln bestimmt. Die Daten haben beide zusammen in einem Gewächshausexperiment erhoben. In dem Experiment ging es um eine vorher/nachher Untersuchung an den gleichen Kartoffeln. Als Behandlung wurde Jäten ($Aussaat$ und $Ernte$) eingesetzt. Nach der Meinung der Betreuerin muss hier ein gepaarter t-Test gerechnet werden. Leider kennen sich beide nicht sehr gut in \Rlogo aus.
...
## t = -4.5704, df = 8, p-value = 0.001825
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -27.516543  -9.061234
## sample estimates:
...
Jetzt brauchen Mark und Steffen Ihre Hilfe bei der Berechnung eines gepaarten t-Tests in \Rlogo um ihre Arbeit dann in diesem Semester noch abschließen zu können.
...
Steffen und Yuki schauen sich etwas entnervt an. Gemeinsam schreiben die beiden ihre Abschlussarbeit und sollen nun als erstes einmal die Daten visualisieren damit abgeschätzt werden kann, ob überhaupt signifikante Ergebnisse zu erwarten sind. Die beiden waren im Emsland um einen Versuch in einer Klimakammer mit Kartoffeln durchzuführen. Dabei haben Steffen und Yuki den Messwert Frischegewicht [kg/ha] unter der Behandung Düngestufen ($ctrl$, $low$ und $high$) ermittelt.
...
Leider kennen sich Steffen und Yuki mit Darstellung einer einfaktoriellen ANOVA überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe! 
...
'Als erstes bauen wir uns aus unsere Daten die ANOVA Tabelle dann sehen wir schon, ob unser Gruppenvergleich in der ANOVA signifikant ist.', Steffen schaut Mark fragend an und hofft auf eine positive Regung im Gesicht. Wird aber enttäuscht. Mark tut sich auch sehr schwer mit der einfaktoriellen ANOVA. Beide waren im Emsland um einen Versuch in einer Klimakammer mit Kartoffeln durchzuführen. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Substrattypen ($torf$, $40p60n$, $30p20n$ und $70p30n$) und dem Messwert Trockengewicht [kg/ha] gibt.



\vspace{1ex}

Leider kennen sich Steffen und Mark mit Berechnung einer einfaktoriellen ANOVA überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe! 
...
\toprule
    ...
    \midrule
   \textbf{Substrattypen}  & 3 & 4509.46 &  &  &  \strut\\
   \textbf{error}  & 23 & 730.83 &  &  &  \strut\\
...
Tina und Jonas schauen sich etwas entnervt an. Gemeinsam schreiben die beiden ihre Abschlussarbeit und sollen nun als erstes einmal die Daten mit eine einfaktoriellen ANOVA auswerten damit abgeschätzt werden kann, ob überhaupt signifikante Ergebnisse in den multipen Gruppenvergleichen zu erwarten sind. Nun möchte erstmal ihre Betreuung der Arbeit eine ANOVA Tabelle sehen. Was immer da auch drin zu erkennen sein mag. Tina schaut Jonas sehen erstmla gar nichts. Die beiden waren im Emsland um ein Freilandversuch mit Kartoffeln durchzuführen. Dabei haben Tina und Jonas den Messwert Trockengewicht [kg/ha] unter der Behandung Lüftungssystemen und Folientunneln ($ctrl$, $storm$, $thunder$ und $tornado$) ermittelt.
...
\toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Lüftungssystemen}  & 3 & 5695.64 &  &  &  \strut\\
   \textbf{Error}  & 33 & 1172.36 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
\begin{enumerate}
  \setcounter{enumi}{3}
\item Schätzen Sie den p-Wert der Tabelle mit $F_{\alpha = 5\%} = 2.89$ ab. Begründen Sie Ihre Antwort! \textbf{(2 Punkte)}
...
ctrl & 8 & 15.50 & 4.81\\
storm & 9 & 11.78 & 2.99\\
thunder & 10 & 34.60 & 8.14\\
tornado & 10 & 1.60 & 6.17\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
Jonas schaut entnervt auf und klappt den Laptop zu. Nun möchte sein Betreuer seinem Projektbericht erstmal eine ANOVA sehen und \textit{dann} die Ergebnisse präsentiert bekommen bevor es überhaupt mit der Abschlussarbeit weitergeht. Dabei war er extra im Emsland um einen Versuch in einer Klimakammer mit Kartoffeln durchzuführen. Und dort was es wirklich nicht schön geschweige denn spannend wie bei seinen Kommilitonen, die in Almería waren. Hätte er es vorher gewusst, dann hätte er die Abschlussarbeit bei wem anders geschrieben. Aber gut, jetzt als die ANOVA in \Rlogo.
...
## Lichtstufen  3 4823.0 1607.67   53.28 2.441e-12
## Residuals   31  935.4   30.17
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Wie absolut ärgerlich. Jetzt stellt sich tatsächlich heraus, dass seiner Betreuerin keine Anhnung von der zweifaktoriellen ANOVA hat. Woher soll Jonas jetzt das Wissen nehmen? Immerhin muss er ja noch mit seinem Projektbericht dieses Jahr fertig werden. In einen Versuch in einer Klimakammer hatte er Kartoffeln mit der Behandlung Lüftungssysteme ($ctrl$, $storm$, $thunder$ und $tornado$) sowie der Behandlung Genotypen ($AA$, und $BB$) im Emsland untersucht. Es wurde als Messwert Proteingehalt [g/kg] bestimmt. Jetzt muss er erstmal die zweifaktorielle ANOVA verstehen.
...
\begin{center}
  ...
  \toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Lüftungssysteme}  & 3 & 443.46 &  &  &  \strut\\
    \textbf{Genotypen}  & 1 & 6.95 &  &  &  \strut\\
    \textbf{Lüftungssysteme:Genotypen}  & 3 & 216.32 &  &  &  \strut\\
   \textbf{Error}  & 18 & 278.38 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
\midrule
  ...
  \textbf{Lüftungssysteme:Genotypen} & $5.23$ \\
  \bottomrule
  \end{tabular}
\end{center}
...
\item Was sagt der Term \textit{Lüftungssysteme:Genotypen} aus? Interpretieren Sie das Ergebnis! \textbf{(2 Punkte)}
\end{enumerate}
...
In ein Gewächshausexperiment wurden Kartoffeln mit der Behandlung Bewässerungstypen ($ctrl$, $low$, $mid$ und $high$) sowie der Behandlung Substrattypen ($torf$, $70p30n$) untersucht. Es wurde als Messwert Trockengewicht [kg/ha] bestimmt. Jetzt starrt Jonas mit auf die \Rlogo Ausgabe einer zweifaktoriellen ANOVA. Leider starrt sein Betreuer in der gleichen Art Jonas zurück an. Das wird ein langer Nachmmittag, denkt er sich und kreuselt seinen Mund. 'Und was machen wir jetzt?' entfährt es ihm überrascht entnervt. Immerhin war geht es ja um seine Hausarbeit. Jonas hätte doch nichts mit Kartoffeln machen sollen. Kartoffeln -- was soll das auch bedeutendes sein?
...
##                                 Df Sum Sq Mean Sq F value    Pr(>F)
## Bewässerungstypen                2 333.35 166.676 11.5968 0.0005807
## Substrattypen                    1  18.49  18.493  1.2867 0.2715381
## Bewässerungstypen:Substrattypen  2 339.27 169.633 11.8025 0.0005311
## Residuals                       18 258.71  14.373
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Leider kennen sich Tina und Jessica mit der Adjustierung von $p$-Werten und dem Signifikanzniveau $\alpha$ überhaupt nicht aus. Deshalb brauchen die beiden bei der Erstellung Ihre Hilfe!
...
Tina sitzt schon etwas länger bei ihrem Betreuer. So langsam macht Tina sich Gedanken, ob sie nicht doch mal anmerken sollte, dass sie von CLD noch nie was gehört hat. Aber noch kann gelauscht werden, ein Ende ist erstmal nicht in Sicht! Tina hatte in ihrem Projektbericht einen Versuch in einer Klimakammer durchgeführt. Deshalb sitzt sie hier. Also eigentlich nein, deshalb nicht. Tina will fertig werden. Hat sie sich doch mit Genotypen ($00$, $AA$, $AB$ und $BB$) und Proteingehalt [g/kg] schon eine Menge angeschaut. Tina beugt sich leicht nach vorne. Nein, doch keine Pause. Weiter warten auf eine Lücke im Fluss...
...
'Oh, nee!', ruft Paula aus und rollt entnervt mit ihren Augen. Paula hatte ihre gesamte Analyse in Excel gerechnet. Das war ja auch alles in Ordnung. Abbilungen haben geklappt und auch die statistischen Tests gingen dann irgendwie doch. Aber das CLD nicht. Paula findet einfach keine Möglichkeit ein CLD in Excel zu erhalten. Aber ihre Betreuerin möchte unbedingt ein CLD. Sonst wird es mit der Abgabe nichts. Dabei hatte sie schon wirklich eine Menge gemacht! Paula hatte sich zwei Variablen mit Düngestufen ($ctrl$, $low$, $mid$ und $high$) und Trockengewicht [kg/ha] in einen Versuch in einer Klimakammer mit Kartoffeln angeschaut. Wo kriegt sie jetzt ein CLD her? Dann eben per Hand aus der Matrix der $p$-Wert. Paula stöhnt...
...
\midrule
\textbf{ctrl} & 1.0000000 & 0.6710322 & 0.9700933 & 0.6131190\\
\textbf{low} & 0.6710322 & 1.0000000 & 0.6243883 & 0.9308686\\
\textbf{mid} & 0.9700933 & 0.6243883 & 1.0000000 & 0.5651919\\
\textbf{high} & 0.6131190 & 0.9308686 & 0.5651919 & 1.0000000\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
\item Interpretieren Sie das \textit{Compact letter display (CLD)} für Paula und Jessica! \textbf{(2 Punkte)} 
\end{enumerate}
...
Am Ende hätte Paula dann doch einen normalverteilten Endpunkt in ihrer Abschlussarbeit nehmen sollen. Vor ihr liegen jetzt die Daten von zwei Variablen als Kategorien oder wie es in \Rlogo so schön heißt, als Faktoren. Aber immerhin, hofft sie das was bei den Daten rausgekommen ist. Gezählt hat Paula einiges mit $n = 108$ Beobachtungen von Kartoffeln. Zum einen hat sie als Behandlung \textit{Pestizideinsatz [ja/nein]} bestimmt und zum anderen die Variable \textit{Trockengewicht über Zielwert [ja/nein]} ermittelt. Nun möchte ihr Betreuer gerne einen $\mathcal{X}^2$-Test auf einer $2x2$-Kreuztabelle berechnet bekommen.
...
Am Ende hätte Steffen dann doch einen normalverteilten Endpunkt in seinem Projektbericht nehmen sollen. Vor ihm liegen jetzt die Daten von zwei Variablen als Kategorien oder wie es in \Rlogo so schön heißt, als Faktoren. Aber immerhin, hofft er das was bei den Daten rausgekommen ist. Gezählt hat Steffen einiges mit $n = 134$ Beobachtungen von Kartoffeln. Zum einen hat er als Behandlung \textit{Pestizideinsatz [ja/nein]} bestimmt und zum anderen die Variable \textit{Proteingehalt im Zielbereich [ja/nein]} ermittelt. Nun möchte sein Betreuer gerne einen $\mathcal{X}^2$-Test auf einer $2x2$-Kreuztabelle berechnet bekommen.
...
Am Ende war es für Mark in seiner Abschlussarbeit dann doch kein normalverteiltes Outcome. Das was jetzt etwas doff, da er sich auf eine ANOVA gefreut hatte. Prinzipiell ginge das auch irgendwie, aber nun möchte seine Betreuerin gerne einen $\mathcal{X}^2$-Test auf einer $2x2$-Kreuztabelle berechnet bekommen. Mark hatte sich in ein Feldexperiment $n = 134$ Beobachtungen von Kartoffeln angeschaut. Dabei hat er als Behandlung \textit{Mechanische Bearbeitung [ja/nein]} bestimmt und zum anderen die Variable \textit{Trockengewicht über Zielwert [ja/nein]} ermittelt. Jetzt muss Mark mal schauen, wie er das jetzt rechnet. Nach seinem Experiment erhielt er folgende $2x2$ Kreuztabelle aus seinen erhobenen Daten.
...
'Wichtig ist es, dass wir jetzt eine Gerade durch die Punkte zeichnen!', ruft Jessica. 'Ich sehe nur eine Zahlen und keine Punkte. Wie soll ich da denn jetzt eine Gerade durchzeichnen?', fragt Nilufar. Jessica atmet schwer ein. Die beiden hatten ein Gewächshausexperiment im Emsland mit Kartoffeln durchgeführt. Dabei wurden die beiden folgenden Variablen gemessen: durchschnittlichen Anteil an Ton [\%/l] und Trockengewicht [kg/ha]. Jetzt will die Betreuung von den beiden einmal die Visualisierung der Daten und auch gleich noch die lineare Regression gerechnet bekommen.
...
Leider kennen sich Jessica und Nilufar mit der linearen Regression für kontinuierliche Daten überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe!
...
\midrule
(Intercept) & 4.44 & 1.74 &  & \\
Durchschnittliche Regenwurmdichte & -0.15 & 0.17 &  & \\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
## 
## Call:
## Chlorophyllgehalt ~ Durchschnittlicher_Niederschlag
## 
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -2.8277 -1.3200  0.0311  1.1865  3.3962 
## 
## Coefficients:
##                                 Estimate Std. Error t value Pr(>|t|)
## (Intercept)                       1.6683     2.1744   0.767    0.448
## Durchschnittlicher_Niederschlag   0.1345     0.2214   0.607    0.547
## 
## Residual standard error: 1.532 on 39 degrees of freedom
## Multiple R-squared:  0.009367,	Adjusted R-squared:  -0.01603 
## F-statistic: 0.3688 on 1 and 39 DF,  p-value: 0.5472
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: dosage, rainfall und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
Paula und Yuki sind bei Tina um sich Hilfe in \Rlogo zu holen. Dabei ging es um den Zusammenhang zwischen der Behandlung Bewässerungstypen ($ctrl$, $low$, $mid$ und $high$) und dem Messwert Proteingehalt [g/kg]. Der Versuch wurde in ein Freilandversuch im Wendland durchgeführt. Nach ihr Betreuer ist der Messwert Proteingehalt [g/kg] normalverteilt.

Nach einem erfolgreichen Pilotversuch zur Wirksamkeit von Lichtregimen bei Kartoffeln in ein Freilandversuch wollen Sie nun den Versuch eine Nummer größer anlegen. Dafür entscheiden Sie sich für ein faktorielles Versuchsdesign. In Ihrem Hauptversuch stellt die Wirksamkeit von Lichtregimen den ersten Faktor mit insgesamt 3 Leveln dar. Der zweite Faktor mit dem Gewächshaus beinhaltet 4 Level. \\

Im ersten Schritt überlegen Sie ein einfaches experimentelles Design zu probieren. Sie entscheiden sich für das \textit{Latin square design}.

Leider kennen sich Tina mit dem \textit{experimentelles Design} überhaupt nicht aus. Deshalb braucht sie bei der Erstellung Ihre Hilfe!



\begin{enumerate}
  \setcounter{enumi}{0}
\item Skizzieren Sie das \textit{Latin square design} für Ihren Versuch! \textbf{(4 Punkte)}
...
Tina: \textit{Warum nutzen wir eigentlich dieses \texttt{c()} in \Rlogo?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]
...
Tina: \textit{Wie heißen nochmal die beiden \Rlogo Pakete, die wir fast immer laden, wenn wir \Rlogo nutzen wollen?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

Tina: \textit{Was ist eigentlich ein Faktor in \Rlogo?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

Tina: \textit{Was ist der Unterschied zwischen \texttt{library()} und \texttt{Packages} und warum brauche ich sowas in \Rlogo?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

Tina: \textit{Was ist der Unterschied zwischen dem RStudio und R?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

Tina: \textit{Ich verstehe den Pipe-Operator nicht. Wie sieht der aus und was macht der? Gebe mal ein Beispiel!} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

Tina: \textit{Ich habe gehört, dass es Vorteile gibt \Rlogo zu nutzen. Nenne mir mal einen Vorteil!} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex] 
\clearpage
% -----------------------------------------------------------------------
...
'Unter den Blinden ist der Einäuge König!', ruft Ihnen Yuki entgegen. Das können Sie schon nicht mehr hören. Nur weil Sie einmal gesagt haben, dass Sie sich schonmal mit \Rlogo beschäftigt haben, stehen hier alle Schlange. Aber gut, das hat Sie dann doch vorangebracht. Leider kennt sich Yuki auch wieder überhaupt nicht mit \Rlogo aus aber ihre Betreuerin möchte gerne, dass die Auswertung in \Rlogo gemacht wird. Da müssen Sie dann wohl mal nochmal ran und helfen.\\[1Ex]
...
Das forschende Lernen basiert auf den folgenden wissenschaftlichen Veröffentlichungen. Für die Prüfung wird die vertiefende Kenntnis der folgenden Veröffentlichungen vorausgesetzt.\\
...
Das forschende Lernen basiert auf den folgenden Datensätzen und deren vertiefende Analyse werden als bekannt vorausgesetzt. Die Teilaufgaben der Aufgaben stellen nur eine zufällige Auswahl an möglichen Fragen dar. Die Datensätze werden über ILIAS bereitgestellt.
...
\begin{enumerate}
  ...
  \item Nennen Sie die untersuchten Endpunkte in der wissenschaftlichen Veröffentlichung! Wie lautet der primäre Enpunkt? \textbf{(2 Punkte)} 
\item Erstellen Sie das lineare Modell in der in \Rlogo üblichen schreibweise! \textbf{(2 Punkte)}
...
\section{Aufgabe \hfill (15 Punkte)}
...
Nilufar starrt auf den wissenschaftlichen Datensatz \textit{data4} in ihrem Laptop unter einem langen Schnaufen. 'Worum geht es denn eigentlich in diesem Datensatz?', fragt sie kopfschüttelnd. Nilufar soll die Datentabelle nutzen um das eigene Experiment zu planen und eine Blaupause zu haben. Als eine Vorlage sozusagen, die sie nur noch ausfüllen muss. Daher möchte ihr Betreuer, dass sie einmal die Daten sinnvoll zusammenfasst. Das sollte dann doch etwas aufwendiger werden.\\
...
\begin{enumerate}
  \setcounter{enumi}{0}
  \item Formulieren Sie die wissenschaftliche Fragestellung des Datensatzes! \textbf{(1 Punkt)}
  \item Nennen Sie die untersuchten Endpunkte in dem Datensatz! Wie lautet der primäre Enpunkt? \textbf{(2 Punkte)} 
  \item Skizzieren Sie eine bedeutende Abbildung für den primären Endpunkt im Kontext der wissenschaftlichen Fragestellung! \textbf{(2 Punkte)}
  \item Erstellen Sie das lineare Modell in der in \Rlogo üblichen schreibweise! \textbf{(2 Punkte)}
...
\begin{enumerate}
\item Wenn 6 Blaubeerschalen 10.74 Euro kosten,  wie viel kosten 10 Schalen? \textbf{(2 Punkte)}
...
\item Ein Kilo Salat benötigt 120l Wasser. Ein Salatkopf wiegt 300 - 520g.
\item Ein Kilo Avocado benötigt 980l Wasser. Eine Avocado wiegt 140 - 410g.
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2023 blieben die Erträge von Blaubeeren mit \ensuremath{7.7\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge steigerte sich um 5.1\%. Die Exporte für Avocados stiegen in dem gleichen Zeitraum um 21.2\% auf \ensuremath{2.1\times 10^{5}}t.
...
\midrule
drinking/eating & 36cm; 13cm; 7.2\% & 29cm; 23cm; 4.5\% & 30cm; 27cm; 10.1\%\\
standing & 29cm; 34cm; 8.1\% & 40cm; 27cm; 5.2\% & 32cm; 16cm; 6.3\%\\
preening & 31cm; 24cm; 1.2\% & 26cm; 26cm; 0.8\% & 34cm; 18cm; 1\%\\
wingflapping & 28cm; 25cm; 18.1\% & 36cm; 31cm; 18.1\% & 34cm; 35cm; 12.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
Radius von $3500$m kollabiert, wird die Sonne $35$\%
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC9T187 & 4.0 | 2.5 | Normal \\
    B & GCM2QIJ & 2.0 | 2.0 | Klein \\ 
    C & GCMUCIH & 4.5 | 4.5 | Normal \\ 
    D & GCBKORG & 3.5 | 1.0 | Normal \\ 
    E & GC5X62J & 1.0 | 1.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 827 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.2\times 10^{10}} - \ensuremath{9\times 10^{8}} \cdot 2.1^{-0.3 \cdot t + 3.1}
\end{equation*}
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  4-mal-gefaltete, 0.6mm, 30-cm-Karton} durch
