...
Sie f{\"u}hren ein Feldexperiment durch um das Gewicht von Erbsen zu
...
wurde an 53 Schweinen durchgef{\"u}hrt, wobei jedes Tier eine von
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 9, 11, 10 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.8 +/- 0.7
\item [\textbf{B} \msquare] Es ergibt sich 9.8 +/- 0.84
\item [\textbf{C} \msquare] Es ergibt sich 9.8 +/- 0.42
\item [\textbf{D} \msquare] Es ergibt sich 10.8 +/- 0.42
\item [\textbf{E} \msquare] Es ergibt sich 8.8 +/- 0.35
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 22, 20, 11, 16, 18, 17, 28, 28, 26, 16 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 +/- 16
\item [\textbf{B} \msquare] Es ergibt sich 20 [16, 28]
\item [\textbf{C} \msquare] Es ergibt sich 20 +/- 28
\item [\textbf{D} \msquare] Es ergibt sich 22 [17, 29]
...
In dem folgenden Histogramm von $n = 195$ Pflanzen ist welche
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 1.4, da es sich um ein Anteil handelt.
...
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.71, da es sich um ein Anteil handelt.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.42, 0.34 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.105, 0.085 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.105, 0.085 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1.68, 1.36 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1, 1 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1, 1 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\begin{center}
$6, 6, 8, 7, 4, 5, 10, 4, 6, 1, 5, 6, 4, 3, 4, 2, 4, 4, 6, 3, 1, 0, 3, 4, 6, 1, 7, 2, 1, 7, 1, 4, 2$
\end{center}
...
\begin{center}
$12.3, 10.9, 15, 11.4, 7.6, 10.9, 9.5, 12.7, 9.4, 11, 10.2, 9.6, 6.5, 12, 8.6, 7.3, 9.5$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  Richtige Entscheidung & $\alpha$-Fehler & (Unbekannte) Wahrheit & 5\% \\
  \end{tabular}
  \end{center}
...
Trockengewicht (\textit{drymatter}) von Brokoli.
...
\item Treffen Sie mit $T_{\alpha = 10\%} = 1.37$ und dem berechneten $T_{calc}$ eine Aussage
...
## t = 4.2603, df = 12, p-value = 0.001107
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  1.535523 4.750192
## sample estimates:
...
Der Datensatz \texttt{plant\_growth\_tbl} enth{\"a}lt das Trockengewicht der Lauchstangen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 1.19 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 50.29 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 183.24  91.619  41.229 1.904e-07
## Residuals 18  40.00   2.222
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 4.53 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 27.73 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 0.8 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 184.61 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 50 Ziegen durchgef{\"u}hrt, wobei
...
## Response: weight
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 227.14 113.569  24.766 6.790e-06
## form       1 184.53 184.531  40.241 5.619e-06
## dose:form  2 436.25 218.124  47.567 6.533e-08
## Residuals 18  82.54   4.586
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high     low       mid
## ctrl 1.0000000 0.1009636 0.0e+00 0.0726725
## high 0.1009636 1.0000000 0.0e+00 0.0012329
## low  0.0000000 0.0000000 1.0e+00 0.0000082
## mid  0.0726725 0.0012329 8.2e-06 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 102$ Pflanzen untersucht.
\vspace{5Ex}
...
## -5.0000 -1.5833 -0.2778  1.1667  4.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  14.7778     0.7886  18.739 2.61e-12
## waterB       -2.7778     1.1153  -2.491   0.0241
## 
## Residual standard error: 2.366 on 16 degrees of freedom
## Multiple R-squared:  0.2794,	Adjusted R-squared:  0.2344 
## F-statistic: 6.203 on 1 and 16 DF,  p-value: 0.02412
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.2794$ aus? \textbf{(2 Punkte)}
...
## t = -11.045, df = 8, p-value = 4.023e-06
...
Einflussvariablen ($x$) wurden erhoben: dosage, region und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\item $i$ dem Verhalten: (1) wing/leg stretching, (2) wingflapping, (3)
  drinking/eating und (4) foraging incl. scratching.
\end{itemize}
...
\midrule
wing/leg stretching & 39cm; 31cm; 0.4\% & 39cm; 32cm; 0.4\% & 36cm; 20cm; 0.8\%\\
wingflapping & 33cm; 28cm; 6.2\% & 45cm; 20cm; 3.2\% & 35cm; 29cm; 1.2\%\\
drinking/eating & 37cm; 35cm; 0.8\% & 30cm; 31cm; 0.9\% & 29cm; 31cm; 1.2\%\\
foraging incl. scratching & 31cm; 19cm; 13.2\% & 27cm; 33cm; 14.2\% & 37cm; 23cm; 18.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\item Sie entnehmen der Literatur folgende Aussage zur Verteilung der
  ...
  Abbildung!  \textbf{(1 Punkt)}
\item Ein Pute braucht Platz f{\"u}r sich
  selbst. Berechnen Sie nun die K{\"o}rperfl{\"a}che $a$, die ein Tier
  Pute einnimmt. Welche Annahmen haben Sie f{\"u}r die
  Berechnung der Putenk{\"o}rperfl{\"a}che getroffen? \textbf{(2
    Punkte)}
\end{enumerate}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCRM2CG & 5.0 | 2.5 | Mikro \\
    B & GC9DFAM & 2.5 | 4.0 | Klein \\ 
    C & GCZTA9L & 3.0 | 3.0 | Normal \\ 
    D & GC65NKA & 2.0 | 5.0 | Klein \\ 
    E & GCRHER9 & 1.5 | 4.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 821 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{8\times 10^{9}} - \ensuremath{9\times 10^{8}} \cdot 2^{-0.3 \cdot t + 3.1}
\end{equation*}
...
5000EUR im Monat \textit{passiv} erwirtschaften.
...
3.5\% p.a. {\"u}ber 36 Monate finanzieren.
...
Sie haben den Vektor $A = \{24, 21, 6\}$ und den Vektor $B = \{10, 2, -1\}$ gegeben.
