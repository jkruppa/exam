...
\begin{graybox}{Checkbox für die Version vom \today}
  ...
  Choice Fragen sowie \textbf{74} Rechen- und
  Textaufgaben.
\end{graybox}
...
\item [\textbf{B} \msquare] Die $\alpha$ Adjustierung wird meist ignoriert. Wenn die Annahmen an den statistischen Test richtig sind, kann auf eine Adjustierung verzichtet werden.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.42, 0.34 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.105, 0.085 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.105, 0.085 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1.68, 1.36 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
\item [\textbf{E} \msquare] Der Korrelationskoeffizienten nach Kendall wird genutzt, wenn das Outcome Y nicht normalverteilt ist. Der Korrelationskoeffizienten liegt zwischen -1 und 1.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 10, 8, 10 und 6.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 7 +/- 2
\item [\textbf{B} \msquare] Es ergibt sich 8 +/- 1
\item [\textbf{C} \msquare] Es ergibt sich 9 +/- 1
\item [\textbf{D} \msquare] Es ergibt sich 8 +/- 4
\item [\textbf{E} \msquare] Es ergibt sich 8 +/- 2
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 6, 14, 24, 15, 32, 15 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 15 +/- 14
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 14
\item [\textbf{C} \msquare] Es ergibt sich 24 [14, 32]
\item [\textbf{D} \msquare] Es ergibt sich 15 +/- 32
\item [\textbf{E} \msquare] Es ergibt sich 15 [14, 32]
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt drei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.08 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung von nur zwei der drei Verteilungsparameter: $\gamma_1$ und $\gamma_3$.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.08 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.08 liegt keine Overdispersion vor.
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es handelt sich um eine Normalverteilung mit N(15, 5).
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.38 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.5, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 0.03
\item [\textbf{B} \msquare] Eine possion Regression basiert auf dem maximum Likelihood Prinzip. Hierbei kann kein Effekt beschrieben werden. Im Zweifel hilft aber eine Quadrierung der Fehlerqudrate $\epsilon$.
\item [\textbf{C} \msquare] In einer possion Regression kann kein Effekt roh interpretiert werden. Es muss erst eine Confounderadjustierung durchgef{"u}hrt werden.
\item [\textbf{D} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.17
\item [\textbf{E} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 0.03
\end{enumerate}
...
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 310
...
\item [\textbf{E} \msquare] Wir machen Aussagen über den Nicht-Zustand/Keinen Effekt!
\end{enumerate}
...
$y = \{18, 21, 17, 19, 16, 19, 19\}$. Berechnen Sie folgende
...
\begin{center}
$8, 7.7, 12.4, 13.8, 7.7, 8.9, 5.9, 8.9, 10.8, 8.6, 10.1, 13.5, 10.3, 9.3, 12.3$
\end{center}
...
## t = -0.56032, df = 12, p-value = 0.5856
...
## 
## data:  weight by group
## t = -0.94943, df = 12, p-value = 0.3611
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.765572  1.479858
## sample estimates:
...
## t = 4.3612, df = 12, p-value = 0.0009264
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  3.224856 9.664033
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 72.15 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 24.29 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 162.215  81.107  30.333 4.743e-07
## Residuals 22  58.825   2.674
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 122 112 125 108 113  98 128 148 153 143 147 154
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 35.82 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 306.21 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 112.82 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 344.41 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 452.92 226.460 15.8110 0.0001087
## form       1   0.07   0.069  0.0048 0.9454223
## dose:form  2  52.01  26.005  1.8156 0.1912985
## Residuals 18 257.81  14.323
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 160$ Sauen. In dem Experiment wurde gemessen,
...
## -4.1111 -1.1111 -0.0556  1.6667  3.8889 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.000      1.056  17.995 4.77e-10
## trtB           8.111      1.317   6.159 4.88e-05
## 
## Residual standard error: 2.361 on 12 degrees of freedom
## Multiple R-squared:  0.7597,	Adjusted R-squared:  0.7397 
## F-statistic: 37.94 on 1 and 12 DF,  p-value: 4.877e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, center und variety. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.56 & 0 & 7.92 & 97.71 & 67.44 & 14\\
10.06 & 0 & 9.79 & 101.55 & 69.87 & 7\\
10.59 & 0 & 9.70 & 97.50 & 67.44 & 13\\
8.85 & 1 & 11.04 & 101.66 & 68.54 & 15\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.3133 -1.4648 -0.0225  1.5341  7.0065 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  8.73566    8.96299   0.975   0.3324
## Fe           0.68423    0.08819   7.759 1.52e-11
## P           -0.47919    0.19405  -2.469   0.0155
## water       -0.26374    0.18578  -1.420   0.1593
## 
## Residual standard error: 2.507 on 87 degrees of freedom
## Multiple R-squared:  0.4353,	Adjusted R-squared:  0.4159 
## F-statistic: 22.36 on 3 and 87 DF,  p-value: 8.01e-11
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & no3 & acerage & so4\\
\midrule
PINEY\_BR & 48 & 8.3 & 4.70 & 4011 & 5.38\\
NORTH\_BR\_CASSELMAN\_R & 16 & 7.4 & 0.29 & 17419 & 2.50\\
OWENS\_CR & 80 & 8.6 & 1.02 & 9961 & 9.07\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.972  -4.770  -1.316   1.134  19.445  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  3.427e+00  1.419e+00   2.415 0.019523
## do2         -1.081e-01  1.704e-01  -0.635 0.528684
## no3          2.858e-01  9.046e-02   3.160 0.002705
## acerage      6.313e-05  1.684e-05   3.749 0.000468
## so4         -2.021e-02  2.523e-02  -0.801 0.426943
## 
## (Dispersion parameter for quasipoisson family taken to be 44.06516)
## 
##     Null deviance: 2415.4  on 53  degrees of freedom
## Residual deviance: 1627.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.52     0.0381   0.970
## 2 water           0.150   -0.388    0.698
## 3 nematodes       0.149    1.34     0.180
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 791.7
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1741 -0.6018 -0.0728  0.5006  3.5110 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  201.7   14.20   
##  subject  (Intercept) 3945.5   62.81   
##  Residual              634.2   25.18   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.063     26.486   7.667
## attitudepop  -20.714      5.533  -3.744
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0006441 0.0000133 0.0000003
## high 0.0006441 1.0000000 0.1845470 0.0112712
## low  0.0000133 0.1845470 1.0000000 0.1918254
## mid  0.0000003 0.0112712 0.1918254 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 4, 11, 12, 11 und 2!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 4, 12, 11, 10 und 12! \textbf{(2 Punkte)}
...
$1.3mm$ pro Jahr aus. Es ist bekannt, dass die Eiche im
...
einen Radius von 4cm und eine H{\"o}he von 8cm. Der
...
\begin{quote}
  >>Ohne ausreichende Zufuhr von Vitamin C stellen sich nach 70 Tagen die
...
$5$\%iger Lichtgeschwindigkeit los um sich auf den erreichten
Planeten selbst zu replizieren. Nach $250$ Jahren ist die
...
\item Bei einem vermutetet Alter der Erde von $\ensuremath{4.1\times 10^{9}}$ Jahren,
  ...
  $\ensuremath{9\times 10^{8}}$ Jahre vollst{\"a}ndig im Erdinneren umgewandelt haben! \textbf{(2
    Punkte)}
...
Sie haben den Vektor $A = 12, -8, 6$ und den Vektor $B = 7, 4, 4$ gegeben.
...
Sie haben die Wahrscheinlichkeit $Pr(A) = 0.1$ f{\"u}r das Ereignis
$A$, die Wahrscheinlichkeit $Pr(B) = 0.25$ f{\"u}r das Ereignis $B$ und
die Wahrscheinlichkeit $Pr(A \land B) = 0.1$ f{\"u}r das Ereignis
$A \land B$ gegeben.



Erkl{\"a}ren Sie das Konzept der bedingten Wahrscheinlichkeit Pr(B|A) an einer 2x2 Kreuztabelle und  einem Baumdiagramm.
