...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.01, 0.89 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.04, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.0025, 0.2225 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.0025, 0.2225 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.04, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.04, 3.56 und 1.36. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 7, 6, 2 und 9.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 6 +/- 6.5
\item [\textbf{B} \msquare] Es ergibt sich 7 +/- 1.275
\item [\textbf{C} \msquare] Es ergibt sich 5 +/- 3.25
\item [\textbf{D} \msquare] Es ergibt sich 6 +/- 1.275
\item [\textbf{E} \msquare] Es ergibt sich 6 +/- 2.55
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 15, 33, 32, 27, 18, 13 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 27 +/- 15
\item [\textbf{B} \msquare] Es ergibt sich 29 +/- 15
\item [\textbf{C} \msquare] Es ergibt sich 27 +/- 33
\item [\textbf{D} \msquare] Es ergibt sich 27 [15, 33]
\item [\textbf{E} \msquare] Es ergibt sich 29 [16, 34]
\end{enumerate} 
...
$y = \{17, 17, 18, 18, 15, 19, 19\}$. Berechnen Sie folgende
...
\begin{center}
$8.3, 9.2, 7.4, 9, 11.5, 9.7, 9.7, 13.9, 10.9, 12.2, 10.1, 9.9, 10.3, 6, 10.3$
\end{center}
...
## t = -1.7461, df = 16, p-value = 0.09996
...
## t = -3.2704, df = 14, p-value = 0.005581
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -6.255300 -1.300256
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 48.45 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 37.46 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 60.171 30.0856  40.937 8.505e-08
## Residuals 20 14.698  0.7349
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 110 110 134  97  91  88 128 139 146 135 152 145
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 114.39 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 156.67 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 114.31 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 278.24 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2 263.49 131.745  6.9374 0.00584
## form       1   0.82   0.821  0.0432 0.83766
## dose:form  2 130.89  65.444  3.4461 0.05406
## Residuals 18 341.83  18.991
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## (Intercept)   20.600      0.900  22.889 1.41e-08
## trtB          -6.000      1.273  -4.714  0.00151
## 
## Residual standard error: 2.012 on 8 degrees of freedom
## Multiple R-squared:  0.7353,	Adjusted R-squared:  0.7022 
## F-statistic: 22.22 on 1 and 8 DF,  p-value: 0.001514
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -4.8685, df = 8, p-value = 0.001242
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, center und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.25 & 0 & 9.90 & 100.06 & 68.94 & 6\\
10.02 & 0 & 10.14 & 101.87 & 71.69 & 8\\
7.97 & 0 & 11.21 & 90.62 & 64.43 & 13\\
7.04 & 0 & 10.89 & 103.80 & 72.43 & 15\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.1839 -1.3158  0.0123  1.3758  4.5257 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -10.72680    6.44193  -1.665   0.0993
## P            -0.45094    0.13949  -3.233   0.0017
## Fe            0.88686    0.06021  14.730   <2e-16
## water        -0.33235    0.13812  -2.406   0.0181
## 
## Residual standard error: 1.958 on 92 degrees of freedom
## Multiple R-squared:  0.7263,	Adjusted R-squared:  0.7174 
## F-statistic: 81.37 on 3 and 92 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & no3 & maxdepth & acerage\\
\midrule
BENNETT\_CR & 2 & 12.9 & 2.26 & 51 & 583\\
GREAT\_SENECA\_CR & 87 & 21.3 & 3.37 & 78 & 8624\\
GUNPOWDER\_FALLS & 22 & 18.0 & 3.30 & 65 & 12659\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.862  -3.868  -2.041   1.967  14.323  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 9.787e-01  8.374e-01   1.169 0.248139
## temp        4.372e-02  3.607e-02   1.212 0.231241
## no3         2.218e-01  6.329e-02   3.505 0.000987
## maxdepth    1.104e-02  3.940e-03   2.803 0.007235
## acerage     3.491e-05  1.239e-05   2.817 0.006977
## 
## (Dispersion parameter for quasipoisson family taken to be 34.04601)
## 
##     Null deviance: 2529.8  on 53  degrees of freedom
## Residual deviance: 1501.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>     <dbl>
## 1 (Intercept)     1.81       4.05 0.0000517
## 2 light           0.497      1.20 0.230    
## 3 water           0.179     -4.13 0.0000370
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2836 -0.5542 -0.0680  0.4133  3.2343 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  213.4   14.61   
##  subject  (Intercept) 4024.2   63.44   
##  Residual              666.0   25.81   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   202.31      26.78   7.555
## attitudepop   -20.39       5.67  -3.595
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0030821 0.0000000
## high 0.0000000 1.0000000 0.0000000 0.2640985
## low  0.0030821 0.0000000 1.0000000 0.0000000
## mid  0.0000000 0.2640985 0.0000000 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 6, 15, 6, 11 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 14, 14, 10, 12 und 6! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes grade, P und pigs an drei verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{-6, 2, -6\}$ und den Vektor $B = \{-4, 1, -4\}$ gegeben.
