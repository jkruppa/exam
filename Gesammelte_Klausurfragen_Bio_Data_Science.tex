...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.001, 0.03, 0.42 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 0.005, 0.15, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 2e-04, 0.006, 0.084 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 2e-04, 0.006, 0.084 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 0.005, 0.15, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 0.005, 0.15, 2.1 und 4.45. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 10, 5, 12 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.4 +/- 1.305
\item [\textbf{B} \msquare] Es ergibt sich 9.4 +/- 1.305
\item [\textbf{C} \msquare] Es ergibt sich 8.4 +/- 3.4
\item [\textbf{D} \msquare] Es ergibt sich 9.4 +/- 6.8
\item [\textbf{E} \msquare] Es ergibt sich 9.4 +/- 2.61
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 14, 28, 28, 34, 7, 20, 26, 10, 32, 14 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 +/- 14
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 14
\item [\textbf{C} \msquare] Es ergibt sich 26 [14, 32]
\item [\textbf{D} \msquare] Es ergibt sich 26 +/- 32
\item [\textbf{E} \msquare] Es ergibt sich 24 [14, 32]
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.34 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.42, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 2.4, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.42, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.29, da es sich um ein Anteil handelt.
...
In einem Stallexperiment mit $n = 83$ Ferkeln wurden verschiedene
...
\item [\textbf{B} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 0.01
...
\item [\textbf{E} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 0.12
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 4
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 8
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 5
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 10
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 3
\end{enumerate}
...
$y = \{16, 21, 12, 11, 26, 12, 11, 25, 22, 19, 16\}$. Berechnen Sie folgende
...
\begin{center}
$8.6, 10.9, 10, 8.6, 11, 8.6, 8.1, 13.4, 8.1, 9, 9.7, 8.9, 14.3, 10.3$
\end{center}
...
## t = -3.1163, df = 10, p-value = 0.01094
...
## t = 0.59735, df = 12, p-value = 0.5614
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.403875  5.975304
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = -3.7554, df = 12, p-value = 0.002744
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -12.149837  -3.227941
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 8.3 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 57.78 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 14.952  7.4762  4.5288 0.02552
## Residuals 18 29.714  1.6508
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1]  98 139 138 100  99 100 134 145 130 146 124 152
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 198.23 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2428.97 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 108.95 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 713.09 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df Sum Sq Mean Sq  F value    Pr(>F)
## supp       1  375.6  375.58  27.9525 1.276e-06
## dose       2 3636.5 1818.25 135.3223 < 2.2e-16
## supp:dose  2  101.6   50.78   3.7789    0.0275
## Residuals 72  967.4   13.44
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.3333 -1.8333 -0.3333  1.5000  8.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  16.0000     1.0138  15.782 3.56e-11
## trtB          0.3333     1.4337   0.232    0.819
## 
## Residual standard error: 3.041 on 16 degrees of freedom
## Multiple R-squared:  0.003367,	Adjusted R-squared:  -0.05892 
## F-statistic: 0.05405 on 1 and 16 DF,  p-value: 0.8191
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, N und block. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.45 & 0 & 8.11 & 95.24 & 67.09 & 6\\
9.93 & 0 & 9.15 & 99.53 & 68.91 & 12\\
9.89 & 0 & 11.93 & 98.61 & 68.77 & 5\\
9.96 & 0 & 9.84 & 100.35 & 67.55 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.3822 -1.3774 -0.0742  1.4813  5.4923 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.16470    6.92378  -0.024    0.981
## water       -0.03716    0.15526  -0.239    0.811
## Fe           0.70177    0.06735  10.420   <2e-16
## nematodes    0.03488    0.06285   0.555    0.580
## 
## Residual standard error: 2.215 on 109 degrees of freedom
## Multiple R-squared:  0.4997,	Adjusted R-squared:  0.4859 
## F-statistic: 36.28 on 3 and 109 DF,  p-value: 2.438e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
FLINTSTONE\_CR & 11 & 18.5 & 50 & 0.25 & 18943\\
BUSH\_CR & 32 & 18.0 & 120 & 2.93 & 19046\\
ISRAEL\_CR & 30 & 21.0 & 133 & 2.41 & 6260\\
MUDLICK\_RUN & 8 & 21.0 & 51 & 0.84 & 1507\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -7.052  -3.487  -1.264   0.988  16.438  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.272e+00  8.016e-01   1.587 0.119025
## temp        4.862e-02  3.506e-02   1.387 0.171755
## maxdepth    4.906e-03  4.220e-03   1.162 0.250707
## no3         2.128e-01  5.831e-02   3.649 0.000638
## acerage     3.605e-05  1.215e-05   2.966 0.004648
## 
## (Dispersion parameter for quasipoisson family taken to be 26.13105)
## 
##     Null deviance: 1793.7  on 53  degrees of freedom
## Residual deviance: 1086.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.50      1.74   0.0813
## 2 water           0.148    -1.64   0.101 
## 3 nematodes       0.146     0.244  0.807
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3060 -0.6266 -0.0924  0.5910  3.1852 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  234.6   15.32   
##  subject  (Intercept) 3969.0   63.00   
##  Residual              680.5   26.09   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.651     26.669   7.636
## attitudepop  -21.352      5.732  -3.725
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0079128 0.1407106 0.8360082
## high 0.0079128 1.0000000 0.1953461 0.0046668
## low  0.1407106 0.1953461 1.0000000 0.0952265
## mid  0.8360082 0.0046668 0.0952265 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 8, 3, 10, 7 und 14!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 12, 8, 9, 10 und 13! \textbf{(2 Punkte)}
...
haben einen Radius von 5cm und eine H{\"o}he von 7cm. Der
