...
\begin{graybox}{Ergebnis der Klausur}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 38 Punkten sind aus dem Rechen- und
    Textteil erreicht. 
  \item[] \rule[0ex]{3em}{.4pt}\, von 58 Punkten in Summe.
...
\end{center}
\begin{itemize}
\item Es sind \rule[0ex]{2em}{.4pt}\, von 38 Punkten erreicht worden.
\end{itemize}
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.01, 0.89, 0.03, 0.34 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.52, 0.06, 5.34, 0.18, 2.04 und 1.26. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.0017, 0.1483, 0.005, 0.0567 und 0.035. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.06, 1, 0.18, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.06, 1, 0.18, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.0017, 0.1483, 0.005, 0.0567 und 0.035. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 13, 10, 15 und 15.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12.8 +/- 1.915
\item [\textbf{B} \msquare] Es ergibt sich 11.8 +/- 3.83
\item [\textbf{C} \msquare] Es ergibt sich 11.8 +/- 1.915
\item [\textbf{D} \msquare] Es ergibt sich 11.8 +/- 14.7
\item [\textbf{E} \msquare] Es ergibt sich 10.8 +/- 7.35
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 24, 17, 18, 29, 18, 23 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 +/- 18
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 29
\item [\textbf{C} \msquare] Es ergibt sich 23 +/- 18
\item [\textbf{D} \msquare] Es ergibt sich 23 [18, 29]
\item [\textbf{E} \msquare] Es ergibt sich 26 [19, 30]
\end{enumerate} 
...
$y = \{23, 16, 17, 20, 22, 13, 21, 16, 17, 15, 22\}$. Berechnen Sie folgende
...
\begin{center}
$8.4, 13.9, 9.1, 9, 9.5, 10.9, 10.1, 7.9, 12.1, 10.8, 10.7, 10.7, 11.7, 9.4$
\end{center}
...
## t = 0.85575, df = 12, p-value = 0.4089
...
## t = -0.22412, df = 12, p-value = 0.8264
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.097415  2.519637
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 97.84 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 99.46 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 13.238  6.6190  1.7595 0.2005
## Residuals 18 67.714  3.7619
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 119 108 105 102  94 107 144 163 150 152 180 139
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 77.7 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 48.35 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 201.54 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 542.64 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2 186.11  93.056  5.4338 0.01425
## form       1   2.16   2.162  0.1263 0.72648
## dose:form  2 345.62 172.808 10.0908 0.00115
## Residuals 18 308.26  17.125
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   83  \strut\\
    \hline
...
## -4.0000 -1.7778 -0.3889  1.5556  4.2222 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.000      1.180   14.41 6.16e-09
## trtB          -1.222      1.472   -0.83    0.423
## 
## Residual standard error: 2.639 on 12 degrees of freedom
## Multiple R-squared:  0.05434,	Adjusted R-squared:  -0.02446 
## F-statistic: 0.6896 on 1 and 12 DF,  p-value: 0.4225
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 10.256, df = 8, p-value = 7.025e-06
...
Einflussvariablen ($x$) wurden erhoben: weight, variety und N. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
12.28 & 0 & 11.06 & 100.52 & 72.53 & 5\\
14.02 & 1 & 9.69 & 101.13 & 73.96 & 9\\
9.74 & 0 & 9.42 & 94.63 & 64.53 & 8\\
9.40 & 0 & 8.46 & 96.49 & 69.37 & 8\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##    Min     1Q Median     3Q    Max 
## -6.083 -1.621  0.258  1.725  4.311 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -7.232127   8.195157  -0.882   0.3800
## nematodes   -0.007167   0.084716  -0.085   0.9328
## Fe           0.768705   0.080812   9.512 4.96e-15
## light        1.273492   0.589270   2.161   0.0335
## 
## Residual standard error: 2.229 on 85 degrees of freedom
## Multiple R-squared:  0.5336,	Adjusted R-squared:  0.5171 
## F-statistic: 32.42 on 3 and 85 DF,  p-value: 4.579e-14
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & do2 & acerage & so4\\
\midrule
SOUTH\_BR\_CASSELMAN\_R & 2 & 0.64 & 7.6 & 6311 & 21.16\\
FALLS\_RUN & 15 & 2.19 & 9.4 & 1745 & 10.27\\
PINEY\_RUN & 36 & 2.17 & 9.2 & 11405 & 10.17\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.394  -3.487  -1.363   1.199   8.874  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.044e+00  1.076e+00   0.970   0.3369
## no3         1.339e-01  6.289e-02   2.129   0.0383
## do2         1.685e-01  1.236e-01   1.363   0.1791
## acerage     4.937e-05  1.026e-05   4.813 1.47e-05
## so4         8.176e-03  1.618e-02   0.505   0.6156
## 
## (Dispersion parameter for quasipoisson family taken to be 19.56789)
## 
##     Null deviance: 1429.1  on 53  degrees of freedom
## Residual deviance:  891.6  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.53       1.43  0.151 
## 2 water           0.153     -1.43  0.152 
## 3 light           0.502      2.15  0.0315
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.5859 -0.5787 -0.0752  0.5536  3.4308 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  212.9   14.59   
##  subject  (Intercept) 4021.8   63.42   
##  Residual              715.9   26.76   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.244     26.791   7.586
## attitudepop  -19.787      5.879  -3.366
## 
...
\begin{verbatim}
##           ctrl      high low       mid
## ctrl 1.0000000 0.0009663   0 0.1219472
## high 0.0009663 1.0000000   0 0.0490916
## low  0.0000000 0.0000000   1 0.0000000
## mid  0.1219472 0.0490916   0 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, 7, 8, 8 und 16!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 16, 9, 4, 11 und 15! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes grade, leaf und freshmatter an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCOFLWB & 3.5 | 3.0 | Klein \\
    B & GC7KYHZ & 4.5 | 3.5 | Normal \\ 
    C & GCJNMVL & 2.5 | 4.0 | Klein \\ 
    D & GCGTQS9 & 2.0 | 4.5 | Normal \\ 
    E & GCCEJIJ & 5.0 | 2.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
Jetzt hei{\ss}t es Kartons optimieren. Der nun zu optimierende Karton hat eine
L{\"a}nge von 40cm und eine Breite von 18cm. Die
...
Seitenl{\"a}ngen $a$ und $b$ bei der Verwendung von 100m Zaun bestimmen!
...
Sie haben den Vektor $A = \{-5, 6, 10\}$ und den Vektor $B = \{4, 3, 2\}$ gegeben.
