...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.001, 0.02, 0.21 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.7, 0.005, 0.1, 1.05 und 2.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.005, 0.1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 2e-04, 0.004, 0.042 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 2e-04, 0.004, 0.042 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.005, 0.1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 9, 10, 0 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 7.2 +/- 2.105
\item [\textbf{B} \msquare] Es ergibt sich 6.2 +/- 8.85
\item [\textbf{C} \msquare] Es ergibt sich 7.2 +/- 4.21
\item [\textbf{D} \msquare] Es ergibt sich 7.2 +/- 17.7
\item [\textbf{E} \msquare] Es ergibt sich 8.2 +/- 2.105
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 18, 24, 26, 24, 11, 23 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 +/- 18
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 26
\item [\textbf{C} \msquare] Es ergibt sich 24 [18, 26]
\item [\textbf{D} \msquare] Es ergibt sich 25 +/- 18
\item [\textbf{E} \msquare] Es ergibt sich 25 [19, 27]
\end{enumerate}
...
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.59 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.59 liegt keine Overdispersion vor.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.89 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 1.17, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.46, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.46, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\midrule
(Intercept) & 38.50 & 0.26\\
light\_binhigh & 3.26 & 0.36\\
\bottomrule
\end{tabular}
\end{table}
...
\item [\textbf{B} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 10.62
...
\item [\textbf{D} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 3.26
\item [\textbf{E} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 10.62
\end{enumerate}
...
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 275
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 548
...
$y = \{18, 12, 16, 16, 14, 13, 17, 17, 16, 14, 13\}$. Berechnen Sie folgende
...
\begin{center}
$8.5, 13.9, 10.3, 11.5, 10, 8.5, 6.4, 12.1, 8.6, 7.9, 13.5, 10.2, 10.3, 13.2$
\end{center}
...
## t = -0.67783, df = 12, p-value = 0.5107
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.465186  1.820742
## sample estimates:
...
## t = -0.79305, df = 12, p-value = 0.4431
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.353398  2.496255
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 32.08 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 48.16 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  5.7364  2.8682  1.8686 0.1803
## Residuals 20 30.6984  1.5349
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 121 117 109  94 112  96 135 126 133 150 158 153
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 46.34 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 130.86 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 49.24 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 267.39 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2 257.780 128.890 10.0395 0.001178
## form       1  45.696  45.696  3.5594 0.075449
## dose:form  2  82.844  41.422  3.2265 0.063456
## Residuals 18 231.088  12.838
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -3.4444 -1.4167  0.1111  1.3333  4.5556 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  15.4444     0.7556   20.44 6.84e-13
## trtB         10.8889     1.0686   10.19 2.11e-08
## 
## Residual standard error: 2.267 on 16 degrees of freedom
## Multiple R-squared:  0.8665,	Adjusted R-squared:  0.8581 
## F-statistic: 103.8 on 1 and 16 DF,  p-value: 2.114e-08
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 5.1622, df = 8, p-value = 0.0008613
...
Einflussvariablen ($x$) wurden erhoben: dry, fertilizier und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.23 & 0 & 11.80 & 94.69 & 63.75 & 17\\
9.30 & 0 & 9.22 & 96.83 & 64.07 & 9\\
10.79 & 0 & 11.94 & 98.30 & 69.10 & 4\\
11.00 & 1 & 7.54 & 99.51 & 67.58 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.2134 -1.7144  0.0983  1.8615  7.1305 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.77723    8.35693   0.332  0.74031
## Fe           0.75545    0.08046   9.389 1.44e-15
## water       -0.40231    0.17832  -2.256  0.02614
## P           -0.45718    0.16723  -2.734  0.00735
## 
## Residual standard error: 2.529 on 105 degrees of freedom
## Multiple R-squared:  0.4856,	Adjusted R-squared:  0.4709 
## F-statistic: 33.04 on 3 and 105 DF,  p-value: 4.029e-15
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & no3 & acerage & temp\\
\midrule
NORTH\_BR & 23 & 8.3 & 1.32 & 3836 & 18.5\\
BEAVER\_RUN & 37 & 8.1 & 5.66 & 1722 & 19.3\\
DEAD\_RUN & 25 & 8.7 & 0.34 & 4145 & 23.0\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -8.3597  -3.5108  -0.5952   2.0493  11.3374  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -1.773e+00  1.570e+00  -1.129   0.2645
## do2          1.483e-01  1.138e-01   1.303   0.1988
## no3          2.887e-01  6.523e-02   4.426 5.35e-05
## acerage      6.484e-05  1.265e-05   5.126 5.02e-06
## temp         1.385e-01  4.610e-02   3.003   0.0042
## 
## (Dispersion parameter for quasipoisson family taken to be 22.55765)
## 
##     Null deviance: 1997.0  on 53  degrees of freedom
## Residual deviance: 1064.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.351     0.199  0.842 
## 2 light           0.418     1.98   0.0476
## 3 nematodes       0.154    -0.163  0.870
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4364 -0.5898 -0.1115  0.5912  3.4507 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  195.9   13.99   
##  subject  (Intercept) 4119.7   64.19   
##  Residual              693.6   26.34   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.529     27.039   7.527
## attitudepop  -20.673      5.787  -3.573
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0001862 0.0000069 0.0000001
## high 0.0001862 1.0000000 0.2636846 0.0151382
## low  0.0000069 0.2636846 1.0000000 0.1626192
## mid  0.0000001 0.0151382 0.1626192 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 12, 9, 16, 8 und 13!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 9, 11, 13 und 4! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes grade, drymatter und freshmatter an vier verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{3, 11, 14\}$ und den Vektor $B = \{-1, 3, -5\}$ gegeben.
