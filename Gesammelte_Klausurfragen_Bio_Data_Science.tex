...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\square\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\item [\textbf{B} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Umweltbedingungen erklärt wird. Daher werden 28\% der Varianz durch die Umweltbedingungen erklärt. Der Anteil der Varianz durch die Behandlungsgruppen ist dann 72\%.
...
\item [\textbf{E} \msquare] Es werden 28\% der Varianz durch den Versuch erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der durch Fehler in der Versuchsdurchführung entsteht.
\end{enumerate} 
...
In einer Studie zur Bewertung der Wirkung von Vitamin D auf das Zahnwachstum bei Schweine entstand folgende Abbildung. Der Versuch wurde an 56 Tieren durchgeführt, wobei jedes Tier eine von  drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Welche Aussage ist im Bezug auf eine zweifaktorielle ANOVA richtig?
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 9, 17, 7 und 6.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.6 +/- 9.4
\item [\textbf{B} \msquare] Es ergibt sich 9.6 +/- 18.8
\item [\textbf{C} \msquare] Es ergibt sich 9.6 +/- 2.17
\item [\textbf{D} \msquare] Es ergibt sich 10.6 +/- 2.17
\item [\textbf{E} \msquare] Es ergibt sich 9.6 +/- 4.34
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 24, 25, 36, 26, 14, 28, 27, 8, 12, 14 und 51.
...
\item [\textbf{C} \msquare] Es ergibt sich 24 [15, 29]
\item [\textbf{D} \msquare] Es ergibt sich 25 +/- 28
\item [\textbf{E} \msquare] Es ergibt sich 25 [14, 28]
\end{enumerate} 
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.25, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.33, da es sich um eine Chancenverh{"a}ltnis handelt.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.42, 0.01, 0.03 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.084, 0.002, 0.006 und 0.068. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1, 0.05, 0.15 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1, 0.05, 0.15 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 2.1, 0.05, 0.15 und 1.7. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.084, 0.002, 0.006 und 0.068. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] $Pr(D|H_0)$ beschreibt die Wahrscheinlichkeit die Teststatistik $T$ aus den Daten zu beobachten, wenn die Nullhypothese wahr ist.
...
\begin{enumerate}
\item [\textbf{A} \msquare] Ja, die untersuchte Population k{"o}nnen wir mit einem statistischen Test auswerten. Wir erhalten eine Aussage zur Population.
...
\item [\textbf{E} \msquare] Ja, wir erhalten eine Aussage. M{"u}ssen aber das Individuum im Kontext der Population adjustieren.
\end{enumerate}
...
\item [\textbf{B} \msquare] Anhand des 95\%-Konfidenzintervalls l{"a}sst sich wie folgt eine Entscheidung treffen. Liegt der Wert in dem Signifikanzniveauintervall $\alpha$ dann kann die Nullhypothese abgelehnt werden.
...
\item [\textbf{E} \msquare] Anhand des 95\%-Konfidenzintervalls l{"a}sst sich wie folgt eine Entscheidung treffen. Liegt der Wert {"u}ber oder gleich dem Signifikanzniveau $\alpha$ dann kann die Nullhypothese abgelehnt werden.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Hypothesen $H_0$ und $H_A$ sind rein prosarischer Natur und bilden keinen mathematischen Hintergrund ab. In der Statistik wird die wissenschaftliche Fragestellung getestet. Daher stehen auch die verst{"a}ndlichen Hypothesen im Mittelpunkt der biologischen Interpretation.
\item [\textbf{B} \msquare] Es gibt ein statistisches Hypothesenpaar mit der Hypothese f{"u}r und gegen die wissenschaftliche Fragestellung. Die Hypothesen werden $H_{pro}$ und $H_{contra}$ bezeichnet.
...
In einem Gew{"a}chshausexperiment mit drei D{"u}ngestufen ($ctrl$, $low$ und $high$) als Behandlung
...
\begin{center}
$2, 0, 6, 2, 1, 3, 5, 3, 10, 2, 6, 3, 4, 8, 1, 3, 6, 4, 3, 2, 4, 5, 2, 4, 4, 5, 6, 3, 4, 5$
\end{center}
...
\begin{center}
$6.7, 11.8, 8.7, 11, 13.7, 6.8, 13.3, 9.3, 8.6, 9, 10.7, 13.1, 6.9, 12.5, 10, 8.6, 8.5$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ wahr & H$_0$ falsch & H$_0$ beibehalten & Richtige Entscheidung \\
  \end{tabular}
  \end{center}
...
## t = 3.4661, df = 12, p-value = 0.004664
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  1.939539 8.504905
## sample estimates:
...
## t = -1.9864, df = 14, p-value = 0.06693
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -7.8238010  0.2999915
## sample estimates:
...
In einem Gew{"a}chshausexperiment wurde der Ertrag von Brokoli unter drei verschiedenen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 49.54 &  &  &  \strut\\
    \hline
   \textbf{error}  & 20 &  &  &  &  \strut\\
        \hline
   \textbf{total}  & 22 & 83.83 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 188.1 &  &  &  \strut\\
    \hline
   \textbf{error}  & 18 & 334.57 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 53.415 26.7073  12.548 0.0002311
## Residuals 22 46.825  2.1284
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 26.4 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 195.7 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 82.77 &  &  &  \strut\\
    \hline
   \textbf{error}  & 24 & 174.2 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
jedes Tier eine von drei Selen-Dosen $dose$ ($0.5$ ng/Tag, $2$ ng/Tag und $20$ ng/Tag)
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 547.86 273.931 45.4038 9.279e-08
## form       1  58.46  58.463  9.6902  0.006007
## dose:form  2  58.30  29.152  4.8319  0.020905
## Residuals 18 108.60   6.033
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0006669 0.1556943 0.1385274
## high 0.0006669 1.0000000 0.0000104 0.0314645
## low  0.1556943 0.0000104 1.0000000 0.0055621
## mid  0.1385274 0.0314645 0.0055621 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   51   \strut\\
    \hline
     &  66 &  52 &  118  \strut\\
  \end{tabular}
\end{center}
...
## -4.6667 -1.8611 -0.6667  0.9722  7.3333 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.667      1.070  15.575 4.34e-11
## waterB        11.444      1.513   7.562 1.14e-06
## 
## Residual standard error: 3.21 on 16 degrees of freedom
## Multiple R-squared:  0.7814,	Adjusted R-squared:  0.7677 
## F-statistic: 57.19 on 1 and 16 DF,  p-value: 1.141e-06
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7814$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: dry, center und block. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\item Wenn Sie die 8 Blaubeerschalen gekauft haben, wie viele Aligatorbirnen zu je 2.59 EUR können Sie sich dann noch für 100 EUR leisten? \textbf{(1 Punkt)}
\end{enumerate}
...
\item Ein Kilo Strauchtomaten benötigt 190l Wasser. Eine Strauchtomate wiegt 110 - 130g.
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2021 blieben die Erträge von Blaubeeren mit \ensuremath{7.9\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge steigerte sich um 7.2\%. Die Exporte für Avocados stiegen in dem gleichen Zeitraum um 18.1\% auf \ensuremath{2.1\times 10^{5}}t.
...
\item $i$ dem Verhalten: (1) walking, (2) preening, (3)
...
\midrule
walking & 39cm; 28cm; 2.1\% & 38cm; 30cm; 2.1\% & 46cm; 31cm; 1.8\%\\
preening & 33cm; 26cm; 0.2\% & 37cm; 28cm; 0.4\% & 30cm; 32cm; 0.2\%\\
wingflapping & 32cm; 15cm; 8.1\% & 32cm; 22cm; 6.3\% & 40cm; 29cm; 8.1\%\\
foraging incl. scratching & 36cm; 21cm; 7.3\% & 30cm; 24cm; 0.9\% & 33cm; 24cm; 0.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCA9PWA & 1.5 | 3.0 | Klein \\
    B & GCYGZGG & 2.5 | 4.0 | Klein \\ 
    C & GCKIRJV & 1.0 | 1.0 | Klein \\ 
    D & GCNX3PG & 2.0 | 2.0 | Normal \\ 
    E & GCHLAMP & 5.0 | 2.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1043 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.1\times 10^{10}} - \ensuremath{10^{9}} \cdot 1.7^{-0.1 \cdot t + 2.4}
\end{equation*}
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  5-mal-gefaltete, 0.8mm, 60-cm-Karton} durch
