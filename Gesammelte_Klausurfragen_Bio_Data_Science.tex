...
Helfen Sie der Lerngruppe \textit{Die Kühe auf dem Deich} bei der Beantwortung der Forschungsfrage! Gehen Sie von einem radialen Wachstum der 1000-jährigen Eiche von $2mm$ pro Jahr aus. Es ist bekannt, dass die Eiche im Jahr 2022 einen Umfang von $11m$ in Brusthöhe hatte.
...
\midrule
$d_{1810} = 265.34cm$ & r = 0 + 2mm * Baumalter & $V_{eff} = 2.14m^3$ & $s_{Eiche} = 7.67cm$ & $s_{Platz} = -12.33cm$\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
