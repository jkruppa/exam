...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.21, 0.42 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.84, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.84, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.36, 0.84, 1.68 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.0525, 0.105 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.0525, 0.105 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 8, 12, 5, 12 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.6 +/- 4.65
\item [\textbf{B} \msquare] Es ergibt sich 9.6 +/- 1.525
\item [\textbf{C} \msquare] Es ergibt sich 9.6 +/- 9.3
\item [\textbf{D} \msquare] Es ergibt sich 9.6 +/- 3.05
\item [\textbf{E} \msquare] Es ergibt sich 10.6 +/- 1.525
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 19, 17, 20, 13, 27, 18 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 +/- 17
\item [\textbf{B} \msquare] Es ergibt sich 19 [17, 27]
\item [\textbf{C} \msquare] Es ergibt sich 19 +/- 17
\item [\textbf{D} \msquare] Es ergibt sich 19 +/- 27
\item [\textbf{E} \msquare] Es ergibt sich 24 [18, 28]
\end{enumerate} 
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.3, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 2.33, da es sich um ein Anteil handelt.
\end{enumerate}
...
$y = \{20, 19, 21, 19, 24, 20, 20\}$. Berechnen Sie folgende
...
\begin{center}
$6.7, 10.5, 11.6, 12.6, 11.6, 9.9, 11.7, 14.3, 12.7, 12.8, 11, 11.3$
\end{center}
...
## t = 2.3269, df = 16, p-value = 0.03343
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  0.3360787 7.2194768
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 147.95 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 41.27 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  7.238  3.6190     1.5 0.2497
## Residuals 18 43.429  2.4127
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 139 125 129  96  92  67 146 142 136 153 162 165
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 182.79 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 148.72 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 100.15 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 65 & 1475.27 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2   0.665   0.333  0.0204 0.979794
## form       1 230.529 230.529 14.1686 0.001421
## dose:form  2 123.010  61.505  3.7802 0.042594
## Residuals 18 292.866  16.270
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##  -2.60  -1.40  -0.50   1.55   3.40 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.600      0.900  19.556 4.86e-08
## trtB          -2.200      1.273  -1.728    0.122
## 
## Residual standard error: 2.012 on 8 degrees of freedom
## Multiple R-squared:  0.2719,	Adjusted R-squared:  0.1809 
## F-statistic: 2.988 on 1 and 8 DF,  p-value: 0.1222
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: N, dosage und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.58 & 1 & 9.91 & 103.12 & 73.34 & 11\\
8.88 & 1 & 12.24 & 99.99 & 69.27 & 13\\
9.78 & 1 & 9.80 & 103.75 & 73.62 & 12\\
12.05 & 0 & 10.82 & 101.14 & 67.82 & 17\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.9807 -2.5910  0.4223  2.4690  7.7865 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 70.67511    2.77146  25.501   <2e-16
## water       -0.13618    0.25900  -0.526    0.600
## nematodes    0.02261    0.10841   0.209    0.835
## light        0.98893    0.84058   1.176    0.242
## 
## Residual standard error: 3.705 on 103 degrees of freedom
## Multiple R-squared:  0.01763,	Adjusted R-squared:  -0.01098 
## F-statistic: 0.6163 on 3 and 103 DF,  p-value: 0.606
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & maxdepth & do2 & so4 & temp\\
\midrule
SECOND\_MINE\_BR & 62 & 60 & 10.2 & 10.75 & 17.7\\
HOLLANDS\_BR & 38 & 85 & 10.5 & 11.44 & 12.0\\
BIG\_BR & 72 & 91 & 9.4 & 5.65 & 16.7\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.112  -4.588  -1.180   1.079  13.086  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -1.127222   1.876871  -0.601 0.550884
## maxdepth     0.018443   0.004744   3.888 0.000305
## do2          0.253062   0.139293   1.817 0.075373
## so4          0.020105   0.018850   1.067 0.291394
## temp         0.041293   0.044828   0.921 0.361491
## 
## (Dispersion parameter for quasipoisson family taken to be 32.58205)
## 
##     Null deviance: 1897.1  on 53  degrees of freedom
## Residual deviance: 1359.0  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.392    -1.39  0.163  
## 2 light           0.491     3.03  0.00243
## 3 nematodes       0.155    -0.491 0.624
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 799
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9509 -0.6142 -0.0993  0.6114  3.4345 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  214.5   14.65   
##  subject  (Intercept) 3930.4   62.69   
##  Residual              700.6   26.47   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.961     26.503   7.658
## attitudepop  -20.748      5.816  -3.567
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0024219 0.1967068 0.5321125
## high 0.0024219 1.0000000 0.0569678 0.0120593
## low  0.1967068 0.0569678 1.0000000 0.4971359
## mid  0.5321125 0.0120593 0.4971359 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 16, 10, 12, 10 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 11, 13, 11, 8 und 5! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes freshmatter, grade und P an drei verschiedenen Messterminen.
...
\item Berechnen Sie die L{\"a}nge der Rampe mit einem Anstellwinkel von
  $10^\circ$! \textbf{(2 Punkte)}
...
Sie haben den Vektor $A = \{10, -9, 5\}$ und den Vektor $B = \{9, 1, 1\}$ gegeben.
