...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.21, 0.02, 0.34, 0.03 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 5.34, 1.26, 0.12, 2.04, 0.18 und 2.52. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.12, 1, 0.18 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1483, 0.035, 0.0033, 0.0567, 0.005 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.12, 1, 0.18 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1483, 0.035, 0.0033, 0.0567, 0.005 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 4, 15, 8 und 4.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9 +/- 2.265
\item [\textbf{B} \msquare] Es ergibt sich 8 +/- 20.5
\item [\textbf{C} \msquare] Es ergibt sich 8 +/- 4.53
\item [\textbf{D} \msquare] Es ergibt sich 7 +/- 10.25
\item [\textbf{E} \msquare] Es ergibt sich 8 +/- 2.265
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 12, 14, 8, 36, 21, 25 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 [13, 37]
\item [\textbf{B} \msquare] Es ergibt sich 26 +/- 12
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 12
\item [\textbf{D} \msquare] Es ergibt sich 21 [12, 36]
\item [\textbf{E} \msquare] Es ergibt sich 21 +/- 36
\end{enumerate} 
...
$y = \{13, 13, 19, 18, 20, 16, 19\}$. Berechnen Sie folgende
...
\begin{center}
$8.1, 12.1, 12.1, 10.7, 12.2, 11.9, 9.9, 13.6, 5, 7.6, 10.7, 11.1, 9.9, 10$
\end{center}
...
## t = 0.29303, df = 12, p-value = 0.7745
...
## t = 3.0427, df = 14, p-value = 0.008776
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  1.044580 6.034785
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 42.75 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 43.49 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 126.382  63.191  16.207 4.719e-05
## Residuals 22  85.778   3.899
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 112 117 123 109 118  89 151 145 117 155 163 149
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 47.81 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 580.31 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 67.82 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 635.32 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2  83.783  41.891  4.5016 0.0259845
## form       1  92.443  92.443  9.9338 0.0055167
## dose:form  2 229.661 114.831 12.3396 0.0004222
## Residuals 18 167.506   9.306
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.2222 -1.5556 -0.2222  1.7778  5.7778 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  16.6667     0.9112  18.291 3.77e-12
## trtB         10.5556     1.2886   8.191 4.07e-07
## 
## Residual standard error: 2.734 on 16 degrees of freedom
## Multiple R-squared:  0.8075,	Adjusted R-squared:  0.7954 
## F-statistic:  67.1 on 1 and 16 DF,  p-value: 4.075e-07
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: block, height und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
14.34 & 1 & 11.15 & 103.23 & 71.93 & 8\\
10.88 & 0 & 13.41 & 101.55 & 69.39 & 8\\
10.02 & 0 & 9.97 & 103.38 & 75.65 & 11\\
9.76 & 0 & 9.39 & 98.88 & 69.80 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.1340 -1.8109  0.0718  1.6273  7.3627 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.24934    7.06139   0.319 0.750684
## P           -0.55356    0.13995  -3.955 0.000136
## Fe           0.72970    0.06864  10.631  < 2e-16
## light        1.05658    0.48313   2.187 0.030885
## 
## Residual standard error: 2.316 on 109 degrees of freedom
## Multiple R-squared:  0.552,	Adjusted R-squared:  0.5397 
## F-statistic: 44.77 on 3 and 109 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
BROAD\_RUN & 53 & 22.2 & 3.25 & 11.12 & 1971\\
LITTLE\_GUNPOWDER\_R & 3 & 17.5 & 2.60 & 6.96 & 15305\\
NORTHWEST\_BR\_ANACOSTIA\_R & 100 & 23.0 & 1.41 & 14.45 & 22550\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.253  -4.906  -2.095   2.248  21.368  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.921e+00  8.675e-01   2.214  0.03150
## temp        4.649e-02  4.360e-02   1.066  0.29149
## no3         1.727e-01  6.970e-02   2.478  0.01672
## so4         2.506e-04  2.530e-02   0.010  0.99214
## acerage     4.090e-05  1.401e-05   2.919  0.00529
## 
## (Dispersion parameter for quasipoisson family taken to be 48.19844)
## 
##     Null deviance: 2483.9  on 53  degrees of freedom
## Residual deviance: 1775.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.394     0.450  0.653 
## 2 nematodes       0.149    -0.477  0.633 
## 3 light           0.531     2.07   0.0383
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1527 -0.6078 -0.0246  0.4779  3.5662 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  214.0   14.63   
##  subject  (Intercept) 3924.6   62.65   
##  Residual              669.6   25.88   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.720     26.469   7.659
## attitudepop  -21.167      5.685  -3.723
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0014419 0.0041541 0.0000031
## high 0.0014419 1.0000000 0.0000002 0.0388380
## low  0.0041541 0.0000002 1.0000000 0.0000000
## mid  0.0000031 0.0388380 0.0000000 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 12, 7, 13, 11 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 5, 12, 14, 16 und 13! \textbf{(2 Punkte)}
...
wollen diesmal endlich die abw{"a}rts Terrainchallenge durchf{\"u}hren. Die
...
Verf{\"u}gung. Sie starten an dem Ort B.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCJT3NG & 5.0 | 1.0 | Normal \\
    B & GCVGX1X & 1.0 | 1.5 | Mikro \\ 
    C & GCMBZN3 & 2.5 | 3.0 | Klein \\ 
    D & GCPNXHZ & 2.0 | 2.0 | Klein \\ 
    E & GCHED4Q & 3.5 | 3.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
s{"u}dlich. Vom Ort B betrachtet, bilden die Orte C und D einen
rechten Winkel am Ort B. Der Ort B liegt auf gerader Linie zwischen den
Orten C und E. Somit liegt der Ort E s{"u}dlich von B. Die
...
\item Welche Strecke in $km$ legen Sie bei der Bew{\"a}ltigung der
  abw{"a}rts Terrainchallenge zur{\"u}ck? Geben Sie
...
Sie haben den Vektor $A = \{11, 10, 20\}$ und den Vektor $B = \{-3, 5, 0\}$ gegeben.
