...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.89, 0.01, 0.34, 0.21 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1, 0.06, 1, 1 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0033, 0.1483, 0.0017, 0.0567, 0.035 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 5.34, 0.06, 2.04, 1.26 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1, 0.06, 1, 1 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0033, 0.1483, 0.0017, 0.0567, 0.035 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 5, 11, 3, -2 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 4.8 +/- 16.85
\item [\textbf{B} \msquare] Es ergibt sich 5.8 +/- 33.7
\item [\textbf{C} \msquare] Es ergibt sich 5.8 +/- 2.905
\item [\textbf{D} \msquare] Es ergibt sich 6.8 +/- 2.905
\item [\textbf{E} \msquare] Es ergibt sich 5.8 +/- 5.81
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 21, 25, 16, 21, 18, 27, 20, 19, 37, 12 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 +/- 27
\item [\textbf{B} \msquare] Es ergibt sich 23 [18, 27]
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 18
\item [\textbf{D} \msquare] Es ergibt sich 21 [18, 27]
\item [\textbf{E} \msquare] Es ergibt sich 23 +/- 18
\end{enumerate}
...
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.06 liegt keine Overdispersion vor.
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.06 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.14 ist
richtig?
...
\item [\textbf{E} \msquare] Y beinhaltet eine Spalte. Die Spalte gibt nicht die Verteilungsfamilie vor.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.43, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.75, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.75, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 1.33, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.43, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
In einem Stallexperiment mit $n = 117$ Ferkeln wurden verschiedene
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 9.37
...
\item [\textbf{C} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -3.06
\item [\textbf{D} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 9.37
...
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 18
...
$y = \{15, 21, 13, 16, 10, 16, 18\}$. Berechnen Sie folgende
...
\begin{center}
$11.3, 14.1, 8.7, 7.6, 13.5, 13.2, 9.7, 10.5, 8, 10.5, 11.8, 10.7, 11.4, 10.6, 9.8$
\end{center}
...
## t = -0.84223, df = 12, p-value = 0.4161
...
## 
## data:  drymatter by Fe
## t = 2.0073, df = 10, p-value = 0.07251
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.3364183  6.4507040
## sample estimates:
...
## t = 1.7961, df = 12, p-value = 0.09769
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.3044452  3.1615881
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 0.29 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 32 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 164.095  82.048  27.063 3.755e-06
## Residuals 18  54.571   3.032
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 110 132 107  89  98 102 153 124 135 137 164 143
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Sch{\"a}tzen Sie den p-Wert der Tabelle mit der Information von den
  ...
  $F_{supp} = 4.08$ und
  $F_{dose} = 2.84$ sowie
  $F_{supp:dose} = 2.84$ ab. Begr{\"u}nden Sie Ihre
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 324.11 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 182.08 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 29.71 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 1306.7 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 48 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: gain
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2 239.429 119.715 12.8789 0.0003372
## form       1  92.506  92.506  9.9518 0.0054822
## dose:form  2  63.809  31.905  3.4323 0.0546032
## Residuals 18 167.317   9.295
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 156$ Sauen. In dem Experiment wurde gemessen,
...
## -4.0000 -1.2500 -0.1667  1.4167  5.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  16.3333     0.8607  18.978 2.57e-10
## trtB         -0.3333     1.4402  -0.231    0.821
## 
## Residual standard error: 2.582 on 12 degrees of freedom
## Multiple R-squared:  0.004444,	Adjusted R-squared:  -0.07852 
## F-statistic: 0.05357 on 1 and 12 DF,  p-value: 0.8209
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -6.8911, df = 8, p-value = 0.0001256
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, center und weight. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.85 & 1 & 9.37 & 101.96 & 68.24 & 7\\
11.39 & 0 & 9.42 & 98.08 & 69.23 & 8\\
12.83 & 0 & 11.54 & 103.83 & 70.23 & 8\\
9.35 & 0 & 10.02 & 105.62 & 72.14 & 8\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.5140 -1.4273 -0.1302  1.4362  6.7247 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 11.14335    6.78251   1.643 0.103442
## water       -0.10997    0.13948  -0.788 0.432263
## P           -0.58290    0.14728  -3.958 0.000139
## Fe           0.65768    0.06619   9.936  < 2e-16
## 
## Residual standard error: 2.246 on 103 degrees of freedom
## Multiple R-squared:  0.5103,	Adjusted R-squared:  0.496 
## F-statistic: 35.77 on 3 and 103 DF,  p-value: 6.347e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & no3 & so4 & acerage\\
\midrule
BUSH\_CR & 32 & 18.0 & 2.93 & 11.31 & 19046\\
BEAVER\_RUN & 37 & 19.3 & 5.66 & 5.91 & 1722\\
ROCK\_CR & 3 & 18.0 & 2.47 & 7.61 & 575\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.802  -4.660  -1.854   1.782  20.110  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.008e+00  8.858e-01   2.266  0.02788
## temp         4.949e-02  4.370e-02   1.133  0.26293
## no3          2.059e-01  7.340e-02   2.805  0.00719
## so4         -1.755e-02  2.962e-02  -0.593  0.55620
## acerage      3.948e-05  1.417e-05   2.787  0.00754
## 
## (Dispersion parameter for quasipoisson family taken to be 43.63197)
## 
##     Null deviance: 2504.6  on 53  degrees of freedom
## Residual deviance: 1713.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.85       2.04 0.0417 
## 2 light           0.555      2.71 0.00681
## 3 water           0.184     -2.19 0.0288
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3268 -0.5653 -0.1000  0.5274  3.3662 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  217.2   14.74   
##  subject  (Intercept) 3919.7   62.61   
##  Residual              687.8   26.23   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.829     26.471   7.625
## attitudepop  -19.636      5.762  -3.408
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0098425 0.0000000
## high 0.0000000 1.0000000 0.0000000 0.7478345
## low  0.0098425 0.0000000 1.0000000 0.0000000
## mid  0.0000000 0.7478345 0.0000000 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 14, 13, 4, 8 und 3!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 19, 12, 7, 8 und 10! \textbf{(2 Punkte)}
...
ausgesendet. Gehen Sie von $6.23$ Lichtjahren als mittlerer
...
\item Bei einem vermutetet Alter der Erde von $\ensuremath{4.5\times 10^{9}}$ Jahren,
  ...
  $\ensuremath{8\times 10^{8}}$ Jahre vollst{\"a}ndig im Erdinneren umgewandelt haben! \textbf{(2
    Punkte)}
...
\paragraph{Von Vektoren und Matrizen}



Sie haben den Vektor $A = 19, 0, 5$ und den Vektor $B = -6, 2, 1$ gegeben.
...
\begin{enumerate}
\item Nennen Sie die logischen Operatoren f{\"u}r UND sowie ODER in \Rlogo!
  \textbf{(1 Punkt)}
\item Visualisieren Sie folgende logischen Aussagen zu der Menge $A$ und
  $B$ als Venn-Diagramme. Erg{\"a}nzen Sie die mathematische Notation!
  \textbf{(2 Punkte)}
  \begin{itemize}
  ...
  \end{itemize}
\item Erg{\"a}nzen Sie zu den Venn-Diagrammen die mathematische Notation!
  \textbf{(2 Punkte)}
\item Erstellen Sie den \texttt{numeric} \Rlogo Output f{\"u}r die
  ...
  \item ATGTGTAT
  \end{itemize}
\item Geben ist A mit 12. Erkl{\"a}ren Sie den
  Unterschied zwischen \texttt{A == 12} und \texttt{A != 12}
  in \Rlogo!  \textbf{(1 Punkt)}
\end{enumerate}
