...
wurde an 67 Schweinen durchgef{\"u}hrt, wobei jedes Tier eine von
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 8, 5, 10, 9 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 7 +/- 1.75
\item [\textbf{B} \msquare] Es ergibt sich 8 +/- 1.87
\item [\textbf{C} \msquare] Es ergibt sich 8 +/- 0.935
\item [\textbf{D} \msquare] Es ergibt sich 9 +/- 0.935
\item [\textbf{E} \msquare] Es ergibt sich 8 +/- 3.5
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 25, 20, 26, 14, 35, 21 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 27 +/- 20
\item [\textbf{B} \msquare] Es ergibt sich 27 [21, 36]
\item [\textbf{C} \msquare] Es ergibt sich 25 +/- 35
\item [\textbf{D} \msquare] Es ergibt sich 25 [20, 35]
\item [\textbf{E} \msquare] Es ergibt sich 25 +/- 20
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Den Mittelwert berechnen und die Abst{"a}nde quadrieren. Die Summe mit der Fallzahl multiplizieren.
...
In dem folgenden Histogramm von $n = 179$ Pflanzen ist welche
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.3, da es sich um ein Anteil handelt.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.01, 0.34, 0.21, 0.001 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1483, 0.0017, 0.0567, 0.035, 2e-04 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 5.34, 0.06, 2.04, 1.26, 0.006 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.06, 1, 1, 0.006 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.06, 1, 1, 0.006 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1483, 0.0017, 0.0567, 0.035, 2e-04 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Das R Paket emmeans erlaubt die Durchf{"u}hrung eines multiplen Gruppenvergleichs. Aus einem emmeans Objekt l{"a}sst sich recht einfach das CLD erstellen und so {"u}ber Barplots eine schnelle Interpration der statistischen Auswertung durchf{"u}hren.
\item [\textbf{B} \msquare] Das R Paket hmisc erlaubt die Durchf{"u}hrung eines multiplen Gruppenvergleichs aus verschiedenen Modellen heraus. Aus einem hmisc Objekt l{"a}sst sich recht einfach das CL-h erstellen und so {"u}ber Barplots eine schnelle Interpration der statistischen Auswertung durchf{"u}hren.
...
\item [\textbf{E} \msquare] In der Analogie der Maximaltemperatur: Was ist der maximale Unterschied zwischen zwei Gruppen. Wir erhalten hier eine Aussage {"u}ber die Spannweite und den maximalen Effekt.
\end{enumerate}
...
\item [\textbf{B} \msquare] Ja, die untersuchte Population k{"o}nnen wir mit einem statistischen Test auswerten. Wir erhalten eine Aussage zur Population.
...
\item [\textbf{D} \msquare] Nein, die untersuchte Population k{"o}nnen wir mit einem statistischen Test nicht auswerten. Wir erhalten keine Aussage zur Population.
...
Nach einem Freilandversuch mit drei L{"u}ftungssystemen und Folientunneln ($ctrl$, $storm$ und $tornado$) als Behandlung
...
\begin{center}
$4, 2, 6, 4, 0, 6, 5, 2, 4, 2, 5, 1, 6, 6, 2, 2, 4, 4, 0, 9, 6, 4, 4, 6, 6, 3, 7$
\end{center}
...
\item Berechnen Sie aus den Daten die \textit{Wahrscheinlichkeit}
  mehr als 6 L{\"a}sionen zu beobachten! \textbf{(1
    Punkt)}
...
\begin{center}
$11.1, 8, 9.6, 10.5, 9.4, 10.8, 11.8, 6.4, 12.9, 8.8, 7.6, 9.1, 11.2, 9, 8.7, 8.5, 12$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  20\% & $\beta$-Fehler & (Unbekannte) Wahrheit & H$_0$ beibehalten \\
  \end{tabular}
  \end{center}
...
## t = -0.18261, df = 14, p-value = 0.8577
...
## t = -4.4445, df = 12, p-value = 0.0008006
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -7.749201 -2.650799
## sample estimates:
...
In einem Freilandversuch wurde der Ertrag von Erdbeeren unter drei verschiedenen
...
Der Datensatz \texttt{plant\_growth\_tbl} enth{\"a}lt das Trockengewicht der Erbsenschoten
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 44.89 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 44.41 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 54.614 27.3071  13.451 0.0001988
## Residuals 20 40.603  2.0302
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 123.09 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 448.08 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 105.43 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 349.66 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 60 Ziegen durchgef{\"u}hrt, wobei
jedes Tier eine von drei Selen-Dosen $dose$ ($0.1$ ng/Tag, $3$ ng/Tag und $10$ ng/Tag)
...
## Response: gain
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2 168.34  84.171  3.3614 0.05749
## form       1  42.11  42.114  1.6818 0.21106
## dose:form  2 231.00 115.502  4.6126 0.02414
## Residuals 18 450.73  25.041
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000189 0.2975453 0.0349901
## high 0.0000189 1.0000000 0.0000009 0.0082815
## low  0.2975453 0.0000009 1.0000000 0.0026380
## mid  0.0349901 0.0082815 0.0026380 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 140$ Pflanzen untersucht.
\vspace{5Ex}
...
Experiment mit $n = 139$ Sauen. In dem Experiment wurde gemessen,
...
## (Intercept)   15.800      1.356  11.648 2.69e-06
## waterB        11.000      1.918   5.734 0.000437
## 
## Residual standard error: 3.033 on 8 degrees of freedom
## Multiple R-squared:  0.8043,	Adjusted R-squared:  0.7798 
## F-statistic: 32.88 on 1 and 8 DF,  p-value: 0.0004369
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.8043$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: N, block und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
preening & 51cm; 24cm; 3.5\% & 40cm; 30cm; 3.5\% & 29cm; 31cm; 10.1\%\\
walking & 30cm; 26cm; 2.1\% & 36cm; 28cm; 2.1\% & 38cm; 33cm; 3.5\%\\
standing & 33cm; 26cm; 4.1\% & 29cm; 26cm; 5.2\% & 31cm; 20cm; 5.1\%\\
drinking/eating & 37cm; 29cm; 16.4\% & 38cm; 29cm; 18.1\% & 34cm; 20cm; 18.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCCJEZZ & 3.0 | 1.5 | Mikro \\
    B & GCUAER6 & 2.0 | 4.0 | Mikro \\ 
    C & GCJVEDW & 2.5 | 5.0 | Mikro \\ 
    D & GCDXXDN & 4.0 | 4.5 | Mikro \\ 
    E & GC1PMEP & 1.5 | 1.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
\item Welche Strecke in $km$ legen Sie bei der Bew{\"a}ltigung der
  aufw{"a}rts Schwierigkeitschallenge zur{\"u}ck? \textbf{(4
    Punkte)}
...
man nicht alles im Jahr 257 n. Chr. f{\"u}r den neuen Lehnsherren
...
Kaninchenweibchens pro Jahr bei ca. 9 Tieren pro Wurf. Ein
Weibchen hat im Durchschnitt 6 W{\"u}rfe pro Jahr. Trotz fehlender
...
\item Die durchschnittliche, australische Lebenserwartung eines weiblichen
  Kaninchens liegt bei 7 Jahren. Wie viele weibliche Kaninchen
...
2.5\% p.a. {\"u}ber 72 Monate finanzieren.
...
Sie haben den Vektor $A = \{11, 21, -1\}$ und den Vektor $B = \{4, -1, 8\}$ gegeben.
