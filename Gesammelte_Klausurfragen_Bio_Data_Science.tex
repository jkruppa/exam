...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.02, 0.89 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.08, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0003, 0.005, 0.2225 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.08, 3.56 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0003, 0.005, 0.2225 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.08, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
\textit{r} zwischen $x$ mit 15, 3, 7, 7 und 14 sowie $y$ mit 22, 15, 14, 13 und 14.
\begin{equation*}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Kovarianz von 1191.02 sowie eine Korrelation von -0.57
\item [\textbf{B} \msquare] Es ergibt sich eine Kovarianz von 10.6 sowie eine Korrelation von 0.57
\item [\textbf{C} \msquare] Es ergibt sich eine Kovarianz von 10.6 sowie eine Korrelation von -0.57
\item [\textbf{D} \msquare] Es ergibt sich eine Kovarianz von -10.6 sowie eine Korrelation von 0.32
\item [\textbf{E} \msquare] Es ergibt sich eine Kovarianz von 112.36 sowie eine Korrelation von 0.32
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 9, 11, 13 und 6.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.6 +/- 1.305
\item [\textbf{B} \msquare] Es ergibt sich 9.6 +/- 6.8
\item [\textbf{C} \msquare] Es ergibt sich 9.6 +/- 2.61
\item [\textbf{D} \msquare] Es ergibt sich 9.6 +/- 1.305
\item [\textbf{E} \msquare] Es ergibt sich 8.6 +/- 3.4
\end{enumerate}
...
Berechnen Sie den Median und das IQR von $x$ mit 20, 23, 10, 9, 20, 17, 14, 22, 28, 21 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 20 [14, 23]
\item [\textbf{B} \msquare] Es ergibt sich 20 +/- 23
\item [\textbf{C} \msquare] Es ergibt sich 22 [14, 23]
\item [\textbf{D} \msquare] Es ergibt sich 20 +/- 14
\item [\textbf{E} \msquare] Es ergibt sich 22 +/- 14
\end{enumerate} 
...
\item [\textbf{E} \msquare] Der Begriff \textit{ordinary mean} beschreibt einen einzelnen Mittelwert eines Levels eines Faktors wohingegen der \textit{marginal mean} die unbedeutenden Mittelwerte beschreibt.
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.08 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.19 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.71, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.71, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 1.4, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.42, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.42, da es sich um ein Anteil handelt.
\end{enumerate}
...
\item [\textbf{B} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.17
\item [\textbf{C} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 0.03
\item [\textbf{D} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 0.03
...
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 76
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 39
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 38
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.98 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 8.84 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 201.83 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2418.3 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 104.37 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 710.34 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  3.57191 1.785955 4.59592 0.01915 *
## Residuals 27 10.49207 0.388595                  
## ---
...
Versuch wurde an 69 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: len
##           Df  Sum Sq  Mean Sq   F value                 Pr(>F)    
## supp       1  369.79  369.791  40.70165         0.000000023758 ***
## dose       2 3712.45 1856.224 204.30851 < 0.000000000000000222 ***
## supp:dose  2  177.98   88.992   9.79509             0.00019769 ***
## Residuals 63  572.38    9.085                                     
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   86  \strut\\
    \hline
...
Sie haben folgende Zahlenreihe $y$ vorliegen
$y = \{18, 18, 16, 19, 12, 20, 18\}$. Berechnen Sie folgende
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, block und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
In einem Stallexperiment mit $n = 94$ Ferkeln wurde der
...
\toprule
stream & longnose & acerage & so4 & do2 & maxdepth\\
\midrule
PINEY\_RUN & 36 & 11405 & 10.17 & 9.2 & 70\\
RED\_RUN & 32 & 3332 & 5.50 & 8.4 & 73\\
BIG\_PIPE\_CR & 18 & 25440 & 8.20 & 7.5 & 120\\
DORSEY\_RUN & 8 & 7814 & 20.24 & 6.8 & 160\\
\bottomrule
\end{tabular}
\end{table}
...
## -10.1693   -4.8737   -1.9134    1.1596   21.1429  
## 
## Coefficients:
##                 Estimate   Std. Error t value Pr(>|t|)  
## (Intercept)  0.249723594  1.700488147  0.1469  0.88385  
## acerage      0.000028727  0.000016665  1.7237  0.09106 .
## so4         -0.001234179  0.024811016 -0.0497  0.96053  
## do2          0.241426672  0.167369239  1.4425  0.15553  
## maxdepth     0.013346127  0.005080028  2.6272  0.01146 *
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 49.033716)
## 
##     Null deviance: 2424.58  on 53  degrees of freedom
## Residual deviance: 1835.60  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.396     -1.62  0.105 
## 2 nematodes       0.150      1.40  0.160 
## 3 light           0.518      2.06  0.0399
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
9.42 & 0 & 11.18 & 94.64 & 65.44 & 11\\
7.78 & 0 & 10.41 & 101.48 & 70.71 & 16\\
9.81 & 0 & 7.51 & 97.53 & 67.60 & 9\\
9.99 & 0 & 8.56 & 103.19 & 73.07 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.8125 -2.7780  0.2002  2.4312  8.1267 
## 
## Coefficients:
##             Estimate Std. Error t value             Pr(>|t|)    
## (Intercept) 75.61428    3.68378 20.5263 < 0.0000000000000002 ***
## water       -0.43127    0.23916 -1.8033              0.07413 .  
## light       -0.11028    0.77447 -0.1424              0.88703    
## P           -0.17362    0.24971 -0.6953              0.48837    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.4829 on 108 degrees of freedom
## Multiple R-squared:  0.034159,	Adjusted R-squared:  0.0073303 
## F-statistic: 1.2732 on 3 and 108 DF,  p-value: 0.28728
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -4.20000 -1.96429  0.54286  1.92143  4.80000 
## 
## Coefficients:
##             Estimate Std. Error t value     Pr(>|t|)    
## (Intercept) 16.20000    1.26672 12.7890 0.0000001602 ***
## trtB        -0.48571    1.65852 -0.2929       0.7756    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.8325 on 10 degrees of freedom
## Multiple R-squared:  0.0085038,	Adjusted R-squared:  -0.090646 
## F-statistic: 0.085767 on 1 and 10 DF,  p-value: 0.77562
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 795.2
## 
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.34101 -0.60907 -0.00373  0.53327  3.39788 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  214.27  14.638  
##  subject  (Intercept) 4049.97  63.639  
##  Residual              662.98  25.748  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 204.6864    26.8587  7.6209
## attitudepop -22.5578     5.6575 -3.9872
## 
...
\midrule
A & 16.00 & 16 & 14 & 17 & 15.5 & 17.0 & 1.33\\
B & 20.14 & 20 & 14 & 25 & 18.5 & 22.5 & 13.14\\
C & 11.57 & 11 & 6 & 18 & 9.5 & 13.5 & 16.95\\
D & 14.71 & 15 & 7 & 22 & 11.5 & 18.0 & 29.24\\
\bottomrule
\end{tabular}
\end{table}
...
## t = 1.7682, df = 12, p-value = 0.10242
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.78439241  7.53994797
## sample estimates:
...
## t = 0.288181, df = 12, p-value = 0.77812
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.9363358  5.1363358
## sample estimates:
...
## 
## data:  freshmatter by N
## t = 0.263371, df = 12, p-value = 0.79673
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.0779419  2.6493705
## sample estimates:
...
## t = -0.988714, df = 8, p-value = 0.35176
