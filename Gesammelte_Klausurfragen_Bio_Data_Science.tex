...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.42, 0.89 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1.68, 3.56 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.105, 0.2225 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.105, 0.2225 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
\item [\textbf{B} \msquare] Es ergibt sich 23 [13, 33]
\item [\textbf{C} \msquare] Es ergibt sich 20 [13, 33]
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Verteilung von Daten. Meistens dem Outcome oder auch $y$ genannt. Hierbei ist eine hohe Fallzahl notwendig.
\item [\textbf{B} \msquare] Die Verteilung von Daten. Meistens dem Outcome oder auch $y$ genannt. Die Darstellung ist auch mit einer kleinen Fallzahl m{"o}glich.
\item [\textbf{C} \msquare] Die Eigenschaften von Daten aufgeteilt nach zwei Gruppen eines Faktors $x$.
\item [\textbf{D} \msquare] Die Verteilung von Daten. Auch 2 bis 5 Beonachtungen k{"o}nnen noch dargestellt werden. Auch wenn es sich streng genommen um keine Darstellug einer Verteilung handelt.
...
In einer ANOVA wird die F Statistik nach der Formel
$F_{calc} = \cfrac{MS_{treatment}}{MS_{error}}$ berechnet. In einem t-Test
berechnen wir die T Statistik nach der Formel
$T_{calc} = \cfrac{\bar{y}_1 - \bar{y}_2}{s_p \cdot \sqrt{2/n_g}}$.
...
\item Erkl{\"a}ren Sie den Unterschied zwischen Ihren beiden Zeichnungen!
  \textbf{(2 Punkte)}
\item Wenn Sie eine signifikante Interaktion in Ihren Daten vorliegen
  haben, wie ist dann Ihr weiteres Vorgehen bei dem Posthoc-Tests?
  \textbf{(2 Punkte)}
\end{enumerate}
...
\item Erkl{\"a}ren Sie die Annahme der Normalverteilung und die Annahme der
  Varianzhomogenit{\"a}t an einer passenden Abbildung! \textbf{(2 Punkte)}
...
\item Erkl{\"a}ren Sie das Ergebnis der obigen einfaktoriellen ANOVA unter der
  Ber{\"u}cksichtigung der Annahmen an eine ANOVA! Geben Sie ein numerisches
  Beispiel! \textbf{(4 Punkte)}
\end{enumerate}
...
Nach einem Gew{\"a}chshausexperiment mit drei Bew{\"a}sserungstypen (A, B und C)
...
\item Zeichnen Sie in \textit{einer} Abbildung die Barplots f{\"u}r die
  Bew{\"a}sserungstypen! Beschriften Sie die Achsen entsprechend!  \textbf{(6
    Punkte)}
...
Nach einem Experiment z{\"a}hlen Sie folgende Anzahl an L{\"a}sionen auf den Beobachtungen nach einer durchgestandenen Infektion. 
...
\toprule
stream & longnose & temp & do2 & acerage & no3\\
\midrule
PINEY\_CR & 18 & 18.6 & 9.3 & 6949 & 4.57\\
MEADOW\_BR & 234 & 24.3 & 8.5 & 4803 & 5.01\\
FALLS\_RUN & 15 & 14.3 & 9.4 & 1745 & 2.19\\
LITTLE\_DEER\_CR & 38 & 20.5 & 9.6 & 8115 & 3.40\\
\bottomrule
\end{tabular}
\end{table}
...
## -8.4045  -3.9955  -2.0496   1.1367  21.7006  
## 
## Coefficients:
##                Estimate  Std. Error t value Pr(>|t|)   
## (Intercept) 0.460561685 1.756286702  0.2622 0.794239   
## temp        0.058462502 0.044126864  1.3249 0.191359   
## do2         0.140007530 0.149996548  0.9334 0.355188   
## acerage     0.000037885 0.000013537  2.7987 0.007316 **
## no3         0.190551081 0.069955949  2.7239 0.008917 **
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 44.463135)
## 
##     Null deviance: 2373.24  on 53  degrees of freedom
## Residual deviance: 1562.72  on 49  degrees of freedom
## AIC: NA
## 
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -8.44050 -1.77999  0.27398  2.16166  9.44344 
## 
## Coefficients:
##              Estimate Std. Error t value            Pr(>|t|)    
## (Intercept) 67.984201   2.547589 26.6857 <0.0000000000000002 ***
## nematodes    0.066230   0.097071  0.6823              0.4970    
## light        1.187267   0.786624  1.5093              0.1351    
## water        0.108572   0.230179  0.4717              0.6384    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.2891 on 82 degrees of freedom
## Multiple R-squared:  0.038005,	Adjusted R-squared:  0.00281 
## F-statistic: 1.0798 on 3 and 82 DF,  p-value: 0.36233
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.34675 -0.59678 -0.02361  0.59132  3.33404 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  266.15  16.314  
##  subject  (Intercept) 4022.42  63.423  
##  Residual              705.26  26.557  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 201.6852    26.9298  7.4893
