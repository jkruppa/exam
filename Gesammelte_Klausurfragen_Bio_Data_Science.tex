...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.34, 0.89 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.085, 0.2225 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 1 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 1 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1.36, 3.56 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.085, 0.2225 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
$\eta^2 = 0.14$. Welche Aussage ist richtig?
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 9, 7, 12 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.2 +/- 1.385
\item [\textbf{B} \msquare] Es ergibt sich 8.2 +/- 3.85
\item [\textbf{C} \msquare] Es ergibt sich 9.2 +/- 7.7
\item [\textbf{D} \msquare] Es ergibt sich 9.2 +/- 2.77
\item [\textbf{E} \msquare] Es ergibt sich 10.2 +/- 1.385
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 27, 21, 23, 20, 26, 23 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 [21, 27]
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 27
\item [\textbf{C} \msquare] Es ergibt sich 29 +/- 21
\item [\textbf{D} \msquare] Es ergibt sich 29 [21, 27]
\item [\textbf{E} \msquare] Es ergibt sich 23 +/- 21
\end{enumerate}
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.08 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 6.08
...
\item [\textbf{C} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 6.08
\item [\textbf{D} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -2.47
...
$y = \{15, 12, 14, 15, 14, 15, 18\}$. Berechnen Sie folgende
...
## t = 3.01801, df = 12, p-value = 0.010702
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  0.79711304 4.93622029
## sample estimates:
...
## t = -0.329099, df = 12, p-value = 0.74775
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.7095234  1.9984123
## sample estimates:
...
## t = -1.45866, df = 14, p-value = 0.16673
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -6.1171276  1.1647466
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = 2.03932, df = 4, p-value = 0.11103
## alternative hypothesis: true mean difference is not equal to 0
## 95 percent confidence interval:
##  -1.7349756 11.3349756
## sample estimates:
## mean difference 
##             4.8
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 111 125 123  96 117  89 159 147 132 152 147 160
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 4.44 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 9.96 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  3.15861 1.579305 3.52023 0.0438 *
## Residuals 27 12.11320 0.448637                 
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 202.35 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2421 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 109.02 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 717.19 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df  Sum Sq  Mean Sq   F value                 Pr(>F)    
## supp       1  580.88  580.878  45.07436        0.0000000031783 ***
## dose       2 3358.30 1679.152 130.29705 < 0.000000000000000222 ***
## supp:dose  2   71.91   35.954   2.78994               0.067811 .  
## Residuals 75  966.53   12.887                                     
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
In einem Stallexperiment mit $n = 101$ Ferkeln wurde der
...
## -5.1429 -1.4000  0.6000  1.6643  2.8571 
## 
## Coefficients:
##             Estimate Std. Error t value       Pr(>|t|)    
## (Intercept) 15.14286    0.87877 17.2318 0.000000009159 ***
## trtB        -0.74286    1.36139 -0.5457         0.5973    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.325 on 10 degrees of freedom
## Multiple R-squared:  0.028914,	Adjusted R-squared:  -0.068195 
## F-statistic: 0.29774 on 1 and 10 DF,  p-value: 0.59726
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: P, N und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
MEADOW\_BR & 234 & 5.01 & 10.98 & 93 & 4803\\
DEEP\_RUN & 5 & 1.30 & 21.68 & 57 & 1175\\
PINEY\_RUN & 36 & 2.17 & 10.17 & 70 & 11405\\
LITTLE\_GUNPOWDER\_R & 3 & 2.60 & 6.96 & 85 & 15305\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##      Min        1Q    Median        3Q       Max  
## -10.4880   -4.2792   -1.2433    1.1539   16.4327  
## 
## Coefficients:
##                 Estimate   Std. Error t value  Pr(>|t|)    
## (Intercept)  2.079516007  0.526328024  3.9510 0.0002494 ***
## no3          0.207215864  0.065666264  3.1556 0.0027378 ** 
## so4         -0.005548019  0.021923279 -0.2531 0.8012766    
## maxdepth     0.010469347  0.004229477  2.4753 0.0168173 *  
## acerage      0.000024732  0.000015634  1.5819 0.1200977    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 35.232417)
## 
##     Null deviance: 2206.14  on 53  degrees of freedom
## Residual deviance: 1520.57  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.76      1.92   0.0551
## 2 water           0.175    -1.77   0.0768
## 3 light           0.492     0.608  0.543
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
10.02 & 0 & 10.79 & 99.83 & 73.26 & 15\\
9.63 & 0 & 9.61 & 102.45 & 70.71 & 8\\
10.41 & 0 & 10.95 & 97.05 & 70.97 & 5\\
7.83 & 0 & 7.97 & 101.37 & 72.78 & 8\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -7.32833 -2.23865  0.29221  2.02294  7.11463 
## 
## Coefficients:
##              Estimate Std. Error t value              Pr(>|t|)    
## (Intercept) 74.730261   2.810334 26.5912 < 0.00000000000000022 ***
## P           -0.660310   0.201956 -3.2696              0.001435 ** 
## nematodes    0.091688   0.081917  1.1193              0.265437    
## water        0.087128   0.214641  0.4059              0.685579    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.06 on 111 degrees of freedom
## Multiple R-squared:  0.093656,	Adjusted R-squared:  0.06916 
## F-statistic: 3.8233 on 3 and 111 DF,  p-value: 0.011923
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.27770 -0.60174 -0.14624  0.49995  3.36380 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  221.99  14.899  
##  subject  (Intercept) 4094.68  63.990  
##  Residual              657.27  25.637  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 201.8934    27.0150  7.4734
## attitudepop -18.4687     5.6331 -3.2786
## 
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.0391192 0.0000000 0.0000001
## B 0.0391192 1.0000000 0.0000000 0.0000000
## C 0.0000000 0.0000000 1.0000000 0.0279215
## D 0.0000001 0.0000000 0.0279215 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
