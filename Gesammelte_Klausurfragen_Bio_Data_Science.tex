...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.01, 0.03 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.0025, 0.0075 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3.56, 0.04, 0.12 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.04, 0.12 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.0025, 0.0075 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.04, 0.12 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 5, 14, 8 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.2 +/- 11.7
\item [\textbf{B} \msquare] Es ergibt sich 7.2 +/- 5.85
\item [\textbf{C} \msquare] Es ergibt sich 9.2 +/- 1.71
\item [\textbf{D} \msquare] Es ergibt sich 8.2 +/- 1.71
\item [\textbf{E} \msquare] Es ergibt sich 8.2 +/- 3.42
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 30, 19, 29, 17, 22, 28 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 28 [19, 30]
\item [\textbf{B} \msquare] Es ergibt sich 27 [19, 30]
\item [\textbf{C} \msquare] Es ergibt sich 28 +/- 30
\item [\textbf{D} \msquare] Es ergibt sich 27 +/- 19
\item [\textbf{E} \msquare] Es ergibt sich 28 +/- 19
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.42 liegt keine Overdispersion vor.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.42 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt drei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.42 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung von nur zwei der drei Verteilungsparameter: $\gamma_1$ und $\gamma_3$.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.54 ist
richtig?
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.2, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.2, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\item [\textbf{B} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 0.02
...
\item [\textbf{D} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 0.02
\item [\textbf{E} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.15
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 3
...
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 5
\end{enumerate}
...
$y = \{19, 16, 18, 15, 17, 17, 16, 18, 19, 17, 16\}$. Berechnen Sie folgende
...
\begin{center}
$7.4, 8.5, 9.9, 10.5, 9.8, 10.4, 9.7, 10.3, 11.7, 8.2, 7.7, 14.3, 9.2, 10.2, 9$
\end{center}
...
## t = -5.2211, df = 10, p-value = 0.0003893
...
## t = 2.4468, df = 16, p-value = 0.02634
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  0.5938054 8.2950835
## sample estimates:
...
## 
## data:  freshmatter by N
## t = 3.4236, df = 16, p-value = 0.003482
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  1.777037 7.556296
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 28.3 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 43.17 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 26.138  13.069  5.3257 0.01399
## Residuals 20 49.079   2.454
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 114 122 117 109 103  91 138 136 133 142 135 147
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 91.25 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 305.39 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 294.02 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 776.53 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2 177.20  88.600  2.6915 0.09492
## form       1  34.42  34.421  1.0456 0.32006
## dose:form  2  36.02  18.008  0.5470 0.58798
## Residuals 18 592.54  32.919
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   93  \strut\\
    \hline
...
## -2.8000 -0.6286  0.3143  0.6214  2.2000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  14.8000     0.6405   23.11 5.21e-10
## trtB          0.7714     0.8387    0.92    0.379
## 
## Residual standard error: 1.432 on 10 degrees of freedom
## Multiple R-squared:  0.07801,	Adjusted R-squared:  -0.01419 
## F-statistic: 0.8461 on 1 and 10 DF,  p-value: 0.3793
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 5.7815, df = 8, p-value = 0.0004138
...
Einflussvariablen ($x$) wurden erhoben: region, block und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.23 & 0 & 10.63 & 102.52 & 67.99 & 18\\
9.86 & 0 & 10.55 & 99.80 & 69.34 & 5\\
11.19 & 1 & 9.53 & 102.91 & 71.77 & 8\\
9.12 & 1 & 9.70 & 99.99 & 68.18 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.2276 -1.5834  0.1725  1.7534  4.8652 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -11.72971    8.14139  -1.441    0.153
## nematodes    -0.05045    0.07995  -0.631    0.529
## Fe            0.84954    0.08007  10.610   <2e-16
## water        -0.29866    0.18642  -1.602    0.112
## 
## Residual standard error: 2.494 on 103 degrees of freedom
## Multiple R-squared:  0.5244,	Adjusted R-squared:  0.5105 
## F-statistic: 37.85 on 3 and 103 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & maxdepth & acerage & do2\\
\midrule
HAINES\_BR & 98 & 16.8 & 50 & 1967 & 8.6\\
BIG\_PIPE\_CR & 18 & 13.7 & 120 & 25440 & 7.5\\
WATTS\_BR & 19 & 26.5 & 82 & 510 & 6.7\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -10.659   -4.126   -1.603    1.331   14.813  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -3.043e+00  2.195e+00  -1.386  0.17197
## temp         1.244e-01  4.964e-02   2.507  0.01554
## maxdepth     1.275e-02  4.328e-03   2.946  0.00491
## acerage      1.584e-05  1.913e-05   0.828  0.41172
## do2          3.665e-01  1.719e-01   2.132  0.03805
## 
## (Dispersion parameter for quasipoisson family taken to be 37.5422)
## 
##     Null deviance: 2218.6  on 53  degrees of freedom
## Residual deviance: 1580.4  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.58      2.07   0.0382
## 2 water           0.149    -2.19   0.0286
## 3 nematodes       0.152     0.413  0.680
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 796.6
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1129 -0.6582 -0.2074  0.7210  3.1074 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  274.7   16.57   
##  subject  (Intercept) 4064.0   63.75   
##  Residual              664.0   25.77   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.028     27.063   7.465
## attitudepop  -20.500      5.662  -3.621
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0005983 0.0000005 0.0810994
## high 0.0005983 1.0000000 0.0201861 0.0532543
## low  0.0000005 0.0201861 1.0000000 0.0000970
## mid  0.0810994 0.0532543 0.0000970 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, 13, 14, 11 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 14, 9, 10 und 15! \textbf{(2 Punkte)}
