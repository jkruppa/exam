...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.03, 0.42 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.12, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.0075, 0.105 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.12, 1.68 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.0075, 0.105 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.12, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 20, 6, 15, 2 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.8 +/- 3.56
\item [\textbf{B} \msquare] Es ergibt sich 10.8 +/- 3.56
\item [\textbf{C} \msquare] Es ergibt sich 10.8 +/- 50.7
\item [\textbf{D} \msquare] Es ergibt sich 10.8 +/- 7.12
\item [\textbf{E} \msquare] Es ergibt sich 9.8 +/- 25.35
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 10, 6, 17, 19, 24, 30, 25, 17, 14, 9 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 17 [10, 25]
\item [\textbf{B} \msquare] Es ergibt sich 17 +/- 10
\item [\textbf{C} \msquare] Es ergibt sich 19 +/- 10
\item [\textbf{D} \msquare] Es ergibt sich 19 [11, 26]
\item [\textbf{E} \msquare] Es ergibt sich 17 +/- 25
\end{enumerate} 
...
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.3, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 2.33, da es sich um ein Anteil handelt.
...
$y = \{18, 14, 11, 17, 13, 14, 18, 18, 13, 16, 17\}$. Berechnen Sie folgende
...
Nach einem Gew{\"a}chshausexperiment mit drei Substrattypen ($torf$, $40p60n$ und $70p30n$) als Behandlung 
...
\begin{center}
$9.9, 15.3, 10.7, 10.5, 10, 13.8, 8.3, 8.1, 12.9, 10.5, 13.4, 9.5, 10.9, 7.1$
\end{center}
...
## t = -0.43741, df = 12, p-value = 0.6696
...
## t = -0.10047, df = 12, p-value = 0.9216
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.032922  3.677366
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = 0.72028, df = 16, p-value = 0.4817
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.806801  5.695690
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 13.92 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 70.32 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 42.634 21.3168  5.1419 0.01472
## Residuals 22 91.206  4.1457
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 112 125 123  97  78  95 139 140 129 149 156 155
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 94.47 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 100.49 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 193.62 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 222.93 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
jedes Tier eine von drei Selen-Dosen $dose$ ($0.2$ ng/Tag, $2$ ng/Tag und $10$ ng/Tag)
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 108.62  54.312  3.2677 0.061564
## form       1 235.84 235.840 14.1893 0.001412
## dose:form  2 232.00 116.001  6.9792 0.005704
## Residuals 18 299.18  16.621
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##  -5.00  -1.15  -0.20   1.35   5.00 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.000      1.292  12.386 2.17e-07
## waterB         8.200      2.001   4.098  0.00215
## 
## Residual standard error: 3.418 on 10 degrees of freedom
## Multiple R-squared:  0.6267,	Adjusted R-squared:  0.5894 
## F-statistic: 16.79 on 1 and 10 DF,  p-value: 0.002153
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.6267$ aus? \textbf{(2 Punkte)}
...
## t = 3.5211, df = 8, p-value = 0.007833
...
Einflussvariablen ($x$) wurden erhoben: block, fertilizier und N. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.41 & 0 & 7.56 & 102.53 & 74.11 & 2\\
7.68 & 0 & 8.70 & 102.06 & 71.59 & 10\\
8.16 & 0 & 9.04 & 102.03 & 75.70 & 11\\
10.51 & 0 & 9.62 & 103.57 & 70.95 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.1582 -1.4793  0.1325  1.6033  4.1872 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -8.31643    8.30202  -1.002   0.3194
## nematodes    0.04245    0.08584   0.495   0.6223
## Fe           0.81983    0.07718  10.622   <2e-16
## P           -0.45641    0.18711  -2.439   0.0168
## 
## Residual standard error: 2.323 on 83 degrees of freedom
## Multiple R-squared:  0.6046,	Adjusted R-squared:  0.5903 
## F-statistic:  42.3 on 3 and 83 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & temp & acerage & do2\\
\midrule
LITTLE\_DEER\_CR & 38 & 3.40 & 20.5 & 8115 & 9.6\\
SECOND\_MINE\_BR & 62 & 4.17 & 17.7 & 2511 & 10.2\\
LITTLE\_FALLS & 84 & 3.54 & 19.5 & 1600 & 10.2\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.334  -4.810  -2.128   1.382  22.277  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 2.237e-01  1.889e+00   0.118   0.9063
## no3         1.615e-01  7.322e-02   2.205   0.0322
## temp        7.604e-02  5.193e-02   1.464   0.1495
## acerage     3.225e-05  1.724e-05   1.870   0.0674
## do2         1.401e-01  1.538e-01   0.911   0.3666
## 
## (Dispersion parameter for quasipoisson family taken to be 48.07621)
## 
##     Null deviance: 2283.6  on 53  degrees of freedom
## Residual deviance: 1702.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.49      2.46  0.0137 
## 2 nematodes       0.157     0.665 0.506  
## 3 water           0.145    -2.76  0.00577
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 802.6
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2684 -0.5455 -0.0995  0.6629  3.3401 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  194.3   13.94   
##  subject  (Intercept) 4016.5   63.38   
##  Residual              740.1   27.20   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.443     26.736   7.572
## attitudepop  -20.749      5.977  -3.471
## 
...
\begin{verbatim}
##           ctrl      high low       mid
## ctrl 1.0000000 0.0029111   0 0.4337158
## high 0.0029111 1.0000000   0 0.0208525
## low  0.0000000 0.0000000   1 0.0000000
## mid  0.4337158 0.0208525   0 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 16, 13, 16, 7 und 9!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 16, 10, 15, 6 und 9! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, grade und leaf an vier verschiedenen Messterminen.
...
Kannibalismus. Wenn der Nachbar nervt, dann muss zu Ma{\ss}nahmen gegriffen
...
\item $i$ dem Verhalten: (1) walking, (2) sitting, (3)
  wingflapping und (4) preening.
\end{itemize}

Test test hjasjj kaskas lasladlad
...
\caption{\label{tab:unnamed-chunk-62}Extract from four publications on the daily percentage of time spent on a behaviour.}
\centering
\begin{tabular}[t]{lllll}
\toprule
\rotatebox{30}{ } & \rotatebox{30}{Aldridge et al.} & \rotatebox{30}{Baxter et al.} & \rotatebox{30}{Jabcobs et al.} & \rotatebox{30}{Ma et al.}\\
\midrule
walking & 25.4 & 64.1 & 50.1 & 25.4\\
sitting & 1.8 & 1.8 & 1.8 & 2.1\\
wingflapping & 8.1 & 6.3 & 8.1 & 3.6\\
preening & 0.8 & 0.8 & 1.2 & 1.2\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCRUYK5 & 4.5 | 4.0 | Klein \\
    B & GCOWJG0 & 2.0 | 2.5 | Normal \\ 
    C & GC7REYI & 3.5 | 3.0 | Mikro \\ 
    D & GCDIQ9S & 3.0 | 5.0 | Normal \\ 
    E & GCMU8D2 & 5.0 | 3.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1016 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{12, 10, 7\}$ und den Vektor $B = \{6, -3, 2\}$ gegeben.
