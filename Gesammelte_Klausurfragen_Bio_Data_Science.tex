...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.01, 0.42 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0025, 0.105 und 0.2225. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.04, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.04, 1.68 und 3.56. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.04, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0025, 0.105 und 0.2225. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 19, 11, 11, 10 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.6 +/- 2.225
\item [\textbf{B} \msquare] Es ergibt sich 11.6 +/- 19.8
\item [\textbf{C} \msquare] Es ergibt sich 10.6 +/- 9.9
\item [\textbf{D} \msquare] Es ergibt sich 11.6 +/- 4.45
\item [\textbf{E} \msquare] Es ergibt sich 12.6 +/- 2.225
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 12, 17, 20, 15, 16, 12, 29, 21, 28, 26 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 +/- 15
\item [\textbf{B} \msquare] Es ergibt sich 20 +/- 28
\item [\textbf{C} \msquare] Es ergibt sich 20 [15, 28]
\item [\textbf{D} \msquare] Es ergibt sich 24 [15, 28]
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.92 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.92 liegt keine Overdispersion vor.
\end{enumerate}
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.62, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.62, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.38, da es sich um ein Anteil handelt.
...
\item [\textbf{B} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 0.07
\item [\textbf{C} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.27
...
\item [\textbf{E} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 0.07
\end{enumerate}
...
$y = \{21, 21, 20, 17, 26, 21, 23\}$. Berechnen Sie folgende
...
\begin{center}
$13.3, 10.6, 8.7, 10.9, 9, 9.1, 11.1, 8.7, 10.3, 7.3, 11.2, 7.9$
\end{center}
...
## 
## data:  weight by group
## t = 2.5561, df = 10, p-value = 0.02856
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##   0.762548 11.123166
## sample estimates:
...
## 
## data:  freshmatter by N
## t = -2.6221, df = 4, p-value = 0.05867
## alternative hypothesis: true mean difference is not equal to 0
## 95 percent confidence interval:
##  -14.8238574   0.4238574
## sample estimates:
## mean difference 
##            -7.2
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 117 130 114 103 113 110 139 153 146 159 128 157
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.41 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.63 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  3.4054 1.70270  3.6475 0.03961 *
## Residuals 27 12.6039 0.46681                  
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 199.16 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2416.42 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 105.59 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 712.52 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df Sum Sq Mean Sq  F value    Pr(>F)    
## supp       1  124.4  124.45  13.1421 0.0005677 ***
## dose       2 3512.4 1756.22 185.4629 < 2.2e-16 ***
## supp:dose  2   57.2   28.59   3.0195 0.0557246 .  
## Residuals 65  615.5    9.47                       
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
Experiment mit $n = 120$ Sauen. In dem Experiment wurde gemessen,
...
## -10.2222  -1.0167   0.2778   2.4833   5.7778 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   17.400      1.892   9.197 8.78e-07 ***
## trtB          -2.178      2.360  -0.923    0.374    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 4.23 on 12 degrees of freedom
## Multiple R-squared:  0.06628,	Adjusted R-squared:  -0.01153 
## F-statistic: 0.8518 on 1 and 12 DF,  p-value: 0.3742
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: S, N und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & so4 & do2 & temp & no3\\
\midrule
HAY\_MEADOW\_BR & 5 & 4.46 & 9.5 & 20.1 & 3.53\\
ISRAEL\_CR & 30 & 13.77 & 9.5 & 21.0 & 2.41\\
MEADOW\_BR & 234 & 10.98 & 8.5 & 24.3 & 5.01\\
GREAT\_SENECA\_CR & 87 & 7.51 & 8.6 & 21.3 & 3.37\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -8.2336  -5.0083  -2.4900  -0.0707  21.5128  
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)  
## (Intercept)  1.85127    2.17488   0.851   0.3988  
## so4         -0.00150    0.02479  -0.061   0.9520  
## do2          0.06910    0.17376   0.398   0.6926  
## temp         0.03961    0.05502   0.720   0.4750  
## no3          0.16113    0.08271   1.948   0.0571 .
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 58.79545)
## 
##     Null deviance: 2335.6  on 53  degrees of freedom
## Residual deviance: 2064.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.75       2.25  0.0242
## 2 water           0.178     -2.37  0.0177
## 3 light           0.453      1.68  0.0937
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
8.81 & 0 & 10.72 & 96.55 & 67.42 & 12\\
8.38 & 1 & 8.98 & 96.81 & 68.41 & 12\\
10.46 & 0 & 10.20 & 98.83 & 67.99 & 8\\
9.91 & 0 & 9.30 & 98.69 & 69.28 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.9286 -1.7320 -0.0138  1.5346  7.4345 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -1.49095    8.66171  -0.172    0.864    
## light        0.42477    0.56851   0.747    0.457    
## Fe           0.71030    0.08525   8.332 6.83e-13 ***
## nematodes   -0.02572    0.07239  -0.355    0.723    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.436 on 93 degrees of freedom
## Multiple R-squared:  0.4437,	Adjusted R-squared:  0.4258 
## F-statistic: 24.73 on 3 and 93 DF,  p-value: 7.506e-12
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4255 -0.5946 -0.0204  0.5521  3.4597 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  203.4   14.26   
##  subject  (Intercept) 4022.4   63.42   
##  Residual              688.6   26.24   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.030     26.756   7.551
## attitudepop  -19.206      5.766  -3.331
## 
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.0007416 0.0000001 0.8002553
## B 0.0007416 1.0000000 0.0056142 0.0014879
## C 0.0000001 0.0056142 1.0000000 0.0000003
## D 0.8002553 0.0014879 0.0000003 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
