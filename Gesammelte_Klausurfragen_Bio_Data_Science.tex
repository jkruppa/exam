...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.34, 0.89, 0.21 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1, 1, 1 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1.7, 4.45, 1.05 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.068, 0.178, 0.042 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1, 1, 1 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.068, 0.178, 0.042 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 4, 4, 10, 16 und 6.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8 +/- 2.55
\item [\textbf{B} \msquare] Es ergibt sich 8 +/- 5.1
\item [\textbf{C} \msquare] Es ergibt sich 7 +/- 13
\item [\textbf{D} \msquare] Es ergibt sich 9 +/- 2.55
\item [\textbf{E} \msquare] Es ergibt sich 8 +/- 26
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 17, 14, 13, 21, 21, 18, 20, 29, 22, 30 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 +/- 17
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 17
\item [\textbf{C} \msquare] Es ergibt sich 23 [18, 30]
\item [\textbf{D} \msquare] Es ergibt sich 21 [17, 29]
\item [\textbf{E} \msquare] Es ergibt sich 21 +/- 29
\end{enumerate} 
...
$y = \{18, 7, 18, 16, 16, 16, 15, 11, 17, 11, 13\}$. Berechnen Sie folgende
...
\begin{center}
$11.9, 7.4, 13.4, 12.3, 7.2, 8.2, 8.8, 10.2, 8.9, 10.8, 11.7, 7.3, 8.4, 10.1$
\end{center}
...
den Boniturnoten (\textit{grade}) von Maiss.
...
## t = 0.70535, df = 12, p-value = 0.4941
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.984286  5.841429
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 117.97 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 92.98 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 159.62  79.812  13.645 0.0001831
## Residuals 20 116.98   5.849
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 130 118 110  95 115  94 136 152 128 168 131 156
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 300.32 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 137.34 &  &  &  \strut\\
    \hline
...
## Response: gain
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2 209.96 104.978  4.4184 0.02747
## form       1  15.84  15.836  0.6665 0.42494
## dose:form  2 156.25  78.127  3.2882 0.06064
## Residuals 18 427.67  23.759
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -6.6000 -1.3333  0.1667  1.6000  4.4000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)    9.600      1.246   7.703 5.53e-06
## waterB         2.733      1.554   1.758    0.104
## 
## Residual standard error: 2.787 on 12 degrees of freedom
## Multiple R-squared:  0.2049,	Adjusted R-squared:  0.1386 
## F-statistic: 3.092 on 1 and 12 DF,  p-value: 0.1041
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.2049$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: S, height und weight. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.37 & 0 & 8.21 & 99.67 & 70.88 & 7\\
11.30 & 0 & 9.42 & 99.71 & 70.51 & 7\\
8.52 & 0 & 7.69 & 99.05 & 72.56 & 9\\
12.72 & 1 & 7.50 & 99.76 & 70.52 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.3742 -1.4827  0.1856  1.5123  4.6303 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.26414    7.14684   0.177  0.85994
## P           -0.64382    0.14865  -4.331 3.38e-05
## water       -0.44594    0.16337  -2.730  0.00743
## Fe           0.79740    0.06699  11.903  < 2e-16
## 
## Residual standard error: 2.163 on 106 degrees of freedom
## Multiple R-squared:  0.6176,	Adjusted R-squared:  0.6068 
## F-statistic: 57.06 on 3 and 106 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & temp & maxdepth & acerage\\
\midrule
DEER\_CR & 26 & 5.26 & 19.1 & 60 & 8297\\
DORSEY\_RUN & 8 & 0.44 & 22.6 & 160 & 7814\\
SECOND\_MINE\_BR & 62 & 4.17 & 17.7 & 60 & 2511\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -10.001   -3.534   -1.392    1.536   14.623  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.772e-01  9.546e-01  -0.290  0.77270
## no3          2.184e-01  7.779e-02   2.807  0.00715
## temp         1.059e-01  3.941e-02   2.687  0.00982
## maxdepth     1.119e-02  3.877e-03   2.887  0.00577
## acerage      3.631e-05  1.853e-05   1.960  0.05574
## 
## (Dispersion parameter for quasipoisson family taken to be 30.10484)
## 
##     Null deviance: 2126.1  on 53  degrees of freedom
## Residual deviance: 1305.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.30      0.957  0.338 
## 2 water           0.129    -1.10   0.270 
## 3 light           0.448     1.96   0.0505
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1562 -0.5910 -0.0887  0.6136  3.4612 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  212.9   14.59   
##  subject  (Intercept) 3907.9   62.51   
##  Residual              637.0   25.24   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.717     26.399   7.679
## attitudepop  -19.711      5.545  -3.554
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000115 0.0000005 0.0019361
## high 0.0000115 1.0000000 0.2980398 0.0796672
## low  0.0000005 0.2980398 1.0000000 0.0072525
## mid  0.0019361 0.0796672 0.0072525 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 6, 4, 9, 11 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 14, 13, 7, 7 und 9! \textbf{(2 Punkte)}
...
die Sorten eins bis vier sowie die Bl{\"o}cke eins bis drei
vorliegen. Sie messen die Outcomes pigs, freshmatter und leaf an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCXRTN0 & 1.5 | 4.5 | Klein \\
    B & GCFCQKH & 3.0 | 2.5 | Mikro \\ 
    C & GCKTJLH & 3.5 | 1.0 | Klein \\ 
    D & GC3JOLQ & 2.0 | 1.5 | Normal \\ 
    E & GCLUMNV & 4.5 | 2.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 136 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{16, 2, 0\}$ und den Vektor $B = \{1, 0, 1\}$ gegeben.
