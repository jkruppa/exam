...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.21, 0.001 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3.56, 0.84, 0.004 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.0525, 3e-04 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.2225, 0.0525, 3e-04 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.84, 0.004 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.84, 0.004 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 14, 13, 16, 8 und 9.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12 +/- 11.5
\item [\textbf{B} \msquare] Es ergibt sich 12 +/- 1.695
\item [\textbf{C} \msquare] Es ergibt sich 11 +/- 5.75
\item [\textbf{D} \msquare] Es ergibt sich 13 +/- 1.695
\item [\textbf{E} \msquare] Es ergibt sich 12 +/- 3.39
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 19, 22, 11, 14, 28, 24 und 42.
...
\item [\textbf{E} \msquare] Es ergibt sich 22 [14, 28]
\end{enumerate} 
...
$y = \{18, 11, 10, 21, 22, 20, 8, 13, 16, 14, 12\}$. Berechnen Sie folgende
...
\begin{center}
$7.9, 14, 9.7, 8.3, 8.3, 8.8, 13.3, 10.5, 11.6, 12.6, 11.1, 11.7, 7.7, 11.1, 8.1$
\end{center}
...
## t = 0.16037, df = 14, p-value = 0.8749
...
## 
## data:  drymatter by Fe
## t = -0.34816, df = 16, p-value = 0.7323
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.725976  3.392643
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 113.15 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 37.49 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 54.000 27.0000    10.5 0.0009503
## Residuals 18 46.286  2.5714
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 110 136 122 101 120  90 134 129 146 146 156 163
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 105.7 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 166.46 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 259.87 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 340.67 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 109.43  54.715  3.0086 0.074602
## form       1   0.02   0.016  0.0009 0.976631
## dose:form  2 230.59 115.295  6.3396 0.008239
## Residuals 18 327.35  18.186
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -6.4286 -1.4286  0.0857  2.0929  4.5714 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  16.4000     1.5422  10.634 9.02e-07
## trtB         -0.9714     2.0192  -0.481    0.641
## 
## Residual standard error: 3.448 on 10 degrees of freedom
## Multiple R-squared:  0.02262,	Adjusted R-squared:  -0.07512 
## F-statistic: 0.2315 on 1 and 10 DF,  p-value: 0.6408
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: block, center und weight. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.43 & 0 & 9.94 & 102.22 & 75.49 & 8\\
6.62 & 0 & 9.26 & 99.18 & 67.51 & 9\\
9.89 & 1 & 13.34 & 98.42 & 65.68 & 8\\
9.94 & 0 & 12.40 & 99.90 & 64.79 & 11\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.8354 -2.0326 -0.4955  1.6562  7.6519 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  80.7817     3.1659  25.516  < 2e-16
## water        -0.2982     0.2154  -1.384 0.169257
## light         0.2025     0.6805   0.298 0.766649
## P            -0.8203     0.2114  -3.880 0.000185
## 
## Residual standard error: 3.245 on 102 degrees of freedom
## Multiple R-squared:  0.1358,	Adjusted R-squared:  0.1103 
## F-statistic: 5.341 on 3 and 102 DF,  p-value: 0.001856
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
MEADOW\_BR & 234 & 10.98 & 93 & 4803 & 5.01\\
DEAD\_RUN & 25 & 44.93 & 51 & 4145 & 0.34\\
ISRAEL\_CR & 30 & 13.77 & 133 & 6260 & 2.41\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.610  -3.660  -2.042   1.714  17.563  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.938e+00  5.362e-01   3.615 0.000708
## so4         -2.535e-02  2.554e-02  -0.993 0.325829
## maxdepth     1.235e-02  3.836e-03   3.221 0.002274
## acerage      4.771e-05  1.268e-05   3.762 0.000450
## no3          1.997e-01  6.655e-02   3.001 0.004220
## 
## (Dispersion parameter for quasipoisson family taken to be 31.70941)
## 
##     Null deviance: 2338.9  on 53  degrees of freedom
## Residual deviance: 1255.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.71       2.82 0.00485
## 2 water           0.175     -2.78 0.00545
## 3 light           0.486      1.94 0.0526
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1426 -0.5446 -0.1042  0.5564  3.1373 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  182.6   13.51   
##  subject  (Intercept) 3976.7   63.06   
##  Residual              632.8   25.16   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.788     26.532   7.643
## attitudepop  -21.327      5.527  -3.859
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0157801 0.3361805 0.0005911
## high 0.0157801 1.0000000 0.1255346 0.0000004
## low  0.3361805 0.1255346 1.0000000 0.0000367
## mid  0.0005911 0.0000004 0.0000367 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 15, 13, 11, 3 und 7!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 14, 9, 14, 14 und 10! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes drymatter, Fe und pigs an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCKBVET & 1.5 | 2.0 | Klein \\
    B & GCH9XQJ & 3.5 | 1.0 | Normal \\ 
    C & GCU7GRF & 5.0 | 5.0 | Mikro \\ 
    D & GCJZZ6F & 2.0 | 3.5 | Normal \\ 
    E & GCWVL2H & 4.0 | 1.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 145 n. Chr. f{\"u}r den neuen Lehnsherren
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  4-mal-gefaltete, 0.6mm, 40-cm-Karton} durch
...
Sie haben den Vektor $A = \{-9, -5, 6\}$ und den Vektor $B = \{8, 7, -1\}$ gegeben.
