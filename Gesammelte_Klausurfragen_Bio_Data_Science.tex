...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.34, 0.01, 0.42 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.068, 0.002, 0.084 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 1, 0.05, 1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.068, 0.002, 0.084 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 1.7, 0.05, 2.1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 1, 0.05, 1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 3, 11, 11 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.2 +/- 1.745
\item [\textbf{B} \msquare] Es ergibt sich 10.2 +/- 1.745
\item [\textbf{C} \msquare] Es ergibt sich 9.2 +/- 12.2
\item [\textbf{D} \msquare] Es ergibt sich 9.2 +/- 3.49
\item [\textbf{E} \msquare] Es ergibt sich 8.2 +/- 6.1
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 30, 23, 11, 22, 15, 18, 25, 7, 27, 26 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 27
\item [\textbf{B} \msquare] Es ergibt sich 24 [15, 27]
\item [\textbf{C} \msquare] Es ergibt sich 24 +/- 15
\item [\textbf{D} \msquare] Es ergibt sich 23 +/- 15
\item [\textbf{E} \msquare] Es ergibt sich 23 [15, 27]
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.59 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung einer anderen Verteilungsfamilie wie die Quasipossion Verteilung.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.59 liegt keine Overdispersion vor.
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.59 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.39 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.86, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.86, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 1.17, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.46, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.46, da es sich um ein Anteil handelt.
\end{enumerate}
...
In einem Stallexperiment mit $n = 110$ Ferkeln wurden verschiedene
...
\midrule
(Intercept) & 38.38 & 0.23\\
light\_binhigh & 3.44 & 0.34\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 11.8
...
\item [\textbf{D} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 11.8
\item [\textbf{E} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 3.44
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 38
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 20
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 39
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 78
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 76
\end{enumerate}
...
$y = \{13, 14, 18, 11, 17, 17, 22, 22, 14, 15, 17\}$. Berechnen Sie folgende
...
\begin{center}
$10.4, 11.1, 8.7, 7.5, 6.8, 12.9, 9.8, 9.2, 9.9, 9.7, 9, 10.1, 10.9, 16.2, 12.1$
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 12.67 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 20.57 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 60.437 30.2184  14.265 0.0001066
## Residuals 22 46.603  2.1183
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 136 129 120  87  78 102 139 142 137 160 144 153
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 378.57 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 178.78 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 12.69 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 30 & 640.35 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 178.98  89.490  3.9480 0.037876
## form       1 270.25 270.248 11.9223 0.002839
## dose:form  2 248.43 124.213  5.4798 0.013846
## Residuals 18 408.01  22.667
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 151$ Sauen. In dem Experiment wurde gemessen,
...
## -3.4000 -1.7143  0.2857  0.7857  3.6000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  17.7143     0.8335  21.253 1.18e-09
## trtB          0.6857     1.2912   0.531    0.607
## 
## Residual standard error: 2.205 on 10 degrees of freedom
## Multiple R-squared:  0.02743,	Adjusted R-squared:  -0.06983 
## F-statistic: 0.282 on 1 and 10 DF,  p-value: 0.607
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: N, center und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.78 & 1 & 11.71 & 99.29 & 67.64 & 19\\
12.02 & 1 & 10.41 & 98.00 & 65.93 & 6\\
10.46 & 0 & 10.76 & 97.55 & 69.30 & 16\\
10.98 & 1 & 10.92 & 100.58 & 72.18 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.4565 -1.4988 -0.1728  1.3589  8.1203 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.61307    6.18411  -0.423   0.6735
## light        0.44066    0.45943   0.959   0.3396
## water       -0.38571    0.16752  -2.302   0.0232
## Fe           0.75988    0.06388  11.895   <2e-16
## 
## Residual standard error: 2.261 on 108 degrees of freedom
## Multiple R-squared:  0.5683,	Adjusted R-squared:  0.5564 
## F-statistic:  47.4 on 3 and 108 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & so4 & no3 & maxdepth & temp\\
\midrule
DEEP\_RUN & 5 & 21.68 & 1.30 & 57 & 21.8\\
BUFFALO\_RUN & 16 & 18.87 & 0.61 & 37 & 16.8\\
MILL\_CR & 6 & 15.77 & 1.71 & 53 & 13.1\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.694  -4.417  -1.514   1.365  15.086  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.844699   1.012800   1.821 0.074656
## so4         -0.009110   0.021924  -0.416 0.679557
## no3          0.231933   0.069147   3.354 0.001543
## maxdepth     0.014095   0.003689   3.820 0.000376
## temp         0.004989   0.046071   0.108 0.914207
## 
## (Dispersion parameter for quasipoisson family taken to be 32.23564)
## 
##     Null deviance: 2069.8  on 53  degrees of freedom
## Residual deviance: 1362.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.53      0.253  0.800 
## 2 water           0.147     0.198  0.843 
## 3 nematodes       0.158    -2.05   0.0400
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 798.1
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3381 -0.5876 -0.0694  0.4987  3.4497 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  229.2   15.14   
##  subject  (Intercept) 4200.2   64.81   
##  Residual              685.1   26.17   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.400     27.369   7.432
## attitudepop  -21.297      5.751  -3.703
## 
...
\begin{verbatim}
##           ctrl      high low       mid
## ctrl 1.0000000 0.5837563   0 0.9068816
## high 0.5837563 1.0000000   0 0.5067712
## low  0.0000000 0.0000000   1 0.0000000
## mid  0.9068816 0.5067712   0 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 10, 11, 10, 15 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 22, 6, 15, 16 und 13! \textbf{(2 Punkte)}
...
\begin{quote}
  ...
  ersten Symptome ein; die ersten Toten sind nach 88 Tagen zu beklagen;
...
Eine au{\ss}erirdische Zivilisation schickt $4$ Sonden mit
...
\item Bei einem vermutetet Alter der Erde von $\ensuremath{4.6\times 10^{9}}$ Jahren,
  ...
  $\ensuremath{1.2\times 10^{9}}$ Jahre vollst{\"a}ndig umgewandelt haben! \textbf{(2
    Punkte)}
\item Skizzieren Sie in einer Abbildung den Zusammenhang zwischen Zeit $t$
  ...
  $\vec{v_r}$ einer ruhenden Sonde, einer mit 50\% Lichtegschwindigkeit und
  mit 99\% Lichtegeschwindigkeit fliegendes Raumschiff! \textbf{(3 Punkte)}
