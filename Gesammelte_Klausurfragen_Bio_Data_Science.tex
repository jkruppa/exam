...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.02, 0.03, 0.42, 0.001 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.0033, 0.005, 0.07, 2e-04 und 0.0567. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.18, 1, 0.006 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.0033, 0.005, 0.07, 2e-04 und 0.0567. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 0.18, 1, 0.006 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.26, 0.12, 0.18, 2.52, 0.006 und 2.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Der Korrelationskoeffizienten nach Spearman wird genutzt, wenn das Outcome Y nicht normalverteilt ist. Der Korrelationskoeffizienten liegt zwischen -1 und 1.
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 15, 13, 20, 11 und 5.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 13.8 +/- 2.75
\item [\textbf{B} \msquare] Es ergibt sich 12.8 +/- 2.75
\item [\textbf{C} \msquare] Es ergibt sich 12.8 +/- 30.2
\item [\textbf{D} \msquare] Es ergibt sich 11.8 +/- 15.1
\item [\textbf{E} \msquare] Es ergibt sich 12.8 +/- 5.5
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 29, 7, 24, 12, 17, 22 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 [12, 29]
\item [\textbf{B} \msquare] Es ergibt sich 22 +/- 12
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 12
\item [\textbf{D} \msquare] Es ergibt sich 22 +/- 29
\item [\textbf{E} \msquare] Es ergibt sich 22 [12, 29]
\end{enumerate}
...
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.92 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.92 liegt keine Overdispersion vor.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.95 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.57, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 1.75, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.57, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.36, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\midrule
(Intercept) & 38.28 & 0.27\\
light\_binhigh & 3.78 & 0.37\\
\bottomrule
\end{tabular}
\end{table}
...
\item [\textbf{B} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 14.26
...
\item [\textbf{D} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 14.26
\item [\textbf{E} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 3.78
\end{enumerate}
...
$y = \{20, 11, 18, 18, 22, 18, 15\}$. Berechnen Sie folgende
...
\begin{center}
$10.7, 8.8, 12.3, 10, 11.6, 9.8, 13.4, 9.8, 10.7, 11.1, 10.1, 11.6, 5.9, 10.5$
\end{center}
...
## t = -3.1078, df = 12, p-value = 0.009058
...
## 
## data:  weight by group
## t = -1.7825, df = 12, p-value = 0.09996
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -8.5436580  0.8547691
## sample estimates:
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 121 118 112 104  95  99 137 127 139 127 144 141
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.55 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.83 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  5.3524 2.67621  5.9161 0.007402 **
## Residuals 27 12.2138 0.45236                    
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 204.28 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2434.9 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 112.11 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 712.99 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 62 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: len
##           Df  Sum Sq Mean Sq  F value    Pr(>F)    
## supp       1    0.01    0.01   0.0005    0.9827    
## dose       2 2805.83 1402.92 115.4058 < 2.2e-16 ***
## supp:dose  2  285.80  142.90  11.7550 5.463e-05 ***
## Residuals 56  680.76   12.16                       
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
## -3.600 -3.143 -0.600  2.243  4.857 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   19.600      1.415  13.855 7.48e-08 ***
## trtB          -4.457      1.852  -2.406   0.0369 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.163 on 10 degrees of freedom
## Multiple R-squared:  0.3667,	Adjusted R-squared:  0.3034 
## F-statistic: 5.791 on 1 and 10 DF,  p-value: 0.03691
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: region, fertilizier und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & temp & maxdepth & no3 & acerage\\
\midrule
MAINSTEM\_PATUXENT\_R & 239 & 18.1 & 150 & 3.31 & 8636\\
SOUTH\_BR\_PATAPSCO & 26 & 18.6 & 60 & 2.96 & 1450\\
LITTLE\_CONOCOCHEAGUE\_CR & 15 & 24.0 & 54 & 0.33 & 2227\\
BEAVER\_RUN & 37 & 19.3 & 43 & 5.66 & 1722\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -9.9621  -3.2359  -0.9109   2.4170  13.2302  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -1.912e-02  9.998e-01  -0.019   0.9848    
## temp         6.583e-02  4.163e-02   1.582   0.1202    
## maxdepth     1.247e-02  3.733e-03   3.341   0.0016 ** 
## no3          3.251e-01  6.948e-02   4.679 2.31e-05 ***
## acerage      4.164e-05  1.681e-05   2.477   0.0167 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 26.55405)
## 
##     Null deviance: 2304.3  on 53  degrees of freedom
## Residual deviance: 1239.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.65      0.988   0.323
## 2 water           0.158    -1.07    0.283
## 3 nematodes       0.116    -0.367   0.714
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
10.14 & 1 & 11.64 & 104.76 & 72.79 & 17\\
9.79 & 1 & 11.05 & 96.50 & 63.68 & 13\\
12.27 & 0 & 9.44 & 96.80 & 67.51 & 11\\
9.05 & 1 & 10.11 & 99.77 & 73.31 & 13\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -9.5197 -1.8313 -0.0865  2.0798  7.1317 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 76.29569    3.33570  22.873   <2e-16 ***
## nematodes    0.02575    0.11256   0.229   0.8195    
## water       -0.14219    0.23475  -0.606   0.5461    
## P           -0.54700    0.24199  -2.260   0.0261 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.253 on 96 degrees of freedom
## Multiple R-squared:  0.0554,	Adjusted R-squared:  0.02588 
## F-statistic: 1.877 on 3 and 96 DF,  p-value: 0.1387
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.32253 -0.56616 -0.07793  0.53254  3.07669 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  218.6   14.78   
##  subject  (Intercept) 4020.0   63.40   
##  Residual              655.0   25.59   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.039     26.773   7.546
## attitudepop  -18.781      5.623  -3.340
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0727695 0.0412232 0.0000117
## high 0.0727695 1.0000000 0.7876626 0.0022125
## low  0.0412232 0.7876626 1.0000000 0.0045029
## mid  0.0000117 0.0022125 0.0045029 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 29, 7, 24, 12, 17, 22 und 42!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 29, 7, 24, 12, 17, 22 und 42! \textbf{(2 Punkte)}
...
\hfill\href{https://youtu.be/rWTyHXXlYjY}{\includegraphics[width =
  2cm]{img/youtube}}
\hspace{2Ex}
\href{https://youtu.be/rWTyHXXlYjY}{\includegraphics[width =
