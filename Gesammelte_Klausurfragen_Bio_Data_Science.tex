...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.001, 0.01, 0.21, 0.34 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.18, 0.006, 0.06, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 2e-04, 0.0017, 0.035, 0.0567 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 2e-04, 0.0017, 0.035, 0.0567 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.18, 0.006, 0.06, 1.26, 2.04 und 2.52. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.18, 0.006, 0.06, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 16, 3, 10, 9 und 1.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 6.8 +/- 17.85
\item [\textbf{B} \msquare] Es ergibt sich 7.8 +/- 35.7
\item [\textbf{C} \msquare] Es ergibt sich 8.8 +/- 2.985
\item [\textbf{D} \msquare] Es ergibt sich 7.8 +/- 5.97
\item [\textbf{E} \msquare] Es ergibt sich 7.8 +/- 2.985
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 6, 12, 25, 3, 22, 22 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 +/- 6
\item [\textbf{B} \msquare] Es ergibt sich 22 [7, 26]
\item [\textbf{C} \msquare] Es ergibt sich 22 [6, 25]
\item [\textbf{D} \msquare] Es ergibt sich 22 +/- 25
\item [\textbf{E} \msquare] Es ergibt sich 22 +/- 6
\end{enumerate} 
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.36, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.57, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 1.75, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.36, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
$y = \{21, 15, 19, 19, 19, 18, 20, 17, 20, 21, 19\}$. Berechnen Sie folgende
...
\begin{center}
$6.7, 8.3, 13.1, 6.1, 10.4, 9.5, 7.7, 8.5, 10.2, 12.2, 9, 10.8, 11.7, 10.5, 10.6$
\end{center}
...
## t = -2.9749, df = 14, p-value = 0.01004
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 15.5 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 31.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 52.957  26.478  12.609 0.0002866
## Residuals 20 42.000   2.100
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 111 120 133  98 105 109 147 145 124 156 135 156
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 12 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 359.8 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 173.47 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 264.25 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 343.69 171.844  9.3082 0.001676
## form       1 204.77 204.771 11.0918 0.003723
## dose:form  2  70.39  35.196  1.9064 0.177433
## Residuals 18 332.31  18.462
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   88   \strut\\
    \hline
     &  87 &  71 &  158  \strut\\
  \end{tabular}
\end{center}
...
## -5.5556 -2.2381 -0.2857  2.6944  6.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.556      1.259  13.152 2.86e-09
## waterB        -5.270      1.903  -2.769   0.0151
## 
## Residual standard error: 3.776 on 14 degrees of freedom
## Multiple R-squared:  0.3539,	Adjusted R-squared:  0.3077 
## F-statistic: 7.668 on 1 and 14 DF,  p-value: 0.01507
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.3539$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: region, variety und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.86 & 0 & 11.76 & 95.46 & 68.15 & 4\\
10.71 & 0 & 8.62 & 97.98 & 63.83 & 8\\
9.19 & 0 & 10.20 & 94.38 & 64.33 & 6\\
11.83 & 1 & 7.74 & 99.19 & 71.39 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.4343 -2.2838  0.2176  1.9145  6.8601 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -5.09085    9.64599  -0.528    0.599
## nematodes   -0.01691    0.08830  -0.192    0.849
## Fe           0.76033    0.09318   8.160 1.78e-12
## water       -0.10409    0.19729  -0.528    0.599
## 
## Residual standard error: 2.721 on 91 degrees of freedom
## Multiple R-squared:  0.4323,	Adjusted R-squared:  0.4136 
## F-statistic:  23.1 on 3 and 91 DF,  p-value: 3.316e-11
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & so4 & temp & acerage & no3\\
\midrule
DEER\_CR & 26 & 6.36 & 19.1 & 8297 & 5.26\\
BIG\_BR & 72 & 5.65 & 16.7 & 4790 & 4.10\\
SECOND\_MINE\_BR & 62 & 10.75 & 17.7 & 2511 & 4.17\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.996  -4.965  -2.031   2.212  19.803  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.119e+00  8.327e-01   2.545  0.01413
## so4         -2.927e-02  2.839e-02  -1.031  0.30764
## temp         5.655e-02  4.227e-02   1.338  0.18716
## acerage      4.127e-05  1.410e-05   2.928  0.00517
## no3          1.596e-01  6.990e-02   2.284  0.02677
## 
## (Dispersion parameter for quasipoisson family taken to be 43.05494)
## 
##     Null deviance: 2354.8  on 53  degrees of freedom
## Residual deviance: 1664.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.44     0.329    0.742
## 2 water           0.142   -0.517    0.605
## 3 nematodes       0.152    0.0104   0.992
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 793.4
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4144 -0.6103 -0.1250  0.6209  3.0050 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  233.1   15.27   
##  subject  (Intercept) 3864.0   62.16   
##  Residual              644.5   25.39   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.384     26.318   7.690
## attitudepop  -19.926      5.578  -3.572
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0234864 0.0002178 0.0000153
## high 0.0234864 1.0000000 0.0000002 0.0000000
## low  0.0002178 0.0000002 1.0000000 0.3632013
## mid  0.0000153 0.0000000 0.3632013 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 8, 11, 10, 13 und 7!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 7, 13, 7, 7 und 11! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes freshmatter, Fe und leaf an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCY61RA & 3.5 | 4.0 | Mikro \\
    B & GCM8B32 & 1.0 | 1.5 | Normal \\ 
    C & GCPW5TA & 5.0 | 3.0 | Normal \\ 
    D & GCLLTGV & 3.0 | 4.5 | Klein \\ 
    E & GCLZBYX & 2.5 | 2.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 619 n. Chr. f{\"u}r den neuen Lehnsherren
...
1859 ungef{\"a}hr 26 Kaninchen entlassen hat, Millionen
...
Sie haben den Vektor $A = \{9, 7, 11\}$ und den Vektor $B = \{-7, 6, -1\}$ gegeben.
