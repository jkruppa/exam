...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.01, 0.21, 0.34, 0.42 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.06, 1, 1, 1 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1483, 0.0017, 0.035, 0.0567, 0.07 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 5.34, 0.06, 1.26, 2.04, 2.52 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1483, 0.0017, 0.035, 0.0567, 0.07 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.06, 1, 1, 1 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 8, 12, 13 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.6 +/- 1.35
\item [\textbf{B} \msquare] Es ergibt sich 8.6 +/- 3.65
\item [\textbf{C} \msquare] Es ergibt sich 9.6 +/- 2.7
\item [\textbf{D} \msquare] Es ergibt sich 9.6 +/- 7.3
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 17, 19, 21, 20, 20, 2 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 20 +/- 21
\item [\textbf{B} \msquare] Es ergibt sich 21 [18, 22]
\item [\textbf{C} \msquare] Es ergibt sich 20 +/- 17
\item [\textbf{D} \msquare] Es ergibt sich 21 +/- 17
\item [\textbf{E} \msquare] Es ergibt sich 20 [17, 21]
\end{enumerate} 
...
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.2, da es sich um eine Chancenverh{"a}ltnis handelt.
...
$y = \{11, 8, 15, 19, 15, 12, 17, 13, 13, 17, 7\}$. Berechnen Sie folgende
...
\begin{center}
$8.5, 11.6, 4.9, 8.2, 10.9, 8.9, 7.5, 7.8, 7, 9.7, 10.6, 10.9, 13.4, 9.8$
\end{center}
...
\item Treffen Sie mit $T_{\alpha = 1\%} = 2.76$ und dem berechneten $T_{calc}$ eine Aussage
...
## 
## data:  weight by group
## t = 0.62554, df = 12, p-value = 0.5433
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.192523  5.763951
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 44.57 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 41.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 179.46  89.730  25.791 1.707e-06
## Residuals 22  76.54   3.479
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 37.49 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 179.63 &  &  &  \strut\\
    \hline
...
jedes Tier eine von drei Selen-Dosen $dose$ ($0.2$ ng/Tag, $3$ ng/Tag und $20$ ng/Tag)
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 554.03 277.017 16.5621 8.314e-05
## form       1  56.55  56.551  3.3811   0.08251
## dose:form  2 148.27  74.136  4.4324   0.02721
## Residuals 18 301.07  16.726
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -3.2857 -1.4087 -0.2857  1.7143  3.2222 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  13.7778     0.6606  20.857 6.09e-12
## waterB        8.5079     0.9987   8.519 6.54e-07
## 
## Residual standard error: 1.982 on 14 degrees of freedom
## Multiple R-squared:  0.8383,	Adjusted R-squared:  0.8267 
## F-statistic: 72.57 on 1 and 14 DF,  p-value: 6.541e-07
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.8383$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: block, center und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.67 & 0 & 9.73 & 93.85 & 68.66 & 9\\
9.45 & 1 & 10.11 & 99.57 & 69.44 & 14\\
8.77 & 0 & 11.28 & 99.65 & 70.87 & 14\\
12.52 & 0 & 7.42 & 98.51 & 67.50 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.5543 -1.4228 -0.0276  1.1884  4.8825 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -4.07294    7.18817  -0.567   0.5725
## water       -0.34566    0.14872  -2.324   0.0226
## Fe           0.81024    0.07074  11.454   <2e-16
## P           -0.33548    0.18919  -1.773   0.0799
## 
## Residual standard error: 2.063 on 82 degrees of freedom
## Multiple R-squared:  0.6235,	Adjusted R-squared:  0.6097 
## F-statistic: 45.26 on 3 and 82 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & maxdepth & do2 & no3\\
\midrule
BIG\_BR & 72 & 16.7 & 91 & 9.4 & 4.10\\
OWENS\_CR & 80 & 21.8 & 79 & 8.6 & 1.02\\
BIG\_ELK\_CR & 164 & 13.8 & 81 & 10.2 & 3.20\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -7.932  -4.104  -2.220   1.236  13.200  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.677912   1.575211  -0.430  0.66882
## temp         0.025753   0.042935   0.600  0.55140
## maxdepth     0.012911   0.003844   3.358  0.00152
## do2          0.290293   0.125494   2.313  0.02495
## no3          0.096215   0.077670   1.239  0.22133
## 
## (Dispersion parameter for quasipoisson family taken to be 32.83087)
## 
##     Null deviance: 1895  on 53  degrees of freedom
## Residual deviance: 1341  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.393     0.706   0.480
## 2 nematodes       0.157    -1.00    0.316
## 3 light           0.509    -0.666   0.505
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 801.4
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9168 -0.6044 -0.1395  0.6503  3.4647 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  210.7   14.52   
##  subject  (Intercept) 4092.1   63.97   
##  Residual              722.8   26.89   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.326     27.006   7.492
## attitudepop  -20.808      5.907  -3.523
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.2733381 0.0046722 0.0000005
## high 0.2733381 1.0000000 0.0002255 0.0000000
## low  0.0046722 0.0002255 1.0000000 0.0030792
## mid  0.0000005 0.0000000 0.0030792 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 10, 10, 10, 13 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 8, 12, 14 und 15! \textbf{(2 Punkte)}
...
die Sorten A bis D sowie die Bl{\"o}cke I bis IV
vorliegen. Sie messen die Outcomes P, grade und pigs an zwei verschiedenen Messterminen.
...
\midrule
drinking/eating & 36cm; 26cm; 3.5\% & 32cm; 26cm; 12.1\% & 27cm; 31cm; 8.9\%\\
standing & 35cm; 18cm; 4.1\% & 25cm; 25cm; 3.6\% & 44cm; 23cm; 8.1\%\\
preening & 36cm; 23cm; 6.2\% & 32cm; 23cm; 5.1\% & 33cm; 22cm; 3.2\%\\
wing/leg stretching & 39cm; 25cm; 13.2\% & 34cm; 26cm; 14.2\% & 29cm; 31cm; 18.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCSCIEZ & 3.5 | 2.0 | Klein \\
    B & GC1XPHU & 2.0 | 4.0 | Klein \\ 
    C & GCSQGAZ & 1.0 | 3.0 | Mikro \\ 
    D & GCWTSFK & 3.0 | 1.5 | Klein \\ 
    E & GC0OQOI & 2.5 | 4.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 368 n. Chr. f{\"u}r den neuen Lehnsherren
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  6-mal-gefaltete, 0.6mm, 30-cm-Karton} durch
...
L{\"a}nder z{\"a}hlen. Im Jahr 2023 leben ca. \ensuremath{8.2\times 10^{7}} Menschen in Deutschland und
...
Sie haben den Vektor $A = \{12, 9, -5\}$ und den Vektor $B = \{1, 2, 3\}$ gegeben.
