...
\begin{graybox}{Inhalte der Klausur nach Modul}  
  ...
  \item 2 Fragen abhängig von der Vertiefung (Pflanze oder Nutztier)
  \end{itemize} 
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.21, 0.02, 0.34, 0.89 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.52, 1.26, 0.12, 2.04, 5.34 und 0.06. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.035, 0.0033, 0.0567, 0.1483 und 0.0017. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
...
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.035, 0.0033, 0.0567, 0.1483 und 0.0017. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 14, 4, 10, 8 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.6 +/- 3.85
\item [\textbf{B} \msquare] Es ergibt sich 9.6 +/- 1.925
\item [\textbf{C} \msquare] Es ergibt sich 8.6 +/- 7.4
\item [\textbf{D} \msquare] Es ergibt sich 10.6 +/- 1.925
\item [\textbf{E} \msquare] Es ergibt sich 9.6 +/- 14.8
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 30, 25, 14, 20, 31, 24, 15, 28, 7, 15 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 [16, 31]
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 15
\item [\textbf{C} \msquare] Es ergibt sich 25 +/- 15
\item [\textbf{D} \msquare] Es ergibt sich 24 +/- 30
\item [\textbf{E} \msquare] Es ergibt sich 24 [15, 30]
\end{enumerate} 
...
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 1.6, da es sich um ein Anteil handelt.
...
$y = \{22, 20, 18, 18, 20, 19, 13\}$. Berechnen Sie folgende
...
\begin{center}
$2, 4, 5, 1, 2, 4, 2, 4, 5, 12, 3, 4, 8, 7, 4$
\end{center}
...
\begin{center}
$11.2, 5.5, 6.8, 10.9, 9.2, 12.2, 12.6, 10.3, 11.8, 6.3, 12.6, 8.1, 9, 11.8$
\end{center}
...
## t = -2.1766, df = 16, p-value = 0.04483
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.72855441 -0.04922337
## sample estimates:
...
## 
## data:  freshmatter by N
## t = -1.7496, df = 16, p-value = 0.09935
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.1265188  0.6820744
## sample estimates:
...
## t = -3.9336, df = 16, p-value = 0.001187
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.865578 -2.356644
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 88.22 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 21.08 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 194.076  97.038  34.172 3.536e-07
## Residuals 20  56.794   2.840
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 115 118 117 117  84 109 134 131 141 146 158 151
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 120.07 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 355.21 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 27.52 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 269.18 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 708.22  354.11  15.667 0.0001146
## form       1 556.52  556.52  24.621 0.0001008
## dose:form  2  68.80   34.40   1.522 0.2450698
## Residuals 18 406.85   22.60
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## (Intercept)  19.0000     0.6025  31.537 6.51e-13
## trtB         -3.6000     1.0081  -3.571  0.00385
## 
## Residual standard error: 1.807 on 12 degrees of freedom
## Multiple R-squared:  0.5152,	Adjusted R-squared:  0.4748 
## F-statistic: 12.75 on 1 and 12 DF,  p-value: 0.003845
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 7.1737, df = 8, p-value = 9.486e-05
...
Einflussvariablen ($x$) wurden erhoben: dosage, S und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.58 & 0 & 9.02 & 96.97 & 65.06 & 12\\
10.32 & 0 & 10.51 & 95.23 & 66.68 & 8\\
10.76 & 1 & 11.12 & 103.36 & 72.21 & 6\\
9.42 & 0 & 11.08 & 100.82 & 71.86 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.2446 -1.1748  0.1261  1.1123  5.5379 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -5.69123    6.92273  -0.822  0.41307
## Fe           0.82128    0.06722  12.219  < 2e-16
## water       -0.33653    0.11804  -2.851  0.00535
## P           -0.29449    0.12148  -2.424  0.01724
## 
## Residual standard error: 1.782 on 95 degrees of freedom
## Multiple R-squared:  0.6246,	Adjusted R-squared:  0.6127 
## F-statistic: 52.69 on 3 and 95 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & acerage & maxdepth & so4\\
\midrule
PINEY\_CR & 18 & 9.3 & 6949 & 100 & 17.84\\
GUNPOWDER\_FALLS & 22 & 9.7 & 12659 & 65 & 5.98\\
OWENS\_CR & 80 & 8.6 & 9961 & 79 & 9.07\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -10.075   -5.096   -2.098    1.372   21.459  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  6.466e-01  1.623e+00   0.398   0.6921
## do2          2.047e-01  1.526e-01   1.341   0.1860
## acerage      3.178e-05  1.652e-05   1.923   0.0602
## maxdepth     1.265e-02  5.029e-03   2.516   0.0152
## so4         -7.497e-03  3.395e-02  -0.221   0.8262
## 
## (Dispersion parameter for quasipoisson family taken to be 51.22858)
## 
##     Null deviance: 2535.9  on 53  degrees of freedom
## Residual deviance: 1868.6  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.429    -0.546   0.585
## 2 light           0.489     1.32    0.188
## 3 nematodes       0.158     0.330   0.741
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1242 -0.5846 -0.0685  0.4751  3.4838 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  231.6   15.22   
##  subject  (Intercept) 3940.4   62.77   
##  Residual              632.7   25.15   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.603     26.549   7.593
## attitudepop  -18.484      5.527  -3.344
## 
...
\begin{verbatim}
##         ctrl      high       low       mid
## ctrl 1.0e+00 0.0000002 0.0000078 0.0000000
## high 2.0e-07 1.0000000 0.2352094 0.0094259
## low  7.8e-06 0.2352094 1.0000000 0.0003785
## mid  0.0e+00 0.0094259 0.0003785 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 16, 11, 15, 13 und 15!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 9, 19, 15, 6 und 10! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes freshmatter, Fe und leaf an vier verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{4, 1, 8\}$ und den Vektor $B = \{1, 2, 4\}$ gegeben.
