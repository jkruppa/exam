...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.89, 0.03 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0525, 0.2225, 0.0075 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 3.56, 0.12 und 1.68. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 1, 0.12 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 1, 0.12 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0525, 0.2225, 0.0075 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 2, 8, 12, 7 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.2 +/- 4.15
\item [\textbf{B} \msquare] Es ergibt sich 7.2 +/- 8.6
\item [\textbf{C} \msquare] Es ergibt sich 8.2 +/- 2.075
\item [\textbf{D} \msquare] Es ergibt sich 8.2 +/- 17.2
\item [\textbf{E} \msquare] Es ergibt sich 9.2 +/- 2.075
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 22, 11, 35, 7, 28, 20, 32, 15, 13, -5 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 20 [12, 33]
\item [\textbf{B} \msquare] Es ergibt sich 20 +/- 32
\item [\textbf{C} \msquare] Es ergibt sich 20 [11, 32]
\item [\textbf{D} \msquare] Es ergibt sich 20 +/- 11
\item [\textbf{E} \msquare] Es ergibt sich 20 +/- 11
\end{enumerate} 
...
$y = \{13, 14, 14, 17, 17, 15, 12\}$. Berechnen Sie folgende
...
Frischgewicht (\textit{freshmatter}) von Kartoffel.
...
\begin{center}
$6.9, 11.4, 14.9, 10.7, 7.6, 10.5, 13.5, 11.8, 11.8, 12.6, 7.9, 8.6$
\end{center}
...
## t = 2.4413, df = 14, p-value = 0.02852
...
## t = 2.4841, df = 10, p-value = 0.03231
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  0.4357367 8.0214061
## sample estimates:
...
## t = -2.2372, df = 12, p-value = 0.04503
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -8.6852037 -0.1147963
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 96 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 68.67 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 83.185  41.593  25.669 1.093e-06
## Residuals 24 38.889   1.620
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 138 109 128  95  79 106 132 153 142 157 129 158
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 144.83 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 290.81 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 296.71 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 223.96 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2 176.92  88.461  4.7400 0.02220
## form       1 116.13 116.125  6.2223 0.02257
## dose:form  2 159.24  79.622  4.2663 0.03044
## Residuals 18 335.93  18.663
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -3.2222 -0.6000 -0.4111  1.5278  2.7778 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  17.6000     0.9014  19.524 1.85e-10
## waterB        9.6222     1.1243   8.558 1.87e-06
## 
## Residual standard error: 2.016 on 12 degrees of freedom
## Multiple R-squared:  0.8592,	Adjusted R-squared:  0.8475 
## F-statistic: 73.25 on 1 and 12 DF,  p-value: 1.872e-06
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.8592$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: region, dry und block. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
7.52 & 0 & 8.02 & 99.69 & 70.84 & 11\\
9.57 & 1 & 10.13 & 97.61 & 65.79 & 7\\
12.86 & 0 & 9.92 & 100.67 & 72.62 & 9\\
9.66 & 0 & 9.04 & 98.24 & 70.65 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.2889 -1.2067 -0.1173  1.5121  5.7324 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -3.59070    8.83711  -0.406   0.6857
## nematodes    0.02428    0.07880   0.308   0.7588
## Fe           0.72961    0.08814   8.278 3.53e-12
## light        1.19206    0.61378   1.942   0.0559
## 
## Residual standard error: 2.526 on 75 degrees of freedom
## Multiple R-squared:  0.4937,	Adjusted R-squared:  0.4734 
## F-statistic: 24.38 on 3 and 75 DF,  p-value: 4.092e-11
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & so4 & maxdepth & do2\\
\midrule
LITTLE\_GUNPOWDER\_R & 3 & 2.60 & 6.96 & 85 & 9.7\\
DORSEY\_RUN & 8 & 0.44 & 20.24 & 160 & 6.8\\
PINEY\_CR & 18 & 4.57 & 17.84 & 100 & 9.3\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.947  -3.998  -2.001   1.279  13.465  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.630697   1.569801  -0.402 0.689601
## no3          0.085736   0.081224   1.056 0.296355
## so4          0.004761   0.019432   0.245 0.807487
## maxdepth     0.015962   0.004136   3.859 0.000333
## do2          0.305218   0.163566   1.866 0.068029
## 
## (Dispersion parameter for quasipoisson family taken to be 33.06552)
## 
##     Null deviance: 2043.1  on 53  degrees of freedom
## Residual deviance: 1425.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.40       1.69  0.0904
## 2 nematodes       0.172     -1.64  0.101 
## 3 water           0.130     -1.28  0.202
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3580 -0.6069 -0.0860  0.5654  3.3670 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  199.9   14.14   
##  subject  (Intercept) 3892.6   62.39   
##  Residual              690.3   26.27   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.449     26.339   7.686
## attitudepop  -18.545      5.773  -3.213
## 
...
\begin{verbatim}
##           ctrl      high   low       mid
## ctrl 1.0000000 0.0785650 0e+00 0.0424448
## high 0.0785650 1.0000000 0e+00 0.0004253
## low  0.0000000 0.0000000 1e+00 0.0000003
## mid  0.0424448 0.0004253 3e-07 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 16, 14, 14, 5 und 1!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 2, 14, 9, 7 und 5! \textbf{(2 Punkte)}
...
die D{"u}nger eins bis vier sowie die Bl{\"o}cke eins bis drei
vorliegen. Sie messen die Outcomes drymatter, pigs und leaf an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCDT86U & 5.0 | 4.0 | Mikro \\
    B & GC2UWJL & 2.5 | 3.0 | Mikro \\ 
    C & GC3NBWR & 1.5 | 3.5 | Mikro \\ 
    D & GCCDRAK & 3.5 | 1.5 | Mikro \\ 
    E & GCEPXAH & 4.5 | 2.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 740 n. Chr. f{\"u}r den neuen Lehnsherren
...
\item Erg{\"a}nzen Sie in der Tabelle den \textit{gesamten} Fleischkonsum in
  Deutschland und Nigeria im Jahr 2023, der sich aus der Abbildung ergibt! \textbf{(1 Punkt)}
\end{enumerate}
...
\item Sch{\"a}tzen Sie graphisch die zu erwartende Bev{\"o}lkerung in Nigeria im Jahr 2050, die sich
  anhand der Informationen aus der Abbildung ergibt! \textbf{(1
    Punkt)}
\begin{enumerate}
...
Sie haben den Vektor $A = \{12, 21, 6\}$ und den Vektor $B = \{2, 6, 6\}$ gegeben.
