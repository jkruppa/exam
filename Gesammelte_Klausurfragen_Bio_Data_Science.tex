...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.89, 0.02, 0.42, 0.01 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 5.34, 0.12, 2.52, 0.06 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.1483, 0.0033, 0.07, 0.0017 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 1, 0.12, 1, 0.06 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.1483, 0.0033, 0.07, 0.0017 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 1, 0.12, 1, 0.06 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 3, 12, 11 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9 +/- 1.805
\item [\textbf{B} \msquare] Es ergibt sich 7 +/- 6.5
\item [\textbf{C} \msquare] Es ergibt sich 8 +/- 3.61
\item [\textbf{D} \msquare] Es ergibt sich 8 +/- 13
\item [\textbf{E} \msquare] Es ergibt sich 8 +/- 1.805
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 27, 28, 29, 29, 20, 11 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 28 [21, 30]
\item [\textbf{B} \msquare] Es ergibt sich 28 +/- 20
\item [\textbf{C} \msquare] Es ergibt sich 28 +/- 20
\item [\textbf{D} \msquare] Es ergibt sich 28 +/- 29
\item [\textbf{E} \msquare] Es ergibt sich 28 [20, 29]
\end{enumerate} 
...
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 1.4, da es sich um ein Anteil handelt.
...
$y = \{23, 20, 18, 18, 16, 18, 20, 17, 18, 17, 20\}$. Berechnen Sie folgende
...
\begin{center}
$6, 14.4, 14.3, 11.5, 10.8, 11.2, 11.4, 9.7, 11.2, 9.4, 10.6, 12.9, 9, 13, 8.9$
\end{center}
...
Nach einem Experiment mit zwei Substrattypen ($torf$ und $70+30$) ergibt sich die
...
## t = 3.6148, df = 8, p-value = 0.006834
...
## 
## data:  weight by group
## t = 0.92789, df = 12, p-value = 0.3718
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.456594  6.101039
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 83.94 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 53.37 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 44.842 22.4210  7.6024 0.003502
## Residuals 20 58.984  2.9492
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 141 115 133  98 111  93 152 155 140 150 150 134
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 46.96 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 173.69 &  &  &  \strut\\
    \hline
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 398.44 199.221 12.1978 0.0004483
## form       1 222.93 222.927 13.6493 0.0016589
## dose:form  2 108.49  54.244  3.3212 0.0591973
## Residuals 18 293.99  16.333
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -2.6667 -0.8000 -0.6667  0.3333  5.3333 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  14.6667     0.7252  20.224 1.22e-10
## waterB        9.1333     1.2135   7.526 6.98e-06
## 
## Residual standard error: 2.176 on 12 degrees of freedom
## Multiple R-squared:  0.8252,	Adjusted R-squared:  0.8106 
## F-statistic: 56.65 on 1 and 12 DF,  p-value: 6.983e-06
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.8252$ aus? \textbf{(2 Punkte)}
...
## t = -3.4148, df = 8, p-value = 0.009158
...
Einflussvariablen ($x$) wurden erhoben: dry, N und dosage. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.72 & 0 & 11.21 & 96.94 & 67.55 & 7\\
12.18 & 1 & 10.66 & 97.76 & 70.60 & 15\\
7.32 & 0 & 11.33 & 100.17 & 67.00 & 9\\
10.86 & 0 & 9.02 & 98.93 & 67.08 & 5\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.7047 -1.6624 -0.3231  1.6645  5.9938 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  6.97637    7.86808   0.887  0.37776
## light        1.48977    0.54505   2.733  0.00763
## P           -0.56338    0.19159  -2.941  0.00422
## Fe           0.67817    0.07547   8.986 5.76e-14
## 
## Residual standard error: 2.274 on 85 degrees of freedom
## Multiple R-squared:  0.5378,	Adjusted R-squared:  0.5215 
## F-statistic: 32.97 on 3 and 85 DF,  p-value: 3.121e-14
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & acerage & temp & so4\\
\midrule
LITTLE\_FALLS & 84 & 3.54 & 1600 & 19.5 & 5.69\\
SOUTH\_BR\_CASSELMAN\_R & 2 & 0.64 & 6311 & 18.5 & 21.16\\
PINEY\_RUN & 36 & 2.17 & 11405 & 23.6 & 10.17\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.092  -4.224  -1.630   1.271  20.019  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.850e+00  8.713e-01   2.123  0.03882
## no3          1.247e-01  7.082e-02   1.761  0.08441
## acerage      4.581e-05  1.409e-05   3.251  0.00209
## temp         7.562e-02  4.366e-02   1.732  0.08958
## so4         -3.297e-02  2.939e-02  -1.122  0.26741
## 
## (Dispersion parameter for quasipoisson family taken to be 42.13982)
## 
##     Null deviance: 2324.4  on 53  degrees of freedom
## Residual deviance: 1597.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.82       2.11  0.0348
## 2 water           0.183     -1.99  0.0471
## 3 nematodes       0.163     -1.25  0.213
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 791.1
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3722 -0.5391 -0.0761  0.6516  3.5152 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  237.7   15.42   
##  subject  (Intercept) 3991.2   63.18   
##  Residual              621.8   24.94   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.472     26.720   7.578
## attitudepop  -20.106      5.479  -3.670
## 
...
\begin{verbatim}
##           ctrl      high      low       mid
## ctrl 1.0000000 0.0025147 0.00e+00 0.0000048
## high 0.0025147 1.0000000 1.00e-07 0.0345598
## low  0.0000000 0.0000001 1.00e+00 0.0000372
## mid  0.0000048 0.0345598 3.72e-05 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 11, 13, 5, 15 und 1!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 16, 15, 14, 9 und 10! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, P und grade an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCGO18U & 1.5 | 4.0 | Normal \\
    B & GCEFFDO & 1.0 | 3.0 | Klein \\ 
    C & GCRJCBK & 3.0 | 2.0 | Klein \\ 
    D & GCECKUC & 3.5 | 3.5 | Normal \\ 
    E & GCC5RGY & 5.0 | 4.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1081 n. Chr. f{\"u}r den neuen Lehnsherren
...
\item Erg{\"a}nzen Sie in der Tabelle den \textit{gesamten} Fleischkonsum in
  Deutschland und Nigeria im Jahr 2020, der sich aus der Abbildung ergibt! \textbf{(1 Punkt)}
\end{enumerate}
...
Sie haben den Vektor $A = \{16, 5, 13\}$ und den Vektor $B = \{1, 4, 2\}$ gegeben.
