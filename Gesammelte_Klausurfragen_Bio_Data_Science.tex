...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.03, 0.89, 0.001 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 1, 0.005 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.006, 0.178, 2e-04 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.006, 0.178, 2e-04 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.05, 0.15, 4.45, 0.005 und 2.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 1, 0.005 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 12, 5, 9, 11 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.4 +/- 3.65
\item [\textbf{B} \msquare] Es ergibt sich 9.4 +/- 1.35
\item [\textbf{C} \msquare] Es ergibt sich 9.4 +/- 2.7
\item [\textbf{D} \msquare] Es ergibt sich 9.4 +/- 7.3
\item [\textbf{E} \msquare] Es ergibt sich 10.4 +/- 1.35
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 32, 28, 23, 14, 17, 31 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 28 +/- 17
\item [\textbf{B} \msquare] Es ergibt sich 30 [18, 33]
\item [\textbf{C} \msquare] Es ergibt sich 28 +/- 32
\item [\textbf{D} \msquare] Es ergibt sich 30 +/- 17
\item [\textbf{E} \msquare] Es ergibt sich 28 [17, 32]
\end{enumerate} 
...
$y = \{19, 13, 10, 14, 19, 6, 18, 18, 16, 21, 11\}$. Berechnen Sie folgende
...
\begin{center}
$13.4, 9.8, 12.5, 11.3, 10.5, 6.4, 7.5, 11.4, 11.2, 14.3, 12.2, 9, 8.6, 5$
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 22.57 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 87.43 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 90.286  45.143  16.159 9.592e-05
## Residuals 18 50.286   2.794
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 123 114 121 105 109  94 144 145 147 174 146 150
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 2.98 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 92.46 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 111.26 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 154.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 195.14  97.568  5.9123 0.0106241
## form       1 304.83 304.833 18.4718 0.0004331
## dose:form  2 191.75  95.873  5.8095 0.0113059
## Residuals 18 297.05  16.503
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 86$ Pflanzen untersucht.
\vspace{5Ex}
...
## -5.4286 -1.0714  0.1429  1.7143  3.5714 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   14.429      1.007  14.331 6.54e-09
## waterB        -2.143      1.424  -1.505    0.158
## 
## Residual standard error: 2.664 on 12 degrees of freedom
## Multiple R-squared:  0.1588,	Adjusted R-squared:  0.08869 
## F-statistic: 2.265 on 1 and 12 DF,  p-value: 0.1582
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.1588$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: rainfall, block und N. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.08 & 1 & 10.32 & 97.81 & 67.48 & 6\\
7.66 & 1 & 9.90 & 94.20 & 67.46 & 6\\
9.92 & 1 & 10.38 & 99.46 & 66.22 & 12\\
9.76 & 0 & 9.06 & 105.49 & 74.48 & 11\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.9300 -1.1425 -0.0658  1.3006  5.7218 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -16.35849    8.44494  -1.937   0.0561
## light         0.62156    0.50794   1.224   0.2245
## Fe            0.85164    0.08179  10.413   <2e-16
## water         0.09589    0.17284   0.555   0.5805
## 
## Residual standard error: 2.097 on 83 degrees of freedom
## Multiple R-squared:  0.5668,	Adjusted R-squared:  0.5511 
## F-statistic: 36.19 on 3 and 83 DF,  p-value: 4.676e-15
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
SOUTH\_FORK\_LINGANORE\_CR & 20 & 4106 & 5.45 & 2.62 & 10.0\\
MUDLICK\_RUN & 8 & 1507 & 16.30 & 0.84 & 7.4\\
LITTLE\_GUNPOWDER\_R & 3 & 15305 & 6.96 & 2.60 & 9.7\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -9.2978  -4.4114  -2.1120   0.6446  20.0046  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.707e+00  1.425e+00   1.900  0.06329
## acerage      4.860e-05  1.457e-05   3.336  0.00163
## so4         -2.213e-02  3.264e-02  -0.678  0.50099
## no3          2.106e-01  7.406e-02   2.844  0.00649
## do2          1.669e-02  1.563e-01   0.107  0.91541
## 
## (Dispersion parameter for quasipoisson family taken to be 47.68122)
## 
##     Null deviance: 2532.6  on 53  degrees of freedom
## Residual deviance: 1717.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.41       2.31  0.0208
## 2 water           0.131     -2.10  0.0358
## 3 nematodes       0.150     -1.26  0.208
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2821 -0.6607 -0.0759  0.6630  3.4711 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  217.7   14.76   
##  subject  (Intercept) 4075.6   63.84   
##  Residual              647.6   25.45   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.507     26.940   7.480
## attitudepop  -18.610      5.591  -3.328
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0593769 0.2519841 0.0894157
## high 0.0593769 1.0000000 0.4363314 0.8402162
## low  0.2519841 0.4363314 1.0000000 0.5626364
## mid  0.0894157 0.8402162 0.5626364 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 17, 0, 13, -3 und 7!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 7, 9, 11, 20 und 11! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, P und freshmatter an vier verschiedenen Messterminen.
...
\midrule
wing/leg stretching & 20cm; 34cm; 2.1\% & 39cm; 23cm; 4.1\% & 34cm; 30cm; 4.1\%\\
walking & 30cm; 24cm; 0.8\% & 42cm; 19cm; 0.2\% & 36cm; 36cm; 0.4\%\\
drinking/eating & 34cm; 29cm; 5.1\% & 37cm; 23cm; 1.2\% & 37cm; 23cm; 3.2\%\\
foraging incl. scratching & 27cm; 23cm; 13.2\% & 31cm; 15cm; 18.1\% & 29cm; 25cm; 12.8\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCMHLU4 & 2.0 | 2.5 | Normal \\
    B & GCRARWM & 4.5 | 5.0 | Mikro \\ 
    C & GC8STL7 & 1.0 | 3.5 | Mikro \\ 
    D & GCBX7AL & 2.5 | 4.5 | Mikro \\ 
    E & GCUWXXJ & 3.0 | 1.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 351 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{14, 6, 6\}$ und den Vektor $B = \{5, 8, 5\}$ gegeben.
