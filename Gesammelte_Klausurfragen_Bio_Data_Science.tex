...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.001, 0.42, 0.34, 0.01 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.006, 1, 1, 0.06 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.006, 1, 1, 0.06 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1483, 2e-04, 0.07, 0.0567, 0.0017 und 0.035. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1483, 2e-04, 0.07, 0.0567, 0.0017 und 0.035. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 5.34, 0.006, 2.52, 2.04, 0.06 und 1.26. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 8, 10, 13 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.8 +/- 2.86
\item [\textbf{B} \msquare] Es ergibt sich 8.8 +/- 4.1
\item [\textbf{C} \msquare] Es ergibt sich 10.8 +/- 1.43
\item [\textbf{D} \msquare] Es ergibt sich 9.8 +/- 1.43
\item [\textbf{E} \msquare] Es ergibt sich 9.8 +/- 8.2
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 24, 23, 9, 11, 28, 27, 16, 15, 14, 23 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 14
\item [\textbf{B} \msquare] Es ergibt sich 23 [14, 27]
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 14
\item [\textbf{D} \msquare] Es ergibt sich 23 +/- 27
\item [\textbf{E} \msquare] Es ergibt sich 21 [14, 27]
\end{enumerate}
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.59 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.3 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.2, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\midrule
(Intercept) & 38.77 & 0.28\\
light\_binhigh & 3.33 & 0.40\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 3.33
...
\item [\textbf{D} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 11.11
\item [\textbf{E} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 11.11
\end{enumerate}
...
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 154
...
$y = \{9, 14, 14, 21, 17, 14, 21\}$. Berechnen Sie folgende
...
\begin{center}
$7.3, 11.6, 9.2, 9.6, 9.4, 8.1, 5.3, 12.7, 11.3, 6.1, 11.3, 8.5$
\end{center}
...
## t = 0.28975, df = 14, p-value = 0.7763
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.150329  4.134456
## sample estimates:
...
## t = 4.4513, df = 16, p-value = 0.0004021
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##   3.608126 10.169652
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 86.38 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 26.86 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 101.168  50.584   31.06 7.341e-07
## Residuals 20  32.571   1.629
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 130 121  95  94  84 109 145 137 134 152 140 157
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 55.53 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 72.6 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 82.36 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 296.36 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 260.55 130.277  7.8316 0.003573
## form       1 242.51 242.515 14.5788 0.001259
## dose:form  2 124.96  62.478  3.7559 0.043330
## Residuals 18 299.43  16.635
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##  -4.00  -1.05   0.50   1.15   4.00 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   14.400      1.142  12.610 1.83e-07
## trtB          -1.400      1.495  -0.936    0.371
## 
## Residual standard error: 2.553 on 10 degrees of freedom
## Multiple R-squared:  0.08061,	Adjusted R-squared:  -0.01133 
## F-statistic: 0.8768 on 1 and 10 DF,  p-value: 0.3711
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: center, variety und weight. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.91 & 0 & 9.46 & 101.11 & 72.03 & 8\\
9.70 & 0 & 8.83 & 100.13 & 66.16 & 10\\
10.49 & 1 & 12.42 & 96.99 & 66.85 & 5\\
7.91 & 1 & 9.07 & 103.55 & 71.91 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.2624 -1.6197 -0.3665  1.4972  5.9789 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  6.13251    9.07651   0.676   0.5012
## light        0.40798    0.58072   0.703   0.4844
## P           -0.50675    0.20370  -2.488   0.0149
## Fe           0.68339    0.08543   8.000  8.1e-12
## 
## Residual standard error: 2.427 on 80 degrees of freedom
## Multiple R-squared:  0.4939,	Adjusted R-squared:  0.475 
## F-statistic: 26.03 on 3 and 80 DF,  p-value: 7.553e-12
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & maxdepth & no3 & temp & so4\\
\midrule
LITTLE\_DEER\_CR & 38 & 110 & 3.40 & 20.5 & 9.22\\
SOUTH\_BR\_PATAPSCO & 26 & 60 & 2.96 & 18.6 & 8.84\\
SAVAGE\_R & 106 & 73 & 0.63 & 21.4 & 12.28\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.833  -4.793  -2.497   1.583  16.159  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.569805   1.043391   1.505  0.13887
## maxdepth     0.011597   0.004376   2.650  0.01080
## no3          0.235138   0.083380   2.820  0.00691
## temp         0.033315   0.044717   0.745  0.45982
## so4         -0.012220   0.026177  -0.467  0.64271
## 
## (Dispersion parameter for quasipoisson family taken to be 44.50656)
## 
##     Null deviance: 2439.4  on 53  degrees of freedom
## Residual deviance: 1784.4  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.439    -1.12    0.263
## 2 light           0.462     1.33    0.183
## 3 nematodes       0.159     0.331   0.741
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0147 -0.5739 -0.1097  0.5385  3.8121 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  200.9   14.17   
##  subject  (Intercept) 4000.5   63.25   
##  Residual              710.9   26.66   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.472     26.691   7.586
## attitudepop  -19.444      5.858  -3.319
## 
...
\begin{verbatim}
##          ctrl      high       low       mid
## ctrl 1.00e+00 0.0000000 0.0000104 0.0000001
## high 0.00e+00 1.0000000 0.0070414 0.2989025
## low  1.04e-05 0.0070414 1.0000000 0.0775198
## mid  1.00e-07 0.2989025 0.0775198 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 6, 11, 24, 7 und 12!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 14, 12, 19, 11 und 12! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, Fe und drymatter an zwei verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{8, 0, -9\}$ und den Vektor $B = \{13, 1, -3\}$ gegeben.
