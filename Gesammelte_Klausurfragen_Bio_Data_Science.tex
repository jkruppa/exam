...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.001, 0.34, 0.89 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.005, 1, 1 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.005, 1, 1 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 2e-04, 0.068, 0.178 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.005, 1.7, 4.45 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 2e-04, 0.068, 0.178 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 8, 7, 14, 16 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.4 +/- 7.4
\item [\textbf{B} \msquare] Es ergibt sich 11.4 +/- 1.925
\item [\textbf{C} \msquare] Es ergibt sich 11.4 +/- 3.85
\item [\textbf{D} \msquare] Es ergibt sich 11.4 +/- 14.8
\item [\textbf{E} \msquare] Es ergibt sich 12.4 +/- 1.925
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 21, 20, 13, 10, 22, 25, 34, 31, 20, 23 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 [20, 31]
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 20
\item [\textbf{C} \msquare] Es ergibt sich 24 [21, 32]
...
$y = \{18, 18, 21, 19, 20, 18, 18, 20, 17, 17, 18\}$. Berechnen Sie folgende
...
\begin{center}
$11.4, 13.9, 6.3, 7.8, 10.9, 15.1, 9.5, 8.3, 11.2, 4.6, 10.4, 11$
\end{center}
...
## t = 2.6423, df = 12, p-value = 0.02148
...
## t = -3.4385, df = 14, p-value = 0.003995
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -6.598098 -1.528886
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 14 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 69.14 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 26.747  13.373  3.5625 0.04749
## Residuals 20 75.079   3.754
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 118 126 104 107 104 113 139 153 138 140 165 180
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 0.42 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 421.55 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 287.07 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 295.51 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 471.99 235.995 33.6711 8.260e-07
## form       1  21.50  21.501  3.0676   0.09689
## dose:form  2 380.67 190.335 27.1565 3.669e-06
## Residuals 18 126.16   7.009
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.1429 -1.4444  0.0556  1.6310  5.5556 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  15.1429     1.0156  14.910 5.51e-10
## trtB          0.3016     1.3541   0.223    0.827
## 
## Residual standard error: 2.687 on 14 degrees of freedom
## Multiple R-squared:  0.003531,	Adjusted R-squared:  -0.06765 
## F-statistic: 0.0496 on 1 and 14 DF,  p-value: 0.827
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 4.2513, df = 8, p-value = 0.002794
...
Einflussvariablen ($x$) wurden erhoben: dosage, N und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
6.08 & 0 & 9.54 & 99.06 & 70.30 & 7\\
10.10 & 1 & 9.69 & 98.89 & 68.93 & 13\\
11.65 & 1 & 9.83 & 94.33 & 62.98 & 6\\
9.60 & 0 & 10.93 & 104.65 & 71.02 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.2638 -1.5494  0.1851  1.3407  5.6174 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -10.05818    6.93214  -1.451    0.151
## nematodes     0.02544    0.09123   0.279    0.781
## light        -0.51790    0.65632  -0.789    0.432
## Fe            0.79687    0.06978  11.420   <2e-16
## 
## Residual standard error: 2.29 on 81 degrees of freedom
## Multiple R-squared:  0.6212,	Adjusted R-squared:  0.6071 
## F-statistic: 44.27 on 3 and 81 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & maxdepth & acerage & no3\\
\midrule
PRETTYBOY\_BR & 19 & 19.2 & 39 & 904 & 6.81\\
DEEP\_RUN & 5 & 21.8 & 57 & 1175 & 1.30\\
SENECA\_CR & 23 & 20.1 & 45 & 18422 & 1.58\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.877  -3.517  -1.990   2.125  13.903  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.843e+00  8.051e-01   2.290 0.026380
## temp        7.988e-03  3.654e-02   0.219 0.827872
## maxdepth    1.002e-02  3.625e-03   2.763 0.008042
## acerage     4.286e-05  1.108e-05   3.870 0.000322
## no3         1.689e-01  5.598e-02   3.018 0.004034
## 
## (Dispersion parameter for quasipoisson family taken to be 26.65167)
## 
##     Null deviance: 1996.1  on 53  degrees of freedom
## Residual deviance: 1180.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.57      0.665   0.506
## 2 nematodes       0.135    -0.586   0.558
## 3 water           0.157    -0.602   0.547
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0507 -0.6214 -0.0724  0.4984  3.5642 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  212.4   14.57   
##  subject  (Intercept) 4051.5   63.65   
##  Residual              696.0   26.38   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.588     26.873   7.501
## attitudepop  -19.777      5.797  -3.412
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.6228654 0.1322071 0.4109969
## high 0.6228654 1.0000000 0.0495199 0.1930379
## low  0.1322071 0.0495199 1.0000000 0.4817181
## mid  0.4109969 0.1930379 0.4817181 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 16, 7, 15, 4 und 9!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 3, 9, 12 und 8! \textbf{(2 Punkte)}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC6U4JO & 4.5 | 4.0 | Normal \\
    B & GC79TJK & 1.5 | 1.5 | Normal \\ 
    C & GCEVJQV & 3.0 | 4.5 | Normal \\ 
    D & GCABUE2 & 2.0 | 5.0 | Normal \\ 
    E & GCHKBIR & 3.5 | 3.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 322 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{4, -10, 4\}$ und den Vektor $B = \{9, -1, 5\}$ gegeben.
