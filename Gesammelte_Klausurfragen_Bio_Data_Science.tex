...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.34, 0.03, 0.21, 0.89 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.0567, 0.005, 0.035, 0.1483 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.0567, 0.005, 0.035, 0.1483 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.18, 1, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.18, 1, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.52, 2.04, 0.18, 1.26, 5.34 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 7, 11, 13 und 1.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.4 +/- 4.67
\item [\textbf{B} \msquare] Es ergibt sich 9.4 +/- 2.335
\item [\textbf{C} \msquare] Es ergibt sich 7.4 +/- 10.9
\item [\textbf{D} \msquare] Es ergibt sich 8.4 +/- 2.335
\item [\textbf{E} \msquare] Es ergibt sich 8.4 +/- 21.8
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 7, 24, 38, 28, 34, 7 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 28 +/- 38
\item [\textbf{B} \msquare] Es ergibt sich 26 [7, 38]
\item [\textbf{C} \msquare] Es ergibt sich 28 [7, 38]
\item [\textbf{D} \msquare] Es ergibt sich 26 +/- 7
\item [\textbf{E} \msquare] Es ergibt sich 28 +/- 7
\end{enumerate}
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.55 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.82 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 1.4, da es sich um ein Anteil handelt.
...
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.71, da es sich um ein Anteil handelt.
...
In einem Stallexperiment mit $n = 91$ Ferkeln wurden verschiedene
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 0.06
\item [\textbf{B} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.25
...
\item [\textbf{E} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 0.06
\end{enumerate}
...
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 155
\end{enumerate}
...
$y = \{15, 18, 20, 15, 18, 19, 16\}$. Berechnen Sie folgende
...
\begin{center}
$7.9, 12.5, 9.5, 7.8, 8.7, 5.6, 10.4, 11.9, 10, 7.6, 8.6, 7.5, 11.5, 12$
\end{center}
...
## t = -2.1557, df = 16, p-value = 0.04668
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.50949093 -0.04606463
## sample estimates:
## mean in group high mean in group trt1 
##           15.00000           17.77778
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 130 113 110  92 101 100 126 142 127 153 136 164
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 4.1 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.91 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  3.7231 1.86154  4.1925 0.02596 *
## Residuals 27 11.9884 0.44402                  
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 198.98 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2434.21 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 105.25 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 713.78 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df  Sum Sq Mean Sq F value    Pr(>F)    
## supp       1  398.87  398.87 27.5384 1.863e-06 ***
## dose       2 2817.23 1408.62 97.2515 < 2.2e-16 ***
## supp:dose  2  106.32   53.16  3.6701   0.03098 *  
## Residuals 64  926.99   14.48                      
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
## -4.2222 -1.1667  0.3889  1.0000  2.7778 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  19.2222     0.6774  28.377 2.27e-12 ***
## trtB         -3.2222     1.1335  -2.843   0.0148 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.032 on 12 degrees of freedom
## Multiple R-squared:  0.4024,	Adjusted R-squared:  0.3526 
## F-statistic: 8.081 on 1 and 12 DF,  p-value: 0.01482
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: region, block und N. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & acerage & no3 & so4 & do2\\
\midrule
RED\_RUN & 32 & 3332 & 2.09 & 5.50 & 8.4\\
HERRINGTON\_RUN & 1 & 7056 & 0.25 & 9.82 & 6.4\\
SOUTH\_BR\_CASSELMAN\_R & 2 & 6311 & 0.64 & 21.16 & 7.6\\
FISHING\_CR & 11 & 5046 & 0.73 & 7.10 & 7.6\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -6.6885  -3.2004  -0.2512   1.7583   7.8429  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  6.400e-01  7.781e-01   0.823  0.41475    
## acerage      5.436e-05  8.296e-06   6.553 3.27e-08 ***
## no3          8.630e-02  5.105e-02   1.690  0.09731 .  
## so4         -2.048e-02  1.810e-02  -1.132  0.26332    
## do2          2.642e-01  8.762e-02   3.015  0.00406 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 14.70476)
## 
##     Null deviance: 1475.05  on 53  degrees of freedom
## Residual deviance:  721.79  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.353    -0.421   0.674
## 2 nematodes       0.149     0.161   0.872
## 3 light           0.460     0.204   0.838
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
11.39 & 0 & 7.69 & 96.24 & 68.88 & 14\\
12.96 & 0 & 13.20 & 103.77 & 67.57 & 11\\
10.84 & 1 & 11.58 & 104.85 & 71.87 & 7\\
9.65 & 1 & 12.01 & 100.70 & 69.96 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -10.172  -2.042   0.168   2.184   7.708 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 75.84604    3.05458  24.830   <2e-16 ***
## water       -0.24212    0.21270  -1.138    0.257    
## nematodes   -0.03811    0.10262  -0.371    0.711    
## P           -0.31102    0.21308  -1.460    0.147    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.335 on 114 degrees of freedom
## Multiple R-squared:  0.03302,	Adjusted R-squared:  0.007568 
## F-statistic: 1.297 on 3 and 114 DF,  p-value: 0.2788
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4426 -0.6010 -0.2142  0.7053  3.3564 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  204.7   14.31   
##  subject  (Intercept) 3768.7   61.39   
##  Residual              754.8   27.47   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.707     25.987   7.762
## attitudepop  -19.421      6.037  -3.217
## 
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.0259792 0.0072167 0.0000002
## B 0.0259792 1.0000000 0.0000109 0.0000000
## C 0.0072167 0.0000109 1.0000000 0.0008945
## D 0.0000002 0.0000000 0.0008945 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 7, 24, 38, 28, 34, 7 und 42!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 7, 24, 38, 28, 34, 7 und 42! \textbf{(2 Punkte)}
