...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit -1, 8, 6, 12 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 7 +/- 25
\item [\textbf{B} \msquare] Es ergibt sich 6 +/- 12.5
\item [\textbf{C} \msquare] Es ergibt sich 8 +/- 2.5
\item [\textbf{D} \msquare] Es ergibt sich 7 +/- 2.5
\item [\textbf{E} \msquare] Es ergibt sich 7 +/- 5
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 22, 32, 17, 25, 36, 38, 26, 24, 9, 24 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 +/- 22
\item [\textbf{B} \msquare] Es ergibt sich 25 [22, 36]
\item [\textbf{C} \msquare] Es ergibt sich 25 +/- 36
\item [\textbf{D} \msquare] Es ergibt sich 29 +/- 22
\item [\textbf{E} \msquare] Es ergibt sich 29 [23, 37]
\end{enumerate} 
...
In dem folgenden Histogramm von $n = 215$ Pflanzen ist welche
...
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.29, da es sich um eine Chancenverh{"a}ltnis handelt.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.89, 0.42, 0.21, 0.01 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.1483, 0.07, 0.035, 0.0017 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.04, 5.34, 2.52, 1.26, 0.06 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1, 1, 0.06 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1, 1, 0.06 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.1483, 0.07, 0.035, 0.0017 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\item [\textbf{E} \msquare] Nein, ein untersuchtes Individuum k{"o}nnen wir mit einem statistischen Test nicht auswerten. Wir erhalten keine Aussage zum Individuum.
\end{enumerate}
...
Nach einem Freilandversuch mit zwei D{"u}ngestufen ($ctrl$, $low$ und $high$) als Behandlung
...
\begin{center}
$2, 4, 7, 3, 5, 2, 5, 3, 4, 6, 9, 4, 3, 3, 2, 4, 6, 5, 4, 1, 3, 5, 6, 2, 5, 2, 5, 5, 6, 5$
\end{center}
...
\begin{center}
$6.6, 7.4, 14.3, 6.9, 9.5, 8, 10.8, 9.9, 10.7, 12.5, 8, 8.5, 11.2, 10.5, 9.1, 9.6, 12.8, 13.3, 8.5, 8.4$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ wahr & H$_0$ falsch & H$_0$ beibehalten & 20\% \\
  \end{tabular}
  \end{center}
...
## t = -0.48026, df = 12, p-value = 0.6397
...
## t = 0.38432, df = 10, p-value = 0.7088
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -2.467339  3.495910
## sample estimates:
...
## 
## data:  drymatter by Fe
## t = 1.8171, df = 14, p-value = 0.09066
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -0.3978518  4.8105503
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 108.02 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 79.46 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Der Datensatz \textit{crop\_tbl} enth{\"a}lt das Outcome \textit{drymatter} f{\"u}r ein Feldexperiment mit 
...
## trt        2  20.729 10.3644  2.1693 0.1381
## Residuals 22 105.111  4.7778
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 6.07 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 98.27 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 685.19 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 285.01 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 60 Rindern durchgef{\"u}hrt, wobei
...
## Response: weight
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 422.18 211.089 14.1789 0.0002006
## form       1  10.80  10.795  0.7251 0.4056601
## dose:form  2 117.48  58.739  3.9455 0.0379418
## Residuals 18 267.98  14.888
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000898 0.0417501 0.0028905
## high 0.0000898 1.0000000 0.0000002 0.2194865
## low  0.0417501 0.0000002 1.0000000 0.0000072
## mid  0.0028905 0.2194865 0.0000072 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 104$ Sauen. In dem Experiment wurde gemessen,
...
## -4.7143 -1.5357  0.1429  1.0000  4.2857 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  13.7143     0.9221  14.872 4.29e-09
## waterB       10.2857     1.3041   7.887 4.35e-06
## 
## Residual standard error: 2.44 on 12 degrees of freedom
## Multiple R-squared:  0.8383,	Adjusted R-squared:  0.8248 
## F-statistic: 62.21 on 1 and 12 DF,  p-value: 4.347e-06
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -6.3499, df = 8, p-value = 0.0002206
...
Einflussvariablen ($x$) wurden erhoben: rainfall, weight und N. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\item $i$ dem Verhalten: (1) foraging incl. scratching, (2) walking, (3)
  sitting und (4) wing/leg stretching.
\end{itemize}
...
\midrule
foraging incl. scratching & 36cm; 31cm; 25.4\% & 27cm; 26cm; 64.1\% & 29cm; 23cm; 25.4\%\\
walking & 28cm; 30cm; 2.1\% & 31cm; 19cm; 5.2\% & 38cm; 28cm; 2.1\%\\
sitting & 33cm; 22cm; 0.4\% & 39cm; 16cm; 0.6\% & 34cm; 25cm; 0.4\%\\
wing/leg stretching & 42cm; 19cm; 6.2\% & 36cm; 27cm; 6.1\% & 26cm; 29cm; 3.2\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCPY3IV & 4.0 | 2.0 | Mikro \\
    B & GCJ3YFY & 1.0 | 1.5 | Normal \\ 
    C & GCSP7GK & 2.5 | 2.5 | Klein \\ 
    D & GCJU5RM & 5.0 | 5.0 | Mikro \\ 
    E & GCXBP0A & 4.5 | 4.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1149 n. Chr. f{\"u}r den neuen Lehnsherren
...
4.5\% p.a. {\"u}ber 72 Monate finanzieren.
...
Sie haben den Vektor $A = \{18, 3, 7\}$ und den Vektor $B = \{3, 2, 4\}$ gegeben.
