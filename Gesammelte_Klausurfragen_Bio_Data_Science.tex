...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.03, 0.89, 0.42, 0.01 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.04, 0.18, 5.34, 2.52, 0.06 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.005, 0.1483, 0.07, 0.0017 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.18, 1, 1, 0.06 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.18, 1, 1, 0.06 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.005, 0.1483, 0.07, 0.0017 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 11, 6, 12 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10 +/- 1.175
\item [\textbf{B} \msquare] Es ergibt sich 10 +/- 5.5
\item [\textbf{C} \msquare] Es ergibt sich 11 +/- 1.175
\item [\textbf{D} \msquare] Es ergibt sich 10 +/- 2.35
\item [\textbf{E} \msquare] Es ergibt sich 9 +/- 2.75
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 20, 31, 17, 23, 15, 11, 23, 26, 31, 21 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 [17, 31]
...
\item [\textbf{E} \msquare] Es ergibt sich 26 +/- 17
\end{enumerate} 
...
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.42, da es sich um eine Chancenverh{"a}ltnis handelt.
...
$y = \{19, 12, 16, 19, 12, 12, 19\}$. Berechnen Sie folgende
...
\begin{center}
$9.7, 8.1, 13.6, 11.3, 9.3, 9.7, 9.9, 11.9, 11.8, 6.8, 10.3, 8.9, 8.1, 12.3, 9.7$
\end{center}
...
## t = 0.59684, df = 12, p-value = 0.5617
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.827302  4.960635
## sample estimates:
...
## 
## data:  freshmatter by N
## t = -0.32187, df = 14, p-value = 0.7523
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.257465  3.146354
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 103.7 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 70.54 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2   2.921  1.4603  0.2945 0.7478
## Residuals 22 109.079  4.9582
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 114 118 107 105 105 106 132 151 148 149 166 149
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 94.83 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 78.38 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 173.24 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 349.13 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 117.90  58.951  4.8291 0.0209428
## form       1   4.15   4.148  0.3398 0.5671606
## dose:form  2 354.72 177.360 14.5288 0.0001753
## Residuals 18 219.74  12.208
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.7778 -0.7778  0.2111  0.9722  2.2222 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  15.8000     0.8598  18.376 3.74e-10
## trtB         -1.0222     1.0724  -0.953    0.359
## 
## Residual standard error: 1.923 on 12 degrees of freedom
## Multiple R-squared:  0.07039,	Adjusted R-squared:  -0.007075 
## F-statistic: 0.9087 on 1 and 12 DF,  p-value: 0.3593
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
11.61 & 0 & 12.57 & 102.47 & 70.26 & 11\\
10.79 & 0 & 10.33 & 98.65 & 72.84 & 10\\
8.77 & 0 & 9.02 & 103.87 & 68.00 & 14\\
10.33 & 0 & 10.48 & 98.28 & 67.80 & 8\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##    Min     1Q Median     3Q    Max 
## -5.526 -1.261 -0.190  1.371  4.914 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  5.52182    8.87010   0.623    0.535
## light        0.05680    0.59634   0.095    0.924
## Fe           0.64761    0.08742   7.408 6.98e-11
## nematodes   -0.09705    0.07390  -1.313    0.192
## 
## Residual standard error: 2.492 on 89 degrees of freedom
## Multiple R-squared:  0.4067,	Adjusted R-squared:  0.3867 
## F-statistic: 20.34 on 3 and 89 DF,  p-value: 4.001e-10
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & so4 & do2 & maxdepth & acerage\\
\midrule
WATTS\_BR & 19 & 14.19 & 6.7 & 82 & 510\\
NORTHWEST\_BR\_ANACOSTIA\_R & 100 & 14.45 & 8.4 & 107 & 22550\\
PATAPSCO\_R & 28 & 9.90 & 8.9 & 61 & 4706\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.784  -4.335  -1.866   1.463  17.457  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 7.217e-01  1.358e+00   0.531  0.59756
## so4         9.570e-04  2.123e-02   0.045  0.96423
## do2         2.067e-01  1.366e-01   1.513  0.13670
## maxdepth    8.412e-03  4.308e-03   1.953  0.05659
## acerage     4.204e-05  1.275e-05   3.297  0.00182
## 
## (Dispersion parameter for quasipoisson family taken to be 34.5046)
## 
##     Null deviance: 1985.2  on 53  degrees of freedom
## Residual deviance: 1401.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.41     -0.357  0.721 
## 2 water           0.139     0.323  0.747 
## 3 light           0.462     1.95   0.0516
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 788
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4010 -0.6382 -0.0415  0.5016  3.3690 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  220.6   14.85   
##  subject  (Intercept) 4184.1   64.68   
##  Residual              596.8   24.43   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.876     27.259   7.442
## attitudepop  -19.604      5.368  -3.652
## 
...
\begin{verbatim}
##           ctrl     high      low       mid
## ctrl 1.0000000 0.00e+00 3.75e-05 0.0216638
## high 0.0000000 1.00e+00 0.00e+00 0.0000196
## low  0.0000375 0.00e+00 1.00e+00 0.0000000
## mid  0.0216638 1.96e-05 0.00e+00 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 15, 15, 17, 6 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 9, 6, 5, 12 und 9! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes grade, drymatter und pigs an vier verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCIADPW & 3.0 | 3.5 | Klein \\
    B & GCVHKJK & 1.5 | 5.0 | Klein \\ 
    C & GCZ0ERV & 2.5 | 1.5 | Mikro \\ 
    D & GCD6ERL & 3.5 | 1.0 | Normal \\ 
    E & GC0SJ3Y & 4.5 | 2.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 405 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{13, 8, 18\}$ und den Vektor $B = \{1, 9, -1\}$ gegeben.
