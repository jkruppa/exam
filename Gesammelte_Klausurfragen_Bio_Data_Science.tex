...
\item [\textbf{C} \msquare] Die $\alpha$ Adjustierung wird durchgef{"u}hrt um den Fehler 2. Art zu kontrollieren. Ohne diese Adjustierung w{"u}rde der Fehler 2. Art nicht bei 80\% liegen sondern sehr schnell gegen 0 laufen.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.89, 0.01, 0.21, 0.42 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.06, 1, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.06, 1, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.1483, 0.0017, 0.035, 0.07 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.1483, 0.0017, 0.035, 0.07 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.04, 5.34, 0.06, 1.26, 2.52 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Der Korrelationskoeffizienten nach Kendall wird genutzt, wenn das Outcome Y nicht normalverteilt ist. Der Korrelationskoeffizienten liegt zwischen 0 und 1.
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 7, 11, 14 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.6 +/- 2.7
\item [\textbf{B} \msquare] Es ergibt sich 10.6 +/- 7.3
\item [\textbf{C} \msquare] Es ergibt sich 11.6 +/- 1.35
\item [\textbf{D} \msquare] Es ergibt sich 9.6 +/- 3.65
\item [\textbf{E} \msquare] Es ergibt sich 10.6 +/- 1.35
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 18, 19, 21, 21, 4, 6 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 +/- 21
\item [\textbf{B} \msquare] Es ergibt sich 20 [6, 21]
\item [\textbf{C} \msquare] Es ergibt sich 19 [6, 21]
\item [\textbf{D} \msquare] Es ergibt sich 19 +/- 6
\item [\textbf{E} \msquare] Es ergibt sich 20 +/- 6
\end{enumerate}
...
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.08 liegt keine Overdispersion vor.
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.08 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 1.4, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.42, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.71, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.71, da es sich um ein Anteil handelt.
\end{enumerate}
...
\item [\textbf{C} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 7.29
\item [\textbf{D} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -2.7
\item [\textbf{E} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 7.29
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 136
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 69
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 138
...
$y = \{22, 18, 17, 14, 25, 9, 24\}$. Berechnen Sie folgende
...
\begin{center}
$11.8, 11, 12.9, 12.4, 14.3, 9.4, 8.2, 8.1, 7.6, 13.8, 8.3, 11.2, 11.4, 11.8, 8.8$
\end{center}
...
## t = 0.23973, df = 10, p-value = 0.8154
...
## t = -2.2702, df = 12, p-value = 0.04242
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -8.666381 -0.178063
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 0.22 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 71.78 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 16.858  8.4292  3.4791 0.04866
## Residuals 22 53.302  2.4228
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 124 128 124 124 109  90 139 146 142 139 146 152
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 73.14 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 567.56 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 191.5 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 30 & 790.13 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value  Pr(>F)
## dose       2  73.290  36.645  2.6106 0.10104
## form       1  17.963  17.963  1.2797 0.27281
## dose:form  2 130.987  65.493  4.6657 0.02331
## Residuals 18 252.670  14.037
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##  -3.20  -0.65   0.00   1.10   2.80 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  16.8000     0.9165  18.330 8.07e-08
## trtB         10.4000     1.2961   8.024 4.27e-05
## 
## Residual standard error: 2.049 on 8 degrees of freedom
## Multiple R-squared:  0.8895,	Adjusted R-squared:  0.8757 
## F-statistic: 64.38 on 1 and 8 DF,  p-value: 4.275e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: S, block und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.31 & 0 & 10.53 & 105.69 & 75.48 & 10\\
10.16 & 0 & 10.87 & 97.45 & 67.04 & 8\\
8.56 & 0 & 11.49 & 99.99 & 68.95 & 4\\
10.69 & 1 & 7.56 & 94.58 & 63.30 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.9755 -1.8289  0.1624  1.5833  6.9314 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -7.59017    9.30903  -0.815  0.41683
## Fe           0.83833    0.09146   9.166  7.2e-15
## light        0.40665    0.68110   0.597  0.55184
## P           -0.62978    0.19782  -3.184  0.00194
## 
## Residual standard error: 2.761 on 99 degrees of freedom
## Multiple R-squared:  0.4842,	Adjusted R-squared:  0.4686 
## F-statistic: 30.98 on 3 and 99 DF,  p-value: 3.283e-14
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & no3 & temp & so4\\
\midrule
BEAVER\_DAM\_CR & 19 & 3570 & 5.44 & 17.0 & 16.53\\
RED\_RUN & 32 & 3332 & 2.09 & 17.7 & 5.50\\
DEEP\_RUN & 5 & 1175 & 1.30 & 21.8 & 21.68\\
SECOND\_MINE\_BR & 62 & 2511 & 4.17 & 17.7 & 10.75\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -7.688  -4.508  -1.833   2.489  16.954  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.564e+00  7.487e-01   2.089  0.04194
## acerage     4.029e-05  1.159e-05   3.475  0.00108
## no3         1.635e-01  5.789e-02   2.825  0.00682
## temp        6.068e-02  3.704e-02   1.638  0.10776
## so4         4.324e-03  1.889e-02   0.229  0.81993
## 
## (Dispersion parameter for quasipoisson family taken to be 31.01907)
## 
##     Null deviance: 2025.1  on 53  degrees of freedom
## Residual deviance: 1356.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.52       2.48  0.0133
## 2 water           0.153     -2.53  0.0112
## 3 light           0.458      1.87  0.0620
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1645 -0.6719 -0.1401  0.5261  3.2736 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  241.5   15.54   
##  subject  (Intercept) 3961.4   62.94   
##  Residual              655.0   25.59   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.439     26.652   7.633
## attitudepop  -20.385      5.624  -3.625
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0126017 0.0246014 0.3303258
## high 0.0126017 1.0000000 0.7777875 0.1077059
## low  0.0246014 0.7777875 1.0000000 0.1801055
## mid  0.3303258 0.1077059 0.1801055 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 11, 6, 17, 5 und 9!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 6, 10, 9 und 10! \textbf{(2 Punkte)}
...
haben einen Radius von 4cm und eine H{\"o}he von 9cm. Der
