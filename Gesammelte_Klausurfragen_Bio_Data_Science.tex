...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\blacksquare\!\square\!\square\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\square\!\blacksquare\!\square\!\blacksquare$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\begin{center}
  \includegraphics[height = 12cm]{C:/Users/jokruppa/Documents/GitHub/exam/question/img/statistisches-testen-04}
\end{center}
...
Einflussvariablen ($x$) wurden erhoben: rainfall, dry und block. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
walking & 37cm; 31cm; 1.8\% & 41cm; 24cm; 4.1\% & 37cm; 29cm; 3.5\%\\
dustbathing & 23cm; 19cm; 1.6\% & 44cm; 29cm; 2.4\% & 39cm; 28cm; 8.1\%\\
preening & 31cm; 32cm; 4.1\% & 27cm; 20cm; 5.2\% & 40cm; 30cm; 3.6\%\\
wing/leg stretching & 38cm; 35cm; 3.2\% & 34cm; 28cm; 5.1\% & 41cm; 19cm; 6.9\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC3JG1L & 5.0 | 5.0 | Mikro \\
    B & GCIJYZT & 1.5 | 3.5 | Mikro \\ 
    C & GCVKTJ2 & 4.5 | 2.0 | Klein \\ 
    D & GCQKBZO & 2.5 | 1.5 | Normal \\ 
    E & GCBO7KH & 1.0 | 4.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 854 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{10^{9}} \cdot 1.9^{-0.1 \cdot t + 2.7}
\end{equation*}
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  5-mal-gefaltete, 0.6mm, 30-cm-Karton} durch
...
Das Jahr 2020 war das erfolgreichste Jahr in der Geschichte von
...
2019. Doch wie viel kommt bei den Partnern an? Laut
...
\item Berechnen Sie zuerst den Umsatz der Firma D-FL/R im
  Jahr 2020! \textbf{(1 Punkt)}
\item Wie viel von dem Umsatz im Jahr 2020 wird im Durchschnitt von jedem
...
%% --------------------------------------------------------------------
\hfill\href{https://youtu.be/SZqp_vy3rgI}{\includegraphics[width = 2cm]{img/caution}} %%youtube
\hspace{2Ex}
%% --------------------------------------------------------------------
