...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.89, 0.42, 0.34, 0.01 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.26, 5.34, 2.52, 2.04, 0.06 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1, 1, 0.06 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1, 1, 0.06 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.1483, 0.07, 0.0567, 0.0017 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.1483, 0.07, 0.0567, 0.0017 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 14, 13, 12, 8 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12.6 +/- 1.15
\item [\textbf{B} \msquare] Es ergibt sich 11.6 +/- 5.3
\item [\textbf{C} \msquare] Es ergibt sich 11.6 +/- 1.15
\item [\textbf{D} \msquare] Es ergibt sich 11.6 +/- 2.3
\item [\textbf{E} \msquare] Es ergibt sich 10.6 +/- 2.65
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 13, 15, 31, 2, 20, 17, 18, 23, 25, 27 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 20 +/- 27
\item [\textbf{B} \msquare] Es ergibt sich 20 +/- 15
\item [\textbf{C} \msquare] Es ergibt sich 20 [15, 27]
\item [\textbf{D} \msquare] Es ergibt sich 21 +/- 15
\item [\textbf{E} \msquare] Es ergibt sich 21 [16, 28]
\end{enumerate} 
...
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 1.33, da es sich um ein Anteil handelt.
...
$y = \{11, 9, 15, 15, 15, 17, 14\}$. Berechnen Sie folgende
...
\begin{center}
$9.4, 4.4, 11.6, 8.8, 11.6, 6.6, 9.1, 7.7, 8.8, 13.8, 7.2, 9.3$
\end{center}
...
## t = 1.8997, df = 12, p-value = 0.08176
...
## t = -3.7141, df = 10, p-value = 0.004014
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.908126 -1.977589
## sample estimates:
...
## 
## data:  freshmatter by N
## t = -6.4313, df = 6, p-value = 0.0006681
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 124.91 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 27.65 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 199.815  99.907   40.09 4.609e-08
## Residuals 22  54.825   2.492
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 126  82 119  89 112  86 146 142 152 140 147 173
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 46.5 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 193.04 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 191.73 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 302.97 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  41.17   20.58  2.1261  0.148288
## form       1 333.33  333.33 34.4308 1.479e-05
## dose:form  2 146.10   73.05  7.5457  0.004169
## Residuals 18 174.26    9.68
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -9.4286 -0.2500  0.2857  2.8214  4.5714 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.000      1.864   9.120 3.67e-06
## waterB        11.429      2.440   4.683 0.000864
## 
## Residual standard error: 4.168 on 10 degrees of freedom
## Multiple R-squared:  0.6868,	Adjusted R-squared:  0.6555 
## F-statistic: 21.93 on 1 and 10 DF,  p-value: 0.0008637
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.6868$ aus? \textbf{(2 Punkte)}
...
## t = 8.2532, df = 8, p-value = 3.487e-05
...
Einflussvariablen ($x$) wurden erhoben: region, height und variety. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
12.59 & 0 & 9.92 & 100.85 & 68.56 & 8\\
8.76 & 0 & 10.78 & 103.72 & 74.53 & 11\\
12.17 & 0 & 9.20 & 98.76 & 66.65 & 15\\
11.38 & 0 & 9.30 & 106.44 & 68.84 & 15\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.8992 -1.9491  0.1808  1.7447  5.9631 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 72.41942    2.86173  25.306   <2e-16
## P           -0.38694    0.19151  -2.021   0.0459
## light        1.72810    0.71901   2.403   0.0180
## water        0.04371    0.22263   0.196   0.8447
## 
## Residual standard error: 2.898 on 105 degrees of freedom
## Multiple R-squared:  0.08593,	Adjusted R-squared:  0.05981 
## F-statistic:  3.29 on 3 and 105 DF,  p-value: 0.02356
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & acerage & do2 & so4\\
\midrule
LITTLE\_PAINT\_BR & 63 & 1.19 & 5794 & 9.4 & 12.27\\
BIG\_PIPE\_CR & 18 & 3.53 & 25440 & 7.5 & 8.20\\
ISRAEL\_CR & 30 & 2.41 & 6260 & 9.5 & 13.77\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.144  -4.562  -1.915   1.384  20.298  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.295e+00  1.455e+00   1.577  0.12113
## no3          2.153e-01  7.631e-02   2.821  0.00689
## acerage      3.903e-05  1.443e-05   2.705  0.00937
## do2          6.579e-02  1.568e-01   0.420  0.67658
## so4         -1.612e-02  2.811e-02  -0.573  0.56896
## 
## (Dispersion parameter for quasipoisson family taken to be 47.17036)
## 
##     Null deviance: 2447  on 53  degrees of freedom
## Residual deviance: 1720  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.85      1.44    0.151
## 2 water           0.181    -1.51    0.132
## 3 light           0.513    -0.129   0.897
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1744 -0.6282 -0.0796  0.6073  3.3683 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  270.1   16.43   
##  subject  (Intercept) 4197.5   64.79   
##  Residual              662.3   25.74   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.499     27.458   7.375
## attitudepop  -20.430      5.655  -3.613
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000007 0.0004354 0.1507529
## high 0.0000007 1.0000000 0.0328250 0.0000501
## low  0.0004354 0.0328250 1.0000000 0.0199285
## mid  0.1507529 0.0000501 0.0199285 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 6, 4, 8, 12 und 1!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 15, 7, 12, 16 und 10! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes P, grade und freshmatter an zwei verschiedenen Messterminen.
...
\midrule
drinking/eating & 30cm; 31cm; 7.2\% & 29cm; 32cm; 12.1\% & 27cm; 29cm; 8.9\%\\
walking & 33cm; 25cm; 4.3\% & 31cm; 27cm; 2.1\% & 40cm; 25cm; 2.1\%\\
foraging incl. scratching & 31cm; 21cm; 0.6\% & 45cm; 25cm; 0.8\% & 41cm; 20cm; 0.2\%\\
standing & 29cm; 27cm; 13.2\% & 34cm; 27cm; 12.8\% & 36cm; 33cm; 12.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCCZ1DB & 3.5 | 2.0 | Klein \\
    B & GCL4IM5 & 3.0 | 3.5 | Klein \\ 
    C & GCGPGZI & 5.0 | 2.5 | Klein \\ 
    D & GCUIZXB & 4.5 | 1.5 | Mikro \\ 
    E & GCYHBYM & 4.0 | 1.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 528 n. Chr. f{\"u}r den neuen Lehnsherren
...
\item Welche \textit{monatlicher} Umsatz ergibt sich dadurch im
  Durchschnitt f{\"u}r jeden aktiven Partner? \textbf{(1 Punkt)}  
\end{enumerate}
...
Sie haben den Vektor $A = \{3, -16, 11\}$ und den Vektor $B = \{14, -6, 5\}$ gegeben.
