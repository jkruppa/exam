...
\begin{graybox}{Ergebnis der Klausur}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 35 Punkten sind aus dem Rechen- und
    Textteil erreicht. 
  \item[] \rule[0ex]{3em}{.4pt}\, von 55 Punkten in Summe.
...
\end{center}
\begin{itemize}
\item Es sind \rule[0ex]{2em}{.4pt}\, von 35 Punkten erreicht worden.
\end{itemize}
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.42, 0.02, 0.21 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.084, 0.004, 0.042 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1, 0.1, 1 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1, 0.1, 1 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.084, 0.004, 0.042 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 2.1, 0.1, 1.05 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 5, 2, 3 und 3.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 2.8 +/- 1.35
\item [\textbf{B} \msquare] Es ergibt sich 3.8 +/- 2.7
\item [\textbf{C} \msquare] Es ergibt sich 3.8 +/- 1.64
\item [\textbf{D} \msquare] Es ergibt sich 3.8 +/- 0.82
\item [\textbf{E} \msquare] Es ergibt sich 4.8 +/- 0.82
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 29, 5, 23, 36, 25, 13, 43, 16, 21, 15 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 [16, 37]
\item [\textbf{B} \msquare] Es ergibt sich 26 +/- 15
\item [\textbf{C} \msquare] Es ergibt sich 23 +/- 36
\item [\textbf{D} \msquare] Es ergibt sich 23 [15, 36]
...
$y = \{17, 15, 9, 18, 18, 14, 15, 16, 19, 16, 15\}$. Berechnen Sie folgende
...
\begin{center}
$12.4, 12.5, 10.2, 9.6, 8.3, 7.2, 12.3, 11.2, 9.3, 11.3, 9.3, 8.3, 12, 10.6$
\end{center}
...
## t = 3.0528, df = 10, p-value = 0.01219
...
## 
## data:  waterintake by infusion
## t = -2.785, df = 6, p-value = 0.03178
## alternative hypothesis: true mean difference is not equal to 0
## 95 percent confidence interval:
##  -13.6868738  -0.8845548
## sample estimates:
## mean difference 
##       -7.285714
\end{verbatim}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 1.28 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 51.94 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  14.00  7.0000  1.4651  0.251
## Residuals 24 114.67  4.7778
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 129 135 120  94 114 105 129 132 135 147 164 155
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 116.46 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 203.65 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 235.01 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 262.23 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 457.29 228.643  8.9319 0.002021
## form       1  64.99  64.987  2.5387 0.128493
## dose:form  2 118.45  59.227  2.3137 0.127570
## Residuals 18 460.77  25.598
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -2.4000 -2.1429 -0.2714  0.9143  4.8571 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  17.1429     0.8788   19.51 2.74e-09
## trtB         -1.7429     1.3614   -1.28    0.229
## 
## Residual standard error: 2.325 on 10 degrees of freedom
## Multiple R-squared:  0.1408,	Adjusted R-squared:  0.05489 
## F-statistic: 1.639 on 1 and 10 DF,  p-value: 0.2294
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -5.0716, df = 8, p-value = 0.0009632
...
Einflussvariablen ($x$) wurden erhoben: center, rainfall und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.69 & 0 & 9.69 & 99.96 & 67.03 & 14\\
6.90 & 0 & 9.18 & 105.36 & 72.77 & 12\\
9.76 & 0 & 8.43 & 98.06 & 71.26 & 10\\
10.72 & 0 & 10.12 & 101.59 & 69.62 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.0115 -1.7772  0.2155  1.5550  5.4738 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -12.14721    9.30051  -1.306   0.1947
## P            -0.33698    0.15626  -2.157   0.0336
## Fe            0.85160    0.09041   9.419 2.88e-15
## nematodes     0.02924    0.08201   0.357   0.7222
## 
## Residual standard error: 2.485 on 95 degrees of freedom
## Multiple R-squared:  0.5049,	Adjusted R-squared:  0.4892 
## F-statistic: 32.29 on 3 and 95 DF,  p-value: 1.775e-14
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & temp & maxdepth & no3\\
\midrule
SOUTH\_BR\_PATAPSCO & 26 & 1450 & 18.6 & 60 & 2.96\\
LITTLE\_DEER\_CR & 38 & 8115 & 20.5 & 110 & 3.40\\
PRETTYBOY\_BR & 19 & 904 & 19.2 & 39 & 6.81\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -7.846  -4.335  -1.531   1.699  16.455  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.531e+00  8.134e-01   1.882  0.06574
## acerage     3.586e-05  1.276e-05   2.810  0.00711
## temp        3.931e-02  3.653e-02   1.076  0.28723
## maxdepth    5.094e-03  4.505e-03   1.131  0.26362
## no3         2.026e-01  6.054e-02   3.346  0.00158
## 
## (Dispersion parameter for quasipoisson family taken to be 28.82741)
## 
##     Null deviance: 1904.7  on 53  degrees of freedom
## Residual deviance: 1222.2  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.78      3.29  0.00100
## 2 water           0.177    -3.24  0.00118
## 3 light           0.507     0.200 0.842
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3398 -0.5893 -0.1636  0.6081  3.3633 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  218.7   14.79   
##  subject  (Intercept) 4035.3   63.52   
##  Residual              694.2   26.35   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.503     26.839   7.545
## attitudepop  -19.447      5.789  -3.359
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.8061227 0.1295594 0.0000171
## high 0.8061227 1.0000000 0.0807472 0.0000083
## low  0.1295594 0.0807472 1.0000000 0.0014076
## mid  0.0000171 0.0000083 0.0014076 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 16, 13, 11, 19 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 4, 18, 6, 4 und 8! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, P und leaf an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCJUJCN & 4.5 | 4.5 | Mikro \\
    B & GCCR3PL & 2.0 | 1.0 | Klein \\ 
    C & GCN5JKR & 3.0 | 2.0 | Mikro \\ 
    D & GCPHFLB & 4.0 | 1.5 | Normal \\ 
    E & GCTBLEA & 5.0 | 2.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 400 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{-1, -4, 18\}$ und den Vektor $B = \{2, 4, 2\}$ gegeben.
