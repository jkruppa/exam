...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 94.58 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 48.29 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 79.504  39.752  21.278 1.116e-05
## Residuals 20 37.365   1.868
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 0.81 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 422.61 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 85.24 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 302.92 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 62 H{"a}ngebauchschweinen durchgef{\"u}hrt, wobei
...
## Response: weight
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2  17.837   8.919  0.9425 0.408062
## form       1 105.642 105.642 11.1640 0.003635
## dose:form  2 171.134  85.567  9.0425 0.001912
## Residuals 18 170.330   9.463
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0019621 0.0032074 0.0596144
## high 0.0019621 1.0000000 0.0000002 0.1654218
## low  0.0032074 0.0000002 1.0000000 0.0000132
## mid  0.0596144 0.1654218 0.0000132 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -2.4000 -1.5357  0.2143  1.6000  3.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  20.2857     0.7804   26.00 1.63e-10
## waterB        5.1143     1.2089    4.23  0.00174
## 
## Residual standard error: 2.065 on 10 degrees of freedom
## Multiple R-squared:  0.6415,	Adjusted R-squared:  0.6057 
## F-statistic:  17.9 on 1 and 10 DF,  p-value: 0.001743
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: height, region und variety. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
wing/leg stretching & 38cm; 21cm; 25.4\% & 34cm; 23cm; 25.4\% & 32cm; 24cm; 50.1\%\\
walking & 33cm; 22cm; 2.1\% & 41cm; 33cm; 1.8\% & 45cm; 21cm; 4.1\%\\
foraging incl. scratching & 40cm; 20cm; 0.8\% & 38cm; 20cm; 0.6\% & 38cm; 32cm; 0.2\%\\
sitting & 36cm; 31cm; 5.1\% & 33cm; 16cm; 1.2\% & 40cm; 27cm; 1.2\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCPL1NX & 3.0 | 4.0 | Mikro \\
    B & GCYFTXT & 1.5 | 3.5 | Normal \\ 
    C & GCLZO3Z & 1.0 | 3.0 | Normal \\ 
    D & GC9AWQ4 & 2.5 | 2.5 | Normal \\ 
    E & GCHTSQD & 4.0 | 4.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 291 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{1.4\times 10^{9}} \cdot 2.3^{-0.1 \cdot t + 4.1}
\end{equation*}
...
Sie haben den Vektor $A = \{8, 23, 9\}$ und den Vektor $B = \{-3, 5, 6\}$ gegeben.
