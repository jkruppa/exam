...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.03, 0.001, 0.21 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.15, 0.005, 1.05 und 2.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.15, 0.005, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.006, 0.0002, 0.042 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.15, 0.005, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.006, 0.0002, 0.042 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 14, 8, 13 und 9.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.2 +/- 3.11
\item [\textbf{B} \msquare] Es ergibt sich 9.2 +/- 4.85
\item [\textbf{C} \msquare] Es ergibt sich 10.2 +/- 1.555
\item [\textbf{D} \msquare] Es ergibt sich 10.2 +/- 9.7
\item [\textbf{E} \msquare] Es ergibt sich 11.2 +/- 1.555
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 18, 17, 15, 11, 24, 21 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 +/- 15
\item [\textbf{B} \msquare] Es ergibt sich 21 [15, 24]
\item [\textbf{C} \msquare] Es ergibt sich 18 +/- 15
\item [\textbf{D} \msquare] Es ergibt sich 18 [15, 24]
\item [\textbf{E} \msquare] Es ergibt sich 18 +/- 24
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Der Begriff \textit{ordinary mean} beschreibt einen einzelnen Mittelwert eines Levels eines Faktors wohingegen der \textit{marginal mean} die unbedeutenden Mittelwerte beschreibt.
\item [\textbf{B} \msquare] Der Begriff \textit{ordinary mean} beschreibt gew{"o}hnliche Mittelwerte und wohingegen \textit{marginal mean} kleine Mittelwerte beschreibt.
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3 liegt keine Overdispersion vor.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3 liegt Overdispersion vor. Damit kann keine Possion-Regression gerechnet werden. Die L{"o}sung ist eine Gaussian Regression mit Nullanpassung.
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt drei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung von nur zwei der drei Verteilungsparameter: $\gamma_1$ und $\gamma_3$.
...
\item [\textbf{D} \msquare] Es handelt sich um eine Poisson-Verteilung mit Pois(15).
\item [\textbf{E} \msquare] Es handelt sich um eine Normalverteilung mit N(15, 5).
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Y beinhaltet die Zeilen. Die Zeilen geben die Verteilungsfamilie vor.
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.57, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.36, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.36, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.57, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 1.75, da es sich um ein Anteil handelt.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.21
\item [\textbf{B} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 0.04
...
\item [\textbf{D} \msquare] In einer possion Regression kann kein Effekt roh interpretiert werden. Es muss erst eine Confounderadjustierung durchgef{"u}hrt werden.
\item [\textbf{E} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 0.04
\end{enumerate}
...
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 68
...
Sie haben folgende Zahlenreihe $y$ vorliegen
$y = \{20, 15, 16, 18, 15, 17, 11, 16, 17, 18, 15\}$. Berechnen Sie folgende
...
## t = -1.19925, df = 16, p-value = 0.24789
...
## t = 1.0008, df = 12, p-value = 0.33668
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -1.3601655  3.6712766
## sample estimates:
...
## 
## data:  freshmatter by N
## t = 1.00702, df = 8, p-value = 0.34341
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -1.5479211  3.9479211
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 4.52 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 11.21 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  4.09551 2.047753 4.61662 0.018857 *
## Residuals 27 11.97614 0.443561                   
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 207.82 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2426.56 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 107.35 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 712.44 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df  Sum Sq  Mean Sq   F value                 Pr(>F)    
## supp       1  353.80  353.800  28.64232           0.0000010749 ***
## dose       2 3514.68 1757.339 142.26744 < 0.000000000000000222 ***
## supp:dose  2  234.94  117.468   9.50977             0.00022507 ***
## Residuals 69  852.31   12.352                                     
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
Experiment mit $n = 162$ Sauen. In dem Experiment wurde gemessen,
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   89  \strut\\
    \hline
...
Einflussvariablen ($x$) wurden erhoben: weight, block und N. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
In einem Stallexperiment mit $n = 98$ Ferkeln wurde der
...
\midrule
BEAR\_BR & 12 & 83 & 7.74 & 3333 & 5.34\\
DEEP\_RUN & 5 & 57 & 21.68 & 1175 & 1.30\\
FISHING\_CR & 11 & 109 & 7.10 & 5046 & 0.73\\
BUSH\_CR & 32 & 120 & 11.31 & 19046 & 2.93\\
\bottomrule
\end{tabular}
\end{table}
...
## -7.98020  -3.21115  -0.91362   1.46284   9.07938  
## 
## Coefficients:
##                 Estimate   Std. Error t value     Pr(>|t|)    
## (Intercept)  2.444694094  0.413447625  5.9129 0.0000003186 ***
## maxdepth    -0.001048991  0.004213857 -0.2489     0.804449    
## so4          0.011800802  0.015636105  0.7547     0.454032    
## acerage      0.000054005  0.000015382  3.5110     0.000969 ***
## no3          0.152199500  0.058387300  2.6067     0.012078 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 17.901742)
## 
##     Null deviance: 1120.85  on 53  degrees of freedom
## Residual deviance:  844.77  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.62       1.89  0.0591
## 2 nematodes       0.155      1.56  0.119 
## 3 water           0.163     -2.22  0.0264
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
10.59 & 0 & 6.06 & 99.75 & 71.63 & 8\\
10.20 & 0 & 12.68 & 91.19 & 61.23 & 13\\
11.17 & 1 & 10.06 & 100.80 & 70.81 & 11\\
10.46 & 0 & 10.80 & 100.43 & 67.03 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -5.23856 -1.09261 -0.15071  1.64210  5.80431 
## 
## Coefficients:
##              Estimate Std. Error t value              Pr(>|t|)    
## (Intercept) -0.458059   6.920301 -0.0662              0.947357    
## water       -0.083825   0.174029 -0.4817              0.631079    
## P           -0.490994   0.161177 -3.0463              0.002956 ** 
## Fe           0.759718   0.061754 12.3024 < 0.00000000000000022 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.2422 on 101 degrees of freedom
## Multiple R-squared:  0.62621,	Adjusted R-squared:  0.61511 
## F-statistic: 56.401 on 3 and 101 DF,  p-value: < 0.000000000000000222
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -3.7778 -1.0944 -0.2000  1.2222  5.2222 
## 
## Coefficients:
##             Estimate Std. Error t value        Pr(>|t|)    
## (Intercept) 17.77778    0.87324 20.3584 0.0000000001133 ***
## trtB        -1.57778    1.46121 -1.0798          0.3015    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.6197 on 12 degrees of freedom
## Multiple R-squared:  0.088555,	Adjusted R-squared:  0.012601 
## F-statistic: 1.1659 on 1 and 12 DF,  p-value: 0.30147
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 795.5
## 
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.12015 -0.60554 -0.08054  0.54083  3.31307 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  178.16  13.348  
##  subject  (Intercept) 4140.78  64.349  
##  Residual              672.74  25.937  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 202.2425    27.0481  7.4771
## attitudepop -18.8889     5.6989 -3.3145
## 
...
\midrule
A & 12.14 & 12 & 8 & 17 & 11.0 & 13.0 & 7.81\\
B & 19.14 & 18 & 16 & 24 & 17.5 & 20.5 & 7.48\\
C & 8.43 & 8 & 1 & 13 & 7.0 & 11.5 & 16.62\\
D & 13.29 & 12 & 10 & 18 & 11.5 & 15.0 & 7.90\\
\bottomrule
\end{tabular}
\end{table}
