...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 0, 14, 11, 9 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.8 +/- 27.7
\item [\textbf{B} \msquare] Es ergibt sich 8.8 +/- 2.63
\item [\textbf{C} \msquare] Es ergibt sich 8.8 +/- 5.26
\item [\textbf{D} \msquare] Es ergibt sich 9.8 +/- 2.63
\item [\textbf{E} \msquare] Es ergibt sich 7.8 +/- 13.85
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 29, 36, 19, 37, 19, 27 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 33 +/- 19
\item [\textbf{B} \msquare] Es ergibt sich 33 [20, 38]
\item [\textbf{C} \msquare] Es ergibt sich 29 +/- 19
\item [\textbf{D} \msquare] Es ergibt sich 29 +/- 37
\item [\textbf{E} \msquare] Es ergibt sich 29 [19, 37]
\end{enumerate} 
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.001, 0.89 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.004, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.004, 3.56 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 3e-04, 0.2225 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 3e-04, 0.2225 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.004, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\begin{center}
$2, 1, 4, 2, 3, 3, 4, 4, 4, 2, 6, 8, 3, 5, 5, 3, 2, 2, 11, 4, 5, 6, 1, 4, 3, 3, 1$
\end{center}
...
\begin{center}
$11.1, 14.2, 11.6, 6.8, 8.5, 10.8, 11.7, 7.8, 10.7, 8.9, 8.6, 8.8, 8.3, 6.1, 8.9, 12.5, 13.5$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ beibehalten & (Unbekannte) Wahrheit & 20\% & H$_0$ wahr \\
  \end{tabular}
  \end{center}
...
## t = -0.37919, df = 14, p-value = 0.7102
...
## 
## data:  drymatter by Fe
## t = 0.16215, df = 14, p-value = 0.8735
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -2.523019  2.935718
## sample estimates:
...
Der Datensatz \texttt{plant\_growth\_tbl} enth{\"a}lt den Ertrag pro Hektar der Maisspflanzen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 89.98 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 25.78 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 142.424  71.212  53.156 9.905e-09
## Residuals 20  26.794   1.340
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 33.86 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 239.74 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 346.56 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 375.39 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 59 H{"u}hnern durchgef{\"u}hrt, wobei
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 473.18 236.592 20.1919 2.517e-05
## form       1   1.17   1.171  0.0999 0.7555664
## dose:form  2 304.16 152.080 12.9792 0.0003237
## Residuals 18 210.91  11.717
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.1646719 0.0970245 0.0165918
## high 0.1646719 1.0000000 0.0037006 0.2768738
## low  0.0970245 0.0037006 1.0000000 0.0001787
## mid  0.0165918 0.2768738 0.0001787 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.8571 -1.0000  0.0714  1.0000  6.1429 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.000      1.085   14.75 4.71e-09
## waterB        -4.143      1.534   -2.70   0.0193
## 
## Residual standard error: 2.87 on 12 degrees of freedom
## Multiple R-squared:  0.378,	Adjusted R-squared:  0.3261 
## F-statistic: 7.292 on 1 and 12 DF,  p-value: 0.0193
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.378$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: region, weight und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
foraging incl. scratching & 36cm; 27cm; 50.1\% & 35cm; 25cm; 25.4\% & 33cm; 21cm; 64.1\%\\
wing/leg stretching & 37cm; 35cm; 0.6\% & 39cm; 20cm; 0.4\% & 42cm; 11cm; 0.2\%\\
sitting & 29cm; 32cm; 6.2\% & 31cm; 23cm; 6.1\% & 34cm; 27cm; 6.9\%\\
wingflapping & 41cm; 26cm; 7.3\% & 32cm; 25cm; 1\% & 41cm; 22cm; 0.8\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCNXTBL & 4.0 | 4.0 | Mikro \\
    B & GCOHG4O & 5.0 | 3.5 | Normal \\ 
    C & GC3O4GD & 1.5 | 5.0 | Mikro \\ 
    D & GCAYWTA & 2.5 | 3.0 | Mikro \\ 
    E & GCY7D2C & 4.5 | 1.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 210 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{9\times 10^{8}} \cdot 1.7^{-0.15 \cdot t + 2.4}
\end{equation*}
...
\item Wie viele Partner m{\"u}ssen auf der 2 Stufe anwerben um Ihr passives
  Einkommen durch indirekte Provision zu erreichen? Stellen Sie den
...
Sie haben den Vektor $A = \{16, 20, -4\}$ und den Vektor $B = \{-3, 3, 4\}$ gegeben.
