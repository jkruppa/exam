...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.001, 0.34 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 3e-04, 0.085 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.004, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 3e-04, 0.085 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.004, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 0.004, 1.36 und 1.68. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 2, 12, 16, 8 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.8 +/- 13.6
\item [\textbf{B} \msquare] Es ergibt sich 9.8 +/- 5.22
\item [\textbf{C} \msquare] Es ergibt sich 9.8 +/- 27.2
\item [\textbf{D} \msquare] Es ergibt sich 9.8 +/- 2.61
\item [\textbf{E} \msquare] Es ergibt sich 10.8 +/- 2.61
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 32, 19, 30, 19, 26, 32 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 32 +/- 19
\item [\textbf{B} \msquare] Es ergibt sich 30 +/- 19
\item [\textbf{C} \msquare] Es ergibt sich 30 [19, 32]
\item [\textbf{D} \msquare] Es ergibt sich 30 +/- 32
\item [\textbf{E} \msquare] Es ergibt sich 32 [19, 32]
\end{enumerate}
...
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.97 liegt keine Overdispersion vor.
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.97 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.68 ist
richtig?
...
In einem Stallexperiment mit $n = 102$ Ferkeln wurden verschiedene
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 382.83
\item [\textbf{B} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 382.83
\item [\textbf{C} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -19.57
\item [\textbf{D} \msquare] Eine logistischen Regression basiert auf dem maximum Likelihood Prinzip. Hierbei kann kein Effekt beschrieben werden. Im Zweifel hilft aber eine Quadrierung der Fehlerqudrate $\epsilon$.
...
$y = \{19, 20, 20, 21, 23, 19, 17\}$. Berechnen Sie folgende
...
\begin{center}
$10.1, 9.5, 8.7, 11.6, 8.9, 11.3, 11.2, 8.6, 7.7, 12, 11.1, 8.2, 12.2, 11.4$
\end{center}
...
## t = 0.88649, df = 14, p-value = 0.3903
...
## 
## data:  waterintake by infusion
## t = -0.17695, df = 10, p-value = 0.8631
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.048506  4.305649
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 43.66 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 69.3 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 141.60  70.800  27.619 1.762e-06
## Residuals 20  51.27   2.563
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 103 129 122  92 110 102 140 134 149 151 158 130
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 35.07 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 25.77 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 335.37 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 504.08 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2  80.356  40.178  2.5277 0.107769
## form       1 238.152 238.152 14.9828 0.001120
## dose:form  2 256.909 128.454  8.0814 0.003129
## Residuals 18 286.110  15.895
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -2.2000 -0.5556 -0.2000  0.4444  3.4444 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  17.5556     0.5360  32.756 4.15e-13
## trtB          0.6444     0.8968   0.719    0.486
## 
## Residual standard error: 1.608 on 12 degrees of freedom
## Multiple R-squared:  0.04126,	Adjusted R-squared:  -0.03864 
## F-statistic: 0.5164 on 1 and 12 DF,  p-value: 0.4861
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -14.75, df = 8, p-value = 4.389e-07
...
Einflussvariablen ($x$) wurden erhoben: dry, region und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.13 & 1 & 10.36 & 99.73 & 69.77 & 10\\
10.58 & 0 & 12.47 & 95.68 & 68.16 & 12\\
9.99 & 0 & 9.18 & 99.80 & 65.40 & 18\\
8.86 & 1 & 11.72 & 97.17 & 68.94 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.3562 -1.9526  0.1862  1.5652  5.8024 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  14.3469    11.2735   1.273   0.2078
## water        -0.4820     0.2595  -1.858   0.0679
## nematodes    -0.1335     0.1133  -1.178   0.2432
## Fe            0.6089     0.1026   5.936 1.37e-07
## 
## Residual standard error: 2.741 on 63 degrees of freedom
## Multiple R-squared:  0.4544,	Adjusted R-squared:  0.4285 
## F-statistic: 17.49 on 3 and 63 DF,  p-value: 2.258e-08
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & do2 & no3 & acerage\\
\midrule
DORSEY\_RUN & 8 & 22.6 & 6.8 & 0.44 & 7814\\
LITTLE\_GUNPOWDER\_R & 3 & 17.5 & 9.7 & 2.60 & 15305\\
CABIN\_JOHN\_CR & 21 & 15.0 & 8.2 & 1.57 & 8612\\
PRETTYBOY\_BR & 19 & 19.2 & 9.8 & 6.81 & 904\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.560  -3.517  -1.631   1.540  18.195  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -9.315e-01  1.514e+00  -0.615   0.5413
## temp         9.268e-02  3.899e-02   2.377   0.0214
## do2          2.226e-01  1.206e-01   1.846   0.0709
## no3          1.055e-01  6.555e-02   1.610   0.1139
## acerage      4.876e-05  1.106e-05   4.409 5.66e-05
## 
## (Dispersion parameter for quasipoisson family taken to be 27.38544)
## 
##     Null deviance: 1928.6  on 53  degrees of freedom
## Residual deviance: 1099.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.403    -0.818 0.414  
## 2 light           0.496     2.85  0.00442
## 3 nematodes       0.180    -0.863 0.388
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3312 -0.5798 -0.1816  0.5685  3.2314 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  234.2   15.30   
##  subject  (Intercept) 3976.9   63.06   
##  Residual              603.1   24.56   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.285     26.658   7.588
## attitudepop  -20.939      5.396  -3.880
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0005721 0.0000002
## high 0.0000000 1.0000000 0.0001072 0.1091628
## low  0.0005721 0.0001072 1.0000000 0.0092793
## mid  0.0000002 0.1091628 0.0092793 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 11, 14, 2, 6 und 10!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 11, 13, 12 und 8! \textbf{(2 Punkte)}
...
Sie wollen 60 Sonnenblumen pflanzen und auswerten. Die T{\"o}pfe
haben einen Radius von 4.5cm und eine H{\"o}he von 8cm. Der
