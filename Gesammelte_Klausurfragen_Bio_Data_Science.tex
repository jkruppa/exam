...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.34, 0.42 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 1, 1 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.085, 0.105 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 1, 1 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.085, 0.105 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 1.36, 1.68 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 8, 6, 10 und 14.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 7.8 +/- 5.6
\item [\textbf{B} \msquare] Es ergibt sich 9.8 +/- 1.675
\item [\textbf{C} \msquare] Es ergibt sich 8.8 +/- 3.35
\item [\textbf{D} \msquare] Es ergibt sich 8.8 +/- 1.675
\item [\textbf{E} \msquare] Es ergibt sich 8.8 +/- 11.2
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 3, 21, 25, 28, 14, 23, 19, 26, 21, 29 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 19
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 19
\item [\textbf{C} \msquare] Es ergibt sich 23 +/- 28
\item [\textbf{D} \msquare] Es ergibt sich 23 [19, 28]
\item [\textbf{E} \msquare] Es ergibt sich 24 [20, 29]
\end{enumerate} 
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.62, da es sich um ein Anteil handelt.
...
$y = \{18, 18, 17, 15, 21, 19, 22, 22, 21, 22, 18\}$. Berechnen Sie folgende
...
\begin{center}
$8.2, 11.2, 7.2, 9.2, 12.1, 10.4, 9.3, 5.4, 10.9, 7.7, 7.1, 6.8, 10.1, 9.5$
\end{center}
...
## t = -4.1135, df = 14, p-value = 0.001054
...
## t = -0.72207, df = 10, p-value = 0.4868
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.369853  2.741282
## sample estimates:
...
## trt        2 17.016  8.5079  2.4962 0.1054
## Residuals 22 74.984  3.4084
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 120 129 104 101  90  88 130 145 125 157 147 148
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 185.36 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 149.91 &  &  &  \strut\\
    \hline
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 355.10 177.551  8.5705 0.002427
## form       1   0.08   0.078  0.0038 0.951776
## dose:form  2  82.18  41.090  1.9835 0.166544
## Residuals 18 372.90  20.716
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 104$ Pflanzen untersucht.
\vspace{5Ex}
...
##  -6.00  -2.60   0.10   2.75   4.20 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   15.000      1.109  13.527 1.26e-08
## waterB         9.800      1.856   5.282 0.000194
## 
## Residual standard error: 3.327 on 12 degrees of freedom
## Multiple R-squared:  0.6992,	Adjusted R-squared:  0.6741 
## F-statistic: 27.89 on 1 and 12 DF,  p-value: 0.0001941
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.6992$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: dry, N und variety. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.12 & 0 & 10.80 & 94.52 & 65.36 & 10\\
10.36 & 0 & 10.76 & 98.45 & 67.26 & 8\\
9.22 & 0 & 11.33 & 95.45 & 64.27 & 9\\
8.94 & 1 & 8.76 & 102.67 & 74.99 & 13\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.6508 -1.6975  0.2243  1.9236  7.0522 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  6.76098    7.90104   0.856    0.394
## P           -0.14349    0.22547  -0.636    0.526
## Fe           0.64449    0.07421   8.684 1.44e-13
## light        0.75506    0.55125   1.370    0.174
## 
## Residual standard error: 2.536 on 91 degrees of freedom
## Multiple R-squared:  0.4643,	Adjusted R-squared:  0.4467 
## F-statistic: 26.29 on 3 and 91 DF,  p-value: 2.446e-12
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & so4 & do2 & no3 & maxdepth\\
\midrule
LITTLE\_HUNTING\_CR & 18 & 7.41 & 9.5 & 0.51 & 58\\
OWENS\_CR & 80 & 9.07 & 8.6 & 1.02 & 79\\
CONOWINGO\_CR & 112 & 14.94 & 8.5 & 6.95 & 65\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.398  -4.603  -2.111   1.846  15.509  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.701238   1.391252   1.223  0.22725
## so4         -0.004505   0.024276  -0.186  0.85356
## do2          0.059483   0.138632   0.429  0.66975
## no3          0.222019   0.074305   2.988  0.00438
## maxdepth     0.010402   0.004342   2.396  0.02046
## 
## (Dispersion parameter for quasipoisson family taken to be 39.78244)
## 
##     Null deviance: 2183.8  on 53  degrees of freedom
## Residual deviance: 1624.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.411    -2.04   0.0410
## 2 light           0.463     0.757  0.449 
## 3 nematodes       0.151     1.40   0.162
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9985 -0.5644 -0.0575  0.4811  3.4645 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  215.1   14.67   
##  subject  (Intercept) 3947.4   62.83   
##  Residual              709.0   26.63   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   203.29      26.56   7.654
## attitudepop   -20.64       5.85  -3.528
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0290849 0.0524424 0.0000998
## high 0.0290849 1.0000000 0.0001500 0.0000001
## low  0.0524424 0.0001500 1.0000000 0.0210084
## mid  0.0000998 0.0000001 0.0210084 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 6, 6, 10, 10 und 16!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 5, 1, 4, 10 und 13! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes leaf, freshmatter und grade an vier verschiedenen Messterminen.
...
\midrule
preening & 35cm; 24cm; 7.2\% & 30cm; 23cm; 8.9\% & 29cm; 15cm; 10.1\%\\
walking & 34cm; 30cm; 1.8\% & 39cm; 25cm; 4.1\% & 31cm; 16cm; 1.8\%\\
standing & 37cm; 29cm; 1.6\% & 43cm; 30cm; 8.1\% & 36cm; 31cm; 8.1\%\\
dustbathing & 28cm; 28cm; 4.1\% & 37cm; 30cm; 5.2\% & 30cm; 32cm; 6.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCIWSVW & 2.5 | 3.0 | Normal \\
    B & GCEMQNP & 1.5 | 5.0 | Normal \\ 
    C & GCRMXBH & 3.5 | 2.0 | Normal \\ 
    D & GCN9O7C & 3.0 | 4.5 | Mikro \\ 
    E & GCHKQIL & 4.0 | 3.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 916 n. Chr. f{\"u}r den neuen Lehnsherren
...
1875 ungef{\"a}hr 24 Kaninchen entlassen hat,
...
Direkt Finanzanlagen Left/Right (D-FL/R). Das Unternehmen steigerte den Umsatz um rund
...
\item Wie viel von dem Umsatz im Jahr 2021 der Firma D-FL/R
  wird im Schnitt von jedem aktiven Partner erwirtschaftet? \textbf{(1
    Punkt)}
...
Sie haben den Vektor $A = \{9, 10, 2\}$ und den Vektor $B = \{3, 6, 7\}$ gegeben.
