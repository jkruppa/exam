...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\blacksquare\!\square\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\square\!\square\!\blacksquare\!\square\!\blacksquare\!\square\!\blacksquare\!\square\!\blacksquare$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\begin{graybox}{Endnote}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 56 Punkten sind aus den Rechen- und
    Textaufgaben erreicht. 
  \item[] \rule[0ex]{3em}{.4pt}\, von 76 Punkten in Summe.
...
\end{center}
\begin{itemize}
\item Es sind \rule[0ex]{2em}{.4pt}\, von 56 Punkten erreicht worden.
\end{itemize}
\end{graybox}
...
Ein Versuch wurde an 55 Tieren durchgeführt, wobei jedes Tier eine von drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Die folgende Abbildung enthält die Daten aus diesem Versuch zur Bewertung der Wirkung von Vitamin D auf das Zahnwachstum bei Schweine.  Welche Aussage ist richtig, wenn Sie eine zweifaktorielle ANOVA rechnen?
...
Wie lautet der Mittelwert und Standardabweichung von $y$ mit 10, 9, 6, 9 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es berechnet sich 9.4 +/- 2.3
\item [\textbf{B} \msquare] Sie erhalten 8.4 +/- 1.52
\item [\textbf{C} \msquare] Es berechnet sich 8.4 +/- 2.3
\item [\textbf{D} \msquare] Sie erhalten 8.4 +/- 0.76
\item [\textbf{E} \msquare] Sie erhalten 8.4 +/- 1.23
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 18, 13, 24, 32, 22, 23, 22, 29, 30, 24 und 42.




\begin{enumerate}
\item [\textbf{A} \msquare] Es berechnet sich 25 [23; 31]
\item [\textbf{B} \msquare] Sie erhalten 24 +/- 30
\item [\textbf{C} \msquare] Es berechnet sich 25 [23; 29]
\item [\textbf{D} \msquare] Es ergibt sich 25 +/- 22
\item [\textbf{E} \msquare] Sie erhalten 24 [22; 30]
\end{enumerate} 
...
\item [\textbf{C} \msquare] Als erstes berechnen wir den Mittelwert. Dann bilden wir die Summe der quadratischen Abstände zu dem Mittelwert. Abschließend teilen wir durch die Fallzahl. Nicht zu vergessen, am Ende dann noch die Wurzel zu ziehen.
...
In dem folgenden Histogramm von $n = 187$ Pflanzen ist welche Verteilung abgebildet?
...
Nach einer simplen linearen Regression zur Untersuchung vom Einfluss der $PO_2$-Konzentration in [$\mu g$] im Wasser auf den absoluten Proteingehalt von Erbsen in [$kg$] erhalten Sie einen $\beta_{PO_2}$ Koeffizienten von $1.1\times 10^{-5}$ und einen hoch signifikanten $p$-Wert mit $2e-04$. Warum sehen Sie so einen kleinen Effekt bei einer so deutlichen Signifikanz?
...
Sie führen ein Experiment zur Behandlung von Klaueninfektionen bei Schweinen durch. Bei 3 Tieren finden Sie eine Erkrankung der Klauen vor und 8 Tiere sind gesund. Welche Aussage über den Effektschätzer Odds ratio ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.27, da es sich um ein Anteil handelt. Wir berechnen den Anteil der Kranken.
...
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.27, da es sich um eine Chancenverhältnis handelt.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.001, 0.21, 0.03 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 2e-04, 0.042, 0.006 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.005, 1.05, 0.15 und 4.45. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.005, 1, 0.15 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 0.005, 1, 0.15 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 2e-04, 0.042, 0.006 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate}
...
Ein Versuch wurde in 12 Parzellen pro Gruppe durchgeführt. Die folgende Abbildung enthält die Daten aus diesem Versuch zur Bewertung der Wirkung des Mikronährstoff Sulfit auf den Ertrag in t/ha von Weizen im Vergleich zu einer Kontrolle.  Welche Aussage ist richtig, wenn Sie einen t-Test rechnen?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Nach Betrachtung des Barplots liegt ein signifikanter Unterschied vor. Der Effekt liegt bei -5.
...
\item [\textbf{C} \msquare] Die Barplots deuten auf keinen signifikanten Unterschied. Der Effekt liegt vermutlich bei -5. Wir müssen aber einen Posthoc-Test rechnen um den Effekt wirklich bestimmen zu können.
\item [\textbf{D} \msquare] Die Barplots deuten auf kein signifikanten Unterschied. Der Effekt liegt vermutlich bei -5.
\item [\textbf{E} \msquare] Die Barplots deuten auf einen signifikanten Unterschied. Der Effekt liegt vermutlich bei -5 unter einer groben Abschätzung. Wir müssen aber eine ANOVA rechnen um den Effekt wirklich bestimmen zu können.
\end{enumerate}
...
Barplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Mark nicht gemerkt, welche statistischen Maßzahlen für einen Barplot erhoben werden müssen. Das ist in soweit doof, da nach seiner Betreuer erstmal ein Barplot nachgebaut werden soll, bevor es mit seinem Projektbericht losgeht. Dann hat er schonmal den \Rlogo Code vorliegen und nachher geht dann alles schneller. Die Behandlung für Maiss werden verschiedene Lichtstufen ($none$, $200lm$ und $600lm$) sein. Erfasst wird als Endpunkt ($Y$) \textit{Trockengewicht}. Mark soll dann \textit{drymatter} in seiner Exceldatei eintragen.
...
Paula steht vor einem ersten Problem, denn wenn es nach ihrem Betreuer geht, soll sie in einem einem Gewächshausexperiment Brokoli auswertet. Soweit eigentlich alles passend. Die Behandlung waren verschiedene Lichtstufen ($none$, $200lm$ und $600lm$). In ihrer Exceldatei hat sie den Endpunkt ($Y$) \textit{Ertrag} als \textit{yield} aufgenommen. Nun soll Paula die Daten eimal als Barplots in einer Präsentation visualisieren, damit ihrem Betreuer wieder klar wird, was sie eigentlich nochmal gemacht hat und was für ein Ergbnis in einem statistischen Test zu erwarten wäre.
...
Boxplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Jessica nicht gemerkt, welche statistischen Maßzahlen für einen Boxplot erhoben werden müssen. Das ist in soweit doof, da nach ihrem Betreuer erstmal ein Boxplot nachgebaut werden soll, bevor es mit ihrer Abschlussarbeit losgeht. Anhand von Boxplots lässt sich eine Aussage über die Normalverteilung von $Y$ treffen. Dann hat sie schonmal den \Rlogo Code vorliegen und nachher geht dann alles schneller. Die Behandlung für Erdbeeren werden verschiedene Lichtstufen ($none$, $200lm$ und $600lm$) sein. Erfasst wird als Outcome ($Y$) \textit{Ertrag}. Jessica soll dann \textit{yield} in ihrer Exceldatei eintragen.
...
Boxplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Mark nicht gemerkt, welche statistischen Maßzahlen für einen Boxplot erhoben werden müssen. Das ist in soweit doof, da nach seinem Betreuer nun Boxplots aus seinen Daten gebaut werden sollen, bevor es mit dem statistischen Testen weitergeht. Anhand von Boxplots lässt sich eine Aussage über die Varianzhomogenität über die Behandlungsgruppen treffen. Die Behandlung für Erbsen waren verschiedene Substrattypen ($torf$ und $70p30n$). Erfasst wurde von Mark als Outcome ($Y$) \textit{Ertrag}. Mark hat dann \textit{yield} in seiner Exceldatei eintragen.
...
Mark betrachtet die folgenden Daten nach einem Stallexperiment mit Fleischrinder. In dem Experiment wurden die Anzahl an gedrehten Haaren pro $cm^2$ gezählt. Nach der Meinung seiner Betreuerin muss als erstes geschaut werden, wie diese verteilt sind. Also welcher statistischen Verteilung die Anzahl an gedrehten Haaren pro $cm^2$ folgen. Dazu soll Mark ein Histogramm verwenden. Dann hätte man auch einen guten Überblick über den Endpunkt ($Y$).

\begin{center}
Die Anzahl an gedrehten Haaren pro $cm^2$: 1, 1, 4, 5, 2, 8, 3, 1, 3, 3, 8, 4, 3, 5, 6, 2, 0, 3, 3, 6, 5, 4, 6, 6, 5, 6, 6, 3, 3, 4, 4, 4, 4
\end{center}
...
In seiner Hausarbeit möchte Manuel gerne die Daten aus einem Kreuzungsexperiment mit Hühner in einem Histogramm darstellen. Das Histogramm erlaubt ihm dabei Rückschlüsse auf die Verteilung über den Endpunkt ($Y$) zu treffen. In seinem Experiment hat Manuel die mittleren dunklen Pigmentstörungen gezählt.

\begin{center}
Die mittleren dunklen Pigmentstörungen: 9.3, 11.9, 9.4, 10.1, 12.3, 10.4, 9.4, 7.5, 11.4, 10.2, 8.6, 9.5, 11.5, 9, 6.8, 9.1, 9.3, 9.2, 13.5, 7.4, 8.5, 10.7, 7.8, 9.2, 8, 12.7, 10.2, 7.4
\end{center}
...
Sabine möchte gerne den Zusammenhang zwischen durchschnittlicher Tagestemperatur [C/d] und Fettgehalt [\%/kg] im Kontext von Hühner herausfinden. Hierfür hat Sabine ein Kreuzungsexperiment im Emsland durchgeführt. Nach einigen unvorgesehenen Ereignissen hat sie es geschafft folgende Datentabelle zu erstellen. Nun stellt sich die Frage für sie, ob es überhaupt einen Zusammenhang zwischen den gemessenen Variablen gibt. Deshalb möchte Sabine als erstes eine explorative Datenanalyse durchführen.
...
Zwei kategoriale Variablen darzustellen ist nicht so einfach. Mark hatte erst über einen Mittelwert nachgedacht, dann aber die Idee verworfen. In einen Leistungssteigerungsversuch im Oldenburger Land hatte er sich zum einen die Behandlung Klimakontrolle [ja/nein] und zum anderen die Messung Fettgehalt erreicht [ja/nein] im Kontext von Fleischrinder angeschaut. Jetzt möchte sein Betreuer erstmal die langen Tabellen mit ja/nein in einer explorativen Datenanalyse zusammengefasst bekommen. Sonst geht es bei seinem Projektbericht nicht weiter.
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  (Unbekannte) Wahrheit & H$_0$ abgelehnt & $\beta$-Fehler & H$_0$ wahr \\
  \end{tabular}
  \end{center}
...
Der t-Test. Jonas erschaudert. Ein mächtiges Werkzeug in den Händen desjenigen, der einen normalverteilten Endpunkt ($Y$) hat. Aber erstmal überhaupt den t-Test rechnen können. Wie sah das Experiment von Jonas überhaupt aus? Jonas hat ein Feldexperiment mit Erbsen durchgeführt um eine neue technische Versuchsanlage zu testen. Bei dem Pilotexperiment mit sehr geringer Fallzahl $(n_1 = n_2 = 3)$ wurde die Behandlung Düngestufen ($ctrl$ und $high$) an den Erbsen getestet und dabei wurde geschaut, ob der Versuch überhaupt technisch klappen könnte. Gemessen hat Jonas dann als Messwert Trockengewicht [kg/ha]. Warum der Versuch im Teuteburgerwald für seiner Hausarbeit stattfinden musste, ist ihm bis heute ein Rätsel. Egal. Gibt es jetzt einen Zusammenhang zwischen der Behandlung und Trockengewicht [kg/ha]?
...
Eric ist in der Uckermark für einen Versuch mit Brokoli. Allein diese Tatsache ist für ihn eine Erzählung wert. Für seinen Projektbericht musste er ein Freilandversuch mit Brokoli durchführen und das sollte laut seinem Betreuer an diesem Nichtort besonders gut gelingen. Ablenkung gibt es jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn seine Behandlung Lüftungssystemen und Folientunneln ($ctrl$ und $tornado$) und der Messwert Trockengewicht [kg/ha] sollen mit einem t-Test ausgewertet werden. Immerhin weiß er, dass sein Messwert einer Normalverteilung folgt. 
...
\item Formulieren Sie eine Antwort an Eric über das Ergebnis Ihrer statistischen Analyse! \textbf{(2 Punkte)}
\end{enumerate} 
\clearpage
% -----------------------------------------------------------------------
...
## t = -0.79596, df = 16, p-value = 0.4377
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -5.291480  2.402591
## sample estimates:
...
Enten, die unter einer Kontrolle und zwei verschiedenen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 5.89 &  &  &  \strut\\
    \hline
   \textbf{error}  & 20 & 58.98 &  &  &  \strut\\
        \hline
...
Faktorstufen \textit{lethal}, \textit{extreme} und
\textit{pos} vorliegen.
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 180.59 &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 & 71.97 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  5.9289 2.96444  4.3159 0.02623
## Residuals 22 15.1111 0.68687
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 6.49 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 360.93 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 226.42 &  &  &  \strut\\
    \hline
   \textbf{error}  & 40 & 487.09 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 65 H{"a}ngebauchschweinen durchgef{\"u}hrt, wobei
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  78.49  39.243   6.766  0.006437
## form       1 177.07 177.067  30.529 3.022e-05
## dose:form  2 392.97 196.487  33.877 7.910e-07
## Residuals 18 104.40   5.800
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0742321 0.0004006 0.4698843
## high 0.0742321 1.0000000 0.0000020 0.2735058
## low  0.0004006 0.0000020 1.0000000 0.0000497
## mid  0.4698843 0.2735058 0.0000497 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 116$ Sauen. In dem Experiment wurde gemessen,
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   55  \strut\\
    \hline
...
##  -5.40  -2.15   0.10   2.10   6.60 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.400      1.631  10.669 5.23e-06
## waterB        10.000      2.307   4.336  0.00249
## 
## Residual standard error: 3.647 on 8 degrees of freedom
## Multiple R-squared:  0.7015,	Adjusted R-squared:  0.6641 
## F-statistic:  18.8 on 1 and 8 DF,  p-value: 0.002493
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7015$ aus? \textbf{(2 Punkte)}
...
## t = -11.326, df = 8, p-value = 3.326e-06
...
Einflussvariablen ($x$) wurden erhoben: dosage, rainfall und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\begin{enumerate}
\item Wenn 7 Blaubeerschalen 13.93 Euro kosten,  wie viel kosten 9 Schalen? \textbf{(1 Punkt)}
...
\midrule
dustbathing & 46cm; 28cm; 4.1\% & 40cm; 32cm; 5.2\% & 42cm; 29cm; 1.8\%\\
walking & 37cm; 24cm; 0.4\% & 34cm; 20cm; 0.4\% & 36cm; 28cm; 0.9\%\\
foraging incl. scratching & 34cm; 24cm; 1.2\% & 45cm; 21cm; 0.5\% & 33cm; 36cm; 7.6\%\\
wingflapping & 37cm; 17cm; 0.8\% & 37cm; 22cm; 0.8\% & 41cm; 23cm; 0.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
Radius von $5000$m kollabiert, wird die Sonne $30$\%
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCRPYVI & 2.5 | 5.0 | Klein \\
    B & GCI9W0Y & 2.0 | 1.5 | Klein \\ 
    C & GCBLVDG & 3.5 | 4.0 | Mikro \\ 
    D & GCVDPZT & 3.0 | 2.0 | Klein \\ 
    E & GCFEQVJ & 1.5 | 3.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 558 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{1.4\times 10^{9}} \cdot 2^{-0.15 \cdot t + 3.1}
\end{equation*}
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  8-mal-gefaltete, 0.7mm, 60-cm-Karton} durch
