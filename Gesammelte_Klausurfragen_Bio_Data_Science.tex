...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.42, 0.89 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.105, 0.2225 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.105, 0.2225 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.36, 1.68, 3.56 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 17, 14, 10 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12.4 +/- 3.05
\item [\textbf{B} \msquare] Es ergibt sich 12.4 +/- 9.3
\item [\textbf{C} \msquare] Es ergibt sich 11.4 +/- 4.65
\item [\textbf{D} \msquare] Es ergibt sich 12.4 +/- 1.525
\item [\textbf{E} \msquare] Es ergibt sich 13.4 +/- 1.525
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 21, 27, 13, 16, 5, 9, 13, 25, 6, 27 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 [10, 28]
\item [\textbf{B} \msquare] Es ergibt sich 16 [9, 27]
\item [\textbf{C} \msquare] Es ergibt sich 19 +/- 9
\item [\textbf{D} \msquare] Es ergibt sich 16 +/- 9
\item [\textbf{E} \msquare] Es ergibt sich 16 +/- 27
\end{enumerate} 
...
$y = \{20, 25, 19, 17, 20, 19, 18, 22, 20, 19, 18\}$. Berechnen Sie folgende
...
\begin{center}
$11.8, 10.3, 11.9, 10, 9.1, 9.1, 10.2, 12.2, 9.1, 6.9, 9, 7, 9.7, 7.5, 13.9$
\end{center}
...
## t = -0.79369, df = 12, p-value = 0.4428
...
## t = -2.5355, df = 12, p-value = 0.02616
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.7186707 -0.2813293
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 26.26 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 60.7 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  0.458 0.22921  0.1283 0.8802
## Residuals 22 39.302 1.78644
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 48.03 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 64.15 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 127.4 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 241.33 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: weight
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 276.75 138.377  7.4848 0.004309
## form       1  68.99  68.993  3.7318 0.069282
## dose:form  2  57.14  28.570  1.5453 0.240237
## Residuals 18 332.78  18.488
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -3.2857 -2.2214 -0.2429  2.7143  3.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   20.200      1.185  17.044 1.02e-08
## waterB        -9.914      1.552  -6.389 7.94e-05
## 
## Residual standard error: 2.65 on 10 degrees of freedom
## Multiple R-squared:  0.8032,	Adjusted R-squared:  0.7836 
## F-statistic: 40.82 on 1 and 10 DF,  p-value: 7.941e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.8032$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: height, N und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
7.17 & 0 & 8.72 & 102.41 & 73.35 & 6\\
10.70 & 0 & 9.71 & 97.15 & 71.71 & 11\\
11.20 & 0 & 8.90 & 98.63 & 68.88 & 8\\
6.37 & 1 & 9.29 & 96.16 & 72.55 & 13\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.0899 -1.4124 -0.0982  1.2136  7.4501 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 26.07523    7.51056   3.472 0.000774
## Fe           0.46067    0.07266   6.340 7.27e-09
## P           -0.26522    0.14084  -1.883 0.062685
## light        1.58237    0.47370   3.340 0.001188
## 
## Residual standard error: 2.077 on 97 degrees of freedom
## Multiple R-squared:  0.381,	Adjusted R-squared:  0.3619 
## F-statistic:  19.9 on 3 and 97 DF,  p-value: 3.906e-10
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & maxdepth & do2 & acerage\\
\midrule
COLLIER\_RUN & 18 & 0.26 & 42 & 8.6 & 6298\\
DORSEY\_RUN & 8 & 0.44 & 160 & 6.8 & 7814\\
LITTLE\_BEAR\_CR & 6 & 0.81 & 67 & 9.1 & 3330\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -11.052   -3.823   -1.366    1.427   17.618  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 7.545e-01  1.308e+00   0.577  0.56661
## no3         1.828e-01  7.217e-02   2.533  0.01455
## maxdepth    1.239e-02  4.395e-03   2.818  0.00695
## do2         1.221e-01  1.303e-01   0.937  0.35340
## acerage     3.602e-05  1.250e-05   2.881  0.00586
## 
## (Dispersion parameter for quasipoisson family taken to be 34.67412)
## 
##     Null deviance: 2307.3  on 53  degrees of freedom
## Residual deviance: 1448.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.55     0.871    0.384
## 2 nematodes       0.140   -0.0721   0.943
## 3 water           0.155   -0.808    0.419
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0877 -0.6347 -0.1473  0.5718  3.2051 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  169.7   13.03   
##  subject  (Intercept) 3873.7   62.24   
##  Residual              638.7   25.27   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.899     26.174   7.790
## attitudepop  -20.261      5.553  -3.649
## 
...
\midrule
walking & 39cm; 29cm; 12.1\% & 33cm; 29cm; 4.5\% & 36cm; 31cm; 10.1\%\\
dustbathing & 37cm; 33cm; 2.1\% & 42cm; 18cm; 5.2\% & 42cm; 17cm; 4.1\%\\
wing/leg stretching & 35cm; 35cm; 8.1\% & 33cm; 29cm; 1.2\% & 38cm; 31cm; 1.2\%\\
standing & 42cm; 23cm; 5.1\% & 36cm; 14cm; 1.2\% & 34cm; 25cm; 3.2\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCZ5SPG & 2.5 | 4.0 | Normal \\
    B & GCEM0XE & 4.5 | 2.5 | Mikro \\ 
    C & GCRSPDC & 1.5 | 5.0 | Normal \\ 
    D & GCTJ323 & 5.0 | 3.0 | Normal \\ 
    E & GCYJWGG & 1.0 | 1.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 238 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{3, -7, 15\}$ und den Vektor $B = \{5, 6, 2\}$ gegeben.
