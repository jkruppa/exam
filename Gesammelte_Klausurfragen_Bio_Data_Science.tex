...
\begin{graybox}{Checkbox für die Version vom \today}
  ...
  Im Weiteren finden sich \textbf{10} Aufgaben zur Mathematik.
\end{graybox}
...
\begin{graybox}{Ergebnis der Klausur}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 57 Punkten sind aus dem Rechen- und
    Textteil erreicht. 
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.34, 0.02, 0.42 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.068, 0.004, 0.084 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1.7, 0.1, 2.1 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.068, 0.004, 0.084 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
...
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1, 0.1, 1 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 9, 15, 7 und 9.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.8 +/- 9.2
\item [\textbf{B} \msquare] Es ergibt sich 10.8 +/- 1.515
\item [\textbf{C} \msquare] Es ergibt sich 9.8 +/- 1.515
\item [\textbf{D} \msquare] Es ergibt sich 9.8 +/- 3.03
\item [\textbf{E} \msquare] Es ergibt sich 8.8 +/- 4.6
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 28, 25, 27, 13, 19, 38 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 27 [20, 39]
\item [\textbf{B} \msquare] Es ergibt sich 27 [19, 38]
\item [\textbf{C} \msquare] Es ergibt sich 27 +/- 19
\item [\textbf{D} \msquare] Es ergibt sich 27 +/- 38
...
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 2.4, da es sich um ein Anteil handelt.
...
$y = \{16, 17, 19, 18, 20, 17, 17, 17, 15, 21, 16\}$. Berechnen Sie folgende
...
\begin{center}
$10.7, 5.7, 4.5, 9.5, 8.4, 7, 11.3, 7, 13.4, 12.4, 7.6, 11.3, 11.3, 10.7, 12.2$
\end{center}
...
## t = -4.0541, df = 8, p-value = 0.003663
...
## t = -2.7118, df = 10, p-value = 0.02186
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.1824509 -0.7032634
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 16.57 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 77.43 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 13.273  6.6363  3.9001 0.03714
## Residuals 20 34.032  1.7016
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 114 121 129 113  95 107 147 144 133 142 143 146
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 215.92 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 203.82 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 72.14 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 552.47 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 251.70 125.849 12.7624 0.0003538
## form       1   0.96   0.958  0.0972 0.7588411
## dose:form  2 327.57 163.786 16.6097 8.176e-05
## Residuals 18 177.50   9.861
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.286 -2.071 -1.000  1.500  7.714 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  15.2857     1.3386  11.419 4.65e-07
## trtB         -0.2857     2.0737  -0.138    0.893
## 
## Residual standard error: 3.542 on 10 degrees of freedom
## Multiple R-squared:  0.001895,	Adjusted R-squared:  -0.09792 
## F-statistic: 0.01898 on 1 and 10 DF,  p-value: 0.8932
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -5.9054, df = 8, p-value = 0.0003595
...
Einflussvariablen ($x$) wurden erhoben: variety, P und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.94 & 0 & 9.09 & 96.82 & 69.72 & 11\\
12.21 & 0 & 7.74 & 101.48 & 69.23 & 7\\
10.03 & 1 & 8.84 & 100.80 & 71.85 & 6\\
6.79 & 0 & 9.17 & 98.52 & 63.81 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.8213 -1.5899  0.0281  1.8491  5.4142 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -3.96883    7.93412  -0.500    0.618
## nematodes    0.01045    0.07316   0.143    0.887
## Fe           0.73185    0.07879   9.289 7.85e-15
## light        0.77644    0.59156   1.313    0.193
## 
## Residual standard error: 2.378 on 91 degrees of freedom
## Multiple R-squared:  0.4953,	Adjusted R-squared:  0.4786 
## F-statistic: 29.76 on 3 and 91 DF,  p-value: 1.684e-13
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
BROAD\_RUN & 53 & 3.25 & 56 & 11.9 & 11.12\\
HOLLANDS\_BR & 38 & 2.34 & 85 & 10.5 & 11.44\\
RED\_RUN & 32 & 2.09 & 73 & 8.4 & 5.50\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.294  -4.426  -1.495   1.581  15.902  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.397317   1.423067   0.279  0.78127
## no3          0.249088   0.083834   2.971  0.00459
## maxdepth     0.013676   0.004146   3.299  0.00181
## do2          0.174800   0.143429   1.219  0.22878
## so4         -0.018484   0.027389  -0.675  0.50293
## 
## (Dispersion parameter for quasipoisson family taken to be 36.74943)
## 
##     Null deviance: 2303.8  on 53  degrees of freedom
## Residual deviance: 1489.2  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.69       2.19  0.0289
## 2 water           0.163     -2.10  0.0353
## 3 light           0.503      1.37  0.170
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1439 -0.6238 -0.0962  0.6617  3.3055 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  220.2   14.84   
##  subject  (Intercept) 3968.2   62.99   
##  Residual              647.5   25.45   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.915     26.613   7.587
## attitudepop  -18.874      5.591  -3.376
## 
...
\begin{verbatim}
##          ctrl      high       low       mid
## ctrl 1.00e+00 0.0000000 0.0000187 0.0000003
## high 0.00e+00 1.0000000 0.0002549 0.0108921
## low  1.87e-05 0.0002549 1.0000000 0.1684253
## mid  3.00e-07 0.0108921 0.1684253 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 11, 14, 8, 11 und 12!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 12, 9, 11, 10 und 11! \textbf{(2 Punkte)}
...
Seitenl{\"a}nge einer Pyramide betr{\"a}gt 40 K{\"o}nigsellen. Eine K{\"o}nigselle
misst 52.2cm.\\
...
\begin{enumerate}
\item Die K{\"o}nigspyramide von Meroe soll eine Seitenl{\"a}nge von 40
...
Sie haben den Vektor $A = \{-2, 6, -4\}$ und den Vektor $B = \{-8, 5, -1\}$ gegeben.
