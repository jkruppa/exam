...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.21, 0.02, 0.89 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1.05, 0.1, 4.45 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1, 0.1, 1 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.042, 0.004, 0.178 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1, 0.1, 1 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.042, 0.004, 0.178 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 6, 10, 9 und 15.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.6 +/- 1.755
\item [\textbf{B} \msquare] Es ergibt sich 11.6 +/- 1.755
\item [\textbf{C} \msquare] Es ergibt sich 9.6 +/- 6.15
\item [\textbf{D} \msquare] Es ergibt sich 10.6 +/- 12.3
\item [\textbf{E} \msquare] Es ergibt sich 10.6 +/- 3.51
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 32, 10, 25, 15, 23, 23, 19, 43, 14, 13 und 51.
...
\item [\textbf{C} \msquare] Es ergibt sich 24 [15, 33]
\item [\textbf{D} \msquare] Es ergibt sich 23 +/- 32
\item [\textbf{E} \msquare] Es ergibt sich 23 [14, 32]
\end{enumerate} 
...
$y = \{17, 16, 17, 13, 16, 14, 15\}$. Berechnen Sie folgende
...
Frischgewicht (\textit{freshmatter}) von Maiss.
...
\begin{center}
$11.4, 10.5, 6.7, 4.7, 6.4, 8.7, 9.8, 8, 7.8, 10.3, 9.7, 8, 10.5, 10.3, 11.5$
\end{center}
...
## t = -0.20535, df = 14, p-value = 0.8403
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.086460  4.197571
## sample estimates:
...
## 
## data:  freshmatter by N
## t = 3.5068, df = 8, p-value = 0.007999
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 26.64 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 30.32 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 134.634  67.317  44.599 1.818e-08
## Residuals 22  33.206   1.509
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 105 118 114 113 103  92 148 140 142 153 151 150
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 46.46 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 63.69 &  &  &  \strut\\
    \hline
...
## Response: weight
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 421.93 210.964 11.0283 0.0007471
## form       1  15.54  15.535  0.8121 0.3793985
## dose:form  2 233.08 116.540  6.0922 0.0095368
## Residuals 18 344.33  19.129
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.2000 -1.6786 -0.3143  2.0500  3.5714 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.429      1.018  19.089 3.38e-09
## waterB         8.771      1.577   5.563  0.00024
## 
## Residual standard error: 2.693 on 10 degrees of freedom
## Multiple R-squared:  0.7558,	Adjusted R-squared:  0.7314 
## F-statistic: 30.95 on 1 and 10 DF,  p-value: 0.0002397
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7558$ aus? \textbf{(2 Punkte)}
...
## t = 6.1855, df = 8, p-value = 0.0002636
...
Einflussvariablen ($x$) wurden erhoben: block, N und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.31 & 1 & 8.39 & 108.04 & 79.37 & 11\\
9.06 & 0 & 8.16 & 105.35 & 70.41 & 6\\
10.41 & 0 & 9.98 & 103.26 & 70.43 & 15\\
7.75 & 0 & 11.58 & 101.50 & 70.26 & 17\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.6756 -1.3914 -0.2169  1.5669  5.1795 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -6.22421    7.51336  -0.828   0.4096
## light        1.34341    0.55179   2.435   0.0169
## nematodes   -0.01161    0.07096  -0.164   0.8704
## Fe           0.75770    0.07455  10.164   <2e-16
## 
## Residual standard error: 2.256 on 90 degrees of freedom
## Multiple R-squared:  0.5412,	Adjusted R-squared:  0.526 
## F-statistic: 35.39 on 3 and 90 DF,  p-value: 3.346e-15
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & so4 & maxdepth & do2\\
\midrule
SOUTH\_BR\_CASSELMAN\_R & 2 & 6311 & 21.16 & 46 & 7.6\\
FLINTSTONE\_CR & 11 & 18943 & 14.21 & 50 & 9.2\\
DEER\_CR & 26 & 8297 & 6.36 & 60 & 9.9\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.966  -5.230  -2.328   1.665  21.006  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 7.434e-01  1.665e+00   0.447   0.6572
## acerage     2.841e-05  1.973e-05   1.441   0.1561
## so4         2.125e-03  2.665e-02   0.080   0.9368
## maxdepth    1.143e-02  4.919e-03   2.324   0.0243
## do2         2.018e-01  1.569e-01   1.286   0.2044
## 
## (Dispersion parameter for quasipoisson family taken to be 50.12314)
## 
##     Null deviance: 2372.1  on 53  degrees of freedom
## Residual deviance: 1905.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.58       2.77 0.00566
## 2 water           0.157     -2.83 0.00467
## 3 light           0.489      1.93 0.0533
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4357 -0.5750 -0.0102  0.5741  3.6341 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  257.7   16.05   
##  subject  (Intercept) 3899.3   62.44   
##  Residual              690.1   26.27   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.928     26.516   7.615
## attitudepop  -19.118      5.772  -3.312
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.5672211 0.0249660 0.0000226
## high 0.5672211 1.0000000 0.0061968 0.0000042
## low  0.0249660 0.0061968 1.0000000 0.0138705
## mid  0.0000226 0.0000042 0.0138705 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 10, 6, 7, 8 und 13!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 13, 12, 14, 14 und 14! \textbf{(2 Punkte)}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCIE3I5 & 5.0 | 4.5 | Klein \\
    B & GCONSDL & 3.0 | 2.5 | Klein \\ 
    C & GCDHC3N & 1.0 | 4.0 | Klein \\ 
    D & GCD6LPJ & 2.0 | 3.0 | Mikro \\ 
    E & GCWMLXT & 4.5 | 5.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 668 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{2, 0, 0\}$ und den Vektor $B = \{1, 1, 0\}$ gegeben.
