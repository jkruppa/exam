...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.21, 0.001 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0525, 3e-04 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0525, 3e-04 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.84, 0.004 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.84, 0.004 und 1.36. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.84, 0.004 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 12, 8, 12, 13 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11 +/- 2
\item [\textbf{B} \msquare] Es ergibt sich 11 +/- 1
\item [\textbf{C} \msquare] Es ergibt sich 10 +/- 2
\item [\textbf{D} \msquare] Es ergibt sich 11 +/- 4
\item [\textbf{E} \msquare] Es ergibt sich 12 +/- 1
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 35, 12, 18, 29, 10, 24 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 [12, 35]
\item [\textbf{B} \msquare] Es ergibt sich 26 +/- 12
\item [\textbf{C} \msquare] Es ergibt sich 24 +/- 35
\item [\textbf{D} \msquare] Es ergibt sich 24 +/- 12
\item [\textbf{E} \msquare] Es ergibt sich 24 [12, 35]
\end{enumerate}
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.05 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.35 ist
richtig?
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.38, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 1.6, da es sich um ein Anteil handelt.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.16
...
\item [\textbf{E} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 0.02
\end{enumerate}
...
$y = \{15, 19, 19, 18, 8, 6, 15, 14, 16, 13, 19\}$. Berechnen Sie folgende
...
\begin{center}
$10.5, 9.8, 11.4, 5.6, 10.6, 11.8, 8.5, 14.9, 6.9, 12.4, 8.7, 7.1, 10.7, 11.5, 8.8$
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{group}  & 2 & 4.11 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 11.22 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  4.4229 2.21147  5.7933 0.008064
## Residuals 27 10.3067 0.38173
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 125 114 128 102 104  87 148 134 139 150 156 134
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 206.78 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2407.67 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 107.49 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 708.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df Sum Sq Mean Sq  F value    Pr(>F)
## supp       1  105.7  105.70  10.5757  0.001796
## dose       2 3502.6 1751.31 175.2245 < 2.2e-16
## supp:dose  2  137.5   68.76   6.8794  0.001917
## Residuals 67  669.6    9.99
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -2.4000 -1.2857  0.1571  0.9357  1.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  15.2857     0.5429   28.16 7.42e-11
## trtB         10.1143     0.8410   12.03 2.86e-07
## 
## Residual standard error: 1.436 on 10 degrees of freedom
## Multiple R-squared:  0.9353,	Adjusted R-squared:  0.9289 
## F-statistic: 144.6 on 1 and 10 DF,  p-value: 2.861e-07
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -2.0841, df = 8, p-value = 0.07067
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  -0.89030100  0.05815226
## sample estimates:
##        cor 
## -0.5931933
\end{verbatim}
...
Einflussvariablen ($x$) wurden erhoben: block, weight und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
12.09 & 0 & 8.13 & 96.95 & 67.36 & 7\\
8.25 & 1 & 11.19 & 98.67 & 67.21 & 14\\
12.35 & 0 & 10.96 & 107.30 & 72.89 & 9\\
9.06 & 0 & 10.23 & 96.56 & 65.35 & 14\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.1783 -1.6656  0.2545  1.1578  5.8026 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -9.85404    7.08160  -1.391 0.167225
## Fe           0.83703    0.07072  11.835  < 2e-16
## light        1.11904    0.50812   2.202 0.029988
## P           -0.48901    0.14328  -3.413 0.000935
## 
## Residual standard error: 2.249 on 98 degrees of freedom
## Multiple R-squared:  0.5974,	Adjusted R-squared:  0.5851 
## F-statistic: 48.47 on 3 and 98 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & so4 & acerage & no3\\
\midrule
SOUTH\_BR\_PATAPSCO & 26 & 18.6 & 8.84 & 1450 & 2.96\\
BIG\_PIPE\_CR & 18 & 13.7 & 8.20 & 25440 & 3.53\\
HOLLANDS\_BR & 38 & 12.0 & 11.44 & 1934 & 2.34\\
PATAPSCO\_R & 28 & 19.7 & 9.90 & 4706 & 4.06\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.107  -4.203  -1.479   1.663  20.516  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.064e+00  1.109e+00   0.959 0.342444
## temp         7.587e-02  4.727e-02   1.605 0.114923
## so4         -1.128e-02  2.374e-02  -0.475 0.636935
## acerage      5.941e-05  1.645e-05   3.612 0.000715
## no3          2.708e-01  8.038e-02   3.369 0.001479
## 
## (Dispersion parameter for quasipoisson family taken to be 41.61734)
## 
##     Null deviance: 2399.6  on 53  degrees of freedom
## Residual deviance: 1636.6  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.364    -0.425   0.671
## 2 nematodes       0.152    -0.335   0.737
## 3 light           0.481     0.357   0.721
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3738 -0.6330 -0.1079  0.4991  3.4861 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  218.1   14.77   
##  subject  (Intercept) 4096.5   64.00   
##  Residual              730.4   27.03   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.126     27.043   7.511
## attitudepop  -21.051      5.938  -3.545
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.1917492 0.4927497 0.0730562
## high 0.1917492 1.0000000 0.0510071 0.0032032
## low  0.4927497 0.0510071 1.0000000 0.2548090
## mid  0.0730562 0.0032032 0.2548090 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 4, 15, 5, 8 und 6!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 7, 17, 11, 13 und 8! \textbf{(2 Punkte)}
