...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.34, 0.001, 0.89 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.005, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.005, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.084, 0.068, 2e-04, 0.178 und 0.042. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.084, 0.068, 2e-04, 0.178 und 0.042. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.1, 1.7, 0.005, 4.45 und 1.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 11, 16, 10 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.6 +/- 1.255
\item [\textbf{B} \msquare] Es ergibt sich 12.6 +/- 1.255
\item [\textbf{C} \msquare] Es ergibt sich 10.6 +/- 3.15
\item [\textbf{D} \msquare] Es ergibt sich 11.6 +/- 6.3
\item [\textbf{E} \msquare] Es ergibt sich 11.6 +/- 2.51
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 27, 29, 17, 29, 6, 24, 16, 28, 13, 15 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 +/- 15
\item [\textbf{B} \msquare] Es ergibt sich 22 +/- 15
\item [\textbf{C} \msquare] Es ergibt sich 24 +/- 29
\item [\textbf{D} \msquare] Es ergibt sich 22 [16, 30]
\item [\textbf{E} \msquare] Es ergibt sich 24 [15, 29]
\end{enumerate} 
...
$y = \{20, 14, 11, 12, 15, 17, 16\}$. Berechnen Sie folgende
...
\begin{center}
$11.8, 10.6, 9.5, 9.2, 13.7, 7.3, 8.5, 10.4, 6.4, 10.2, 14.2, 8.1$
\end{center}
...
## t = 0.10944, df = 14, p-value = 0.9144
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.247284  3.596490
## sample estimates:
...
## t = 0.84908, df = 12, p-value = 0.4125
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.958160  6.735938
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 12.13 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 67.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 67.872  33.936   13.34 0.0001607
## Residuals 22 55.968   2.544
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 102 113 115  96 103 101 126 141 121 143 140 147
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 2.39 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 254.31 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 253.01 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 403.04 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2   5.21   2.605   0.212     0.811
## form       1 307.67 307.667  25.035 9.215e-05
## dose:form  2 436.42 218.210  17.756 5.514e-05
## Residuals 18 221.21  12.290
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -2.8000 -0.5500  0.3333  1.3000  2.2000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  20.8000     0.7616  27.312 3.58e-12
## trtB          6.8667     0.9499   7.229 1.04e-05
## 
## Residual standard error: 1.703 on 12 degrees of freedom
## Multiple R-squared:  0.8133,	Adjusted R-squared:  0.7977 
## F-statistic: 52.26 on 1 and 12 DF,  p-value: 1.044e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: block, dry und dosage. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.51 & 1 & 11.37 & 104.87 & 74.41 & 10\\
11.28 & 0 & 12.29 & 100.22 & 66.10 & 8\\
10.54 & 0 & 9.25 & 101.31 & 76.86 & 6\\
9.61 & 0 & 10.88 & 104.29 & 70.40 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.3173 -1.5847  0.1204  1.4000  6.5478 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 12.14282   10.12661   1.199    0.233
## Fe           0.57947    0.09578   6.050 2.59e-08
## water       -0.06984    0.16515  -0.423    0.673
## nematodes    0.03323    0.08989   0.370    0.712
## 
## Residual standard error: 2.464 on 99 degrees of freedom
## Multiple R-squared:  0.2816,	Adjusted R-squared:  0.2599 
## F-statistic: 12.94 on 3 and 99 DF,  p-value: 3.368e-07
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & temp & acerage & no3\\
\midrule
ROCK\_CR & 3 & 6.8 & 18.0 & 575 & 2.47\\
HAY\_MEADOW\_BR & 5 & 9.5 & 20.1 & 639 & 3.53\\
RED\_RUN & 32 & 8.4 & 17.7 & 3332 & 2.09\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -6.9495  -3.3740  -1.0965   0.8658  17.5132  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -5.067e-01  1.507e+00  -0.336  0.73813
## do2          1.592e-01  1.249e-01   1.275  0.20847
## temp         8.484e-02  4.172e-02   2.034  0.04741
## acerage      3.345e-05  1.420e-05   2.355  0.02255
## no3          1.946e-01  5.903e-02   3.296  0.00183
## 
## (Dispersion parameter for quasipoisson family taken to be 25.69439)
## 
##     Null deviance: 1637.5  on 53  degrees of freedom
## Residual deviance: 1011.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.56       1.06  0.291 
## 2 nematodes       0.173      2.10  0.0357
## 3 water           0.154     -1.64  0.101
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.5784 -0.5634 -0.1241  0.6264  3.2453 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  167.3   12.93   
##  subject  (Intercept) 3932.8   62.71   
##  Residual              652.7   25.55   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.293     26.361   7.674
## attitudepop  -20.571      5.613  -3.665
## 
...
\begin{verbatim}
##           ctrl      high      low       mid
## ctrl 1.0000000 0.0841977 0.00e+00 0.0001187
## high 0.0841977 1.0000000 1.00e-07 0.0140213
## low  0.0000000 0.0000001 1.00e+00 0.0002130
## mid  0.0001187 0.0140213 2.13e-04 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 10, 9, 15, 13 und 14!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 7, 12, 4, 9 und 2! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes Fe, pigs und P an drei verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{10, 2, 5\}$ und den Vektor $B = \{7, 5, 2\}$ gegeben.
