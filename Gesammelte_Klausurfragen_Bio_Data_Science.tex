...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.29, da es sich um eine Chancenverh{"a}ltnis handelt.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.89, 0.02 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.105, 0.2225, 0.005 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.68, 3.56, 0.08 und 1.36. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.105, 0.2225, 0.005 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\item [\textbf{D} \msquare] Beim multiplen Testen kann es zu einer $\Delta$-Inflation kommen. Das globale Effektniveau liegt nicht mehr bei $20\%$. Daher m{"u}ssen die Effekte entsprechend adjustiert werden. Hierf{"u}r gibt es verschiedene Verfahren, wobei das Verfahren zur Adjustierung der Effekte nach Bonferroni das bekanneste Verfahren ist.
...
\item [\textbf{D} \msquare] Der Effekt eines statistischen Tests beschreibt den Output oder die Wiedergabe eines Tests.
...
Nach einem Freilandversuch mit zwei L{"u}ftungssystemen und Folientunneln ($ctrl$ und $tornado$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Datentabelle mit dem
...
\begin{center}
$7, 5, 8, 2, 8, 2, 3, 5, 1, 3, 6, 5, 8, 5, 9, 2, 0, 7, 2, 4, 3, 8, 1, 1, 6, 6, 6, 1, 8, 5$
\end{center}
...
\begin{center}
$9.9, 8.5, 13.3, 10, 10.2, 9.6, 10.8, 11.3, 7.5, 8.3, 7.2, 10, 7.2, 11.3, 10.3, 6.6, 11.4, 11.6, 13.3, 11.2$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  (Unbekannte) Wahrheit & H$_0$ abgelehnt & Testentscheidung & H$_0$ falsch \\
  \end{tabular}
  \end{center}
...
\item Treffen Sie mit $T_{\alpha = 5\%} = 1.64$ und dem berechneten $T_{calc}$ eine Aussage
  zur Nullhypothese! Begr{\"u}nden Sie Ihre Antwort! \textbf{(2 Punkte)}
...
## t = 3.4711, df = 10, p-value = 0.00601
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  1.555111 7.130603
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 1.2 &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 & 68.16 &  &  &  \strut\\
        \hline
...
Faktorstufen \textit{ctrl}, \textit{pos} und
\textit{mid} vorliegen.
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 130.89 &  &  &  \strut\\
    \hline
   \textbf{error}  & 24 & 257.78 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 25.081 12.5403  8.8769 0.001491
## Residuals 22 31.079  1.4127
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 86.46 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 244.6 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 26.37 &  &  &  \strut\\
    \hline
   \textbf{error}  & 32 & 164.81 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 66 H{"a}ngebauchschweinen durchgef{\"u}hrt, wobei
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 399.95 199.976 13.1930 0.0002967
## form       1 169.30 169.299 11.1692 0.0036283
## dose:form  2  39.25  19.625  1.2947 0.2982961
## Residuals 18 272.84  15.158
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0600926 0.0146835 0.7681440
## high 0.0600926 1.0000000 0.0000777 0.1083563
## low  0.0146835 0.0000777 1.0000000 0.0070899
## mid  0.7681440 0.1083563 0.0070899 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 155$ Sauen. In dem Experiment wurde gemessen,
...
## -4.4444 -1.5611  0.0556  1.5556  4.4000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  16.4444     0.8894  18.490 3.48e-10
## waterB        9.1556     1.4882   6.152 4.93e-05
## 
## Residual standard error: 2.668 on 12 degrees of freedom
## Multiple R-squared:  0.7593,	Adjusted R-squared:  0.7392 
## F-statistic: 37.85 on 1 and 12 DF,  p-value: 4.93e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7593$ aus? \textbf{(2 Punkte)}
...
## t = 6.2785, df = 8, p-value = 0.0002383
...
Einflussvariablen ($x$) wurden erhoben: dry, block und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
foraging incl. scratching & 35cm; 30cm; 0.2\% & 36cm; 22cm; 0.6\% & 41cm; 30cm; 0.4\%\\
preening & 39cm; 28cm; 6.3\% & 34cm; 23cm; 5.2\% & 43cm; 21cm; 8.1\%\\
wingflapping & 38cm; 25cm; 6.2\% & 36cm; 27cm; 3.2\% & 30cm; 38cm; 5.1\%\\
wing/leg stretching & 38cm; 20cm; 1.2\% & 35cm; 26cm; 1\% & 37cm; 24cm; 0.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCDE3QM & 4.0 | 1.0 | Klein \\
    B & GCLAYHW & 5.0 | 1.5 | Normal \\ 
    C & GCYM3JG & 3.5 | 5.0 | Klein \\ 
    D & GC1LIJY & 3.0 | 2.5 | Normal \\ 
    E & GCZTVKT & 2.0 | 3.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1164 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{8\times 10^{9}} - \ensuremath{1.2\times 10^{9}} \cdot 2.1^{-0.15 \cdot t + 3.2}
\end{equation*}
...
Sie haben den Vektor $A = \{15, -3, 11\}$ und den Vektor $B = \{2, 1, 4\}$ gegeben.
