...
In einen Versuch in einer Klimakammer wurden die Daten $D$ von Kartoffeln mit der Behandlung Genotypen ($AA$, $AB$ und $BB$) untersucht. Es wurde als Messwert Frischegewicht [kg/ha] bestimmt. Jetzt starrt Tina mit auf die \Rlogo Ausgabe einer einfaktoriellen ANOVA. Anscheinend gibt es ein Problem mit der Annahme der Normalverteilung und der Varianzhomogenität der ANOVA in den Daten. 'Wir haben jetzt bei der ANOVA einen p-Wert mit 0.071 raus sowie eine F-Statistik $F_D$ mit 1.78 berechnet. Nach den Boxplots müsste sich eigentlich ein Unterschied zwischen $AA$ und $AB$ ergeben. Der Unterschied ist in \texttt{\{emmeans\}} auch signifikant mit einem p-Wert von 0.021. Wie kann das sein?', meint Tina ungläubig. Leider starrt ihr Betreuer in der gleichen Art Tina zurück an. Tina hat schon genug Probleme. Wenn die Wut nicht wäre, dann wäre es einfacher. Das wird ein langer Nachmmittag, denkt sie sich und kreuselt ihren Mund. 'Und was machen wir jetzt?' entfährt es ihr überrascht entnervt. Immerhin war geht es ja um ihre Hausarbeit. Tina hätte doch nichts mit Kartoffeln machen sollen. Kartoffeln -- was soll das auch bedeutendes sein? Hoffentlich kommt sie noch zum Konzert von Tocotronic. Nervös krault sie die Spinne.
...
Jonas und Yuki untersuchen gemeinsam in ihrer Abschlussarbeit den Messwert Proteingehalt [g/kg] in Erbsen. Es ist einiges schiefgelaufen, wie es immer so passiert. Hauptsächlich waren es Wölfe, auch wenn man erstmal bei dem Messwert nicht unbedingt an Wölfe denken würde. Aber das ist eine andere Geschichte. Jetzt wollen Jonas und Yuki ihre Ergebnisse nochmal mit einer Studie von Almar et al. (2012) vergleichen und schauen, ob was ähnliches rauskommt. Angeschaut wurde sich als Behandlung Bewässerungstypen ($none$, $ctrl$, $low$, $mid$ und $high$). Es ergab sich dann die folgende Tabelle der rohen p-Werte für die Vergleiche zu Almar et al. (2012).
...
Nilufar sitzt schon etwas länger bei ihrer Betreuerin. So langsam macht Nilufar sich Gedanken, ob sie nicht doch mal anmerken sollte, dass sie von CLD noch nie was gehört hat. Aber noch kann gelauscht werden, ein Ende ist erstmal nicht in Sicht! Nilufar hatte in ihrem Projektbericht einen Versuch in einer Klimakammer durchgeführt. Deshalb sitzt sie hier. Also eigentlich nein, deshalb nicht. Nilufar will fertig werden. Hat sie sich doch mit Bewässerungstypen ($none$, $ctrl$, $low$ und $high$) und Chlorophyllgehalt (SPAD-502Plus) [SPAD] schon eine Menge angeschaut. Nilufar beugt sich leicht nach vorne. Nein, doch keine Pause. Weiter warten auf eine Lücke im Fluss...
...
Mark sitzt schon etwas länger bei seine Betreuerin. So langsam macht Mark sich Gedanken, ob er nicht doch mal anmerken sollte, dass er von CLD noch nie was gehört hat. Aber noch kann gelauscht werden, ein Ende ist erstmal nicht in Sicht! Mark hatte in der Projektbericht ein Stallexperiment durchgeführt. Deshalb sitzt er hier. Also eigentlich nein, deshalb nicht. Mark will fertig werden. Hat er sich doch mit Elterlinie ($ctrl$, $Standard$, $TOP$ und $Xray$) und Schlachtgewicht [kg] schon eine Menge angeschaut. Mark beugt sich leicht nach vorne. Nein, doch keine Pause. Weiter warten auf eine Lücke im Fluss... 'Wir müssen als erstes die Gruppen nach absteigender Effektstärke sortieren!', hört Mark noch aus der Ferne bevor er einnickt.
