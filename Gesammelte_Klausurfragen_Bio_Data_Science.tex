...
\clearpage
% -----------------------------------------------------------------------
\section*{Deskrptive Statistik \& Explorative Datenanalyse}

\section{Aufgabe \hfill (2 Punkte)}



Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.02, 0.21 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.005, 0.0525 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.005, 0.0525 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 0.84 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 0.84 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 0.84 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 17, 4, 12, 21 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12.8 +/- 42.7
\item [\textbf{B} \msquare] Es ergibt sich 12.8 +/- 6.53
\item [\textbf{C} \msquare] Es ergibt sich 13.8 +/- 3.265
\item [\textbf{D} \msquare] Es ergibt sich 11.8 +/- 21.35
\item [\textbf{E} \msquare] Es ergibt sich 12.8 +/- 3.265
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 28, 18, 14, 13, 8, 16, 32, 15, 32, 15 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 16 +/- 14
\item [\textbf{B} \msquare] Es ergibt sich 22 [15, 33]
\item [\textbf{C} \msquare] Es ergibt sich 16 [14, 32]
\item [\textbf{D} \msquare] Es ergibt sich 22 +/- 14
\item [\textbf{E} \msquare] Es ergibt sich 16 +/- 32
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.46, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\begin{center}
$0, 5, 2, 6, 3, 2, 4, 6, 3, 5, 2, 7, 3, 5, 5, 8, 6, 4, 3, 5, 3, 4, 5, 5, 4, 3, 6, 5, 0, 4, 5, 6, 5$
\end{center}
...
\begin{center}
$9.5, 9.9, 7.5, 8.8, 8, 9, 11.6, 13.1, 9.7, 9.7, 8.5, 15.3, 8.2, 12.3, 9.7, 11.9, 7.7, 9.7, 8.9, 10.3$
\end{center}
...
## t = 5.0484, df = 14, p-value = 0.0001778
...
## t = -3.189, df = 10, p-value = 0.009671
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -11.648249  -2.066036
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 109.4 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 42.6 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 12.254  6.1270  1.5362 0.2374
## Residuals 22 87.746  3.9885
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{supp}  & 1 & 0.01 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 148.72 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 152.97 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 228.27 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 369.04 184.518 10.9544 0.0007724
## form       1  13.55  13.554  0.8047 0.3815454
## dose:form  2  31.02  15.511  0.9209 0.4161352
## Residuals 18 303.20  16.844
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0450847 0.0291522 0.2835500
## high 0.0450847 1.0000000 0.0001228 0.0032955
## low  0.0291522 0.0001228 1.0000000 0.2415330
## mid  0.2835500 0.0032955 0.2415330 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.6000 -1.1071  0.2714  1.2071  3.4000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  13.6000     1.0006  13.592 8.98e-08
## waterB       -0.7429     1.3101  -0.567    0.583
## 
## Residual standard error: 2.237 on 10 degrees of freedom
## Multiple R-squared:  0.03115,	Adjusted R-squared:  -0.06573 
## F-statistic: 0.3215 on 1 and 10 DF,  p-value: 0.5832
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.0312$ aus? \textbf{(2 Punkte)}
...
\midrule
preening & 39cm; 36cm; 4.1\% & 34cm; 25cm; 2.1\% & 34cm; 24cm; 3.5\%\\
walking & 31cm; 30cm; 1.6\% & 37cm; 14cm; 0.5\% & 32cm; 18cm; 8.1\%\\
drinking/eating & 45cm; 23cm; 8.1\% & 44cm; 36cm; 5.2\% & 36cm; 20cm; 6.3\%\\
dustbathing & 31cm; 23cm; 18.1\% & 40cm; 24cm; 16.4\% & 35cm; 22cm; 18.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC3T41I & 4.0 | 2.0 | Normal \\
    B & GCBT4RW & 2.5 | 4.5 | Normal \\ 
    C & GCYLHQW & 3.0 | 1.5 | Mikro \\ 
    D & GCJCJE4 & 3.5 | 3.5 | Klein \\ 
    E & GCNPFAG & 2.0 | 4.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 554 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{3, 7, -2\}$ und den Vektor $B = \{-7, -1, 3\}$ gegeben.
