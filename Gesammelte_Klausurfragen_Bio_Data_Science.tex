...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.21, 0.42, 0.01 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.042, 0.084, 0.002 und 0.0002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 1.05, 2.1, 0.05 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
...
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 1, 1, 0.05 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.042, 0.084, 0.002 und 0.0002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 15, 14, 12 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12.6 +/- 3.8
\item [\textbf{B} \msquare] Es ergibt sich 12.6 +/- 1.95
\item [\textbf{C} \msquare] Es ergibt sich 11.6 +/- 1.9
\item [\textbf{D} \msquare] Es ergibt sich 12.6 +/- 0.975
\item [\textbf{E} \msquare] Es ergibt sich 13.6 +/- 0.975
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 15, 10, 4, 18, 19, 30 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 18 [10, 30]
\item [\textbf{B} \msquare] Es ergibt sich 21 +/- 10
\item [\textbf{C} \msquare] Es ergibt sich 18 +/- 10
\item [\textbf{D} \msquare] Es ergibt sich 18 +/- 30
\item [\textbf{E} \msquare] Es ergibt sich 21 [10, 30]
\end{enumerate}
...
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.52 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.75, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\midrule
(Intercept) & 38.23 & 0.25\\
light\_binhigh & 3.62 & 0.38\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 13.12
\item [\textbf{B} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 13.12
...
\item [\textbf{D} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 3.62
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 34
...
$y = \{16, 14, 17, 13, 18, 12, 20\}$. Berechnen Sie folgende
...
## t = 0.0556046, df = 14, p-value = 0.95644
...
## t = -0.573112, df = 10, p-value = 0.57923
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.4688339  2.6402625
## sample estimates:
...
## t = 0.489878, df = 10, p-value = 0.63479
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.1704649  8.0847506
## sample estimates:
...
## 
## data:  freshmatter by N
## t = 0.382546, df = 6, p-value = 0.71524
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.56 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 11.63 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  2.96655 1.483274 3.55189 0.042715 *
## Residuals 27 11.27524 0.417601                   
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 206.99 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2427.83 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 108.48 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 721.74 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 49 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: len
##           Df   Sum Sq Mean Sq  F value               Pr(>F)    
## supp       1  414.675 414.675 40.97371 0.000000095361068572 ***
## dose       2 1502.041 751.021 74.20781 0.000000000000011404 ***
## supp:dose  2   29.825  14.912  1.47348              0.24047    
## Residuals 43  435.182  10.121                                  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
In einem Stallexperiment mit $n = 91$ Ferkeln wurde der
...
## -3.00000 -1.91667 -0.33333  2.25000  3.33333 
## 
## Coefficients:
##             Estimate Std. Error t value       Pr(>|t|)    
## (Intercept)  16.0000     1.0801 14.8131 0.000000004485 ***
## trtB         11.6667     1.3472  8.6603 0.000001654494 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.4152 on 12 degrees of freedom
## Multiple R-squared:  0.86207,	Adjusted R-squared:  0.85057 
## F-statistic:     75 on 1 and 12 DF,  p-value: 0.0000016545
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\toprule
stream & longnose & temp & no3 & do2 & maxdepth\\
\midrule
BLUE\_LICK\_RUN & 1 & 14.3 & 1.20 & 8.5 & 46\\
PINEY\_BR & 48 & 18.9 & 4.70 & 8.3 & 52\\
LITTLE\_CONOCOCHEAGUE\_CR & 15 & 24.0 & 0.33 & 6.8 & 54\\
LITTLE\_ANTIETAM\_CR & 24 & 24.0 & 2.11 & 9.3 & 44\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -9.5748  -4.4264  -1.8132   1.9810  16.9114  
## 
## Coefficients:
##               Estimate Std. Error t value  Pr(>|t|)    
## (Intercept) -1.0253564  1.7864436 -0.5740 0.5686168    
## temp         0.0985994  0.0463234  2.1285 0.0383488 *  
## no3          0.1876213  0.0809175  2.3187 0.0246272 *  
## do2          0.1113075  0.1521531  0.7315 0.4679281    
## maxdepth     0.0165679  0.0041599  3.9827 0.0002255 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 36.542729)
## 
##     Null deviance: 2431.01  on 53  degrees of freedom
## Residual deviance: 1501.69  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.387    -0.605  0.545 
## 2 light           0.478     1.80   0.0718
## 3 nematodes       0.154     1.06   0.291
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
10.35 & 0 & 10.16 & 98.00 & 67.39 & 12\\
10.22 & 0 & 8.90 & 102.36 & 73.74 & 11\\
9.46 & 1 & 8.78 & 102.52 & 71.70 & 13\\
10.84 & 1 & 10.56 & 102.48 & 70.81 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -6.75656 -1.44751  0.21021  1.78284  5.79241 
## 
## Coefficients:
##             Estimate Std. Error t value             Pr(>|t|)    
## (Intercept) 79.17535    2.87045 27.5829 < 0.0000000000000002 ***
## water       -0.24309    0.22552 -1.0779              0.28474    
## P           -0.60204    0.22900 -2.6290              0.01049 *  
## light        0.42785    0.84129  0.5086              0.61263    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.7946 on 71 degrees of freedom
## Multiple R-squared:  0.11895,	Adjusted R-squared:  0.081717 
## F-statistic: 3.1951 on 3 and 71 DF,  p-value: 0.028589
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -1.95616 -0.57440 -0.16516  0.58132  3.39956 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  231.80  15.225  
##  subject  (Intercept) 4264.30  65.302  
##  Residual              653.02  25.554  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 201.6907    27.5568  7.3191
## attitudepop -18.9462     5.6149 -3.3743
## 
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.1044235 0.6556892 0.1311078
## B 0.1044235 1.0000000 0.0417341 0.0029328
## C 0.6556892 0.0417341 1.0000000 0.2798073
## D 0.1311078 0.0029328 0.2798073 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
