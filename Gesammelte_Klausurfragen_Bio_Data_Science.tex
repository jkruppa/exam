...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.21, 0.01, 0.34, 0.42 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.18, 1, 0.06, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.035, 0.0017, 0.0567, 0.07 und 0.1483. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.18, 1, 0.06, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.035, 0.0017, 0.0567, 0.07 und 0.1483. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.18, 1.26, 0.06, 2.04, 2.52 und 5.34. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 12, 16, 5, 8 und 5.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.2 +/- 2.38
\item [\textbf{B} \msquare] Es ergibt sich 10.2 +/- 2.38
\item [\textbf{C} \msquare] Es ergibt sich 9.2 +/- 4.76
\item [\textbf{D} \msquare] Es ergibt sich 9.2 +/- 22.7
\item [\textbf{E} \msquare] Es ergibt sich 8.2 +/- 11.35
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 12, 18, 25, 17, 26, 18 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 18 [17, 26]
\item [\textbf{B} \msquare] Es ergibt sich 18 +/- 17
\item [\textbf{C} \msquare] Es ergibt sich 26 +/- 17
\item [\textbf{D} \msquare] Es ergibt sich 26 [17, 26]
\item [\textbf{E} \msquare] Es ergibt sich 18 +/- 26
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.91 liegt keine Overdispersion vor.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.91 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.91 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung einer anderen Verteilungsfamilie wie die Quasipossion Verteilung.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.11 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 1.75, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.36, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.57, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.1
...
Sie haben folgende Zahlenreihe $y$ vorliegen
$y = \{22, 13, 13, 20, 20, 12, 18, 18, 19, 16, 16\}$. Berechnen Sie folgende
...
## t = -0.0793884, df = 12, p-value = 0.93803
...
## t = 1.76835, df = 12, p-value = 0.10239
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.7169885  6.8947663
## sample estimates:
...
## t = -1.17108, df = 16, p-value = 0.25871
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.6204275  1.6204275
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = -0.371391, df = 4, p-value = 0.72918
...
## trt        2 3.05829 1.529145 5.05046 0.0137 *
## Residuals 27 8.17487 0.302773                 
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 202.01 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2422.94 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 107.13 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 702.13 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df   Sum Sq  Mean Sq  F value                 Pr(>F)    
## supp       1  549.428  549.428  52.1730       0.00000000052356 ***
## dose       2 2607.742 1303.871 123.8138 < 0.000000000000000222 ***
## supp:dose  2  257.983  128.992  12.2489       0.00002803217730 ***
## Residuals 69  726.632   10.531                                    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   54   \strut\\
    \hline
     &  75 &  47 &  122  \strut\\
  \end{tabular}
\end{center}
...
Einflussvariablen ($x$) wurden erhoben: variety, height und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & no3 & acerage & maxdepth & temp\\
\midrule
BEAR\_CR & 54 & 0.99 & 19611 & 96 & 19.5\\
DEEP\_RUN & 5 & 1.30 & 1175 & 57 & 21.8\\
BASIN\_RUN & 13 & 2.28 & 2528 & 80 & 15.3\\
ROCK\_CR & 3 & 2.47 & 575 & 33 & 18.0\\
\bottomrule
\end{tabular}
\end{table}
...
## -10.5658   -3.7534   -2.0848    2.3921   14.8668  
## 
## Coefficients:
##                Estimate  Std. Error t value Pr(>|t|)   
## (Intercept) 1.695363766 0.789533397  2.1473 0.036743 * 
## no3         0.184461143 0.062946674  2.9304 0.005129 **
## acerage     0.000038144 0.000011632  3.2794 0.001919 **
## maxdepth    0.009091221 0.003845144  2.3643 0.022069 * 
## temp        0.018434401 0.035396392  0.5208 0.604853   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 29.387087)
## 
##     Null deviance: 2164.72  on 53  degrees of freedom
## Residual deviance: 1336.61  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.73       1.76  0.0791
## 2 light           0.485      2.27  0.0230
## 3 water           0.168     -1.97  0.0486
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
11.06 & 1 & 11.92 & 101.29 & 69.86 & 12\\
8.99 & 0 & 13.06 & 95.87 & 69.00 & 6\\
7.37 & 1 & 7.77 & 101.77 & 71.32 & 5\\
8.42 & 0 & 8.63 & 102.79 & 72.80 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -5.54949 -1.44263  0.06365  1.43982  5.83543 
## 
## Coefficients:
##               Estimate Std. Error t value             Pr(>|t|)    
## (Intercept) -5.5693174  7.0424833 -0.7908              0.43096    
## Fe           0.7887971  0.0679234 11.6130 < 0.0000000000000002 ***
## P           -0.3508435  0.1508782 -2.3253              0.02212 *  
## nematodes    0.0018001  0.0735985  0.0245              0.98054    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.2408 on 98 degrees of freedom
## Multiple R-squared:  0.5928,	Adjusted R-squared:  0.58033 
## F-statistic: 47.556 on 3 and 98 DF,  p-value: < 0.000000000000000222
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Residuals:
##    Min     1Q Median     3Q    Max 
##  -2.00  -1.05   0.00   1.00   3.20 
## 
## Coefficients:
##             Estimate Std. Error t value      Pr(>|t|)    
## (Intercept) 15.80000    0.75895 20.8183 0.00000000145 ***
## trtB        -0.80000    0.99369 -0.8051        0.4395    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.6971 on 10 degrees of freedom
## Multiple R-squared:  0.06087,	Adjusted R-squared:  -0.033043 
## F-statistic: 0.64815 on 1 and 10 DF,  p-value: 0.4395
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 798.5
## 
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.37934 -0.53921 -0.21363  0.53363  3.31164 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  245.51  15.669  
##  subject  (Intercept) 3929.46  62.685  
##  Residual              688.68  26.243  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 201.7183    26.5778  7.5897
## attitudepop -17.8885     5.7662 -3.1023
## 
...
\midrule
A & 16.11 & 15 & 12 & 21 & 13 & 19 & 11.61\\
B & 17.22 & 16 & 14 & 22 & 15 & 19 & 8.19\\
C & 11.89 & 13 & 3 & 16 & 10 & 15 & 16.36\\
D & 6.56 & 7 & 3 & 9 & 5 & 8 & 3.78\\
\bottomrule
\end{tabular}
\end{table}
