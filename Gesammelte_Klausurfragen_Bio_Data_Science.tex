...
Eine neue technische Anlage wurde in einer Klimakammer getestet. Bei dem
...
\midrule
preening & 30cm; 19cm; 0.6\% & 33cm; 23cm; 0.2\% & 39cm; 36cm; 0.9\%\\
wingflapping & 26cm; 24cm; 8.1\% & 31cm; 25cm; 0.5\% & 33cm; 37cm; 8.1\%\\
dustbathing & 39cm; 24cm; 8.1\% & 28cm; 22cm; 3.6\% & 27cm; 30cm; 8.1\%\\
foraging incl. scratching & 27cm; 23cm; 1\% & 37cm; 24cm; 1.2\% & 32cm; 21cm; 0.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
Sie haben den Vektor $A = \{3, 7, 6\}$ und den Vektor $B = \{1, -2, -5\}$ gegeben.
