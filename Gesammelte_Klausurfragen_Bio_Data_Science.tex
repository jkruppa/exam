...
% -----------------------------------------------------------------------
\input{C:/Users/jokruppa/Documents/GitHub/exam/init}
% -----------------------------------------------------------------------
...
\begin{graybox}{Ergebnis der Klausur}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 59 Punkten sind aus dem Rechen- und
    Textteil erreicht. 
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.42, 0.89 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1.68, 3.56 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0003, 0.105, 0.2225 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0003, 0.105, 0.2225 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 17, 3, 4, 8 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.6 +/- 2.84
\item [\textbf{B} \msquare] Es ergibt sich 7.6 +/- 16.15
\item [\textbf{C} \msquare] Es ergibt sich 9.6 +/- 2.84
\item [\textbf{D} \msquare] Es ergibt sich 8.6 +/- 5.68
\item [\textbf{E} \msquare] Es ergibt sich 8.6 +/- 32.3
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 19, 19, 15, 21, 22, 30, 25, 15, 21, 31 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 [20, 31]
\item [\textbf{B} \msquare] Es ergibt sich 21 +/- 19
\item [\textbf{C} \msquare] Es ergibt sich 24 +/- 19
\item [\textbf{D} \msquare] Es ergibt sich 21 [19, 30]
\item [\textbf{E} \msquare] Es ergibt sich 21 +/- 30
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.62, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.38, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.62, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 1.6, da es sich um ein Anteil handelt.
...
$y = \{14, 15, 15, 16, 17, 15, 12, 13, 19, 11, 18\}$. Berechnen Sie folgende
...
\begin{center}
$10.3, 9.2, 8.8, 11.4, 7.8, 11, 11.4, 9.2, 9.7, 9, 11.8, 10.8, 8.5, 10.6$
\end{center}
...
\item Berechnen Sie das 99\% Konfidentintervall unter der
...
## t = 0.318223, df = 8, p-value = 0.75846
...
## t = -0.113961, df = 16, p-value = 0.91069
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.1780104  1.9557882
## sample estimates:
...
## 
## data:  freshmatter by N
## t = -0.290713, df = 12, p-value = 0.77623
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.9080601  3.7525045
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = 1.64978, df = 6, p-value = 0.15008
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 11.17 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 40.57 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 178.1629 89.0814 28.3727 0.0000014447
## Residuals 20  62.7937  3.1397
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 110 130 130  97 101 103 133 144 144 148 153 148
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 62.7 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 237.87 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 199.75 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 540.9 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq  Mean Sq F value    Pr(>F)
## dose       2 236.777 118.3884 6.49378 0.0075295
## form       1  12.377  12.3767 0.67888 0.4207558
## dose:form  2 340.030 170.0149 9.32558 0.0016621
## Residuals 18 328.159  18.2310
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##  -3.60  -2.00  -0.50   2.05   5.40 
## 
## Coefficients:
##             Estimate Std. Error t value        Pr(>|t|)
## (Intercept) 19.00000    0.93887 20.2370 0.0000000001215
## trtB        -3.40000    1.57103 -2.1642         0.05133
## 
## Residual standard error: 2.8166 on 12 degrees of freedom
## Multiple R-squared:  0.28073,	Adjusted R-squared:  0.2208 
## F-statistic: 4.6837 on 1 and 12 DF,  p-value: 0.051326
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 7.29544, df = 8, p-value = 0.000084258
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  0.73314773 0.98421919
## sample estimates:
##        cor 
## 0.93237928
\end{verbatim}
...
Einflussvariablen ($x$) wurden erhoben: P, variety und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.20 & 1 & 10.71 & 97.42 & 70.85 & 6\\
9.28 & 0 & 9.91 & 98.38 & 65.13 & 13\\
11.08 & 0 & 8.27 & 98.89 & 73.70 & 5\\
9.02 & 0 & 10.79 & 102.58 & 68.24 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -7.42987 -1.98273  0.34317  2.12614 10.15067 
## 
## Coefficients:
##             Estimate Std. Error t value             Pr(>|t|)
## (Intercept) 76.39864    2.94773 25.9178 < 0.0000000000000002
## P           -0.37843    0.20529 -1.8434              0.06787
## light        0.29671    0.67807  0.4376              0.66252
## water       -0.26777    0.20211 -1.3248              0.18787
## 
## Residual standard error: 3.2327 on 114 degrees of freedom
## Multiple R-squared:  0.04398,	Adjusted R-squared:  0.018821 
## F-statistic: 1.7481 on 3 and 114 DF,  p-value: 0.16116
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & no3 & so4 & temp\\
\midrule
LITTLE\_BEAR\_CR & 6 & 3330 & 0.81 & 8.16 & 14.9\\
GREENE\_BR & 33 & 2225 & 2.30 & 9.72 & 20.5\\
NORTH\_BR & 23 & 3836 & 1.32 & 7.36 & 18.5\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -8.5891  -4.8693  -1.8213   1.3920  21.3755  
## 
## Coefficients:
##                 Estimate   Std. Error t value Pr(>|t|)
## (Intercept)  1.784321905  0.929808279  1.9190 0.060816
## acerage      0.000043234  0.000014108  3.0645 0.003539
## no3          0.189429842  0.069452044  2.7275 0.008833
## so4         -0.007419356  0.024795914 -0.2992 0.766040
## temp         0.052331746  0.045263959  1.1561 0.253227
## 
## (Dispersion parameter for quasipoisson family taken to be 48.17801)
## 
##     Null deviance: 2585.44  on 53  degrees of freedom
## Residual deviance: 1777.22  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.328     0.162   0.871
## 2 light           0.474     1.17    0.242
## 3 nematodes       0.134    -1.56    0.119
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 802.3
## 
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -2.25456 -0.57421 -0.06063  0.60011  3.16329 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  240.74  15.516  
##  subject  (Intercept) 4031.02  63.490  
##  Residual              726.87  26.960  
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept) 202.5797    26.8986  7.5312
## attitudepop -21.1346     5.9238 -3.5677
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0050612 0.0067832 0.0000219
## high 0.0050612 1.0000000 0.9087794 0.0591378
## low  0.0067832 0.9087794 1.0000000 0.0463715
## mid  0.0000219 0.0591378 0.0463715 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 15, 8, 14, 5 und 13!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 6, 18, 6, 6 und 11! \textbf{(2 Punkte)}
...
die Sorten 1 bis 4 sowie die Bl{\"o}cke eins bis drei
vorliegen. Sie messen die Outcomes pigs, leaf und P an zwei verschiedenen Messterminen.
...
Die Sonne hat eine aktuelle, angenommene Masse von $19999999999999999166424484824$kg. Wenn
...
\item Gehen Sie von einer Lichtgeschwindigkeit von $270000000m/s$
...
Voyager 1 {\"a}hnliche Sonden mit der Geschwindigkeit von $61198km/h$
...
Milchstra{\ss}e aus. Es gibt $150000000000$ Sterne in der Milchstra{\ss}e. Nehmen
Sie eine Lichtgeschwindigkeit von $290000000m/s$ an.
...
\item Bei einem vermutetet Alter der Erde von $4500000000$ Jahren,
  wie oft war dann eine Sonde einer au{\ss}erirdischen Zivilisation schon zu
  Besuch? Korrigieren Sie Ihre Antwort mit dem Wissen, dass sich die
  Kontinentalplatten einmal alle $80000000$ Jahre vollst{\"a}ndig im
...
\item Die K{\"o}nigspyramide von Meroe soll eine Seitenl{\"a}nge der Grundfl{\"a}che‚
  von 38 K{\"o}nigsellen haben. Wie hoch wird die K{\"o}nigspyramide
  sein? \textbf{(1 Punkt)}
...
zu Verf{\"u}gung. Sie starten an dem Ort B.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCRVGRZ & 1.5 | 3.5 | Klein \\
    B & GCG7FPD & 2.5 | 2.5 | Mikro \\ 
    C & GCBLYFN & 1.0 | 3.0 | Normal \\ 
    D & GCH5HCZ & 3.0 | 4.0 | Mikro \\ 
    E & GCU7VM0 & 4.0 | 5.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
B anpeilen, so liegt der Ort D ungef{\"a}hr $50^\circ$
...
man nicht alles im Jahr 1064 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben jetzt die 230000 Bleikugeln zusammen. Blei hat eine Dichte
von $11.34g/cm^3$.

\begin{enumerate}
  \setcounter{enumi}{3}
\item Wie schwer in Kilogramm $kg$ sind die 230000 produzierten
...
1875 ungef{\"a}hr 26 Kaninchen entlassen hat, Millionen
...
ca. 30\%. Ein Weibchen erreicht nach einem halben Jahr die
Geschlechtsreife.

\begin{enumerate}
\item Wie viele Milliarden Kaninchen w{\"u}rden bei einem ungebremsten
  Wachstum \textit{im elften Jahr} geboren? \textbf{(2 Punkte)}
...
Kaninchenpopulation.
\begin{equation*}
  f(t) = 11000000000 - 1000000000 \cdot 2^{-0.1 \cdot t + 3.4}
\end{equation*}
...
%% --------------------------------------------------------------------
\hfill\href{https://foo}{\includegraphics[width =
...
G{"u}nther und Helmut das Team der drei Kandidaten.
...
schon im vorherigen Semester... In der Kartonagenfabrik erfahren Sie, dass
die Kartons zum Versand von N{\"a}geln hier nicht zusammengebaut werden, die
Endfertigung befindet sich in Flint, Michigan. Unter anderem wird dort der
\textit{Doppelt gewellte, 6-mal-gefaltete, 0.762mm,
  40-cm-Karton} hergestellt. Beim letzten Mal war Rektor
Skinner die Stimmung zu schlecht und deshalb geht es erst nach Hause, wenn
ein paar Aufgaben gel{\"o}st sind. Martin freut das. An dem Vorrat an
Zigaretten von Mrs. Krabappel meinen Sie wenig Zuversicht zu erkennen.\\

Der zu optimierende Karton hat eine L{\"a}nge von 40cm und eine
Breite von 23cm. Die einzustellende Maschine soll jetzt einen
quadratischen Eckenausschnitt der L{\"a}nge $x$ falzen. 

\begin{enumerate}
\item Erstellen Sie eine Skizze des Karton\textit{blattes}! Beschriften Sie
  die Skizze mit den entsprechenden L{\"a}ngenangaben \textbf{(1 Punkt)}
\item Berechnen Sie die Falztiefe $x$ f{\"u}r ein maximales Volumen des
  Kartons! \textbf{(3 Punkte)}
\item Welches Volumen ergibt sich mit der von Ihnen berechneten Falztiefe?
  \textbf{(1 Punkt)}
\item Sie wollen noch einen b{\"u}ndig mit dem Boden abschlie{\ss}enden Deckel f{\"u}r
  den Karton stanzen lassen. Wie gro{\ss} ist die L{\"a}nge und Breite des
  Kartondeckels? \textbf{(2 Punkte)}
\end{enumerate}
...
Sie haben den Vektor $A = \{2, 5, 4\}$ und den Vektor $B = \{6, 9, -3\}$ gegeben.
