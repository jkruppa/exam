...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\square\!\square\!\blacksquare$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\begin{graybox}{Endnote}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 58 Punkten sind aus den Rechen- und
...
\begin{enumerate}
\item [\textbf{A} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Behandlungsbedingungen erklärt wird. Daher werden 22\% der Varianz durch die Behandlungsgruppen erklärt.
...
\item [\textbf{E} \msquare] Es werden 22\% der Varianz durch den Versuch erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der durch Fehler in der Versuchsdurchführung entsteht.
\end{enumerate} 
...
In einer Studie zur Bewertung der Wirkung von Vitamin E auf das Zahnwachstum bei Kanarienvögel entstand folgende Abbildung. Der Versuch wurde an 76 Tieren durchgeführt, wobei jedes Tier eine von  drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Welche Aussage ist im Bezug auf eine zweifaktorielle ANOVA richtig?
...
Wie lautet der Mittelwert und Standardabweichung von $y$ mit 18, 13, 11, 13 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.4 +/- 7.9
\item [\textbf{B} \msquare] Es berechnet sich 13.4 +/- 15.8
\item [\textbf{C} \msquare] Sie erhalten 12.4 +/- 3.97
\item [\textbf{D} \msquare] Es berechnet sich 12.4 +/- 15.8
\item [\textbf{E} \msquare] Sie erhalten 12.4 +/- 1.99
\end{enumerate} 
...
Gegeben ist $y$ mit 18, 21, 10, 17, 22, 34, 30, 14, 17, 14 und 51. Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile.




\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 14
\item [\textbf{B} \msquare] Es berechnet sich 23 [15; 31]
\item [\textbf{C} \msquare] Es ergibt sich 18 [14; 30]
\item [\textbf{D} \msquare] Es berechnet sich 19 [15; 29]
\item [\textbf{E} \msquare] Sie erhalten 18 [12; 28]
\end{enumerate} 
...
In Ihrer Abschlussarbeit zuLauch finden Sie aufeinmal seltsame Daten. Jedenfalls kommt Ihnen das so vor. Daher berechnen Sie den Mittelwert und den Median. Der Mittelwert $\bar{y}$ und der Median $\tilde{y}$ unterscheiden sich nicht. Welche Aussage ist richtig?
...
Bevor Sie in Ihrer Abschlussarbeit einen statistischen Test rechnen, wollen Sie einmal betrachten, welcher Verteilung Ihre $n = 182$ geernteten Pflanzen folgen.  Welche Verteilung ist abgebildet?
...
\item [\textbf{B} \msquare] Wenn ein prädiktives Modell gerechnet werden soll, dann muss zum einen ein Traingsdatensatz sowie ein Testdatensatz definiert werden. Dabei ist der Trainingsdatensatz meist 2/3 und der Testdatensatz 1/3 der Fallzahl groß. Der Testdatensatz dient zur Validierung.
...
In einer Studie wollen Sie den Effektschätzer Odds ratio berechnen. Sie finden in Ihrem Experiment zur Behandlung von Klaueninfektionen bei Schweinen in 4 Tieren Erkrankung der Klauen vor. 12 Tiere sind gesund. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.33, da es sich um ein Anteil handelt.
\item [\textbf{B} \msquare] Das Verhältnis von Chancen Odds ratio ergibt ein Chancenverhältnis von 0.33.
\item [\textbf{C} \msquare] Das Verhältnis der Anteile Odds ratio ergibt ein Anteilsverhältnis von 0.25. Wir sind am Anteil der Kranken interessiert.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.25, da es sich um eine Chancenverhältnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 3, da es sich um ein Anteil handelt.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.42, 0.34 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.105, 0.085 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.105, 0.085 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1.68, 1.36 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate}
...
Die folgende Abbildung enthält die Daten aus einer Studie zur Bewertung der Wirkung des Mikronährstoff Sulfit auf den Ertrag in t/ha von Mais im Vergleich zu einer Kontrolle. Der Versuch wurde in 13 Parzellen pro Gruppe durchgeführt. Welche Aussage im Bezug auf eine statistische Auswertung ist richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Nach Betrachtung des Barplots liegt ein signifikanter Unterschied vor. Der Effekt liegt bei 8.
...
Nach einem Freilandversuch mit drei Genotypen ($AA$, $AB$ und $BB$) als Behandlung
...
Nach einem Freilandversuch mit zwei Substrattypen ($torf$ und $70p30n$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Datentabelle mit dem
gemessenen Trockengewicht (\textit{drymatter}) von Erdbeeren.
...
\begin{center}
$2, 5, 7, 3, 7, 4, 6, 6, 2, 1, 5, 4, 4, 2, 6, 7, 0, 8, 3, 3, 3, 2, 4, 3, 3, 5, 2, 2, 3, 4$
\end{center}
...
\begin{center}
$10.8, 8.6, 10.4, 10.8, 12.6, 9, 9.2, 11.3, 11.1, 9, 11.5, 8.4, 8.2, 9.6, 10.9, 11.1, 8.3, 9.4, 10.7, 8.4, 12, 12.7, 9.7$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ abgelehnt & $\alpha$-Fehler & 5\% & H$_0$ wahr \\
  \end{tabular}
  \end{center}
...
\item Treffen Sie mit $T_{\alpha = 1\%} = 2.65$ und dem berechneten $T_{D}$ eine Aussage
  zur Nullhypothese! Begr{\"u}nden Sie Ihre Antwort! \textbf{(2 Punkte)}
...
In einem Freilandversuch wurde der Ertrag von Erbsen unter drei verschiedenen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 41.83 &  &  &  \strut\\
    \hline
   \textbf{error}  & 20 &  &  &  &  \strut\\
        \hline
   \textbf{total}  & 22 & 116.43 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Faktorstufen \textit{high}, \textit{neg} und
\textit{pos} vorliegen.
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 408.65 &  &  &  \strut\\
    \hline
   \textbf{error}  & 20 & 41.17 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2   1.81 0.90476  0.3016 0.7433
## Residuals 18  54.00 3.00000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 18.24 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 529.1 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 201.57 &  &  &  \strut\\
    \hline
   \textbf{error}  & 40 & 317.87 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 67 H{"u}hnern durchgef{\"u}hrt, wobei
...
## Response: weight
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 108.07   54.04  3.5043   0.05184
## form       1   1.62    1.62  0.1052   0.74941
## dose:form  2 930.69  465.35 30.1785 1.781e-06
## Residuals 18 277.56   15.42
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.4084883 0.0032417 0.9667701
## high 0.4084883 1.0000000 0.0003310 0.4321404
## low  0.0032417 0.0003310 1.0000000 0.0029040
## mid  0.9667701 0.4321404 0.0029040 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 108$ Pflanzen untersucht.
\vspace{5Ex}
...
Experiment mit $n = 118$ Sauen. In dem Experiment wurde gemessen,
...
## -6.5556 -2.0389  0.1222  1.8000  7.4444 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   14.556      1.351  10.777 1.59e-07
## waterB         8.644      2.260   3.825  0.00242
## 
## Residual standard error: 4.052 on 12 degrees of freedom
## Multiple R-squared:  0.5494,	Adjusted R-squared:  0.5118 
## F-statistic: 14.63 on 1 and 12 DF,  p-value: 0.002418
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.5494$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: rainfall, S und variety. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
Erdbeeren in einem Gew{"a}chshausexperiment wollen Sie nun den Versuch eine Nummer gr{\"o}{\ss}er
...
\begin{enumerate}
\item Wenn 6 Blaubeerschalen 9.54 Euro kosten,  wie viel kosten 10 Schalen? \textbf{(1 Punkt)}
...
\item Ein Kilo Strauchtomaten benötigt 180l Wasser. Eine Strauchtomate wiegt 120 - 125g.
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2023 blieben die Erträge von Blaubeeren mit \ensuremath{7.5\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge reduzierte sich um 6.1\%. Die Exporte für Avocados fielen in dem gleichen Zeitraum um 23.8\% auf \ensuremath{2\times 10^{5}}t.
...
\midrule
drinking/eating & 28cm; 24cm; 1.8\% & 42cm; 20cm; 5.2\% & 35cm; 26cm; 3.5\%\\
walking & 35cm; 16cm; 1.2\% & 28cm; 30cm; 8.1\% & 41cm; 31cm; 1.2\%\\
wing/leg stretching & 32cm; 32cm; 5.1\% & 38cm; 31cm; 3.2\% & 38cm; 28cm; 1.2\%\\
dustbathing & 28cm; 16cm; 12.8\% & 34cm; 26cm; 14.2\% & 41cm; 24cm; 18.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
Radius von $5000$m kollabiert, wird die Sonne $20$\%
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCKPX9N & 4.5 | 4.0 | Mikro \\
    B & GCM3PT4 & 4.0 | 3.0 | Klein \\ 
    C & GCXQZZU & 5.0 | 2.0 | Klein \\ 
    D & GCUU8BW & 3.0 | 2.5 | Normal \\ 
    E & GC1OU9Y & 3.5 | 5.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 126 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{9\times 10^{8}} \cdot 2.3^{-0.3 \cdot t + 2.4}
\end{equation*}
