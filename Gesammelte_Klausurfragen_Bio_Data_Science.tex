...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.89, 0.01 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.04 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.2225, 0.0025 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.04 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.36, 3.56, 0.04 und 1.68. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.2225, 0.0025 und 0.105. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 8, 14, 9, 8 und 3.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.4 +/- 3.91
\item [\textbf{B} \msquare] Es ergibt sich 8.4 +/- 1.955
\item [\textbf{C} \msquare] Es ergibt sich 9.4 +/- 1.955
\item [\textbf{D} \msquare] Es ergibt sich 8.4 +/- 15.3
\item [\textbf{E} \msquare] Es ergibt sich 7.4 +/- 7.65
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 12, 15, 34, 13, 25, 23 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 34
\item [\textbf{B} \msquare] Es ergibt sich 25 +/- 13
\item [\textbf{C} \msquare] Es ergibt sich 23 [13, 34]
\item [\textbf{D} \msquare] Es ergibt sich 23 +/- 13
\item [\textbf{E} \msquare] Es ergibt sich 25 [14, 35]
\end{enumerate} 
...
$y = \{19, 18, 18, 18, 19, 15, 17, 15, 17, 22, 15\}$. Berechnen Sie folgende
...
\begin{center}
$11.6, 8.6, 12.5, 10.9, 9.8, 9.4, 13.3, 9.8, 7.9, 11.4, 8.5, 6.8, 9.1, 11.9$
\end{center}
...
## t = -0.92222, df = 16, p-value = 0.3701
...
## t = -3.6598, df = 14, p-value = 0.002574
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.351154 -1.918687
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 90.97 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 114.51 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 76.323  38.161  15.806 7.633e-05
## Residuals 20 48.286   2.414
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 125 120 131 115  93 103 144 135 132 156 132 138
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 3.15 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 618.21 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 164.99 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 524.21 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2   4.06    2.03  0.0785 0.9248563
## form       1 130.15  130.15  5.0305 0.0377313
## dose:form  2 654.98  327.49 12.6576 0.0003696
## Residuals 18 465.72   25.87
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -6.5714 -1.5000  0.2143  1.6786  6.4286 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   18.000      1.742  10.333 1.18e-06
## trtB          -7.429      2.281  -3.257  0.00862
## 
## Residual standard error: 3.895 on 10 degrees of freedom
## Multiple R-squared:  0.5148,	Adjusted R-squared:  0.4663 
## F-statistic: 10.61 on 1 and 10 DF,  p-value: 0.008616
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{Multiple R-squared}!
  Was sagt Ihnen der Wert $0.5148$ aus? \textbf{(2 Punkte)}
...
## t = 5.8356, df = 8, p-value = 0.0003891
...
Einflussvariablen ($x$) wurden erhoben: dry, dosage und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.26 & 0 & 8.78 & 101.75 & 69.50 & 10\\
8.28 & 0 & 12.90 & 104.06 & 70.59 & 8\\
8.86 & 0 & 10.68 & 98.45 & 62.95 & 6\\
9.57 & 1 & 11.94 & 100.07 & 66.75 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.7136 -2.1588 -0.0951  1.8797  5.5669 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.73621    7.61215  -0.359   0.7199
## P           -0.30646    0.16658  -1.840   0.0684
## Fe           0.76998    0.07008  10.986   <2e-16
## water       -0.12778    0.16699  -0.765   0.4457
## 
## Residual standard error: 2.58 on 114 degrees of freedom
## Multiple R-squared:  0.5313,	Adjusted R-squared:  0.519 
## F-statistic: 43.08 on 3 and 114 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
BLUE\_LICK\_RUN & 1 & 2217 & 1.20 & 14.3 & 10.85\\
RED\_RUN & 32 & 3332 & 2.09 & 17.7 & 5.50\\
SENECA\_CR & 23 & 18422 & 1.58 & 20.1 & 8.37\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -7.4533  -3.6999  -0.5534   1.7715  10.1315  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -5.222e-01  8.881e-01  -0.588 0.559271
## acerage      6.288e-05  1.174e-05   5.354 2.27e-06
## no3          2.960e-01  6.024e-02   4.913 1.04e-05
## temp         1.390e-01  3.670e-02   3.787 0.000417
## so4          6.473e-03  1.542e-02   0.420 0.676434
## 
## (Dispersion parameter for quasipoisson family taken to be 20.95029)
## 
##     Null deviance: 1883.06  on 53  degrees of freedom
## Residual deviance:  971.51  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.354   -0.435    0.664
## 2 nematodes       0.134   -0.0702   0.944
## 3 light           0.476    0.554    0.579
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1496 -0.5700 -0.1064  0.5835  3.4533 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  205.4   14.33   
##  subject  (Intercept) 4057.4   63.70   
##  Residual              663.5   25.76   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   203.42      26.86   7.574
## attitudepop   -21.45       5.66  -3.790
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0022207 0.0008838 0.2179777
## high 0.0022207 1.0000000 0.7354184 0.0466689
## low  0.0008838 0.7354184 1.0000000 0.0218642
## mid  0.2179777 0.0466689 0.0218642 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 12, 9, 9, 4 und 6!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 14, 15, 14, 10 und 14! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes Fe, pigs und P an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCIGLZR & 5.0 | 4.5 | Klein \\
    B & GCYRGZI & 2.0 | 3.0 | Normal \\ 
    C & GCZC87V & 4.5 | 5.0 | Klein \\ 
    D & GCAC5KX & 1.5 | 4.0 | Klein \\ 
    E & GCCEH9V & 4.0 | 2.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 991 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{13, 5, 4\}$ und den Vektor $B = \{2, -1, -1\}$ gegeben.
