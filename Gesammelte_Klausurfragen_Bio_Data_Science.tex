...
\begin{graybox}{Checkbox für die Version vom \today}
  ...
  Choice Fragen sowie \textbf{52} Rechen- und
  Textaufgaben.
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.03, 0.02, 0.001 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.006, 0.004, 0.0002 und 0.042. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.068, 0.006, 0.004, 0.0002 und 0.042. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 0.1, 0.005 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
...
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.7, 0.15, 0.1, 0.005 und 1.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Einflussvariablen ($x$) wurden erhoben: variety, height und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: 'C:/Users/jokruppa/lehre/intern/data/snake.txt' does not exist.}}\end{kframe}
\end{knitrout}
...
In einem Stallexperiment mit $n = 84$ Ferkeln wurde der
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: 'C:/Users/jokruppa/lehre/intern/data/longnose.csv' does not exist.}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in sample.int(length(x), size, replace, prob): invalid first argument}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `select()`:\\\#\# ! Can't subset columns that don't exist.\\\#\# x Column `stream` doesn't exist.}}\end{kframe}
\end{knitrout}
...
water & drymatter\\
\midrule
13.1303213 & 29.089550\\
12.1347460 & 27.359975\\
6.9331836 & 22.279004\\
8.7196851 & 21.437965\\
\bottomrule
\end{tabular}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'object' in selecting a method for function 'summary': <text>:1:5: unexpected numeric constant\\\#\# 1: Das 1\\\#\# \ \ \ \ \ \ \ \ \textasciicircum{}}}\end{kframe}
\end{knitrout}
}
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.37      1.94   0.0518
## 2 water           0.130    -1.93   0.0535
## 3 nematodes       0.137     0.146  0.884
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
11.43 & 0 & 10.85 & 100.27 & 69.24 & 13\\
13.24 & 0 & 7.07 & 106.15 & 80.34 & 7\\
9.25 & 1 & 10.54 & 101.94 & 68.95 & 2\\
12.53 & 0 & 12.49 & 96.36 & 63.50 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## -6.33284 -1.41263 -0.11622  1.23939  5.33379 
## 
## Coefficients:
##              Estimate Std. Error t value              Pr(>|t|)    
## (Intercept)  2.337620   6.687295  0.3496                0.7275    
## light        0.063271   0.457512  0.1383                0.8903    
## Fe           0.752945   0.063383 11.8793 < 0.00000000000000022 ***
## P           -0.765186   0.137901 -5.5488          0.0000002991 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.0335 on 88 degrees of freedom
## Multiple R-squared:  0.68653,	Adjusted R-squared:  0.67584 
## F-statistic: 64.242 on 3 and 88 DF,  p-value: < 0.000000000000000222
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.6667 -1.6667  0.5000  1.3333  3.0000 
## 
## Coefficients:
##             Estimate Std. Error t value            Pr(>|t|)    
## (Intercept) 18.66667    0.73598 25.3630 0.00000000000002389 ***
## trtB        -4.66667    1.04083 -4.4836           0.0003761 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.2079 on 16 degrees of freedom
## Multiple R-squared:  0.55682,	Adjusted R-squared:  0.52912 
## F-statistic: 20.103 on 1 and 16 DF,  p-value: 0.00037609
\end{verbatim}
\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: 'C:/Users/jokruppa/lehre/intern/exam/question/data/politeness\_data.csv' does not exist.}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'object' in selecting a method for function 'summary': object 'subject' not found}}\end{kframe}
\end{knitrout}
...
\midrule
A & 15.29 & 15 & 14 & 17 & 15.0 & 15.5 & 0.90\\
B & 19.00 & 19 & 14 & 23 & 16.5 & 22.0 & 12.67\\
C & 11.14 & 10 & 4 & 18 & 9.5 & 13.5 & 19.48\\
D & 14.14 & 15 & 7 & 22 & 11.0 & 16.5 & 25.48\\
\bottomrule
\end{tabular}
\end{table}
...
\item Skizieren Sie in die
  ...
  \item[(d)] Ein Konfidenzintervall mit h{"o}herer Fallzahl $n$ in der Stichprobe als der Rest der Konfidenzintervalle 
...
## t = 2.91999, df = 12, p-value = 0.012841
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  0.65269938 4.49015776
## sample estimates:
...
## 
## data:  drymatter by P
## t = 1.44028, df = 12, p-value = 0.17536
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -1.4699271  7.2032604
## sample estimates:
...
\item Folgende statistische Fachbegriffe bzw. Methoden sind gegeben:
  \begin{itemize}
  \item[] Mann-Whitney-U-Test, Simple Gaussian linear Regression, ANOVA, Kruskal-Wallis-Test, Pearson Korrelation, Spearman Korrelation, t-Test, Paired t-Test und Wilcoxon-Test.
  \end{itemize}
