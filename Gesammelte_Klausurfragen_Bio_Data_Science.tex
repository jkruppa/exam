...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.89, 0.02, 0.21, 0.42 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.18, 1, 0.12, 1, 1 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.1483, 0.0033, 0.035, 0.07 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.1483, 0.0033, 0.035, 0.07 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.18, 5.34, 0.12, 1.26, 2.52 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.18, 1, 0.12, 1, 1 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
$\eta^2 = 0.32$. Welche Aussage ist richtig?
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 14, 6, 6, 7 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.8 +/- 12.7
\item [\textbf{B} \msquare] Es ergibt sich 8.8 +/- 3.56
\item [\textbf{C} \msquare] Es ergibt sich 9.8 +/- 1.78
\item [\textbf{D} \msquare] Es ergibt sich 7.8 +/- 6.35
\item [\textbf{E} \msquare] Es ergibt sich 8.8 +/- 1.78
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 25, 13, 26, 15, 28, 19 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 [15, 28]
\item [\textbf{B} \msquare] Es ergibt sich 25 +/- 28
\item [\textbf{C} \msquare] Es ergibt sich 25 [16, 29]
\item [\textbf{D} \msquare] Es ergibt sich 25 +/- 15
\item [\textbf{E} \msquare] Es ergibt sich 25 +/- 15
\end{enumerate} 
...
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 2.4, da es sich um ein Anteil handelt.
...
$y = \{13, 16, 11, 19, 16, 14, 13, 13, 16, 13, 13\}$. Berechnen Sie folgende
...
\begin{center}
$10.7, 10.7, 6.8, 8.3, 12.5, 7.9, 5.9, 8.9, 12.2, 5.5, 11, 10$
\end{center}
...
## t = 2.1303, df = 16, p-value = 0.04901
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  0.01523923 6.20698299
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 29.73 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 37.75 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 52.286 26.1429  31.673 1.272e-06
## Residuals 18 14.857  0.8254
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 131 128 117  86  78 106 150 142 147 154 142 156
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 25.94 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 60.01 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 76.41 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 984.75 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 313.11 156.556  14.435 0.0001817
## form       1 163.64 163.639  15.088 0.0010867
## dose:form  2 100.36  50.182   4.627 0.0239105
## Residuals 18 195.22  10.846
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##  -1.20  -0.80  -0.20   0.75   1.80 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  18.0000     0.4690  38.376 2.33e-10
## trtB         -3.8000     0.6633  -5.729  0.00044
## 
## Residual standard error: 1.049 on 8 degrees of freedom
## Multiple R-squared:  0.804,	Adjusted R-squared:  0.7795 
## F-statistic: 32.82 on 1 and 8 DF,  p-value: 0.0004396
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 6.9308, df = 8, p-value = 0.0001207
...
Einflussvariablen ($x$) wurden erhoben: P, dry und N. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.60 & 1 & 10.19 & 103.10 & 70.47 & 9\\
9.66 & 1 & 11.10 & 100.75 & 70.01 & 9\\
9.20 & 0 & 9.52 & 106.40 & 73.88 & 11\\
10.14 & 1 & 10.65 & 93.35 & 66.26 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -9.7174 -2.1874 -0.0588  1.9629 10.2236 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 75.10157    3.25672  23.060   <2e-16
## P           -0.41030    0.25438  -1.613    0.110
## water       -0.13160    0.22380  -0.588    0.558
## nematodes    0.05067    0.11307   0.448    0.655
## 
## Residual standard error: 3.266 on 96 degrees of freedom
## Multiple R-squared:  0.03396,	Adjusted R-squared:  0.003768 
## F-statistic: 1.125 on 3 and 96 DF,  p-value: 0.343
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
CONOWINGO\_CR & 112 & 6.95 & 14.94 & 8.5 & 65\\
DEER\_CR & 26 & 5.26 & 6.36 & 9.9 & 60\\
PINEY\_CR & 18 & 4.57 & 17.84 & 9.3 & 100\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -8.1771  -4.2254  -2.0835   0.8494  13.6098  
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 0.502892   1.436879   0.350  0.72785
## no3         0.144865   0.072970   1.985  0.05273
## so4         0.005024   0.020553   0.244  0.80792
## do2         0.189462   0.138924   1.364  0.17887
## maxdepth    0.012280   0.004261   2.882  0.00585
## 
## (Dispersion parameter for quasipoisson family taken to be 36.00009)
## 
##     Null deviance: 1940.3  on 53  degrees of freedom
## Residual deviance: 1469.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.37      0.985   0.325
## 2 light           0.443     1.30    0.193
## 3 water           0.139    -1.02    0.308
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9240 -0.6054 -0.1221  0.6129  3.5185 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  221.7   14.89   
##  subject  (Intercept) 4143.9   64.37   
##  Residual              669.0   25.87   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.758     27.171   7.462
## attitudepop  -19.426      5.683  -3.418
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0011232 0.0000331 0.4988279
## high 0.0011232 1.0000000 0.2223346 0.0067761
## low  0.0000331 0.2223346 1.0000000 0.0002362
## mid  0.4988279 0.0067761 0.0002362 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, 7, 9, 8 und 6!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 6, 11, 7, 7 und 2! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes freshmatter, grade und pigs an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCMJM09 & 5.0 | 5.0 | Klein \\
    B & GCCO5WV & 2.5 | 1.0 | Normal \\ 
    C & GCSRNVB & 2.0 | 3.0 | Klein \\ 
    D & GC5HP11 & 3.0 | 3.5 | Mikro \\ 
    E & GCCNQ7T & 4.0 | 4.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 338 n. Chr. f{\"u}r den neuen Lehnsherren
...
L{\"a}nge von 30cm und eine Breite von 23cm. Die
...
Sie haben den Vektor $A = \{24, -12, 13\}$ und den Vektor $B = \{9, 2, 2\}$ gegeben.
