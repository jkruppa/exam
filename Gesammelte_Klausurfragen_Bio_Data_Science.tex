...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.001, 0.03 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.36, 0.004, 0.12 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 3e-04, 0.0075 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 3e-04, 0.0075 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.004, 0.12 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.004, 0.12 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 4, 1, 5 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 5.8 +/- 4.09
\item [\textbf{B} \msquare] Es ergibt sich 6.8 +/- 2.045
\item [\textbf{C} \msquare] Es ergibt sich 4.8 +/- 8.35
\item [\textbf{D} \msquare] Es ergibt sich 5.8 +/- 16.7
\item [\textbf{E} \msquare] Es ergibt sich 5.8 +/- 2.045
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 14, 21, 22, 27, 33, 21, 14, 26, 7, 32 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 +/- 14
\item [\textbf{B} \msquare] Es ergibt sich 24 [15, 33]
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 14
\item [\textbf{D} \msquare] Es ergibt sich 22 [14, 32]
\item [\textbf{E} \msquare] Es ergibt sich 22 +/- 32
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 3, da es sich um ein Anteil handelt.
...
$y = \{16, 14, 20, 16, 18, 16, 16\}$. Berechnen Sie folgende
...
\begin{center}
$4, 4, 2, 8, 3, 10, 3, 4, 4, 1, 6, 5, 4, 1, 2$
\end{center}
...
\begin{center}
$12.3, 5.4, 10.1, 11.1, 8.5, 10.5, 13.3, 13.4, 8.8, 8.6, 7.4, 12.3$
\end{center}
...
## t = -0.026883, df = 12, p-value = 0.979
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.469784  5.336451
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = -3.0134, df = 14, p-value = 0.009301
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.9669126 -0.6680081
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 121.12 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 47.84 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  26.09 13.0451  5.5977 0.01083
## Residuals 22  51.27  2.3304
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 128 124 122  94  84 113 140 148 147 152 152 159
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 84.28 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 195.27 &  &  &  \strut\\
    \hline
...
## Response: weight
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2  96.05  48.025  2.6990 0.094372
## form       1   6.37   6.365  0.3577 0.557228
## dose:form  2 390.18 195.091 10.9641 0.000769
## Residuals 18 320.28  17.794
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## (Intercept)   17.600      1.386  12.702 2.56e-08
## waterB        -6.600      1.728  -3.819  0.00244
## 
## Residual standard error: 3.098 on 12 degrees of freedom
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.5486$ aus? \textbf{(2 Punkte)}
...
## t = 2.2646, df = 8, p-value = 0.05333
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  -0.00760303  0.90033592
## sample estimates:
##       cor 
## 0.6250153
\end{verbatim}
...
Einflussvariablen ($x$) wurden erhoben: N, variety und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.64 & 0 & 7.72 & 103.99 & 73.30 & 12\\
10.72 & 0 & 10.80 & 99.33 & 66.90 & 12\\
9.79 & 0 & 12.19 & 99.25 & 67.43 & 8\\
8.95 & 1 & 11.39 & 98.82 & 71.74 & 11\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##    Min     1Q Median     3Q    Max 
## -6.390 -2.514 -0.663  2.455 10.805 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 70.02116    2.97717  23.519   <2e-16
## P           -0.16839    0.24986  -0.674    0.502
## nematodes    0.09709    0.10149   0.957    0.341
## light        0.57037    0.84758   0.673    0.503
## 
## Residual standard error: 3.417 on 90 degrees of freedom
## Multiple R-squared:  0.02473,	Adjusted R-squared:  -0.00778 
## F-statistic: 0.7607 on 3 and 90 DF,  p-value: 0.5191
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & so4 & no3 & temp & maxdepth\\
\midrule
LITTLE\_DEER\_CR & 38 & 9.22 & 3.40 & 20.5 & 110\\
BIG\_BR & 72 & 5.65 & 4.10 & 16.7 & 91\\
HOLLANDS\_BR & 38 & 11.44 & 2.34 & 12.0 & 85\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.082  -4.149  -1.820   1.886  16.924  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.656137   1.007904   0.651 0.518093
## so4         -0.003226   0.021558  -0.150 0.881655
## no3          0.286931   0.072024   3.984 0.000225
## temp         0.057066   0.043826   1.302 0.198964
## maxdepth     0.013656   0.004224   3.233 0.002193
## 
## (Dispersion parameter for quasipoisson family taken to be 37.54824)
## 
##     Null deviance: 2381.2  on 53  degrees of freedom
## Residual deviance: 1464.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.54      0.128  0.898 
## 2 water           0.156    -0.190  0.849 
## 3 light           0.466     2.32   0.0202
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1208 -0.6467 -0.0477  0.5749  3.3576 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  250.7   15.83   
##  subject  (Intercept) 4059.1   63.71   
##  Residual              620.6   24.91   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.263     26.965   7.501
## attitudepop  -20.854      5.474  -3.810
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000290 0.0393324 0.0170097
## high 0.0000290 1.0000000 0.0104258 0.0249732
## low  0.0393324 0.0104258 1.0000000 0.7144409
## mid  0.0170097 0.0249732 0.7144409 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, -2, 8, 14 und 13!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 14, 8, 17, 3 und 11! \textbf{(2 Punkte)}
...
die Futterzus{"a}tze eins bis vier sowie die Bl{\"o}cke eins bis drei
vorliegen. Sie messen die Outcomes freshmatter, leaf und pigs an zwei verschiedenen Messterminen.
...
In der folgenden Tabelle 1 sehen Sie die t{\"a}glichen prozentualen Zeiten f{\"u}r
ein spezifisches Verhalten aus vier wissenschaftlichen Ver{\"o}ffentlichungen.
...
\midrule
wingflapping & 3.5 & 12.1 & 8.9 & 3.5\\
standing & 50.1 & 25.4 & 25.4 & 64.1\\
sitting & 8.1 & 3.6 & 6.3 & 3.6\\
preening & 1.2 & 0.8 & 1.2 & 1.0\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCULLVB & 3.5 | 4.5 | Mikro \\
    B & GCZFJTP & 5.0 | 3.0 | Normal \\ 
    C & GCYANAH & 2.0 | 5.0 | Klein \\ 
    D & GCOJS3F & 4.5 | 2.0 | Mikro \\ 
    E & GC6MKJD & 4.0 | 1.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 35 n. Chr. f{\"u}r den neuen Lehnsherren
...
1860 ungef{\"a}hr 24 Kaninchen entlassen hat, Millionen
...
Sie haben den Vektor $A = \{0, 18, 12\}$ und den Vektor $B = \{1, 0, 0\}$ gegeben.
