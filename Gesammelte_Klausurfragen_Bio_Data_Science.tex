...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\square\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\square\!\blacksquare\!\square\!\blacksquare\!\square\!\square\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es werden 19\% der Varianz durch den Versuch erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der durch Fehler in der Versuchsdurchführung entsteht.
...
\item [\textbf{E} \msquare] Es werden 19\% der Varianz durch die Behandlung erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der von den unterschiedlichen Behandlungsbedingungen erklärt wird.
\end{enumerate} 
...
In einer Studie zur Bewertung der Wirkung von Vitamin D auf das Zahnwachstum bei Schweine entstand folgende Abbildung. Der Versuch wurde an 63 Tieren durchgeführt, wobei jedes Tier eine von  drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Welche Aussage ist im Bezug auf eine zweifaktorielle ANOVA richtig?
...
Wie lautet der Mittelwert und Standardabweichung von $y$ mit 12, 11, 8, 13 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es berechnet sich 11 +/- 3.5
\item [\textbf{B} \msquare] Es ergibt sich 12 +/- 0.935
\item [\textbf{C} \msquare] Es berechnet sich 12 +/- 3.5
\item [\textbf{D} \msquare] Es ergibt sich 11 +/- 1.87
\item [\textbf{E} \msquare] Sie erhalten 11 +/- 0.935
\end{enumerate} 
...
Gegeben ist $y$ mit 9, 39, 23, 22, 28, 16, 18, 23, 15, 11 und 51. Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile.




\begin{enumerate}
\item [\textbf{A} \msquare] Sie erhalten 22 +/- 28
\item [\textbf{B} \msquare] Sie erhalten 22 [13; 26]
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 15
\item [\textbf{D} \msquare] Es ergibt sich 23 +/- 15
\item [\textbf{E} \msquare] Es berechnet sich 22 [15; 28]
\end{enumerate} 
...
In dem folgenden Histogramm von $n = 209$ Pflanzen ist welche Verteilung abgebildet?
...
In einer Studie wollen Sie den Effektschätzer Odds ratio berechnen. Sie finden in Ihrem Experiment zur Behandlung von Klaueninfektionen bei Rinder in 4 Tieren Erkrankung der Klauen vor. 12 Tiere sind gesund. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Der Anteil der Gesunden wird berechnet. Da es sich um ein Anteil handelt ergibt sich ein Odds ratio von 0.25.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 3, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.33, da es sich um eine Chancenverhältnis handelt
  
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.33, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.25, da es sich um ein Anteil handelt. Wir berechnen den Anteil der Kranken.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.42, 0.21 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1.68, 0.84 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 0.84 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.105, 0.0525 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 1, 0.84 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 3e-04, 0.105, 0.0525 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es liegt kein signifikanter Unterschied vor. Der Effekt liegt bei 8.
...
\item [\textbf{C} \msquare] Nach Betrachtung des Barplots liegt ein signifikanter Unterschied vor. Der Effekt liegt bei 8.
\item [\textbf{D} \msquare] Die Barplots deuten auf einen signifikanten Unterschied. Der Effekt liegt vermutlich bei 8 unter einer groben Abschätzung. Wir müssen aber eine ANOVA rechnen um den Effekt wirklich bestimmen zu können.
\item [\textbf{E} \msquare] Die Barplots deuten auf keinen signifikanten Unterschied. Der Effekt liegt vermutlich bei 8. Wir müssen aber einen Posthoc-Test rechnen um den Effekt wirklich bestimmen zu können.
\end{enumerate}
...
Mark steht vor einem ersten Problem, denn wenn es nach seiner Betreuer geht, soll er in einem einem Feldexperiment Maiss auswertet. Soweit eigentlich alles passend. Die Behandlung werden verschiedene Lüftungssysteme und Folientunnel ($ctrl$, $storm$ und $tornado$) sein. In seiner Exceldatei wird er den Outcome ($Y$) \textit{Frischegewicht} als \textit{freshmatter} aufnehmen. Vorab soll Mark aber eimal die folgenden Barplots seiner Betreuer nachbauen, damit er den \Rlogo Code schonmal für später vorliegen hat. Damit geht das Problem schon los.
...
Steffen steht vor einem ersten Problem, denn wenn es nach seinem Betreuer geht, soll er in einem einem Gewächshausexperiment Erdbeeren auswertet. Soweit eigentlich alles passend. Die Behandlung waren verschiedene Substrattypen ($torf$, $40p60n$ und $70p30n$). In seiner Exceldatei hat er den Outcome ($Y$) \textit{Trockengewicht} als \textit{drymatter} aufgenommen. Nun soll Steffen die Daten eimal als Barplots in einer Präsentation visualisieren, damit seinem Betreuer wieder klar wird, was er eigentlich nochmal gemacht hat und was für ein Ergbnis in einem statistischen Test zu erwarten wäre.
...
Boxplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Alex nicht gemerkt, welche statistischen Maßzahlen für einen Boxplot erhoben werden müssen. Das ist in soweit doof, da nach seiner Betreuerin erstmal ein Boxplot nachgebaut werden soll, bevor es mit seiner Abschlussarbeit losgeht. Anhand von Boxplots lässt sich eine Aussage über die Normalverteilung von $Y$ treffen. Dann hat er schonmal den \Rlogo Code vorliegen und nachher geht dann alles schneller. Die Behandlung für Erdbeeren werden verschiedene Bewässerungstypen ($low$, $mid$ und $high$) sein. Erfasst wird als Messwert ($Y$) \textit{Trockengewicht}. Alex soll dann \textit{drymatter} in seiner Exceldatei eintragen.
...
Paula betrachtet die folgenden Daten nach einem Freilandversuch mit Lauch. In dem Experiment wurden die Läsionen auf den Blättern gezählt. Nach der Meinung ihrer Betreuerin muss als erstes geschaut werden, wie diese verteilt sind. Also welcher statistischen Verteilung die Läsionen auf den Blättern folgen. Dazu soll Paula ein Histogramm verwenden. Dann hätte man auch einen guten Überblick über den Endpunkt ($Y$).

\begin{center}
Die Läsionen auf den Blättern: 12, 4, 4, 7, 7, 2, 3, 3, 6, 3, 3, 6, 3, 3, 0, 5, 4, 4, 7, 2, 7, 8, 4, 5, 4, 2, 5, 5, 2, 3
\end{center}
...
In ihrer Abschlussarbeit möchte Yuki gerne die Daten aus einem Versuch in einer Klimakammer mit Lauch in einem Histogramm darstellen. Das Histogramm erlaubt ihr dabei Rückschlüsse auf die Verteilung über den Endpunkt ($Y$) zu treffen. In seinem Experiment hat Yuki die mittleren seltsamen Verdickungen gezählt.

\begin{center}
Die mittleren seltsamen Verdickungen: 10.3, 7.4, 11.5, 11.2, 8.6, 12.1, 9.1, 9.7, 14.9, 9.4, 9.6, 12.2, 12.3, 10.5, 5.8, 9.9, 9.1, 8.5, 9.9, 14.9, 7.4, 11, 9.2, 11.6, 9.5
\end{center}
...
Steffen liest laut: 'Wenn zwei kontinuierliche Variablen vorliegen, können diese in einer exploartiven Datenanalyse...'. Steffen stoppt. Was waren noch gleich kontinuierliche Variablen? In seinem Projektbericht hatte er ein Feldexperiment im Teuteburgerwald durchgeführt. Dabei ging es um den Zusammenhang zwischen Frischegewicht [kg/ha] und durchschnittliche UV Einstrahlung [UV/d] im groben Kontext von Lauch. Nun stellt sich die Frage für ihn, ob es überhaupt einen Zusammenhang zwischen den gemessenen Variablen gibt. Dafür war eine explorative Datenanalyse gut!
...
In einen Versuch in einer Klimakammer im Oldenburger Land hatte Nilufar sich zum einen die Behandlung Herbizideinsatz [ja/nein] und zum anderen die Messung Chlorophyllgehalt unter Zielwert [ja/nein] im Kontext von Lauch angeschaut. Nun steht Nilufar vor dem Problem, dass sie zwei kategoriale Variablen in ihrer Abschlussarbeit gemessen hat. Da ihre Betreuerin erstmal die langen Tabellen mit ja/nein in einer explorativen Datenanalyse zusammengefasst und präsentiert bekommen möchte bevor es überhaupt weitergeht, muss sie jetzt eine Lösung finden.
...
\toprule
Herbizideinsatz & Chlorophyllgehalt unter Zielwert\\
\midrule
nein & nein\\
ja & nein\\
ja & nein\\
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ wahr & Testentscheidung & Richtige Entscheidung & 5\% \\
  \end{tabular}
  \end{center}
...
Steffen ist im Oldenburger Land für einen Versuch mit Lauch. Allein diese Tatsache ist für ihn eine Erzählung wert. Für seiner Hausarbeit musste er ein Feldexperiment mit Lauch durchführen und das sollte laut seiner Betreuerin an diesem Nichtort besonders gut gelingen. Ablenkung gibt es jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn seine Behandlung Substrattypen ($torf$ und $70p30n$) und der Messwert Chlorophyllgehalt (SPAD-502Plus) [SPAD] sollen mit einem t-Test ausgewertet werden. Immerhin weiß er, dass sein Messwert einer Normalverteilung folgt. 
...
Nilufar ist im Teuteburgerwald für einen Versuch mit Lauch. Allein diese Tatsache ist für sie eine Erzählung wert. Für ihren Projektbericht musste sie ein Gewächshausexperiment mit Lauch durchführen und das sollte laut ihrem Betreuer an diesem Nichtort besonders gut gelingen. Ablenkung gibt es jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn ihre Behandlung Genotypen ($AA$ und $BB$) und der Messwert Proteingehalt [g/kg] sollen mit einem t-Test ausgewertet werden. Immerhin weiß sie, dass ihr Messwert einer Normalverteilung folgt. 
...
Es gibt ja immer die Möglichkeit sich Hilfe zu holen. Das geht natürlich auch immer in einer Hausarbeit. Deshalb arbeiten Jonas und Yuki gemeinsam an einer Hausarbeit. Das macht dann auch die Analyse ihres Hauptversuches einfacher. Zwar hat jeder von ihnen noch ein Subthema, aber auch da kann man sich ja helfen. In dem Hauptversuch wurde Folgendes von den beiden gemacht. Jonas und Yuki haben sich Lauch angeschaut. Dabei geht um Zusammenhang zwischen Ausgeizen ($ctrl$ und $28d$) und Frischegewicht [kg/ha]. Jetzt sollen beide einen gepaarten t-Test rechnen.
...
'Wir waren in der Uckermark um Lauch in einem Feldexperiment zu messen.', Paula legt das Dokument auf den Tisch und schaut Nilufar und Yuki fragend an. Beide schauen fragend zurück. Die beiden sind zu ihr gekommen, da sie sich nicht mit \Rlogo auskennen und daher Hilfe bei der Interpretation des t-Tests brauchen. Kein Problem. Aber worum es in dem Versuch geht, lässt sich nur aus dem Text in seiner Hand erahnen. Vielleicht hilft da ja die Ausgabe des t-Tests in R weiter.
...
## t = 4.4977, df = 16, p-value = 0.0003653
...
Helfen Sie Paula bei der Interpretation des t-Tests! Sonst geht es auch für Nilufar und Yuki nicht weiter.
...
'Mit dem R Paket \texttt{\{emmeans\}} können wir gleich die Gruppenvergleiche rechnen und uns das \textit{compact letter displac}' ausgeben lassen!', verkündet Mark sichtlich stolz. 'Nach Meinung des Betreuers soll es aber nur erstmal ein t-Test sein. Und die Ausgabe ist schon wirr genug.', merkt Tina an. Jonas und Tina sind bei Mark um sich in \Rlogo helfen zu lassen. Die beiden waren 1 Monate im Teuteburgerwald um einen Versuch mit Lauch in einem Gewächshausexperiment durchzuführen. Ziel war es das Outcome ($Y$) Chlorophyllgehalt (SPAD-502Plus) [SPAD] zu bestimmen.
...
## t = -0.21438, df = 15, p-value = 0.8331
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -12.91826  10.55715
## sample estimates:
...
Helfen Sie Mark bei der Interpretation des t-Tests! Sonst geht es auch für Jonas und Tina nicht weiter.
...
\Rlogo ist schon ein tolles Programm, wenn man mit dem Ding umgehen kann. Super umgehen kann damit Tina. Deshalb sind auch Alex und Jessica bei ihr um sich bei einem gemeinsamen Projekt helfen zu lassen. Beide arbeiten gemeinsam an einer Hausarbeit. In dem zu beschreibenden Versuch geht es im Wendland um einem Feldexperiment mit Lauch. Dabei ging darum herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Genotypen ($AA$ und $BB$) und dem Messwert Proteingehalt [g/kg] gibt. Da der Messwert Proteingehalt [g/kg] normalverteilt ist kann ein t-Test gerechnet werden.
...
## t = 4.9594, df = 15, p-value = 0.0001714
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  13.04450 32.70828
## sample estimates:
...
Helfen Sie Tina bei der Interpretation des t-Tests! Sonst geht es auch für Alex und Jessica nicht weiter.
...
Es gibt ja immer die Möglichkeit sich Hilfe zu holen. Das geht natürlich auch immer in einer Hausarbeit. Deshalb arbeiten Alex und Yuki gemeinsam an einer Hausarbeit. Das macht dann auch die Analyse ihres Hauptversuches einfacher. Zwar hat jeder von ihnen noch ein Subthema, aber auch da kann man sich ja helfen. In dem Hauptversuch wurde Folgendes von den beiden gemacht. Alex und Yuki haben sich Lauch angeschaut. Dabei geht um Zusammenhang zwischen Jäten ($Aussaat$ und $Ernte$) und Frischegewicht [kg/ha]. Jetzt sollen beide einen gepaarten t-Test rechnen. Leider kennen sich beide nicht sehr gut in \Rlogo aus.
...
Jetzt brauchen Alex und Yuki Ihre Hilfe bei der Berechnung eines gepaarten t-Tests in \Rlogo um ihre Arbeit dann in diesem Semester noch abschließen zu können.
...
\toprule
    ...
    \midrule
   \textbf{Düngestufen}  & 3 & 18.98 &  &  &  \strut\\
   \textbf{error}  & 19 & 350.68 &  &  &  \strut\\
...
'Als erstes bauen wir uns aus unsere Daten die ANOVA Tabelle dann sehen wir schon, ob unser Gruppenvergleich in der ANOVA signifikant ist.', Nilufar schaut Yuki fragend an und hofft auf eine positive Regung im Gesicht. Wird aber enttäuscht. Yuki tut sich auch sehr schwer mit der einfaktoriellen ANOVA. Nun möchte erstmal ihre Betreuung der Arbeit eine ANOVA Tabelle sehen. Was immer da auch drin zu erkennen sein mag. Beide waren in der Uckermark um ein Gewächshausexperiment mit Lauch durchzuführen. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Lichtstufen ($none$, $200lm$, $400lm$ und $600lm$) und dem Messwert Frischegewicht [kg/ha] gibt.



\vspace{1ex}

Leider kennen sich Nilufar und Yuki mit Berechnung einer einfaktoriellen ANOVA überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe! 
...
\toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Lichtstufen}  & 3 & 5623.42 &  &  &  \strut\\
   \textbf{Error}  & 27 & 667.42 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
Mark schaut entnervt auf und klappt den Laptop zu. Nun möchte sein Betreuer seinem Projektbericht erstmal eine ANOVA sehen und \textit{dann} die Ergebnisse präsentiert bekommen bevor es überhaupt mit der Abschlussarbeit weitergeht. Dabei war er extra in der Uckermark um einen Versuch in einer Klimakammer mit Lauch durchzuführen. Und dort was es wirklich nicht schön geschweige denn spannend wie bei seinen Kommilitonen, die in Almería waren. Hätte er es vorher gewusst, dann hätte er die Abschlussarbeit bei wem anders geschrieben. Aber gut, jetzt als die ANOVA in \Rlogo.
...
## Lichtstufen  3  21.586  7.1954  0.7213 0.5487
## Residuals   25 249.379  9.9752
\end{verbatim}
\end{kframe}
\end{knitrout}
...
In ein Freilandversuch wurden Lauch mit dem Behandlung Genotypen ($AA$, $AB$ und $BB$) sowie der Behandlung Düngestufen ($ctrl$, und $high$) untersucht. Es wurde als Messwert Trockengewicht [kg/ha] bestimmt. Steffen ahnte schon, dass es komplexer wird, als er mit seiner Hausarbeit angefangen hat. Das es jetzt aber so kompliziert wird, hätte er jetzt aber auch nicht gedacht. Steffen kratzt sich am Kopf. Eventuell muss er dann doch nochmal Hilfe in der statistischen Beratung holen. Jetzt versucht er es aber erstmal selber.
...
\begin{center}
  ...
  \toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Genotypen}  & 3 & 170.74 &  &  &  \strut\\
    \textbf{Düngestufen}  & 1 & 24.2 &  &  &  \strut\\
    \textbf{Genotypen:Düngestufen}  & 3 & 97.01 &  &  &  \strut\\
   \textbf{Error}  & 18 & 179.2 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
##                         Df Sum Sq Mean Sq F value    Pr(>F)
## Düngestufen              2   3.60    1.80  0.1041 0.9017060
## Lichtstufen              1 318.73  318.73 18.4048 0.0004407
## Düngestufen:Lichtstufen  2 218.96  109.48  6.3218 0.0083253
## Residuals               18 311.72   17.32
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Mark und Nilufar untersuchen gemeinsam in ihrer Abschlussarbeit den Messwert Frischegewicht [kg/ha] in Lauch. Es ist einiges schiefgelaufen, wie es immer so passiert. Hauptsächlich waren es Hunde, auch wenn man erstmal bei dem Messwert nicht unbedingt an Hunde denken würde. Aber das ist eine andere Geschichte. Jetzt wollen Mark und Nilufar ihre Ergebnisse nochmal mit einer Studie von Meyer et al. (2021) vergleichen und schauen, ob was ähnliches rauskommt. Angeschaut wurde sich als Behandlung Genotypen ($00$, $AA$, $AB$ und $BB$). Es ergab sich dann die folgende Tabelle der rohen p-Werte für die Vergleiche zu Meyer et al. (2021).
...
Leider kennen sich Mark und Nilufar mit der Adjustierung von $p$-Werten und dem Signifikanzniveau $\alpha$ überhaupt nicht aus. Deshalb brauchen die beiden bei der Erstellung Ihre Hilfe!
...
Jonas sitzt schon etwas länger bei seiner Betreuerin. So langsam macht Jonas sich Gedanken, ob er nicht doch mal anmerken sollte, dass er von CLD noch nie was gehört hat. Aber noch kann gelauscht werden, ein Ende ist erstmal nicht in Sicht! Jonas hatte in seiner Hausarbeit einen Versuch in einer Klimakammer durchgeführt. Deshalb sitzt er hier. Also eigentlich nein, deshalb nicht. Jonas will fertig werden. Hat er sich doch mit Bewässerungstypen ($none$, $ctrl$, $low$, $mid$ und $high$) und Trockengewicht [kg/ha] schon eine Menge angeschaut. Jonas beugt sich leicht nach vorne. Nein, doch keine Pause. Weiter warten auf eine Lücke im Fluss...
...
\midrule
\textbf{ctrl} & 1.0000000 & 0.5883949 & 0.0005786 & 0.000000\\
\textbf{low} & 0.5883949 & 1.0000000 & 0.0001260 & 0.000000\\
\textbf{mid} & 0.0005786 & 0.0001260 & 1.0000000 & 0.000349\\
\textbf{high} & 0.0000000 & 0.0000000 & 0.0003490 & 1.000000\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
'Wir müssen als erstes die Gruppen nach absteigender Effektstärke sortieren!', ruft Paula ganz aufgeregt. 'Das habe ich mir gemerkt.', blinzelt sie Nilufar an. Mark hebt die Augenbraue. Als ob das jetzt so viel weiter helfen würde.
...
\item Interpretieren Sie das \textit{Compact letter display (CLD)} für Paula und Nilufar! \textbf{(1 Punkt)} 
\end{enumerate}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   85  \strut\\
    \hline
...
Leider kennen sich Alex und Nilufar mit der Erstellung einer Datenanalyse für kontinuierliche Daten überhaupt nicht aus. Deshalb brauchen bei der Erstellung Ihre Hilfe!
...
## -5.143 -1.667  1.095  1.976  4.333 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   15.143      1.101  13.750  1.6e-09
## waterB        -2.476      1.468  -1.686    0.114
## 
## Residual standard error: 2.914 on 14 degrees of freedom
## Multiple R-squared:  0.1688,	Adjusted R-squared:  0.1095 
## F-statistic: 2.844 on 1 and 14 DF,  p-value: 0.1139
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.1688$ aus? \textbf{(2 Punkte)}
...
## t = -8.1739, df = 8, p-value = 3.739e-05
...
Einflussvariablen ($x$) wurden erhoben: block, P und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
mit insgesamt 3 Leveln dar. Der zweite Faktor mit dem Block
beinhaltet
4 Level. \\
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2022 blieben die Erträge von Blaubeeren mit \ensuremath{7.7\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge steigerte sich um 6.8\%. Die Exporte für Avocados stiegen in dem gleichen Zeitraum um 23.8\% auf \ensuremath{2\times 10^{5}}t.
...
\item $i$ dem Verhalten: (1) dustbathing, (2) wingflapping, (3)
...
\midrule
dustbathing & 29cm; 24cm; 1.8\% & 26cm; 25cm; 1.8\% & 31cm; 30cm; 2.1\%\\
wingflapping & 29cm; 21cm; 1.2\% & 28cm; 31cm; 8.1\% & 42cm; 25cm; 0.5\%\\
walking & 37cm; 26cm; 0.8\% & 36cm; 30cm; 1.2\% & 39cm; 26cm; 1.2\%\\
drinking/eating & 40cm; 24cm; 18.1\% & 42cm; 20cm; 14.2\% & 26cm; 29cm; 12.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCARYHJ & 5.0 | 4.0 | Mikro \\
    B & GCXUWO5 & 2.0 | 3.0 | Mikro \\ 
    C & GC9TLUI & 2.5 | 1.0 | Klein \\ 
    D & GCJL5DJ & 4.0 | 2.5 | Klein \\ 
    E & GCNFSTL & 3.0 | 2.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 21 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.2\times 10^{10}} - \ensuremath{1.4\times 10^{9}} \cdot 2.1^{-0.3 \cdot t + 3.2}
\end{equation*}
...
5.1\% p.a. {\"u}ber 60 Monate finanzieren.
