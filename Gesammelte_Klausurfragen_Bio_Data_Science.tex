...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.03, 0.21, 0.34, 0.02 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.005, 0.035, 0.0567, 0.0033 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.18, 1, 1, 0.12 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.52, 0.18, 1.26, 2.04, 0.12 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.18, 1, 1, 0.12 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.005, 0.035, 0.0567, 0.0033 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 16, 13, 5, 8 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.6 +/- 2.14
\item [\textbf{B} \msquare] Es ergibt sich 10.6 +/- 18.3
\item [\textbf{C} \msquare] Es ergibt sich 10.6 +/- 4.28
\item [\textbf{D} \msquare] Es ergibt sich 10.6 +/- 2.14
\item [\textbf{E} \msquare] Es ergibt sich 9.6 +/- 9.15
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 13, 20, 21, 22, 34, 17, 19, 10, 30, 6 und 51.
...
\item [\textbf{C} \msquare] Es ergibt sich 20 [13, 30]
\item [\textbf{D} \msquare] Es ergibt sich 20 +/- 30
\item [\textbf{E} \msquare] Es ergibt sich 22 [14, 31]
\end{enumerate} 
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.25, da es sich um eine Chancenverh{"a}ltnis handelt.
...
$y = \{20, 21, 21, 20, 14, 11, 19, 11, 18, 14, 20\}$. Berechnen Sie folgende
...
\begin{center}
$10.4, 11.1, 9.4, 10.2, 14.4, 12.7, 10, 8.6, 8.3, 6.3, 8.3, 10.2$
\end{center}
...
## t = 0.58354, df = 14, p-value = 0.5688
...
## 
## data:  drymatter by Fe
## t = -0.21265, df = 10, p-value = 0.8359
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.591203  3.791203
## sample estimates:
...
## t = -2.4398, df = 10, p-value = 0.03486
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -6.9423753 -0.3147676
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 47.52 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 67.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 110.296  55.148  33.841 1.035e-07
## Residuals 24  39.111   1.630
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 128 135 109 104  82  96 152 159 144 146 142 157
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 309.03 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 144.84 &  &  &  \strut\\
    \hline
...
## Response: weight
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 328.64 164.321 12.6181 0.0003757
## form       1   4.60   4.603  0.3535 0.5595472
## dose:form  2 274.19 137.096 10.5275 0.0009383
## Residuals 18 234.41  13.023
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 92$ Pflanzen untersucht.
\vspace{5Ex}
...
## (Intercept)   16.200      1.836   8.825 2.14e-05
## waterB        11.800      2.596   4.545  0.00189
## 
## Residual standard error: 4.105 on 8 degrees of freedom
## Multiple R-squared:  0.7209,	Adjusted R-squared:  0.686 
## F-statistic: 20.66 on 1 and 8 DF,  p-value: 0.001886
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7209$ aus? \textbf{(2 Punkte)}
...
## t = 2.4684, df = 8, p-value = 0.03881
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  0.04760038 0.91029271
## sample estimates:
##       cor 
## 0.6575205
\end{verbatim}
...
Einflussvariablen ($x$) wurden erhoben: N, fertilizier und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.48 & 0 & 8.73 & 98.18 & 66.61 & 13\\
10.19 & 0 & 10.59 & 100.72 & 70.38 & 11\\
10.57 & 0 & 9.23 & 100.59 & 73.87 & 11\\
13.12 & 0 & 9.94 & 100.49 & 74.27 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.6482 -1.6521 -0.0969  1.6830  4.6608 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.32430    7.70161   0.172  0.86387
## P           -0.46139    0.15686  -2.941  0.00418
## Fe           0.72143    0.07410   9.736 1.26e-15
## nematodes    0.10186    0.07989   1.275  0.20568
## 
## Residual standard error: 2.226 on 88 degrees of freedom
## Multiple R-squared:  0.5497,	Adjusted R-squared:  0.5344 
## F-statistic: 35.81 on 3 and 88 DF,  p-value: 3.199e-15
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & so4 & do2 & acerage\\
\midrule
SOUTH\_BR\_CASSELMAN\_R & 2 & 0.64 & 21.16 & 7.6 & 6311\\
PINEY\_BR & 48 & 4.70 & 5.38 & 8.3 & 4011\\
SAVAGE\_R & 106 & 0.63 & 12.28 & 7.7 & 29708\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.976  -4.498  -1.797   1.078  19.961  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.037e+00  1.269e+00   1.606  0.11475
## no3          2.063e-01  9.862e-02   2.092  0.04163
## so4         -1.688e-02  2.800e-02  -0.603  0.54949
## do2          9.429e-02  1.469e-01   0.642  0.52401
## acerage      4.925e-05  1.503e-05   3.277  0.00193
## 
## (Dispersion parameter for quasipoisson family taken to be 46.8526)
## 
##     Null deviance: 2382.8  on 53  degrees of freedom
## Residual deviance: 1745.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.73    -0.371    0.711
## 2 water           0.166    0.0926   0.926
## 3 nematodes       0.205    1.34     0.179
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1729 -0.6417 -0.0953  0.5844  3.4515 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  212.6   14.58   
##  subject  (Intercept) 4138.0   64.33   
##  Residual              664.6   25.78   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.829     27.127   7.477
## attitudepop  -19.005      5.664  -3.355
## 
...
\begin{verbatim}
##           ctrl      high low       mid
## ctrl 1.0000000 0.0371889   0 0.5210038
## high 0.0371889 1.0000000   0 0.1369978
## low  0.0000000 0.0000000   1 0.0000000
## mid  0.5210038 0.1369978   0 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 2, 9, 5, 6 und 2!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 13, 14, 16 und 13! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes leaf, drymatter und grade an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCUHJZF & 3.0 | 2.0 | Mikro \\
    B & GCSG0CH & 4.0 | 1.0 | Klein \\ 
    C & GCPDW3A & 2.5 | 4.5 | Normal \\ 
    D & GCRUSSS & 1.0 | 1.5 | Klein \\ 
    E & GCJELKX & 3.5 | 4.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 976 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{3, 7, 4\}$ und den Vektor $B = \{8, -2, -7\}$ gegeben.
