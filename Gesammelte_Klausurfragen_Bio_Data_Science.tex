...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.42, 0.001 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0525, 0.105, 3e-04 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 1, 0.004 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 1, 0.004 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 1.68, 0.004 und 1.36. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0525, 0.105, 3e-04 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 5, 6, 15, 8 und 6.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9 +/- 2.03
\item [\textbf{B} \msquare] Es ergibt sich 7 +/- 8.25
\item [\textbf{C} \msquare] Es ergibt sich 8 +/- 4.06
\item [\textbf{D} \msquare] Es ergibt sich 8 +/- 16.5
\item [\textbf{E} \msquare] Es ergibt sich 8 +/- 2.03
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 18, 24, 30, 13, 23, 29, 2, 31, 26, 12 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 [13, 30]
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 13
\item [\textbf{C} \msquare] Es ergibt sich 24 [13, 30]
\item [\textbf{D} \msquare] Es ergibt sich 24 +/- 13
\item [\textbf{E} \msquare] Es ergibt sich 24 +/- 30
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.04 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.04 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung einer anderen Verteilungsfamilie wie die Quasipossion Verteilung.
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.04 liegt keine Overdispersion vor.
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.29 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.71, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.71, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.42, da es sich um eine Chancenverh{"a}ltnis handelt.
...
In einem Stallexperiment mit $n = 81$ Ferkeln wurden verschiedene
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -3.54
\item [\textbf{B} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 12.54
...
\item [\textbf{D} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 12.54
...
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 17
...
$y = \{16, 19, 17, 16, 21, 19, 15\}$. Berechnen Sie folgende
...
\begin{center}
$9.8, 9.9, 6.5, 11.2, 8.8, 9.1, 10.7, 9.1, 11.4, 8.4, 9.8, 13.1$
\end{center}
...
## t = -3.0971, df = 12, p-value = 0.009239
...
## t = 0.64865, df = 12, p-value = 0.5288
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.380992  8.095278
## sample estimates:
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 118 122 105 100  95 105 153 133 148 164 150 131
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.9 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.58 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  4.352 2.17601  5.1694 0.01257 *
## Residuals 27 11.366 0.42094                  
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 204.7 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2414.91 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 105.52 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 720.52 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 72 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: len
##           Df  Sum Sq Mean Sq  F value    Pr(>F)    
## supp       1  313.72  313.72  27.9258 1.524e-06 ***
## dose       2 2417.60 1208.80 107.6003 < 2.2e-16 ***
## supp:dose  2  125.18   62.59   5.5715   0.00581 ** 
## Residuals 66  741.46   11.23                       
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
Experiment mit $n = 128$ Sauen. In dem Experiment wurde gemessen,
...
## -7.6667 -0.7500  0.2222  1.0000  4.3333 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  14.6667     0.9844  14.898 8.46e-11 ***
## trtB         13.1111     1.3922   9.417 6.29e-08 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.953 on 16 degrees of freedom
## Multiple R-squared:  0.8472,	Adjusted R-squared:  0.8376 
## F-statistic: 88.69 on 1 and 16 DF,  p-value: 6.29e-08
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: block, dry und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.45 & 0 & 11.42 & 99.97 & 67.96 & 6\\
6.78 & 1 & 10.95 & 94.77 & 66.68 & 12\\
9.29 & 1 & 9.14 & 97.60 & 69.70 & 9\\
10.58 & 0 & 10.40 & 94.94 & 68.78 & 13\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.9608 -1.5669  0.0703  1.5390  4.5916 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -2.94969    7.04688  -0.419  0.67645    
## Fe           0.72813    0.06846  10.635  < 2e-16 ***
## light        1.33866    0.48810   2.743  0.00726 ** 
## water       -0.02534    0.17065  -0.148  0.88227    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.156 on 97 degrees of freedom
## Multiple R-squared:  0.5659,	Adjusted R-squared:  0.5525 
## F-statistic: 42.15 on 3 and 97 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
DEER\_CR & 26 & 19.1 & 6.36 & 60 & 8297\\
SECOND\_MINE\_BR & 62 & 17.7 & 10.75 & 60 & 2511\\
HAWLINGS\_R & 1 & 20.5 & 4.64 & 73 & 1172\\
DORSEY\_RUN & 8 & 22.6 & 20.24 & 160 & 7814\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.585  -4.036  -2.065   1.956  18.200  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)   
## (Intercept)  1.723e+00  1.001e+00   1.721  0.09155 . 
## temp         6.627e-02  4.402e-02   1.505  0.13863   
## so4         -2.714e-02  2.674e-02  -1.015  0.31505   
## maxdepth     7.912e-03  4.282e-03   1.848  0.07065 . 
## acerage      4.245e-05  1.429e-05   2.970  0.00461 **
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 39.71579)
## 
##     Null deviance: 2200.2  on 53  degrees of freedom
## Residual deviance: 1651.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.363     0.586 0.558  
## 2 light           0.491     2.59  0.00949
## 3 nematodes       0.143    -0.571 0.568
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0377 -0.6162 -0.1383  0.5791  3.7954 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  215.1   14.67   
##  subject  (Intercept) 4074.9   63.83   
##  Residual              672.5   25.93   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.889     26.942   7.493
## attitudepop  -19.520      5.698  -3.426
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0096320 0.0001620 0.0000013
## high 0.0096320 1.0000000 0.1387020 0.0032413
## low  0.0001620 0.1387020 1.0000000 0.1058744
## mid  0.0000013 0.0032413 0.1058744 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 18, 24, 30, 13, 23, 29, 2, 31, 26, 12 und 42!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 18, 24, 30, 13, 23, 29, 2, 31, 26, 12 und 42! \textbf{(2 Punkte)}
