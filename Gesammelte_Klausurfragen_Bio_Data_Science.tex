...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.89, 0.03, 0.001 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 4.45, 0.15, 0.005 und 1.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.178, 0.006, 2e-04 und 0.042. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 1, 0.15, 0.005 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.004, 0.178, 0.006, 2e-04 und 0.042. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1, 1, 0.15, 0.005 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 3, 11, 13, 8 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.6 +/- 14.3
\item [\textbf{B} \msquare] Es ergibt sich 7.6 +/- 7.15
\item [\textbf{C} \msquare] Es ergibt sich 8.6 +/- 1.89
\item [\textbf{D} \msquare] Es ergibt sich 9.6 +/- 1.89
\item [\textbf{E} \msquare] Es ergibt sich 8.6 +/- 3.78
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 22, 24, 30, 24, 31, 20 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 +/- 31
\item [\textbf{B} \msquare] Es ergibt sich 29 +/- 22
\item [\textbf{C} \msquare] Es ergibt sich 24 +/- 22
\item [\textbf{D} \msquare] Es ergibt sich 24 [22, 31]
\item [\textbf{E} \msquare] Es ergibt sich 29 [23, 32]
\end{enumerate} 
...
$y = \{20, 19, 21, 16, 19, 17, 19, 19, 22, 21, 21\}$. Berechnen Sie folgende
...
\begin{center}
$12.7, 11.7, 10.1, 7.5, 10.8, 11.3, 10.7, 10.3, 9.2, 11.4, 11, 8, 6.2, 7.9$
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 2.48 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 53.43 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 48.456 24.2279  17.203 3.178e-05
## Residuals 22 30.984  1.4084
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 116 111 125 101 111  76 131 137 141 144 130 144
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 3.92 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 159.28 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 487.86 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 837.88 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 136.16  68.078  4.5681 0.0248613
## form       1  45.05  45.054  3.0232 0.0991574
## dose:form  2 369.30 184.648 12.3899 0.0004133
## Residuals 18 268.25  14.903
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.2857 -1.8571 -0.5714  2.0357  6.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.286      1.255  15.368 2.94e-09
## trtB          -5.429      1.775  -3.059  0.00992
## 
## Residual standard error: 3.32 on 12 degrees of freedom
## Multiple R-squared:  0.4381,	Adjusted R-squared:  0.3913 
## F-statistic: 9.356 on 1 and 12 DF,  p-value: 0.009921
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -5.9856, df = 8, p-value = 0.0003286
...
Einflussvariablen ($x$) wurden erhoben: region, S und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.37 & 0 & 10.24 & 101.47 & 67.02 & 9\\
9.03 & 0 & 9.49 & 107.46 & 73.88 & 6\\
9.21 & 1 & 9.87 & 99.08 & 73.75 & 9\\
11.96 & 0 & 9.45 & 96.43 & 67.37 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.2609 -1.4474  0.0588  1.5236  4.8884 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -6.09293    7.87315  -0.774    0.441
## P           -0.18436    0.16884  -1.092    0.278
## Fe           0.78288    0.07652  10.231   <2e-16
## nematodes   -0.06165    0.08095  -0.762    0.448
## 
## Residual standard error: 2.128 on 84 degrees of freedom
## Multiple R-squared:  0.5603,	Adjusted R-squared:  0.5446 
## F-statistic: 35.67 on 3 and 84 DF,  p-value: 5.758e-15
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & maxdepth & temp & do2 & acerage\\
\midrule
WATTS\_BR & 19 & 82 & 26.5 & 6.7 & 510\\
SOUTH\_BR\_CASSELMAN\_R & 2 & 46 & 18.5 & 7.6 & 6311\\
LIBERTY\_RES & 12 & 62 & 20.2 & 8.3 & 424\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -10.159   -3.790   -1.585    1.550   18.273  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.245e+00  1.903e+00  -1.180  0.24371
## maxdepth     1.353e-02  4.331e-03   3.123  0.00300
## temp         9.443e-02  4.411e-02   2.141  0.03728
## do2          2.884e-01  1.356e-01   2.127  0.03844
## acerage      4.344e-05  1.335e-05   3.254  0.00207
## 
## (Dispersion parameter for quasipoisson family taken to be 36.43379)
## 
##     Null deviance: 2336.6  on 53  degrees of freedom
## Residual deviance: 1466.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.420     0.125  0.901 
## 2 nematodes       0.143    -0.153  0.878 
## 3 light           0.488     1.86   0.0632
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3681 -0.5781 -0.1561  0.5761  3.2642 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  218.0   14.76   
##  subject  (Intercept) 4034.9   63.52   
##  Residual              720.4   26.84   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.956     26.847   7.522
## attitudepop  -18.968      5.897  -3.216
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000059 0.0000037 0.0368433
## high 0.0000059 1.0000000 0.8688703 0.0028093
## low  0.0000037 0.8688703 1.0000000 0.0018058
## mid  0.0368433 0.0028093 0.0018058 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 5, 11, 11, 3 und 6!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 13, 10, 11, 12 und 11! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes leaf, freshmatter und pigs an vier verschiedenen Messterminen.
...
\item Die K{\"o}nigspyramide von Meroe soll eine Seitenl{\"a}nge der Grundfl{\"a}che‚
  von 32 K{\"o}nigsellen haben. Wie hoch wird die K{\"o}nigspyramide
  sein? \textbf{(1 Punkt)}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCETCUK & 2.0 | 2.5 | Mikro \\
    B & GCP83PG & 3.5 | 4.5 | Klein \\ 
    C & GCZJT7P & 4.5 | 3.0 | Mikro \\ 
    D & GCQL4Y4 & 3.0 | 5.0 | Klein \\ 
    E & GCD5UEX & 2.5 | 1.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 377 n. Chr. f{\"u}r den neuen Lehnsherren
...
\item Wie viele Millionen Kaninchen leben nach der S{\"a}ttigungsfunktion
  nach 30 Jahren auf dem australischen Kontinent? \textbf{(1
    Punkt)}
\end{enumerate}
...
\paragraph{Der Preis ist hei{\ss}!}
...
Sie haben den Vektor $A = \{10, 8, 3\}$ und den Vektor $B = \{4, 4, 3\}$ gegeben.
