...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\blacksquare\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\item [\textbf{E} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Behandlungsbedingungen erklärt wird. Daher werden 22\% der Varianz erklärt.
\end{enumerate} 
...
wurde an 58 Schweinen durchgef{\"u}hrt, wobei jedes Tier eine von
...
\item [\textbf{C} \msquare] Eine leichte Interaktion ist zu erwarten. Die Geraden schneiden sich noch nicht, aber die Abst{"a}nde unterscheiden sich stark.
\item [\textbf{D} \msquare] Keine Interaktion ist zu erwarten. Die Geraden der Verabreichungsmethode laufen parallel und mit {"a}hnlichen Abst{"a}nden.
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 18, 11, 7, 0 und 6.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.4 +/- 6.66
\item [\textbf{B} \msquare] Es ergibt sich 8.4 +/- 3.33
\item [\textbf{C} \msquare] Es ergibt sich 7.4 +/- 22.15
\item [\textbf{D} \msquare] Es ergibt sich 8.4 +/- 44.3
\item [\textbf{E} \msquare] Es ergibt sich 9.4 +/- 3.33
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 22, 16, 28, 23, 25, 13 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 [16, 28]
\item [\textbf{B} \msquare] Es ergibt sich 27 [17, 29]
\item [\textbf{C} \msquare] Es ergibt sich 23 +/- 28
\item [\textbf{D} \msquare] Es ergibt sich 23 +/- 16
\item [\textbf{E} \msquare] Es ergibt sich 27 +/- 16
\end{enumerate} 
...
Um die Standardabweichung zu berechnen m{"u}ssen wir folgende Rechenoperationen durchf{"u}hren.
...
\item [\textbf{B} \msquare] Den Mittelwert berechen, dann die quadratischen Abst{"a}nde zum Mittelwert aufsummieren und durch die Fallzahl teilen, dann die Wurzel ziehen.
\item [\textbf{C} \msquare] Den Mittelwert berechnen und die Abst{"a}nde quadrieren. Die Summe mit der Fallzahl multiplizieren.
\item [\textbf{D} \msquare] Den Median berechen, dann die quadratischen Abst{"a}nde zum Median aufsummieren, dann die Wurzel ziehen.
\item [\textbf{E} \msquare] Den Mittelwert berechen, dann die absoluten Abst{"a}nde zum Mittelwert aufsummieren
\end{enumerate} 
...
In dem folgenden Histogramm von $n = 216$ Pflanzen ist welche
...
\item [\textbf{B} \msquare] Der Korrelationskoeffizienten nach Kendall wird genutzt, wenn das Outcome Y normalverteilt ist. Der Korrelationskoeffizienten liegt zwischen 0 und 1.
...
\begin{enumerate}
\item [\textbf{A} \msquare] Randomisierung erlaubt erst die Varianzen zu sch{"a}tzen. Ohne eine Randomisierung ist die Berechnung von Mittelwerten und Varianzen nicht m{"o}glich. Dadurch lässt sich erst ein Experiment auswerten.
...
\item [\textbf{C} \msquare] Randomisierung erlaubt erst die Mittelwerte zu sch{"a}tzen. Ohne Randomisierung keine Mittelwerte. Ohne Mittelwerte keine Varianz und somit auch kein statistischer Test.
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.36, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.57, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 1.75, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.57, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.36, da es sich um ein Anteil handelt.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.21, 0.34, 0.001 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.042, 0.068, 2e-04 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 1, 1, 0.005 und 0.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 1.05, 1.7, 0.005 und 0.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.042, 0.068, 2e-04 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 1, 1, 0.005 und 0.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate}
...
Sie rechnen einen PostHoc-Test. Nun sollen Sie ein \textit{CLD} erstellen. Was bedeutet dieser Fachbegriff und welche folgende Beschreibung der Interpretation ist korekt?
...
\item [\textbf{E} \msquare] Beim multiplen Testen kann es zu Varianzheterogenit{"a}t kommen. Das globale Signifikanzniveau liegt nicht mehr bei $5\%$. Daher müssen die p-Werte entsprechend adjustiert werden. Das Verfahren nach Welch, bekannt aus dem t-Test, ist hier h{"a}ufig anzuwenden.
\end{enumerate}
...
\item [\textbf{B} \msquare] Beim multiplen Testen kann es zu einer Effekt{"u}bersch{"a}tzung ($\Delta$-Inflation) kommen. Daher m{"u}ssen die Effekte angepasst werden. Dies geschieht nicht h{"a}ndisch sondern intern in den angewendeten Algorithmen.
...
\item [\textbf{B} \msquare] Nein, wir erhalten eine Aussage. M{"u}ssen aber das Individuum im Kontext der Population adjustieren.
...
Welche Aussage {\"u}ber die Entscheidung anhand der berechneten Teststatistik gegen die
Nullhypothese ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Anhand der berechneten Teststatistik l{"a}sst sich wie folgt eine Entscheidung treffen. Liegt der Wert in dem Signifikanzniveauintervall $\alpha$ dann kann die Nullhypothese abgelehnt werden.
...
\item [\textbf{D} \msquare] Anhand der berechneten Teststatistik l{"a}sst sich wie folgt eine Entscheidung treffen. Liegt der Wert {"u}ber oder gleich dem Signifikanzniveau $\alpha$ dann kann die Nullhypothese abgelehnt werden.
...
\item [\textbf{C} \msquare] Die Hypothesen $H_0$ und $H_A$ sind rein prosarischer Natur und bilden keinen mathematischen Hintergrund ab. In der Statistik wird die wissenschaftliche Fragestellung getestet. Daher stehen auch die verst{"a}ndlichen Hypothesen im Mittelpunkt der biologischen Interpretation.
...
In einer Klimakammer mit drei Bew{"a}sserungstypen ($low$, $mid$ und $high$) als Behandlung
...
Nach einem Gew{"a}chshausexperiment mit zwei Substrattypen ($torf$ und $70p30n$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Datentabelle mit dem
...
\begin{center}
$5, 5, 1, 4, 3, 4, 4, 4, 8, 3, 3, 1, 2, 7, 3, 5, 3, 3, 4, 5, 4, 2, 2, 3, 4, 2, 4, 4, 3, 1, 2, 3, 3$
\end{center}
...
\begin{center}
$8.6, 11.9, 6.6, 12.4, 9.7, 10.2, 13.4, 6.9, 11.2, 10.1, 12.5, 9.3, 10.8, 11.6, 10.9, 8, 9, 9, 8.1, 6.3, 13.5, 9.4, 10.3$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  5\% & 20\% & Richtige Entscheidung & H$_0$ abgelehnt \\
  \end{tabular}
  \end{center}
...
Trockengewicht (\textit{drymatter}) von Kartoffeln in $g/m^2$.
...
\item Treffen Sie mit $T_{\alpha = 5\%} = 1.77$ und dem berechneten $T_{D}$ eine Aussage
  zur Nullhypothese! Begr{\"u}nden Sie Ihre Antwort! \textbf{(2 Punkte)}
...
## t = -0.27937, df = 12, p-value = 0.7847
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -5.027979  3.885122
## sample estimates:
...
In einem Experiment in einer Klimakammer wurde der Ertrag von Erdbeeren unter drei verschiedenen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{group}  & 2 &  &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 & 33.27 &  &  &  \strut\\
        \hline
   \textbf{total}  & 24 & 138.24 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Faktorstufen \textit{mid}, \textit{neg} und
\textit{high} vorliegen.
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 193.41 &  &  &  \strut\\
    \hline
   \textbf{error}  & 24 & 240.89 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 116.709  58.355  27.456 1.84e-06
## Residuals 20  42.508   2.125
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{supp}  & 1 & 6.49 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 180.47 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 235.33 &  &  &  \strut\\
    \hline
   \textbf{error}  & 40 & 349.99 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2 218.94 109.468  3.2402 0.06282
## form       1   4.21   4.214  0.1247 0.72806
## dose:form  2 138.52  69.261  2.0501 0.15772
## Residuals 18 608.12  33.784
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0046719 0.0004603 0.6543143
## high 0.0046719 1.0000000 0.0000001 0.0143487
## low  0.0004603 0.0000001 1.0000000 0.0001282
## mid  0.6543143 0.0143487 0.0001282 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -11.5714  -1.8056  -0.0556   1.6905  13.4286 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.556      1.773   9.339 2.16e-07
## waterB         8.016      2.680   2.991  0.00972
## 
## Residual standard error: 5.318 on 14 degrees of freedom
## Multiple R-squared:  0.3899,	Adjusted R-squared:  0.3463 
## F-statistic: 8.946 on 1 and 14 DF,  p-value: 0.009724
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.3899$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: block, region und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\begin{enumerate}
\item Wenn 7 Blaubeerschalen 13.93 Euro kosten,  wie viel kosten 8 Schalen? \textbf{(1 Punkt)}
...
\midrule
standing & 31cm; 34cm; 12.1\% & 46cm; 33cm; 3.5\% & 29cm; 22cm; 3.5\%\\
wingflapping & 29cm; 36cm; 25.4\% & 27cm; 27cm; 50.1\% & 34cm; 26cm; 24.1\%\\
sitting & 38cm; 23cm; 2.1\% & 32cm; 19cm; 2.1\% & 42cm; 33cm; 1.8\%\\
walking & 36cm; 20cm; 1\% & 36cm; 22cm; 0.8\% & 36cm; 24cm; 0.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCRANET & 3.5 | 1.0 | Mikro \\
    B & GCWLYEJ & 1.0 | 4.0 | Normal \\ 
    C & GCMFFVC & 5.0 | 5.0 | Klein \\ 
    D & GCRJJ1U & 4.0 | 1.5 | Klein \\ 
    E & GCB97GT & 4.5 | 4.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 836 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.1\times 10^{10}} - \ensuremath{10^{9}} \cdot 1.7^{-0.1 \cdot t + 3.1}
\end{equation*}
...
G{"u}nther und Annegret das Team der drei Kandidaten.
