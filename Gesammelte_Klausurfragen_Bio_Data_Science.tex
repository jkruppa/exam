...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.01, 0.02 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 0.04, 0.08 und 1.36. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 0.04, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0525, 0.0025, 0.005 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 0.04, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0525, 0.0025, 0.005 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
$\eta^2 = 0.36$. Welche Aussage ist richtig?
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 7, 7, 9 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 7.2 +/- 0.85
\item [\textbf{B} \msquare] Es ergibt sich 8.2 +/- 0.65
\item [\textbf{C} \msquare] Es ergibt sich 8.2 +/- 1.7
\item [\textbf{D} \msquare] Es ergibt sich 8.2 +/- 1.3
\item [\textbf{E} \msquare] Es ergibt sich 9.2 +/- 0.65
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 17, 16, 15, 12, 20, 33, 14, 24, 21, 20 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 20 +/- 24
\item [\textbf{B} \msquare] Es ergibt sich 20 [15, 24]
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 15
\item [\textbf{D} \msquare] Es ergibt sich 20 +/- 15
\item [\textbf{E} \msquare] Es ergibt sich 21 [16, 25]
\end{enumerate} 
...
$y = \{19, 17, 18, 17, 23, 20, 17, 16, 18, 20, 19\}$. Berechnen Sie folgende
...
\begin{center}
$12.7, 8.4, 7.8, 10, 7.1, 12.4, 8.6, 11.1, 11.6, 9.7, 10.5, 10.2$
\end{center}
...
## t = 2.1643, df = 10, p-value = 0.0557
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.04802582  3.30516868
## sample estimates:
...
## 
## data:  freshmatter by N
## t = -0.78323, df = 10, p-value = 0.4516
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.360046  3.531475
## sample estimates:
...
## t = -3.8247, df = 8, p-value = 0.005056
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 92.18 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 108.86 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 102.223  51.112  11.482 0.0003848
## Residuals 22  97.937   4.452
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 54.4 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 217.91 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 214.97 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 384.45 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2  53.318  26.659  2.5322 0.107389
## form       1 142.326 142.326 13.5190 0.001725
## dose:form  2 183.045  91.523  8.6934 0.002280
## Residuals 18 189.502  10.528
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.5714 -2.1429 -0.0714  1.4286  7.8571 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.571      1.339  12.377 3.42e-08
## waterB         6.571      1.893   3.471  0.00463
## 
## Residual standard error: 3.542 on 12 degrees of freedom
## Multiple R-squared:  0.5009,	Adjusted R-squared:  0.4594 
## F-statistic: 12.05 on 1 and 12 DF,  p-value: 0.004625
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.5009$ aus? \textbf{(2 Punkte)}
...
## t = 0.037067, df = 8, p-value = 0.9713
...
Einflussvariablen ($x$) wurden erhoben: S, dosage und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.05 & 1 & 10.05 & 99.03 & 71.44 & 6\\
9.69 & 1 & 11.01 & 106.00 & 75.22 & 10\\
8.22 & 0 & 9.86 & 97.08 & 66.73 & 11\\
10.81 & 0 & 10.91 & 104.94 & 73.16 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##    Min     1Q Median     3Q    Max 
## -8.198 -2.339  0.024  2.461  7.736 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 70.88753    3.60599  19.658   <2e-16
## P           -0.11562    0.23245  -0.497   0.6201
## water        0.02007    0.25217   0.080   0.9367
## light        1.43721    0.83603   1.719   0.0889
## 
## Residual standard error: 3.27 on 94 degrees of freedom
## Multiple R-squared:  0.03375,	Adjusted R-squared:  0.002913 
## F-statistic: 1.094 on 3 and 94 DF,  p-value: 0.3555
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & maxdepth & no3 & temp & acerage\\
\midrule
MAINSTEM\_PATUXENT\_R & 239 & 150 & 3.31 & 18.1 & 8636\\
BASIN\_RUN & 13 & 80 & 2.28 & 15.3 & 2528\\
GREAT\_SENECA\_CR & 87 & 78 & 3.37 & 21.3 & 8624\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.599  -3.774  -1.194   2.247  12.324  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.930e-02  1.013e+00   0.019 0.984878
## maxdepth    1.259e-02  3.762e-03   3.345 0.001583
## no3         2.932e-01  7.247e-02   4.045 0.000185
## temp        6.544e-02  4.175e-02   1.567 0.123437
## acerage     5.757e-05  1.458e-05   3.949 0.000251
## 
## (Dispersion parameter for quasipoisson family taken to be 28.55485)
## 
##     Null deviance: 2436.2  on 53  degrees of freedom
## Residual deviance: 1325.6  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.331     1.10   0.272 
## 2 nematodes       0.126    -1.75   0.0803
## 3 light           0.507     0.813  0.416
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2907 -0.5909 -0.0196  0.4958  3.5291 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  226.2   15.04   
##  subject  (Intercept) 3991.7   63.18   
##  Residual              691.2   26.29   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.023     26.722   7.560
## attitudepop  -19.839      5.777  -3.434
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0003810 0.2176601 0.0000031
## high 0.0003810 1.0000000 0.0106572 0.1049350
## low  0.2176601 0.0106572 1.0000000 0.0001187
## mid  0.0000031 0.1049350 0.0001187 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 5, 10, 11, 11 und 14!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 15, 11, 13, 12 und 8! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes freshmatter, drymatter und Fe an zwei verschiedenen Messterminen.
...
\midrule
dustbathing & 30cm; 27cm; 2.1\% & 31cm; 31cm; 5.2\% & 29cm; 20cm; 4.1\%\\
walking & 35cm; 17cm; 8.1\% & 28cm; 21cm; 1.2\% & 36cm; 31cm; 1.2\%\\
preening & 26cm; 29cm; 6.3\% & 23cm; 31cm; 3.6\% & 38cm; 26cm; 8.1\%\\
drinking/eating & 30cm; 25cm; 18.1\% & 29cm; 30cm; 14.2\% & 39cm; 20cm; 12.8\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCJMINP & 5.0 | 4.5 | Mikro \\
    B & GCAZ7VW & 4.0 | 4.0 | Klein \\ 
    C & GCZAFPW & 1.5 | 3.0 | Klein \\ 
    D & GC4XQ1T & 4.5 | 1.5 | Klein \\ 
    E & GCLBSNJ & 3.5 | 1.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 62 n. Chr. f{\"u}r den neuen Lehnsherren
...
f{\"u}r die erste Stufe betr{\"a}gt 30\%. F{\"u}r die zweite, dritte und vierte
Stufe betragen die indirekten Provisionen jeweils 3\%, 
2\% und 1.5\%. Im Schnitt wirbt jeder Ihrer
angeworbenen "`Partner"' wiederum vier Partner f{\"u}r sich selbst
an. Sie wollen 1500EUR im Monat \textit{passiv} erwirtschaften.  

\begin{enumerate}
  \setcounter{enumi}{4}
\item F{\"u}llen Sie die folgende Tabelle mit den obigen Informationen aus! \textbf{(2 Punkte)}
\end{enumerate}
...
\begin{enumerate}
  \setcounter{enumi}{5}
\item Wie viele Partner m{\"u}ssen auf der 2 Stufe anwerben um Ihr
  passives Einkommen zu erreichen? \textbf{(3 Punkte)}
\end{enumerate} 
\clearpage
% -----------------------------------------------------------------------
...
Sie haben den Vektor $A = \{-6, 8, 11\}$ und den Vektor $B = \{1, 1, -9\}$ gegeben.
