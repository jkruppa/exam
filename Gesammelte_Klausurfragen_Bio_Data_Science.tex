...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.89, 0.001 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.36, 3.56, 0.004 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.004 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.2225, 3e-04 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.004 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.085, 0.2225, 3e-04 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 5, 10, 13, 14 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.6 +/- 3.51
\item [\textbf{B} \msquare] Es ergibt sich 11.6 +/- 1.755
\item [\textbf{C} \msquare] Es ergibt sich 10.6 +/- 12.3
\item [\textbf{D} \msquare] Es ergibt sich 10.6 +/- 1.755
\item [\textbf{E} \msquare] Es ergibt sich 9.6 +/- 6.15
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 23, 23, 32, 21, 2, 24, 8, 21, 19, 22 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 [19, 24]
\item [\textbf{B} \msquare] Es ergibt sich 22 +/- 19
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 24
\item [\textbf{D} \msquare] Es ergibt sich 22 +/- 19
\item [\textbf{E} \msquare] Es ergibt sich 22 [20, 25]
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.25, da es sich um eine Chancenverh{"a}ltnis handelt.
...
$y = \{18, 14, 17, 8, 21, 12, 14\}$. Berechnen Sie folgende
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in list\_rbind(.): could not find function "{}list\_rbind"{}}}\end{kframe}\begin{table}[!h]
\centering
\begin{tabular}{cc}
\toprule
x & y\\
...
\begin{center}
$12.2, 9.8, 11, 10.9, 9.4, 12.4, 12.1, 11.1, 10.6, 9.8, 6.7, 9$
\end{center}
...
## t = 3.3052, df = 10, p-value = 0.007943
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 26.92 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 87.08 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 27.810 13.9048  4.7097 0.02264
## Residuals 18 53.143  2.9524
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 89.01 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 65.11 &  &  &  \strut\\
    \hline
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 140.17  70.086  4.3692 0.028395
## form       1 122.50 122.499  7.6366 0.012800
## dose:form  2 331.77 165.885 10.3413 0.001023
## Residuals 18 288.74  16.041
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   34   \strut\\
    \hline
     &  71 &  38 &  109  \strut\\
  \end{tabular}
\end{center}
...
##  -5.20  -0.80   0.40   0.95   3.80 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   20.000      1.253  15.962 2.38e-07
## waterB         7.200      1.772   4.063  0.00362
## 
## Residual standard error: 2.802 on 8 degrees of freedom
## Multiple R-squared:  0.6736,	Adjusted R-squared:  0.6328 
## F-statistic: 16.51 on 1 and 8 DF,  p-value: 0.003617
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.6736$ aus? \textbf{(2 Punkte)}
...
## t = -7.5215, df = 8, p-value = 6.788e-05
...
Einflussvariablen ($x$) wurden erhoben: dosage, dry und weight. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.34 & 1 & 7.93 & 99.45 & 69.36 & 14\\
10.23 & 0 & 9.29 & 100.26 & 67.24 & 7\\
9.04 & 0 & 9.87 & 103.32 & 68.46 & 8\\
12.04 & 1 & 10.25 & 96.94 & 67.72 & 3\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.9519 -1.7189 -0.0138  1.4543  4.7863 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.66239    7.19400  -0.092   0.9268
## water       -0.11346    0.15385  -0.737   0.4626
## Fe           0.70278    0.07099   9.900   <2e-16
## nematodes    0.13317    0.07211   1.847   0.0678
## 
## Residual standard error: 2.245 on 99 degrees of freedom
## Multiple R-squared:  0.5251,	Adjusted R-squared:  0.5107 
## F-statistic: 36.49 on 3 and 99 DF,  p-value: 5.75e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & maxdepth & no3 & so4\\
\midrule
LIBERTY\_RES & 12 & 424 & 62 & 3.49 & 5.82\\
OWENS\_CR & 80 & 9961 & 79 & 1.02 & 9.07\\
BEAR\_BR & 12 & 3333 & 83 & 5.34 & 7.74\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -12.608   -3.921   -2.596    1.664   16.672  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.775e+00  5.248e-01   3.382  0.00142
## acerage      3.686e-05  1.228e-05   3.002  0.00421
## maxdepth     1.195e-02  4.062e-03   2.942  0.00496
## no3          2.173e-01  6.520e-02   3.334  0.00164
## so4         -2.386e-03  2.091e-02  -0.114  0.90963
## 
## (Dispersion parameter for quasipoisson family taken to be 35.05885)
## 
##     Null deviance: 2534.6  on 53  degrees of freedom
## Residual deviance: 1553.8  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.48      1.87   0.0614
## 2 water           0.142    -1.86   0.0629
## 3 nematodes       0.127    -0.753  0.452
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3216 -0.5713 -0.0864  0.6108  3.3054 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  232.9   15.26   
##  subject  (Intercept) 4052.0   63.66   
##  Residual              707.3   26.60   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.292     26.934   7.511
## attitudepop  -20.187      5.844  -3.455
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0314454 0.3841147 0.0487273
## high 0.0314454 1.0000000 0.0036917 0.8419164
## low  0.3841147 0.0036917 1.0000000 0.0061816
## mid  0.0487273 0.8419164 0.0061816 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item $i$ dem Verhalten: (1) preening, (2) dustbathing, (3)
  wing/leg stretching und (4) foraging incl. scratching.
\end{itemize}
...
\midrule
preening & 36cm; 14cm; 0.2\% & 28cm; 28cm; 0.8\% & 37cm; 21cm; 0.2\%\\
dustbathing & 31cm; 26cm; 1.2\% & 39cm; 6cm; 8.1\% & 35cm; 36cm; 7.6\%\\
wing/leg stretching & 39cm; 27cm; 3.6\% & 38cm; 22cm; 3.6\% & 32cm; 30cm; 6.3\%\\
foraging incl. scratching & 39cm; 23cm; 6.2\% & 39cm; 32cm; 6.1\% & 36cm; 36cm; 6.9\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCNNZEI & 2.5 | 1.0 | Klein \\
    B & GCZOICN & 1.5 | 2.0 | Normal \\ 
    C & GCK1H7C & 4.5 | 4.5 | Normal \\ 
    D & GC4GGM7 & 2.0 | 3.0 | Klein \\ 
    E & GCQTZPR & 5.0 | 4.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 349 n. Chr. f{\"u}r den neuen Lehnsherren
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  4-mal-gefaltete, 0.8mm, 60-cm-Karton} durch
...
Das Jahr 2023 war das erfolgreichste Jahr in der Geschichte von
...
2022. Doch wie viel kommt bei den Partnern an? Laut
...
Sie haben den Vektor $A = \{4, 7, 14\}$ und den Vektor $B = \{2, 3, -4\}$ gegeben.
