...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.02, 0.21, 0.01, 0.89 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.0033, 0.035, 0.0017, 0.1483 und 0.0567. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 1, 0.06, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.0033, 0.035, 0.0017, 0.1483 und 0.0567. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 1, 0.06, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.52, 0.12, 1.26, 0.06, 5.34 und 2.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 7, 8, 13, 13 und 15.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.2 +/- 12.2
\item [\textbf{B} \msquare] Es ergibt sich 11.2 +/- 1.745
\item [\textbf{C} \msquare] Es ergibt sich 12.2 +/- 1.745
\item [\textbf{D} \msquare] Es ergibt sich 11.2 +/- 3.49
\item [\textbf{E} \msquare] Es ergibt sich 10.2 +/- 6.1
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 26, 28, 9, 13, 23, 15, 12, 27, 10, 23 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 [13, 28]
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 12
\item [\textbf{C} \msquare] Es ergibt sich 23 [12, 27]
\item [\textbf{D} \msquare] Es ergibt sich 23 +/- 27
\item [\textbf{E} \msquare] Es ergibt sich 22 +/- 12
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.43, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.75, da es sich um eine Chancenverh{"a}ltnis handelt.
...
$y = \{16, 17, 20, 15, 15, 18, 17, 21, 19, 17, 18\}$. Berechnen Sie folgende
...
Nach einem Gew{\"a}chshausexperiment mit drei L{"u}ftungssystemen und Folientunneln ($ctrl$, $storm$ und $tornado$) als Behandlung 
...
Nach einem Experiment mit zwei L{"u}ftungssystemen und Folientunneln ($ctrl$ und $tornado$) ergibt sich die
folgende Datentabelle mit dem gemessenen Trockengewicht
(\textit{drymatter})  von Kartoffeln. 
...
\begin{center}
$8.5, 9.8, 9.8, 9.6, 8.6, 12.3, 8.6, 7.4, 9.8, 10.2, 7.5, 8.4, 13.7, 9.3, 10.6$
\end{center}
...
Nullhypothese abgebildet. Erg{\"a}nzen Sie die Abbildung wie folgt.
...
\begin{center}
  ...
  \end{tabular}
\end{center}
\item Visualisieren Sie anhand von einer Normalverteilung folgende {\"A}nderung in den
  Daten.  
  \begin{enumerate}
...
## t = 0.83305, df = 16, p-value = 0.4171
...
## t = 0.38144, df = 14, p-value = 0.7086
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.641638  3.784495
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.74 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 53.3 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 10.571  5.2857  2.6016 0.1017
## Residuals 18 36.571  2.0317
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 36.34 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 169.27 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 542.31 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 521.63 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 581.98 290.991 21.6278 1.634e-05
## form       1  19.43  19.426  1.4438   0.24509
## dose:form  2 125.89  62.945  4.6783   0.02311
## Residuals 18 242.18  13.454
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high     low       mid
## ctrl 1.0000000 0.0001806 0.0e+00 0.9713291
## high 0.0001806 1.0000000 5.7e-06 0.0001629
## low  0.0000000 0.0000057 1.0e+00 0.0000000
## mid  0.9713291 0.0001629 0.0e+00 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -2.8000 -1.0929 -0.3571  1.1571  3.2000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  15.8571     0.7527  21.068 1.29e-09
## waterB        7.9429     1.1661   6.812 4.67e-05
## 
## Residual standard error: 1.991 on 10 degrees of freedom
## Multiple R-squared:  0.8227,	Adjusted R-squared:  0.805 
## F-statistic:  46.4 on 1 and 10 DF,  p-value: 4.673e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.8227$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: N, center und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.40 & 1 & 10.05 & 101.50 & 70.58 & 13\\
11.55 & 1 & 8.67 & 100.09 & 68.63 & 13\\
9.39 & 0 & 10.89 & 99.29 & 69.52 & 5\\
10.44 & 0 & 9.24 & 100.08 & 69.19 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##    Min     1Q Median     3Q    Max 
## -9.421 -2.043  0.272  1.929  8.498 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 74.52965    3.68561  20.222   <2e-16
## P           -0.38113    0.27124  -1.405    0.163
## water       -0.12046    0.26666  -0.452    0.653
## light       -0.04528    0.79425  -0.057    0.955
## 
## Residual standard error: 3.473 on 91 degrees of freedom
## Multiple R-squared:  0.02489,	Adjusted R-squared:  -0.007253 
## F-statistic: 0.7744 on 3 and 91 DF,  p-value: 0.5113
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & so4 & no3 & acerage\\
\midrule
SOUTH\_BR\_PATAPSCO & 26 & 18.6 & 8.84 & 2.96 & 1450\\
WATTS\_BR & 19 & 26.5 & 14.19 & 5.25 & 510\\
LIBERTY\_RES & 12 & 20.2 & 5.82 & 3.49 & 424\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.689  -4.680  -1.746   1.236  19.549  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.425e+00  9.413e-01   2.576  0.01305
## temp         4.302e-02  4.615e-02   0.932  0.35588
## so4         -3.668e-02  3.038e-02  -1.207  0.23311
## no3          1.322e-01  7.401e-02   1.787  0.08019
## acerage      5.285e-05  1.453e-05   3.638  0.00066
## 
## (Dispersion parameter for quasipoisson family taken to be 44.40144)
## 
##     Null deviance: 2443.2  on 53  degrees of freedom
## Residual deviance: 1682.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>    <dbl>
## 1 (Intercept)     0.369    -1.29  0.197   
## 2 nematodes       0.153    -0.634 0.526   
## 3 light           0.485     3.44  0.000576
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9442 -0.5806 -0.1811  0.5763  3.3422 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  214.1   14.63   
##  subject  (Intercept) 4045.2   63.60   
##  Residual              635.4   25.21   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.413     26.831   7.507
## attitudepop  -19.341      5.539  -3.492
## 
...
In der Klau sur zu dem Modul \textbf{Angewandte Statistik und Versuchswesen} wird \textit{eine Aufgabe} aus den folgenden Aufgaben zur R Programmierung ausgew{\"a}hlt.  \\
...
mit der Funktion \texttt{mean} und den Zahlen 11, 13, 6, 8 und 5!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 18, 5, 4, 10 und 6! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes grade, P und pigs an vier verschiedenen Messterminen.
...
In der Klausur zu dem Modul \textbf{Mathematik \& Statistik} werden drei bis vier Aufgaben aus den folgenden Aufgaben zur Mathematik ausgew{\"a}hlt. \\
\end{graybox}
\clearpage
% -----------------------------------------------------------------------  
...
\midrule
wing/leg stretching & 38cm; 22cm; 8.9\% & 39cm; 24cm; 12.1\% & 33cm; 33cm; 3.5\%\\
standing & 41cm; 30cm; 64.1\% & 37cm; 30cm; 64.1\% & 44cm; 32cm; 64.1\%\\
sitting & 26cm; 26cm; 6.3\% & 33cm; 40cm; 8.1\% & 34cm; 27cm; 5.1\%\\
preening & 34cm; 26cm; 6.2\% & 32cm; 26cm; 3.2\% & 44cm; 19cm; 1.2\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCEW0HB & 2.5 | 5.0 | Klein \\
    B & GCVRHCE & 5.0 | 2.5 | Mikro \\ 
    C & GCZIVR8 & 4.5 | 4.0 | Klein \\ 
    D & GCHXLOJ & 3.5 | 4.5 | Klein \\ 
    E & GCLJH93 & 1.0 | 3.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 155 n. Chr. f{\"u}r den neuen Lehnsherren
...
Fressfeinde liegt die Mortalit{\"a}t der S{\"a}uglinge bei 37\%.
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  5-mal-gefaltete, 0.8mm, 40-cm-Karton} durch
...
4.1\% p.a. {\"u}ber 36 Monate finanzieren.
...
Sie haben den Vektor $A = \{27, 0, -1\}$ und den Vektor $B = \{-2, -1, -2\}$ gegeben.
