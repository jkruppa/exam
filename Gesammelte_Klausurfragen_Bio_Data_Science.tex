...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 11, 4, 11 und 7.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.2 +/- 3.63
\item [\textbf{B} \msquare] Es ergibt sich 10.2 +/- 1.815
\item [\textbf{C} \msquare] Es ergibt sich 8.2 +/- 6.6
\item [\textbf{D} \msquare] Es ergibt sich 9.2 +/- 13.2
\item [\textbf{E} \msquare] Es ergibt sich 9.2 +/- 1.815
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 13, 11, 6, 21, 6, 15 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 18 +/- 6
\item [\textbf{B} \msquare] Es ergibt sich 13 +/- 6
\item [\textbf{C} \msquare] Es ergibt sich 13 +/- 21
\item [\textbf{D} \msquare] Es ergibt sich 18 [7, 22]
\item [\textbf{E} \msquare] Es ergibt sich 13 [6, 21]
\end{enumerate} 
...
In dem folgenden Histogramm von $n = 191$ Pflanzen ist welche
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.43, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 2.33, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.3, da es sich um eine Chancenverh{"a}ltnis handelt.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.03, 0.01, 0.42 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.006, 0.002, 0.084 und 0.068. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 0.05, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.006, 0.002, 0.084 und 0.068. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.05, 0.15, 0.05, 2.1 und 1.7. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 0.05, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate}
...
\begin{center}
$3, 3, 4, 5, 2, 2, 5, 5, 3, 9, 3, 4, 6, 3, 4, 4, 5, 5, 8, 5, 5, 7, 4, 2, 1, 8, 4, 2, 3, 4, 3, 6, 2$
\end{center}
...
\begin{center}
$10.6, 11.2, 10.9, 9.2, 11.3, 9.9, 10.9, 7.3, 10.4, 8.2, 7.2, 9.8, 7.8, 11.6, 11.7, 11.8, 9.9$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ wahr & Testentscheidung & 5\% & H$_0$ falsch \\
  \end{tabular}
  \end{center}
...
## t = -0.083189, df = 16, p-value = 0.9347
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -2.942554  2.720332
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{group}  & 2 & 59.45 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 30.98 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Der Datensatz \textit{crop\_tbl} enth{\"a}lt das Outcome \textit{height} f{\"u}r ein Experiment in einer Klimakammer mit 
...
## trt        2 104.17  52.085  18.111 2.242e-05
## Residuals 22  63.27   2.876
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 1.5 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 176.64 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 97.93 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 315.78 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 61 Puten durchgef{\"u}hrt, wobei
...
## Response: weight
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2  54.31  27.154  1.4784 0.254404
## form       1  78.67  78.673  4.2833 0.053153
## dose:form  2 524.00 262.002 14.2647 0.000194
## Residuals 18 330.61  18.367
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0038156 0.7186935 0.0138104
## high 0.0038156 1.0000000 0.0014570 0.6104464
## low  0.7186935 0.0014570 1.0000000 0.0056243
## mid  0.0138104 0.6104464 0.0056243 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 154$ Pflanzen untersucht.
\vspace{5Ex}
...
## -2.7143 -0.7302  0.2540  1.2222  1.2857 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  16.7778     0.4271   39.28 9.99e-16
## waterB        9.9365     0.6457   15.39 3.63e-10
## 
## Residual standard error: 1.281 on 14 degrees of freedom
## Multiple R-squared:  0.9442,	Adjusted R-squared:  0.9402 
## F-statistic: 236.8 on 1 and 14 DF,  p-value: 3.627e-10
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.9442$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: dry, fertilizier und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
preening & 36cm; 24cm; 8.9\% & 31cm; 27cm; 8.9\% & 31cm; 33cm; 8.9\%\\
wingflapping & 40cm; 22cm; 4.3\% & 27cm; 22cm; 1.8\% & 41cm; 32cm; 2.1\%\\
walking & 46cm; 28cm; 3.6\% & 33cm; 28cm; 3.6\% & 26cm; 18cm; 6.3\%\\
standing & 36cm; 24cm; 1.2\% & 33cm; 25cm; 1.2\% & 36cm; 28cm; 0.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCSYO5G & 5.0 | 5.0 | Mikro \\
    B & GC4ZVUU & 1.5 | 2.5 | Klein \\ 
    C & GCVQCTT & 4.0 | 4.0 | Normal \\ 
    D & GCVNSXQ & 1.0 | 1.5 | Normal \\ 
    E & GC0F968 & 3.0 | 1.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 367 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{10^{10}} - \ensuremath{1.1\times 10^{9}} \cdot 2.3^{-0.2 \cdot t + 2.7}
\end{equation*}
...
In der n{\"a}chsten Abbildung finden Sie die CO$_2$-Emission in [kg] pro [kg] nach Lebensmittel
...
Sie haben den Vektor $A = \{10, -11, 2\}$ und den Vektor $B = \{1, 5, -2\}$ gegeben.
