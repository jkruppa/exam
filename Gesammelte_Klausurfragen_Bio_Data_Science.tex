...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.42, 0.03 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 0.12 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.105, 0.0075 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1, 0.12 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0025, 0.105, 0.0075 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.04, 1.68, 0.12 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 8, 12, 16, 10 und 15.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12.2 +/- 1.675
\item [\textbf{B} \msquare] Es ergibt sich 12.2 +/- 11.2
\item [\textbf{C} \msquare] Es ergibt sich 11.2 +/- 5.6
\item [\textbf{D} \msquare] Es ergibt sich 12.2 +/- 3.35
\item [\textbf{E} \msquare] Es ergibt sich 13.2 +/- 1.675
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 30, 18, 26, 34, 8, 22 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 26 +/- 18
\item [\textbf{B} \msquare] Es ergibt sich 29 +/- 18
\item [\textbf{C} \msquare] Es ergibt sich 26 +/- 34
\item [\textbf{D} \msquare] Es ergibt sich 29 [19, 35]
\item [\textbf{E} \msquare] Es ergibt sich 26 [18, 34]
\end{enumerate} 
...
$y = \{13, 15, 14, 14, 14, 13, 15, 12, 15, 14, 9\}$. Berechnen Sie folgende
...
\begin{center}
$13.8, 10.7, 7.7, 9.5, 8.7, 9.6, 13.3, 7.9, 6.1, 12.1, 8.4, 7.3$
\end{center}
...
## t = -0.56259, df = 14, p-value = 0.5826
...
## 
## data:  drymatter by Fe
## t = 0.44256, df = 14, p-value = 0.6648
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.258950  3.433553
## sample estimates:
...
## trt        2 22.837 11.4184  3.1959 0.06047
## Residuals 22 78.603  3.5729
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 123 129  97 122 107  96 139 153 146 150 152 151
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 242.61 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 94.79 &  &  &  \strut\\
    \hline
...
## Response: weight
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2 293.465 146.732 21.1604 1.876e-05
## form       1   8.313   8.313  1.1988  0.288005
## dose:form  2  88.454  44.227  6.3780  0.008055
## Residuals 18 124.817   6.934
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 96$ Pflanzen untersucht.
\vspace{5Ex}
...
## -1.857 -1.814 -0.300  1.200  3.143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  19.8571     0.6934  28.637 6.28e-11
## waterB        7.9429     1.0742   7.394 2.33e-05
## 
## Residual standard error: 1.835 on 10 degrees of freedom
## Multiple R-squared:  0.8454,	Adjusted R-squared:  0.8299 
## F-statistic: 54.67 on 1 and 10 DF,  p-value: 2.331e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.8454$ aus? \textbf{(2 Punkte)}
...
## t = 3.9897, df = 8, p-value = 0.004007
...
Einflussvariablen ($x$) wurden erhoben: dry, height und dosage. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
7.70 & 0 & 10.31 & 97.87 & 68.39 & 7\\
10.04 & 0 & 10.03 & 102.85 & 70.26 & 10\\
7.96 & 0 & 10.18 & 99.71 & 66.07 & 12\\
6.84 & 0 & 9.73 & 102.50 & 72.14 & 5\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.4786 -1.8285 -0.1543  2.1414  7.2401 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 69.33890    2.66433  26.025   <2e-16
## nematodes   -0.09587    0.10883  -0.881    0.381
## light        0.50882    0.78414   0.649    0.518
## water        0.11409    0.24747   0.461    0.646
## 
## Residual standard error: 3.107 on 80 degrees of freedom
## Multiple R-squared:  0.01799,	Adjusted R-squared:  -0.01883 
## F-statistic: 0.4886 on 3 and 80 DF,  p-value: 0.6912
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & so4 & no3 & acerage\\
\midrule
ISRAEL\_CR & 30 & 9.5 & 13.77 & 2.41 & 6260\\
HOLLANDS\_BR & 38 & 10.5 & 11.44 & 2.34 & 1934\\
DEER\_CR & 26 & 9.9 & 6.36 & 5.26 & 8297\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -7.028  -4.291  -1.264   1.172  19.861  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.299e+00  1.124e+00   1.156 0.253445
## do2         1.505e-01  1.207e-01   1.247 0.218335
## so4         7.784e-03  2.057e-02   0.378 0.706696
## no3         1.888e-01  6.307e-02   2.994 0.004307
## acerage     4.064e-05  1.125e-05   3.611 0.000717
## 
## (Dispersion parameter for quasipoisson family taken to be 32.51818)
## 
##     Null deviance: 1973.7  on 53  degrees of freedom
## Residual deviance: 1231.4  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.50      2.76  0.00570
## 2 water           0.147    -2.53  0.0113 
## 3 nematodes       0.141    -0.379 0.705
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1210 -0.6771 -0.0704  0.5574  3.3967 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  229.0   15.13   
##  subject  (Intercept) 3914.0   62.56   
##  Residual              656.2   25.62   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.387     26.470   7.646
## attitudepop  -20.301      5.628  -3.607
## 
...
\begin{verbatim}
##           ctrl      high   low       mid
## ctrl 1.0000000 0.0133051 0e+00 0.0000007
## high 0.0133051 1.0000000 0e+00 0.0012218
## low  0.0000000 0.0000000 1e+00 0.0000001
## mid  0.0000007 0.0012218 1e-07 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 5, 13, 11, 10 und 7!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 11, 10, -4, 20 und 9! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes Fe, pigs und freshmatter an zwei verschiedenen Messterminen.
...
\item $i$ dem Verhalten: (1) sitting, (2) foraging including scratching, (3)
...
\toprule
\rotatebox{45}{ } & \rotatebox{45}{Aldridge et al.} & \rotatebox{45}{Baxter et al.} & \rotatebox{45}{Jabcobs et al.} & \rotatebox{45}{Ma et al.}\\
\midrule
sitting & 64.1 & 64.1 & 25.4 & 64.1\\
foraging including scratching & 0.4 & 0.4 & 0.4 & 0.2\\
preening & 8.1 & 8.1 & 1.2 & 1.2\\
dustbathing & 8.1 & 8.1 & 6.3 & 6.3\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCPY6R0 & 1.0 | 3.0 | Klein \\
    B & GCCMIDR & 1.5 | 2.5 | Mikro \\ 
    C & GCL3N9D & 3.0 | 4.0 | Mikro \\ 
    D & GCFWUBW & 3.5 | 3.5 | Mikro \\ 
    E & GC4VVGX & 2.5 | 2.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 171 n. Chr. f{\"u}r den neuen Lehnsherren
...
1859 ungef{\"a}hr 22 Kaninchen entlassen hat, Millionen
...
Sie haben den Vektor $A = \{8, 7, 3\}$ und den Vektor $B = \{1, -5, -1\}$ gegeben.
