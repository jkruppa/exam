...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.001, 0.42, 0.02 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 4.45, 0.005, 2.1, 0.1 und 1.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 2e-04, 0.084, 0.004 und 0.042. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.005, 1, 0.1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.005, 1, 0.1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 2e-04, 0.084, 0.004 und 0.042. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 7, 9, 15 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.4 +/- 1.485
\item [\textbf{B} \msquare] Es ergibt sich 10.4 +/- 8.8
\item [\textbf{C} \msquare] Es ergibt sich 10.4 +/- 2.97
\item [\textbf{D} \msquare] Es ergibt sich 10.4 +/- 1.485
\item [\textbf{E} \msquare] Es ergibt sich 9.4 +/- 4.4
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 19, 30, 33, 13, 40, 9, 29, 18, 13, 22 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 +/- 13
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 13
\item [\textbf{C} \msquare] Es ergibt sich 22 [13, 33]
\item [\textbf{D} \msquare] Es ergibt sich 24 [14, 34]
\item [\textbf{E} \msquare] Es ergibt sich 22 +/- 33
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.42, da es sich um ein Anteil handelt.
...
$y = \{16, 13, 22, 17, 16, 17, 21, 15, 21, 16, 19\}$. Berechnen Sie folgende
...
\begin{center}
$10.3, 11.1, 11.3, 10.2, 7.2, 8.4, 7.2, 11.2, 14.2, 7.7, 10.9, 10.5$
\end{center}
...
## 
## data:  freshmatter by N
## t = -3.443, df = 12, p-value = 0.004867
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -9.651752 -2.170470
## sample estimates:
...
## t = -0.51053, df = 14, p-value = 0.6176
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.467413  2.134079
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 73.18 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 38.13 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  89.347  44.674  9.5967 0.001008
## Residuals 22 102.413   4.655
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 29.94 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 394.01 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 100.01 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 271.47 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  88.86  44.430  2.2019 0.1394916
## form       1  31.30  31.296  1.5510 0.2289501
## dose:form  2 601.56 300.779 14.9066 0.0001519
## Residuals 18 363.20  20.178
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.7143 -1.6286 -0.1571  2.2857  3.4000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.714      1.033  16.188 1.68e-08
## waterB        -6.114      1.600  -3.822  0.00336
## 
## Residual standard error: 2.732 on 10 degrees of freedom
## Multiple R-squared:  0.5937,	Adjusted R-squared:  0.553 
## F-statistic: 14.61 on 1 and 10 DF,  p-value: 0.00336
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.5937$ aus? \textbf{(2 Punkte)}
...
## t = -6.6175, df = 8, p-value = 0.0001663
...
Einflussvariablen ($x$) wurden erhoben: N, weight und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.61 & 0 & 9.62 & 96.53 & 68.74 & 8\\
8.75 & 0 & 8.74 & 98.11 & 69.56 & 7\\
8.85 & 0 & 12.31 & 100.43 & 72.44 & 12\\
8.39 & 0 & 10.27 & 96.58 & 67.19 & 7\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.2406 -1.4529 -0.0596  1.6163  4.4991 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -9.498457   6.380331  -1.489    0.139
## nematodes   -0.001542   0.061681  -0.025    0.980
## light        0.191178   0.424716   0.450    0.653
## Fe           0.791617   0.064203  12.330   <2e-16
## 
## Residual standard error: 2.083 on 111 degrees of freedom
## Multiple R-squared:  0.5863,	Adjusted R-squared:  0.5752 
## F-statistic: 52.44 on 3 and 111 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
PINEY\_BR & 48 & 5.38 & 8.3 & 18.9 & 4.70\\
ISRAEL\_CR & 30 & 13.77 & 9.5 & 21.0 & 2.41\\
SOUTH\_BR\_PATAPSCO & 26 & 8.84 & 7.9 & 18.6 & 2.96\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -7.9659  -4.7100  -2.0642   0.8302  15.2316  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.510982   1.644199  -0.311   0.7573
## so4          0.009191   0.019678   0.467   0.6425
## do2          0.231936   0.129095   1.797   0.0786
## temp         0.075624   0.044257   1.709   0.0938
## no3          0.175242   0.070449   2.487   0.0163
## 
## (Dispersion parameter for quasipoisson family taken to be 39.25529)
## 
##     Null deviance: 2035.8  on 53  degrees of freedom
## Residual deviance: 1537.6  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.410     -2.84 0.00456
## 2 nematodes       0.174      1.76 0.0785 
## 3 light           0.455      1.85 0.0640
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 791.6
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.9832 -0.6217 -0.1292  0.5360  3.2717 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  250.0   15.81   
##  subject  (Intercept) 3976.4   63.06   
##  Residual              624.3   24.99   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   201.53      26.71   7.545
## attitudepop   -19.39       5.49  -3.532
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0000645 0.0003135
## high 0.0000000 1.0000000 0.0159787 0.0040361
## low  0.0000645 0.0159787 1.0000000 0.5834523
## mid  0.0003135 0.0040361 0.5834523 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 10, 15, 15, 9 und 10!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 6, 12, 8 und 14! \textbf{(2 Punkte)}
...
die Futterzus{"a}tze 1 bis 4 sowie die Bl{\"o}cke I bis IV
vorliegen. Sie messen die Outcomes pigs, drymatter und freshmatter an drei verschiedenen Messterminen.
...
\midrule
wingflapping & 36cm; 24cm; 50.1\% & 36cm; 26cm; 64.1\% & 35cm; 30cm; 64.1\%\\
foraging incl. scratching & 41cm; 29cm; 4.3\% & 32cm; 38cm; 1.8\% & 28cm; 25cm; 1.8\%\\
sitting & 29cm; 16cm; 0.4\% & 40cm; 19cm; 0.8\% & 46cm; 33cm; 0.2\%\\
walking & 47cm; 27cm; 1.2\% & 29cm; 28cm; 0.8\% & 28cm; 38cm; 1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCEKAPA & 4.0 | 5.0 | Mikro \\
    B & GCKOJ6I & 4.5 | 3.5 | Klein \\ 
    C & GCLOOVL & 3.0 | 1.0 | Normal \\ 
    D & GCUIUIF & 1.0 | 4.5 | Klein \\ 
    E & GCPUMVC & 3.5 | 3.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 815 n. Chr. f{\"u}r den neuen Lehnsherren
...
2.5\% p.a. {\"u}ber 60 Monate finanzieren.
...
Sie haben den Vektor $A = \{-7, -2, 8\}$ und den Vektor $B = \{12, 0, 0\}$ gegeben.
