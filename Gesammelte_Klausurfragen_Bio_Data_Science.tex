...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.34, 0.02, 0.01 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.1, 0.05 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.068, 0.004, 0.002 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.1, 0.05 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.05, 1.7, 0.1, 0.05 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.068, 0.004, 0.002 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 15, 17, 9, 6 und 6.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.6 +/- 13.15
\item [\textbf{B} \msquare] Es ergibt sich 10.6 +/- 2.565
\item [\textbf{C} \msquare] Es ergibt sich 10.6 +/- 5.13
\item [\textbf{D} \msquare] Es ergibt sich 11.6 +/- 2.565
\item [\textbf{E} \msquare] Es ergibt sich 10.6 +/- 26.3
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 20, 21, 18, 15, 15, 19, 16, 10, 24, 41 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 +/- 15
\item [\textbf{B} \msquare] Es ergibt sich 19 [15, 24]
\item [\textbf{C} \msquare] Es ergibt sich 19 +/- 24
\item [\textbf{D} \msquare] Es ergibt sich 23 +/- 15
\item [\textbf{E} \msquare] Es ergibt sich 23 [15, 24]
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.53 liegt Overdispersion vor. Damit kann keine Possion-Regression gerechnet werden. Die L{"o}sung ist eine Gaussian Regression mit Nullanpassung.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.53 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.53 liegt keine Overdispersion vor.
...
\item [\textbf{B} \msquare] Untereinander abh{"a}ngig. Die Ferkel stammen von einem Muttertier und haben vermutliche eine {"a}hnliche Varianzstruktur.
...
\item [\textbf{C} \msquare] Y beinhaltet mehrere Spalten. Die Spalten enthalten die Behandlung und weitere potenzielle Einflussvariablen
...
\item [\textbf{C} \msquare] Die Varianzstruktur wird modelliert.
...
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.5, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.33, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 2, da es sich um ein Anteil handelt.
\end{enumerate}
...
\midrule
(Intercept) & 38.01 & 0.28\\
light\_binhigh & 3.86 & 0.40\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 3.86
...
\item [\textbf{D} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 14.88
\item [\textbf{E} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 14.88
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Wir machen Aussagen über den Nicht-Zustand/Keinen Effekt!
...
$y = \{18, 13, 17, 16, 19, 11, 17, 13, 17, 14, 13\}$. Berechnen Sie folgende
...
\begin{center}
$8.1, 8.9, 10.5, 12.4, 10.2, 8.6, 12.9, 10.7, 11.2, 17.6, 13.6, 12.7, 10.2, 11.1$
\end{center}
...
## t = 3.4222, df = 12, p-value = 0.005058
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  1.267631 5.710147
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 62.51 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 21.49 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 112.47  56.235  24.844 3.79e-06
## Residuals 20  45.27   2.263
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 120  96 105  92 110  88 131 144 164 137 154 173
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 21.05 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 422.2 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 139.02 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 30 & 767.89 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2 260.384 130.192 13.6572 0.0002462
## form       1  84.670  84.670  8.8819 0.0080224
## dose:form  2  69.419  34.709  3.6410 0.0470046
## Residuals 18 171.591   9.533
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 137$ Sauen. In dem Experiment wurde gemessen,
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   84   \strut\\
    \hline
     &  71 &  66 &  137  \strut\\
  \end{tabular}
\end{center}
...
## -10.571  -1.179   1.000   2.214   5.429 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   13.571      1.594   8.514 1.98e-06
## trtB          13.857      2.254   6.147 4.97e-05
## 
## Residual standard error: 4.217 on 12 degrees of freedom
## Multiple R-squared:  0.759,	Adjusted R-squared:  0.7389 
## F-statistic: 37.79 on 1 and 12 DF,  p-value: 4.968e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 4.3171, df = 8, p-value = 0.002556
...
Einflussvariablen ($x$) wurden erhoben: dry, center und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.91 & 0 & 9.41 & 97.50 & 73.08 & 14\\
8.36 & 1 & 9.44 & 101.96 & 70.64 & 11\\
10.27 & 1 & 11.09 & 98.89 & 71.42 & 11\\
6.76 & 0 & 8.12 & 101.08 & 75.00 & 16\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##    Min     1Q Median     3Q    Max 
## -7.616 -2.249  0.186  2.029  5.701 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  73.5424     3.1981  22.996   <2e-16
## P            -0.5386     0.2093  -2.574   0.0117
## water         0.1069     0.2434   0.439   0.6615
## light         1.2695     0.7337   1.730   0.0870
## 
## Residual standard error: 2.992 on 89 degrees of freedom
## Multiple R-squared:  0.1057,	Adjusted R-squared:  0.07554 
## F-statistic: 3.506 on 3 and 89 DF,  p-value: 0.0186
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & acerage & do2 & maxdepth\\
\midrule
WATTS\_BR & 19 & 5.25 & 510 & 6.7 & 82\\
SOUTH\_BR\_PATAPSCO & 26 & 2.96 & 1450 & 7.9 & 60\\
LITTLE\_FALLS & 84 & 3.54 & 1600 & 10.2 & 56\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -11.348   -4.048   -1.195    1.348   16.892  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 4.947e-01  1.298e+00   0.381  0.70476
## no3         1.915e-01  6.349e-02   3.017  0.00404
## acerage     3.497e-05  1.149e-05   3.045  0.00374
## do2         1.473e-01  1.333e-01   1.105  0.27464
## maxdepth    1.323e-02  3.972e-03   3.332  0.00165
## 
## (Dispersion parameter for quasipoisson family taken to be 31.7718)
## 
##     Null deviance: 2364.4  on 53  degrees of freedom
## Residual deviance: 1382.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.64      0.513   0.608
## 2 water           0.161    -0.624   0.533
## 3 nematodes       0.161     0.490   0.624
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 792.6
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.8059 -0.6039 -0.0752  0.5637  3.6347 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  182.3   13.50   
##  subject  (Intercept) 3994.8   63.20   
##  Residual              646.7   25.43   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.174     26.594   7.602
## attitudepop  -19.093      5.588  -3.417
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0003569 0.0041128 0.0000000
## high 0.0003569 1.0000000 0.0000000 0.0024902
## low  0.0041128 0.0000000 1.0000000 0.0000000
## mid  0.0000000 0.0024902 0.0000000 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 11, 12, 12, 14 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 8, 9, 12 und 11! \textbf{(2 Punkte)}
