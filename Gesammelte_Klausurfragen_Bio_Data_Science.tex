...
$\eta^2 = 0.33$. Welche Aussage ist richtig?
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 11, 15, 12 und 18.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 13.4 +/- 2.255
\item [\textbf{B} \msquare] Es ergibt sich 12.4 +/- 2.255
\item [\textbf{C} \msquare] Es ergibt sich 11.4 +/- 10.15
\item [\textbf{D} \msquare] Es ergibt sich 12.4 +/- 4.51
\item [\textbf{E} \msquare] Es ergibt sich 12.4 +/- 20.3
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 30, 2, 18, 14, 8, 17, 23, 18, 18, 39 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 18 +/- 14
\item [\textbf{B} \msquare] Es ergibt sich 18 [14, 30]
\item [\textbf{C} \msquare] Es ergibt sich 23 +/- 14
\item [\textbf{D} \msquare] Es ergibt sich 23 [15, 31]
\item [\textbf{E} \msquare] Es ergibt sich 18 +/- 30
\end{enumerate} 
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.34, 0.001, 0.89 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.05, 1.7, 0.005, 4.45 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.005, 1 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.005, 1 und 0.05. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.068, 2e-04, 0.178 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.068, 2e-04, 0.178 und 0.002. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate}
...
\item [\textbf{E} \msquare] Compact line display. Gleichheit in den Behandlungen wird durch den gleichen Buchstaben oder Symbol dargestellt. Fr{"u}her wurden keine Buchstaben sondern eine durchgezogene Linie verwendet. Bei mehr als drei Gruppen funktioniert die Linie aber graphisch nicht mehr.
\end{enumerate}
...
\item [\textbf{B} \msquare] Das R Paket lm. Das Paket lm erstellt selbstst{"a}ndig Konfidenzintervalle und entsprechende p-Werte. Da wir in dem Paket nicht adjustieren m{"u}ssen, ist es bei Anwendern sehr beliebt.
...
\item [\textbf{D} \msquare] Das R Paket ggplot. Wir erhalten hier sofort eine Visualisierung der Daten. Anhand der Visualisierung l{"a}sst sich eine explorative Datenanalyse durchf{"u}hren, die gleichwertig zu einem Posthoc-Test ist.
...
\item [\textbf{E} \msquare] In der Analogie des Niederschlags oder Regenmenge: ein statistischer Test gibt die St{"a}rke eines Effektes wieder. Zum Beispiel, wie hoch ist der Mittelwertsunterschied.
\end{enumerate}
...
Nach einem Freilandexperiment mit zwei Substrattypen ($torf$, $40p60n$ und $70p30n$) als Behandlung
...
Nach einem Freilandexperiment mit zwei D{"u}ngestufen ($ctrl$ und $high$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Datentabelle mit dem
...
\begin{center}
$5, 1, 0, 5, 3, 4, 5, 7, 1, 6, 7, 3, 4, 5, 0, 2, 3, 2, 3, 9, 4, 2, 6, 6, 7, 4, 1, 7, 4, 5, 3, 3, 8$
\end{center}
...
\begin{center}
$10.9, 15.2, 10.1, 11.4, 7, 10.8, 13.5, 10.7, 10.2, 8.9, 10.3, 10.6, 5.8, 11.4, 11.2, 11.2, 10.9, 13.5, 9.2, 9.7$
\end{center}
...
\item Visualisieren Sie ein 95\%-iges Konfidenzintervall im Vergleich
  zu einem 90\%-igen Konfidenzintervall! Begr{\"u}nden Sie Ihre Antwort mathematisch! \textbf{(2 Punkte)} 
\end{enumerate} 
\clearpage
% -----------------------------------------------------------------------
...
\item Treffen Sie mit $T_{\alpha = 1\%} = 2.65$ und dem berechneten $T_{calc}$ eine Aussage
...
## 
## data:  weight by group
## t = -0.12975, df = 14, p-value = 0.8986
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -6.399818  5.669660
## sample estimates:
...
## 
## data:  weight by group
## t = -0.20067, df = 12, p-value = 0.8443
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -3.387911  2.816483
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 96.64 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 101.27 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 17.823  8.9117  3.0665 0.06688
## Residuals 22 63.937  2.9062
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 86.49 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 92.02 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 399.22 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 40 & 388.27 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 600.04 300.021  27.769 3.154e-06
## form       1 197.13 197.125  18.245 0.0004593
## dose:form  2 225.09 112.543  10.417 0.0009877
## Residuals 18 194.48  10.804
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000275 0.0017339 0.0277376
## high 0.0000275 1.0000000 0.0000000 0.0146062
## low  0.0017339 0.0000000 1.0000000 0.0000024
## mid  0.0277376 0.0146062 0.0000024 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 108$ Sauen. In dem Experiment wurde gemessen,
...
## -4.8571 -2.8143  0.1714  2.3929  6.2000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   20.857      1.402  14.873 3.79e-08
## waterB        -9.057      2.172  -4.169  0.00192
## 
## Residual standard error: 3.71 on 10 degrees of freedom
## Multiple R-squared:  0.6348,	Adjusted R-squared:  0.5983 
## F-statistic: 17.38 on 1 and 10 DF,  p-value: 0.001921
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.6348$ aus? \textbf{(2 Punkte)}
...
## t = 3.7112, df = 8, p-value = 0.005946
...
Einflussvariablen ($x$) wurden erhoben: weight, P und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
foraging incl. scratching & 41cm; 23cm; 0.4\% & 41cm; 21cm; 0.4\% & 32cm; 32cm; 0.2\%\\
wingflapping & 44cm; 29cm; 1.6\% & 37cm; 29cm; 0.5\% & 41cm; 28cm; 1.2\%\\
dustbathing & 29cm; 24cm; 4.1\% & 38cm; 28cm; 6.3\% & 30cm; 21cm; 6.3\%\\
preening & 35cm; 31cm; 7.3\% & 38cm; 27cm; 0.9\% & 31cm; 25cm; 1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCGST1W & 1.5 | 5.0 | Normal \\
    B & GCZKYK6 & 4.0 | 3.5 | Normal \\ 
    C & GCYNIHD & 2.5 | 4.5 | Normal \\ 
    D & GC4KOSG & 2.0 | 2.0 | Mikro \\ 
    E & GCGYCHM & 1.0 | 3.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 393 n. Chr. f{\"u}r den neuen Lehnsherren
...
Weibchen hat im Durchschnitt 5 W{\"u}rfe pro Jahr. Trotz fehlender
...
\item Wie viele Millionen Kaninchen w{\"u}rden bei einem ungebremsten
  Wachstum \textit{im f{"u}nften Jahr} geboren? Berechnen Sie hierf{\"u}r
  zuerst die Anzahl an geboren Weibchen im f{"u}nften Jahr! \textbf{(2 Punkte)}
...
Kaninchenpopulation.
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{10^{9}} \cdot 2^{-0.1 \cdot t + 3.4}
\end{equation*}
...
L{\"a}nder z{\"a}hlen. Im Jahr 2023 leben ca. \ensuremath{8.4\times 10^{7}} Menschen in Deutschland und
...
2500EUR im Monat \textit{passiv} erwirtschaften.
...
4.1\% p.a. {\"u}ber 60 Monate finanzieren.
...
Sie haben den Vektor $A = \{11, 5, 7\}$ und den Vektor $B = \{2, 6, 2\}$ gegeben.
