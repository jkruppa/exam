...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.03, 0.34, 0.02, 0.001 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 5.34, 0.18, 2.04, 0.12, 0.006 und 1.26. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.18, 1, 0.12, 0.006 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1483, 0.005, 0.0567, 0.0033, 2e-04 und 0.035. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.1483, 0.005, 0.0567, 0.0033, 2e-04 und 0.035. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.18, 1, 0.12, 0.006 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
$\eta^2 = 0.34$. Welche Aussage ist richtig?
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 10, 11, 13, 10 und 9.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.6 +/- 0.76
\item [\textbf{B} \msquare] Es ergibt sich 10.6 +/- 1.52
\item [\textbf{C} \msquare] Es ergibt sich 10.6 +/- 2.3
\item [\textbf{D} \msquare] Es ergibt sich 9.6 +/- 1.15
\item [\textbf{E} \msquare] Es ergibt sich 11.6 +/- 0.76
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 23, 21, 18, 11, 23, 21, 39, 14, 16, 27 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 [17, 28]
\item [\textbf{B} \msquare] Es ergibt sich 25 +/- 16
\item [\textbf{C} \msquare] Es ergibt sich 21 [16, 27]
\item [\textbf{D} \msquare] Es ergibt sich 21 +/- 27
\item [\textbf{E} \msquare] Es ergibt sich 21 +/- 16
\end{enumerate} 
...
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.71, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
$y = \{14, 15, 19, 14, 8, 19, 19\}$. Berechnen Sie folgende
...
\begin{center}
$9, 11.7, 8.1, 8.4, 8.6, 5.5, 9.3, 8.8, 10.6, 10.7, 12.5, 10, 5.9, 9.6, 8.4$
\end{center}
...
## t = 1.8746, df = 10, p-value = 0.09032
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.6088789  7.0660217
## sample estimates:
...
## t = 1.9694, df = 14, p-value = 0.06903
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.2318858  5.4382350
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 77.85 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 21.11 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 28.494 14.2471     3.8 0.03992
## Residuals 20 74.984  3.7492
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 109 124 121  93 111  97 142 137 157 150 170 134
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 190.95 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 78.23 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 190.16 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 339.67 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 312.84 156.419  8.2983 0.002794
## form       1  13.37  13.368  0.7092 0.410758
## dose:form  2   1.47   0.737  0.0391 0.961736
## Residuals 18 339.29  18.850
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.667 -2.400  0.400  1.383  8.333 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   18.667      1.191  15.673 2.35e-09
## waterB         7.933      1.993   3.981  0.00182
## 
## Residual standard error: 3.573 on 12 degrees of freedom
## Multiple R-squared:  0.5691,	Adjusted R-squared:  0.5331 
## F-statistic: 15.85 on 1 and 12 DF,  p-value: 0.001824
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.5691$ aus? \textbf{(2 Punkte)}
...
## t = 4.1009, df = 8, p-value = 0.003434
...
Einflussvariablen ($x$) wurden erhoben: weight, fertilizier und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.58 & 0 & 12.56 & 102.35 & 67.78 & 6\\
11.43 & 0 & 10.52 & 92.84 & 67.59 & 10\\
10.82 & 0 & 10.11 & 103.59 & 73.84 & 6\\
9.09 & 0 & 11.04 & 100.34 & 71.62 & 17\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.4171 -1.6282  0.1153  1.6833  4.7238 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  7.82129    6.54049   1.196   0.2344
## water       -0.31466    0.14276  -2.204   0.0297
## nematodes    0.13601    0.06658   2.043   0.0435
## Fe           0.63634    0.06327  10.057   <2e-16
## 
## Residual standard error: 2.227 on 106 degrees of freedom
## Multiple R-squared:  0.5224,	Adjusted R-squared:  0.5088 
## F-statistic: 38.64 on 3 and 106 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & so4 & acerage & do2\\
\midrule
PINEY\_RUN & 36 & 2.17 & 10.17 & 11405 & 9.2\\
COLLIER\_RUN & 18 & 0.26 & 17.63 & 6298 & 8.6\\
SOUTH\_FORK\_LINGANORE\_CR & 20 & 2.62 & 5.45 & 4106 & 10.0\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -7.9983  -3.7050  -1.2973   0.6109  21.3852  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.533e+00  1.258e+00   1.219 0.228798
## no3          1.837e-01  7.332e-02   2.506 0.015598
## so4         -2.467e-02  2.766e-02  -0.892 0.376795
## acerage      4.732e-05  1.270e-05   3.727 0.000501
## do2          1.529e-01  1.371e-01   1.115 0.270436
## 
## (Dispersion parameter for quasipoisson family taken to be 35.70451)
## 
##     Null deviance: 1938.6  on 53  degrees of freedom
## Residual deviance: 1240.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.366    -0.766   0.444
## 2 nematodes       0.139    -0.133   0.894
## 3 light           0.457     1.04    0.299
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1585 -0.5707 -0.1309  0.4773  3.5534 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  236.6   15.38   
##  subject  (Intercept) 3928.1   62.67   
##  Residual              676.9   26.02   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.285     26.544   7.658
## attitudepop  -21.239      5.716  -3.715
## 
...
\begin{verbatim}
##          ctrl      high       low       mid
## ctrl 1.00e+00 0.0000001 0.0000385 0.0000346
## high 1.00e-07 1.0000000 0.0316719 0.0343978
## low  3.85e-05 0.0316719 1.0000000 0.9705562
## mid  3.46e-05 0.0343978 0.9705562 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 12, 9, 13, 10 und 19!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 3, 8, 9, 7 und 9! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes grade, freshmatter und pigs an vier verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCAIQG4 & 1.0 | 2.5 | Klein \\
    B & GCBI65J & 2.5 | 1.0 | Klein \\ 
    C & GC2JYCT & 1.5 | 1.5 | Klein \\ 
    D & GCPK70Y & 3.5 | 4.5 | Normal \\ 
    E & GCX7HAM & 2.0 | 3.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 831 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{9, 14, 3\}$ und den Vektor $B = \{1, 1, 0\}$ gegeben.
