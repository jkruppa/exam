...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.03, 0.89, 0.21, 0.42 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.005, 0.1483, 0.035, 0.07 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.18, 1, 1, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.18, 1, 1, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.18, 5.34, 1.26, 2.52 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.005, 0.1483, 0.035, 0.07 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 15, 3, 4, 12 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.2 +/- 5.36
\item [\textbf{B} \msquare] Es ergibt sich 9.2 +/- 28.7
\item [\textbf{C} \msquare] Es ergibt sich 8.2 +/- 14.35
\item [\textbf{D} \msquare] Es ergibt sich 9.2 +/- 2.68
\item [\textbf{E} \msquare] Es ergibt sich 10.2 +/- 2.68
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 18, 13, 14, 27, 12, 24, 26, 21, 10, 23 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 [14, 27]
\item [\textbf{B} \msquare] Es ergibt sich 21 [13, 26]
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 13
\item [\textbf{D} \msquare] Es ergibt sich 21 +/- 26
...
$y = \{16, 15, 14, 20, 12, 18, 19\}$. Berechnen Sie folgende
...
\begin{center}
$5.1, 11.7, 10.2, 12.7, 11.4, 5.3, 12.6, 7.3, 6.2, 11, 12.3, 8.4$
\end{center}
...
## t = 0.18548, df = 10, p-value = 0.8566
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 19.46 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 30.54 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 116.671  58.335  17.601 3.897e-05
## Residuals 20  66.286   3.314
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 114 102 118  98 101  87 133 142 144 154 148 166
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 64.45 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 40.5 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 44.87 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 170.6 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 152.94  76.468  4.4893 0.026198
## form       1 208.09 208.089 12.2167 0.002584
## dose:form  2 295.95 147.976  8.6875 0.002287
## Residuals 18 306.60  17.033
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -7.3333 -2.2500 -0.1667  2.6667  8.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  14.3333     1.5013   9.547 1.65e-07
## trtB         -0.3333     2.2698  -0.147    0.885
## 
## Residual standard error: 4.504 on 14 degrees of freedom
## Multiple R-squared:  0.001538,	Adjusted R-squared:  -0.06978 
## F-statistic: 0.02157 on 1 and 14 DF,  p-value: 0.8853
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -7.1067, df = 8, p-value = 0.0001013
...
Einflussvariablen ($x$) wurden erhoben: block, center und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.96 & 0 & 9.31 & 97.67 & 65.88 & 12\\
10.73 & 0 & 9.57 & 95.33 & 64.39 & 9\\
11.58 & 0 & 10.97 & 97.85 & 69.39 & 8\\
8.68 & 1 & 8.44 & 93.87 & 70.93 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -9.5632 -2.3661  0.4714  2.3338  9.8290 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  83.8503     3.8024  22.052  < 2e-16
## P            -0.8293     0.2433  -3.409 0.000965
## nematodes    -0.0971     0.1190  -0.816 0.416737
## water        -0.5092     0.2582  -1.972 0.051596
## 
## Residual standard error: 3.529 on 93 degrees of freedom
## Multiple R-squared:  0.1461,	Adjusted R-squared:  0.1186 
## F-statistic: 5.305 on 3 and 93 DF,  p-value: 0.002024
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
PINEY\_RUN & 36 & 70 & 2.17 & 10.17 & 11405\\
LIBERTY\_RES & 12 & 62 & 3.49 & 5.82 & 424\\
DEAD\_RUN & 25 & 51 & 0.34 & 44.93 & 4145\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -10.508   -3.836   -1.333    1.924   18.598  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.819e+00  5.543e-01   3.282 0.001902
## maxdepth    8.050e-03  5.239e-03   1.537 0.130840
## no3         1.969e-01  6.211e-02   3.170 0.002624
## so4         1.683e-02  2.011e-02   0.837 0.406706
## acerage     4.068e-05  1.161e-05   3.502 0.000994
## 
## (Dispersion parameter for quasipoisson family taken to be 30.27174)
## 
##     Null deviance: 2025.3  on 53  degrees of freedom
## Residual deviance: 1244.4  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.84      1.76   0.0784
## 2 nematodes       0.194    -0.432  0.666 
## 3 water           0.174    -1.68   0.0939
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4973 -0.5958 -0.0875  0.5186  3.3541 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  204.5   14.30   
##  subject  (Intercept) 3977.4   63.07   
##  Residual              698.5   26.43   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.968     26.622   7.586
## attitudepop  -19.000      5.807  -3.272
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0004050 0.4604471
## high 0.0000000 1.0000000 0.0011805 0.0000001
## low  0.0004050 0.0011805 1.0000000 0.0030879
## mid  0.4604471 0.0000001 0.0030879 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 5, 13, 12, 9 und 10!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 11, 2, 11, 8 und 11! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes leaf, P und grade an drei verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{13, -1, -1\}$ und den Vektor $B = \{7, -2, 0\}$ gegeben.
