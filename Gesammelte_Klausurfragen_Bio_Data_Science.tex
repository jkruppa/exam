...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.01, 0.34 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 0.04, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 0.04, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.08, 0.04, 1.36 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.0025, 0.085 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.0025, 0.085 und 0.0075. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
\item [\textbf{B} \msquare] Der Korrelationskoeffizienten nach Spearman wird genutzt, wenn das Outcome Y normalverteilt ist. Der Korrelationskoeffizienten liegt zwischen -1 und 1.
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 17, 7, 17, 14 und 9.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 13.8 +/- 2.3
\item [\textbf{B} \msquare] Es ergibt sich 12.8 +/- 21.2
\item [\textbf{C} \msquare] Es ergibt sich 12.8 +/- 4.6
\item [\textbf{D} \msquare] Es ergibt sich 11.8 +/- 10.6
\item [\textbf{E} \msquare] Es ergibt sich 12.8 +/- 2.3
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 37, 28, 24, 27, 20, 22 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 29 [22, 37]
\item [\textbf{B} \msquare] Es ergibt sich 27 [22, 37]
\item [\textbf{C} \msquare] Es ergibt sich 27 +/- 22
\item [\textbf{D} \msquare] Es ergibt sich 29 +/- 22
\item [\textbf{E} \msquare] Es ergibt sich 27 +/- 37
\end{enumerate}
...
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.97 liegt keine Overdispersion vor.
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.97 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.86 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.71, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.71, da es sich um ein Anteil handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.42, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 0.04
...
\item [\textbf{C} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.2
\item [\textbf{D} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 0.04
...
$y = \{16, 16, 15, 10, 18, 12, 23, 14, 10, 19, 15\}$. Berechnen Sie folgende
...
\begin{center}
$10.9, 6.7, 8.2, 11.5, 11.6, 10, 10.7, 7.7, 7.4, 11, 7.6, 7.6$
\end{center}
...
## t = -2.8856, df = 16, p-value = 0.01076
...
## t = 0.83819, df = 12, p-value = 0.4183
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -1.990399  4.479288
## sample estimates:
...
## t = -0.46843, df = 12, p-value = 0.6479
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -5.023368  3.245590
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 30.78 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 26.7 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 50.761 25.3803  6.2682 0.007008
## Residuals 22 89.079  4.0491
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 120 103 141  90 107 115 147 150 125 153 143 144
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 17.38 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 106.76 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 134.5 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 240.95 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 452.21 226.105 13.7765 0.0002349
## form       1   9.13   9.133  0.5564 0.4653278
## dose:form  2 121.47  60.737  3.7007 0.0450554
## Residuals 18 295.42  16.412
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 175$ Sauen. In dem Experiment wurde gemessen,
...
## -6.0000 -1.8929 -0.1429  1.6429  7.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.000      1.418  11.990 4.88e-08
## trtB          -1.857      2.005  -0.926    0.373
## 
## Residual standard error: 3.751 on 12 degrees of freedom
## Multiple R-squared:  0.06672,	Adjusted R-squared:  -0.01105 
## F-statistic: 0.8579 on 1 and 12 DF,  p-value: 0.3726
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 7.6122, df = 8, p-value = 6.233e-05
...
Einflussvariablen ($x$) wurden erhoben: dosage, variety und weight. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.29 & 1 & 9.29 & 103.72 & 70.89 & 7\\
8.42 & 0 & 12.76 & 100.33 & 66.86 & 11\\
11.34 & 0 & 8.49 & 95.91 & 64.67 & 8\\
9.27 & 0 & 10.35 & 97.54 & 68.16 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.1804 -2.3177 -0.1617  2.0912 12.2440 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  74.0844     2.6533  27.922   <2e-16
## nematodes    -0.1265     0.1127  -1.123   0.2642
## P            -0.4214     0.2424  -1.739   0.0851
## light         1.7199     0.6896   2.494   0.0142
## 
## Residual standard error: 3.287 on 103 degrees of freedom
## Multiple R-squared:  0.09939,	Adjusted R-squared:  0.07316 
## F-statistic: 3.789 on 3 and 103 DF,  p-value: 0.01266
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & no3 & acerage & do2\\
\midrule
DEER\_CR & 26 & 19.1 & 5.26 & 8297 & 9.9\\
BUSH\_CR & 32 & 18.0 & 2.93 & 19046 & 8.3\\
BLUE\_LICK\_RUN & 1 & 14.3 & 1.20 & 2217 & 8.5\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -7.2710  -3.3531  -0.8008   2.1523  12.8551  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.592e+00  1.420e+00  -1.825 0.074093
## temp         1.427e-01  3.953e-02   3.610 0.000719
## no3          2.567e-01  6.325e-02   4.059 0.000177
## acerage      6.796e-05  1.260e-05   5.393 1.98e-06
## do2          2.341e-01  1.036e-01   2.259 0.028359
## 
## (Dispersion parameter for quasipoisson family taken to be 21.15495)
## 
##     Null deviance: 1912.12  on 53  degrees of freedom
## Residual deviance:  971.13  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.38       2.05 0.0401 
## 2 water           0.140     -2.46 0.0139 
## 3 light           0.469      2.68 0.00740
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1564 -0.6815 -0.0964  0.4681  3.5121 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  233.5   15.28   
##  subject  (Intercept) 4127.9   64.25   
##  Residual              646.6   25.43   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.089     27.143   7.409
## attitudepop  -17.231      5.587  -3.084
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0256078 0.0886424 0.5038929
## high 0.0256078 1.0000000 0.5625120 0.0049700
## low  0.0886424 0.5625120 1.0000000 0.0207857
## mid  0.5038929 0.0049700 0.0207857 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 15, 13, 14, 9 und 10!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 7, 2, 7 und 15! \textbf{(2 Punkte)}
...
die D{"u}nger A bis D sowie die Bl{\"o}cke eins bis drei
vorliegen. Sie messen die Outcomes drymatter, leaf und Fe an zwei verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{5, 13, 3\}$ und den Vektor $B = \{4, 1, 6\}$ gegeben.
