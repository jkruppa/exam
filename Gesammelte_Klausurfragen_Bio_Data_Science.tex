...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.21, 0.02, 0.01 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.1, 0.05 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 4.45, 1.05, 0.1, 0.05 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 0.042, 0.004, 0.002 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.1, 0.05 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 0.042, 0.004, 0.002 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 17, 16, 11, 5 und 5.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.8 +/- 2.88
\item [\textbf{B} \msquare] Es ergibt sich 11.8 +/- 2.88
\item [\textbf{C} \msquare] Es ergibt sich 10.8 +/- 5.76
\item [\textbf{D} \msquare] Es ergibt sich 10.8 +/- 33.2
\item [\textbf{E} \msquare] Es ergibt sich 9.8 +/- 16.6
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 14, 5, 13, 20, 16, 17, 15, 29, 20, 18 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 [15, 21]
\item [\textbf{B} \msquare] Es ergibt sich 17 [14, 20]
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 14
\item [\textbf{D} \msquare] Es ergibt sich 17 +/- 14
\item [\textbf{E} \msquare] Es ergibt sich 17 +/- 20
\end{enumerate} 
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.42, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.42, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 1.4, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.71, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
$y = \{16, 19, 11, 10, 20, 21, 19, 22, 19, 14, 17\}$. Berechnen Sie folgende
...
\begin{center}
$6.6, 8.8, 11.1, 11, 10.8, 6.5, 10, 10.8, 9.7, 11, 13.4, 9.2, 11.1, 11.6, 9.8$
\end{center}
...
Nach einem Experiment mit zwei Substrattypen ($torf$ und $70p30n$) ergibt sich die
...
## t = 3.1539, df = 12, p-value = 0.008314
...
## t = -1.8269, df = 14, p-value = 0.08911
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.2811942  0.5827815
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 40.81 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 72.63 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 82.058  41.029  12.314 0.0002579
## Residuals 22 73.302   3.332
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 0 & 488.26 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 231.46 &  &  &  \strut\\
    \hline
...
Versuch wurde an 25 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: weight
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 717.84  358.92 14.8881 0.0001529
## form       1  15.58   15.58  0.6464 0.4318942
## dose:form  2  58.20   29.10  1.2071 0.3221385
## Residuals 18 433.94   24.11
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -6.5556 -2.3056  0.1222  2.4444  4.8000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.556      1.206  13.730 1.06e-08
## waterB        10.644      2.018   5.276 0.000196
## 
## Residual standard error: 3.617 on 12 degrees of freedom
## Multiple R-squared:  0.6987,	Adjusted R-squared:  0.6736 
## F-statistic: 27.83 on 1 and 12 DF,  p-value: 0.000196
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.6987$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: region, weight und block. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.66 & 1 & 10.26 & 101.96 & 72.64 & 15\\
10.95 & 0 & 11.69 & 106.02 & 73.83 & 11\\
9.67 & 0 & 6.62 & 102.23 & 69.89 & 4\\
10.07 & 0 & 11.84 & 96.34 & 62.59 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.1369 -2.0405  0.3038  1.8821  5.4321 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  6.10239    8.97250   0.680   0.4982
## P           -0.38739    0.17903  -2.164   0.0332
## Fe           0.69372    0.08145   8.518 4.03e-13
## water       -0.19334    0.19229  -1.005   0.3174
## 
## Residual standard error: 2.353 on 88 degrees of freedom
## Multiple R-squared:  0.4996,	Adjusted R-squared:  0.4825 
## F-statistic: 29.29 on 3 and 88 DF,  p-value: 3.177e-13
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & temp & so4 & do2 & no3\\
\midrule
BEAVER\_RUN & 37 & 19.3 & 5.91 & 8.1 & 5.66\\
LITTLE\_CONOCOCHEAGUE\_CR & 15 & 24.0 & 7.60 & 6.8 & 0.33\\
MUDLICK\_RUN & 8 & 21.0 & 16.30 & 7.4 & 0.84\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -8.4835  -4.3509  -2.0273  -0.0447  23.4093  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.597630   2.543176  -0.235    0.815
## temp         0.048850   0.061576   0.793    0.431
## so4         -0.005631   0.027184  -0.207    0.837
## do2          0.337397   0.206497   1.634    0.109
## no3          0.113734   0.096244   1.182    0.243
## 
## (Dispersion parameter for quasipoisson family taken to be 51.46579)
## 
##     Null deviance: 2004.1  on 53  degrees of freedom
## Residual deviance: 1677.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.321   -0.635  0.525  
## 2 light           0.479    2.93   0.00339
## 3 nematodes       0.126   -0.0403 0.968
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 794.2
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0426 -0.6503 -0.0602  0.6762  3.6132 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  221     14.87   
##  subject  (Intercept) 3943     62.79   
##  Residual              653     25.55   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.213     26.538   7.657
## attitudepop  -19.690      5.615  -3.507
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.5742746 0.0000072 0.0352410
## high 0.5742746 1.0000000 0.0000014 0.0093375
## low  0.0000072 0.0000014 1.0000000 0.0035087
## mid  0.0352410 0.0093375 0.0035087 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 13, 8, 9, 10 und 4!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 22, 20, 8, 14 und 13! \textbf{(2 Punkte)}
...
\midrule
walking & 27cm; 27cm; 8.9\% & 19cm; 18cm; 8.9\% & 39cm; 22cm; 12.1\%\\
standing & 34cm; 25cm; 4.1\% & 34cm; 29cm; 4.1\% & 31cm; 31cm; 1.8\%\\
wingflapping & 33cm; 24cm; 1.2\% & 35cm; 24cm; 1.2\% & 39cm; 32cm; 1.2\%\\
drinking/eating & 34cm; 33cm; 13.2\% & 36cm; 18cm; 12.8\% & 35cm; 25cm; 18.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCRC9SY & 5.0 | 1.5 | Normal \\
    B & GC3SJI5 & 2.5 | 4.5 | Mikro \\ 
    C & GCWHB6Y & 3.0 | 3.0 | Klein \\ 
    D & GCVVXTZ & 2.0 | 2.0 | Mikro \\ 
    E & GCTDST2 & 3.5 | 2.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 501 n. Chr. f{\"u}r den neuen Lehnsherren
...
Kaninchenpopulation.
\begin{equation*}
  f(t) = \ensuremath{1.1\times 10^{10}} - \ensuremath{9\times 10^{8}} \cdot 2^{-0.1 \cdot t + 3.4}
\end{equation*}
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  8-mal-gefaltete, 0.8mm, 30-cm-Karton} durch
...
4.1\% p.a. {\"u}ber 72 Monate finanzieren.
...
Sie haben den Vektor $A = \{3, 8, 12\}$ und den Vektor $B = \{4, -1, 3\}$ gegeben.
