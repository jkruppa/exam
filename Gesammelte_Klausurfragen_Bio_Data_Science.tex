...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.02, 0.03, 0.34 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 4.45, 0.1, 0.15, 1.7 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 0.004, 0.006, 0.068 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.1, 0.15, 1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.1, 0.15, 1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 0.004, 0.006, 0.068 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 13, 9, 12 und 2.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.4 +/- 19.3
\item [\textbf{B} \msquare] Es ergibt sich 9.4 +/- 2.195
\item [\textbf{C} \msquare] Es ergibt sich 9.4 +/- 4.39
\item [\textbf{D} \msquare] Es ergibt sich 10.4 +/- 2.195
\item [\textbf{E} \msquare] Es ergibt sich 8.4 +/- 9.65
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 9, 24, 25, 19, 11, 27, 22, 25, 28, 31 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 [20, 29]
\item [\textbf{B} \msquare] Es ergibt sich 25 +/- 28
\item [\textbf{C} \msquare] Es ergibt sich 25 [19, 28]
\item [\textbf{D} \msquare] Es ergibt sich 25 +/- 19
\item [\textbf{E} \msquare] Es ergibt sich 25 +/- 19
\end{enumerate} 
...
$y = \{12, 18, 9, 8, 16, 18, 23, 17, 11, 19, 13\}$. Berechnen Sie folgende
...
\begin{center}
$13.2, 7.6, 4.7, 11.2, 9.6, 9.8, 12.8, 15.4, 12.9, 11.7, 9.2, 10.1, 9.7, 8.7, 8.2$
\end{center}
...
## 
## data:  weight by group
## t = -2.2151, df = 12, p-value = 0.04685
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -9.91815447 -0.08184553
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 32.81 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 51.43 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 42.544 21.2719  12.363 0.0003197
## Residuals 20 34.413  1.7206
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1]  98 110 133 101  98  84 141 146 135 153 146 140
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 6.65 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 229.93 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 280.48 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 348.17 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 492.88 246.438 16.3880 8.842e-05
## form       1  60.55  60.552  4.0267   0.06005
## dose:form  2  76.53  38.263  2.5444   0.10637
## Residuals 18 270.68  15.038
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -2.1111 -1.1111 -0.2222  0.8889  2.8889 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  18.3333     0.4631  39.584  < 2e-16
## trtB         -3.2222     0.6550  -4.919 0.000154
## 
## Residual standard error: 1.389 on 16 degrees of freedom
## Multiple R-squared:  0.602,	Adjusted R-squared:  0.5771 
## F-statistic:  24.2 on 1 and 16 DF,  p-value: 0.000154
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -4.1236, df = 8, p-value = 0.003328
...
\midrule
11.12 & 1 & 8.20 & 97.23 & 72.87 & 15\\
10.65 & 0 & 8.44 & 93.18 & 64.52 & 8\\
11.12 & 1 & 10.12 & 102.18 & 72.56 & 10\\
11.18 & 0 & 11.71 & 101.85 & 68.70 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -9.1104 -1.7844  0.0918  2.1649  8.1812 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 69.60949    2.83291  24.572   <2e-16
## water       -0.03230    0.22307  -0.145    0.885
## light        0.37042    0.74043   0.500    0.618
## nematodes    0.02163    0.10448   0.207    0.836
## 
## Residual standard error: 3.202 on 98 degrees of freedom
## Multiple R-squared:  0.003705,	Adjusted R-squared:  -0.02679 
## F-statistic: 0.1215 on 3 and 98 DF,  p-value: 0.9473
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & no3 & maxdepth & temp\\
\midrule
HAWLINGS\_R & 1 & 8.3 & 2.62 & 73 & 20.5\\
LITTLE\_FALLS & 84 & 10.2 & 3.54 & 56 & 19.5\\
PINEY\_BR & 48 & 8.3 & 4.70 & 52 & 18.9\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -7.528  -4.118  -1.746   1.104  16.436  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.901508   1.844420  -0.489   0.6272
## do2          0.183443   0.140534   1.305   0.1979
## no3          0.158887   0.080244   1.980   0.0533
## maxdepth     0.010761   0.005071   2.122   0.0389
## temp         0.081380   0.046965   1.733   0.0894
## 
## (Dispersion parameter for quasipoisson family taken to be 36.90599)
## 
##     Null deviance: 1917.3  on 53  degrees of freedom
## Residual deviance: 1427.6  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.350    -0.331   0.741
## 2 light           0.442     1.34    0.179
## 3 nematodes       0.144     0.104   0.917
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1502 -0.5718 -0.0985  0.5792  3.4784 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  248.8   15.77   
##  subject  (Intercept) 3964.1   62.96   
##  Residual              641.1   25.32   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.873     26.674   7.568
## attitudepop  -20.321      5.563  -3.653
## 
...
\begin{verbatim}
##           ctrl     high       low       mid
## ctrl 1.0000000 0.000000 0.0000022 0.7286410
## high 0.0000000 1.000000 0.0430430 0.0000000
## low  0.0000022 0.043043 1.0000000 0.0000061
## mid  0.7286410 0.000000 0.0000061 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 8, 10, 9, 5 und 10!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 1, 3, 6 und 12! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes P, pigs und Fe an zwei verschiedenen Messterminen.
...
den {\"a}gyptischen Pyramiden 53 Grad auf. Die durchschnittliche
Seitenl{\"a}nge einer Pyramide ist 34 K{\"o}nigsellen. Eine K{\"o}nigselle
misst 52.6cm.
...
\item Die K{\"o}nigspyramide von Meroe soll eine Seitenl{\"a}nge von 34
  K{\"o}nigsellen haben. Wie hoch wird die K{\"o}nigspyramide werden? \textbf{(1
    Punkt)}
\item Die Au{\ss}enfl{\"a}chen der Pyramide soll begr{\"u}nt werden. F{\"u}r die
  Bepflanzung muss eine 5cm dicke Torfschicht auf die Pyramide aufgebracht
  werden. Berechnen Sie die ungef{\"a}hre Menge an ben{\"o}tigten Torf! \textbf{(2
    Punkte)}
\end{enumerate}
...
chronische Knieschmerzen entwickelt, als die Sklaven von der
...
Sie haben den Vektor $A = \{8, 4, 11\}$ und den Vektor $B = \{7, -1, 0\}$ gegeben.
