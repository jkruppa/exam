...
\fancypagestyle{empty}{
  \fancyfoot[C]{\tiny frTL-vngb-8AvU-znmL}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
wurde an 49 Schweinen durchgef{\"u}hrt, wobei jedes Tier eine von
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 11, 5, 5, 10 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 6.8 +/- 3.85
\item [\textbf{B} \msquare] Es ergibt sich 7.8 +/- 7.7
\item [\textbf{C} \msquare] Es ergibt sich 8.8 +/- 1.385
\item [\textbf{D} \msquare] Es ergibt sich 7.8 +/- 1.385
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 0, -10, 24, 30, 28, 10 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 +/- 0
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 30
\item [\textbf{C} \msquare] Es ergibt sich 19 [1, 31]
\item [\textbf{D} \msquare] Es ergibt sich 19 +/- 0
\item [\textbf{E} \msquare] Es ergibt sich 24 [0, 30]
\end{enumerate} 
...
In dem folgenden Histogramm von $n = 223$ Pflanzen ist welche
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es handelt sich um eine Poisson-Verteilung mit Pois(2).
...
\item [\textbf{D} \msquare] Es handelt sich um eine Normalverteilung mit N(2, 5).
...
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.71, da es sich um eine Chancenverh{"a}ltnis handelt.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.89, 0.01, 0.001, 0.42 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1, 0.06, 0.006, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1, 0.06, 0.006, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 5.34, 0.06, 0.006, 2.52 und 1.26. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0033, 0.1483, 0.0017, 2e-04, 0.07 und 0.035. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0033, 0.1483, 0.0017, 2e-04, 0.07 und 0.035. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\item [\textbf{B} \msquare] Beim multiplen Testen kann es zu Varianzheterogenit{"a}t kommen. Das globale Signifikanzniveau liegt nicht mehr bei $5\%$. Daher m{"u}ssen die p-Werte entsprechend adjustiert werden. Das Verfahren nach Welch, bekannt aus dem t-Test, ist hier h{"a}ufig anzuwenden.
...
\begin{enumerate}
\item [\textbf{A} \msquare] Ist $T_{calc}$ h{"o}her als der kritische Wert $T_{\alpha = 5\%}$ dann wird die Nullhypothese $H_0$ abgelehnt.
...
\item [\textbf{E} \msquare] Anhand der Teststatistik l{"a}sst sich wie folgt eine Entscheidung treffen. Liegt der Wert in dem Signifikanzniveauintervall $\alpha$ dann kann die Nullhypothese abgelehnt werden.
\end{enumerate}
...
\begin{center}
$5, 2, 4, 5, 4, 5, 8, 6, 2, 4, 4, 3, 4, 3, 4, 1, 4, 4, 4, 3, 5, 3, 4, 1, 5, 8, 2$
\end{center}
...
\begin{center}
$9.6, 10.4, 10.4, 12.1, 10.5, 6.8, 11.4, 12.5, 10.3, 11.2, 8.8, 13.3, 7.6, 11.5, 9, 8.2, 8.2, 9.1, 10.3, 7.4$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  (Unbekannte) Wahrheit & $\alpha$-Fehler & $\beta$-Fehler & H$_0$ wahr \\
  \end{tabular}
  \end{center}
...
Eine neue technische Anlage wurde in einem Freilandversuch getestet. Bei dem
...
\item Treffen Sie mit $T_{\alpha = 5\%} = 1.96$ und dem berechneten $T_{calc}$ eine Aussage
  zur Nullhypothese! Begr{\"u}nden Sie Ihre Antwort! \textbf{(2 Punkte)}
...
## t = 0.52157, df = 12, p-value = 0.6115
...
## t = -4.315, df = 12, p-value = 0.001005
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -5.885990 -1.936232
## sample estimates:
...
## t = -0.80464, df = 10, p-value = 0.4397
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -8.076674  3.790959
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{group}  & 2 &  &  &  &  \strut\\
    \hline
   \textbf{error}  & 24 & 51.78 &  &  &  \strut\\
        \hline
   \textbf{total}  & 26 & 146.07 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Faktorstufen \textit{high}, \textit{extreme} und
\textit{neg} vorliegen.
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 327.19 &  &  &  \strut\\
    \hline
   \textbf{error}  & 24 & 177.33 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 224.672 112.336  77.308 1.12e-10
## Residuals 22  31.968   1.453
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 95.92 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 73.08 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 210.17 &  &  &  \strut\\
    \hline
   \textbf{error}  & 32 & 245.17 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 76 Mastschweinen durchgef{\"u}hrt, wobei
jedes Tier eine von drei Selen-Dosen $dose$ ($0.1$ ng/Tag, $3$ ng/Tag und $20$ ng/Tag)
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 322.74 161.371 10.3912 0.0009994
## form       1  30.66  30.664  1.9746 0.1769896
## dose:form  2   0.25   0.124  0.0080 0.9920249
## Residuals 18 279.53  15.529
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0002184 0.0086506 0.0185456
## high 0.0002184 1.0000000 0.0000001 0.1014673
## low  0.0086506 0.0000001 1.0000000 0.0000088
## mid  0.0185456 0.1014673 0.0000088 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.1429 -2.7778  0.2222  1.4722  6.8571 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   20.143      1.287  15.647 2.91e-10
## waterB         6.635      1.716   3.865  0.00171
## 
## Residual standard error: 3.406 on 14 degrees of freedom
## Multiple R-squared:  0.5163,	Adjusted R-squared:  0.4817 
## F-statistic: 14.94 on 1 and 14 DF,  p-value: 0.001715
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.5163$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: height, fertilizier und dosage. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
wingflapping & 31cm; 18cm; 8.1\% & 41cm; 25cm; 0.5\% & 28cm; 17cm; 0.5\%\\
dustbathing & 40cm; 24cm; 1.2\% & 40cm; 18cm; 3.2\% & 31cm; 28cm; 3.2\%\\
drinking/eating & 27cm; 27cm; 1.2\% & 27cm; 27cm; 1\% & 44cm; 21cm; 1\%\\
wing/leg stretching & 37cm; 20cm; 12.8\% & 30cm; 22cm; 16.4\% & 39cm; 25cm; 12.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCX5LR4 & 2.0 | 5.0 | Klein \\
    B & GCB9CAT & 3.5 | 1.0 | Klein \\ 
    C & GCBKISB & 3.0 | 2.5 | Klein \\ 
    D & GCID32W & 4.5 | 3.0 | Mikro \\ 
    E & GC3HY8D & 2.5 | 2.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 164 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{10, 16, -7\}$ und den Vektor $B = \{5, 7, -3\}$ gegeben.
