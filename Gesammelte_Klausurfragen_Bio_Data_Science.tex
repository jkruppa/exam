...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\square$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\begin{graybox}{Endnote}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 63 Punkten sind aus den Rechen- und
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es werden 78\% der Varianz durch die Behandlung erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der von den unterschiedlichen Behandlungsbedingungen nicht erklärt wird.
...
\item [\textbf{D} \msquare] Es werden 22\% der Varianz durch die Behandlung erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der von den unterschiedlichen Behandlungsbedingungen erklärt wird.
...
Die folgende Abbildung enthält die Daten aus einer Studie zur Bewertung der Wirkung von Vitamin C auf das Zahnwachstum bei Kanarienvögel. Der Versuch wurde an 59 Tieren durchgeführt, wobei jedes Tier eine von  drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Welche Aussage ist richtig im Bezug auf eine zweifaktorielle ANOVA?
...
Wie lautet der Mittelwert und Standardabweichung von $y$ mit 13, 5, 14, 7 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es berechnet sich 10.8 +/- 14.7
\item [\textbf{B} \msquare] Es berechnet sich 9.8 +/- 14.7
\item [\textbf{C} \msquare] Es ergibt sich 8.8 +/- 7.35
\item [\textbf{D} \msquare] Es ergibt sich 9.8 +/- 3.83
\item [\textbf{E} \msquare] Es ergibt sich 10.8 +/- 1.915
\end{enumerate} 
...
Gegeben ist $y$ mit 11, 30, 21, 13, 6, 34 und 51. Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile.




\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 +/- 11
\item [\textbf{B} \msquare] Sie erhalten 21 [9; 32]
\item [\textbf{C} \msquare] Sie erhalten 21 [11; 34]
\item [\textbf{D} \msquare] Es ergibt sich 21 +/- 11
\item [\textbf{E} \msquare] Es berechnet sich 24 [12; 35]
\end{enumerate} 
...
Bevor Sie in Ihrer Abschlussarbeit einen statistischen Test rechnen, wollen Sie einmal betrachten, welcher Verteilung Ihre $n = 195$ geernteten Pflanzen folgen.  Welche Verteilung ist abgebildet?
...
\item [\textbf{C} \msquare] Wir modellieren den Zusammenhang zwischen $X$ und $Y$ wenn ein prädiktives Modell rerechnet wird. Dabei kann nicht der gesamte Datensatz genutzt werden. Es wird ein Trainingsdatensatz zum Trainieren des Modells benötigt.
...
Sie haben ein Feldexperiment mit Spitzkohl durchgeführt und wollen nun in einer simplen linearen Regression den Einfluss der $PO_2$-Konzentration in [$\mu g$] im Wasser auf den absoluten Proteingehalt in [$kg$] untersuchen. Sie erhalten einen $\beta_{PO_2}$ Koeffizienten von $7.4\times 10^{-6}$ und einen $p$-Wert mit $0.00051$. Welche Aussage zu der Signifikanz und dem Effekt ist richtig?
...
\item [\textbf{D} \msquare] Manchmal ist die Einheit der Einflussvariable $X$ zu groß gewählt, so dass der Ansteig von 1 Einheit in $X$ zu einer zu großen Änderung in $y$ führt. Daher kann der Effekt $\beta_{PO_2}$ sehr klein wirken, da der p-Wert wird auf einer einheitslosen Teststatistik bestimmt wird.
...
\begin{enumerate}
\item [\textbf{A} \msquare] Das Verhältnis von Chancen Risk ratio ergibt ein Chancenverhältnis von 0.25.
\item [\textbf{B} \msquare] Da es sich um ein Chancenverhältnis handelt ergibt sich ein Risk ratio von 5.
\item [\textbf{C} \msquare] Das Verhältnis der Anteile Risk ratio ergibt ein Anteilsverhältnis von 0.2. Wir sind am Anteil der Kranken interessiert.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.42, 0.03, 0.21 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.15, 1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 0.084, 0.006, 0.042 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 4.45, 2.1, 0.15, 1.05 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 0.084, 0.006, 0.042 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.15, 1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate}
...
\item [\textbf{B} \msquare] Die Barplots deuten auf keinen signifikanten Unterschied. Der Effekt liegt vermutlich bei -2 unter einer groben Abschätzung. Wir müssen aber eine ANOVA rechnen um den Effekt wirklich bestimmen zu können.
\item [\textbf{C} \msquare] Nach Betrachtung des Barplots liegt kein signifikanter Unterschied vor. Der Effekt liegt bei -2.
\item [\textbf{D} \msquare] Die Barplots deuten auf einen signifikanten Unterschied. Der Effekt liegt vermutlich bei -2. Wir müssen aber einen Posthoc-Test rechnen um den Effekt wirklich bestimmen zu können.
...
Jonas steht vor einem ersten Problem, denn wenn es nach seiner Betreuer geht, soll er in einem einem Feldexperiment Erbsen auswertet. Soweit eigentlich alles passend. Die Behandlung werden verschiedene Bewässerungstypen ($low$, $mid$ und $high$) sein. In seiner Exceldatei wird er den Endpunkt ($Y$) \textit{Trockengewicht} als \textit{drymatter} aufnehmen. Vorab soll Jonas aber eimal die folgenden Barplots seiner Betreuer nachbauen, damit er den \Rlogo Code schonmal für später vorliegen hat. Damit geht das Problem schon los.
...
Boxplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Paula nicht gemerkt, welche statistischen Maßzahlen für einen Boxplot erhoben werden müssen. Das ist in soweit doof, da nach ihrem Betreuer erstmal ein Boxplot nachgebaut werden soll, bevor es mit ihrer Abschlussarbeit losgeht. Anhand von Boxplots lässt sich eine Aussage über die Varianzhomogenität über die Behandlungsgruppen treffen. Dann hat sie schonmal den \Rlogo Code vorliegen und nachher geht dann alles schneller. Die Behandlung für Kartoffeln werden verschiedene Bewässerungstypen ($low$, $mid$ und $high$) sein. Erfasst wird als Outcome ($Y$) \textit{Ertrag}. Paula soll dann \textit{yield} in ihrer Exceldatei eintragen.
...
In einem Gespräch mit ihrem Betreuer wird Paula gebeten seine Daten aus einem Stallexperiment mit Schweinen in einem Histogramm darzustellen. In ihrem Experiment hat er die mittlere Anzahl an weißen Blutkörperchen erst fotographiert und dann ausgezählt. Laut ihrem Betreuer soll das Histogramm helfen, die Verteilung der die mittlere Anzahl an weißen Blutkörperchen zu bestimmen.

\begin{center}
Die mittlere Anzahl an weißen Blutkörperchen: 11.8, 10.9, 8.1, 8.6, 10.9, 6.3, 8.9, 9, 9.8, 9.8, 11, 10.9, 9.7, 11.8, 10.1, 8.8, 10.2, 10.6, 12, 10.8, 7, 9.7, 6.2, 4.7, 8.6
\end{center}
...
Tina liest laut: 'Wenn zwei kontinuierliche Variablen vorliegen, können diese in einer exploartiven Datenanalyse...'. Tina stoppt. Was waren noch gleich kontinuierliche Variablen? In ihrem Projektbericht hatte sie einen Leistungssteigerungsversuch in der Uckermark durchgeführt. Dabei ging es um den Zusammenhang zwischen Fettgehalt [\%/kg] und durchschnittlichen Bewegungsscore [Movement/h] im groben Kontext von Schweinen. Nun stellt sich die Frage für sie, ob es überhaupt einen Zusammenhang zwischen den gemessenen Variablen gibt. Dafür war eine explorative Datenanalyse gut!
...
Zwei kategoriale Variablen darzustellen ist nicht so einfach. Tina hatte erst über einen Mittelwert nachgedacht, dann aber die Idee verworfen. In einen Leistungssteigerungsversuch in der Uckermark hatte sie sich zum einen die Behandlung Automatische Fütterung [ja/nein] und zum anderen die Messung Schlachtgewicht im Zielbereich [ja/nein] im Kontext von Schweinen angeschaut. Jetzt möchte ihr Betreuer erstmal die langen Tabellen mit ja/nein in einer explorativen Datenanalyse zusammengefasst bekommen. Sonst geht es bei ihrer Abschlussarbeit nicht weiter.
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ falsch & H$_0$ wahr & 20\% & $\beta$-Fehler \\
  \end{tabular}
  \end{center}
...
Jonas ist in der Uckermark für einen Pilotexperiment mit sehr geringer Fallzahl $(n_1 = n_2 = 3)$ mit Schweinen. Allein diese Tatsache ist für ihn eine Erzählung wert. Für seinen Projektbericht musste er einen Leistungssteigerungsversuch mit Schweinen durchführen und das sollte laut seinem Betreuer an diesem Ort besonders gut gelingen, da man hier gut neue technische Anlagen und Behandlungen fernab der Bevölkerung testen könne. Zeugen gibt es hier jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn seine Behandlung Lüftungssystem ($keins$ und $vorhanden$) und der Messwert Gewichtszuwachs in der 1LW sollen mit einem t-Test ausgewertet werden. Immerhin weiß er, dass sein Messwert einer Normalverteilung folgt. 
...
Die Uckermark, unendliche Weiten. Wir schreiben das Jahr 2024. Dies sind die Abenteuer von Nilufar, die mit ihrer 1 Frau starken Besatzung 12 Wochen lang unterwegs ist, um neue Welten zu erforschen, neues Leben und neue Zivilisationen. 'Oder nennen wir es Ödnis und Verzweiflung', denkt Nilufar. Für ihren Projektbericht ist Nilufar ins Nichts gezogen. Was macht sie nun? Nilufar hat einen Leistungssteigerungsversuch mit Schweinen durchgeführt. Die Behandlung Flüssignahrung ($ctrl$ und $flOw$) wurde an Schweinen getestet. Gemessen hat sie dann als ein normalverteiltes Outcome ($Y$) Gewichtszuwachs in der 1LW. Jetzt soll sie ihrer Betreuerin nach testen, ob die Behandlung Flüssignahrung ($ctrl$ und $flOw$) ein signifikantes Ergebnis liefert.
...
'Der t-Test testet einen normalverteilten Messwert ($Y$).', liest Tina laut. Das hilft jetzt auch nur bedingt weiter. Laut ihrem Betreuer ist zwar ihr Messwert Gewichtszuwachs in der 1LW normalverteilt, aber wie rechnet sie jetzt einen t-Test? Für ihrer Hausarbeit musste sie ein Kreuzungsexperiment mit Schweinen im Wendland durchführen. Als wäre das nicht schon anstrengend genug gewesen. Jetzt soll sie auch noch testen, ob die Behandlung Lüftungssystem ($keins$ und $vorhanden$) ein signifikantes Ergebnis liefert.
...
Alles voll mit Schweinen. Das haben Jonas und Steffen gemeinsam in einer Hausarbeit gemacht! Worum ging es aber konkret? Beide haben als einen normalverteilten Messwert ($Y$) Protein/Fettrate [\%/kg] von Schweinen bestimmt. Die Daten haben beide zusammen in einem Stallexperiment erhoben. In dem Experiment ging es um eine vorher/nachher Untersuchung an den gleichen Schweinen. Als Behandlung wurde Ernährungszusatz ($ohne$ und $14d$) eingesetzt. Nach der Meinung des Betreuers muss hier ein gepaarter t-Test gerechnet werden.
...
Almería. Spanien. Sonne und Strand. Steffen und Mark haben ihren gemeinsamen Auslandsaufenthalt sichtlich genossen. Dann hatte sich auch noch angeboten ihre Abschlussarbeit gemeinsam in Almería durchzuführen. Nur muss jetzt alles in \Rlogo gerechnet werden, da \Rlogo international der Standard in der Datenauswertung ist und die Betreuer in Spanien nur \Rlogo können. Während beide Tina Oliven füttern, hoffen sie mehr Informationen von ihr über ihr seltsamen \Rlogo Ausgabe des t-Tests. Immerhin erinnern beide sich an die Behandlung Lüftungssystem ($keins$ und $vorhanden$) und das es um Schweinen ging.
...
## t = 3.8975, df = 19, p-value = 0.0009683
...
Helfen Sie Tina bei der Interpretation des t-Tests! Sonst geht es auch für Steffen und Mark nicht weiter.
...
'Programmieren ist wie eine Sprache lernen. Man muss es nur machen, dann wird man mit der Zeit immer besser!', gibt Tina zwinkernd zu Protokoll. Das hilft jetzt Jonas und Nilufar nur bedingt, da beide jetzt die \Rlogo Ausgabe interpretieren müssen und nicht vor drei Wochen, wo noch Zeit gewesen wäre. Die beiden hatten im Teuteburgerwald einen Versuch mit Schweinen in einem Kreuzungsexperiment durchgeführt. Das war schon anstrengend genug! 'Wir haben Schlachtgewicht [kg] gemessen, vieleicht hilft das ja...', meint Nilufar leicht genervt. Alle starren auf die \Rlogo Ausgabe des t-Tests.
...
## t = -4.0428, df = 17, p-value = 0.0008452
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -24.434542  -7.676569
## sample estimates:
...
Helfen Sie Tina bei der Interpretation des t-Tests! Sonst geht es auch für Jonas und Nilufar nicht weiter.
...
Almería. Spanien. Sonne und Strand. Alex und Tina haben ihren gemeinsamen Auslandsaufenthalt sichtlich genossen. Dann hatte sich auch noch angeboten ihre Abschlussarbeit gemeinsam in Almería durchzuführen. Nur muss jetzt alles in \Rlogo gerechnet werden, da \Rlogo international der Standard in der Datenauswertung ist und die Betreuer in Spanien nur \Rlogo können. Während beide Jonas Oliven füttern, hoffen sie mehr Informationen von ihr über ihm seltsamen \Rlogo Ausgabe des t-Tests. Immerhin erinnern beide sich an die Behandlung Flüssignahrung ($ctrl$ und $flOw$) und das es um Schweinen ging.
...
## t = -1.981, df = 18, p-value = 0.06308
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -13.4684290   0.3957018
## sample estimates:
...
Alles voll mit Schweinen. Aber das haben Tina und Mark eben gemeinsam in einer Hausarbeit gemacht! Worum ging es aber konkret? Beide haben als einen normalverteilten Messwert ($Y$) Schlachtgewicht [kg] von Schweinen bestimmt. Die Daten haben beide zusammen in einem Stallexperiment erhoben. In dem Experiment ging es um eine vorher/nachher Untersuchung an den gleichen Schweinen. Als Behandlung wurde Bestandsdichte ($hoch$ und $niedrig$) eingesetzt. Nach der Meinung des Betreuers muss hier ein gepaarter t-Test gerechnet werden. Leider kennen sich beide nicht sehr gut in \Rlogo aus.
...
## t = -5.3175, df = 8, p-value = 0.0007131
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -19.704858  -7.784031
## sample estimates:
...
Tina und Jessica schauen sich etwas entnervt an. Gemeinsam schreiben die beiden ihre Abschlussarbeit und sollen nun als erstes einmal die Daten visualisieren damit abgeschätzt werden kann, ob überhaupt signifikante Ergebnisse zu erwarten sind. Die beiden waren im Teuteburgerwald um einen Leistungssteigerungsversuch mit Schweinen durchzuführen. Dabei haben Tina und Jessica den Messwert Schlachtgewicht [kg] unter der Behandung Lüftungssystem ($keins$, $storm$ und $thunder$) ermittelt.
...
Leider kennen sich Tina und Jessica mit Darstellung einer einfaktoriellen ANOVA überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe! 
...
'Als erstes bauen wir uns aus unsere Daten die ANOVA Tabelle dann sehen wir schon, ob unser Gruppenvergleich in der ANOVA signifikant ist.', Nilufar schaut Jonas fragend an und hofft auf eine positive Regung im Gesicht. Wird aber enttäuscht. Jonas tut sich auch sehr schwer mit der einfaktoriellen ANOVA. Beide waren im Teuteburgerwald um ein Kreuzungsexperiment mit Schweinen durchzuführen. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Lüftungssystem ($keins$, $storm$, $tornado$ und $thunder$) und dem Messwert Fettgehalt [\%/kg] gibt.
...
\toprule
    ...
    \midrule
   \textbf{Lüftungssystem}  & 3 & 4094.62 &  &  &  \strut\\
   \textbf{error}  & 20 & 1886.71 &  &  &  \strut\\
...
'Als erstes bauen wir uns aus unsere Daten die ANOVA Tabelle dann sehen wir schon, ob unser Gruppenvergleich in der ANOVA signifikant ist.', Mark schaut Steffen fragend an und hofft auf eine positive Regung im Gesicht. Wird aber enttäuscht. Steffen tut sich auch sehr schwer mit der einfaktoriellen ANOVA. Nun möchte erstmal ihre Betreuung der Arbeit eine ANOVA Tabelle sehen. Was immer da auch drin zu erkennen sein mag. Beide waren im Teuteburgerwald um ein Kreuzungsexperiment mit Schweinen durchzuführen. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Elterlinie ($ctrl$, $Standard$, $Yray$ und $Xray$) und dem Messwert Fettgehalt [\%/kg] gibt.



\vspace{1ex}

Leider kennen sich Mark und Steffen mit Berechnung einer einfaktoriellen ANOVA überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe! 
...
\toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Elterlinie}  & 3 & 301.92 &  &  &  \strut\\
   \textbf{Error}  & 23 & 327.71 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
Nilufar schaut sich fragend in der Bibliothek um. Nilufar hatte gehofft, dass jemand hier sein würde, den sie kennt und sich mit \Rlogo auskennt. Wird aber enttäuscht. Nilufar war im Teuteburgerwald um einen Leistungssteigerungsversuch mit Schweinen durchzuführen. Nun möchte ihr Betreuer ihrer Abschlussarbeit erstmal eine ANOVA sehen und die Ergebnisse präsentiert bekommen. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Elterlinie ($ctrl$, $Standard$, $Yray$ und $Xray$) und dem Messwert Fettgehalt [\%/kg] gibt.
...
## Elterlinie  3 2380.7  793.58  10.331 0.0001921
## Residuals  22 1689.9   76.81
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Jessica steht im Teuteburgerwald. Und das ist noch langweiliger als es sich anhört. Wäre es nur so spannend wie bei ihren Kommilitonen, die in Almería waren. Ödnis wohin man nur blickt. Oder eben Schweinen. Ja, darum geht es in ihrem Projektbericht. Und wäre das nicht noch alles genug, ist ihr Experiment auch noch als ein Stallexperiment komplex geraten. Es wurde der Messwert Fettgehalt [\%/kg] mit dem Behandlung Elterlinie ($ctrl$, $Standard$, $Yray$ und $Xray$) sowie der Behandlung Flüssignahrung ($ctrl$ und $flOw$) untersucht. 'Hmpf', denkt Jessica und ruft 'Und jetzt!?' in die Leere.
...
\begin{center}
  ...
  \toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Elterlinie}  & 3 & 200.95 &  &  &  \strut\\
    \textbf{Flüssignahrung}  & 1 & 465.4 &  &  &  \strut\\
    \textbf{Elterlinie:Flüssignahrung}  & 3 & 51.76 &  &  &  \strut\\
   \textbf{Error}  & 18 & 282.73 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
\midrule
  ...
  \textbf{Elterlinie:Flüssignahrung} & $5.23$ \\
  \bottomrule
  \end{tabular}
\end{center}
...
\item Was sagt der Term \textit{Elterlinie:Flüssignahrung} aus? Interpretieren Sie das Ergebnis! \textbf{(2 Punkte)}
\end{enumerate}
...
In ein Stallexperiment wurden Schweinen mit der Behandlung Flüssignahrung ($ctrl$, $superIn$ und $flOw$) sowie der Behandlung Ernährungszusatz ($ctrl$ und $getIt$) untersucht. Es wurde als Messwert Schlachtgewicht [kg] bestimmt. Jetzt starrt Mark mit auf die \Rlogo Ausgabe einer zweifaktoriellen ANOVA. Leider starrt seine Betreuerin in der gleichen Art Mark zurück an. Das wird ein langer Nachmmittag, denkt er sich und kreuselt seinen Mund. 'Und was machen wir jetzt?' entfährt es ihm überrascht entnervt. Immerhin war geht es ja um seine Hausarbeit. Mark hätte doch nichts mit Schweinen machen sollen. Schweinen -- was soll das auch bedeutendes sein?
...
##                                 Df Sum Sq Mean Sq F value    Pr(>F)
## Flüssignahrung                   2 198.56  99.279   7.193 0.0050610
## Ernährungszusatz                 1 166.79 166.792  12.085 0.0026949
## Flüssignahrung:Ernährungszusatz  2 375.02 187.512  13.586 0.0002533
## Residuals                       18 248.44  13.802
\end{verbatim}
\end{kframe}
\end{knitrout}
...
In ein Kreuzungsexperiment mit Schweinen wurde die Behandlung Lüftungssystem ($keins$, $storm$, $tornado$ und $thunder$) gegen die Ergebnisse einer früheren Studie von Almar et al. (2012) verglichen. Im Rahmen des Experiments haben Steffen und Alex verschiedene Student t-Tests für den Mittelwertsvergleich für den Messwert Schlachtgewicht [kg] gerechnet. Es ergab sich dann die folgende Tabelle der rohen p-Werte für die Vergleiche zu Almar et al. (2012).
...
Leider kennen sich Steffen und Alex mit der Adjustierung von $p$-Werten und dem Signifikanzniveau $\alpha$ überhaupt nicht aus. Deshalb brauchen bei der Erstellung Ihre Hilfe!
...
Leider kennen sich Mark und Steffen mit dem \textit{Compact letter display (CLD)} überhaupt nicht aus. Deshalb brauchen bei der Erstellung Ihre Hilfe!
...
'Wir müssen als erstes die Gruppen nach absteigender Effektstärke sortieren!', ruft Paula ganz aufgeregt. 'Das habe ich mir gemerkt.', blinzelt sie Jonas an. Mark hebt die Augenbraue. Als ob das jetzt so viel weiter helfen würde.
 ...
 In einem Experiment für mit vier
...
\begin{tabular}{>{}lcccc}
\toprule
\textbf{ } & \textbf{ctrl} & \textbf{Standard} & \textbf{Yray} & \textbf{Xray}\\
\midrule
\textbf{ctrl} & 1.0000 & 0.1382 & 0.7936 & 0.3519\\
\textbf{Standard} & 0.1382 & 1.0000 & 0.0850 & 0.5286\\
\textbf{Yray} & 0.7936 & 0.0850 & 1.0000 & 0.2339\\
\textbf{Xray} & 0.3519 & 0.5286 & 0.2339 & 1.0000\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
Leider kennen sich Paula und Jonas mit dem \textit{Compact letter display (CLD)} überhaupt nicht aus. Deshalb brauchen bei der Erstellung Ihre Hilfe!  
...
Leider kennen sich Paula und Jonas mit der Erstellung einer Datenanalyse für kontinuierliche Daten überhaupt nicht aus. Deshalb brauchen bei der Erstellung Ihre Hilfe!
...
## -3.4444 -1.4444 -0.4222  1.5889  4.5556 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  19.4444     0.8357  23.268 2.37e-11
## waterB        6.9556     1.3984   4.974 0.000323
## 
## Residual standard error: 2.507 on 12 degrees of freedom
## Multiple R-squared:  0.6734,	Adjusted R-squared:  0.6462 
## F-statistic: 24.74 on 1 and 12 DF,  p-value: 0.000323
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.6734$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: region, dry und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
mit insgesamt 4 Leveln dar. Der zweite Faktor mit dem Feld
beinhaltet
4 Level. \\
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2022 blieben die Erträge von Blaubeeren mit \ensuremath{7.5\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge reduzierte sich um 7.2\%. Die Exporte für Avocados stiegen in dem gleichen Zeitraum um 18.1\% auf \ensuremath{2.3\times 10^{5}}t.
...
\midrule
dustbathing & 29cm; 23cm; 4.1\% & 32cm; 22cm; 1.8\% & 38cm; 33cm; 3.5\%\\
walking & 34cm; 21cm; 1.2\% & 26cm; 27cm; 0.5\% & 37cm; 23cm; 8.1\%\\
wingflapping & 34cm; 31cm; 8.1\% & 47cm; 26cm; 5.2\% & 29cm; 36cm; 3.6\%\\
preening & 39cm; 24cm; 0.8\% & 42cm; 31cm; 1\% & 29cm; 40cm; 0.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCKUOOC & 2.0 | 3.5 | Normal \\
    B & GCRCAT0 & 1.5 | 5.0 | Normal \\ 
    C & GCV5IAW & 1.0 | 2.5 | Klein \\ 
    D & GCJF25H & 5.0 | 1.0 | Mikro \\ 
    E & GCLKEMD & 2.5 | 2.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 722 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{10^{9}} \cdot 2.3^{-0.2 \cdot t + 2.4}
\end{equation*}
