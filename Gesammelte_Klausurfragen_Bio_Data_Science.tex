...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.42, 0.01, 0.34 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.084, 0.002, 0.068 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 1, 0.05, 1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 2.1, 0.05, 1.7 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.15, 1, 0.05, 1 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.084, 0.002, 0.068 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 15, 10, 8, 11 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.2 +/- 1.295
\item [\textbf{B} \msquare] Es ergibt sich 11.2 +/- 2.59
\item [\textbf{C} \msquare] Es ergibt sich 11.2 +/- 6.7
\item [\textbf{D} \msquare] Es ergibt sich 10.2 +/- 3.35
\item [\textbf{E} \msquare] Es ergibt sich 12.2 +/- 1.295
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 27, 4, 21, 14, 11, 23, 13, 13, 24, 31 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 +/- 13
\item [\textbf{B} \msquare] Es ergibt sich 21 [14, 28]
\item [\textbf{C} \msquare] Es ergibt sich 21 [13, 27]
\item [\textbf{D} \msquare] Es ergibt sich 21 +/- 13
\item [\textbf{E} \msquare] Es ergibt sich 21 +/- 27
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 2.67, da es sich um ein Anteil handelt.
...
$y = \{16, 15, 15, 10, 11, 17, 15, 13, 11, 16, 13\}$. Berechnen Sie folgende
...
\begin{center}
$7, 11, 10.7, 8.6, 11, 10.7, 9.8, 12.3, 10.2, 7.8, 10.3, 10.8, 11.9, 11.5$
\end{center}
...
## 
## data:  drymatter by Fe
## t = 2.1374, df = 16, p-value = 0.04835
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  0.02730125 6.63936542
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 134.64 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 30.32 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  7.020  3.5100  1.4644  0.255
## Residuals 20 47.937  2.3968
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 133 130 105  94  98 111 173 151 142 146 148 156
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 115.02 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 437.75 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 126.06 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 496.96 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2   8.67   4.333  0.2329 0.794591
## form       1  65.78  65.784  3.5361 0.076329
## dose:form  2 331.53 165.763  8.9103 0.002043
## Residuals 18 334.87  18.604
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -7.5556 -0.8889  0.1111  0.9444 10.4444 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.889      1.234  14.502 1.27e-10
## trtB          -3.333      1.744  -1.911   0.0741
## 
## Residual standard error: 3.701 on 16 degrees of freedom
## Multiple R-squared:  0.1858,	Adjusted R-squared:  0.1349 
## F-statistic: 3.651 on 1 and 16 DF,  p-value: 0.07412
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -3.3762, df = 8, p-value = 0.009697
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, rainfall und N. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.96 & 1 & 8.81 & 100.35 & 74.19 & 11\\
11.46 & 0 & 12.83 & 98.51 & 66.90 & 9\\
10.82 & 1 & 7.64 & 98.82 & 71.18 & 11\\
10.65 & 1 & 8.35 & 98.22 & 68.71 & 13\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.0781 -1.6987  0.0608  1.5203  5.4823 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  4.81386    6.21238   0.775     0.44
## P           -0.80910    0.14727  -5.494    3e-07
## nematodes    0.10730    0.06843   1.568     0.12
## Fe           0.72292    0.06334  11.413   <2e-16
## 
## Residual standard error: 2.154 on 100 degrees of freedom
## Multiple R-squared:  0.5925,	Adjusted R-squared:  0.5803 
## F-statistic: 48.48 on 3 and 100 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & maxdepth & temp & no3 & so4\\
\midrule
LITTLE\_DEER\_CR & 38 & 110 & 20.5 & 3.40 & 9.22\\
NORTH\_BR\_CASSELMAN\_R & 16 & 48 & 18.0 & 0.29 & 2.50\\
SOUTH\_BR\_CASSELMAN\_R & 2 & 46 & 18.5 & 0.64 & 21.16\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.147  -4.707  -2.038   1.431  17.317  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.399893   0.992759   1.410   0.1648
## maxdepth     0.011920   0.004456   2.675   0.0101
## temp         0.053433   0.044749   1.194   0.2382
## no3          0.188957   0.091621   2.062   0.0445
## so4         -0.019737   0.027834  -0.709   0.4816
## 
## (Dispersion parameter for quasipoisson family taken to be 44.20603)
## 
##     Null deviance: 2332.0  on 53  degrees of freedom
## Residual deviance: 1739.4  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.58     1.89    0.0584
## 2 nematodes       0.151   -0.0485  0.961 
## 3 water           0.144   -1.99    0.0470
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0810 -0.5655 -0.1118  0.5044  3.6465 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  201.4   14.19   
##  subject  (Intercept) 3937.6   62.75   
##  Residual              753.1   27.44   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   204.64      26.51   7.718
## attitudepop   -20.87       6.03  -3.461
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0241715 0.1561967 0.0001380
## high 0.0241715 1.0000000 0.3673237 0.0585188
## low  0.1561967 0.3673237 1.0000000 0.0071029
## mid  0.0001380 0.0585188 0.0071029 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 15, 13, 8, 7 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 12, 7, 17 und 3! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes leaf, freshmatter und drymatter an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCIMMGB & 3.5 | 4.5 | Mikro \\
    B & GCUX5HE & 1.0 | 3.0 | Normal \\ 
    C & GC5A7VN & 2.5 | 1.5 | Mikro \\ 
    D & GCO2PUR & 4.0 | 5.0 | Klein \\ 
    E & GCWP7LZ & 5.0 | 3.5 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 897 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{14, 8, 2\}$ und den Vektor $B = \{2, 3, -1\}$ gegeben.
