...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.03, 0.001, 0.01 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 0.005, 0.05 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.05, 0.15, 0.005, 0.05 und 1.7. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 0.005, 0.05 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.006, 2e-04, 0.002 und 0.068. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 0.006, 2e-04, 0.002 und 0.068. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 22, 7, 8, 1 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.8 +/- 3.865
\item [\textbf{B} \msquare] Es ergibt sich 9.8 +/- 3.865
\item [\textbf{C} \msquare] Es ergibt sich 9.8 +/- 59.7
\item [\textbf{D} \msquare] Es ergibt sich 8.8 +/- 29.85
\item [\textbf{E} \msquare] Es ergibt sich 9.8 +/- 7.73
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 39, 27, 19, 22, 26, 19, 28, 20, 22, 20 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 [20, 28]
\item [\textbf{B} \msquare] Es ergibt sich 22 +/- 28
\item [\textbf{C} \msquare] Es ergibt sich 27 +/- 20
\item [\textbf{D} \msquare] Es ergibt sich 22 +/- 20
\item [\textbf{E} \msquare] Es ergibt sich 27 [20, 28]
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.94 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt drei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.94 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung von nur zwei der drei Verteilungsparameter: $\gamma_1$ und $\gamma_3$.
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.94 liegt keine Overdispersion vor.
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.46, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 1.17, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.86, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.86, da es sich um ein Anteil handelt.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -2.98
...
\item [\textbf{D} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 8.85
\item [\textbf{E} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 8.85
\end{enumerate}
...
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 5
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 8
...
$y = \{18, 17, 16, 14, 16, 17, 14, 20, 16, 16, 17\}$. Berechnen Sie folgende
...
\begin{center}
$11.7, 12.7, 9.1, 8.6, 9.6, 8.3, 10.6, 8.3, 11.3, 7.5, 10.4, 10.7, 10.1, 9.8, 10.8$
\end{center}
...
## t = -0.82701, df = 10, p-value = 0.4275
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.905293  1.791007
## sample estimates:
...
## t = -0.74685, df = 14, p-value = 0.4675
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -6.575861  3.179036
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 2.57 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 57.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 60.795 30.3975  22.636 7.294e-06
## Residuals 20 26.857  1.3429
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 125 114 115 107  93 113 123 140 138 148 149 149
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 176.67 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 194.19 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 58.62 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 760.73 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2 432.51 216.256  7.5158 0.004237
## form       1   1.42   1.417  0.0493 0.826860
## dose:form  2 257.41 128.703  4.4730 0.026486
## Residuals 18 517.92  28.774
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   90  \strut\\
    \hline
...
##  -5.00  -1.00   0.40   2.15   4.00 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   17.000      1.442  11.787 2.46e-06
## trtB          -0.400      2.040  -0.196    0.849
## 
## Residual standard error: 3.225 on 8 degrees of freedom
## Multiple R-squared:  0.004785,	Adjusted R-squared:  -0.1196 
## F-statistic: 0.03846 on 1 and 8 DF,  p-value: 0.8494
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: center, rainfall und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.75 & 0 & 11.24 & 96.71 & 65.68 & 7\\
8.78 & 0 & 7.68 & 104.03 & 73.67 & 13\\
11.29 & 0 & 11.23 & 97.82 & 67.77 & 8\\
11.82 & 0 & 11.05 & 99.06 & 72.76 & 8\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -9.5352 -2.5395  0.1056  2.0131  9.0598 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  79.6315     2.6225  30.364  < 2e-16
## P            -0.8543     0.2259  -3.781 0.000268
## nematodes    -0.1868     0.1098  -1.701 0.092193
## light         0.2526     0.8285   0.305 0.761093
## 
## Residual standard error: 3.497 on 98 degrees of freedom
## Multiple R-squared:  0.1396,	Adjusted R-squared:  0.1132 
## F-statistic: 5.298 on 3 and 98 DF,  p-value: 0.001992
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & acerage & temp & maxdepth\\
\midrule
FISHING\_CR & 11 & 7.6 & 5046 & 19.0 & 109\\
TUSCARORA\_CR & 38 & 9.3 & 10274 & 15.0 & 90\\
BEAVER\_RUN & 37 & 8.1 & 1722 & 19.3 & 43\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -10.272   -3.974   -1.684    1.359   14.057  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -1.802e+00  1.740e+00  -1.036 0.305484
## do2          1.831e-01  1.326e-01   1.380 0.173830
## acerage      2.085e-05  1.638e-05   1.273 0.209110
## temp         1.267e-01  4.372e-02   2.898 0.005603
## maxdepth     1.583e-02  4.381e-03   3.614 0.000709
## 
## (Dispersion parameter for quasipoisson family taken to be 35.42501)
## 
##     Null deviance: 2290.4  on 53  degrees of freedom
## Residual deviance: 1471.4  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.51       1.99  0.0464
## 2 water           0.145     -2.13  0.0329
## 3 nematodes       0.141     -1.15  0.248
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##      Min       1Q   Median       3Q      Max 
## -1.94925 -0.61681 -0.09111  0.49517  3.01780 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  222.3   14.91   
##  subject  (Intercept) 3992.9   63.19   
##  Residual              692.1   26.31   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   201.97      26.72   7.560
## attitudepop   -18.01       5.78  -3.116
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0008740 0.0089369 0.0000445
## high 0.0008740 1.0000000 0.0000003 0.3012284
## low  0.0089369 0.0000003 1.0000000 0.0000000
## mid  0.0000445 0.3012284 0.0000000 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 15, 9, 9, 14 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 7, 14, 10 und 10! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, P und leaf an vier verschiedenen Messterminen.
...
einen Radius von 4.5cm und eine H{\"o}he von 9cm. Der
...
\item Bei einem vermutetet Alter der Erde von $\ensuremath{4.5\times 10^{9}}$ Jahren,
  ...
  $\ensuremath{9\times 10^{7}}$ Jahre vollst{\"a}ndig im Erdinneren umgewandelt haben! \textbf{(2
    Punkte)}
...
Sie haben den Vektor $A = -11, 5, 4$ und den Vektor $B = 4, -4, -2$ gegeben.
