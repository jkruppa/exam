...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.001, 0.21, 0.89, 0.03 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 2e-04, 0.035, 0.1483, 0.005 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 2e-04, 0.035, 0.1483, 0.005 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.52, 0.006, 1.26, 5.34, 0.18 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.006, 1, 1, 0.18 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.006, 1, 1, 0.18 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 15, 0, 7, 13 und 6.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.2 +/- 2.985
\item [\textbf{B} \msquare] Es ergibt sich 8.2 +/- 5.97
\item [\textbf{C} \msquare] Es ergibt sich 9.2 +/- 2.985
\item [\textbf{D} \msquare] Es ergibt sich 8.2 +/- 35.7
\item [\textbf{E} \msquare] Es ergibt sich 7.2 +/- 17.85
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 15, 14, 16, 27, 30, 15 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 16 [15, 30]
\item [\textbf{B} \msquare] Es ergibt sich 26 [16, 31]
\item [\textbf{C} \msquare] Es ergibt sich 16 +/- 30
\item [\textbf{D} \msquare] Es ergibt sich 16 +/- 15
\item [\textbf{E} \msquare] Es ergibt sich 26 +/- 15
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt drei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.77 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung von nur zwei der drei Verteilungsparameter: $\gamma_1$ und $\gamma_3$.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.77 liegt keine Overdispersion vor.
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.77 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\end{enumerate}
...
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 2, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.33, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.5, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 6.55
...
\item [\textbf{C} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -2.56
...
\item [\textbf{E} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 6.55
\end{enumerate}
...
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 39
\end{enumerate}
...
$y = \{22, 14, 10, 23, 14, 19, 24, 12, 16, 18, 22\}$. Berechnen Sie folgende
...
\begin{center}
$9.5, 9.6, 13.2, 12.6, 12.2, 8.7, 7.5, 7.3, 10.7, 8.2, 8.3, 9, 7.2, 10.1, 9.1$
\end{center}
...
## t = 0.50483, df = 10, p-value = 0.6246
...
## 
## data:  drymatter by Fe
## t = -2.3095, df = 14, p-value = 0.03668
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -9.0310730 -0.3340064
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{group}  & 2 & 86.86 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 83.43 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 119.143  59.571  18.859 3.832e-05
## Residuals 18  56.857   3.159
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1]  95 103 127 108 106  83 134 138 142 162 154 143
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 57.79 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 155.33 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 84.45 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 235.13 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2  49.33  24.663  1.1311 0.344579
## form       1  69.42  69.422  3.1837 0.091241
## dose:form  2 266.45 133.225  6.1097 0.009438
## Residuals 18 392.50  21.805
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.8571 -1.9762  0.4048  1.7857  3.6667 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.857      1.034  19.197 1.87e-11
## trtB           7.476      1.379   5.421 9.02e-05
## 
## Residual standard error: 2.737 on 14 degrees of freedom
## Multiple R-squared:  0.6773,	Adjusted R-squared:  0.6543 
## F-statistic: 29.38 on 1 and 14 DF,  p-value: 9.019e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -2.662, df = 8, p-value = 0.02872
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  -0.91859424 -0.09804155
## sample estimates:
##        cor 
## -0.6853608
\end{verbatim}
...
Einflussvariablen ($x$) wurden erhoben: weight, dosage und variety. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
13.20 & 0 & 9.63 & 101.11 & 69.01 & 10\\
12.22 & 1 & 9.09 & 104.73 & 77.53 & 15\\
10.11 & 0 & 12.88 & 100.04 & 66.45 & 7\\
11.38 & 0 & 8.32 & 96.63 & 68.01 & 17\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.1009 -2.0011  0.1754  1.6544  6.7071 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.80323    7.16811  -0.112    0.911
## Fe           0.80331    0.06498  12.363  < 2e-16
## water       -0.25960    0.17650  -1.471    0.145
## P           -0.71118    0.17294  -4.112  8.1e-05
## 
## Residual standard error: 2.441 on 99 degrees of freedom
## Multiple R-squared:  0.6604,	Adjusted R-squared:  0.6501 
## F-statistic: 64.18 on 3 and 99 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & so4 & maxdepth & acerage\\
\midrule
LIBERTY\_RES & 12 & 3.49 & 5.82 & 62 & 424\\
BEAR\_CR & 54 & 0.99 & 10.92 & 96 & 19611\\
GREENE\_BR & 33 & 2.30 & 9.72 & 41 & 2225\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -6.483  -3.728  -1.430   2.039   8.270  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.607e+00  3.969e-01   6.567 3.11e-08
## no3          1.859e-01  4.980e-02   3.733 0.000492
## so4         -1.052e-02  1.724e-02  -0.610 0.544572
## maxdepth     1.793e-03  3.918e-03   0.458 0.649323
## acerage      4.494e-05  1.172e-05   3.833 0.000361
## 
## (Dispersion parameter for quasipoisson family taken to be 18.6697)
## 
##     Null deviance: 1398.74  on 53  degrees of freedom
## Residual deviance:  879.75  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.367     0.674 0.500  
## 2 light           0.638     2.62  0.00872
## 3 nematodes       0.162    -1.66  0.0965
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 798.6
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0810 -0.5638 -0.1657  0.4706  3.4049 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  215.9   14.69   
##  subject  (Intercept) 4110.8   64.12   
##  Residual              694.3   26.35   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   203.02      27.07   7.501
## attitudepop   -20.67       5.79  -3.570
## 
...
\begin{verbatim}
##           ctrl      high     low       mid
## ctrl 1.0000000 0.0083785 0.0e+00 0.0003464
## high 0.0083785 1.0000000 2.0e-07 0.2413430
## low  0.0000000 0.0000002 1.0e+00 0.0000078
## mid  0.0003464 0.2413430 7.8e-06 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 14, 6, 10, 10 und 13!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 10, 13, 4, 12 und 6! \textbf{(2 Punkte)}
...
die Sorten eins bis vier sowie die Bl{\"o}cke I bis IV
vorliegen. Sie messen die Outcomes grade, drymatter und leaf an drei verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{17, 12, -1\}$ und den Vektor $B = \{0, 1, 3\}$ gegeben.
