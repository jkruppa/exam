...
\begin{graybox}{Ergebnis der Klausur}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 56 Punkten sind aus dem Rechen- und
    Textteil erreicht. 
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.21, 0.02 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.84, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.84, 0.08 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.84, 0.08 und 1.36. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0525, 0.005 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0525, 0.005 und 0.085. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 12, 9, 9, 9 und 9.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.6 +/- 1.34
\item [\textbf{B} \msquare] Es ergibt sich 9.6 +/- 0.67
\item [\textbf{C} \msquare] Es ergibt sich 10.6 +/- 0.67
\item [\textbf{D} \msquare] Es ergibt sich 8.6 +/- 0.9
\item [\textbf{E} \msquare] Es ergibt sich 9.6 +/- 1.8
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 34, 19, 3, 9, 14, 22, 15, 26, 25, 24 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 22 +/- 14
\item [\textbf{B} \msquare] Es ergibt sich 22 [15, 27]
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 26
\item [\textbf{D} \msquare] Es ergibt sich 22 +/- 14
\item [\textbf{E} \msquare] Es ergibt sich 22 [14, 26]
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Odds ratio von 0.62, da es sich um eine Chancenverh{"a}ltnis handelt.
...
$y = \{26, 17, 13, 11, 22, 21, 19, 3, 12, 24, 23\}$. Berechnen Sie folgende
...
\begin{center}
$11.3, 12.1, 11.1, 10.9, 11.3, 7.9, 14.1, 7.2, 9.3, 7.2, 9.9, 14.2, 11.8, 11.9$
\end{center}
...
## t = 0.59634, df = 10, p-value = 0.5642
...
## t = -2.8475, df = 12, p-value = 0.01469
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.565031 -1.006397
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 105.69 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 53.17 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 28.262 14.1311  5.9311 0.009496
## Residuals 20 47.651  2.3825
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 117 116 122  94  95 100 148 133 146 146 138 132
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 6.69 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 333.23 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 9.08 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 241.42 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2 285.699 142.849  8.8951 0.002059
## form       1  20.628  20.628  1.2845 0.271938
## dose:form  2 105.110  52.555  3.2725 0.061345
## Residuals 18 289.069  16.059
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.2857 -2.2500  0.8571  1.8214  5.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.143      1.226  13.166 1.71e-08
## trtB          14.143      1.734   8.156 3.08e-06
## 
## Residual standard error: 3.244 on 12 degrees of freedom
## Multiple R-squared:  0.8472,	Adjusted R-squared:  0.8344 
## F-statistic: 66.52 on 1 and 12 DF,  p-value: 3.083e-06
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 4.3209, df = 8, p-value = 0.002543
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, weight und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.10 & 0 & 9.98 & 102.13 & 72.65 & 12\\
10.09 & 0 & 11.75 & 103.48 & 71.63 & 10\\
11.20 & 0 & 8.92 & 102.50 & 71.99 & 7\\
12.03 & 1 & 6.91 & 100.45 & 71.00 & 13\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##    Min     1Q Median     3Q    Max 
## -5.893 -1.618  0.254  1.825 10.634 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 79.28852    2.97512  26.651  < 2e-16
## P           -0.74534    0.19238  -3.874 0.000184
## water       -0.31020    0.19288  -1.608 0.110691
## nematodes    0.09109    0.08634   1.055 0.293732
## 
## Residual standard error: 2.952 on 108 degrees of freedom
## Multiple R-squared:  0.1347,	Adjusted R-squared:  0.1107 
## F-statistic: 5.605 on 3 and 108 DF,  p-value: 0.001307
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & maxdepth & so4 & do2 & acerage\\
\midrule
BEAR\_BR & 12 & 83 & 7.74 & 8.5 & 3333\\
ROCK\_CR & 3 & 33 & 7.61 & 6.8 & 575\\
GUNPOWDER\_FALLS & 22 & 65 & 5.98 & 9.7 & 12659\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -9.9176  -4.8142  -2.2148   0.3574  21.8763  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.227e-01  1.722e+00   0.071   0.9435
## maxdepth    1.128e-02  5.035e-03   2.240   0.0296
## so4         2.396e-04  3.462e-02   0.007   0.9945
## do2         2.679e-01  1.680e-01   1.595   0.1172
## acerage     2.830e-05  1.765e-05   1.603   0.1153
## 
## (Dispersion parameter for quasipoisson family taken to be 52.98238)
## 
##     Null deviance: 2423.3  on 53  degrees of freedom
## Residual deviance: 1862.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.50      2.97  0.00296
## 2 nematodes       0.135    -0.299 0.765  
## 3 water           0.147    -2.80  0.00510
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0673 -0.5999 -0.0238  0.5432  3.5361 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  200.4   14.16   
##  subject  (Intercept) 3860.6   62.13   
##  Residual              653.5   25.56   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.974     26.222   7.702
## attitudepop  -18.449      5.617  -3.285
## 
...
\begin{verbatim}
##           ctrl  high       low       mid
## ctrl 1.0000000 0e+00 0.0000016 0.1481906
## high 0.0000000 1e+00 0.0000009 0.0000000
## low  0.0000016 9e-07 1.0000000 0.0001208
## mid  0.1481906 0e+00 0.0001208 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 8, 7, 4, 4 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 9, 8, 14, 5 und 2! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes Fe, drymatter und freshmatter an vier verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{-5, 5, -6\}$ und den Vektor $B = \{-1, -1, 1\}$ gegeben.
...
\item Geben ist das \Rlogo Objekt A beinhaltend die Zahl
  15. Erkl{\"a}ren Sie den Unterschied zwischen dem Ausdruck \texttt{A == 15}
  und dem Ausdruck \texttt{A != 15} in \Rlogo! Wie lautet die Ausgabe von \Rlogo
