...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.34, 0.01, 0.89 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1, 0.05, 1 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1, 0.05, 1 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1.7, 0.05, 4.45 und 0.15. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.068, 0.002, 0.178 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.068, 0.002, 0.178 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 5, 9, 8, 12 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10 +/- 1.37
\item [\textbf{B} \msquare] Es ergibt sich 8 +/- 3.75
\item [\textbf{C} \msquare] Es ergibt sich 9 +/- 7.5
\item [\textbf{D} \msquare] Es ergibt sich 9 +/- 1.37
\item [\textbf{E} \msquare] Es ergibt sich 9 +/- 2.74
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 18, 16, 11, 13, 20, 18 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 23 +/- 13
\item [\textbf{B} \msquare] Es ergibt sich 23 [14, 21]
\item [\textbf{C} \msquare] Es ergibt sich 18 [13, 20]
\item [\textbf{D} \msquare] Es ergibt sich 18 +/- 13
\item [\textbf{E} \msquare] Es ergibt sich 18 +/- 20
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.29, da es sich um eine Chancenverh{"a}ltnis handelt.
...
$y = \{20, 18, 19, 20, 19, 20, 15, 17, 17, 18, 20\}$. Berechnen Sie folgende
...
\begin{center}
$11.3, 9.1, 9, 9.7, 12, 10.7, 8.8, 8, 8, 9.3, 10, 11.1, 9.7, 9.4$
\end{center}
...
## t = -0.96034, df = 10, p-value = 0.3595
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 34.62 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 120.86 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 197.056  98.528   48.23 2.231e-08
## Residuals 20  40.857   2.043
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 115 131 130 102  93 111 140 139 136 162 159 144
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 490.77 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 199.63 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 56.43 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 65 & 921.43 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  53.71   26.86  1.2483    0.3107
## form       1   5.84    5.84  0.2713    0.6088
## dose:form  2 697.79  348.89 16.2161 9.399e-05
## Residuals 18 387.27   21.52
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##  -5.60  -2.50   1.60   2.25   4.40 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.600      1.597  10.395 6.35e-06
## trtB          -3.400      2.258  -1.506    0.171
## 
## Residual standard error: 3.571 on 8 degrees of freedom
## Multiple R-squared:  0.2208,	Adjusted R-squared:  0.1234 
## F-statistic: 2.267 on 1 and 8 DF,  p-value: 0.1706
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: block, fertilizier und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.03 & 0 & 11.67 & 100.23 & 70.48 & 8\\
8.34 & 0 & 8.59 & 100.95 & 73.03 & 11\\
9.54 & 0 & 10.30 & 94.96 & 65.90 & 10\\
10.96 & 0 & 11.35 & 99.66 & 65.18 & 8\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.0835 -1.5217  0.2026  1.4612  4.4599 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  6.04586    7.68194   0.787   0.4334
## Fe           0.67027    0.07306   9.174 1.64e-14
## P           -0.39325    0.15960  -2.464   0.0157
## nematodes    0.07175    0.07777   0.923   0.3587
## 
## Residual standard error: 2.23 on 89 degrees of freedom
## Multiple R-squared:  0.5404,	Adjusted R-squared:  0.5249 
## F-statistic: 34.89 on 3 and 89 DF,  p-value: 5.315e-15
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & maxdepth & do2 & no3 & acerage\\
\midrule
FLINTSTONE\_CR & 11 & 50 & 9.2 & 0.25 & 18943\\
NORTHWEST\_BR\_ANACOSTIA\_R & 100 & 107 & 8.4 & 1.41 & 22550\\
BEAR\_CR & 54 & 96 & 8.3 & 0.99 & 19611\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.364  -4.079  -1.161   1.337  19.415  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 1.238e+00  1.329e+00   0.932 0.356157
## maxdepth    3.693e-03  5.017e-03   0.736 0.465208
## do2         1.028e-01  1.423e-01   0.723 0.473402
## no3         2.319e-01  7.471e-02   3.104 0.003171
## acerage     4.876e-05  1.324e-05   3.684 0.000574
## 
## (Dispersion parameter for quasipoisson family taken to be 30.42295)
## 
##     Null deviance: 1883.6  on 53  degrees of freedom
## Residual deviance: 1165.6  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>    <dbl>
## 1 (Intercept)     0.397    -1.36  0.173   
## 2 light           0.489     3.37  0.000762
## 3 nematodes       0.154    -0.213 0.831
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 794.6
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.4779 -0.5622 -0.1533  0.5756  3.4104 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  219.1   14.80   
##  subject  (Intercept) 4159.2   64.49   
##  Residual              655.2   25.60   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.106     27.205   7.429
## attitudepop  -17.797      5.624  -3.164
## 
...
\begin{verbatim}
##           ctrl      high      low       mid
## ctrl 1.0000000 0.7909733 0.00e+00 0.0001915
## high 0.7909733 1.0000000 0.00e+00 0.0000892
## low  0.0000000 0.0000000 1.00e+00 0.0000307
## mid  0.0001915 0.0000892 3.07e-05 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, 8, 14, 10 und 14!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 5, 7, 8, 14 und 7! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes grade, P und leaf an vier verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{6, 7, 13\}$ und den Vektor $B = \{-3, 2, 0\}$ gegeben.
