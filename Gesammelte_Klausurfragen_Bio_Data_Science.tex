...
\item [\textbf{D} \msquare] Wir vergleichen die Effekte des $p$-Wertes mit den Effekten der Signifikanzschwelle unter der Annahme der Nullhypothese.
...
## 
## data:  drymatter [kg/ha] by Fe
## t = 2.0868, df = 14, p-value = 0.05568
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -0.08869472  6.46964710
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
   ...
   \textbf{group}  & 2 &  &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 & 55.08 &  &  &  \strut\\
        \hline
   \textbf{total}  & 24 & 228.96 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 71.41 &  &  &  \strut\\
    \hline
   \textbf{error}  & 24 & 199.56 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 70.382  35.191  17.054 4.761e-05
## Residuals 20 41.270   2.063
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 53.65 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 103.78 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 261.65 &  &  &  \strut\\
    \hline
   \textbf{error}  & 24 & 200.1 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 68 Rindern durchgef{\"u}hrt, wobei
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 418.23 209.114  11.354 0.0006463
## form       1  12.71  12.708   0.690 0.4170537
## dose:form  2 370.36 185.178  10.054 0.0011703
## Residuals 18 331.53  18.418
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0097442 0.0029010 0.0542432
## high 0.0097442 1.0000000 0.0000012 0.4582890
## low  0.0029010 0.0000012 1.0000000 0.0000104
## mid  0.0542432 0.4582890 0.0000104 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   94   \strut\\
    \hline
     &  82 &  65 &  147  \strut\\
  \end{tabular}
\end{center}
...
## (Intercept)   21.000      1.291  16.267 1.53e-09
## waterB         6.000      1.610   3.726  0.00289
## 
## Residual standard error: 2.887 on 12 degrees of freedom
## Multiple R-squared:  0.5364,	Adjusted R-squared:  0.4978 
## F-statistic: 13.89 on 1 and 12 DF,  p-value: 0.002893
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.5364$ aus? \textbf{(2 Punkte)}
...
## t = 2.0208, df = 8, p-value = 0.07796
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  -0.07617187  0.88648629
## sample estimates:
##       cor 
## 0.5813352
\end{verbatim}
...
Einflussvariablen ($x$) wurden erhoben: S, height und block. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
Erbsen in einem Experiment in einer Klimakammer wollen Sie nun den Versuch eine Nummer gr{\"o}{\ss}er
...
\begin{enumerate}
\item Wenn 4 Blaubeerschalen 6.36 Euro kosten,  wie viel kosten 7 Schalen? \textbf{(1 Punkt)}
...
\item Ein Kilo Avocado benötigt 980l Wasser. Eine Avocado wiegt 150 - 420g.
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2023 blieben die Erträge von Blaubeeren mit \ensuremath{7.9\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge steigerte sich um 8.6\%. Die Exporte für Avocados stiegen in dem gleichen Zeitraum um 22.1\% auf \ensuremath{2.3\times 10^{5}}t.
...
\item $i$ dem Verhalten: (1) drinking/eating, (2) wing/leg stretching, (3)
...
\midrule
drinking/eating & 41cm; 21cm; 0.2\% & 41cm; 26cm; 0.2\% & 35cm; 30cm; 0.8\%\\
wing/leg stretching & 46cm; 26cm; 3.2\% & 33cm; 25cm; 3.2\% & 41cm; 23cm; 3.2\%\\
wingflapping & 23cm; 30cm; 0.8\% & 39cm; 24cm; 1\% & 28cm; 17cm; 1\%\\
foraging incl. scratching & 35cm; 22cm; 13.2\% & 45cm; 26cm; 12.8\% & 35cm; 28cm; 12.8\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCKLLFO & 3.5 | 2.0 | Normal \\
    B & GCNZN3N & 2.0 | 2.5 | Klein \\ 
    C & GCZX3YY & 4.0 | 4.5 | Mikro \\ 
    D & GCNGMDE & 2.5 | 1.0 | Mikro \\ 
    E & GC0HRCR & 5.0 | 1.5 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 250 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.2\times 10^{10}} - \ensuremath{1.1\times 10^{9}} \cdot 2^{-0.1 \cdot t + 2.7}
\end{equation*}
