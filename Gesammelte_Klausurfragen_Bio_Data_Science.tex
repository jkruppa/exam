...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in t.test.formula(drymatter \textasciitilde{} P, data\_tbl, var.equal = TRUE, paired = TRUE): cannot use 'paired' in formula method}}\begin{verbatim}
## 
## 	Welch t-Test
## 
