...
\begin{graybox}{Checkbox für die Version vom \today}
  ...
  Choice Fragen sowie \textbf{63} Rechen- und
  Textaufgaben.
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.03, 0.34 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.105, 0.0075, 0.085 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 1 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 1 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.105, 0.0075, 0.085 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.68, 0.12, 1.36 und 0.08. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 8, 12, 16 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.8 +/- 1.95
\item [\textbf{B} \msquare] Es ergibt sich 10.8 +/- 1.95
\item [\textbf{C} \msquare] Es ergibt sich 10.8 +/- 15.2
\item [\textbf{D} \msquare] Es ergibt sich 10.8 +/- 3.9
\item [\textbf{E} \msquare] Es ergibt sich 9.8 +/- 7.6
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 18, 27, 9, 8, 23, 18 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 [9, 27]
\item [\textbf{B} \msquare] Es ergibt sich 18 +/- 27
\item [\textbf{C} \msquare] Es ergibt sich 18 +/- 9
\item [\textbf{D} \msquare] Es ergibt sich 18 [9, 27]
\item [\textbf{E} \msquare] Es ergibt sich 21 +/- 9
\end{enumerate}
...
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3 liegt keine Overdispersion vor.
...
\item [\textbf{E} \msquare] Die Possion-Regression sch{"a}tzt drei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung von nur zwei der drei Verteilungsparameter: $\gamma_1$ und $\gamma_3$.
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.98 ist
richtig?
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.3, da es sich um ein Anteil handelt.
...
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.43, da es sich um ein Anteil handelt.
\end{enumerate}
...
\item [\textbf{B} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 0.11
\item [\textbf{C} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 0.33
\item [\textbf{D} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 0.11
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 39
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 38
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 76
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 20
...
$y = \{17, 15, 18, 17, 16, 17, 14, 16, 15, 13, 13\}$. Berechnen Sie folgende
...
\begin{center}
$14, 6.6, 7.2, 9.3, 9.5, 10.9, 13, 9.5, 12.6, 12.5, 9.7, 9.5, 8.5, 10.3$
\end{center}
...
## t = -0.20008, df = 10, p-value = 0.8454
...
## t = 2.0172, df = 14, p-value = 0.06327
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.2027398  6.6154382
## sample estimates:
...
## t = 1.7774, df = 14, p-value = 0.09722
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -0.6430278  6.8652501
## sample estimates:
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 109 114 130  93  97  94 158 164 136 145 132 150
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.81 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.66 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  3.7465 1.87324  4.6058 0.01901 *
## Residuals 27 10.9812 0.40671                  
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 209.25 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2425.62 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 108.81 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 705.48 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df  Sum Sq Mean Sq  F value    Pr(>F)    
## supp       1  252.80  252.80  22.4893 1.345e-05 ***
## dose       2 2323.53 1161.77 103.3512 < 2.2e-16 ***
## supp:dose  2  108.88   54.44   4.8432   0.01122 *  
## Residuals 60  674.46   11.24                       
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
## -8.4286 -1.1786 -0.4286  1.5714  9.5714 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   19.429      1.533  12.673 2.63e-08 ***
## trtB           7.000      2.168   3.229  0.00724 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 4.056 on 12 degrees of freedom
## Multiple R-squared:  0.4649,	Adjusted R-squared:  0.4203 
## F-statistic: 10.42 on 1 and 12 DF,  p-value: 0.007238
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: dry, P und dosage. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & temp & do2 & acerage & so4\\
\midrule
HOLLANDS\_BR & 38 & 12.0 & 10.5 & 1934 & 11.44\\
LITTLE\_BEAR\_CR & 6 & 14.9 & 9.1 & 3330 & 8.16\\
LITTLE\_HUNTING\_CR & 18 & 16.0 & 9.5 & 7121 & 7.41\\
LITTLE\_FALLS & 84 & 19.5 & 10.2 & 1600 & 5.69\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.931  -3.140  -1.535   1.893  19.545  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -1.980e+00  1.463e+00  -1.353 0.182291    
## temp         1.170e-01  4.015e-02   2.914 0.005359 ** 
## do2          3.544e-01  1.110e-01   3.194 0.002454 ** 
## acerage      5.184e-05  1.226e-05   4.229 0.000102 ***
## so4         -2.625e-02  2.458e-02  -1.068 0.290804    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 29.36068)
## 
##     Null deviance: 1931.9  on 53  degrees of freedom
## Residual deviance: 1152.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.49     1.85    0.0649
## 2 light           0.469    0.0882  0.930 
## 3 water           0.150   -1.75    0.0806
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
8.78 & 0 & 9.39 & 101.93 & 76.41 & 9\\
8.96 & 0 & 10.34 & 102.28 & 71.53 & 12\\
10.85 & 1 & 12.21 & 97.62 & 67.00 & 10\\
8.59 & 1 & 10.88 & 99.76 & 68.33 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -8.0605 -2.1371 -0.2859  1.8465  7.9136 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  76.3587     3.3720  22.645   <2e-16 ***
## P            -0.3043     0.2276  -1.337    0.185    
## light         0.2320     0.7431   0.312    0.756    
## water        -0.3291     0.2488  -1.323    0.189    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 3.222 on 89 degrees of freedom
## Multiple R-squared:  0.03852,	Adjusted R-squared:  0.006114 
## F-statistic: 1.189 on 3 and 89 DF,  p-value: 0.3187
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0393 -0.5413 -0.1227  0.4836  3.3514 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  218.0   14.77   
##  subject  (Intercept) 4180.2   64.65   
##  Residual              639.3   25.28   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.453     27.259   7.427
## attitudepop  -19.347      5.555  -3.483
## 
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.0172786 0.0000011 0.0126846
## B 0.0172786 1.0000000 0.0014584 0.8976847
## C 0.0000011 0.0014584 1.0000000 0.0020648
## D 0.0126846 0.8976847 0.0020648 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 18, 27, 9, 8, 23, 18 und 42!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 18, 27, 9, 8, 23, 18 und 42! \textbf{(2 Punkte)}
