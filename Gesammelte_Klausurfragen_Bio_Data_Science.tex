...
Sie f{\"u}hren ein Feldexperiment durch um das Gewicht von Erdbeeren zu
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 13, 15, 18 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 14.2 +/- 2.39
\item [\textbf{B} \msquare] Es ergibt sich 13.2 +/- 2.85
\item [\textbf{C} \msquare] Es ergibt sich 14.2 +/- 5.7
\item [\textbf{D} \msquare] Es ergibt sich 15.2 +/- 1.195
\item [\textbf{E} \msquare] Es ergibt sich 14.2 +/- 1.195
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 31, 12, 17, 15, 36, 9, 21, 28, 23, 18 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 +/- 31
\item [\textbf{B} \msquare] Es ergibt sich 25 +/- 15
\item [\textbf{C} \msquare] Es ergibt sich 21 +/- 15
\item [\textbf{D} \msquare] Es ergibt sich 21 [15, 31]
\item [\textbf{E} \msquare] Es ergibt sich 25 [16, 32]
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0025, 0.085 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.04, 1.36 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.04, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.0025, 0.085 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.04, 1 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Ja, wir erhalten eine Aussage. M{"u}ssen aber das Individuum im Kontext der Population adjustieren.
...
\begin{center}
$2, 6, 2, 2, 2, 4, 5, 7, 5, 3, 1, 4, 2, 3, 3, 3, 4, 3, 5, 1, 6, 2, 3, 2, 7, 5, 1, 5, 6, 3$
\end{center}
...
\begin{center}
$9.5, 9, 9.9, 12.5, 11.7, 9.4, 7.4, 7.5, 7.7, 9.2, 9.5, 10.9, 6.2, 11.3, 13.4, 9.8, 10.9$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  $\beta$-Fehler & H$_0$ beibehalten & $\alpha$-Fehler & Testentscheidung \\
  \end{tabular}
  \end{center}
...
## t = 0.051674, df = 12, p-value = 0.9596
...
## t = 3.8417, df = 8, p-value = 0.004935
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##   2.79826 11.20174
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 28.02 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 33.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 14.208  7.1042  2.2457 0.1319
## Residuals 20 63.270  3.1635
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 46.3 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 151.81 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 299.38 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 271.14 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 57 Ziegen durchgef{\"u}hrt, wobei
...
## Response: gain
##           Df  Sum Sq Mean Sq F value  Pr(>F)
## dose       2  37.287  18.643  2.2292 0.13647
## form       1  29.604  29.604  3.5397 0.07619
## dose:form  2  80.098  40.049  4.7887 0.02150
## Residuals 18 150.539   8.363
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.1434010 0.6772958 0.0581884
## high 0.1434010 1.0000000 0.0638022 0.6453733
## low  0.6772958 0.0638022 1.0000000 0.0231914
## mid  0.0581884 0.6453733 0.0231914 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -7.286 -1.536  1.257  1.800  4.714 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   18.286      1.311   13.95    7e-08
## waterB         4.914      2.030    2.42    0.036
## 
## Residual standard error: 3.467 on 10 degrees of freedom
## Multiple R-squared:  0.3694,	Adjusted R-squared:  0.3064 
## F-statistic: 5.859 on 1 and 10 DF,  p-value: 0.03603
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.3694$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: N, S und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
wing/leg stretching & 35cm; 26cm; 1.6\% & 37cm; 28cm; 2.4\% & 33cm; 22cm; 0.5\%\\
dustbathing & 27cm; 32cm; 4.1\% & 24cm; 37cm; 3.6\% & 49cm; 26cm; 6.3\%\\
wingflapping & 26cm; 27cm; 6.2\% & 33cm; 27cm; 6.1\% & 31cm; 31cm; 3.2\%\\
preening & 34cm; 15cm; 0.8\% & 33cm; 32cm; 1.2\% & 34cm; 30cm; 0.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCBQFZT & 1.5 | 1.5 | Klein \\
    B & GCXUIZY & 5.0 | 2.0 | Normal \\ 
    C & GCLQB6H & 2.0 | 1.0 | Normal \\ 
    D & GCE16M0 & 1.0 | 4.0 | Normal \\ 
    E & GCGNXHC & 4.5 | 3.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
\begin{equation*}
  f(t) = \ensuremath{1.1\times 10^{10}} - \ensuremath{9\times 10^{8}} \cdot 1.9^{-0.1 \cdot t + 4.1}
\end{equation*}
...
Sie haben den Vektor $A = \{3, 3, -3\}$ und den Vektor $B = \{2, 3, 0\}$ gegeben.
