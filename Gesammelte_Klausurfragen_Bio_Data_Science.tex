...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\square\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\square\!\square\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\begin{enumerate}
\item [\textbf{A} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Behandlungsbedingungen erklärt wird. Daher werden 18\% der Varianz durch die Behandlungsgruppen erklärt.
\item [\textbf{B} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Umweltbedingungen erklärt wird. Daher werden 18\% der Varianz durch die Umweltbedingungen erklärt. Der Anteil der Varianz durch die Behandlungsgruppen ist dann 82\%.
...
\item [\textbf{D} \msquare] Es werden 18\% der Varianz durch den Versuch erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der durch Fehler in der Versuchsdurchführung entsteht.
...
Ein Versuch wurde an 68 Tieren durchgeführt, wobei jedes Tier eine von drei Vitamin-C-Dosen (0.5, 1 und 1.5 mg/Tag) über eine von zwei Verabreichungsmethoden erhielt. Die folgende Abbildung enthält die Daten aus diesem Versuch zur Bewertung der Wirkung von Vitamin D auf das Zahnwachstum bei Schweine.  Welche Aussage ist richtig, wenn Sie eine zweifaktorielle ANOVA rechnen?
...
Gegeben ist $y$ mit 16, 11, 9, 7 und 6. Berechnen Sie den Mittelwert und Standardabweichung.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.8 +/- 7.85
\item [\textbf{B} \msquare] Es berechnet sich 10.8 +/- 15.7
\item [\textbf{C} \msquare] Es berechnet sich 9.8 +/- 15.7
\item [\textbf{D} \msquare] Es ergibt sich 10.8 +/- 1.98
\item [\textbf{E} \msquare] Es ergibt sich 9.8 +/- 3.96
\end{enumerate} 
...
Gegeben ist $y$ mit 23, 28, 26, 10, 18, 28, 8, 17, 14, 20 und 42. Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile.




\begin{enumerate}
\item [\textbf{A} \msquare] Sie erhalten 20 +/- 28
\item [\textbf{B} \msquare] Es ergibt sich 20 +/- 14
\item [\textbf{C} \msquare] Sie erhalten 20 [12; 26]
\item [\textbf{D} \msquare] Es berechnet sich 20 [14; 28]
\item [\textbf{E} \msquare] Es berechnet sich 21 [15; 27]
\end{enumerate} 
...
\item [\textbf{E} \msquare] Wir sollten zwei bis fünf Beobachtungen mindestens pro Gruppe vorliegen haben.
\end{enumerate}
...
\item [\textbf{D} \msquare] Da sich der Mittelwert und der Median unterscheiden, liegen vermutlich Outlier in den Daten vor. Wir untersuchen den Datensatz nach auffälligen Beobachtungen.
...
Bevor Sie in Ihrer Abschlussarbeit einen statistischen Test rechnen, wollen Sie einmal betrachten, welcher Verteilung Ihre $n = 168$ geernteten Pflanzen folgen.  Welche Verteilung ist abgebildet?
...
\item [\textbf{D} \msquare] Wir betrachten die Gerade. Wenn die Punkte einigermaßen gleichmäßig um die Gerade verteilt liegen, dann gehen wir von normalverteilten Residuen aus. Dies ist hier nicht der Fall. Wir haben keine normalverteilten Residuen vorliegen.
...
Nach einer simplen linearen Regression zur Untersuchung vom Einfluss der $NO_3$-Konzentration in [$\mu g$] im Wasser auf den absoluten Proteingehalt von Erbsen in [$kg$] erhalten Sie einen $\beta_{NO_3}$ Koeffizienten von $7.4\times 10^{-6}$ und einen hoch signifikanten $p$-Wert mit $0.00032$. Warum sehen Sie so einen kleinen Effekt bei einer so deutlichen Signifikanz?
...
\item [\textbf{C} \msquare] Die Einheit der $NO_3$-Konzentration ist zu klein gewählt. Die Erhöhung der $NO_3$-Konzentration um 1 Einheit führt nur zu einem sehr winzigen Anstieg von $\beta_{NO_3}$ im Gewicht der Wasserlinsen. Die Einheit [$\mu g$] muss besser gewählt werden.
...
\item [\textbf{E} \msquare] Die Ferkel stammen von der gleichen Sau und sind somit untereinander abhängig.
\end{enumerate}
...
\item [\textbf{B} \msquare] Das Verhältnis der Chancen Odds ratio ergibt ein Chancenverhältnis von 0.27. Wir sind an der Chance krank zu sein interessiert.
\item [\textbf{C} \msquare] Da es sich um ein Chancenverhältnis handelt ergibt sich ein Odds ratio von 0.38.
\item [\textbf{D} \msquare] Da es sich um ein Chancenverhältnis handelt ergibt sich ein Odds ratio von 3.67.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.42, 0.03, 0.001, 0.34 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.07, 0.005, 2e-04, 0.0567 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.18, 0.006, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.18, 0.006, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.07, 0.005, 2e-04, 0.0567 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.26, 2.52, 0.18, 0.006, 2.04 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
Ein Versuch wurde in 14 Parzellen pro Gruppe durchgeführt. Die folgende Abbildung enthält die Daten aus diesem Versuch zur Bewertung der Wirkung des Mikronährstoff Eisen auf den Ertrag in t/ha von Mais im Vergleich zu einer Kontrolle.  Welche Aussage ist richtig, wenn Sie einen t-Test rechnen?
...
\item [\textbf{B} \msquare] Nach Betrachtung des Barplots liegt kein signifikanter Unterschied vor. Der Effekt liegt bei -2.
...
\item [\textbf{D} \msquare] Die Barplots deuten auf ein signifikanten Unterschied. Der Effekt liegt vermutlich bei -2.
\item [\textbf{E} \msquare] Es liegt ein signifikanter Unterschied vor. Der Effekt liegt bei -0.2.
\end{enumerate}
...
Barplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Tina nicht gemerkt, welche statistischen Maßzahlen für einen Barplot erhoben werden müssen. Das ist in soweit doof, da nach ihrer Betreuer erstmal ein Barplot nachgebaut werden soll, bevor es mit ihrer Abschlussarbeit losgeht. Dann hat sie schonmal den \Rlogo Code vorliegen und nachher geht dann alles schneller. Die Behandlung für Maiss werden verschiedene Lüftungssysteme und Folientunnel ($ctrl$, $storm$ und $tornado$) sein. Erfasst wird als Endpunkt ($Y$) \textit{Ertrag}. Tina soll dann \textit{yield} in ihrer Exceldatei eintragen.
...
Anschauen, was andere vor einem gemacht haben, ist eine Möglichkeit schnell ans Ziel zu gelangen. Deshalb hat sich Alex viele Poster in der Fakultät angeschaut und ist zum Schluß gekommen, dass Barplots eine häufig genutzte Abbildung sind. Alex soll nun in seiner Hausarbeit Maiss untersuchen. Die Behandlung in seiner Hausarbeit sind verschiedene Genotypen ($AA$, $AB$ und $BB$). Erhoben wurden von Alex als Messwert ($Y$) \textit{Trockengewicht} benannt als \textit{drymatter} in seiner Exceldatei. Erwartungsgemäß erhält er von seiner Betreuerin den Auftrag die erhobenen Daten als Barplots darzustellen. Dann kann Alex auch schonmal abschätzen, was bei einem statistischen Test rauskommen könnte.
...
\item Wenn Alex \textit{keinen Effekt} zwischen den Behandlungen von Maiss erwarten würde, wie sehen dann die Barplots aus? \textit{Antworten Sie mit einer Skizze der Barplots!}
  \textbf{(1 Punkt)}
\end{enumerate} 
\clearpage
% -----------------------------------------------------------------------
...
Boxplots sind bedeutend in der Darstellung von wissenschaftlichen Ergebnissen. Leider hat sich Jonas nicht gemerkt, welche statistischen Maßzahlen für einen Boxplot erhoben werden müssen. Das ist in soweit doof, da nach seinem Betreuer erstmal ein Boxplot nachgebaut werden soll, bevor es mit seinem Projektbericht losgeht. Anhand von Boxplots lässt sich eine Aussage über die Normalverteilung von $Y$ treffen. Dann hat er schonmal den \Rlogo Code vorliegen und nachher geht dann alles schneller. Die Behandlung für Kartoffeln werden verschiedene Lichtstufen ($none$, $200lm$ und $600lm$) sein. Erfasst wird als Outcome ($Y$) \textit{Proteingehalt}. Jonas soll dann \textit{protein} in seiner Exceldatei eintragen.
...
Alex steht vor einem ersten Problem, denn wenn es nach seinem Betreuer geht, soll er in einem einem Feldexperiment Maiss auswertet. Soweit eigentlich alles passend. Die Behandlung waren verschiedene Lichtstufen ($none$ und $600lm$). In seiner Exceldatei hat er den Endpunkt ($Y$) \textit{Proteingehalt} als \textit{protein} aufgenommen. Nun soll Alex die Daten eimal als Boxplots in einer Präsentation visualisieren, damit seinem Betreuer wieder klar wird, was er eigentlich nochmal gemacht hat und was für ein Ergbnis in einem statistischen Test zu erwarten wäre. Anhand von Boxplots lässt sich eine Aussage über die Varianzhomogenität über die Behandlungsgruppen treffen.
...
In ihrer Abschlussarbeit möchte Paula gerne die Daten aus einem Gewächshausexperiment mit Erdbeeren in einem Histogramm darstellen. Das Histogramm erlaubt ihr dabei Rückschlüsse auf die Verteilung über den Messwert ($Y$) zu treffen. In seinem Experiment hat Paula die Knötchen gezählt.

\begin{center}
Die Knötchen: 6, 8, 3, 3, 0, 6, 6, 1, 2, 2, 4, 8, 2, 2, 4, 8, 5, 4, 3, 2, 4, 4, 3, 4, 2, 3, 6, 3, 5, 9, 5, 1, 5, 1, 4, 6
\end{center}
...
In einem Gespräch mit seinem Betreuer wird Mark gebeten seine Daten aus einem Gewächshausexperiment mit Erdbeeren in einem Histogramm darzustellen. In seinem Experiment hat er die mittleren Läsionen auf den Blättern erst fotographiert und dann ausgezählt. Laut seinem Betreuer soll das Histogramm helfen, die Verteilung der die mittleren Läsionen auf den Blättern zu bestimmen.

\begin{center}
Die mittleren Läsionen auf den Blättern: 9.4, 9.4, 8.3, 7.1, 11.7, 10.5, 10.5, 8.9, 10.8, 8.6, 9.2, 10, 8.5, 9.2, 10.4, 7.4, 14.3, 8.8, 11.7, 10, 9.6, 9.1
\end{center}
...
Nilufar liest laut: 'Wenn zwei kontinuierliche Variablen vorliegen, können diese in einer exploartiven Datenanalyse...'. Nilufar stoppt. Was waren noch gleich kontinuierliche Variablen? In ihrer Abschlussarbeit hatte sie ein Gewächshausexperiment in der Uckermark durchgeführt. Dabei ging es um den Zusammenhang zwischen Trockengewicht [kg/ha] und durchschnittlicher Regenwurmdichte [Anzahl/l] im groben Kontext von Erdbeeren. Nun stellt sich die Frage für sie, ob es überhaupt einen Zusammenhang zwischen den gemessenen Variablen gibt. Dafür war eine explorative Datenanalyse gut!
...
In ein Feldexperiment im Wendland hatte Jonas sich zum einen die Behandlung KI-gesteuert [ja/nein] und zum anderen die Messung Frischegewicht über Zielwert [ja/nein] im Kontext von Erdbeeren angeschaut. Nun steht Jonas vor dem Problem, dass er zwei kategoriale Variablen in seiner Hausarbeit gemessen hat. Da sein Betreuer erstmal die langen Tabellen mit ja/nein in einer explorativen Datenanalyse zusammengefasst und präsentiert bekommen möchte bevor es überhaupt weitergeht, muss er jetzt eine Lösung finden.
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ abgelehnt & H$_0$ beibehalten & $\beta$-Fehler & H$_0$ wahr \\
  \end{tabular}
  \end{center}
...
Steffen ist im Emsland für einen Pilotexperiment mit sehr geringer Fallzahl $(n_1 = n_2 = 3)$ mit Erdbeeren. Allein diese Tatsache ist für ihn eine Erzählung wert. Für seinen Projektbericht musste er ein Freilandversuch mit Erdbeeren durchführen und das sollte laut seinem Betreuer an diesem Ort besonders gut gelingen, da man hier gut neue technische Anlagen und Behandlungen fernab der Bevölkerung testen könne. Zeugen gibt es hier jedenfalls keine. Gar keine. Alleine sein hilft jetzt aber nur bedingt, denn seine Behandlung Düngestufen ($ctrl$ und $high$) und der Messwert Frischegewicht [kg/ha] sollen mit einem t-Test ausgewertet werden. Immerhin weiß er, dass sein Messwert einer Normalverteilung folgt. 
...
'Der t-Test testet ein normalverteiltes Outcome ($Y$).', liest Tina laut. Das hilft jetzt auch nur bedingt weiter. Laut ihrer Betreuerin ist zwar ihr Messwert Trockengewicht [kg/ha] normalverteilt, aber wie rechnet sie jetzt einen t-Test? Für ihre Abschlussarbeit musste sie ein Gewächshausexperiment mit Erdbeeren im Teuteburgerwald durchführen. Als wäre das nicht schon anstrengend genug gewesen. Jetzt soll sie auch noch testen, ob die Behandlung Lichtstufen ($none$ und $600lm$) ein signifikantes Ergebnis liefert.
...
Das Emsland, unendliche Weiten. Wir schreiben das Jahr 2024. Dies sind die Abenteuer von Tina, die mit ihrer 1 Frau starken Besatzung 12 Wochen lang unterwegs ist, um neue Welten zu erforschen, neues Leben und neue Zivilisationen. 'Oder nennen wir es Ödnis und Verzweiflung', denkt Tina. Für ihre Abschlussarbeit ist Tina ins Nichts gezogen. Was macht sie nun? Tina hat ein Freilandversuch mit Erdbeeren durchgeführt. Die Behandlung Lichtstufen ($none$ und $600lm$) wurde an Erdbeeren getestet. Gemessen hat sie dann als einen normalverteilten Endpunkt ($Y$) Chlorophyllgehalt (SPAD-502Plus) [SPAD]. Jetzt soll sie ihrem Betreuer nach testen, ob die Behandlung Lichtstufen ($none$ und $600lm$) ein signifikantes Ergebnis liefert.
...
Alles voll mit Erdbeeren. Das haben Mark und Jessica gemeinsam in einer Hausarbeit gemacht! Worum ging es aber konkret? Beide haben als einen normalverteilten Endpunkt ($Y$) Trockengewicht [kg/ha] von Erdbeeren bestimmt. Die Daten haben beide zusammen in einem Gewächshausexperiment erhoben. In dem Experiment ging es um eine vorher/nachher Untersuchung an den gleichen Erdbeeren. Als Behandlung wurde Ausgeizen ($ctrl$ und $28d$) eingesetzt. Nach der Meinung des Betreuers muss hier ein gepaarter t-Test gerechnet werden.
...
Leider kennen sich Mark und Jessica mit der Berechnung eines gepaarten t-Tests überhaupt nicht aus. Deshalb brauchen sie beide bei der Berechnung Ihre Hilfe!
...
'Wir waren in der Uckermark um Erdbeeren in einem Freilandversuch zu messen.', Jonas legt das Dokument auf den Tisch und schaut Yuki und Paula fragend an. Beide schauen fragend zurück. Die beiden sind zu ihm gekommen, da sie sich nicht mit \Rlogo auskennen und daher Hilfe bei der Interpretation des t-Tests brauchen. Kein Problem. Aber worum es in dem Versuch geht, lässt sich nur aus dem Text in seiner Hand erahnen. Vielleicht hilft da ja die Ausgabe des t-Tests in R weiter.
...
## t = -0.42467, df = 17, p-value = 0.6764
...
Helfen Sie Jonas bei der Interpretation des t-Tests! Sonst geht es auch für Yuki und Paula nicht weiter.
...
Jonas und Mark sind bei Yuki um sich Hilfe in \Rlogo zu holen. Die beiden hatten zwar schon erste Kontakte mit \Rlogo sind sich aber unsicher bei der Interpetierung der Ausgabe eines t-Tests für ihren gemeinsamen Versuch. In einem Projektbericht haben sie zusammen Erdbeeren untersucht. Dabei ging es um den Zusammenhang zwischen der Behandlung Düngestufen ($ctrl$ und $high$) und dem Messwert Proteingehalt [g/kg]. Der Versuch wurde in einem Freilandversuch im Teuteburgerwald durchgeführt. Nach des Betreuers ist der Messwert Proteingehalt [g/kg] normalverteilt und ein t-Test passt daher. Das wird jetzt nicht mehr angezweifel...
...
## t = 1.9774, df = 17, p-value = 0.06444
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -0.437687 13.512687
## sample estimates:
...
Helfen Sie Yuki bei der Interpretation des t-Tests! Sonst geht es auch für Jonas und Mark nicht weiter.
...
Mark und Jessica sind bei Steffen um sich Hilfe in \Rlogo zu holen. Die beiden hatten zwar schon erste Kontakte mit \Rlogo sind sich aber unsicher bei der Interpetierung der Ausgabe eines t-Tests für ihren gemeinsamen Versuch. In einer Abschlussarbeit haben sie zusammen Erdbeeren untersucht. Dabei ging es um den Zusammenhang zwischen der Behandlung Lichtstufen ($none$ und $600lm$) und dem Messwert Frischegewicht [kg/ha]. Der Versuch wurde in einem Feldexperiment im Oldenburger Land durchgeführt. Nach des Betreuers ist der Messwert Frischegewicht [kg/ha] normalverteilt und ein t-Test passt daher. Das wird jetzt nicht mehr angezweifel...
...
## t = 2.6624, df = 16, p-value = 0.01703
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##   1.358431 11.974903
## sample estimates:
...
Helfen Sie Steffen bei der Interpretation des t-Tests! Sonst geht es auch für Mark und Jessica nicht weiter.
...
Es gibt ja immer die Möglichkeit sich Hilfe zu holen. Das geht natürlich auch immer in einer Abschlussarbeit. Deshalb arbeiten Yuki und Jonas gemeinsam an einer Abschlussarbeit. Das macht dann auch die Analyse ihres Hauptversuches einfacher. Zwar hat jeder von ihnen noch ein Subthema, aber auch da kann man sich ja helfen. In dem Hauptversuch wurde Folgendes von den beiden gemacht. Yuki und Jonas haben sich Erdbeeren angeschaut. Dabei geht um Zusammenhang zwischen Düngung ($vorher$ und $nachher$) und Frischegewicht [kg/ha]. Jetzt sollen beide einen gepaarten t-Test rechnen. Leider kennen sich beide nicht sehr gut in \Rlogo aus.
...
## t = 5.6775, df = 8, p-value = 0.0004663
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##   7.660497 18.139503
## sample estimates:
...
Leider kennen sich Yuki und Mark mit Darstellung einer einfaktoriellen ANOVA überhaupt nicht aus. Deshalb brauchen beide bei der Erstellung Ihre Hilfe! 
...
'Als erstes bauen wir uns aus unsere Daten die ANOVA Tabelle dann sehen wir schon, ob unser Gruppenvergleich in der ANOVA signifikant ist.', Mark schaut Yuki fragend an und hofft auf eine positive Regung im Gesicht. Wird aber enttäuscht. Yuki tut sich auch sehr schwer mit der einfaktoriellen ANOVA. Beide waren im Oldenburger Land um einen Versuch in einer Klimakammer mit Erdbeeren durchzuführen. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Düngestufen ($ctrl$, $low$, $mid$ und $high$) und dem Messwert Chlorophyllgehalt (SPAD-502Plus) [SPAD] gibt.
...
\toprule
    ...
    \midrule
   \textbf{Düngestufen}  & 3 & 2816.19 &  &  &  \strut\\
   \textbf{error}  & 19 & 1165.46 &  &  &  \strut\\
...
'Als erstes bauen wir uns aus unsere Daten die ANOVA Tabelle dann sehen wir schon, ob unser Gruppenvergleich in der ANOVA signifikant ist.', Mark schaut Nilufar fragend an und hofft auf eine positive Regung im Gesicht. Wird aber enttäuscht. Nilufar tut sich auch sehr schwer mit der einfaktoriellen ANOVA. Nun möchte erstmal ihre Betreuung der Arbeit eine ANOVA Tabelle sehen. Was immer da auch drin zu erkennen sein mag. Beide waren im Oldenburger Land um ein Feldexperiment mit Erdbeeren durchzuführen. Dabei ging es herauszufinden, ob es einen Zusammenhang zwischen der Behandlung Bewässerungstypen ($ctrl$, $low$, $mid$ und $high$) und dem Messwert Frischegewicht [kg/ha] gibt.
...
\toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Bewässerungstypen}  & 3 & 50.44 &  &  &  \strut\\
   \textbf{Error}  & 17 & 150.8 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
Jonas schaut entnervt auf und klappt den Laptop zu. Nun möchte sein Betreuer seiner Hausarbeit erstmal eine ANOVA sehen und \textit{dann} die Ergebnisse präsentiert bekommen bevor es überhaupt mit der Abschlussarbeit weitergeht. Dabei war er extra im Oldenburger Land um ein Gewächshausexperiment mit Erdbeeren durchzuführen. Und dort was es wirklich nicht schön geschweige denn spannend wie bei seinen Kommilitonen, die in Almería waren. Hätte er es vorher gewusst, dann hätte er die Abschlussarbeit bei wem anders geschrieben. Aber gut, jetzt als die ANOVA in \Rlogo.
...
## Lichtstufen  3  84.133 28.0444  5.5562 0.004398
## Residuals   26 131.233  5.0474
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Steffen steht im Oldenburger Land. Und das ist noch langweiliger als es sich anhört. Wäre es nur so spannend wie bei seinen Kommilitonen, die in Almería waren. Ödnis wohin man nur blickt. Oder eben Erdbeeren. Ja, darum geht es in seiner Abschlussarbeit. Und wäre das nicht noch alles genug, ist sein Experiment auch noch als ein Feldexperiment komplex geraten. Es wurde der Messwert Proteingehalt [g/kg] mit dem Behandlung Substrattypen ($torf$, $40p60n$, $30p20n$ und $70p30n$) sowie der Behandlung Bewässerungstypen ($ctrl$, und $high$) untersucht. 'Hmpf', denkt Steffen und ruft 'Und jetzt!?' in die Leere.
...
\begin{center}
  ...
  \toprule
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \midrule
   \textbf{Substrattypen}  & 3 & 97.75 &  &  &  \strut\\
    \textbf{Bewässerungstypen}  & 1 & 307.91 &  &  &  \strut\\
    \textbf{Substrattypen:Bewässerungstypen}  & 3 & 72.18 &  &  &  \strut\\
   \textbf{Error}  & 18 & 395.73 &  &  &  \strut\\
\bottomrule
  \end{tabular}
\end{center}
...
In einen Versuch in einer Klimakammer wurden Erdbeeren mit der Behandlung Bewässerungstypen ($ctrl$, $low$, $mid$ und $high$) sowie der Behandlung Substrattypen ($torf$, $70p30n$) untersucht. Es wurde als Messwert Trockengewicht [kg/ha] bestimmt. Jetzt starrt Tina mit auf die \Rlogo Ausgabe einer zweifaktoriellen ANOVA. Leider starrt ihre Betreuerin in der gleichen Art Tina zurück an. Das wird ein langer Nachmmittag, denkt sie sich und kreuselt ihren Mund. 'Und was machen wir jetzt?' entfährt es ihr überrascht entnervt. Immerhin war geht es ja um die Projektbericht. Tina hätte doch nichts mit Erdbeeren machen sollen. Erdbeeren -- was soll das auch bedeutendes sein?
...
##                                 Df Sum Sq Mean Sq F value   Pr(>F)
## Bewässerungstypen                2 277.44 138.720  7.0888 0.005364
## Substrattypen                    1  71.37  71.368  3.6470 0.072238
## Bewässerungstypen:Substrattypen  2 275.31 137.655  7.0344 0.005530
## Residuals                       18 352.24  19.569
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Mark und Tina untersuchen gemeinsam in ihrer Abschlussarbeit den Messwert Proteingehalt [g/kg] in Erdbeeren. Es ist einiges schiefgelaufen, wie es immer so passiert. Hauptsächlich waren es Katzen, auch wenn man erstmal bei dem Messwert nicht unbedingt an Katzen denken würde. Aber das ist eine andere Geschichte. Jetzt wollen Mark und Tina ihre Ergebnisse nochmal mit einer Studie von Meyer et al. (2021) vergleichen und schauen, ob was ähnliches rauskommt. Angeschaut wurde sich als Behandlung Genotypen ($00$, $AA$, $AB$ und $BB$). Es ergab sich dann die folgende Tabelle der rohen p-Werte für die Vergleiche zu Meyer et al. (2021).
...
Mark betrachtet in sich gekehrt die Poster vor dem Büro von seinem Betreuer. Viele der explorativen Abbildungen sagen ihm etwas. Die Barplots und die Boxplots könnte er dann schon nachbauen. Das macht ihn dann zuversichtlich die Abschlussarbeit auch hinzukriegen. Etwas komischer sind die seltsamen Buchstaben über den Barplots. Mark betrachtet ein Poster das sich mit Erdbeeren beschäftigt. Genotypen ($00$, $AA$, $AB$ und $BB$) und Frischegewicht [kg/ha] wurden dort bestimmt. So richtig schlau, wird er daraus nicht.
...
Steffen betrachtet in sich gekehrt die Poster vor dem Büro von seine Betreuerin. Viele der explorativen Abbildungen sagen ihm etwas. Die Barplots und die Boxplots könnte er dann schon nachbauen. Das macht ihn dann zuversichtlich die Abschlussarbeit auch hinzukriegen. Etwas komischer sind die seltsamen Buchstaben über den Barplots. Steffen betrachtet ein Poster das sich mit Erdbeeren beschäftigt. Substrattypen ($kompost$, $torf$, $40p60n$ und $70p30n$) und Chlorophyllgehalt (SPAD-502Plus) [SPAD] wurden dort bestimmt. So richtig schlau, wird er daraus nicht. Als erstes müsse müsse man die Gruppen nach absteigender Effektstärke sortieren, liest Steffen im Methodenteil und ist dann noch verwirrter als vorher schon.
...
\item Interpretieren Sie das \textit{Compact letter display (CLD)} für Steffen und Tina! \textbf{(1 Punkt)} 
\end{enumerate}
...
'Oh, nee!', ruft Yuki aus und rollt entnervt mit ihren Augen. Yuki hatte ihre gesamte Analyse in SPSS gerechnet. Das war ja auch alles in Ordnung. Abbilungen haben geklappt und auch die statistischen Tests gingen dann irgendwie doch. Aber das CLD nicht. Yuki findet einfach keine Möglichkeit ein CLD in SPSS zu erhalten. Aber ihre Betreuerin möchte unbedingt ein CLD. Sonst wird es mit der Abgabe nichts. Dabei hatte sie schon wirklich eine Menge gemacht! Yuki hatte sich zwei Variablen mit Lichtstufen ($none$, $200lm$, $400lm$ und $800lm$) und Chlorophyllgehalt (SPAD-502Plus) [SPAD] in einen Versuch in einer Klimakammer mit Erdbeeren angeschaut. Wo kriegt sie jetzt ein CLD her? Dann eben per Hand aus der Matrix der $p$-Wert. Yuki stöhnt...
...
\midrule
\textbf{none} & 1.0000000 & 0.0276991 & 0.2216880 & 0.2839284\\
\textbf{200lm} & 0.0276991 & 1.0000000 & 0.3052977 & 0.1993737\\
\textbf{400lm} & 0.2216880 & 0.3052977 & 1.0000000 & 0.8259603\\
\textbf{800lm} & 0.2839284 & 0.1993737 & 0.8259603 & 1.0000000\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
\item Interpretieren Sie das \textit{Compact letter display (CLD)} für Yuki und Tina! \textbf{(2 Punkte)} 
\end{enumerate}
...
Tina hat sich ein Herz gefasst und war für ihrer Abschlussarbeit in die Niederlande gegangen. Das war eine super Zeit in der sie viel gelernt hat. Klar gab es auch die ein oder andere Besonderheit, aber das gehört hier eher nicht hin. Tina ist schon eine ganze Zeit im Büro, da ihre Betreuerin möchte, dass sie jetzt auf ihren Daten mit $n = 136$ Beobachtungen von Erdbeeren einen $\mathcal{X}^2$-Test rechnet. Das ginge, da sie als Behandlung \textit{KI-gesteuert [ja/nein]} bestimmt und zum anderen die Variable \textit{Chlorophyllgehalt unter Zielwert [ja/nein]} ermittelt hat. Wie genau, das ist jetzt eine andere Frage.
...
Tina hat sich ein Herz gefasst und war für ihrem Projektbericht in die Niederlande gegangen. Das war eine super Zeit in der sie viel gelernt hat. Klar gab es auch die ein oder andere Besonderheit, aber das gehört hier eher nicht hin. Tina ist schon eine ganze Zeit im Büro, da ihr Betreuer möchte, dass sie jetzt auf ihren Daten mit $n = 169$ Beobachtungen von Erdbeeren einen $\mathcal{X}^2$-Test rechnet. Das ginge, da sie als Behandlung \textit{KI-gesteuert [ja/nein]} bestimmt und zum anderen die Variable \textit{Frischegewicht über Zielwert [ja/nein]} ermittelt hat. Wie genau, das ist jetzt eine andere Frage.
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
     & \phantom{\textbf{Erkrankt (ja)}} & \phantom{\textbf{Erkrankt (ja)}} & \phantom{\textbf{Erkrankt (ja)}} \strut\\
    \hline
   \phantom{\textbf{Pestizid (ja)}} & \phantom{100}  & \phantom{100}  &   99  \strut\\
    \hline
...
Nilufar hat sich ein Herz gefasst und war für ihrer Hausarbeit in die Niederlande gegangen. Das war eine super Zeit in der sie viel gelernt hat. Klar gab es auch die ein oder andere Besonderheit, aber das gehört hier eher nicht hin. Nilufar ist schon eine ganze Zeit im Büro, da ihre Betreuerin möchte, dass sie jetzt auf ihren Daten mit $n = 169$ Beobachtungen von Erdbeeren einen $\mathcal{X}^2$-Test rechnet. Das ginge, da sie als Behandlung \textit{Herbizideinsatz [ja/nein]} bestimmt und zum anderen die Variable \textit{Trockengewicht über Zielwert [ja/nein]} ermittelt hat. Wie genau, das ist jetzt eine andere Frage. Nach ihrem Experiment erhielt sie folgende $2x2$ Kreuztabelle aus ihren erhobenen Daten.
...
'Hä? Hatten wir das als Aufgabe nicht schon mal, das wir aus kontinuierlichen Daten eine Abbildung bauen sollten?', fragt Nilufar. Steffen schaut fragend zurück. 'Kann mich wie immer an nichts erinnern. Können wir trotzdem jetzt erstmal die Daten auswerten? Columbo?', antwortet Steffen leicht angespannt. Die beiden hatten ein Feldexperiment im Oldenburger Land mit Erdbeeren durchgeführt. Dabei wurden die beiden folgenden Variablen gemessen: durchschnittlicher Regenwurmdichte [Anzahl/l] und Chlorophyllgehalt (SPAD-502Plus) [SPAD]. Jetzt haben die beiden eigentlich alles zusammen. \textit{Eigentlich...}
...
'Wichtig ist es, dass wir jetzt eine Gerade durch die Punkte zeichnen!', ruft Nilufar. 'Ich sehe nur zwei Zeilen und keine Punkte. Wie soll ich da denn jetzt eine Gerade durchzeichnen?', fragt Yuki. Nilufar atmet schwer ein und starrt auf die \Rlogo Ausgabe der Funktion \texttt{lm()}. Die beiden hatten ein Feldexperiment im Oldenburger Land mit Erdbeeren durchgeführt. Dabei wurden die beiden folgenden Variablen gemessen: durchschnittlicher Niederschlag [ml/w] und Chlorophyllgehalt (SPAD-502Plus) [SPAD]. Jetzt will die Betreuung von den beiden einmal die Visualisierung der Daten und auch gleich noch die lineare Regression gerechnet bekommen. Das haben beide in \Rlogo gemacht, aber wie soll das jetzt gehen?
...
\midrule
(Intercept) & 1.16 & 2.76 &  & \\
Durchschnittlicher Niederschlag & 1.06 & 0.27 &  & \\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
## -3.6243 -0.8788  0.0943  0.8187  2.7362 
## 
## Coefficients:
##                                 Estimate Std. Error t value Pr(>|t|)
## (Intercept)                      2.65225    2.23564   1.186    0.243
## Durchschnittlicher_Niederschlag  0.05924    0.21900   0.270    0.788
## 
## Residual standard error: 1.509 on 35 degrees of freedom
## Multiple R-squared:  0.002086,	Adjusted R-squared:  -0.02643 
## F-statistic: 0.07317 on 1 and 35 DF,  p-value: 0.7884
\end{verbatim}
\end{kframe}
\end{knitrout}
...
'Ich glaube ich bringe da was durcheinander. Ich möchte eine Gerade durch die Punkte zeichnen oder doch eine Korrelation berechnen?', merkt Steffen laut an. 'Ich sehe keine Punkte... das ist doch eine Ausgabe in \Rlogo. Überhaupt, darum geht es doch gar nicht in meinem Versuch. Ich wollte doch keine Gerade zeichnen?.', antwortet Steffen sich sichtlich übernächtigt selber. Die Nacht war zu lang und überhaupt. Steffen hatte ein Freilandversuch im Oldenburger Land mit Erdbeeren durchgeführt. Dabei wurden die beiden folgenden Variablen gemessen: durchschnittlicher Anteil an Ton [\%/l] und Chlorophyllgehalt (SPAD-502Plus) [SPAD]. Jetzt will er erstmal schauen, ob es einen Zusammenhang gibt und das soll mit der \Rlogo Ausgabe möglich sein.
...
## 
## data:  Durchschnittlicher Anteil an Ton [%/l] and Chlorophyllgehalt (SPAD-502Plus) [SPAD]
## t = 2.2741, df = 8, p-value = 0.05255
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  -0.004999918  0.900827807
## sample estimates:
##      cor 
## 0.626599
\end{verbatim}
...
Einflussvariablen ($x$) wurden erhoben: dry, weight und P. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
Paula und Yuki sind bei Alex um sich Hilfe für eine Versuchsplanung in \Rlogo zu holen. Dabei geht es um den Zusammenhang zwischen der Behandlung Bewässerungstypen ($ctrl$, $low$, $mid$ und $high$) sowie Lüftungssystemen und Folientunneln ($ctrl$, und $tornado$) und dem Messwert Chlorophyllgehalt (SPAD-502Plus) [SPAD] in Erdbeeren. Der Versuch soll in einem Freilandversuch im Wendland durchgeführt werden. Nach der Dozentin ist der Messwert Chlorophyllgehalt (SPAD-502Plus) [SPAD] normalverteilt. Die beiden entschieden sich für ein faktorielles Versuchsdesign. Im ersten Schritt überlegt Alex ein einfaches experimentelles Design zu probieren. Daher entscheiden sich alle drei für ein \textit{Complete randomized design (CRD)} mit nur einem der beiden Faktoren. Das sollte für den anfang erstmal reichen. 'Und jetzt, was machen wir jetzt?', Yuki schaut die anderen beiden mit großen Augen an. Die zucken mit der Schulter.\\

Leider kennen sich Alex, Paula und Yuki mit dem \textit{Complete randomized design (CRD)} überhaupt nicht aus. Deshalb brauchen die Drei bei der Erstellung Ihre Hilfe!
...
Nilufar und Yuki sind bei Mark um sich Hilfe für eine Versuchsplanung in \Rlogo zu holen. Dabei geht es um den Zusammenhang zwischen der Behandlung Lichtstufen ($none$, $200lm$, $400lm$ und $600lm$) sowie Substrattypen ($torf$, $70p30n$) sowie drei Blöcken und dem Messwert Chlorophyllgehalt (SPAD-502Plus) [SPAD] in Erdbeeren. Der Versuch soll in einem Feldexperiment in der Uckermark durchgeführt werden. Nach dem Dozenten ist der Messwert Chlorophyllgehalt (SPAD-502Plus) [SPAD] normalverteilt. Die beiden entschieden sich für ein faktorielles Versuchsdesign. Im ersten Schritt überlegt Mark ein komplexeres experimentelles Design zu probieren. Daher entscheiden sich alle drei für ein \textit{Randomized complete block design} mit Berücksichtigung einer Interaktion. Das sollte für den anfang erstmal reichen. 'Und jetzt, was machen wir jetzt?', Yuki schaut die anderen beiden mit großen Augen an. Die zucken mit der Schulter.\\

Leider kennen sich Mark, Nilufar und Yuki mit dem \textit{Randomized complete block design} überhaupt nicht aus. Deshalb brauchen die Drei bei der Erstellung Ihre Hilfe!
...
Alex: \textit{In R hat sich doch mein Datensatz geändert. Warum ist er jetzt wieder so wie vorher, wenn ich den Datensatz wieder aufrufe? Was mache ich falsch?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

Alex: \textit{Ich sehe überall dieses \texttt{c()}. Was ist denn deren Nutzen? } \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]
...
Alex: \textit{Jetzt sehe ich wieder diese Tilde ($\sim$) in R. Wo brauchen wir diese denn nochmal?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

Alex: \textit{Warum gibt es eigentlich das RStudio und R? Wie unterscheiden sich beide voneinander?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

Alex: \textit{Es gibt ja in R unter anderem \texttt{library()} und \texttt{Packages}. Was ist de Unterschied und wozu brauche ich die?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

Alex: \textit{Teilweise brauche ich das Konzept des Faktors in \Rlogo. Was ist ein Faktor?} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex]

Alex: \textit{Ich habe gehört, dass es Vorteile gibt \Rlogo zu nutzen. Nenne mir mal einen Vorteil!} \textbf{(1 Punkt)}\\[1ex]
Sie antworten:\\[2Ex] 
\clearpage
% -----------------------------------------------------------------------
...
Alex fragt: \textit{Wenn ich zwei Faktoren $f_1$ und $f_2$ habe, wie spezifiziere ich nochmal eine Interaktion in einem Modell? \textbf{(1 Punkt)}}\\[1ex]
Sie antworten:\\[2Ex]

Alex fragt: \textit{Viele Abbildungen gehen ja auch in Excel, aber \texttt{\{ggplot\}} ist schon besser. Wie verbindet \texttt{\{ggplot\}} eigentlich nochmal die einzelnen Ebenen? \textbf{(1 Punkt)}}\\[1ex]
Sie antworten:\\[2Ex]
...
Alex fragt: \textit{Okay, und für was brauche ich nochmal die R Pakete  \texttt{\{emmeans\}}, \texttt{\{ggplot\}} und \texttt{\{readxl\}}? \textbf{(2 Punkte)}}\\[1ex]
Sie antworten:\\[2Ex]

Alex fragt: \textit{Oh, wie baue ich mir nochmal die Daten in R? Wie heißt das Dateiformat? Gerne einmal mit Beispiel! \textbf{(1 Punkt)}}\\[1ex]
Sie antworten:\\[2Ex]

Alex fragt: \textit{Wenn ich Daten in R mit Gruppen eingelesen habe, welche Funktion nutze ich dann meistens als erstes und warum muss ich das machen? Was muss ich da machen? \textbf{(2 Punkte)}}\\[1ex]
Sie antworten:\\[2Ex]
...
Vor dem Start der eigenen Arbeit möchte sein Betreuer, dass Jonas einmal die wissenschaftliche Veröffentlichung \textit{Wu, G., et al. (2004). Arginine nutrition in neonatal pigs} sinnvoll zusammenfasst. Dann würde die eigene Arbeit auch leichter von der Hand gehen und Jonas hätte dann schon eine Vorlage. 'Das ist jetzt aber umfangreicher als gedacht!', schnauft er und runzelt die Stirn.\\
...
$75$cm sowie eine L{\"a}nge von  $250$cm.
...
\begin{enumerate}
\item Wenn 6 Blaubeerschalen 11.34 Euro kosten,  wie viel kosten 7 Schalen? \textbf{(2 Punkte)}
\item Wenn Sie die 7 Blaubeerschalen gekauft haben, wie viele Aligatorbirnen zu je 2.59 EUR können Sie sich dann noch für 50 EUR leisten? \textbf{(1 Punkt)}
\end{enumerate}
...
\item $i$ dem Verhalten: (1) wing/leg stretching, (2) drinking/eating, (3)
...
\midrule
wing/leg stretching & 33cm; 25cm; 12.1\% & 36cm; 29cm; 12.1\% & 36cm; 26cm; 10.1\%\\
drinking/eating & 33cm; 20cm; 0.8\% & 41cm; 27cm; 0.2\% & 38cm; 19cm; 0.8\%\\
foraging incl. scratching & 25cm; 21cm; 5.1\% & 32cm; 33cm; 6.1\% & 27cm; 30cm; 3.2\%\\
standing & 41cm; 27cm; 12.8\% & 37cm; 22cm; 18.1\% & 35cm; 22cm; 12.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCYBEZG & 2.0 | 1.5 | Mikro \\
    B & GCZ3F8W & 4.0 | 3.5 | Klein \\ 
    C & GCTDHYS & 4.5 | 1.0 | Mikro \\ 
    D & GCBIL4C & 5.0 | 2.0 | Normal \\ 
    E & GC3IBHY & 3.5 | 3.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 29 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{1.1\times 10^{10}} - \ensuremath{10^{9}} \cdot 2.1^{-0.2 \cdot t + 4.1}
\end{equation*}
...
In dem Spiel haben Sie nun auf einmal 7 zw{"o}lfseitige W{"u}rfel (7d12) zum w{\"u}rfeln in der Hand. Wenn Sie eine 12 w{\"u}rfeln,
...
Annegret und Elke das Team der drei Kandidaten.
