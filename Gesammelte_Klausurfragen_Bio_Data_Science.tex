...
%% --------------------------------------------------------------------
{\tiny\textbf{Stichworte:} Kardaschow-Skala $\bullet$ Dyson-Sphäre $\bullet$ Hohlerde $\bullet$ Entropie $\bullet$ Proton $r_P = 1.7 \times 10^{-15}$ $\bullet$ Wasserstoff $r_H = 5.3\times 10^{-11}$}
%% --------------------------------------------------------------------
