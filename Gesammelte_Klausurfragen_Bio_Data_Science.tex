...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.001, 0.34 und 0.21. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 3e-04, 0.085 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.004, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 3e-04, 0.085 und 0.0525. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.004, 1 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.004, 1.36 und 0.84. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 8, 13, 2, 15 und 14.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10.4 +/- 5.41
\item [\textbf{B} \msquare] Es ergibt sich 9.4 +/- 14.65
\item [\textbf{C} \msquare] Es ergibt sich 11.4 +/- 2.705
\item [\textbf{D} \msquare] Es ergibt sich 10.4 +/- 29.3
\item [\textbf{E} \msquare] Es ergibt sich 10.4 +/- 2.705
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 21, 27, 13, 36, 22, 22, 18, 21, 15, 22 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 [19, 28]
\item [\textbf{B} \msquare] Es ergibt sich 22 [18, 27]
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 18
\item [\textbf{D} \msquare] Es ergibt sich 22 +/- 27
...
$y = \{17, 12, 14, 16, 19, 16, 16\}$. Berechnen Sie folgende
...
\begin{center}
$11.4, 11, 10.3, 9.3, 10.9, 14.2, 9.8, 9.3, 9.6, 11, 9.7, 5.3$
\end{center}
...
## t = 0.16568, df = 14, p-value = 0.8708
...
## t = 0.27735, df = 12, p-value = 0.7862
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.938209  3.795352
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 21.16 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 57.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 171.161  85.580   29.35 1.123e-06
## Residuals 20  58.317   2.916
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 139 113 103 111  97  92 146 139 167 145 146 141
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 153.74 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 135 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 115.24 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 52 & 1171.69 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value   Pr(>F)
## dose       2 148.502  74.251  5.4101 0.014460
## form       1   0.015   0.015  0.0011 0.973625
## dose:form  2 267.011 133.506  9.7275 0.001367
## Residuals 18 247.041  13.725
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -8.7143 -2.9643 -0.1111  1.4365 10.2857 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  15.7143     1.8303   8.585 5.96e-07
## trtB         -0.6032     2.4405  -0.247    0.808
## 
## Residual standard error: 4.843 on 14 degrees of freedom
## Multiple R-squared:  0.004344,	Adjusted R-squared:  -0.06677 
## F-statistic: 0.06109 on 1 and 14 DF,  p-value: 0.8084
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 4.5048, df = 8, p-value = 0.001989
...
Einflussvariablen ($x$) wurden erhoben: block, dry und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.31 & 1 & 9.03 & 103.36 & 76.70 & 14\\
9.12 & 0 & 10.55 & 99.70 & 69.01 & 10\\
9.02 & 0 & 7.50 & 102.42 & 71.21 & 13\\
10.06 & 0 & 9.07 & 97.80 & 65.92 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.0926 -1.1827 -0.1289  1.6303  5.3405 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  5.416883   6.882403   0.787  0.43346
## water       -0.008417   0.159830  -0.053  0.95812
## P           -0.436108   0.130762  -3.335  0.00127
## Fe           0.692981   0.066231  10.463  < 2e-16
## 
## Residual standard error: 2.016 on 84 degrees of freedom
## Multiple R-squared:  0.5872,	Adjusted R-squared:  0.5725 
## F-statistic: 39.83 on 3 and 84 DF,  p-value: 4.137e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & do2 & acerage & maxdepth\\
\midrule
HERRINGTON\_RUN & 1 & 0.25 & 6.4 & 7056 & 60\\
LITTLE\_GUNPOWDER\_R & 3 & 2.60 & 9.7 & 15305 & 85\\
HAY\_MEADOW\_BR & 5 & 3.53 & 9.5 & 639 & 26\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -10.822   -4.061   -2.209    1.684   16.718  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 2.438e-01  1.425e+00   0.171  0.86486
## no3         2.049e-01  6.710e-02   3.054  0.00365
## do2         1.775e-01  1.413e-01   1.256  0.21509
## acerage     3.431e-05  1.212e-05   2.832  0.00669
## maxdepth    1.267e-02  4.457e-03   2.842  0.00652
## 
## (Dispersion parameter for quasipoisson family taken to be 35.86628)
## 
##     Null deviance: 2530.5  on 53  degrees of freedom
## Residual deviance: 1571.0  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.43      0.974   0.330
## 2 nematodes       0.121    -0.253   0.800
## 3 water           0.143    -1.00    0.316
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0147 -0.5514 -0.1484  0.4652  3.2129 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  218.5   14.78   
##  subject  (Intercept) 3937.8   62.75   
##  Residual              640.8   25.31   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.890     26.510   7.653
## attitudepop  -20.098      5.562  -3.613
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.2231315 0.0000000
## high 0.0000000 1.0000000 0.0000000 0.0160774
## low  0.2231315 0.0000000 1.0000000 0.0000000
## mid  0.0000000 0.0160774 0.0000000 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 8, 16, 18, 5 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 11, 10, 9, 7 und 4! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes freshmatter, P und grade an vier verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCGP5DX & 2.0 | 4.0 | Normal \\
    B & GCXPAOA & 2.5 | 2.0 | Mikro \\ 
    C & GC98ROF & 4.5 | 5.0 | Mikro \\ 
    D & GC9JJ6C & 3.0 | 4.5 | Klein \\ 
    E & GCNZ3KT & 3.5 | 1.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
Sie haben den Vektor $A = \{2, 1, 7\}$ und den Vektor $B = \{3, 8, 2\}$ gegeben.
