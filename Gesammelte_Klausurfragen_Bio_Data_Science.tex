...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.02, 0.21, 0.001, 0.89 und 0.03. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 1, 0.006, 1 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.04, 0.12, 1.26, 0.006, 5.34 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.0033, 0.035, 2e-04, 0.1483 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.12, 1, 0.006, 1 und 0.18. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.0033, 0.035, 2e-04, 0.1483 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 5, 13, 9, 11 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 8.8 +/- 4.6
\item [\textbf{B} \msquare] Es ergibt sich 10.8 +/- 1.515
\item [\textbf{C} \msquare] Es ergibt sich 9.8 +/- 9.2
\item [\textbf{D} \msquare] Es ergibt sich 9.8 +/- 1.515
\item [\textbf{E} \msquare] Es ergibt sich 9.8 +/- 3.03
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 22, 25, 30, 16, 29, 9, 18, 12, 23, 26 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 +/- 16
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 16
\item [\textbf{C} \msquare] Es ergibt sich 23 [16, 29]
\item [\textbf{D} \msquare] Es ergibt sich 23 +/- 29
\item [\textbf{E} \msquare] Es ergibt sich 25 [16, 29]
\end{enumerate}
...
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 3.14 liegt keine Overdispersion vor.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.08 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 7.76
\item [\textbf{B} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -2.79
\item [\textbf{C} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 7.76
...
$y = \{19, 16, 21, 20, 14, 18, 16\}$. Berechnen Sie folgende
...
\begin{center}
$10.3, 7.3, 12, 9.6, 9.4, 14.7, 11, 10, 10.4, 10, 9.6, 9.5, 7.6, 10.7$
\end{center}
...
## t = -0.076908, df = 10, p-value = 0.9402
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.706962  7.192676
## sample estimates:
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 123 111 117  98 112  93 143 123 150 138 144 154
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.57 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 27 & 10.93 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  4.4654  2.2327  5.3172 0.0113 *
## Residuals 27 11.3372  0.4199                 
## ---
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 207.63 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2422.26 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 110.13 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 721.12 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: len
##           Df Sum Sq Mean Sq  F value  Pr(>F)    
## supp       1   29.6   29.63   1.8864 0.17375    
## dose       2 3336.9 1668.47 106.2417 < 2e-16 ***
## supp:dose  2  138.0   68.98   4.3923 0.01576 *  
## Residuals 74 1162.1   15.70                     
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
\end{kframe}
...
Experiment mit $n = 184$ Sauen. In dem Experiment wurde gemessen,
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   94  \strut\\
    \hline
...
## -4.5714 -1.1429  0.2143  1.5714  3.0000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  19.5714     0.8312  23.545 1.17e-12 ***
## trtB         -4.5714     1.1083  -4.125  0.00103 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.199 on 14 degrees of freedom
## Multiple R-squared:  0.5486,	Adjusted R-squared:  0.5163 
## F-statistic: 17.01 on 1 and 14 DF,  p-value: 0.001031
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: rainfall, height und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\toprule
stream & longnose & do2 & maxdepth & acerage & temp\\
\midrule
CONOWINGO\_CR & 112 & 8.5 & 65 & 27350 & 24.1\\
LITTLE\_CONOCOCHEAGUE\_CR & 15 & 6.8 & 54 & 2227 & 24.0\\
LITTLE\_GUNPOWDER\_R & 3 & 9.7 & 85 & 15305 & 17.5\\
HAINES\_BR & 98 & 8.6 & 50 & 1967 & 16.8\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.321  -3.598  -1.533   1.407  19.101  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)   
## (Intercept) -2.132e+00  1.799e+00  -1.185  0.24185   
## do2          3.234e-01  1.319e-01   2.451  0.01786 * 
## maxdepth     6.940e-03  4.792e-03   1.448  0.15395   
## acerage      4.458e-05  1.329e-05   3.354  0.00154 **
## temp         9.905e-02  4.444e-02   2.229  0.03043 * 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for quasipoisson family taken to be 36.44416)
## 
##     Null deviance: 2044.2  on 53  degrees of freedom
## Residual deviance: 1316.0  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.402    -0.657   0.511
## 2 light           0.456     1.08    0.281
## 3 nematodes       0.170     1.35    0.177
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
9.64 & 0 & 9.48 & 99.56 & 68.44 & 5\\
10.92 & 0 & 10.28 & 100.70 & 65.88 & 12\\
8.25 & 0 & 11.09 & 98.55 & 66.71 & 6\\
9.93 & 0 & 8.21 & 101.86 & 70.07 & 6\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.3081 -1.3994 -0.1242  1.4718  7.1497 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 16.86664    8.26994   2.040   0.0444 *  
## Fe           0.58785    0.08195   7.173 2.08e-10 ***
## light        0.24392    0.51705   0.472   0.6383    
## P           -0.60775    0.14908  -4.077 9.91e-05 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 2.282 on 89 degrees of freedom
## Multiple R-squared:  0.4317,	Adjusted R-squared:  0.4125 
## F-statistic: 22.53 on 3 and 89 DF,  p-value: 6.074e-11
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2154 -0.6278 -0.0742  0.5135  3.2591 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  189.5   13.77   
##  subject  (Intercept) 4020.5   63.41   
##  Residual              664.4   25.78   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.584     26.702   7.550
## attitudepop  -17.945      5.663  -3.169
## 
...
\begin{verbatim}
##           A         B         C         D
## A 1.0000000 0.0014605 0.1493565 0.5992370
## B 0.0014605 1.0000000 0.0534769 0.0003375
## C 0.1493565 0.0534769 1.0000000 0.0531332
## D 0.5992370 0.0003375 0.0531332 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 5, 13, 6 und 6!  \textbf{(2 Punkte)} 
\item Erkl{\"a}ren Sie den Pfeil-Operator am Beispiel eines Zahlenvektors mit der
Funktion \texttt{c()} und den Zahlen 5, 13, 6 und 6!
