...
Sie haben folgende unadjustierten p-Werte gegeben: 0.34, 0.42, 0.001, 0.01, 0.21 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.07, 2e-04, 0.0017, 0.035 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.006, 0.06, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.006, 0.06, 1 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.04, 2.52, 0.006, 0.06, 1.26 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0567, 0.07, 2e-04, 0.0017, 0.035 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 16, 7, 17, 11 und 11.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 13.4 +/- 2.05
\item [\textbf{B} \msquare] Es ergibt sich 11.4 +/- 8.4
\item [\textbf{C} \msquare] Es ergibt sich 12.4 +/- 16.8
\item [\textbf{D} \msquare] Es ergibt sich 12.4 +/- 4.1
\item [\textbf{E} \msquare] Es ergibt sich 12.4 +/- 2.05
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 10, 19, 6, 15, 24, 15, 27, 13, 22, 19 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 +/- 13
\item [\textbf{B} \msquare] Es ergibt sich 19 [13, 24]
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.5, da es sich um eine Chancenverh{"a}ltnis handelt.
...
$y = \{15, 15, 17, 19, 17, 17, 17, 20, 15, 17, 17\}$. Berechnen Sie folgende
...
\begin{center}
$13.3, 8.4, 9.1, 12.3, 8.8, 10.9, 9.8, 10.3, 11.2, 8.3, 7.2, 6.3, 7.1, 11, 9$
\end{center}
...
## 
## data:  waterintake by infusion
## t = -0.40283, df = 10, p-value = 0.6955
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -8.210615  5.696329
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 203.11 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 92.89 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 82.776  41.388  36.444 1.041e-07
## Residuals 22 24.984   1.136
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 110 133 124  96 110 110 154 121 149 165 160 145
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 1.64 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 424.02 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 286.04 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 65 & 941.73 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  57.46  28.728  2.0872    0.1530
## form       1   1.24   1.238  0.0899    0.7677
## dose:form  2 523.31 261.654 19.0098 3.651e-05
## Residuals 18 247.75  13.764
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.5714  0.0214  0.4286  0.9571  3.8000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  15.5714     0.9298   16.75 1.21e-08
## trtB         15.6286     1.4404   10.85 7.49e-07
## 
## Residual standard error: 2.46 on 10 degrees of freedom
## Multiple R-squared:  0.9217,	Adjusted R-squared:  0.9139 
## F-statistic: 117.7 on 1 and 10 DF,  p-value: 7.489e-07
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: fertilizier, weight und rainfall. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.04 & 1 & 9.30 & 98.90 & 63.03 & 18\\
9.88 & 0 & 8.24 & 101.40 & 71.10 & 7\\
11.22 & 0 & 12.44 & 101.66 & 65.22 & 6\\
8.56 & 1 & 10.59 & 97.83 & 66.89 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.6959 -1.4977 -0.3542  1.5805  6.0090 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -7.07371    9.12944  -0.775    0.440
## light       -0.11149    0.55501  -0.201    0.841
## Fe           0.77250    0.09094   8.494 4.17e-13
## water       -0.05396    0.19780  -0.273    0.786
## 
## Residual standard error: 2.456 on 89 degrees of freedom
## Multiple R-squared:  0.4505,	Adjusted R-squared:  0.432 
## F-statistic: 24.32 on 3 and 89 DF,  p-value: 1.385e-11
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
DEAD\_RUN & 25 & 44.93 & 23.0 & 4145 & 0.34\\
LITTLE\_GUNPOWDER\_R & 3 & 6.96 & 17.5 & 15305 & 2.60\\
RED\_RUN & 32 & 5.50 & 17.7 & 3332 & 2.09\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.378  -4.172  -2.113   1.288  20.790  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.439e+00  9.209e-01   1.563  0.12457
## so4         -2.637e-02  2.695e-02  -0.978  0.33271
## temp         8.647e-02  4.745e-02   1.822  0.07450
## acerage      2.909e-05  1.577e-05   1.846  0.07101
## no3          1.969e-01  6.857e-02   2.872  0.00602
## 
## (Dispersion parameter for quasipoisson family taken to be 42.40737)
## 
##     Null deviance: 2360.0  on 53  degrees of freedom
## Residual deviance: 1650.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>    <dbl>
## 1 (Intercept)     1.47       3.31 0.000922
## 2 light           0.520      1.85 0.0639  
## 3 water           0.151     -3.20 0.00138
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2660 -0.6669 -0.1179  0.4806  3.0711 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  221.5   14.88   
##  subject  (Intercept) 4032.1   63.50   
##  Residual              665.3   25.79   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.894     26.823   7.527
## attitudepop  -19.085      5.667  -3.367
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0006492 0.2232373 0.1302278
## high 0.0006492 1.0000000 0.0162648 0.0332044
## low  0.2232373 0.0162648 1.0000000 0.7577728
## mid  0.1302278 0.0332044 0.7577728 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 17, 4, 6, 4 und 13!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 16, 4, 22, 5 und 8! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes drymatter, freshmatter und leaf an zwei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCKXF5U & 4.0 | 4.5 | Klein \\
    B & GCJOQWR & 2.5 | 1.5 | Mikro \\ 
    C & GCXK2K5 & 1.0 | 3.0 | Normal \\ 
    D & GCJWXNA & 5.0 | 4.0 | Mikro \\ 
    E & GCP3YZI & 2.0 | 2.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 900 n. Chr. f{\"u}r den neuen Lehnsherren
...
\item Im zweiten Versuch ziehen Fridolin und die Rentner mit einem
  $70^\circ$ Winkel mit ihrem Seil an dem Trecker. Welche Kraft
...
Sie haben den Vektor $A = \{-4, 6, 7\}$ und den Vektor $B = \{8, 4, 4\}$ gegeben.
