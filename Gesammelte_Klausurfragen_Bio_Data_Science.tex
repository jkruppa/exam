...
\begin{graybox}{Ergebnis der Klausur}
  ...
  \item[] \rule[0ex]{3em}{.4pt}\, von 49 Punkten sind aus dem Rechen- und
    Textteil erreicht. 
  \item[] \rule[0ex]{3em}{.4pt}\, von 69 Punkten in Summe.
...
\begin{graybox}{Rechen- und Textaufgaben}
  ...
  \begin{center}
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
      ...
      \hspace{1Ex}\Large\textcolor{gray!70}{12}\hspace{1Ex}  & 
      \hspace{1Ex}\Large\textcolor{gray!70}{NA}\hspace{1Ex}  & 
      \hspace{1Ex}\Large\textcolor{gray!70}{NA}\hspace{1Ex} \strut\\
      \hline
  \end{tabular}
\end{center}
\begin{itemize}
\item Es sind \rule[0ex]{2em}{.4pt}\, von 49 Punkten erreicht worden.
\end{itemize}
\end{graybox}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.42, 0.03, 0.34 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1, 0.15, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.084, 0.006, 0.068 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 2.1, 0.15, 1.7 und 4.45. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.084, 0.006, 0.068 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 1, 0.15, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 12, 6, 16, 10 und 16.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12 +/- 2.12
\item [\textbf{B} \msquare] Es ergibt sich 12 +/- 4.24
\item [\textbf{C} \msquare] Es ergibt sich 13 +/- 2.12
\item [\textbf{D} \msquare] Es ergibt sich 12 +/- 18
\item [\textbf{E} \msquare] Es ergibt sich 11 +/- 9
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 27, 34, 28, 16, 18, 12, 24, 28, 39, 21 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 27 +/- 18
\item [\textbf{B} \msquare] Es ergibt sich 27 +/- 18
\item [\textbf{C} \msquare] Es ergibt sich 27 [18, 34]
\item [\textbf{D} \msquare] Es ergibt sich 27 [19, 35]
\item [\textbf{E} \msquare] Es ergibt sich 27 +/- 34
\end{enumerate} 
...
$y = \{22, 13, 17, 25, 12, 19, 16\}$. Berechnen Sie folgende
...
\begin{center}
$9.1, 6.3, 12.3, 9.3, 10.7, 6.4, 9.4, 7.1, 12.3, 8.2, 12, 9.7$
\end{center}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 3.21 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 54.63 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 121.238  60.619  13.737 0.0002385
## Residuals 18  79.429   4.413
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 112 122 114 101  90 105 138 151 144 141 131 156
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 225.31 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 305.22 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 356.41 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 65 & 661.06 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value   Pr(>F)
## dose       2  12.57   6.286  0.1583 0.854753
## form       1 224.10 224.101  5.6446 0.028819
## dose:form  2 551.49 275.747  6.9454 0.005814
## Residuals 18 714.63  39.702
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -2.33333 -1.15000  0.03333  0.66667  2.66667 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  19.6000     0.6481  30.243 1.07e-12
## trtB         -4.2667     0.8083  -5.279 0.000195
## 
## Residual standard error: 1.449 on 12 degrees of freedom
## Multiple R-squared:  0.699,	Adjusted R-squared:  0.6739 
## F-statistic: 27.86 on 1 and 12 DF,  p-value: 0.000195
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 5.7263, df = 8, p-value = 0.0004408
...
\midrule
8.42 & 0 & 9.50 & 100.55 & 69.69 & 14\\
12.61 & 0 & 9.52 & 96.90 & 63.52 & 10\\
9.96 & 0 & 9.31 & 97.43 & 66.79 & 6\\
10.14 & 0 & 10.59 & 98.32 & 71.59 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.5481 -1.4267  0.0252  1.2754  3.5609 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 12.77625    7.40523   1.725   0.0878
## P           -0.52807    0.16913  -3.122   0.0024
## Fe           0.69144    0.06695  10.328  < 2e-16
## water       -0.66942    0.15645  -4.279  4.6e-05
## 
## Residual standard error: 2.071 on 92 degrees of freedom
## Multiple R-squared:  0.6153,	Adjusted R-squared:  0.6028 
## F-statistic: 49.05 on 3 and 92 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & temp & so4 & do2\\
\midrule
SOUTH\_BR\_CASSELMAN\_R & 2 & 6311 & 18.5 & 21.16 & 7.6\\
PATAPSCO\_R & 28 & 4706 & 19.7 & 9.90 & 8.9\\
ROCK\_CR & 3 & 575 & 18.0 & 7.61 & 6.8\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -9.4883  -3.7739  -2.5496  -0.3076  22.8825  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.503e-01  1.987e+00  -0.126   0.9003
## acerage      4.449e-05  1.739e-05   2.558   0.0137
## temp         8.908e-02  5.446e-02   1.636   0.1083
## so4         -8.806e-03  2.769e-02  -0.318   0.7518
## do2          2.177e-01  1.573e-01   1.384   0.1726
## 
## (Dispersion parameter for quasipoisson family taken to be 58.70464)
## 
##     Null deviance: 2341.8  on 53  degrees of freedom
## Residual deviance: 1823.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.89       2.38 0.0171 
## 2 water           0.185     -2.54 0.0111 
## 3 light           0.677      3.09 0.00201
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3131 -0.6664 -0.0585  0.5568  3.4223 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  188.2   13.72   
##  subject  (Intercept) 4079.6   63.87   
##  Residual              699.5   26.45   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.932     26.897   7.508
## attitudepop  -18.619      5.811  -3.204
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.2705855 0.2859173 0.8580724
## high 0.2705855 1.0000000 0.9716231 0.2024194
## low  0.2859173 0.9716231 1.0000000 0.2148182
## mid  0.8580724 0.2024194 0.2148182 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 14, 16, 6, 14 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 7, 14, 6, 12 und 6! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes Fe, freshmatter und drymatter an drei verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCGCVB8 & 2.5 | 3.5 | Normal \\
    B & GCFEK6X & 4.5 | 5.0 | Klein \\ 
    C & GCWYXD3 & 1.5 | 2.5 | Mikro \\ 
    D & GCQTTXS & 2.0 | 4.0 | Klein \\ 
    E & GCPCS0F & 5.0 | 1.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 969 n. Chr. f{\"u}r den neuen Lehnsherren
...
Seitenl{\"a}ngen $a$ und $b$ bei der Verwendung von 130m Zaun bestimmen!
...
Sie haben den Vektor $A = \{13, -9, 6\}$ und den Vektor $B = \{3, 0, 2\}$ gegeben.
