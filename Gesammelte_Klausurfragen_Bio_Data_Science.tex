...
\item [\textbf{B} \msquare] Die $\alpha$ ist notwendig um Effekte gegeneinander aufzurechnen. Ohne diese Adjustierung w{"u}rde der eigentliche Effekt nicht richtig gesch{"a}tzt. Daher handelt es sich um eine Adjustierung der Fehlerwahrscheinlichkeiten.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.89, 0.001, 0.34, 0.01 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 4.45, 0.005, 1.7, 0.05 und 2.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.005, 1, 0.05 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 2e-04, 0.068, 0.002 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.005, 1, 0.05 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.178, 2e-04, 0.068, 0.002 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
\item [\textbf{C} \msquare] Der Korrelationskoeffizienten nach Spearman wird genutzt, wenn das Outcome Y normalverteilt ist. Der Korrelationskoeffizienten liegt zwischen 0 und 1.
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 12, 10, 14 und 6.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10 +/- 5
\item [\textbf{B} \msquare] Es ergibt sich 11 +/- 3.16
\item [\textbf{C} \msquare] Es ergibt sich 11 +/- 10
\item [\textbf{D} \msquare] Es ergibt sich 11 +/- 1.58
\item [\textbf{E} \msquare] Es ergibt sich 12 +/- 1.58
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 25, 29, 12, 24, 19, 14 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 +/- 14
\item [\textbf{B} \msquare] Es ergibt sich 25 +/- 14
\item [\textbf{C} \msquare] Es ergibt sich 24 [14, 29]
\item [\textbf{D} \msquare] Es ergibt sich 25 [14, 29]
\item [\textbf{E} \msquare] Es ergibt sich 24 +/- 29
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.48 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung einer anderen Verteilungsfamilie wie die Quasipossion Verteilung.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.48 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
\item [\textbf{C} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.48 liegt keine Overdispersion vor.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.03 ist
richtig?
...
\begin{enumerate}
\item [\textbf{A} \msquare] X beinhaltet eine Spalte. Die Spalte gibt die Verteilungsfamilie vor.
...
\item [\textbf{D} \msquare] Die Mittelwerte werden modelliert.
...
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.38, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.62, da es sich um ein Anteil handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Odds ratio von 0.62, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
In einem Stallexperiment mit $n = 90$ Ferkeln wurden verschiedene
...
\midrule
(Intercept) & 38.42 & 0.30\\
light\_binhigh & 2.76 & 0.41\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 7.61
...
\item [\textbf{C} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 7.61
\item [\textbf{D} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 2.76
\item [\textbf{E} \msquare] In einer gaussian Regression kann kein Effekt roh interpretiert werden. Es muss erst eine Confounderadjustierung durchgef{"u}hrt werden.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 308
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 78
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 155
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 154
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 310
\end{enumerate}
...
$y = \{17, 16, 16, 13, 16, 19, 15\}$. Berechnen Sie folgende
...
\begin{center}
$8.2, 10.5, 9.6, 11.3, 8.7, 13.4, 9.1, 7.1, 9.7, 10.4, 9.7, 11.5, 8.8, 7.5$
\end{center}
...
\item Skizieren Sie in die
  ...
  \item[(e)] Ein Konfidenzintervall mit h{"o}hererFallzahl $n$ in der Stichprobe als der Rest der Konfidenzintervalle
  \end{itemize}
\end{enumerate}
...
## 
## data:  drymatter by Fe
## t = 0.47597, df = 14, p-value = 0.6414
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -2.782684  4.369986
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 91.56 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 57.08 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2   3.89  1.9448  0.3355 0.7189
## Residuals 20 115.94  5.7968
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 112 120 105 111  97 103 133 139 134 151 143 150
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 350.16 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 12.32 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 229.14 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 478.69 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 130.27  65.135  5.4726 0.0139084
## form       1 111.45 111.450  9.3639 0.0067430
## dose:form  2 326.70 163.350 13.7245 0.0002397
## Residuals 18 214.24  11.902
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   82   \strut\\
    \hline
     &  88 &  62 &  150  \strut\\
  \end{tabular}
\end{center}
...
## -7.6000 -0.5786 -0.0857  0.9286  7.4000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.571      1.478  11.212 5.52e-07
## trtB           1.029      2.290   0.449    0.663
## 
## Residual standard error: 3.91 on 10 degrees of freedom
## Multiple R-squared:  0.01978,	Adjusted R-squared:  -0.07824 
## F-statistic: 0.2018 on 1 and 10 DF,  p-value: 0.6629
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -5.7964, df = 8, p-value = 0.0004068
...
Einflussvariablen ($x$) wurden erhoben: height, weight und region. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.03 & 0 & 7.88 & 97.14 & 69.18 & 9\\
7.22 & 0 & 12.33 & 97.26 & 64.17 & 9\\
9.04 & 0 & 11.75 & 104.88 & 73.32 & 10\\
8.93 & 0 & 8.50 & 100.66 & 71.73 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.6182 -1.6734 -0.1058  1.3105  5.6776 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   6.5221     8.2770   0.788  0.43265
## P            -0.5424     0.1615  -3.359  0.00112
## water        -0.1127     0.1744  -0.646  0.51972
## Fe            0.6969     0.0768   9.075 1.45e-14
## 
## Residual standard error: 2.21 on 96 degrees of freedom
## Multiple R-squared:  0.5229,	Adjusted R-squared:  0.508 
## F-statistic: 35.07 on 3 and 96 DF,  p-value: 2.151e-15
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & no3 & temp & acerage & maxdepth\\
\midrule
MAINSTEM\_PATUXENT\_R & 239 & 3.31 & 18.1 & 8636 & 150\\
HERRINGTON\_RUN & 1 & 0.25 & 24.5 & 7056 & 60\\
HAINES\_BR & 98 & 7.71 & 16.8 & 1967 & 50\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.892  -3.879  -1.304   1.863  13.792  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 2.945e-01  9.531e-01   0.309 0.758676
## no3         2.775e-01  7.103e-02   3.906 0.000287
## temp        7.059e-02  3.929e-02   1.797 0.078558
## acerage     5.596e-05  1.380e-05   4.055 0.000179
## maxdepth    9.704e-03  3.913e-03   2.480 0.016631
## 
## (Dispersion parameter for quasipoisson family taken to be 30.58023)
## 
##     Null deviance: 2435.8  on 53  degrees of freedom
## Residual deviance: 1353.3  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.377     0.725   0.469
## 2 light           0.467     1.17    0.241
## 3 nematodes       0.139    -0.746   0.455
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 797
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1643 -0.5762 -0.1500  0.5179  3.4892 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  215.2   14.67   
##  subject  (Intercept) 3992.7   63.19   
##  Residual              680.3   26.08   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.458     26.691   7.623
## attitudepop  -21.494      5.731  -3.751
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0074586 0.0007593 0.0000474
## high 0.0074586 1.0000000 0.3933361 0.0745688
## low  0.0007593 0.3933361 1.0000000 0.3354060
## mid  0.0000474 0.0745688 0.3354060 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 13, 6, 9, 10 und 14!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 13, 10, 18, 10 und 11! \textbf{(2 Punkte)}
...
haben einen Radius von 4.5cm und eine H{\"o}he von 7cm. Der
