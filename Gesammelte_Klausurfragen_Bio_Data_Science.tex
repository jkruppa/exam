...
\begin{graybox}{Inhalte der Klausur nach Modul}  
  \small
  \textcolor{red}{\textit{Die folgende Einordnung der Themenkomplexe zu den Modulen dient zur Orientierung. Einzelene Klausuren können und werden davon abweichen. Die Angaben hier sind daher ohne Gewähr.}}\\[1Ex]
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.01, 0.89, 0.42, 0.03 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1, 1, 0.15 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 4.45, 2.1, 0.15 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.05, 1, 1, 0.15 und 0.005. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.178, 0.084, 0.006 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.002, 0.178, 0.084, 0.006 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 13, 15, 10, 9 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.8 +/- 1.195
\item [\textbf{B} \msquare] Es ergibt sich 10.8 +/- 2.85
\item [\textbf{C} \msquare] Es ergibt sich 11.8 +/- 2.39
\item [\textbf{D} \msquare] Es ergibt sich 11.8 +/- 5.7
\item [\textbf{E} \msquare] Es ergibt sich 12.8 +/- 1.195
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 4, 11, 24, 20, 13, 18, 14, 24, 26, 14 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 +/- 13
\item [\textbf{B} \msquare] Es ergibt sich 18 [13, 24]
\item [\textbf{C} \msquare] Es ergibt sich 18 +/- 13
\item [\textbf{D} \msquare] Es ergibt sich 18 +/- 24
\item [\textbf{E} \msquare] Es ergibt sich 21 [14, 25]
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich ein Risk ratio von 0.36, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.57, da es sich um ein Anteil handelt.
...
$y = \{14, 22, 16, 18, 11, 19, 21, 15, 9, 11, 15\}$. Berechnen Sie folgende
...
\begin{center}
$11.9, 11.1, 13, 9.9, 9.1, 11.5, 6.7, 9.9, 10.6, 4.7, 9.9, 10.3$
\end{center}
...
## t = 1.8951, df = 14, p-value = 0.07892
...
## t = -2.1516, df = 14, p-value = 0.04937
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.595904501 -0.007270102
## sample estimates:
...
## t = -0.61485, df = 12, p-value = 0.5501
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -7.269877  4.069877
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 24.15 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 76.41 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 50.667 25.3333  16.286 9.169e-05
## Residuals 18 28.000  1.5556
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 125 118 131  96 109  99 131 138 142 153 153 131
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 8.23 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 26.04 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 90.84 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 65 & 1041.73 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2  43.823  21.912   2.078 0.1541838
## form       1 216.980 216.980  20.577 0.0002558
## dose:form  2 224.196 112.098  10.631 0.0008949
## Residuals 18 189.805  10.545
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 172$ Sauen. In dem Experiment wurde gemessen,
...
##  -2.00  -1.25   0.00   1.00   3.00 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  16.0000     0.7746  20.656 1.57e-09
## trtB         -1.0000     1.0142  -0.986    0.347
## 
## Residual standard error: 1.732 on 10 degrees of freedom
## Multiple R-squared:  0.08861,	Adjusted R-squared:  -0.002532 
...
## t = -2.125, df = 8, p-value = 0.0663
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  -0.89268493  0.04656848
## sample estimates:
##        cor 
## -0.6006699
\end{verbatim}
...
Einflussvariablen ($x$) wurden erhoben: height, P und dry. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.59 & 1 & 11.43 & 100.34 & 65.26 & 9\\
12.37 & 1 & 9.01 & 104.22 & 75.65 & 13\\
9.36 & 0 & 9.75 & 91.26 & 63.90 & 12\\
12.39 & 0 & 9.54 & 101.73 & 69.89 & 4\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##    Min     1Q Median     3Q    Max 
## -8.844 -1.477  0.124  2.733  9.145 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 74.33910    4.27642  17.383   <2e-16
## light        1.47900    0.92461   1.600    0.114
## water       -0.07818    0.30210  -0.259    0.796
## P           -0.38847    0.29696  -1.308    0.195
## 
## Residual standard error: 3.83 on 81 degrees of freedom
## Multiple R-squared:  0.06023,	Adjusted R-squared:  0.02542 
## F-statistic:  1.73 on 3 and 81 DF,  p-value: 0.1673
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & acerage & temp & no3\\
\midrule
HOLLANDS\_BR & 38 & 10.5 & 1934 & 12.0 & 2.34\\
PINEY\_CR & 18 & 9.3 & 6949 & 18.6 & 4.57\\
HAWLINGS\_R & 1 & 8.3 & 1172 & 20.5 & 2.62\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.396  -3.457  -1.050   2.211  13.793  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -2.022e+00  1.546e+00  -1.308 0.196846
## do2          2.004e-01  1.145e-01   1.751 0.086226
## acerage      6.669e-05  1.720e-05   3.878 0.000314
## temp         1.260e-01  4.079e-02   3.089 0.003303
## no3          2.658e-01  6.808e-02   3.904 0.000289
## 
## (Dispersion parameter for quasipoisson family taken to be 22.01918)
## 
##     Null deviance: 1728.9  on 53  degrees of freedom
## Residual deviance: 1014.6  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.58      0.430   0.667
## 2 water           0.151    -0.560   0.575
## 3 nematodes       0.135    -0.298   0.766
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2073 -0.5791 -0.0842  0.6058  3.3451 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  208.0   14.42   
##  subject  (Intercept) 4224.0   64.99   
##  Residual              683.7   26.15   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.872     27.386   7.408
## attitudepop  -20.155      5.745  -3.508
## 
...
\begin{verbatim}
##           ctrl    high       low       mid
## ctrl 1.0000000 1.0e-07 0.0050593 0.2196817
## high 0.0000001 1.0e+00 0.0000000 0.0000044
## low  0.0050593 0.0e+00 1.0000000 0.0001667
## mid  0.2196817 4.4e-06 0.0001667 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 17, 11, 6, 13 und 20!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 9, 6, 7, 10 und 14! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes pigs, drymatter und Fe an vier verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{17, -1, 6\}$ und den Vektor $B = \{-2, 5, -9\}$ gegeben.
