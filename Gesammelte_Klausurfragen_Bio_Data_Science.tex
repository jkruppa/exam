...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.42, 0.03, 0.21, 0.89 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 2.52, 0.18, 1.26, 5.34 und 2.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.07, 0.005, 0.035, 0.1483 und 0.0567. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.07, 0.005, 0.035, 0.1483 und 0.0567. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 1, 0.18, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 1, 0.18, 1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 13, 13, 9 und 12.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12.2 +/- 1.025
\item [\textbf{B} \msquare] Es ergibt sich 11.2 +/- 2.05
\item [\textbf{C} \msquare] Es ergibt sich 11.2 +/- 4.2
\item [\textbf{D} \msquare] Es ergibt sich 10.2 +/- 2.1
\item [\textbf{E} \msquare] Es ergibt sich 11.2 +/- 1.025
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 21, 30, 21, 20, 16, 27, 15, 16, 25, 7 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 21 [16, 27]
\item [\textbf{B} \msquare] Es ergibt sich 24 [17, 28]
...
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 1.75, da es sich um ein Anteil handelt.
...
$y = \{17, 21, 17, 17, 18, 22, 17, 16, 18, 20, 17\}$. Berechnen Sie folgende
...
\begin{center}
$7.8, 7.9, 9.1, 13.2, 12.2, 10, 10.4, 12, 11.3, 12.6, 6.9, 8.3, 10, 10.1, 9.9$
\end{center}
...
## t = -2.8129, df = 10, p-value = 0.01838
...
## t = -0.78132, df = 10, p-value = 0.4527
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.622103  2.222103
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 49.45 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 54.03 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2  0.074 0.03704   0.013 0.9871
## Residuals 24 68.222 2.84259
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 117 124 125  94 117  96 131 142 124 162 155 140
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 5.28 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 169.86 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 138.11 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 409.89 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 133.61  66.807  3.6341 0.0472375
## form       1  72.14  72.135  3.9240 0.0630922
## dose:form  2 433.13 216.564 11.7805 0.0005362
## Residuals 18 330.90  18.383
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -2.4286 -2.0714 -0.8571  1.2143  5.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   19.429      1.030  18.860 2.76e-10
## trtB          -8.143      1.457  -5.589 0.000118
## 
## Residual standard error: 2.726 on 12 degrees of freedom
## Multiple R-squared:  0.7225,	Adjusted R-squared:  0.6994 
## F-statistic: 31.24 on 1 and 12 DF,  p-value: 0.0001181
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{Multiple R-squared}!
  Was sagt Ihnen der Wert $0.7225$ aus? \textbf{(2 Punkte)}
...
## t = -3.5347, df = 8, p-value = 0.007679
...
Einflussvariablen ($x$) wurden erhoben: P, weight und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
8.93 & 0 & 10.03 & 101.86 & 71.89 & 8\\
13.61 & 0 & 8.35 & 98.28 & 67.14 & 10\\
7.73 & 0 & 9.91 & 101.44 & 68.02 & 7\\
9.75 & 1 & 13.99 & 104.75 & 73.11 & 11\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.8036 -1.6846 -0.0206  1.6166  5.5405 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  3.16128    7.92748   0.399 0.690877
## light        0.65935    0.50073   1.317 0.190803
## Fe           0.71527    0.07845   9.118 6.26e-15
## P           -0.51846    0.15264  -3.397 0.000968
## 
## Residual standard error: 2.283 on 104 degrees of freedom
## Multiple R-squared:  0.4678,	Adjusted R-squared:  0.4525 
## F-statistic: 30.48 on 3 and 104 DF,  p-value: 3.214e-14
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
HAY\_MEADOW\_BR & 5 & 26 & 9.5 & 639 & 3.53\\
CONOWINGO\_CR & 112 & 65 & 8.5 & 27350 & 6.95\\
MAINSTEM\_PATUXENT\_R & 239 & 150 & 8.4 & 8636 & 3.31\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.120  -4.016  -1.863   1.953  16.481  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept) -3.308e-01  1.314e+00  -0.252 0.802306
## maxdepth     1.292e-02  4.073e-03   3.171 0.002622
## do2          2.185e-01  1.269e-01   1.721 0.091472
## acerage      2.826e-05  1.230e-05   2.297 0.025935
## no3          2.558e-01  6.693e-02   3.822 0.000374
## 
## (Dispersion parameter for quasipoisson family taken to be 31.79498)
## 
##     Null deviance: 2408.3  on 53  degrees of freedom
## Residual deviance: 1354.5  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.431    0.207   0.836 
## 2 light           0.490    1.84    0.0662
## 3 nematodes       0.186   -0.0652  0.948
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0555 -0.5817 -0.0917  0.5288  3.2454 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  205.9   14.35   
##  subject  (Intercept) 4116.6   64.16   
##  Residual              686.5   26.20   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.448     27.053   7.446
## attitudepop  -19.378      5.757  -3.366
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0117171 0.2290767 0.7063738
## high 0.0117171 1.0000000 0.1575229 0.0045275
## low  0.2290767 0.1575229 1.0000000 0.1180336
## mid  0.7063738 0.0045275 0.1180336 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, 13, 7, 4 und 7!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 16, 10, 6, 14 und 7! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes P, drymatter und freshmatter an vier verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCRLN1V & 1.0 | 3.5 | Klein \\
    B & GCEVLSO & 2.0 | 2.5 | Normal \\ 
    C & GC46AD2 & 3.0 | 4.5 | Normal \\ 
    D & GCGZIH0 & 4.0 | 4.0 | Normal \\ 
    E & GCXZSX0 & 3.5 | 5.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 264 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{12, -13, 2\}$ und den Vektor $B = \{5, -1, 7\}$ gegeben.
