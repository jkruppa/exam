...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\blacksquare\!\blacksquare\!\square\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\square\!\blacksquare$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\item [\textbf{B} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Umweltbedingungen erklärt wird. Daher werden 25\% der Varianz durch die Umweltbedingungen erklärt. Der Anteil der Varianz durch die Behandlungsgruppen ist dann 75\%.
\item [\textbf{C} \msquare] Es werden 75\% der Varianz durch die Behandlung erklärt. Das $\eta^2$ beschreibt den Anteil der Varianz, der von den unterschiedlichen Behandlungsbedingungen nicht erklärt wird.
\item [\textbf{D} \msquare] Das $\eta^2$ beschreibt den Anteil der Varianz, der von den Behandlungsbedingungen erklärt wird. Daher werden 25\% der Varianz durch die Behandlungsgruppen erklärt.
...
Wie lautet der Mittelwert und Standardabweichung von $y$ mit 9, 5, 5, 4 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Sie erhalten 6.6 +/- 1.64
\item [\textbf{B} \msquare] Es ergibt sich 5.6 +/- 3.65
\item [\textbf{C} \msquare] Es ergibt sich 6.6 +/- 2.7
\item [\textbf{D} \msquare] Sie erhalten 6.6 +/- 1.35
\item [\textbf{E} \msquare] Es berechnet sich 7.6 +/- 7.3
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit -1, 22, 16, 21, 11, 20, 23, 19, 20, 11 und 51.




\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 20 +/- 11
\item [\textbf{B} \msquare] Sie erhalten 20 [9; 20]
\item [\textbf{C} \msquare] Sie erhalten20 +/- 22
\item [\textbf{D} \msquare] Es ergibt sich 19 +/- 11
\item [\textbf{E} \msquare] Sie erhalten 20 [11; 22]
\end{enumerate} 
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Residuen folgen einer Poissonverteilung.
...
Neben der Mittelwertsdifferenz als Effektschätzer bei normalverteilten Endpunkten wird auch häufig der Effektschätzer Odds ratio bei binären Endpunkten verwendet. Welche Aussage über den Effektschätzer Odds ratio ist im folgenden Beispiel zur Behandlung von Klaueninfektionen bei Rinder richtig? Dabei sind 3 Tiere krank und 8 Tiere sind gesund.



\begin{enumerate}
\item [\textbf{A} \msquare] Da es sich um ein Chancenverhältnis handelt ergibt sich ein Odds ratio von 0.38.
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.27, da es sich um ein Anteil handelt. Wir berechnen den Anteil der Kranken.
\item [\textbf{C} \msquare] Das Verhältnis der Chancen Odds ratio ergibt ein Chancenverhältnis von 0.27. Wir sind an der Chance krank zu sein interessiert.
\item [\textbf{D} \msquare] Es ergibt sich ein Odds ratio von 0.27, da es sich um eine Chancenverhältnis handelt.
\item [\textbf{E} \msquare] Da es sich um ein Chancenverhältnis handelt ergibt sich ein Odds ratio von 3.67.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.01, 0.42, 0.21, 0.03 und 0.02. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.06, 1, 1, 0.18 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.0017, 0.07, 0.035, 0.005 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.0017, 0.07, 0.035, 0.005 und 0.0033. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.06, 1, 1, 0.18 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.006, 0.06, 2.52, 1.26, 0.18 und 0.12. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
Die folgende Abbildung enthält die Daten aus einer Studie zur Bewertung der Wirkung des Mikronährstoff Nitrat auf den Ertrag in t/ha von Papaya im Vergleich zu einer Kontrolle. Der Versuch wurde in 8 Parzellen pro Gruppe durchgeführt. Welche Aussage im Bezug auf eine statistische Auswertung ist richtig?
...
\item [\textbf{E} \msquare] Nach Betrachtung des Barplots liegt ein signifikanter Unterschied vor. Der Effekt liegt bei 2.
\end{enumerate}
...
Nach einem Versuch in einer Klimakammer mit drei L{"u}ftungssystemen und Folientunneln ($ctrl$, $storm$ und $tornado$) als Behandlung
...
Nach einem Gew{"a}chshausexperiment mit zwei Lichtstufen ($none$ und $600lm$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Datentabelle mit dem
...
\begin{center}
$3, 4, 4, 5, 3, 2, 6, 2, 0, 7, 4, 3, 4, 4, 3, 9, 3, 6, 1, 7, 6, 5, 4, 4, 5, 1, 3, 5, 1, 4, 2, 4, 6$
\end{center}
...
\begin{center}
$9.2, 10.2, 10.6, 8.9, 10.4, 9.6, 8.9, 11.4, 7.7, 12.4, 9.8, 12.4, 9.9, 11.9, 11.6, 13.1, 8.9, 12.5, 10.7, 10.4, 4.2, 4.4, 8.4$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  20\% & Testentscheidung & H$_0$ abgelehnt & Richtige Entscheidung \\
  \end{tabular}
  \end{center}
...
Trockengewicht (\textit{drymatter}) von Brokoli in $t/ha$.
...
Das Schlachtgewicht von Emus h{\"a}ngt ma{\ss}geblich von der
...
Gewicht von Emus wurde \textit{vor} der Behandlung mit
...
## t = -0.81689, df = 14, p-value = 0.4277
...
## t = -2.11, df = 14, p-value = 0.05333
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -7.55377144  0.06170795
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 82.92 &  &  &  \strut\\
    \hline
   \textbf{error}  & 22 &  &  &  &  \strut\\
        \hline
   \textbf{total}  & 24 & 165.36 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Maisspflanzen, die unter einer Kontrolle und zwei
verschiedenen Behandlungsbedingungen erzielt wurden. Dabei wurden die
Maisspflanzen unter verschiedenen Konzentrationen von einem alternativen
D{\"u}nger angebaut. Als Behandlung haben Sie daher den Faktor \textit{group} mit den
Faktorstufen \textit{lethal}, \textit{neg} und
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 50.97 &  &  &  \strut\\
    \hline
   \textbf{error}  & 20 & 42.51 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 37.789 18.8946  7.4695 0.003344
## Residuals 22 55.651  2.5296
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 266.25 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 31.23 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 161.77 &  &  &  \strut\\
    \hline
   \textbf{error}  & 32 & 309.62 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 55 Ziegen durchgef{\"u}hrt, wobei
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 567.30 283.649 14.6151 0.0001696
## form       1 251.87 251.866 12.9775 0.0020362
## dose:form  2   9.89   4.943  0.2547 0.7779093
## Residuals 18 349.34  19.408
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000134 0.0002248 0.3203100
## high 0.0000134 1.0000000 0.0000000 0.0002459
## low  0.0002248 0.0000000 1.0000000 0.0000122
## mid  0.3203100 0.0002459 0.0000122 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Experiment mit $n = 136$ Sauen. In dem Experiment wurde gemessen,
...
## -2.6000 -1.3643 -0.2857  0.8857  4.4000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  12.6000     0.9448   13.34 1.08e-07
## waterB       12.6857     1.2370   10.26 1.26e-06
## 
## Residual standard error: 2.113 on 10 degrees of freedom
## Multiple R-squared:  0.9132,	Adjusted R-squared:  0.9045 
## F-statistic: 105.2 on 1 and 10 DF,  p-value: 1.261e-06
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.9132$ aus? \textbf{(2 Punkte)}
...
## t = -6.6864, df = 8, p-value = 0.0001549
...
Einflussvariablen ($x$) wurden erhoben: variety, S und fertilizier. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\item Ein Kilo Salat benötigt 120l Wasser. Ein Salatkopf wiegt 320 - 530g.
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2022 blieben die Erträge von Blaubeeren mit \ensuremath{8\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge steigerte sich um 8.6\%. Die Exporte für Avocados fielen in dem gleichen Zeitraum um 21.2\% auf \ensuremath{2\times 10^{5}}t.
...
\midrule
preening & 31cm; 23cm; 8.9\% & 33cm; 30cm; 12.1\% & 41cm; 19cm; 12.1\%\\
standing & 46cm; 28cm; 64.1\% & 32cm; 15cm; 50.1\% & 41cm; 29cm; 24.1\%\\
wingflapping & 32cm; 25cm; 4.1\% & 27cm; 23cm; 3.6\% & 37cm; 35cm; 8.1\%\\
sitting & 35cm; 11cm; 0.8\% & 32cm; 30cm; 0.8\% & 35cm; 26cm; 0.1\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCRBXAZ & 2.0 | 2.0 | Normal \\
    B & GCBBZCD & 1.5 | 1.5 | Normal \\ 
    C & GCEM8ML & 3.0 | 2.5 | Klein \\ 
    D & GCLP2WM & 3.5 | 5.0 | Klein \\ 
    E & GCGWEWF & 1.0 | 3.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1163 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{8\times 10^{9}} - \ensuremath{1.1\times 10^{9}} \cdot 1.9^{-0.2 \cdot t + 3.2}
\end{equation*}
...
anderem wird dort der ber{\"u}hmte \textit{Doppelt gewellte,
  4-mal-gefaltete, 0.8mm, 30-cm-Karton} durch
