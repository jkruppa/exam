...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.03, 0.02, 0.001 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.084, 0.006, 0.004, 2e-04 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 0.1, 0.005 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.084, 0.006, 0.004, 2e-04 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.15, 0.1, 0.005 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.1, 0.15, 0.1, 0.005 und 4.45. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 0, 10, 7, 4 und 8.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 6.8 +/- 1.95
\item [\textbf{B} \msquare] Es ergibt sich 5.8 +/- 15.2
\item [\textbf{C} \msquare] Es ergibt sich 5.8 +/- 1.95
\item [\textbf{D} \msquare] Es ergibt sich 5.8 +/- 3.9
\item [\textbf{E} \msquare] Es ergibt sich 4.8 +/- 7.6
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 25, 32, 31, 17, 23, 21 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 +/- 32
\item [\textbf{B} \msquare] Es ergibt sich 25 [21, 32]
\item [\textbf{C} \msquare] Es ergibt sich 25 +/- 21
\item [\textbf{D} \msquare] Es ergibt sich 30 [22, 33]
\item [\textbf{E} \msquare] Es ergibt sich 30 +/- 21
\end{enumerate} 
...
$y = \{14, 17, 15, 16, 17, 16, 12, 16, 14, 14, 13\}$. Berechnen Sie folgende
...
\begin{center}
$10.1, 7.7, 12.7, 12, 11.2, 10.1, 6.4, 8.1, 8.1, 8.4, 12, 11, 11.4, 6.9$
\end{center}
...
## t = -2.0756, df = 12, p-value = 0.06009
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 84.76 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 114.6 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 40.668 20.3340  9.4612 0.001283
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 105.75 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 259.56 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 125.57 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 226.11 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value  Pr(>F)
## dose       2 179.28  89.639  4.9204 0.01974
## form       1   0.04   0.043  0.0024 0.96186
## dose:form  2 207.48 103.742  5.6945 0.01213
## Residuals 18 327.92  18.218
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##  -2.60  -2.05  -0.20   1.40   4.80 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   15.200      1.095  13.876 7.04e-07
## waterB         9.400      1.549   6.068    3e-04
## 
## Residual standard error: 2.449 on 8 degrees of freedom
## Multiple R-squared:  0.8215,	Adjusted R-squared:  0.7992 
## F-statistic: 36.82 on 1 and 8 DF,  p-value: 3e-04
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.8215$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: height, S und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.49 & 1 & 9.32 & 101.14 & 68.81 & 12\\
8.32 & 0 & 10.17 & 94.33 & 67.91 & 17\\
11.29 & 0 & 7.60 & 95.86 & 67.21 & 8\\
9.86 & 1 & 9.68 & 100.78 & 73.83 & 5\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.7532 -1.6970 -0.3656  1.8765  6.1566 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -1.499857   7.421534  -0.202 0.840237
## nematodes    0.009171   0.071706   0.128 0.898473
## water       -0.529790   0.153619  -3.449 0.000814
## Fe           0.764736   0.071806  10.650  < 2e-16
## 
## Residual standard error: 2.381 on 104 degrees of freedom
## Multiple R-squared:  0.5442,	Adjusted R-squared:  0.5311 
## F-statistic:  41.4 on 3 and 104 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & do2 & temp & so4 & no3\\
\midrule
WATTS\_BR & 19 & 6.7 & 26.5 & 14.19 & 5.25\\
NORTHWEST\_BR & 6 & 8.2 & 20.8 & 13.22 & 1.56\\
SAVAGE\_R & 106 & 7.7 & 21.4 & 12.28 & 0.63\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -8.3352  -4.2539  -1.5796   0.4292  21.4690  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.939984   1.835923   1.057   0.2958
## do2          0.127450   0.149637   0.852   0.3985
## temp         0.009904   0.049995   0.198   0.8438
## so4         -0.005315   0.024752  -0.215   0.8309
## no3          0.156950   0.078153   2.008   0.0501
## 
## (Dispersion parameter for quasipoisson family taken to be 47.79858)
## 
##     Null deviance: 1935.1  on 53  degrees of freedom
## Residual deviance: 1672.0  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.368   -0.817    0.414
## 2 light           0.448    1.59     0.113
## 3 nematodes       0.139   -0.0176   0.986
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.2857 -0.6077 -0.1671  0.5882  3.5631 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  193.6   13.91   
##  subject  (Intercept) 3955.5   62.89   
##  Residual              695.5   26.37   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.667     26.523   7.641
## attitudepop  -21.028      5.794  -3.629
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0007990 0.0014970 0.0739115
## high 0.0007990 1.0000000 0.0000000 0.0726922
## low  0.0014970 0.0000000 1.0000000 0.0000078
## mid  0.0739115 0.0726922 0.0000078 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\midrule
walking & 32cm; 29cm; 1.8\% & 28cm; 19cm; 1.8\% & 32cm; 23cm; 1.8\%\\
preening & 29cm; 23cm; 4.1\% & 37cm; 17cm; 5.2\% & 43cm; 23cm; 6.3\%\\
wingflapping & 35cm; 25cm; 1.2\% & 33cm; 27cm; 1\% & 38cm; 27cm; 1\%\\
drinking/eating & 39cm; 31cm; 13.2\% & 43cm; 23cm; 16.4\% & 37cm; 24cm; 12.3\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCMHRCQ & 1.5 | 1.0 | Mikro \\
    B & GCGSO46 & 1.0 | 1.5 | Klein \\ 
    C & GCJG4NR & 3.5 | 4.0 | Normal \\ 
    D & GCELSOB & 4.5 | 4.5 | Mikro \\ 
    E & GCFSCIV & 4.0 | 3.0 | Klein \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 726 n. Chr. f{\"u}r den neuen Lehnsherren
...
Sie haben den Vektor $A = \{13, 7, 13\}$ und den Vektor $B = \{2, -2, 3\}$ gegeben.
