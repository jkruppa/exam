...
\fancypagestyle{empty}{
  \fancyfoot[L]{\tiny $\square\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\blacksquare\!\blacksquare\!\blacksquare\!\blacksquare\!\square\!\square\!\blacksquare\!\square\!\blacksquare\!\blacksquare$}
}
\thispagestyle{empty}
\clearpage
% -----------------------------------------------------------------------
...
\item [\textbf{D} \msquare] ... den Unterschied zwischen der Varianz über alle Behandlungsgruppen und der Varianz aus verschiedenen Behandlungsguppen. Wenn die ANOVA signifikant ist, muss ein Posthoc-Test angeschlossen werden.
...
Gegeben ist $y$ mit 4, 11, 6, 9 und 9. Berechnen Sie den Mittelwert und Standardabweichung.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 6.8 +/- 3.85
\item [\textbf{B} \msquare] Sie erhalten 7.8 +/- 2.77
\item [\textbf{C} \msquare] Es berechnet sich 8.8 +/- 7.7
\item [\textbf{D} \msquare] Sie erhalten 7.8 +/- 1.385
\item [\textbf{E} \msquare] Es ergibt sich 8.8 +/- 1.385
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 9, 14, 22, 16, 34, 12 und 63.




\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 16 [12; 34]
\item [\textbf{B} \msquare] Es ergibt sich 24 +/- 12
\item [\textbf{C} \msquare] Es ergibt sich 16 +/- 12
\item [\textbf{D} \msquare] Es berechnet sich 17 [13; 33]
\item [\textbf{E} \msquare] Es berechnet sich 24 [13; 35]
\end{enumerate} 
...
\item [\textbf{D} \msquare] Violinplot, Boxplot, Densityplot
...
In dem folgenden Histogramm von $n = 184$ Pflanzen ist welche Verteilung abgebildet?
...
\item [\textbf{B} \msquare] Ein prädiktives Modell möchte die Zusammenhänge von X auf Y modellieren. Hierbei geht es um die Effekte von $X$ auf $Y$. Man sagt, wenn $x_1$ um 1 ansteigt ändert sich $Y$ um einen Betrag $\beta_1$.
...
\item [\textbf{E} \msquare] Wenn der Effekt $\beta_{Fe_3O_4}$ winzig ist, dann kann es an einer falsch gewählten Einheit liegen. Der Anstieg von einer Einheit in $X$ führt ja zu einer Änderung von $\beta_{Fe_3O_4}$ in $x$. Wir müssen daher die Einheit von $y$ entsprechend anpassen.
\end{enumerate}
...
\item [\textbf{B} \msquare] Es ergibt sich ein Odds ratio von 0.62, da es sich um eine Chancenverhältnis handelt
  
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.62, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Der Anteil der Kranken wird berechnet. Da es sich um ein Anteil handelt ergibt sich ein Odds ratio von 0.38.
\item [\textbf{E} \msquare] Der Anteil der Gesunden wird berechnet. Da es sich um ein Anteil handelt ergibt sich ein Odds ratio von 0.38.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.001, 0.01, 0.02, 0.42 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.05, 0.1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.002, 0.004, 0.084 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.05, 0.1, 2.1 und 4.45. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.005, 0.05, 0.1, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2e-04, 0.002, 0.004, 0.084 und 0.178. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate}
...
\item [\textbf{D} \msquare] Der Test deutet auf einen signifikanten Unterschied hin. Der Effekt liegt vermutlich bei 8.
\item [\textbf{E} \msquare] Die Barplots deuten auf einen signifikanten Unterschied. Der Effekt liegt vermutlich bei 8 unter einer groben Abschätzung. Wir müssen aber eine ANOVA rechnen um den Effekt wirklich bestimmen zu können.
\end{enumerate}
...
Anschauen, was andere vor einem gemacht haben, ist eine Möglichkeit schnell ans Ziel zu gelangen. Noa soll in seiner Projektbericht Erdbeeren untersuchen. Die Behandlung in seiner Projektbericht werden verschiedene Substrattypen ($torf$, $40p60n$ und $70p30n$) sein. Erheben wird Noa als Messwert ($Y$) \textit{Proteingehalt} benannt als \textit{protein} in seiner Exceldatei. Von seiner Betreuerin erhält er nun folgende Abbildung von Barplots, die er erstmal zur Übung nachbauen soll, bevor er mit dem eigentlichen Versuch beginnt.
...
Anschauen, was andere vor einem gemacht haben, ist eine Möglichkeit schnell ans Ziel zu gelangen. Deshalb hat sich Adele viele Poster in der Fakultät angeschaut und ist zum Schluß gekommen, dass Barplots eine häufig genutzte Abbildung sind. Adele soll nun in ihrer Projektbericht Erdbeeren untersuchen. Die Behandlung in ihrer Projektbericht sind verschiedene Substrattypen ($torf$, $40p60n$ und $70p30n$). Erhoben wurden von Adele als Endpunkt ($Y$) \textit{Proteingehalt} benannt als \textit{protein} in ihrer Exceldatei. Erwartungsgemäß erhält sie von ihrer Betreuerin den Auftrag die erhobenen Daten als Barplots darzustellen. Dann kann Adele auch schonmal abschätzen, was bei einem statistischen Test rauskommen könnte.
...
Leider kennt sich Adele mit der Erstellung von Barplots nicht aus. Deshalb braucht sie bei der Visualisierung Ihre Hilfe!
...
Anschauen, was andere vor einem gemacht haben, ist eine Möglichkeit schnell ans Ziel zu gelangen. Paula soll in ihrer Projektbericht Lauch untersuchen. Die Behandlung in ihrer Projektbericht werden verschiedene Substrattypen ($torf$, $40p60n$ und $70p30n$) sein. Erheben wird Paula als Messwert ($Y$) \textit{Proteingehalt} benannt als \textit{protein} in ihrer Exceldatei. Von ihrer Betreuerin erhält sie nun folgende Abbildung von Boxplots, die sie erstmal zur Übung nachbauen soll, bevor sie mit dem eigentlichen Versuch beginnt. Anhand von Boxplots lässt sich eine Aussage über die Normalverteilung von $Y$ treffen.
...
\begin{center}
Die Anzahl an weißen Blutkörperchen: 3, 4, 3, 2, 3, 5, 4, 3, 3, 1, 4, 4, 6, 1, 2, 6, 3, 4, 3, 6, 6, 2, 3, 4, 1, 1, 7, 6, 2, 7, 4, 3, 3, 8, 3, 6
\end{center}
...
In ihrer Abschlussarbeit möchte Paula gerne die Daten aus einem Stallexperiment mit Zander in einem Histogramm darstellen. Das Histogramm erlaubt ihr dabei Rückschlüsse auf die Verteilung über den Messwert ($Y$) zu treffen. In seinem Experiment hat Paula die mittleren auffälligen Hautflecken gezählt.

\begin{center}
Die mittleren auffälligen Hautflecken: 11.8, 7.3, 9.8, 12.3, 8, 9.5, 7.1, 8.2, 6.5, 12, 10.5, 10.7, 12.1, 9.3, 11.7, 10.2, 12, 10.1, 8.8, 10.7, 9.1, 8.2
\end{center}
...
Manuel möchte gerne den Zusammenhang zwischen durchschnittlichen Bewegungsscore [Movement/h] und Gewichtszuwachs in der 1LW im Kontext von Milchvieh herausfinden. Hierfür hat Manuel ein Stallexperiment im Oldenburger Land durchgeführt. Nach einigen unvorgesehenen Ereignissen hat er es geschafft folgende Datentabelle zu erstellen. Nun stellt sich die Frage für ihn, ob es überhaupt einen Zusammenhang zwischen den gemessenen Variablen gibt. Deshalb möchte Manuel als erstes eine explorative Datenanalyse durchführen.
...
Leider kennt sich Manuel mit der Erstellung einer explorativen Datenanalyse für kontinuierliche Daten überhaupt nicht aus. Deshalb braucht er bei der Erstellung Ihre Hilfe!
...
'Uff!', denkt sich Sabine. Jetzt hat sie doch tatsächlich zwei kategoriale Variablen in ihrer Abschlussarbeit gemessen. Zum einen Pestizideinsatz [ja/nein] und zum anderen Proteingehalt im Zielbereich [ja/nein] im Kontext von Erbsen. Hierfür hat sie einen Versuch in einer Klimakammer in der Uckermark durchgeführt. Jetzt möchte Mark die Daten einmal in einer explorativen Datenanalyse darstellen. Danach kann er dann über den passenden statistischen Test nachdenken. Dabei unterstützt ihr Betreuer diesen Ansatz bevor es in der Datenanalyse weiter geht.
...
\begin{enumerate}
\item Stellen Sie den Zusammenhang zwischen den beiden kategorialen Variablen in einer Tabelle dar! \textbf{(3 Punkte)}
\item Visualisieren Sie den Zusammenhang zwischen den beiden kategorialen Variablen! \textbf{(3 Punkte)}
\item Berechnen Sie die Verhältnis! Welche Annahme haben Sie getroffen? \textbf{(2 Punkte)}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  (Unbekannte) Wahrheit & 20\% & Testentscheidung & H$_0$ wahr \\
  \end{tabular}
  \end{center}
...
Trockengewicht (\textit{drymatter}) von Kartoffeln in $kg/ha$.
...
## t = -4.8705, df = 12, p-value = 0.0003847
...
## t = -1.9442, df = 14, p-value = 0.07224
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -6.5097624  0.3192862
## sample estimates:
...
## 
## data:  t0 and t1
## t = -6.8931, df = 4, p-value = 0.002322
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -7.855595 -3.344405
## sample estimates:
...
In einem Experiment in einer Klimakammer wurde der Ertrag von Erbsen unter drei verschiedenen
...
Puten, die unter einer Kontrolle und zwei verschiedenen
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 2.49 &  &  &  \strut\\
    \hline
   \textbf{error}  & 20 & 42.98 &  &  &  \strut\\
        \hline
...
Faktorstufen \textit{lethal}, \textit{high} und
\textit{pos} vorliegen.
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{group}  & 2 & 340.07 &  &  &  \strut\\
    \hline
   \textbf{error}  & 24 & 134.67 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Der Datensatz \textit{plant\_tbl} enth{\"a}lt das Outcome \textit{freshmatter} f{\"u}r ein Feldexperiment mit 
...
## trt        2 248.325 124.163  70.702 2.635e-10
## Residuals 22  38.635   1.756
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 21.88 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 151.91 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 111.76 &  &  &  \strut\\
    \hline
   \textbf{error}  & 32 & 252.6 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 52 Puten durchgef{\"u}hrt, wobei
jedes Tier eine von drei Selen-Dosen $dose$ ($0.5$ ng/Tag, $3$ ng/Tag und $20$ ng/Tag)
...
## Response: fat_perc
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  68.04   34.02  2.0339    0.1598
## form       1 479.55  479.55 28.6718 4.338e-05
## dose:form  2  80.81   40.41  2.4158    0.1177
## Residuals 18 301.06   16.73
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl     high       low       mid
## ctrl 1.0000000 8.86e-05 0.0019334 0.5394638
## high 0.0000886 1.00e+00 0.0000000 0.0005140
## low  0.0019334 0.00e+00 1.0000000 0.0003519
## mid  0.5394638 5.14e-04 0.0003519 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
den Spalten. Insgesamt wurden $n = 100$ Pflanzen untersucht.
\vspace{5Ex}
...
##  -4.00  -1.00  -0.20   1.45   4.00 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  18.0000     0.7278  24.734 1.15e-11
## waterB       -7.6000     1.2178  -6.241 4.31e-05
## 
## Residual standard error: 2.183 on 12 degrees of freedom
## Multiple R-squared:  0.7645,	Adjusted R-squared:  0.7448 
## F-statistic: 38.95 on 1 and 12 DF,  p-value: 4.313e-05
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.7645$ aus? \textbf{(2 Punkte)}
...
## t = -5.3263, df = 8, p-value = 0.0007057
...
Einflussvariablen ($x$) wurden erhoben: height, region und block. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\item Wenn Sie die 12 Blaubeerschalen gekauft haben, wie viele Aligatorbirnen zu je 1.79 EUR können Sie sich dann noch für 50 EUR leisten? \textbf{(1 Punkt)}
\end{enumerate}
...
Chile exportiert im großem Ausmaß Blaubeeren und Avocados. In dem Exportjahr 2022 blieben die Erträge von Blaubeeren mit \ensuremath{7.7\times 10^{4}}t in dem prognostizierten Rahmen. Die Menge steigerte sich um 6.8\%. Die Exporte für Avocados stiegen in dem gleichen Zeitraum um 23.8\% auf \ensuremath{1.9\times 10^{5}}t.
...
\midrule
foraging incl. scratching & 35cm; 31cm; 12.1\% & 34cm; 33cm; 4.5\% & 38cm; 36cm; 12.1\%\\
wing/leg stretching & 36cm; 22cm; 0.8\% & 35cm; 25cm; 0.2\% & 37cm; 17cm; 0.2\%\\
standing & 39cm; 36cm; 1.2\% & 41cm; 24cm; 8.1\% & 37cm; 31cm; 0.5\%\\
dustbathing & 28cm; 20cm; 1.2\% & 34cm; 29cm; 1.2\% & 37cm; 21cm; 6.9\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCNS9WR & 4.5 | 3.5 | Mikro \\
    B & GCVAPLW & 3.5 | 1.5 | Klein \\ 
    C & GCIJHDV & 3.0 | 1.0 | Normal \\ 
    D & GCOYWO3 & 1.5 | 3.0 | Normal \\ 
    E & GCPZN59 & 1.0 | 4.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 572 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{9\times 10^{9}} - \ensuremath{1.4\times 10^{9}} \cdot 1.9^{-0.2 \cdot t + 2.7}
\end{equation*}
