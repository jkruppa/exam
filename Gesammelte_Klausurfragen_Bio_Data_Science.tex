...
Sie haben folgende unadjustierten p-Werte gegeben: 0.02, 0.21, 0.42, 0.89, 0.01 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0033, 0.035, 0.07, 0.1483, 0.0017 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1, 1, 1, 0.06 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1.26, 2.52, 5.34, 0.06 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0033, 0.035, 0.07, 0.1483, 0.0017 und 2e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 1, 1, 1, 0.06 und 0.006. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 8, 7, 13, 16 und 13.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.4 +/- 1.89
\item [\textbf{B} \msquare] Es ergibt sich 11.4 +/- 14.3
\item [\textbf{C} \msquare] Es ergibt sich 12.4 +/- 1.89
\item [\textbf{D} \msquare] Es ergibt sich 10.4 +/- 7.15
\item [\textbf{E} \msquare] Es ergibt sich 11.4 +/- 3.78
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 22, 16, 9, 33, 11, 15, 12, 23, 25, 14 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 16 +/- 12
\item [\textbf{B} \msquare] Es ergibt sich 16 +/- 25
\item [\textbf{C} \msquare] Es ergibt sich 16 [12, 25]
\item [\textbf{D} \msquare] Es ergibt sich 21 [13, 26]
\item [\textbf{E} \msquare] Es ergibt sich 21 +/- 12
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.47 liegt keine Overdispersion vor.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.47 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung einer anderen Verteilungsfamilie wie die Quasipossion Verteilung.
...
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.47 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.77 ist
richtig?
...
In einem Stallexperiment mit $n = 93$ Ferkeln wurden verschiedene
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 8.22
\item [\textbf{B} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 8.22
...
\item [\textbf{D} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -2.87
...
$y = \{19, 16, 15, 15, 15, 15, 14, 19, 15, 16, 15\}$. Berechnen Sie folgende
...
\begin{center}
$11.7, 8.3, 9.8, 9.4, 12, 9.2, 12.7, 13.1, 6.6, 10, 11, 7.7$
\end{center}
...
## t = -3.4306, df = 10, p-value = 0.006432
...
## 
## data:  drymatter by Fe
## t = -2.51, df = 6, p-value = 0.0459
## alternative hypothesis: true mean difference is not equal to 0
## 95 percent confidence interval:
##  -5.92461905 -0.07538095
## sample estimates:
## mean difference 
##              -3
\end{verbatim}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 64.67 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 18 & 88.57 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 177.662  88.831   36.34 1.066e-07
## Residuals 22  53.778   2.444
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 120 133 113 108 110 100 129 148 159 152 158 139
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 23.98 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 363.97 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 44.33 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 257.6 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 251.90 125.948  9.4984 0.0015275
## form       1   7.51   7.515  0.5667 0.4612947
## dose:form  2 423.79 211.895 15.9802 0.0001023
## Residuals 18 238.68  13.260
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.7778 -2.4087 -0.0317  2.0913  5.2222 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   18.778      1.073   17.50 6.49e-11
## trtB          -4.492      1.622   -2.77    0.015
## 
## Residual standard error: 3.218 on 14 degrees of freedom
## Multiple R-squared:  0.354,	Adjusted R-squared:  0.3079 
## F-statistic: 7.672 on 1 and 14 DF,  p-value: 0.01505
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -3.7185, df = 8, p-value = 0.005884
...
Einflussvariablen ($x$) wurden erhoben: variety, dry und N. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.73 & 0 & 12.08 & 99.99 & 68.35 & 9\\
8.89 & 0 & 10.89 & 96.52 & 65.11 & 9\\
9.60 & 0 & 9.49 & 97.36 & 69.84 & 6\\
9.30 & 0 & 9.36 & 99.89 & 67.76 & 9\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -6.9260 -2.4052 -0.1565  2.5237  7.9535 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) 75.671206   3.258040  23.226   <2e-16
## P           -0.695194   0.294611  -2.360   0.0209
## nematodes   -0.005335   0.105633  -0.051   0.9599
## light        1.983037   0.852840   2.325   0.0228
## 
## Residual standard error: 3.261 on 75 degrees of freedom
## Multiple R-squared:  0.1455,	Adjusted R-squared:  0.1114 
## F-statistic: 4.258 on 3 and 75 DF,  p-value: 0.00783
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & maxdepth & temp & no3 & do2\\
\midrule
TUSCARORA\_CR & 38 & 90 & 15.0 & 5.45 & 9.3\\
SENECA\_CR & 23 & 45 & 20.1 & 1.58 & 9.9\\
SOUTH\_BR\_CASSELMAN\_R & 2 & 46 & 18.5 & 0.64 & 7.6\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -8.599  -4.333  -1.874   1.332  14.428  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.716529   1.866568  -0.384  0.70273
## maxdepth     0.013588   0.004276   3.178  0.00257
## temp         0.056851   0.046700   1.217  0.22930
## no3          0.192156   0.079746   2.410  0.01977
## do2          0.189431   0.140275   1.350  0.18308
## 
## (Dispersion parameter for quasipoisson family taken to be 40.82674)
## 
##     Null deviance: 2339.0  on 53  degrees of freedom
## Residual deviance: 1642.4  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.394    -0.877   0.380
## 2 nematodes       0.154     1.00    0.317
## 3 light           0.499     0.327   0.744
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 793.7
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.0913 -0.6542 -0.1490  0.5495  3.5787 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  170.0   13.04   
##  subject  (Intercept) 4054.0   63.67   
##  Residual              658.9   25.67   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)   202.11      26.75   7.555
## attitudepop   -20.25       5.64  -3.591
## 
...
\begin{verbatim}
##           ctrl      high low       mid
## ctrl 1.0000000 0.1526618   0 0.0605321
## high 0.1526618 1.0000000   0 0.0017715
## low  0.0000000 0.0000000   1 0.0000000
## mid  0.0605321 0.0017715   0 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 5, 1, 5, 10 und 12!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 11, 4, 9, 11 und 1! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes P, freshmatter und leaf an vier verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{2, 4, 6\}$ und den Vektor $B = \{4, -7, 1\}$ gegeben.
