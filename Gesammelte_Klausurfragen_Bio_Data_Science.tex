...
Sie haben folgende unadjustierten p-Werte gegeben: 0.42, 0.89, 0.21, 0.02, 0.03 und 0.34. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1, 0.12, 0.18 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.1483, 0.035, 0.0033, 0.005 und 0.0567. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 2.52, 5.34, 1.26, 0.12, 0.18 und 2.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.07, 0.1483, 0.035, 0.0033, 0.005 und 0.0567. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 1, 0.12, 0.18 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 18, 15, 12, 14 und 1.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 12 +/- 42.5
\item [\textbf{B} \msquare] Es ergibt sich 13 +/- 3.26
\item [\textbf{C} \msquare] Es ergibt sich 12 +/- 3.26
\item [\textbf{D} \msquare] Es ergibt sich 11 +/- 21.25
\item [\textbf{E} \msquare] Es ergibt sich 12 +/- 6.52
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 20, 7, 24, 31, 22, 12, 33, 13, 24, 15 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 [14, 32]
\item [\textbf{B} \msquare] Es ergibt sich 22 +/- 31
\item [\textbf{C} \msquare] Es ergibt sich 22 +/- 13
\item [\textbf{D} \msquare] Es ergibt sich 24 +/- 13
\item [\textbf{E} \msquare] Es ergibt sich 22 [13, 31]
\end{enumerate} 
...
$y = \{19, 14, 20, 15, 17, 17, 18\}$. Berechnen Sie folgende
...
\begin{center}
$10.1, 9, 11.6, 9.4, 9.2, 11, 12.1, 8.9, 12.4, 10.2, 12.6, 8.4, 9.4, 10.9, 13.5$
\end{center}
...
## 
## data:  waterintake by infusion
## t = -0.18365, df = 14, p-value = 0.8569
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.622545  3.051117
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 16.1 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 46.86 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 11.528  5.7640  2.1576 0.1417
## Residuals 20 53.429  2.6714
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 128 116 104 108  90  91 151 138 130 148 138 152
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 3.89 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 411.38 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 527.14 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 65 & 616.22 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2 494.24 247.122 24.6934 6.923e-06
## form       1 109.78 109.777 10.9694  0.003877
## dose:form  2  18.82   9.410  0.9403  0.408889
## Residuals 18 180.14  10.008
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -2.1429 -1.1429 -0.6000  0.3571  3.4000 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  18.6000     0.8253  22.537 6.66e-10
## trtB         -4.4571     1.0806  -4.125  0.00206
## 
## Residual standard error: 1.845 on 10 degrees of freedom
## Multiple R-squared:  0.6298,	Adjusted R-squared:  0.5928 
## F-statistic: 17.01 on 1 and 10 DF,  p-value: 0.002061
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -6.8029, df = 8, p-value = 0.0001374
...
Einflussvariablen ($x$) wurden erhoben: P, dosage und height. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
9.59 & 0 & 10.26 & 99.84 & 70.23 & 6\\
11.22 & 0 & 9.40 & 97.65 & 65.04 & 6\\
11.29 & 0 & 11.97 & 102.89 & 72.74 & 10\\
9.76 & 0 & 10.43 & 102.79 & 72.30 & 12\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.4337 -1.3327 -0.2273  1.2040  4.9827 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -15.78214    7.09908  -2.223   0.0287
## nematodes     0.09463    0.07615   1.243   0.2173
## Fe            0.84808    0.07042  12.042   <2e-16
## light        -0.34370    0.49423  -0.695   0.4886
## 
## Residual standard error: 2.08 on 89 degrees of freedom
## Multiple R-squared:  0.6199,	Adjusted R-squared:  0.6071 
## F-statistic: 48.38 on 3 and 89 DF,  p-value: < 2.2e-16
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & so4 & temp & maxdepth\\
\midrule
LIBERTY\_RES & 12 & 424 & 5.82 & 20.2 & 62\\
LITTLE\_GUNPOWDER\_R & 3 & 15305 & 6.96 & 17.5 & 85\\
BLUE\_LICK\_RUN & 1 & 2217 & 10.85 & 14.3 & 46\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -11.645   -4.514   -2.198    2.007   17.151  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  1.370e+00  9.626e-01   1.423   0.1610
## acerage      3.509e-05  1.495e-05   2.347   0.0230
## so4         -9.116e-03  2.465e-02  -0.370   0.7131
## temp         7.511e-02  4.561e-02   1.647   0.1060
## maxdepth     8.772e-03  4.378e-03   2.003   0.0507
## 
## (Dispersion parameter for quasipoisson family taken to be 46.0973)
## 
##     Null deviance: 2478.2  on 53  degrees of freedom
## Residual deviance: 1884.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.347     0.260   0.795
## 2 light           0.503    -0.291   0.771
## 3 nematodes       0.122     0.243   0.808
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1758 -0.5455 -0.1396  0.5146  3.5681 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  249.8   15.80   
##  subject  (Intercept) 4038.4   63.55   
##  Residual              670.1   25.89   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.663     26.920   7.565
## attitudepop  -20.772      5.688  -3.652
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0009523 0.0027902 0.1409579
## high 0.0009523 1.0000000 0.0000001 0.0409526
## low  0.0027902 0.0000001 1.0000000 0.0000411
## mid  0.1409579 0.0409526 0.0000411 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 11, 15, 16, 16 und 8!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 1, 8, 9, 19 und 14! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes grade, pigs und Fe an vier verschiedenen Messterminen.
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GC0PTV4 & 4.0 | 4.5 | Klein \\
    B & GC46MUV & 1.5 | 3.0 | Mikro \\ 
    C & GC7ZIDQ & 3.5 | 2.0 | Mikro \\ 
    D & GCWOXZM & 3.0 | 1.0 | Klein \\ 
    E & GCSDMZQ & 1.0 | 4.0 | Mikro \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 208 n. Chr. f{\"u}r den neuen Lehnsherren
...
des H{"a}ngebauchschweins Frida und Ihnen. Gr{\"u}nes Gras unter Ihren F{\"u}{\ss}en und ein
strammer Wind im Gesicht, egal wohin man schaut. Ein schmatzendes Ger{\"a}usch
unter Ihnen. Sollten Sie Ihre weiten Graslandschaften d{\"u}ngen? Daf{\"u}r
ben{\"o}tigen Sie die \textit{Gr{\"u}nlandtemperatur}!

Sie sehen nicht ein, Geld f{\"u}r einen Agrarmetrologen zu bezahlen. Also
rechnen Sie mit folgenden Informationen 

0.4 0.75 1.1

\begin{enumerate}
\item Skizzieren Sie den Versuchsplan auf Tischen im Gew{\"a}chshaus!
  \textbf{(2 Punkte)}
\end{enumerate}
...
\item Im ersten Versuch legen Sie das Seil f{\"u}r Frida lotrecht {\"u}ber einen
  Ast oberhalb des Traktors. Die Rentner ziehen in einer geraden Linie {\"u}ber
...
\item Im zweiten Versuch ziehen Frida und die Rentner mit einem
  $80^\circ$ jeweils mit ihrem Seil an dem Traktor. Welche Kraft
  wird aufgebracht? \textbf{(2 Punkte)}
\end{enumerate}

https://www.matheretter.de/rechner/parallelogramm

resultierende kraft berechnen 3 kr{\"a}fte
...
Sie haben den Vektor $A = \{9, 13, 4\}$ und den Vektor $B = \{0, 3, -5\}$ gegeben.
