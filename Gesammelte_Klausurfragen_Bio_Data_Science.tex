...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.03, 0.02 und 0.001. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0525, 0.0075, 0.005 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 0.12, 0.08 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0525, 0.0075, 0.005 und 3e-04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 0.12, 0.08 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.84, 0.12, 0.08 und 0.004. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 6, 7, 8, 17 und 5.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 9.6 +/- 2.415
\item [\textbf{B} \msquare] Es ergibt sich 8.6 +/- 4.83
\item [\textbf{C} \msquare] Es ergibt sich 8.6 +/- 2.415
\item [\textbf{D} \msquare] Es ergibt sich 8.6 +/- 23.3
\item [\textbf{E} \msquare] Es ergibt sich 7.6 +/- 11.65
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 8, 8, 19, 22, 27, 25, 31, 8, 25, 30 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 25 +/- 8
\item [\textbf{B} \msquare] Es ergibt sich 23 +/- 8
\item [\textbf{C} \msquare] Es ergibt sich 25 +/- 30
\item [\textbf{D} \msquare] Es ergibt sich 23 [9, 31]
\item [\textbf{E} \msquare] Es ergibt sich 25 [8, 30]
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Die Possion-Regression sch{"a}tzt drei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.55 liegt Overdispersion vor. Die L{"o}sung ist die Nutzung von nur zwei der drei Verteilungsparameter: $\gamma_1$ und $\gamma_3$.
\item [\textbf{B} \msquare] Die Possion-Regression sch{"a}tzt zwei Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.55 liegt keine Overdispersion vor.
...
\item [\textbf{D} \msquare] Die Possion-Regression sch{"a}tzt nur einen Verteilungsparameter. Deshalb muss {"u}berpr{"u}ft werden, ob Overdispersion vorliegt. Mit einer gesch{"a}tzen Overdispersion von 2.55 liegt keine Overdispersion vor. Overdispersion liegt vor, wenn die gesch{"a}tzte Overdispersion unter 1 liegt.
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 2.72 ist
richtig?
...
\item [\textbf{C} \msquare] Es ergibt sich ein Odds ratio von 0.86, da es sich um eine Chancenverh{"a}ltnis handelt.
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer possion Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 0
...
\item [\textbf{D} \msquare] In einer possion Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 0
\item [\textbf{E} \msquare] In einer possion Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -0.01
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 155
...
$y = \{26, 17, 26, 14, 19, 14, 21, 11, 21, 15, 13\}$. Berechnen Sie folgende
...
\begin{center}
$9.3, 11.3, 6.1, 12.9, 8, 9.5, 9.2, 9.2, 11, 9.9, 10.3, 12.6, 8.4, 11.6$
\end{center}
...
## t = 0.074635, df = 10, p-value = 0.942
...
## t = -0.70822, df = 12, p-value = 0.4923
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -4.167037  2.122592
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 151.94 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 20 & 97.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 41.255 20.6273  10.696 0.0006938
## Residuals 20 38.571  1.9286
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 131 123 121 102 104 104 140 144 155 141 157 152
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 1.37 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 50.75 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 4.83 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 39 & 673.13 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  71.38  35.692  2.6403   0.09875
## form       1 107.39 107.394  7.9444   0.01137
## dose:form  2 512.52 256.260 18.9567 3.714e-05
## Residuals 18 243.33  13.518
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   88  \strut\\
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   72   \strut\\
    \hline
     &  78 &  82 &  160  \strut\\
  \end{tabular}
\end{center}
...
## -5.6667 -1.6667  0.6667  2.2500  3.3333 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   16.000      1.252  12.783 2.38e-08
## trtB          -2.333      1.561  -1.495    0.161
## 
## Residual standard error: 2.799 on 12 degrees of freedom
## Multiple R-squared:  0.157,	Adjusted R-squared:  0.0867 
## F-statistic: 2.234 on 1 and 12 DF,  p-value: 0.1608
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Einflussvariablen ($x$) wurden erhoben: dosage, P und S. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
10.21 & 0 & 12.05 & 98.05 & 71.91 & 16\\
11.43 & 0 & 10.24 & 98.85 & 63.54 & 5\\
10.99 & 0 & 8.43 & 98.89 & 66.99 & 13\\
10.72 & 1 & 10.06 & 106.75 & 74.36 & 15\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -7.8354 -2.6534  0.4551  2.4935  5.8767 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) 73.59130    2.77497  26.520   <2e-16
## nematodes    0.04665    0.10842   0.430   0.6680
## light        1.09463    0.83064   1.318   0.1909
## P           -0.42900    0.24834  -1.727   0.0876
## 
## Residual standard error: 3.351 on 89 degrees of freedom
## Multiple R-squared:  0.06187,	Adjusted R-squared:  0.03025 
## F-statistic: 1.957 on 3 and 89 DF,  p-value: 0.1263
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
ISRAEL\_CR & 30 & 21.0 & 13.77 & 133 & 6260\\
BEAR\_CR & 54 & 19.5 & 10.92 & 96 & 19611\\
HAWLINGS\_R & 1 & 20.5 & 4.64 & 73 & 1172\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -7.206  -3.999  -1.498   1.057  11.027  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.915e+00  8.803e-01   3.312 0.001746
## temp        -7.549e-03  4.015e-02  -0.188 0.851621
## so4          1.510e-02  1.697e-02   0.890 0.377893
## maxdepth     4.485e-05  4.392e-03   0.010 0.991894
## acerage      4.600e-05  1.254e-05   3.669 0.000599
## 
## (Dispersion parameter for quasipoisson family taken to be 24.14022)
## 
##     Null deviance: 1374.4  on 53  degrees of freedom
## Residual deviance: 1038.7  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.388    -0.122   0.903
## 2 nematodes       0.134    -0.428   0.669
## 3 light           0.436     1.24    0.214
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 801
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1591 -0.5821 -0.1279  0.5799  3.3121 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  228.2   15.11   
##  subject  (Intercept) 4024.1   63.44   
##  Residual              715.7   26.75   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  202.253     26.839   7.536
## attitudepop  -17.556      5.878  -2.987
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0954828 0.1059710 0.0000018
## high 0.0954828 1.0000000 0.0019158 0.0000000
## low  0.1059710 0.0019158 1.0000000 0.0002221
## mid  0.0000018 0.0000000 0.0002221 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 14, 7, 10, 12 und 15!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 16, 6, 12, 3 und 16! \textbf{(2 Punkte)}
...
vorliegen. Sie messen die Outcomes Fe, leaf und pigs an vier verschiedenen Messterminen.
...
Sie haben den Vektor $A = \{15, 10, 4\}$ und den Vektor $B = \{3, -1, 3\}$ gegeben.
