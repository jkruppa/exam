...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 14, 10, 17, 10 und 0.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.2 +/- 3.21
\item [\textbf{B} \msquare] Es ergibt sich 9.2 +/- 20.6
\item [\textbf{C} \msquare] Es ergibt sich 10.2 +/- 3.21
\item [\textbf{D} \msquare] Es ergibt sich 10.2 +/- 41.2
\item [\textbf{E} \msquare] Es ergibt sich 10.2 +/- 6.42
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 24, 15, 31, 19, 17, 15 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 19 +/- 31
\item [\textbf{B} \msquare] Es ergibt sich 19 [15, 31]
\item [\textbf{C} \msquare] Es ergibt sich 19 +/- 15
\item [\textbf{D} \msquare] Es ergibt sich 23 [16, 32]
\item [\textbf{E} \msquare] Es ergibt sich 23 +/- 15
\end{enumerate} 
...
Erbsen durchgef{\"u}hrt haben, berechnen Sie den Mittelwert und den
...
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 0.38, da es sich um eine Chancenverh{"a}ltnis handelt.
\end{enumerate}
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.001, 0.02, 0.03 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.005, 0.1, 0.15 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 2e-04, 0.004, 0.006 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.042, 2e-04, 0.004, 0.006 und 0.084. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.05, 0.005, 0.1, 0.15 und 2.1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.005, 0.1, 0.15 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1\% verglichen.
\end{enumerate}
...
In einer Klimakammer mit drei L{"u}ftungssystemen und Folientunneln ($ctrl$, $storm$ und $tornado$) als Behandlung
...
Nach einem Versuch in einer Klimakammer mit drei Genotypen ($AA$, $AB$ und $BB$) als Behandlung
...
\begin{center}
$7, 5, 4, 6, 4, 3, 3, 5, 1, 5, 6, 3, 7, 3, 6, 4, 4, 3, 4, 5, 4, 1, 1, 7, 9, 3, 3, 4, 3, 4, 3, 3, 4$
\end{center}
...
\begin{center}
$9.1, 9.4, 9, 7.8, 7.8, 12.4, 10.3, 8.8, 12.1, 10.4, 9.6, 11.3, 8.5, 9.9, 10.6, 5.3, 11.9$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ beibehalten & $\beta$-Fehler & Richtige Entscheidung & 5\% \\
  \end{tabular}
  \end{center}
...
## t = -3.5293, df = 14, p-value = 0.003335
...
## 
## data:  freshmatter by N
## t = 3.0948, df = 12, p-value = 0.009278
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  0.6117059 3.5216274
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 51.33 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 89.71 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Der Datensatz \textit{crop\_tbl} enth{\"a}lt das Outcome \textit{freshmatter} f{\"u}r ein Experiment in einer Klimakammer mit 
...
## trt        2 39.177 19.5887    6.74 0.005787
## Residuals 20 58.127  2.9063
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 376.38 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 39.08 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 9.37 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 24 & 241.4 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 72 H{"u}hnern durchgef{\"u}hrt, wobei
jedes Tier eine von drei Selen-Dosen $dose$ ($0.1$ ng/Tag, $2$ ng/Tag und $20$ ng/Tag)
...
## Response: gain
##           Df  Sum Sq Mean Sq F value    Pr(>F)
## dose       2  30.609  15.305  1.0721 0.3631769
## form       1 309.461 309.461 21.6772 0.0001966
## dose:form  2  96.380  48.190  3.3756 0.0568959
## Residuals 18 256.965  14.276
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.3381247 0.0488027 0.4261002
## high 0.3381247 1.0000000 0.0049257 0.8689831
## low  0.0488027 0.0049257 1.0000000 0.0075021
## mid  0.4261002 0.8689831 0.0075021 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -5.5714 -2.3095 -0.2222  1.7659  8.4286 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   18.222      1.270  14.347 9.16e-10
## waterB        -8.651      1.920  -4.505 0.000494
## 
## Residual standard error: 3.81 on 14 degrees of freedom
## Multiple R-squared:  0.5918,	Adjusted R-squared:  0.5626 
## F-statistic: 20.29 on 1 and 14 DF,  p-value: 0.0004944
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.5918$ aus? \textbf{(2 Punkte)}
...
Einflussvariablen ($x$) wurden erhoben: block, N und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
drinking/eating & 32cm; 25cm; 4.3\% & 29cm; 23cm; 5.2\% & 34cm; 30cm; 2.1\%\\
walking & 33cm; 20cm; 0.6\% & 39cm; 25cm; 0.6\% & 40cm; 25cm; 0.4\%\\
foraging incl. scratching & 38cm; 23cm; 8.1\% & 30cm; 27cm; 6.3\% & 32cm; 36cm; 5.1\%\\
preening & 29cm; 34cm; 12.8\% & 26cm; 26cm; 12.8\% & 28cm; 30cm; 16.4\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCLQMPC & 2.0 | 1.5 | Klein \\
    B & GCS2APG & 4.5 | 4.0 | Mikro \\ 
    C & GCEQZZI & 5.0 | 3.0 | Mikro \\ 
    D & GCELY7Z & 1.0 | 1.0 | Mikro \\ 
    E & GCMNHSA & 1.5 | 2.0 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 686 n. Chr. f{\"u}r den neuen Lehnsherren
...
\begin{equation*}
  f(t) = \ensuremath{8\times 10^{9}} - \ensuremath{10^{9}} \cdot 1.7^{-0.3 \cdot t + 2.4}
\end{equation*}
...
Sie haben den Vektor $A = \{14, 12, 12\}$ und den Vektor $B = \{2, 2, 3\}$ gegeben.
