...
\begin{graybox}{Checkbox für die Version vom \today}
  ...
  Choice Fragen sowie \textbf{73} Rechen- und
  Textaufgaben.
\end{graybox}
...
\item [\textbf{E} \msquare] Die $\alpha$ Adjustierung wird durchgef{"u}hrt um bei multiplen Vergleichen den Fehler 1. Art zu kontrollieren. Es wird die Irrtumswahrscheinlichkeit adjustiert, daher das $\alpha$-Niveau.
\end{enumerate} 
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.001, 0.03, 0.89, 0.02 und 0.42. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.26, 0.006, 0.18, 5.34, 0.12 und 2.52. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.006, 0.18, 1, 0.12 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 0.006, 0.18, 1, 0.12 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 2e-04, 0.005, 0.1483, 0.0033 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 2e-04, 0.005, 0.1483, 0.0033 und 0.07. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\end{enumerate} 
...
$\eta^2 = 0.27$. Welche Aussage ist richtig?
...
\item [\textbf{D} \msquare] Der Korrelationskoeffizienten nach Pearson wird genutzt, wenn das Outcome Y nicht normalverteilt ist. Der Korrelationskoeffizienten liegt zwischen 0 und 1.
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 17, 9, 13, 12 und 4.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11 +/- 23.5
\item [\textbf{B} \msquare] Es ergibt sich 12 +/- 2.425
\item [\textbf{C} \msquare] Es ergibt sich 11 +/- 4.85
\item [\textbf{D} \msquare] Es ergibt sich 10 +/- 11.75
\item [\textbf{E} \msquare] Es ergibt sich 11 +/- 2.425
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 19, 24, 10, 30, 20, 1 und 63.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 20 +/- 30
\item [\textbf{B} \msquare] Es ergibt sich 24 [10, 30]
\item [\textbf{C} \msquare] Es ergibt sich 20 +/- 10
\item [\textbf{D} \msquare] Es ergibt sich 20 [10, 30]
\item [\textbf{E} \msquare] Es ergibt sich 24 +/- 10
\end{enumerate}
...
Aussage zu einer gesch{\"a}tzen Overdispersion von 3.08 ist
richtig?
...
\item [\textbf{B} \msquare] X beinhaltet mehrere Spalten. Die Spalten geben die Verteilungsfamilie vor.
\item [\textbf{C} \msquare] X beinhaltet eine Spalte. Die Spalte gibt nicht die Verteilungsfamilie vor.
\item [\textbf{D} \msquare] X beinhaltet eine Spalte. Die Spalte gibt die Verteilungsfamilie vor.
\item [\textbf{E} \msquare] X beinhaltet die Zeilen. Die Zeilen geben die Verteilungsfamilie vor.
\end{enumerate}
...
\item [\textbf{B} \msquare] Es ergibt sich ein Risk ratio von 0.36, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{C} \msquare] Es ergibt sich ein Risk ratio von 0.57, da es sich um ein Anteil handelt.
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.57, da es sich um eine Chancenverh{"a}ltnis handelt.
\item [\textbf{E} \msquare] Es ergibt sich ein Risk ratio von 1.75, da es sich um ein Anteil handelt.
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] In einer logistischen Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von -3.42
...
\item [\textbf{D} \msquare] In einer logistischen Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ exponiert werden. Somit liegt das OR bei 11.67
\item [\textbf{E} \msquare] In einer logistischen Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch exponiert werden. Somit liegt das RR bei 11.67
\end{enumerate}
...
\begin{enumerate}
\item [\textbf{A} \msquare] Da AIC$_A$ > 0 ist das Modell A das bessere Modell. Der AIC Wert f{"u}r B wird verworfen.
...
\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich eine Fallzahl von 5
\item [\textbf{B} \msquare] Es ergibt sich eine Fallzahl von 4
\item [\textbf{C} \msquare] Es ergibt sich eine Fallzahl von 3
\item [\textbf{D} \msquare] Es ergibt sich eine Fallzahl von 8
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 10
\end{enumerate}
...
$y = \{19, 20, 17, 20, 18, 19, 19\}$. Berechnen Sie folgende
...
\begin{center}
$9.9, 11.5, 13.6, 6.8, 11, 9.4, 11.2, 12.8, 7.9, 8.9, 10.6, 8.1, 8.1, 9$
\end{center}
...
\item Skizieren Sie in die
  ...
  \begin{itemize}
  \item[(a)] Ein Konfidenzintervall mit h{"o}hererVarianz $s_p$ in der Stichprobe als der Rest der Konfidenzintervalle 	
...
## t = 3.3842, df = 12, p-value = 0.005425
...
## t = -0.30253, df = 12, p-value = 0.7674
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.515114  2.657971
## sample estimates:
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 86.76 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 92.6 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 229.903 114.952  30.865 4.121e-07
## Residuals 22  81.937   3.724
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 129 116 118  89 101 111 142 151 134 150 142 137
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Sch{\"a}tzen Sie den p-Wert der Tabelle mit der Information von den
  ...
  $F_{supp} = 4.17$ und
  $F_{dose} = 2.69$ sowie
  $F_{supp:dose} = 2.69$ ab. Begr{\"u}nden Sie Ihre
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 15.53 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 4 & 721.79 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 4 & 254.75 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 30 & 629.76 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  24.26  12.132  0.7428 0.4897974
## form       1  62.20  62.201  3.8086 0.0667268
## dose:form  2 481.27 240.637 14.7345 0.0001621
## Residuals 18 293.97  16.332
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (nein)} & \phantom{100}  & \phantom{100}  &   64   \strut\\
    \hline
     &  76 &  67 &  143  \strut\\
  \end{tabular}
\end{center}
...
## -4.2857 -1.0714  0.5714  1.3571  3.7143 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  12.2857     0.8806  13.951 8.88e-09
## trtB          1.1429     1.2454   0.918    0.377
## 
## Residual standard error: 2.33 on 12 degrees of freedom
## Multiple R-squared:  0.06557,	Adjusted R-squared:  -0.0123 
## F-statistic: 0.8421 on 1 and 12 DF,  p-value: 0.3769
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = -6.9747, df = 8, p-value = 0.0001155
...
Einflussvariablen ($x$) wurden erhoben: dosage, block und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
11.03 & 0 & 12.31 & 100.10 & 68.47 & 12\\
9.36 & 1 & 8.78 & 104.39 & 74.07 & 13\\
10.35 & 0 & 9.76 & 98.69 & 70.12 & 15\\
10.74 & 0 & 13.05 & 95.56 & 61.37 & 8\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -4.9589 -2.0339 -0.0699  1.7830  5.9167 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)
## (Intercept) -10.49053    8.66970  -1.210   0.2294
## water        -0.14082    0.17821  -0.790   0.4314
## light         1.31268    0.57578   2.280   0.0249
## Fe            0.81127    0.08697   9.328 5.92e-15
## 
## Residual standard error: 2.46 on 92 degrees of freedom
## Multiple R-squared:  0.5402,	Adjusted R-squared:  0.5252 
## F-statistic: 36.02 on 3 and 92 DF,  p-value: 1.727e-15
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\begin{tabular}{lrrrrr}
\toprule
stream & longnose & acerage & temp & maxdepth & so4\\
\midrule
BROAD\_RUN & 53 & 1971 & 22.2 & 56 & 11.12\\
LITTLE\_GUNPOWDER\_R & 3 & 15305 & 17.5 & 85 & 6.96\\
MAINSTEM\_PATUXENT\_R & 239 & 8636 & 18.1 & 150 & 5.95\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.506  -4.633  -2.554   1.676  18.592  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  2.097e+00  1.014e+00   2.067    0.044
## acerage      4.043e-05  1.696e-05   2.384    0.021
## temp         5.058e-02  4.406e-02   1.148    0.257
## maxdepth     6.882e-03  4.719e-03   1.458    0.151
## so4         -2.044e-02  3.208e-02  -0.637    0.527
## 
## (Dispersion parameter for quasipoisson family taken to be 47.84752)
## 
##     Null deviance: 2365.8  on 53  degrees of freedom
## Residual deviance: 1866.1  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     1.53      0.728   0.467
## 2 water           0.150    -0.956   0.339
## 3 light           0.510     1.49    0.136
\end{verbatim}
\end{kframe}
\end{knitrout}
...
##    Data: data_tbl
## 
## REML criterion at convergence: 802.9
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.3438 -0.6207 -0.1836  0.5859  3.1893 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  256.1   16.00   
##  subject  (Intercept) 4040.8   63.57   
##  Residual              729.2   27.00   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  203.934     26.970   7.561
## attitudepop  -21.254      5.933  -3.582
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0025477 0.0034769 0.0544829
## high 0.0025477 1.0000000 0.0000003 0.2104539
## low  0.0034769 0.0000003 1.0000000 0.0000128
## mid  0.0544829 0.2104539 0.0000128 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 9, 13, 5, 14 und 11!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 4, 5, 14, 7 und 10! \textbf{(2 Punkte)}
...
einen Radius von 4.5cm und eine H{\"o}he von 8cm. Der
...
Wir treffen folgende Annahmen. Eine au{\ss}erirdische Zivilisation schickt $2$ Sonden mit
$30$\%iger Lichtgeschwindigkeit los um sich auf den erreichten
Planeten selbst zu replizieren. Nach $750$ Jahren ist die
Replikation abgeschlossen und wiederum $2$ Sonden werden
ausgesendet. Gehen Sie von $4.24$ Lichtjahren als mittlerer
Abstand der Sterne in der Milchstra{\ss}e aus. Es gibt $\ensuremath{10^{11}}$
...
\item Berechnen Sie die Dauer, die eine Zivilisation ben{\"o}tigt, um die ganze
  Milchstra{\ss}e zu besuchen! \textbf{(3 Punkte)} 
\item Bei einem vermutetet Alter der Erde von $\ensuremath{4.3\times 10^{9}}$ Jahren,
  wie oft war dann eine Sonde schon zu Besuch? Korrigieren Sie Ihre Antwort
  mit dem Wissen, dass sich die Kontinentalplatten einmal alle
  $\ensuremath{10^{9}}$ Jahre vollst{\"a}ndig im Erdinneren umgewandelt haben! \textbf{(2
    Punkte)}
\item Skizzieren Sie in einer Abbildung den Zusammenhang zwischen Zeit $t$
  ...
  mit 99\% Lichtgeschwindigkeit fliegender Sonde! \textbf{(3 Punkte)}
...
Kniffel oder Dungeon \& Dragons

\begin{enumerate}
\item Stellen Sie alle m{\"o}glichen Ergebnisse von zwei sechsseitigen W{\"u}rfel
  als Diagramm dar! \textbf{(2 Punkte)}
\item Erg{\"a}nzen Sie die relativen H{\"a}ufigkeiten der einzelnen Ergebnisse! \textbf{(1 Punkt)}  
\end{enumerate}
