...
ergibt sich ein $\eta^2 = 0.32$. Welche Aussage ist richtig?
...
wurde an 63 Schweinen durchgef{\"u}hrt, wobei jedes Tier eine von
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 9, 9, 13, 9 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 10 +/- 3
\item [\textbf{B} \msquare] Es ergibt sich 10 +/- 1.73
\item [\textbf{C} \msquare] Es ergibt sich 10 +/- 0.865
\item [\textbf{D} \msquare] Es ergibt sich 11 +/- 0.865
\item [\textbf{E} \msquare] Es ergibt sich 9 +/- 1.5
\end{enumerate} 
...
Berechnen Sie den Median, das $1^{st}$ Quartile sowie das $3^{rd}$ Quartile von $y$ mit 20, 24, 36, 28, 33, 14, 19, 7, 17, 16 und 51.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 24 [17, 34]
\item [\textbf{B} \msquare] Es ergibt sich 20 +/- 16
\item [\textbf{C} \msquare] Es ergibt sich 24 +/- 16
\item [\textbf{D} \msquare] Es ergibt sich 20 +/- 33
\item [\textbf{E} \msquare] Es ergibt sich 20 [16, 33]
\end{enumerate} 
...
\item [\textbf{D} \msquare] Es ergibt sich ein Risk ratio von 0.5, da es sich um ein Anteil handelt.
...
Sie haben folgende unadjustierten p-Werte gegeben: 0.03, 0.02, 0.21 und 0.01. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.005, 0.0525 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.0075, 0.005, 0.0525 und 0.0025. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 0.84 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 1.25\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 0.84 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.12, 0.08, 0.84 und 0.04. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate}
...
\item [\textbf{C} \msquare] In der Analogie der Regenwahrscheinlichkeit: ein statistischer Test gibt die Wahrscheinlichkeit f{"u}r das Auftreten eines Ereignisses wieder. Die St{"a}rke des Effektes wird nicht wiedergeben.
...
\item [\textbf{C} \msquare] Nein, die untersuchte Population k{"o}nnen wir mit einem statistischen Test nicht auswerten. Wir erhalten keine Aussage zur Population.
...
Nach einem Gew{"a}chshausexperiment mit zwei D{"u}ngestufen ($ctrl$ und $high$) als Behandlung
(\textit{treatment}) ergibt sich die folgende Datentabelle mit dem
...
\begin{center}
$0, 3, 4, 2, 3, 7, 3, 5, 2, 2, 3, 5, 7, 0, 6, 5, 5, 1, 2, 2, 2, 1, 1, 5, 1, 3, 3, 3, 6, 8, 7, 8, 4$
\end{center}
...
\begin{center}
$9.3, 11.4, 9.5, 8.2, 12.7, 13.3, 12.6, 10.4, 12.3, 7, 9, 11.7, 12.3, 11.5, 10.9, 12.8, 9.2$
\end{center}
...
\item Tragen Sie folgende statistische Fachbegriffe zur statistischen
  ...
  \begin{center}
  \begin{tabular}{cccc}
  H$_0$ abgelehnt & Testentscheidung & H$_0$ wahr & $\alpha$-Fehler \\
  \end{tabular}
  \end{center}
...
## t = -2.7854, df = 16, p-value = 0.01323
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -5.8702310 -0.7964357
## sample estimates:
...
## t = 0.14453, df = 16, p-value = 0.8869
## alternative hypothesis: true  is not equal to [condensed]
## 95 percent confidence interval:
##  -3.037333  3.481777
## sample estimates:
...
Der Datensatz \texttt{plant\_growth\_tbl} enth{\"a}lt das Trockengewicht der Brokolik{"o}pfe
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 16.53 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 62.83 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Der Datensatz \textit{crop\_tbl} enth{\"a}lt das Outcome \textit{height} f{\"u}r ein Gew{"a}chshausexperiment mit 
...
## trt        2   6.921  3.4603  0.7385 0.4893
## Residuals 22 103.079  4.6854
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 112.65 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 3 & 199.43 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 3 & 144.23 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 32 & 424.63 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 51 Rindern durchgef{\"u}hrt, wobei
jedes Tier eine von drei Selen-Dosen $dose$ ($0.5$ ng/Tag, $1$ ng/Tag und $10$ ng/Tag)
...
## Response: gain
##           Df Sum Sq Mean Sq F value    Pr(>F)
## dose       2  55.90   27.95  2.2691   0.13218
## form       1 355.48  355.48 28.8610 4.178e-05
## dose:form  2 146.71   73.35  5.9554   0.01035
## Residuals 18 221.71   12.32
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.2955305 0.0469495 0.1111361
## high 0.2955305 1.0000000 0.0037167 0.5693588
## low  0.0469495 0.0037167 1.0000000 0.0007960
## mid  0.1111361 0.5693588 0.0007960 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
    \textbf{Medikament (ja)} & \phantom{100}  & \phantom{100}  &   41  \strut\\
    \hline
...
## -3.7778 -2.3944  0.8111  1.3556  4.2222 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)   15.600      1.174  13.283 1.55e-08
## waterB        -2.822      1.465  -1.927    0.078
## 
## Residual standard error: 2.626 on 12 degrees of freedom
## Multiple R-squared:  0.2363,	Adjusted R-squared:  0.1726 
## F-statistic: 3.712 on 1 and 12 DF,  p-value: 0.07802
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\item Erkl{\"a}ren Sie \textit{kurz} den Begriff \texttt{R-squared}!
  Was sagt Ihnen der Wert $0.2363$ aus? \textbf{(2 Punkte)}
...
## t = 10.439, df = 8, p-value = 6.155e-06
...
Einflussvariablen ($x$) wurden erhoben: N, dosage und center. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
wing/leg stretching & 35cm; 32cm; 2.1\% & 36cm; 33cm; 1.8\% & 43cm; 26cm; 1.8\%\\
dustbathing & 36cm; 24cm; 0.4\% & 20cm; 29cm; 0.2\% & 29cm; 19cm; 0.9\%\\
walking & 25cm; 28cm; 0.5\% & 26cm; 25cm; 0.5\% & 38cm; 28cm; 8.1\%\\
foraging incl. scratching & 25cm; 21cm; 1.2\% & 36cm; 21cm; 5.1\% & 36cm; 33cm; 6.9\%\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{center}
  \begin{tabular}{ ccc }
    ...
    \midrule
    A & GCYUOPJ & 3.5 | 5.0 | Mikro \\
    B & GCE0QJ1 & 5.0 | 2.5 | Normal \\ 
    C & GC9CYDG & 1.0 | 4.0 | Mikro \\ 
    D & GCWR5AI & 1.5 | 1.0 | Normal \\ 
    E & GCPJ9LX & 4.0 | 1.5 | Normal \\     
 \bottomrule
\end{tabular}
\end{center}
...
man nicht alles im Jahr 1057 n. Chr. f{\"u}r den neuen Lehnsherren
...
Fressfeinde liegt die Mortalit{\"a}t der S{\"a}uglinge bei 35\%.
...
\item Die durchschnittliche, australische Lebenserwartung eines weiblichen
  Kaninchens liegt bei 5 Jahren. Wie viele weibliche Kaninchen
...
G{"u}nther und Thorsten das Team der drei Kandidaten.
...
4100EUR im Monat \textit{passiv} erwirtschaften.
...
2.5\% p.a. {\"u}ber 48 Monate finanzieren.
...
Sie haben den Vektor $A = \{1, 16, 2\}$ und den Vektor $B = \{1, 6, 1\}$ gegeben.
