...
Sie haben folgende unadjustierten p-Werte gegeben: 0.21, 0.34, 0.001, 0.03, 0.42 und 0.89. Sie adjustieren die p-Werte nach
Bonferroni. Welche Aussage ist richtig?



\begin{enumerate}
\item [\textbf{A} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1.26, 2.04, 0.006, 0.18, 2.52 und 5.34. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{B} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.0567, 2e-04, 0.005, 0.07 und 0.1483. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\item [\textbf{C} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 0.035, 0.0567, 2e-04, 0.005, 0.07 und 0.1483. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{D} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.006, 0.18, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 0.83\% verglichen.
\item [\textbf{E} \msquare] Nach der Bonferroni-Adjustierung ergeben sich die adjustierten p-Werte von 1, 1, 0.006, 0.18, 1 und 1. Die adjustierten p-Werte werden zu einem $\alpha$-Niveau von 5\% verglichen.
\end{enumerate} 
...
Berechnen Sie den Mittelwert und Standardabweichung von $y$ mit 16, 8, 10, 13 und 10.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 11.4 +/- 3.13
\item [\textbf{B} \msquare] Es ergibt sich 11.4 +/- 1.565
\item [\textbf{C} \msquare] Es ergibt sich 12.4 +/- 1.565
\item [\textbf{D} \msquare] Es ergibt sich 11.4 +/- 9.8
\item [\textbf{E} \msquare] Es ergibt sich 10.4 +/- 4.9
\end{enumerate} 
...
Berechnen Sie den Median und das IQR von $x$ mit 14, 12, 6, 22, 5, 11, 26, 25, 9, 13 und 42.



\begin{enumerate}
\item [\textbf{A} \msquare] Es ergibt sich 13 [9, 25]
\item [\textbf{B} \msquare] Es ergibt sich 17 +/- 9
\item [\textbf{C} \msquare] Es ergibt sich 13 +/- 9
\item [\textbf{D} \msquare] Es ergibt sich 17 [9, 25]
\item [\textbf{E} \msquare] Es ergibt sich 13 +/- 25
\end{enumerate}
...
\midrule
(Intercept) & 38.49 & 0.30\\
light\_binhigh & 3.34 & 0.41\\
\bottomrule
\end{tabular}
\end{table}
...
\item [\textbf{B} \msquare] In einer gaussian Regression muss f{"u}r die Interpretation des Effektes das $\beta_1$ quadriert werden. Somit liegt das OR bei 11.14
...
\item [\textbf{D} \msquare] In einer gaussian Regression berechnet man das RR. Daher muss der Sch{"a}tzer des Effektes $\beta_1$ noch quadriert werden. Somit liegt das RR bei 11.14
\item [\textbf{E} \msquare] In einer gaussian Regression wird die Mittelwertsdifferenz betrachtet. Daher ist der Effekt zwischen den beiden Lichtregimen eine Gewichts{"a}nderung von 3.34
\end{enumerate}
...
\item [\textbf{E} \msquare] Es ergibt sich eine Fallzahl von 274
\end{enumerate}
...
$y = \{14, 18, 18, 13, 19, 18, 17\}$. Berechnen Sie folgende
...
\begin{center}
$8.2, 10.4, 13.7, 10.8, 10.4, 9.6, 6.7, 9.7, 10.5, 11, 9.3, 6.7, 12, 6.5, 9.9$
\end{center}
...
## t = -4.0968, df = 14, p-value = 0.001089
...
## t = -0.22549, df = 12, p-value = 0.8254
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  -3.046402  2.474973
## sample estimates:
...
## 
## data:  waterintake by infusion
## t = 2.357, df = 8, p-value = 0.04617
## alternative hypothesis: true difference in means between group high and group low is not equal to 0
## 95 percent confidence interval:
##  0.06493591 5.93506409
## sample estimates:
## mean in group high mean in group trt2 
##               17.4               14.4
\end{verbatim}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
    ...
    \hline
   \textbf{group}  & 2 & 70.04 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 22 & 52.6 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
## trt        2 53.582 26.7911  9.5407 0.001039
## Residuals 22 61.778  2.8081
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  [1] 132 142 112 102 109  93 132 140 141 155 149 168
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{center}
  ...
  \begin{tabular}{l|c|c|c|c|c}
     & \textbf{Df} & \textbf{Sum Sq} & \textbf{Mean Sq} & \textbf{F value} & \textbf{Pr(>F)} \strut\\
    \hline
   \textbf{supp}  & 1 & 201.73 &  &  &  \strut\\
    \hline
    \textbf{dose}  & 2 & 2419.66 &  &  &  \strut\\
    \hline
    \textbf{supp:dose}  & 2 & 108.78 &  &  &  \strut\\
    \hline
   \textbf{Residuals}  & 54 & 714.98 &  &  &  \strut\\
  \end{tabular}
\end{center}
...
Versuch wurde an 77 Mastschweinen durchgef{\"u}hrt, wobei
...
## Response: len
##           Df Sum Sq Mean Sq  F value    Pr(>F)
## supp       1  201.9  201.87  14.6166 0.0002800
## dose       2 3604.0 1801.99 130.4750 < 2.2e-16
## supp:dose  2  227.0  113.48   8.2168 0.0006167
## Residuals 71  980.6   13.81
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## -4.7143 -1.5952  0.2857  2.2857  2.4444 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  16.7143     0.9015  18.540 3.00e-11
## trtB          9.8413     1.2020   8.187 1.05e-06
## 
## Residual standard error: 2.385 on 14 degrees of freedom
## Multiple R-squared:  0.8272,	Adjusted R-squared:  0.8149 
## F-statistic: 67.03 on 1 and 14 DF,  p-value: 1.045e-06
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## t = 3.6585, df = 8, p-value = 0.006415
...
Einflussvariablen ($x$) wurden erhoben: variety, rainfall und dosage. Als m{\"o}gliche Outcomevariablen stehen Ihnen nun
...
\midrule
12.91 & 1 & 12.88 & 100.56 & 65.38 & 8\\
11.81 & 1 & 9.76 & 97.34 & 68.25 & 10\\
10.11 & 0 & 7.54 & 101.80 & 70.50 & 11\\
10.32 & 0 & 9.05 & 102.43 & 71.35 & 10\\
\bottomrule
\end{tabular}
\end{table}
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -5.8570 -1.2702  0.1148  1.5616  6.1526 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -5.40238    7.71609  -0.700    0.485
## nematodes    0.08082    0.07157   1.129    0.261
## Fe           0.74451    0.07644   9.740 3.07e-16
## light        0.38560    0.54529   0.707    0.481
## 
## Residual standard error: 2.435 on 102 degrees of freedom
## Multiple R-squared:  0.4882,	Adjusted R-squared:  0.4732 
## F-statistic: 32.43 on 3 and 102 DF,  p-value: 8.343e-15
\end{verbatim}
\end{kframe}
\end{knitrout}
}
...
\midrule
HOLLANDS\_BR & 38 & 12.0 & 1934 & 10.5 & 11.44\\
BUSH\_CR & 32 & 18.0 & 19046 & 8.3 & 11.31\\
BEAVER\_DAM\_CR & 19 & 17.0 & 3570 & 9.2 & 16.53\\
LITTLE\_DEER\_CR & 38 & 20.5 & 8115 & 9.6 & 9.22\\
\bottomrule
\end{tabular}
\end{table}
...
## Deviance Residuals: 
##    Min      1Q  Median      3Q     Max  
## -9.901  -3.450  -2.028   1.142  23.185  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)
## (Intercept)  5.778e-02  1.931e+00   0.030  0.97625
## temp         4.742e-02  5.217e-02   0.909  0.36778
## acerage      4.763e-05  1.545e-05   3.083  0.00336
## do2          2.640e-01  1.486e-01   1.777  0.08182
## so4         -9.398e-03  2.540e-02  -0.370  0.71300
## 
## (Dispersion parameter for quasipoisson family taken to be 46.61505)
## 
##     Null deviance: 1999.8  on 53  degrees of freedom
## Residual deviance: 1503.9  on 49  degrees of freedom
## AIC: NA
## 
...
##   <chr>           <dbl>     <dbl>   <dbl>
## 1 (Intercept)     0.408     0.586   0.558
## 2 light           0.477     0.494   0.622
## 3 nematodes       0.147    -0.444   0.657
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.1349 -0.5847 -0.1093  0.5403  3.3659 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  barn     (Intercept)  245.6   15.67   
##  subject  (Intercept) 4038.8   63.55   
##  Residual              726.9   26.96   
## Number of obs: 83, groups:  barn, 7; subject, 6
## 
## Fixed effects:
##             Estimate Std. Error t value
## (Intercept)  201.704     26.936   7.488
## attitudepop  -18.574      5.924  -3.135
## 
...
\begin{verbatim}
##           ctrl      high       low       mid
## ctrl 1.0000000 0.0000000 0.0021701 0.0000000
## high 0.0000000 1.0000000 0.0000000 0.0128942
## low  0.0021701 0.0000000 1.0000000 0.0000000
## mid  0.0000000 0.0128942 0.0000000 1.0000000
\end{verbatim}
\end{kframe}
\end{knitrout}
...
mit der Funktion \texttt{mean} und den Zahlen 12, 17, 11, 8 und 5!  \textbf{(2 Punkte)} 
...
Funktion \texttt{c()} und den Zahlen 8, 3, 9, 12 und 8! \textbf{(2 Punkte)}
...
haben einen Radius von 5 und eine H{\"o}he von 7. Der
