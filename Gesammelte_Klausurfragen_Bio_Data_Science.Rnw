...
attr_lst <- lst(Alex = lst(flaw = "das Aufstehen", sweet = "Gummibärchen", animal = "die Katze", sport = "zu Laufen",
                ...
                Jessica = lst(flaw = "der Mangel", sweet = "Schokobons", animal = "der Hund", sport = "Rad zu fahren",
                         hobby = "Warhammer", music = "David Bowie", film = "Herr der Ringe"),
                Jonas = lst(flaw = "die Erschöpfung", sweet = "Snickers", animal = "das Meerschweinchen", sport = "zu Schwimmen",
                         hobby = "Stricken", music = "Iron Maiden", film = "Mission Impossible"),
                Mark = lst(flaw = "die Unsicherheit", sweet = "Marzipankugeln", animal = "der Hamster", sport = "zu Reiten",
                ...
                Steffen = lst(flaw = "die Romantik", sweet = "Oreos", animal = "der Leguan", sport = "zu Ringen",
