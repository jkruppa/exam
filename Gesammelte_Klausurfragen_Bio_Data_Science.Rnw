...
attr_lst <- lst(Alex = lst(flaw = "das Aufstehen", sweet = "Gummibärchen", animal = "die Katze", sport = "zu Laufen",
                ...
                Jessica = c(flaw = "die Unordnung", sweet = "Schokobons", animal = "der Hund", sport = "Rad zu fahren",
                         hobby = "Warhammer", music = "David Bowie", film = "Herr der Ringe"),
                Jonas = c(flaw = "die Unpünktlichkeit", sweet = "Werther's Popcorn", animal = "das Meerschweinchen", sport = "zu Schwimmen",
                         hobby = "Stricken", music = "Iron Maiden", film = "Mission Impossible"),
                Mark = c(flaw = "die Angst", sweet = "Marzipankugeln", animal = "der Hamster", sport = "zu Reiten",
                         hobby = "Geocaching", music = "Andrea Berg", film = "Columbo"),
                Nilufar = c(flaw = "die Erwartung", sweet = "Takis Blue Heat", animal = "das Huhn", sport = "zu Kicken",
                         hobby = "Blasmusik", music = "Deichkind", film = "Star Trek"),
                Paula = c(flaw = "der Perfektionismus", sweet = "Smarties", animal = "die Ratte", sport = "zu Fechten",
                         hobby = "Harry Potter", music = "Fanta4", film = "Jagd auf roter Oktober"),
                Steffen = c(flaw = "die innere Leere", sweet = "Oreos", animal = "der Leguan", sport = "zu Ringen",
                         hobby = "Klemmbausteine", music = "Taylor Swift", film = "Harry Potter"),
                Tina = c(flaw = "die Vergesslichkeit", sweet = "Katjes", animal = "die Spinne", sport = "zu Boxen",
                         hobby = "Astronomie", music = "Michael Jackson", film = "Indiana Jones"),
                Yuki = c(flaw = "die Faulheit", sweet = "Reese's Peanut Butter Cups", animal = "das Minischwein", sport = "zu Boldern",
...
sentence_func <- \(name, pronom, attr_vec){
  sentence_lst <- lst(flaw = c(str_c(name, " und ", attr_vec$flaw ,", eine unendliche Geschichte mit kniffeligen Wendungen."),
                               str_c("Eine echte Herausforderung für ", pronom[5] ," ist schon immer ", attr_vec$flaw ,". Ein leidiges Lied."),
