...
wanted_questions <- text_questions_vec %>% sample(7)
...
\clearpage
% ----------------------------------------------------------------------- 
\Sexpr{knit_child(text_questions_vec[75])} 
\clearpage
% -----------------------------------------------------------------------
\Sexpr{knit_child(text_questions_vec[76])} 
\clearpage
% -----------------------------------------------------------------------
\end{document}
% -----------------------------------------------------------------------
...
b <- c(14,13,16,14,17,15,17)
a <- c(19,18,25,20,20,14,17)
d <- a-b
mean(d)
sd(d)
...
b <- c(13,21,4,12,21,13,-1,6)
a <- c(20,9,11,17,17,9,25,23)
d <- a-b
mean(d)
sd(d)
