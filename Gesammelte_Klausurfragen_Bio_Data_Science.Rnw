...
\clearpage
% -----------------------------------------------------------------------
\part{Vertiefende Aufgaben der Biostatistik}

Die folgenden Aufgaben basieren auf den wissenschaftlichen Veröffentlichungen von X, Y, Z und W. Für die Prüfung wird die Kenntnis der vier Veröffentlichungen vorausgesetzt. Die Teilaufgaben der folgenden Aufgaben stellen nur eine zufällige Auswahl an möglichen Fragen dar.
