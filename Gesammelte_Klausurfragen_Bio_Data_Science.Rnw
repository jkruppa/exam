...
pacman::p_load(tidyverse, simstudy, knitr, xtable, kableExtra, readxl, plyr,
               ...
               janitor, pander, lme4, corpcor)
##
opts_chunk$set(fig.width=7, fig.height=7, fig.path='img/',
               echo=FALSE, warning=FALSE, message=FALSE, 
               cache.path='cache/', fig.pos='H')

## randomize the questions once a semester
## if(force_random_flag & !file.exists(force_random_file)) {
## questions_vec <- list.files("c:/Users/jokruppa/lehre/intern/exam/question",
##                             full.names = TRUE, pattern = "Rnw")
## questions_vec %>%
##   sample %>%
##   write_rds(file = force_random_file)
## } else {
##   questions_vec <- read_rds(force_random_file)
## }

question_path <- "/Users/kruppajo/Documents/GitHub/exam/question"
