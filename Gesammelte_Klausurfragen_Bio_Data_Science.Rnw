...
if(str_detect(path_home(), "^C:")){
  ...
  exam_path <- file.path(path_home(), "GitHub/exam")  
}
...
wanted_questions <- c(text_questions_vec, math_questions_vec) %>% sample(6) ## 20260625 gehen auf 6 runter
...
\vspace{2Ex}
  \begin{center}
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
      ...
      \hline
      \textbf{Punkte} & 
      \hspace{1Ex}\huge\textcolor{gray!70}{\Sexpr{points_vec[1]}}\hspace{1Ex}  & 
      \hspace{1Ex}\huge\textcolor{gray!70}{\Sexpr{points_vec[2]}}\hspace{1Ex}  & 
      \hspace{1Ex}\huge\textcolor{gray!70}{\Sexpr{points_vec[3]}}\hspace{1Ex}  & 
      \hspace{1Ex}\huge\textcolor{gray!70}{\Sexpr{points_vec[4]}}\hspace{1Ex}  & 
      \hspace{1Ex}\huge\textcolor{gray!70}{\Sexpr{points_vec[5]}}\hspace{1Ex}  & 
      \hspace{1Ex}\huge\textcolor{gray!70}{\Sexpr{points_vec[6]}}\hspace{1Ex}  \strut\\
      \hline
  \end{tabular}
\end{center}
\vspace{2Ex}
