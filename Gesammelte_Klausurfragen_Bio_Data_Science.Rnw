...
## Monster des Alltags
attr_lst <- lst(Alex = lst(flaw = "die Gefälligkeit", sweet = "Gummibärchen", animal = "die Katze", sport = "zu Laufen",
                         hobby = "Starcraft", music = "Abba", film = "Alien"),
                Jessica = lst(flaw = "der Mangel", sweet = "Schokobons", animal = "die Hündin", sport = "Rad zu fahren",
                ...
                Steffen = lst(flaw = "die Romantik", sweet = "Oreos", animal = "die Schlange", sport = "zu Ringen",
