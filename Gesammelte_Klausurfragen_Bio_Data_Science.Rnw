...
attr_lst <- lst(Alex = lst(flaw = "das Aufstehen", sweet = "Gummibärchen", animal = "die Katze", sport = "zu Laufen",
                ...
                Paula = lst(flaw = "der Perfektionismus", sweet = "Smarties", animal = "die Ratte", sport = "zu Fechten",
                         hobby = "Harry Potter", music = "White Lies", film = "Jagd auf roter Oktober"),
                ...
                Tina = lst(flaw = "die Vergesslichkeit", sweet = "Katjes", animal = "die Spinne", sport = "zu Boxen",
                         hobby = "Astronomie", music = "Tocotronic", film = "Indiana Jones"),
                Yuki = lst(flaw = "die Faulheit", sweet = "Reese's Peanut Butter Cups", animal = "das Minischwein", sport = "zu Boldern",
                         hobby = "Orchideen", music = "London Grammar", film = "Matrix"))
