...
## Monster des Alltags
attr_lst <- lst(Alex = lst(flaw = "das Aufstehen", sweet = "Gummibärchen", animal = "die Katze", sport = "zu Laufen",
                         hobby = "Starcraft", music = "Abba", film = "Alien"),
                Jessica = lst(flaw = "die Unordnung", sweet = "Schokobons", animal = "der Hund", sport = "Rad zu fahren",
                         hobby = "Warhammer", music = "David Bowie", film = "Herr der Ringe"),
                Jonas = lst(flaw = "die Unpünktlichkeit", sweet = "Werther's Popcorn", animal = "das Meerschweinchen", sport = "zu Schwimmen",
                         hobby = "Stricken", music = "Iron Maiden", film = "Mission Impossible"),
                Mark = lst(flaw = "die Angst", sweet = "Marzipankugeln", animal = "der Hamster", sport = "zu Reiten",
                         hobby = "Geocaching", music = "Andrea Berg", film = "Columbo"),
                Nilufar = lst(flaw = "die Erwartung", sweet = "Takis Blue Heat", animal = "das Huhn", sport = "zu Kicken",
                         hobby = "Blasmusik", music = "Deichkind", film = "Star Trek"),
                Paula = lst(flaw = "der Perfektionismus", sweet = "Smarties", animal = "die Ratte", sport = "zu Fechten",
                         hobby = "Harry Potter", music = "Fanta4", film = "Jagd auf roter Oktober"),
                Steffen = lst(flaw = "die innere Leere", sweet = "Oreos", animal = "der Leguan", sport = "zu Ringen",
                         hobby = "Klemmbausteine", music = "Taylor Swift", film = "Harry Potter"),
                Tina = lst(flaw = "die Vergesslichkeit", sweet = "Katjes", animal = "die Spinne", sport = "zu Boxen",
                         hobby = "Astronomie", music = "Michael Jackson", film = "Indiana Jones"),
                Yuki = lst(flaw = "die Faulheit", sweet = "Reese's Peanut Butter Cups", animal = "das Minischwein", sport = "zu Boldern",
                         hobby = "Orchideen", music = "Madonna", film = "Matrix"))
...
sentence_func <- \(name, pronom, attr_vec){
  sentence_lst <- lst(flaw = c(str_c(name, " und ", attr_vec$flaw ,", eine unendliche Geschichte mit kniffeligen Wendungen."),
                               str_c("Eine echte Herausforderung für ", pronom[5] ," war schon immer ", attr_vec$flaw ,". Ein leidiges Lied."),
                      ...
                      sweet_music = c(str_c(name, " schmeißt noch eine Handvoll ", attr_vec$sweet ," in ", pronom[3] ," Rachen. Im Hintergrund klirrt leise der Spiegel zum Sound von ", attr_vec$music ,"."),
                                      str_c("Hm..., ", attr_vec$sweet ," und ", attr_vec$music ,". Das ist und bleibt die beste Kombination zum Nachdenken."),
                                      str_c("Aus den Boxen wummert ", attr_vec$music ," und sein Mund ist verklebt von ", attr_vec$sweet ,". 'Herrlich', denkt ", name ,".")) |> sample(1),
                      animal_music = c(str_c(name, " streichelt liebevoll ", attr_vec$animal ,". Der Kopf ist in ", pronom[1] ," Schloß vergraben um den Klang von ", attr_vec$music ," zu dämpfen."),
                                       str_c("Wenn ", attr_vec$music ," ertönt, dann sucht ", attr_vec$animal ," schleunigst Schutz unter dem Sofa."),
                      ...
                      sport = c(str_c(name, " will später nochmal raus um ", attr_vec$sport ,". Druck ablassen."),
                      ...
                      hobby = c(str_c(name, " liebt ", attr_vec$hobby ,". Darin kann ", names(name) ," sich wirklich verlieren und immer wieder neu begeistern."),
                                ...
                                str_c("Am Ende dann noch ", attr_vec$hobby ,". Wunderbar. Eine echte Ablenkung für ", name ,".")) |> sample(1),
                      ...
                      animal_film = c(str_c("Das Verrückte ist, dass ", attr_vec$animal ," ", attr_vec$film ," wirklich liebt. Das ist ", name ," sehr recht, denn ", names(name) ," braucht Entspannung."),
                                      str_c("Wenn ", attr_vec$film ," läuft, dann findet ", name ," ", attr_vec$animal ," nicht mehr. Aber jetzt braucht ", names(name) ," mal Entspannung!"),
...
attr_vec <- attr_lst[[name]]
sentence_vec <- sentence_func(name, pronom, attr_vec) 
sentence_vec
sentence_vec |> sample(2)
@ 
% -----------------------------------------------------------------------
...
\clearpage
% -----------------------------------------------------------------------
\Sexpr{knit_child(multcomp_questions_vec[4])} 
\clearpage
% -----------------------------------------------------------------------
